...
void test_query()
{
  exec::inline_exception_handling_t result1 = asio::query(Executor(), Param());
  ASIO_CHECK(result1 == ExpectedResult());

  Executor ex1 = {};
  exec::inline_exception_handling_t result2 = asio::query(ex1, Param());
  ASIO_CHECK(result2 == ExpectedResult());

  const Executor ex2 = {};
  exec::inline_exception_handling_t result3 = asio::query(ex2, Param());
...
void test_constexpr_query()
{
  ...
  constexpr exec::inline_exception_handling_t result1 = asio::query(ex1, Param());
  ASIO_CHECK(result1 == ExpectedResult());
}
...
void test_vars()
{
  ASIO_CHECK(s() == exec::inline_exception_handling);
  ASIO_CHECK(s() != exec::inline_exception_handling.propagate);
  ASIO_CHECK(s() != exec::inline_exception_handling.capture);
  ASIO_CHECK(s() != exec::inline_exception_handling.terminate);
  ASIO_CHECK(n1() == exec::inline_exception_handling.propagate);
  ASIO_CHECK(n1() != exec::inline_exception_handling.capture);
  ASIO_CHECK(n1() != exec::inline_exception_handling.terminate);
  ASIO_CHECK(n2() == exec::inline_exception_handling.capture);
  ASIO_CHECK(n2() != exec::inline_exception_handling.propagate);
  ASIO_CHECK(n2() != exec::inline_exception_handling.terminate);
  ASIO_CHECK(n3() == exec::inline_exception_handling.terminate);
  ASIO_CHECK(n3() != exec::inline_exception_handling.propagate);
  ASIO_CHECK(n3() != exec::inline_exception_handling.capture);
}
