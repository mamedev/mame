...
void nes_sh6578_state::apu_w(offs_t offset, uint8_t data)
{
...
void nes_sh6578_state::nes_sh6578_map(address_map& map)
{
	...
	map(0x4000, 0x4013).w(FUNC(nes_sh6578_state::apu_w));
	map(0x4014, 0x4014).w(FUNC(nes_sh6578_state::sprite_dma_w));
	map(0x4015, 0x4015).r(m_apu, FUNC(nesapu_device::status_r)).lw8(NAME([this](u8 data) { apu_w(0x15, data); }));
	map(0x4016, 0x4016).rw(FUNC(nes_sh6578_state::io0_r), FUNC(nes_sh6578_state::io_w));
	map(0x4017, 0x4017).r(FUNC(nes_sh6578_state::io1_r)).lw8(NAME([this](u8 data) { apu_w(0x17, data); }));
