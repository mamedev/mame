...
static INPUT_PORTS_START( nes_m8 )
	...
	PORT_START("DSW0")
	PORT_DIPNAME( 0x01, 0x00, "Intro Mirroring" )               PORT_DIPLOCATION("DS1:1") PORT_CHANGED_MEMBER(DEVICE_SELF, m8_state, m8_dsw_changed, 0)
...
GAME( 1986, nesm8,  0,       nes_m8, nes_m8, m8_state, empty_init,  ROT0, "Nintendo", "M8 Game Selectable Working Product Display",     MACHINE_IMPERFECT_GRAPHICS | MACHINE_SUPPORTS_SAVE )
