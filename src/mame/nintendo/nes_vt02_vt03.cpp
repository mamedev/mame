...
static INPUT_PORTS_START( tvmjfc )
	...
	PORT_START("MJ1")
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_MAHJONG_PON ) // "PENG" [3B/D6 = wrong?]
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNUSED )
	...
	PORT_START("MJ4")
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_MAHJONG_REACH ) // "JIAO" [3A/D2 = wrong?]
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNUSED )
	...
	PORT_START("MJ9")
	PORT_BIT( 0xff, IP_ACTIVE_LOW, IPT_UNKNOWN ) // special key of unknown significance
INPUT_PORTS_END
