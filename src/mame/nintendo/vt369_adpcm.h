...
private:
	static inline constexpr int ADPCM_LEAD = 0;
	static inline constexpr int ADPCM_FRAME = 1;
	static inline constexpr int ADPCM_VOLUME = 2;
	static inline constexpr int ADPCM_LASTOUTPUT = 3;
	static inline constexpr int ADPCM_OUTPUT = 4;
	static inline constexpr int ADPCM_POSITION = 5;

	static inline constexpr s16 stepTable[16][16] = {
