...
void nes_vt02_vt03_soc_device::apu_w(offs_t offset, uint8_t data)
{
...
void nes_vt02_vt03_soc_device::nes_vt_map(address_map &map)
{
	...
	map(0x4000, 0x4013).w(FUNC(nes_vt02_vt03_soc_device::apu_w));
	...
	map(0x4017, 0x4017).r(FUNC(nes_vt02_vt03_soc_device::in1_r)).lw8(NAME([this](u8 data) { apu_w(0x17, data); }));
