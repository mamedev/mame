...
ROM_START ( urashima )
	...
	ROM_LOAD( "m50747-b84sp.11b", 0x0000, 0x2000, NO_DUMP ) /* Mitsubishi M50747 MCU with 8 Kbytes of internal ROM */
...
ROM_START( daireika )
	...
	ROM_REGION( 0x2000, "mcu", 0 ) /* M50747 MCU Code */
	ROM_LOAD( "mo-88015.bin", 0x0000, 0x2000, NO_DUMP ) /* Mitsubishi M50747 MCU with 8 Kbytes of internal ROM */
...
ROM_START( mjzoomin )
	...
	ROM_REGION( 0x2000, "mcu", 0 ) /* M50747 MCU Code */
	ROM_LOAD( "rf16.bin", 0x0000, 0x2000, NO_DUMP ) /* Mitsubishi M50747 MCU with 8 Kbytes of internal ROM */
...
ROM_START( kakumei )
	...
	ROM_REGION( 0x2000, "mcu", 0 ) /* M50747 MCU Code */
	ROM_LOAD( "m50747-b84sp.bin", 0x0000, 0x2000, NO_DUMP ) /* Mitsubishi M50747 MCU with 8 Kbytes of internal ROM */
...
ROM_START( kakumei2 )
	...
	ROM_REGION( 0x2000, "mcu", 0 ) /* M50747 MCU Code */
	ROM_LOAD( "mo-92000", 0x0000, 0x2000, NO_DUMP ) /* Mitsubishi M50747 MCU with 8 Kbytes of internal ROM */
...
ROM_START( suchiesp )
	...
	ROM_REGION( 0x2000, "mcu", 0 ) /* M50747 MCU Code */
	ROM_LOAD( "m50747", 0x0000, 0x2000, NO_DUMP ) /* Mitsubishi M50747 MCU with 8 Kbytes of internal ROM */
