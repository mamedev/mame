...
ROM_START( abc800c )
	...
	ROM_LOAD( "abc 7-2.2j",   0x7000, 0x1000, CRC(fd137866) SHA1(3ac914d90db1503f61397c0ea26914eb38725044) )
	ROM_LOAD( "abc 7-21.2j",  0x7000, 0x1000, CRC(4d2b589f) SHA1(8772119e002943d9891f77eb59d1d2491a834ccd) )
...
COMP( 1981, abc800c, 0,       0,      abc800c, abc800, abc800c_state, empty_init, "Luxor", "ABC 800 C/HR", MACHINE_SUPPORTS_SAVE )
COMP( 1981, abc800m, abc800c, 0,      abc800m, abc800, abc800m_state, empty_init, "Luxor", "ABC 800 M/HR", MACHINE_SUPPORTS_SAVE )
COMP( 1981, dtc,     abc800c, 0,      abc800m, abc800, abc800m_state, empty_init, "Facit", "DTC",          MACHINE_SUPPORTS_SAVE )
COMP( 1983, abc802,  0,       0,      abc802,  abc802, abc802_state,  empty_init, "Luxor", "ABC 802",      MACHINE_SUPPORTS_SAVE )
COMP( 1983, abc806,  0,       0,      abc806,  abc806, abc806_state,  empty_init, "Luxor", "ABC 806",      MACHINE_SUPPORTS_SAVE )
