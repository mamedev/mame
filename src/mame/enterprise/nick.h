...
/* there are 64 clocks of 16 pixels per 64us line, although in reality
 about 50 are visible */
#define ENTERPRISE_SCREEN_WIDTH     (64*16)
#define ENTERPRISE_VISIBLE_WIDTH    (50*16)

/* the display list normally generates 312 lines per screen, although in
 reality about 35*8 are visible */
#define ENTERPRISE_SCREEN_HEIGHT    312
#define ENTERPRISE_VISIBLE_HEIGHT   (35*8)
...
private:
	...
	/* remaining scanlines in the current LPT entry */
	int m_lines_remaining;

	/* scanline within the frame generated by the display list */
	int m_render_line;
	bool m_vsync;
