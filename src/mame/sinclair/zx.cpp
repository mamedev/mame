...
// Some keys (e.g. A,S,D,F,G etc.) produce glyphs when used in Shift Mode.
// MAME currently cannot show these functions in Input (This System) menu, hence we leave some empty space in the menu
	PORT_START("ROW0")
