...
public:
	...
	void draw(screen_device &screen, bitmap_rgb32 &bitmap, const rectangle &cliprect, bool flash);
	void draw_ula(bitmap_rgb32 &bitmap, const rectangle &cliprect, bool flash);
	void draw_hires(bitmap_rgb32 &bitmap, const rectangle &cliprect);
