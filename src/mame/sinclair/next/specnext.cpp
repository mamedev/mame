...
INPUT_PORTS_START(specnext)
	...
	PORT_START("JOY_LEFT")
	PORT_BIT(0x001, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT) PORT_8WAY PORT_PLAYER(1) PORT_NAME("Joystick (L) Right")
	PORT_BIT(0x002, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT)  PORT_8WAY PORT_PLAYER(1) PORT_NAME("Joystick (L) Left")
	PORT_BIT(0x004, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN)  PORT_8WAY PORT_PLAYER(1) PORT_NAME("Joystick (L) Down")
	PORT_BIT(0x008, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP)    PORT_8WAY PORT_PLAYER(1) PORT_NAME("Joystick (L) Up")
	PORT_BIT(0x010, IP_ACTIVE_HIGH, IPT_BUTTON2)                  PORT_PLAYER(1) PORT_NAME("Joystick (L) B")
	PORT_BIT(0x020, IP_ACTIVE_HIGH, IPT_BUTTON5)                  PORT_PLAYER(1) PORT_NAME("Joystick (L) C")
	PORT_BIT(0x040, IP_ACTIVE_HIGH, IPT_BUTTON1)                  PORT_PLAYER(1) PORT_NAME("Joystick (L) A")
	PORT_BIT(0x080, IP_ACTIVE_HIGH, IPT_BUTTON8)                  PORT_PLAYER(1) PORT_NAME("Joystick (L) Start")
	PORT_BIT(0x100, IP_ACTIVE_HIGH, IPT_BUTTON4)                  PORT_PLAYER(1) PORT_NAME("Joystick (L) Y")
	PORT_BIT(0x200, IP_ACTIVE_HIGH, IPT_BUTTON6)                  PORT_PLAYER(1) PORT_NAME("Joystick (L) Z")
	PORT_BIT(0x400, IP_ACTIVE_HIGH, IPT_BUTTON3)                  PORT_PLAYER(1) PORT_NAME("Joystick (L) X")
	PORT_BIT(0x800, IP_ACTIVE_HIGH, IPT_BUTTON7)                  PORT_PLAYER(1) PORT_NAME("Joystick (L) Mode")

	PORT_START("JOY_RIGHT")
	PORT_BIT(0x001, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT) PORT_8WAY PORT_PLAYER(2) PORT_NAME("Joystick (R) Right")
	PORT_BIT(0x002, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT)  PORT_8WAY PORT_PLAYER(2) PORT_NAME("Joystick (R) Left")
	PORT_BIT(0x004, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN)  PORT_8WAY PORT_PLAYER(2) PORT_NAME("Joystick (R) Down")
	PORT_BIT(0x008, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP)    PORT_8WAY PORT_PLAYER(2) PORT_NAME("Joystick (R) Up")
	PORT_BIT(0x010, IP_ACTIVE_HIGH, IPT_BUTTON2)                  PORT_PLAYER(2) PORT_NAME("Joystick (R) B")
	PORT_BIT(0x020, IP_ACTIVE_HIGH, IPT_BUTTON5)                  PORT_PLAYER(2) PORT_NAME("Joystick (R) C")
	PORT_BIT(0x040, IP_ACTIVE_HIGH, IPT_BUTTON1)                  PORT_PLAYER(2) PORT_NAME("Joystick (R) A")
	PORT_BIT(0x080, IP_ACTIVE_HIGH, IPT_BUTTON8)                  PORT_PLAYER(2) PORT_NAME("Joystick (R) Start")
	PORT_BIT(0x100, IP_ACTIVE_HIGH, IPT_BUTTON4)                  PORT_PLAYER(2) PORT_NAME("Joystick (R) Y")
	PORT_BIT(0x200, IP_ACTIVE_HIGH, IPT_BUTTON6)                  PORT_PLAYER(2) PORT_NAME("Joystick (R) Z")
	PORT_BIT(0x400, IP_ACTIVE_HIGH, IPT_BUTTON3)                  PORT_PLAYER(2) PORT_NAME("Joystick (R) X")
	PORT_BIT(0x800, IP_ACTIVE_HIGH, IPT_BUTTON7)                  PORT_PLAYER(2) PORT_NAME("Joystick (R) Mode")
