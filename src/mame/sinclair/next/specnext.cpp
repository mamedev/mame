...
ROM_START(tbblue)
	...
	ROM_SYSTEM_BIOS(2, "rc30204", "Next Core v3.02.04 (RC)")
	ROMX_LOAD( "boot-30204rc.bin", 0x0000, 0x2000, CRC(95118eb6) SHA1(acf5112e831be8c73952b8513fab33a427e88cf8), ROM_BIOS(2))
	ROMX_LOAD( "boot-30204rc.bin", 0x2000, 0x2000, CRC(95118eb6) SHA1(acf5112e831be8c73952b8513fab33a427e88cf8), ROM_BIOS(2))

	ROM_SYSTEM_BIOS(3, "rc30204ab", "Anti-Brick Core v3.02.04 (RC)")
	ROMX_LOAD( "boot-30204rc-ab.bin", 0x0000, 0x2000, CRC(96c32007) SHA1(6c9fcbd282f7a18fb5a726386ac6fb9df209c36b), ROM_BIOS(3))
	ROMX_LOAD( "boot-30204rc.bin", 0x2000, 0x2000, CRC(95118eb6) SHA1(acf5112e831be8c73952b8513fab33a427e88cf8), ROM_BIOS(3))

	ROM_SYSTEM_BIOS(4, "v30204", "Next Core v3.02.04")
	ROMX_LOAD( "boot-30204.bin", 0x0000, 0x2000, CRC(ab242e0f) SHA1(a88f1a4dadb4584a2a25d22f1dbb0fe3092349ba), ROM_BIOS(4))
	ROMX_LOAD( "boot-30204.bin", 0x2000, 0x2000, CRC(ab242e0f) SHA1(a88f1a4dadb4584a2a25d22f1dbb0fe3092349ba), ROM_BIOS(4))

	ROM_SYSTEM_BIOS(5, "v30204ab", "Anti-Brick Core v3.02.04")
	ROMX_LOAD( "boot-30204-ab.bin", 0x0000, 0x2000, CRC(85d69a61) SHA1(7c77cd7f16a37581eff539f9a0fd9a12edd34b78), ROM_BIOS(5))
	ROMX_LOAD( "boot-30204.bin", 0x2000, 0x2000, CRC(ab242e0f) SHA1(a88f1a4dadb4584a2a25d22f1dbb0fe3092349ba), ROM_BIOS(5))
ROM_END
...
ROM_START(specnext_ks3)
	...
	ROM_SYSTEM_BIOS(0, "rc30204", "Next Core v3.02.04 (RC)")
	ROMX_LOAD( "boot-30204rc.bin", 0x0000, 0x2000, CRC(95118eb6) SHA1(acf5112e831be8c73952b8513fab33a427e88cf8), ROM_BIOS(0))
	ROMX_LOAD( "boot-30204rc.bin", 0x2000, 0x2000, CRC(95118eb6) SHA1(acf5112e831be8c73952b8513fab33a427e88cf8), ROM_BIOS(0))

	ROM_SYSTEM_BIOS(1, "rc30204ab", "Anti-Brick Core v3.02.04 (RC)")
	ROMX_LOAD( "boot-30204rc-ab.bin", 0x0000, 0x2000, CRC(96c32007) SHA1(6c9fcbd282f7a18fb5a726386ac6fb9df209c36b), ROM_BIOS(1))
	ROMX_LOAD( "boot-30204rc.bin", 0x2000, 0x2000, CRC(95118eb6) SHA1(acf5112e831be8c73952b8513fab33a427e88cf8), ROM_BIOS(1))

	ROM_SYSTEM_BIOS(2, "v30204", "Next Core v3.02.04")
	ROMX_LOAD( "boot-30204.bin", 0x0000, 0x2000, CRC(ab242e0f) SHA1(a88f1a4dadb4584a2a25d22f1dbb0fe3092349ba), ROM_BIOS(2))
	ROMX_LOAD( "boot-30204.bin", 0x2000, 0x2000, CRC(ab242e0f) SHA1(a88f1a4dadb4584a2a25d22f1dbb0fe3092349ba), ROM_BIOS(2))

	ROM_SYSTEM_BIOS(3, "v30204ab", "Anti-Brick Core v3.02.04")
	ROMX_LOAD( "boot-30204-ab.bin", 0x0000, 0x2000, CRC(85d69a61) SHA1(7c77cd7f16a37581eff539f9a0fd9a12edd34b78), ROM_BIOS(3))
	ROMX_LOAD( "boot-30204.bin", 0x2000, 0x2000, CRC(ab242e0f) SHA1(a88f1a4dadb4584a2a25d22f1dbb0fe3092349ba), ROM_BIOS(3))
ROM_END
