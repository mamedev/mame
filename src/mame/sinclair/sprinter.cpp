...
INPUT_PORTS_START( sprinter )
	...
	PORT_BIT(0x0104, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN)  PORT_8WAY PORT_PLAYER(1)
	PORT_BIT(0x0208, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP)    PORT_8WAY PORT_PLAYER(1)
	PORT_BIT(0x0010, IP_ACTIVE_HIGH, IPT_BUTTON2)                  PORT_PLAYER(1) PORT_NAME("%p B")
	PORT_BIT(0x0020, IP_ACTIVE_HIGH, IPT_BUTTON5)                  PORT_PLAYER(1) PORT_NAME("%p C")
	PORT_BIT(0x00c0, IP_ACTIVE_LOW,  IPT_UNUSED)

	PORT_BIT(0x0400, IP_ACTIVE_HIGH, IPT_BUTTON1)                  PORT_PLAYER(1) PORT_NAME("%p A")
	PORT_BIT(0x0800, IP_ACTIVE_HIGH, IPT_BUTTON8)                  PORT_PLAYER(1) PORT_NAME("%p Start")

	PORT_BIT(0x1000, IP_ACTIVE_HIGH, IPT_BUTTON7)                  PORT_PLAYER(1) PORT_NAME("%p Select")
	PORT_BIT(0x2000, IP_ACTIVE_HIGH, IPT_BUTTON3)                  PORT_PLAYER(1) PORT_NAME("%p X")
	PORT_BIT(0x4000, IP_ACTIVE_HIGH, IPT_BUTTON4)                  PORT_PLAYER(1) PORT_NAME("%p Y")
	PORT_BIT(0x8000, IP_ACTIVE_HIGH, IPT_BUTTON6)                  PORT_PLAYER(1) PORT_NAME("%p Z")

	PORT_START("JOY2")
	PORT_BIT(0x0001, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT) PORT_8WAY PORT_PLAYER(2)
	PORT_BIT(0x0002, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT)  PORT_8WAY PORT_PLAYER(2)
	PORT_BIT(0x0104, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN)  PORT_8WAY PORT_PLAYER(2)
	PORT_BIT(0x0208, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP)    PORT_8WAY PORT_PLAYER(2)
	PORT_BIT(0x0010, IP_ACTIVE_HIGH, IPT_BUTTON2)                  PORT_PLAYER(2) PORT_NAME("%p B")
	PORT_BIT(0x0020, IP_ACTIVE_HIGH, IPT_BUTTON5)                  PORT_PLAYER(2) PORT_NAME("%p C")
	PORT_BIT(0x00c0, IP_ACTIVE_LOW,  IPT_UNUSED)

	PORT_BIT(0x0400, IP_ACTIVE_HIGH, IPT_BUTTON1)                  PORT_PLAYER(2) PORT_NAME("%p A")
	PORT_BIT(0x0800, IP_ACTIVE_HIGH, IPT_BUTTON8)                  PORT_PLAYER(2) PORT_NAME("%p Start")

	PORT_BIT(0x1000, IP_ACTIVE_HIGH, IPT_BUTTON7)                  PORT_PLAYER(2) PORT_NAME("%p Select")
	PORT_BIT(0x2000, IP_ACTIVE_HIGH, IPT_BUTTON3)                  PORT_PLAYER(2) PORT_NAME("%p X")
	PORT_BIT(0x4000, IP_ACTIVE_HIGH, IPT_BUTTON4)                  PORT_PLAYER(2) PORT_NAME("%p Y")
	PORT_BIT(0x8000, IP_ACTIVE_HIGH, IPT_BUTTON6)                  PORT_PLAYER(2) PORT_NAME("%p Z")
