...
public:
    ...
    void set_raster_offset(std::pair<u16, u16> offset) { m_offset = { offset.first - OVER_BORDER, offset.second - OVER_BORDER }; update_config(); }
    void update_config();
...
private:
    ...
    rectangle m_clip_window = SCREEN_AREA;
