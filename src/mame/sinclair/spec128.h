...
protected:
	static inline constexpr XTAL X1_128_SINCLAIR = 35.469_MHz_XTAL; // Main clock (Sinclair 128K model)

	// 128K machines take an extra 4 cycles per scan line - add this to retrace
	static inline constexpr int SPEC128_UNSEEN_LINES    = 15;
	static inline constexpr int SPEC128_RETRACE_CYCLES  = 52;
	static inline constexpr int SPEC128_CYCLES_PER_LINE = 228;
