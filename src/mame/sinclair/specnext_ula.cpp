...
void specnext_ula_device::draw_border(screen_device &screen, bitmap_ind16 &bitmap, const rectangle &cliprect)
{
}
...
void specnext_ula_device::draw_ula(bitmap_ind16 &bitmap, const rectangle &cliprect, bool flash)
{
...
void specnext_ula_device::draw_hires(bitmap_ind16 &bitmap, const rectangle &cliprect)
{
	rectangle clip = { m_ula_clip_x1 << 1, (m_ula_clip_x2 << 1) | 1, m_ula_clip_y1, m_ula_clip_y2 };
	clip.offset(m_offset_h, m_offset_v);
	clip &= cliprect;
