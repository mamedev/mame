...
public:
    ...
    void set_raster_offset(std::pair<u16, u16> offset) { m_offset = { offset.first - OVER_BORDER, offset.second - OVER_BORDER }; }
    void tilemap_update();
    ...
    void clip_x1_w(u8 clip_x1) { m_clip_x1 = clip_x1; tilemap_update(); }
    void clip_x2_w(u8 clip_x2) { m_clip_x2 = clip_x2; tilemap_update(); }
    void clip_y1_w(u8 clip_y1) { m_clip_y1 = clip_y1; tilemap_update(); }
    void clip_y2_w(u8 clip_y2) { m_clip_y2 = clip_y2; tilemap_update(); }

    void draw(screen_device &screen, bitmap_ind16 &bitmap, const rectangle &cliprect, bool over_ula);
