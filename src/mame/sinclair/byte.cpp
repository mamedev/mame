...
INPUT_PORTS_START(byte)
	...
	PORT_BIT(0x000200, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME(u8"(CS+2) ПР/СТ")    PORT_CODE(KEYCODE_CAPSLOCK)
	...
	PORT_BIT(0xfffe60, IP_ACTIVE_LOW, IPT_UNUSED)

	//PORT_BIT(0x00, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME(u8"РЕГ2")         PORT_CODE()
	//PORT_BIT(0x00, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME(u8"✻")           PORT_CODE()
