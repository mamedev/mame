...
static INPUT_PORTS_START( jdreddp )
	...
	PORT_DIPSETTING(      0x0001, DEF_STR( Off ))
	PORT_DIPSETTING(      0x0000, DEF_STR( On ))
	PORT_DIPNAME( 0x0002, 0x0002, DEF_STR( Test Mode )) 
	PORT_DIPSETTING(      0x0002, DEF_STR( Powerup Test ))
	PORT_DIPSETTING(      0x0000, DEF_STR( Skip Test ))
	...
	PORT_DIPNAME( 0x0080, 0x0080, "Player" )
	PORT_DIPSETTING(      0x0080, DEF_STR( 3 ))
	PORT_DIPSETTING(      0x0000, DEF_STR( 2 ))
