...
static INPUT_PORTS_START( midvunit )
	...
	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_BUTTON8 ) PORT_NAME("4th Gear") PORT_CHANGED_MEMBER(DEVICE_SELF, FUNC(midvunit_state::shift_button), 0x0400)
	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_BUTTON7 ) PORT_NAME("3rd Gear") PORT_CHANGED_MEMBER(DEVICE_SELF, FUNC(midvunit_state::shift_button), 0x0800)
	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON6 ) PORT_NAME("2nd Gear") PORT_CHANGED_MEMBER(DEVICE_SELF, FUNC(midvunit_state::shift_button), 0x1000)
	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON5 ) PORT_NAME("1st Gear") PORT_CHANGED_MEMBER(DEVICE_SELF, FUNC(midvunit_state::shift_button), 0x2000)
	...
	PORT_START("FAKE")
	PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_BUTTON9 ) PORT_NAME("Neutral Gear") PORT_CONDITION("CONF", 0x01, EQUALS, 0x01) PORT_CHANGED_MEMBER(DEVICE_SELF, FUNC(midvunit_state::shift_button), 0x0000)

	PORT_START("CONF")
	PORT_CONFNAME( 0x01, 0x01, "Shifter Type" )
