...
class k1515xm031_kbd_device : public device_t,
	public device_z80daisy_interface,
	protected device_matrix_keyboard_interface<12U>
{
public:
	// construction/destruction
	k1515xm031_kbd_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock);
...
class k1515xm031_tmr_device : public device_t,
							  public device_z80daisy_interface
{
public:
	// construction/destruction
	k1515xm031_tmr_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock);
...
DECLARE_DEVICE_TYPE(K1515XM031_KBD, k1515xm031_kbd_device)
DECLARE_DEVICE_TYPE(K1515XM031_TMR, k1515xm031_tmr_device)
