...
void chessc2_decrypt(running_machine &machine, u8* table)
{
	auto const src = reinterpret_cast<u16 *>(machine.root_device().memregion("user1_encrypted")->base());
	auto const dst = reinterpret_cast<u16 *>(machine.root_device().memregion("user1")->base());
...
void zhongguo_decrypt(running_machine &machine, u8* table)
{
	auto const src = reinterpret_cast<u16 *>(machine.root_device().memregion("user1_encrypted")->base());
	auto const dst = reinterpret_cast<u16 *>(machine.root_device().memregion("user1")->base());
...
void lhzb4_decrypt(running_machine &machine, u8* table)
{
	auto const src = reinterpret_cast<u16 *>(machine.root_device().memregion("user1_encrypted")->base());
	auto const dst = reinterpret_cast<u16 *>(machine.root_device().memregion("user1")->base());
...
void slqz3_decrypt(running_machine &machine, u8* table)
{
	// xor table passed from driver
	auto const src = reinterpret_cast<u16 *>(machine.root_device().memregion("user1_encrypted")->base());
	auto const dst = reinterpret_cast<u16 *>(machine.root_device().memregion("user1")->base());
...
void fruitpar_decrypt(running_machine &machine, u8* table)
{
	auto const src = reinterpret_cast<u16 *>(machine.root_device().memregion("user1_encrypted")->base());
	auto const dst = reinterpret_cast<u16 *>(machine.root_device().memregion("user1")->base());
...
void oceanpar_decrypt(running_machine &machine, u8* table)
{
	auto const src = reinterpret_cast<u16 *>(machine.root_device().memregion("user1_encrypted")->base());
	auto const dst = reinterpret_cast<u16 *>(machine.root_device().memregion("user1")->base());
...
void mgcs3_decrypt(running_machine &machine, u8* table)
{
	auto const src = reinterpret_cast<u16 *>(machine.root_device().memregion("user1_encrypted")->base());
	auto const dst = reinterpret_cast<u16 *>(machine.root_device().memregion("user1")->base());
...
void mgzz_decrypt(running_machine &machine, u8* table)
{
	auto const src = reinterpret_cast<u16 *>(machine.root_device().memregion("user1_encrypted")->base());
	auto const dst = reinterpret_cast<u16 *>(machine.root_device().memregion("user1")->base());
...
void qlgs_decrypt(running_machine &machine, u8* table)
{
	auto const src = reinterpret_cast<u16 *>(machine.root_device().memregion("user1_encrypted")->base());
	auto const dst = reinterpret_cast<u16 *>(machine.root_device().memregion("user1")->base());
...
void lthy_decrypt(running_machine &machine, u8* table)
{
	auto const src = reinterpret_cast<u16 *>(machine.root_device().memregion("user1_encrypted")->base());
	auto const dst = reinterpret_cast<u16 *>(machine.root_device().memregion("user1")->base());
...
void lhdmg_decrypt(running_machine &machine, u8* table)
{
	auto const src = reinterpret_cast<u16 *>(machine.root_device().memregion("user1_encrypted")->base());
	auto const dst = reinterpret_cast<u16 *>(machine.root_device().memregion("user1")->base());
...
void lhdmgp_decrypt(running_machine &machine, u8* table)
{
	auto const src = reinterpret_cast<u16 *>(machine.root_device().memregion("user1_encrypted")->base());
	auto const dst = reinterpret_cast<u16 *>(machine.root_device().memregion("user1")->base());
