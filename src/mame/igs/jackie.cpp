...
static INPUT_PORTS_START( jackie )
	...
	PORT_DIPUNKNOWN( 0x02, 0x02 ) PORT_DIPLOCATION("SWA:7")
	PORT_DIPUNKNOWN( 0x04, 0x04 ) PORT_DIPLOCATION("SWA:6")
	PORT_DIPUNKNOWN( 0x08, 0x08 ) PORT_DIPLOCATION("SWA:5")
	PORT_DIPUNKNOWN( 0x10, 0x10 ) PORT_DIPLOCATION("SWA:4")
	PORT_DIPUNKNOWN( 0x20, 0x20 ) PORT_DIPLOCATION("SWA:3")
	PORT_DIPUNKNOWN( 0x40, 0x40 ) PORT_DIPLOCATION("SWA:2")
	PORT_DIPUNKNOWN( 0x80, 0x80 ) PORT_DIPLOCATION("SWA:1")
	...
	PORT_DIPUNKNOWN( 0x10, 0x10 ) PORT_DIPLOCATION("SWB:4")
	PORT_DIPNAME( 0x20, 0x00, "Double Up Rate" ) PORT_DIPLOCATION("SWB:3")
	PORT_DIPSETTING(    0x20, DEF_STR( Hard ) )
	PORT_DIPSETTING(    0x00, DEF_STR( Easy ) )
	PORT_DIPUNKNOWN( 0x40, 0x40 ) PORT_DIPLOCATION("SWB:2")
	PORT_DIPUNKNOWN( 0x80, 0x80 ) PORT_DIPLOCATION("SWB:1")

	PORT_START("DSW3")
	PORT_DIPUNKNOWN( 0x01, 0x01 ) PORT_DIPLOCATION("SWC:8")
	PORT_DIPUNKNOWN( 0x02, 0x02 ) PORT_DIPLOCATION("SWC:7")
	PORT_DIPUNKNOWN( 0x04, 0x04 ) PORT_DIPLOCATION("SWC:6")
	PORT_DIPUNKNOWN( 0x08, 0x08 ) PORT_DIPLOCATION("SWC:5")
	PORT_DIPUNKNOWN( 0x10, 0x10 ) PORT_DIPLOCATION("SWC:4")
	PORT_DIPUNKNOWN( 0x20, 0x20 ) PORT_DIPLOCATION("SWC:3")
	...
	PORT_START("DSW4")
	PORT_DIPUNKNOWN( 0x01, 0x01 ) PORT_DIPLOCATION("SWD:8")
	PORT_DIPUNKNOWN( 0x02, 0x02 ) PORT_DIPLOCATION("SWD:7")
	PORT_DIPUNKNOWN( 0x04, 0x04 ) PORT_DIPLOCATION("SWD:6")
	PORT_DIPUNKNOWN( 0x08, 0x08 ) PORT_DIPLOCATION("SWD:5")
	PORT_DIPUNKNOWN( 0x10, 0x10 ) PORT_DIPLOCATION("SWD:4")
	PORT_DIPUNKNOWN( 0x20, 0x20 ) PORT_DIPLOCATION("SWD:3")
	PORT_DIPUNKNOWN( 0x40, 0x40 ) PORT_DIPLOCATION("SWD:2")
	PORT_DIPUNKNOWN( 0x80, 0x80 ) PORT_DIPLOCATION("SWD:1")

	PORT_START("DSW5")
	PORT_DIPUNKNOWN( 0x01, 0x01 ) PORT_DIPLOCATION("SWE:8")
	PORT_DIPUNKNOWN( 0x02, 0x02 ) PORT_DIPLOCATION("SWE:7")
	PORT_DIPUNKNOWN( 0x04, 0x04 ) PORT_DIPLOCATION("SWE:6")
	PORT_DIPUNKNOWN( 0x08, 0x08 ) PORT_DIPLOCATION("SWE:5")
	PORT_DIPUNKNOWN( 0x10, 0x10 ) PORT_DIPLOCATION("SWE:4")
	PORT_DIPUNKNOWN( 0x20, 0x20 ) PORT_DIPLOCATION("SWE:3")
	PORT_DIPUNKNOWN( 0x40, 0x40 ) PORT_DIPLOCATION("SWE:2")
	PORT_DIPUNKNOWN( 0x80, 0x80 ) PORT_DIPLOCATION("SWE:1")
...
void jackie_state::init_jackiea()
{
	uint8_t *rom = memregion("maincpu")->base();
...
ROM_START( jackie ) // IGS PCB N0-T0039-8
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "jackiev_119.u23", 0x0000, 0x10000, CRC(3ab7da3b) SHA1(36dc9de4903d6002d06b3763b27f9420af4591e6) )

	ROM_REGION( 0x60000, "tiles", 0 )
	ROM_LOAD( "jackie_6p.u6", 0x00000, 0x20000, CRC(9becce0b) SHA1(27415de7baf17fdacecdae21a1eaf5060638c2c5) )
	ROM_LOAD( "jackie_5p.u5", 0x20000, 0x20000, CRC(204cf5a8) SHA1(8488a075f0982aec99fa1e20c7524942de3d939f) )
	ROM_LOAD( "jackie_4p.u4", 0x40000, 0x20000, CRC(c7aa5c26) SHA1(2500ab8041f28f13ba6d84ed6a752c3aad2cd8a7) )

	ROM_REGION( 0x30000, "reels", 0 )
	ROM_LOAD( "jackie_3.u3",  0x00000, 0x4000, CRC(c69e962b) SHA1(492427ad1ac959cdf22d23439e0eb5932b60ec88) )
	ROM_LOAD( "jackie_2.u2",  0x10000, 0x4000, CRC(8900ffba) SHA1(065cf1810ec9738718e4c94613f726e85ba4314d) )
	ROM_LOAD( "jackie_1.u1",  0x20000, 0x4000, CRC(071d20f0) SHA1(77c87486803dccaa63732ff959c223b1313820e3) )

	ROM_REGION( 0x10000, "gfx3", 0 )
	ROM_LOAD( "jackie7p.u22", 0x0000, 0x10000, CRC(f8b89fc5) SHA1(85c681eb1578036e485fd656424e8daceb819795) )
...
ROM_START( jackiea ) // IGS PCB N0-T0039-4
	ROM_REGION( 0x10000, "maincpu", 0 )
