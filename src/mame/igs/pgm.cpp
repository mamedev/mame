...
INPUT_PORTS_START( pgm )
	...
	PORT_START("DSW")
	PORT_SERVICE( 0x0001, IP_ACTIVE_LOW ) PORT_DIPLOCATION("SW1:1")
	PORT_DIPNAME( 0x0002, 0x0002, "Music" ) PORT_DIPLOCATION("SW1:2")
	PORT_DIPSETTING(      0x0000, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0002, DEF_STR( On ) )
	PORT_DIPNAME( 0x0004, 0x0004, "Voice" ) PORT_DIPLOCATION("SW1:3")
	PORT_DIPSETTING(      0x0000, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0004, DEF_STR( On ) )
	PORT_DIPNAME( 0x0008, 0x0008, "Free" ) PORT_DIPLOCATION("SW1:4")
	PORT_DIPSETTING(      0x0008, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
	PORT_DIPNAME( 0x0010, 0x0010, "Stop" ) PORT_DIPLOCATION("SW1:5")
	...
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
	PORT_DIPNAME( 0x0080, 0x0080, "Debug" ) PORT_DIPLOCATION("SW1:8")
...
void pgm_state::pgmbase(machine_config &config)
{
	...
	m_ics->add_route(ALL_OUTPUTS, "mono", 0.1);
}
...
ROM_START( dmnfrnt ) // same ROM set has also been found on a single PCB board (set dmnfrnta in FBNeo)
	ROM_REGION( 0x600000, "maincpu", 0 ) /* 68000 Code */
	PGM_68K_BIOS
...
// this is a special version only shown at the 2007 Cave Matsuri event
