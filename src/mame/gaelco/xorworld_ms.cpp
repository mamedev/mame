...
GAME( 1990, xorworldm, xorworld, xorworld_ms, xorworld_ms, xorworld_ms_state, init_xorworld_ms, ROT0, "Gaelco", "Xor World (Modular System)", MACHINE_NOT_WORKING | MACHINE_NO_SOUND )
