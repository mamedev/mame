...
GAME(1994, scxsp,  0,     scalextric, scalextric, scalextric_state, empty_init, ROT0, "Gaelco", "Scalextric (Spain, set 1)",   MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL)
GAME(1994, scxspa, scxsp, scalextric, scalextric, scalextric_state, empty_init, ROT0, "Gaelco", "Scalextric (Spain, set 2)",   MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL)
GAME(1994, scxspb, scxsp, scalextric, scalextric, scalextric_state, empty_init, ROT0, "Gaelco", "Scalextric (Spain, set 3)",   MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL)
GAME(1994, scxspc, scxsp, scalextric, scalextric, scalextric_state, empty_init, ROT0, "Gaelco", "Scalextric (Spain, set 4)",   MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL)
GAME(1994, scxspd, scxsp, scalextric, scalextric, scalextric_state, empty_init, ROT0, "Gaelco", "Scalextric (Spain, set 5)",   MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL)
GAME(1994, scxam,  scxsp, scalextric, scalextric, scalextric_state, empty_init, ROT0, "Gaelco", "Scalextric (America)",        MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL)
GAME(1994, scxen,  scxsp, scalextric, scalextric, scalextric_state, empty_init, ROT0, "Gaelco", "Scalextric (England, set 1)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL)
GAME(1994, scxena, scxsp, scalextric, scalextric, scalextric_state, empty_init, ROT0, "Gaelco", "Scalextric (England, set 2)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL)
GAME(1994, scxfr,  scxsp, scalextric, scalextric, scalextric_state, empty_init, ROT0, "Gaelco", "Scalextric (France, set 1)",  MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL)
GAME(1994, scxfra, scxsp, scalextric, scalextric, scalextric_state, empty_init, ROT0, "Gaelco", "Scalextric (France, set 2)",  MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL)
GAME(1994, scxgr,  scxsp, scalextric, scalextric, scalextric_state, empty_init, ROT0, "Gaelco", "Scalextric (Germany)",        MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL)
GAME(1994, scxit,  scxsp, scalextric, scalextric, scalextric_state, empty_init, ROT0, "Gaelco", "Scalextric (Italy, set 1)",   MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL)
GAME(1994, scxita, scxsp, scalextric, scalextric, scalextric_state, empty_init, ROT0, "Gaelco", "Scalextric (Italy, set 2)",   MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL)
GAME(1994, scxpt,  scxsp, scalextric, scalextric, scalextric_state, empty_init, ROT0, "Gaelco", "Scalextric (Portugal)",       MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL)
GAME(1994, scxus,  scxsp, scalextric, scalextric, scalextric_state, empty_init, ROT0, "Gaelco", "Scalextric (USA)",            MACHINE_NO_SOUND | MACHINE_NOT_WORKING | MACHINE_MECHANICAL)
