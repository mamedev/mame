...
ROM_START(tokyocop)
	...
	ROMX_LOAD( "al1 49lf004a.u10", 0x000000, 0x80000, CRC(db8e4a37) SHA1(9ef4bf1d72955a89e7dc9b984e76ce86c824b461), ROM_BIOS(1) )
...
// Gaelco I/O card "REF. 050210" (Altera Cyclone EP1C3T144C8, AD9288, etc.)
ROM_START(tuningrc)
	ROM_REGION32_LE(0x80000, "bios", 0)  // motherboard BIOS
	ROM_SYSTEM_BIOS( 0, "60",  "V4-60" )
	ROMX_LOAD( "310j.u10",             0x000000, 0x80000, CRC(70b0797a) SHA1(696f602e83359d5d36798d4d2962ee85171e3622), ROM_BIOS(0) ) // $40 6.00 PG 12/19/2002, $7413c v0.0 08/13/1999
	ROM_SYSTEM_BIOS( 1, "60a", "V4-60 (alt)" )
	ROMX_LOAD( "3-01_sst49lf004a.u10", 0x000000, 0x80000, CRC(768fc24d) SHA1(81c04fab834700dbe9bb2275151a773fe6e0161d), ROM_BIOS(1) ) // Internal compressed file 100% the same as "V4-60"
