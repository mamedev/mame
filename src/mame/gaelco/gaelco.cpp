...
GAME( 199?, squashb,   squash,   maniacsq, squash,   squash_state,   empty_init, ROT0, "Gaelco",        "Squash (newer PCB)",                                             MACHINE_NOT_WORKING | MACHINE_SUPPORTS_SAVE ) // Missing one program ROM
