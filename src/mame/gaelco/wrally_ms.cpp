...
{
	descramble_16x16tiles(memregion("gfx2")->base(), memregion("gfx1")->bytes());
	descramble_16x16tiles(memregion("gfx3")->base(), memregion("gfx2")->bytes());
	descramble_16x16tiles(memregion("gfx4")->base(), memregion("gfx2")->bytes());
	descramble_16x16tiles(memregion("gfx5")->base(), memregion("gfx2")->bytes());
}
...
ROM_START( wrallymp )
	...
	ROM_LOAD( "mod_5-1_52fx_gal16v8.ic8",       0x0000, 0x117, NO_DUMP )
	ROM_LOAD( "mod_5-1_51fx_gal16v8,ic9",       0x0000, 0x117, NO_DUMP )
	ROM_LOAD( "mod_6-esp-2_16fl_gal16v8as.u20", 0x0000, 0x117, NO_DUMP )
	ROM_LOAD( "mod_9-2_93so_gal16v8as.u10",     0x0000, 0x117, NO_DUMP )
	ROM_LOAD( "mod_9-2_91fl_gal16v8as.u42",     0x0000, 0x117, NO_DUMP )
	ROM_LOAD( "aud_oki_gal16v8as.bin",          0x0000, 0x117, NO_DUMP )
	ROM_LOAD( "mod_9-2_92fl_gal20v8as.ic18",    0x0000, 0x117, NO_DUMP )
ROM_END
