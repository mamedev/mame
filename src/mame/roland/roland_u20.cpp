...
void roland_u20_state::mem_map_u110(address_map &map)
{
...
void roland_u20_state::u110(machine_config &config)
{
	P8098(config, m_maincpu, 12_MHz_XTAL); // 8097BH
	m_maincpu->set_addrmap(AS_PROGRAM, &roland_u20_state::mem_map_u110);
...
ROM_START(u110)
	...
	ROMX_LOAD("roland_r15179960_lh531467.ic9", 0x00000, 0x20000, CRC(d5492e9b) SHA1(9d72b1688a173505b5e1c5ddac01efa78ee76c7f), ROM_BIOS(0)) // R15179960 LH531467 8921 E, marking under chip footprint: 27C512

	ROM_REGION(0x400000, "waverom", ROMREGION_ERASE00)
	ROM_LOAD("roland-a_r15179892f_mb834000a-20_226-aa.ic18", 0x000000, 0x080000, CRC(d5475560) SHA1(55d36199ea489969a729782afe4cbff5b1cede0e))
	// 0x080000 .. 0x0fffff is reserved for PCM card 1
	ROM_LOAD("roland-b_r15179893f_mb834000a-20_227-aa.ic19", 0x100000, 0x080000, CRC(43a5b26c) SHA1(8b8067fbc6fa7b2e8694a3785f123627ea458d1f))
	// 0x180000 .. 0x1fffff is reserved for PCM card 2
	ROM_LOAD("roland-c_r15179894f_mb834000a-20_228-aa.ic20", 0x200000, 0x080000, CRC(e79ee88a) SHA1(8dd9826d7d3e67b9a568eadeaaf7856a05f3e068))
	// 0x280000 .. 0x2fffff is reserved for PCM card 3
	ROM_LOAD("roland-d_r15179895f_mb834000a-20_229-aa.ic21", 0x300000, 0x080000, CRC(da9fbf6d) SHA1(35b98a0fb5cf643fb7b761a74581486eee3bd8c3))
...
ROM_START(u20)
	...
	ROM_LOAD("roland-a_r15179892f_mb834000a-20_226-aa.ic27", 0x000000, 0x080000, CRC(d5475560) SHA1(55d36199ea489969a729782afe4cbff5b1cede0e))
	ROM_LOAD("roland-e_r15179947_mb834000a-20_3a1-aa.ic31",  0x080000, 0x080000, CRC(104f3974) SHA1(71b6f97df6dd4e573db5743c10c77e86d67965a3))
	ROM_LOAD("roland-b_r15179893f_mb834000a-20_227-aa.ic28", 0x100000, 0x080000, CRC(43a5b26c) SHA1(8b8067fbc6fa7b2e8694a3785f123627ea458d1f))
	ROM_LOAD("roland-f_r15179948_mb834000a-20_3a2-aa.ic32",  0x180000, 0x080000, CRC(af1c2778) SHA1(aea715a0a554c071a2e912894805a8d819802e1d))
	ROM_LOAD("roland-c_r15179894f_mb834000a-20_228-aa.ic29", 0x200000, 0x080000, CRC(e79ee88a) SHA1(8dd9826d7d3e67b9a568eadeaaf7856a05f3e068))
	// 0x280000 .. 0x2fffff is reserved for PCM card 1
	ROM_LOAD("roland-d_r15179895f_mb834000a-20_229-aa.ic30", 0x300000, 0x080000, CRC(da9fbf6d) SHA1(35b98a0fb5cf643fb7b761a74581486eee3bd8c3))
...
ROM_START(u220)
	...
	ROM_REGION(0x400000, "waverom", ROMREGION_ERASE00)
	// TODO: figure out the proper order of the 0x#80000 ROMs.
	ROM_LOAD("roland-a_r15179892f_mb834000a-20_226-aa.ic19", 0x000000, 0x080000, CRC(d5475560) SHA1(55d36199ea489969a729782afe4cbff5b1cede0e))  // R15179892 62314BPD81 E22 0L1
	ROM_LOAD("roland-e_r15179947_mb834000a-20_3a1-aa.ic23",  0x080000, 0x080000, CRC(104f3974) SHA1(71b6f97df6dd4e573db5743c10c77e86d67965a3))  // R15179947H ?????????? ??? ???
	ROM_LOAD("roland-b_r15179893f_mb834000a-20_227-aa.ic20", 0x100000, 0x080000, CRC(43a5b26c) SHA1(8b8067fbc6fa7b2e8694a3785f123627ea458d1f))  // R15179893 62314BPD82 E23 1A1
	ROM_LOAD("roland-f_r15179948_mb834000a-20_3a2-aa.ic24",  0x180000, 0x080000, CRC(af1c2778) SHA1(aea715a0a554c071a2e912894805a8d819802e1d))  // R15179948H 62314BPD72 G87 0M1
	ROM_LOAD("roland-c_r15179894f_mb834000a-20_228-aa.ic21", 0x200000, 0x080000, CRC(e79ee88a) SHA1(8dd9826d7d3e67b9a568eadeaaf7856a05f3e068))  // R15179894 62314BPD83 E24 ???
	// 0x280000 .. 0x2fffff is reserved for PCM card 1
	ROM_LOAD("roland-d_r15179895f_mb834000a-20_229-aa.ic22", 0x300000, 0x080000, CRC(da9fbf6d) SHA1(35b98a0fb5cf643fb7b761a74581486eee3bd8c3))  // R15179895 62314BPD84 E25 0M1
	// 0x380000 .. 0x3fffff is reserved for PCM card 2
ROM_END
...
SYST(1988, u110, 0, 0, u110, u110, roland_u20_state, empty_init, "Roland", "U-110 PCM Sound Module", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
SYST(1989, u20,  0, 0, u20,   u20, roland_u20_state, empty_init, "Roland", "U-20 RS-PCM Keyboard", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
SYST(1989, u220, 0, 0, u220, u220, roland_u20_state, empty_init, "Roland", "U-220 RS-PCM Sound Module", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
