...
GAMEL(1979, cosmicbat,   invaders, invaders,  searthin,  invaders_state, empty_init,    ROT270, "bootleg (Recreativos Franco)",       "Cosmic Battle (Recreativos Franco bootleg of Space Invaders)",    MACHINE_SUPPORTS_SAVE | MACHINE_IMPERFECT_CONTROLS, layout_invaders )
