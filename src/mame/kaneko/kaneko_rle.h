...
#ifndef MAME_KANEKO_KANEKO_RLE_H
#define MAME_KANEKO_KANEKO_RLE_H
...
class kaneko_rle_device : public device_t, public device_video_interface, public device_rom_interface<27>
{
public:
	kaneko_rle_device(const machine_config &mconfig, const char *tag, device_t *owner, u32 clock);
...
DECLARE_DEVICE_TYPE(KANEKO_RLE, kaneko_rle_device)

#endif // MAME_KANEKO_KANEKO_RLE_H
