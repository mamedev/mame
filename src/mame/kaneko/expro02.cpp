...
static INPUT_PORTS_START( expro02 ) // TODO: at least for the 1994 version of New Fantasia running on the 940630 SWA and SWB should be inverted
	...
	PORT_DIPNAME( 0x0008, 0x0008, "Alternate Coinage" )  PORT_DIPLOCATION("SWB:4")
	PORT_DIPSETTING(      0x0008, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
	PORT_DIPNAME( 0x0030, 0x0030, DEF_STR( Coin_A ) )   PORT_DIPLOCATION("SWB:5,6")
	PORT_DIPSETTING(      0x0020, DEF_STR( 2C_1C ) )
	PORT_DIPSETTING(      0x0030, DEF_STR( 1C_1C ) )
	PORT_DIPSETTING(      0x0010, DEF_STR( 1C_2C ) ) PORT_CONDITION("DSW2", 0x0008, EQUALS, 0x0008)
	PORT_DIPSETTING(      0x0010, DEF_STR( 1C_3C ) ) PORT_CONDITION("DSW2", 0x0008, EQUALS, 0x0000)
	PORT_DIPSETTING(      0x0000, DEF_STR( 1C_6C ) ) PORT_CONDITION("DSW2", 0x0008, EQUALS, 0x0008)
	PORT_DIPSETTING(      0x0000, DEF_STR( 1C_4C ) ) PORT_CONDITION("DSW2", 0x0008, EQUALS, 0x0000)
	PORT_DIPNAME( 0x00c0, 0x00c0, DEF_STR( Coin_B ) )   PORT_DIPLOCATION("SWB:7,8")
	PORT_DIPSETTING(      0x0080, DEF_STR( 2C_1C ) )
	PORT_DIPSETTING(      0x00c0, DEF_STR( 1C_1C ) )
	PORT_DIPSETTING(      0x0040, DEF_STR( 1C_2C ) ) PORT_CONDITION("DSW2", 0x0008, EQUALS, 0x0008)
	PORT_DIPSETTING(      0x0040, DEF_STR( 1C_3C ) ) PORT_CONDITION("DSW2", 0x0008, EQUALS, 0x0000)
	PORT_DIPSETTING(      0x0000, DEF_STR( 1C_6C ) ) PORT_CONDITION("DSW2", 0x0008, EQUALS, 0x0008)
	PORT_DIPSETTING(      0x0000, DEF_STR( 1C_4C ) ) PORT_CONDITION("DSW2", 0x0008, EQUALS, 0x0000)
...
static INPUT_PORTS_START( fantasia )
	...
	PORT_START("DSW1")
	PORT_DIPNAME( 0x0001, 0x0001, DEF_STR( Unknown ) )  PORT_DIPLOCATION("SWA:1") //Manual says "Default Settings" OFF
	PORT_DIPSETTING(      0x0001, DEF_STR( Off ) ) 
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
	PORT_DIPNAME( 0x0002, 0x0002, DEF_STR( Unknown ) )  PORT_DIPLOCATION("SWA:2") //Manual says "Default Settings" OFF
	PORT_DIPSETTING(      0x0002, DEF_STR( Off ) ) 
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) ) //this setting make the game unplayable (graphic problems)
	PORT_SERVICE_DIPLOC( 0x0004, IP_ACTIVE_LOW, "SWA:3" )
	PORT_DIPNAME( 0x0008, 0x0008, "Alternate Coinage" )  PORT_DIPLOCATION("SWA:4")
	PORT_DIPSETTING(      0x0008, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
	...
	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_UP ) PORT_8WAY PORT_PLAYER(2) PORT_CONDITION("DSW2",0x000c,EQUALS,0x0004)
	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN ) PORT_8WAY PORT_PLAYER(2) PORT_CONDITION("DSW2",0x000c,EQUALS,0x0004)
	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT ) PORT_8WAY PORT_PLAYER(2) PORT_CONDITION("DSW2",0x000c,EQUALS,0x0004)
	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT ) PORT_8WAY PORT_PLAYER(2) PORT_CONDITION("DSW2",0x000c,EQUALS,0x0004)
	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_UP ) PORT_4WAY PORT_PLAYER(2) PORT_CONDITION("DSW2",0x000c,NOTEQUALS,0x0004)
	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN ) PORT_4WAY PORT_PLAYER(2) PORT_CONDITION("DSW2",0x000c,NOTEQUALS,0x0004)
	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT ) PORT_4WAY PORT_PLAYER(2) PORT_CONDITION("DSW2",0x000c,NOTEQUALS,0x0004)
	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT ) PORT_4WAY PORT_PLAYER(2) PORT_CONDITION("DSW2",0x000c,NOTEQUALS,0x0004)
	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON1 ) PORT_PLAYER(2)
	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON2 ) PORT_PLAYER(2)   /* "Shot2" in "test mode" */
	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNUSED )
	...
	PORT_START("DSW2")
	PORT_DIPNAME( 0x0003, 0x0003, DEF_STR( Difficulty ) )   PORT_DIPLOCATION("SWB:1,2")
	PORT_DIPSETTING(      0x0002, DEF_STR( Easy ) )
	PORT_DIPSETTING(      0x0003, DEF_STR( Normal ) )
	PORT_DIPSETTING(      0x0001, DEF_STR( Hard ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( Hardest ) )
	PORT_DIPNAME( 0x000c, 0x0004, "Draw a diagonal" )  PORT_DIPLOCATION("SWB:3,4")
	PORT_DIPSETTING(      0x000c, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0004, DEF_STR( On ) ) //Other combinations are undocumented in manual
	PORT_DIPNAME( 0x0030, 0x0030, DEF_STR( Lives ) )    PORT_DIPLOCATION("SWB:5,6")
	PORT_DIPSETTING(      0x0010, "2" )
	PORT_DIPSETTING(      0x0030, "3" )
	PORT_DIPSETTING(      0x0020, "4" )
	PORT_DIPSETTING(      0x0000, "5" )
	PORT_DIPNAME( 0x0040, 0x0040, DEF_STR( Demo_Sounds ) )  PORT_DIPLOCATION("SWB:7")
	PORT_DIPSETTING(      0x0000, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0040, DEF_STR( On ) )
	PORT_DIPNAME( 0x0080, 0x0080, "Unknown" )   PORT_DIPLOCATION("SWB:8")
	PORT_DIPSETTING(      0x0000, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0080, DEF_STR( On ) )

	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_UP ) PORT_8WAY PORT_PLAYER(1) PORT_CONDITION("DSW2",0x000c,EQUALS,0x0004)
	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN ) PORT_8WAY PORT_PLAYER(1) PORT_CONDITION("DSW2",0x000c,EQUALS,0x0004)
	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT ) PORT_8WAY PORT_PLAYER(1) PORT_CONDITION("DSW2",0x000c,EQUALS,0x0004)
	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT ) PORT_8WAY PORT_PLAYER(1) PORT_CONDITION("DSW2",0x000c,EQUALS,0x0004)
	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_UP ) PORT_4WAY PORT_PLAYER(1) PORT_CONDITION("DSW2",0x000c,NOTEQUALS,0x0004)
	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN ) PORT_4WAY PORT_PLAYER(1) PORT_CONDITION("DSW2",0x000c,NOTEQUALS,0x0004)
	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT ) PORT_4WAY PORT_PLAYER(1) PORT_CONDITION("DSW2",0x000c,NOTEQUALS,0x0004)
	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT ) PORT_4WAY PORT_PLAYER(1) PORT_CONDITION("DSW2",0x000c,NOTEQUALS,0x0004)
	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON1 ) PORT_PLAYER(1)
	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON2 ) PORT_PLAYER(1)   /* "Shot2" in "test mode" */
	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNUSED )
...
void expro02_state::fantasia_map(address_map &map)
{
	...
	map(0x800000, 0x800001).portr("DSW2");
	map(0x800002, 0x800003).portr("DSW1");
	map(0x800004, 0x800005).portr("SYSTEM");
...
void expro02_state::comad(machine_config &config)
{
	...
	m_view2->set_offset(0, 0, 256, 224);
