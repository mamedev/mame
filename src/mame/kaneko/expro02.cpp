...
static INPUT_PORTS_START( fantasia )
	...
	PORT_MODIFY("DSW1")
	PORT_DIPNAME(0x0004, 0x0000, DEF_STR(Unknown))  PORT_DIPLOCATION("SWA:3") //Manual says "Draw a diagonal" ON-OFF
	PORT_DIPSETTING(	  0x0004, DEF_STR(Off))
	PORT_DIPSETTING(	  0x0000, DEF_STR(On))
	PORT_DIPNAME(0x0008, 0x0008, DEF_STR(Unknown))  PORT_DIPLOCATION("SWA:4") //Manual says "Draw a diagonal" ON-OFF
	PORT_DIPSETTING(0x0008, DEF_STR(Off))
	PORT_DIPSETTING(0x0000, DEF_STR(On))
	PORT_DIPNAME( 0x0030, 0x0030, DEF_STR( Lives ) )    PORT_DIPLOCATION("SWA:5,6")
	PORT_DIPSETTING(      0x0010, "2" )
