...
static INPUT_PORTS_START( fantasia )
	...
	PORT_MODIFY("DSW1")
	PORT_DIPNAME( 0x000c, 0x0004, "Draw a diagonal" )  PORT_DIPLOCATION("SWA:3,4")
	...
	PORT_DIPSETTING(      0x0000, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0040, DEF_STR( On ) )
	PORT_DIPNAME( 0x0080, 0x0080, "Unknown" )   PORT_DIPLOCATION("SWA:8")
	PORT_DIPSETTING(      0x0000, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0080, DEF_STR( On ) )
	GALS_PANIC_JOYSTICK_8WAY(1)
		
	PORT_MODIFY("DSW2")
	PORT_DIPNAME( 0x0001, 0x0001, DEF_STR( Unknown ) )  PORT_DIPLOCATION("SWB:1") //Manual says "Default Settings" OFF
	PORT_DIPSETTING(      0x0001, DEF_STR( Off ) ) 
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
	PORT_DIPNAME( 0x0002, 0x0002, DEF_STR( Unknown ) )  PORT_DIPLOCATION("SWB:2") //Manual says "Default Settings" OFF
	PORT_DIPSETTING(      0x0002, DEF_STR( Off ) ) 
