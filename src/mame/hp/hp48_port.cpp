...
std::error_condition hp48_port_image_device::call_load()
{
	int size = length();
...
std::error_condition hp48_port_image_device::call_create(int format_type, util::option_resolution *format_options)
{
	int size = m_max_size;
