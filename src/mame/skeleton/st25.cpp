...
ROM_START(alphar)
	...
	ROM_REGION(0x20000, "onboard", ROMREGION_ERASEFF)
...
ROM_START(cttower)
	...
	ROM_RELOAD(0x100000, 0x80000)
	ROM_LOAD("m27c2001dip32_city_tower_0705.icf5", 0x80000, 0x40000, CRC(e4fbff9c) SHA1(f2081d43051e05ddc54879cf4080746eb8fa43f8))
...
ROM_START(mtclssic)
	ROM_REGION(0x20000, "coin", 0) // coin unit, not emulated yet
