...
ROM_START(blizzard)
	...
	ROM_REGION(0x40000, "maincpu", 0)
	ROM_LOAD("tms27c020dip32_blizzard_pgm_119438_170296.bin", 0x00000, 0x40000, CRC(7ff91608) SHA1(988335313141ca63d06abab6fd2542b167c5c04a))

	ROM_REGION(0x80000, "oki", 0)
	ROM_LOAD("tms27c020dip32_blizzard_snd_118999_090595.bin", 0x00000, 0x80000, CRC(4a609ee5) SHA1(a65aa3cb57f36c56d19cbc1116541dc4a320c6bc))
ROM_END
...
ROM_START(boostersp)
	...
	ROM_LOAD("m48t18_100pc1_zlk_ok_2033_2.bin", 0x00000, 0x02000, CRC(e8135250) SHA1(00e4f427911c29ffd478eef57c6db43ecda40eb2))

	ROM_REGION(0x80000, "oki", 0)
	ROM_LOAD("w27e040_booster_speed_st25_ic1", 0x00000, 0x80000, CRC(11c8eead) SHA1(2bac833eb0d894fa54c01311b7dbf35b16e1f984))
...
ROM_START(colossos)
	...
	ROM_REGION(0x80000, "oki", 0)
	ROM_LOAD("w27c40_ic1.bin", 0x00000, 0x80000, CRC(11c8eead) SHA1(2bac833eb0d894fa54c01311b7dbf35b16e1f984))

	ROM_REGION(0x80000, "maincpu", 0)
	ROM_LOAD("w27c40_ic2.bin", 0x00000, 0x80000, CRC(724d0d1e) SHA1(f8f1d78e101757afddbbe47b14c0c17ee77e800e))
ROM_END

ROM_START(galaktica)
	ROM_REGION(0x80000, "maincpu", 0)
	ROM_LOAD("galaktica_124460_ic2_w27e040_12.bin", 0x00000, 0x80000, CRC(a99c6250) SHA1(a9129eeec99c630b0a3e6355deedb86a1ae5062c))

	ROM_REGION(0x80000, "oki", 0)
	ROM_LOAD("galaktica_124461_ic1_w27e040_12.bin", 0x00000, 0x80000, CRC(0e8acf71) SHA1(184472d62e094a724cd21954459e872f8d1b30c8))
...
ROM_START(jamaica)
	ROM_REGION(0x80000, "oki", 0)
	ROM_LOAD("panther_jamaica_musik_st1.bin", 0x00000, 0x80000, CRC(7dee50d4) SHA1(1d96ee159b07db84c4f0373f5df4df648ecef786))

	ROM_REGION(0x80000, "maincpu", 0)
	ROM_LOAD("panther_jamaica_st2.bin", 0x00000, 0x80000, CRC(a7119368) SHA1(e50174bd7bb2ba00ab9fda3995007d60f0811242))
...
ROM_START(macaor)
	ROM_REGION(0x80000, "oki", 0)
	ROM_LOAD("123623_ic1_.bin", 0x00000, 0x80000, CRC(dccc242f) SHA1(9c0df10dc0028286a02dada673fa56bd6f137f67))

	ROM_REGION(0x80000, "maincpu", 0)
	ROM_LOAD("123742_ic3_.bin", 0x00000, 0x80000, CRC(3eeb68c3) SHA1(09f606988608dc89b1714347145b5b01352aa144))
...
ROM_START(matrixx)
	...
	ROM_REGION(0x02000, "nvram", 0)
	ROM_LOAD("tk_m48t18_100pc1.bin", 0x00000, 0x02000, CRC(675c3ac6) SHA1(11c97bf008b588ec415eeba830fdfabf8d0ce580))

	ROM_REGION(0x80000, "oki", 0)
	ROM_LOAD("winbondw27e040_12_ic1.bin", 0x00000, 0x80000, CRC(11c8eead) SHA1(2bac833eb0d894fa54c01311b7dbf35b16e1f984))

	ROM_REGION(0x80000, "maincpu", 0)
	ROM_LOAD("winbondw27e040_12_ic2.bin", 0x00000, 0x80000, CRC(6def28eb) SHA1(baab03b436277185aee806aff5f9d804a5bc4664))

	ROM_REGION(0x80000, "soundrom", 0)
	ROM_LOAD("winbondw27e040_12_sound_10_08_02.bin", 0x00000, 0x80000, CRC(2ccf9464) SHA1(02b16fe7465ad28ce96f38390fafbceafca2d23c))
ROM_END

ROM_START(multiclassic)
	ROM_REGION(0x02000, "nvram", 0)
	ROM_LOAD("m48t18_100pc1_l", 0x00000, 0x02000, CRC(5814553f) SHA1(7bcfe719f6305a19c0db3b95ab13c81a773b2a46))

	ROM_REGION(0x80000, "oki", 0)
	ROM_LOAD("w27e040_tsop32_123774_02.07.2004_ic1.bin", 0x00000, 0x80000, CRC(80d754c3) SHA1(b30d18a89d1e9d3dc54687d6a355a3a3d0957c5c))

	ROM_REGION(0x80000, "bp", 0)
	ROM_LOAD("w27e040_tsop32_123775_02.07.2004_back_panel_.bin", 0x00000, 0x80000, CRC(633d0f1e) SHA1(1ba518c5fb7367bf2a43b079a8f8b8db5c6fc5af))

	ROM_REGION(0x80000, "maincpu", 0)
	ROM_LOAD("w27e040_tsop32_123986_15.09.2004_ic2.bin", 0x00000, 0x80000, CRC(123e9290) SHA1(c252640ae166fba6b8b76474f3ad2162c0521e87))

	ROM_REGION(0x20000, "coin", 0)
	ROM_LOAD("w29ee011__191_043_v5.05_10.05.04__emp_nsm_euro.bin", 0x00000, 0x20000, CRC(079de5e5) SHA1(7f634769a5d9f56d6dae7a66e21b155b21787c36))
...
ROM_START(purpurr)
	...
	ROM_REGION(0x40000, "maincpu", 0)
	ROM_LOAD("pur_pur_royal_2804_w27e020.bin", 0x00000, 0x40000, CRC(f7058b6a) SHA1(ad307de9dc979e6c21237b893bb186fc75533b60))

	ROM_REGION(0x80000, "oki", 0)
	ROM_LOAD("pur_pur_royal_musik_m27c4001.bin", 0x00000, 0x80000, CRC(5d7f46d1) SHA1(5fe866c2fc13c8b8a1bd0e14f81a0f7fc3fd0c82))
ROM_END
...
ROM_START(robin)
	...
	ROM_REGION(0x40000, "maincpu", 0)
	ROM_LOAD("m27c2001_panther_robin_1705.bin", 0x00000, 0x40000, CRC(1e465f8d) SHA1(63cd069c867c54f24af893ec2d6ad36016b7e179))

	ROM_REGION(0x80000, "oki", 0)
	ROM_LOAD("m27c4001_panther_robin_musik.bin", 0x00000, 0x80000, CRC(0dcf91a7) SHA1(2e29b55c83bfd649dd92c087eeaa887676755e9f))
ROM_END
...
ROM_START(smaragd)
	...
	ROM_LOAD("115191_c5", 0x00000, 0x08000, CRC(346b91cb) SHA1(6bb7beaeef890ca7e0e322b5400e4257101c0c88))

	ROM_REGION(0x08000, "maincpu", 0)
	ROM_LOAD("115192_c6", 0x00000, 0x08000, CRC(6bc0009e) SHA1(a4a10ddd93517cb27be06901232f925f7cbcee52))
ROM_END
...
ROM_START(stakeoffe)
	...
	ROM_REGION(0x02000, "nvram", 0)
	ROM_LOAD("timekeeper_super_take_off_e__m48t18_100pc1", 0x00000, 0x02000, CRC(0091ed01) SHA1(3de7a61b145b50255b8374a537c31de505ede370))
...
ROM_START(tango)
	...
	ROM_REGION(0x40000, "maincpu", 0)
	ROM_LOAD("am27c020_nsm_tango_ic2.bin", 0x00000, 0x40000, CRC(7c0fec14) SHA1(9c2c463c9b39dd1167203c67fb6632d9379a37fe))

	ROM_REGION(0x80000, "oki", 0)
	ROM_LOAD("tms27c040_nsm_tango_ic1.bin", 0x00000, 0x80000, CRC(fee679c1) SHA1(c702d41805b05ccc50a2291eb30950a4be9a6e75))
ROM_END
...
ROM_START(tobago)
	...
	ROM_REGION(0x40000, "maincpu", 0)
	ROM_LOAD("27c2001_ic2", 0x00000, 0x40000, CRC(dc7e529b) SHA1(3bf7b3e0a27c808061c47515513fa6e76d26cd63))

	ROM_REGION(0x80000, "oki", 0)
	ROM_LOAD("27c4001_ic1", 0x00000, 0x80000, CRC(d1d6a78a) SHA1(bef512186af630f938d429c3db4d88ae9523272a))
ROM_END
...
ROM_START(xeno)
	...
	ROM_REGION(0x80000, "oki", 0)
	ROM_LOAD("w27e040_xeno_125227_ic1.bin", 0x00000, 0x80000, CRC(a37314b8) SHA1(b3bb3bacb6a12057b10f3f5e9a039924abf1d43d))

	ROM_REGION(0x80000, "maincpu", 0)
	ROM_LOAD("w27e040_xeno_125227_ic2.bin", 0x00000, 0x80000, CRC(349e38d1) SHA1(0e97ad119cf6864aee826da4c1d560094ff6f22d))

	ROM_REGION(0x80000, "soundrom", 0)
	ROM_LOAD("w27e040_xeno_125228_ic5.bin", 0x00000, 0x80000, CRC(f3475039) SHA1(62e7a132d88976249ec2c047bf47d39a60636ec9))
ROM_END
