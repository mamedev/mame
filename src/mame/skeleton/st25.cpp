...
void st25_state::io_map(address_map &map)
{
	...
	//map(0x50, 0x50).nopw();
	//map(0xe6, 0xe6).nopw();
	//map(0x9884, 0x9884).nopw();
	map(0x3000, 0x3001).nopw();
	//map(0x5000, 0x5000).nopw();
	//map(0xd000, 0xd000).nopw();
	//map(0xd002, 0xd002).nopw();
	//map(0xd003, 0xd003).nopw();
	//map(0xd004, 0xd004).nopw();
	//map(0xd005, 0xd005).nopw();
	//map(0xd00e, 0xd00e).nopw();
	//map(0xd00f, 0xd00f).nopw();
	...
	//map(0xa3, 0xa3).nopr();
	//map(0xae, 0xae).nopr();
	//map(0xa3ec, 0xa3ec).nopr();
	//map(0xd001, 0xd001).nopr();
	//map(0xd002, 0xd002).nopr();
	//map(0xd003, 0xd003).nopr();
	//map(0xd004, 0xd004).nopr();
	//map(0xd005, 0xd005).nopr();
	//map(0xd009, 0xd009).nopr();
	//map(0xd00a, 0xd00a).nopr();
	//map(0xd00b, 0xd00b).nopr();
	//map(0xd00d, 0xd00d).nopr();
	//map(0xfff8, 0xfff8).nopr();
	//map(0xfff9, 0xfff9).nopr();
}
