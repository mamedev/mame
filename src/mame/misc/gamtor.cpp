...
/***********************************************************************************************************************
   ...
   Main hardware:
     ...
     * 2 x Atmel ATF16V8 PLDs.
     * TI TL16C554A quadruple UART near a 8 MHz xtal.
     * 24C04 SEEPROM.
     * Custom Austrian Gaming Industries chip labeled "01800120  F0809D265".
     * Maxim MAX807LCWE.
...
ROM_START(gamtor_vga)
	ROM_REGION(0x117, "pld", 0)
	ROM_LOAD("ngc_vga_1a_atf16v8c.bin", 0x000, 0x117, BAD_DUMP CRC(e91d94db) SHA1(d24b873c9deb02f048a57b5b44290d361f500e5c)) // Bruteforced and untested
ROM_END

const tiny_rom_entry *gamtor_vga_device::device_rom_region() const
{
	return ROM_NAME(gamtor_vga);
}
...
#define COOLFIRE_BASE_ROMS \
	/* PLDs */ \
	ROM_REGION( 0x000117, "plds", ROMREGION_ERASEFF ) \
	ROM_LOAD( "mem3a_atf16v8c.bin",     0x000000, 0x000117, BAD_DUMP CRC(7672124a) SHA1(88b9afdf2180227d46dc0f079810ce18b85aef4e) ) /* Bruteforced and untested */ \
	ROM_LOAD( "mem3b_atf16v8c.bin",     0x000000, 0x000117, BAD_DUMP CRC(661cdd5b) SHA1(7a1b45e47fc39fc61a3b1cf95fd36f8cd7ddea97) ) /* Bruteforced and untested. mem3b is fairly complex so it might be registered */ \
	/* SEEPROM */ \
	ROM_REGION( 0x000200, "seeprom", ROMREGION_ERASEFF ) \
	ROM_LOAD( "m24c04.bin",             0x000000, 0x000200, CRC(2755ce6d) SHA1(96de86fe8bf26ca52a6b31fd0018650ff453c903) ) \
	/* TPM */ \
	ROM_REGION( 0x280000, "tpm", ROMREGION_ERASEFF ) \
	ROM_LOAD( "89c5131a_ul.bin",        0x000000, 0x008000, NO_DUMP ) /* USB MCU, 3-Kbyte Flash EEPROM for Bootloader + 1-Kbyte EEPROM Data */ \
	ROM_LOAD( "sc144144ct.bin",         0x000000, 0x280000, NO_DUMP ) /* Secure MCU, 144K Bytes of FLASH Program Memory + 144K Bytes of EEPROM + 32K Bytes of ROM Dedicated to Atmel's Crypto-library */ \
	ROM_LOAD( "tpm_fm24c04a.bin",       0x000000, 0x000200, CRC(5978d908) SHA1(0d7b29f0f2ee4cd7beb043edd7d81a9b6c231e64) ) /* Mostly empty */
