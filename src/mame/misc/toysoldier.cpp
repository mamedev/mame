...
//  map(0xe000, 0xe000).nopw(); // Super Card led
}
...
void toysoldier_state::toysoldier(machine_config &config)
{
    ...
    ay8910_device &ay(AY8910(config, "ay", XTAL(12'000'000) / 6)); 
...
GAME( 2003, toysoldier, 0,      toysoldier,  toysoldier,  toysoldier_state, empty_init, ROT0, "Paokai", "Toy Soldier (Coastal Amusements)", MACHINE_MECHANICAL | MACHINE_NOT_WORKING | MACHINE_IMPERFECT_SOUND ) // This was dumped from an Coastal branded Toy Soldier around 2003.
