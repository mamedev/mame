...
GAME( 2003, maski,     0,        extrema, extrema, extrema_state, init_maski,    ROT0, "Extrema", "Maski Show (Ukraine V. 43.10)",                MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
GAME( 2003, maskia,    maski,    extrema, extrema, extrema_state, init_maski,    ROT0, "Extrema", "Maski Show (Ukraine V. 43.07)",                MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
GAME( 2003, maskib,    maski,    extrema, extrema, extrema_state, init_maski,    ROT0, "Extrema", "Maski Show (Ukraine V. 42.11)",                MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
GAME( 2003, maskic,    maski,    extrema, extrema, extrema_state, init_maski,    ROT0, "Extrema", "Maski Show (Ukraine V. 42.05)",                MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
GAME( 2003, adults,    0,        extrema, extrema, extrema_state, init_adults,   ROT0, "Extrema", "Adults Only (Ukraine, V. 43.23)",              MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
GAME( 2003, adultsa,   adults,   extrema, extrema, extrema_state, init_adults,   ROT0, "Extrema", "Adults Only (Ukraine, V. 43.17)",              MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
GAME( 200?, bloto,     0,        extrema, extrema, extrema_state, init_bloto,    ROT0, "Extrema", "Blits Loto (Ukraine, V. 30.16)",               MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
GAME( 200?, blotoa,    bloto,    extrema, extrema, extrema_state, init_bloto,    ROT0, "Extrema", "Blits Loto (Ukraine, V. 30.08)",               MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
GAME( 2003, blpearl,   0,        extrema, extrema, extrema_state, init_blpearl,  ROT0, "Extrema", "Black Pearl (Ukraine, V. 45.02)",              MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
GAME( 2003, blpearla,  blpearl,  extrema, extrema, extrema_state, init_blpearl,  ROT0, "Extrema", "Black Pearl (Ukraine, V. 43.07)",              MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
GAME( 2003, blpearlb,  blpearl,  extrema, extrema, extrema_state, init_blpearl,  ROT0, "Extrema", "Black Pearl (Ukraine, V. 43.04)",              MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
GAME( 2003, blpearlc,  blpearl,  extrema, extrema, extrema_state, init_blpearl,  ROT0, "Extrema", "Black Pearl (Ukraine, V. 42.03)",              MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
GAME( 2003, blpearld,  blpearl,  extrema, extrema, extrema_state, init_blpearl,  ROT0, "Extrema", "Black Pearl (Ukraine, V. 42.01)",              MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
GAME( 2003, grancan,   0,        extrema, extrema, extrema_state, init_grancan,  ROT0, "Extrema", "Grand Canyon (Ukraine, V. 43.09)",             MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
GAME( 2003, grancana,  grancan,  extrema, extrema, extrema_state, init_grancan,  ROT0, "Extrema", "Grand Canyon (Ukraine, V. 43.05)",             MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
GAME( 2003, grancanb,  grancan,  extrema, extrema, extrema_state, init_grancan,  ROT0, "Extrema", "Grand Canyon (Ukraine, V. 42.13)",             MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
GAME( 2003, grancanc,  grancan,  extrema, extrema, extrema_state, init_grancan,  ROT0, "Extrema", "Grand Canyon (Ukraine, V. 42.06)",             MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
GAME( 2003, luckshel,  0,        extrema, extrema, extrema_state, init_luckshel, ROT0, "Extrema", "Lucky Shell (Ukraine, V. 42.25)",              MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
GAME( 2003, luckshela, luckshel, extrema, extrema, extrema_state, init_luckshel, ROT0, "Extrema", "Lucky Shell (Ukraine, V. 42.10)",              MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
GAME( 2003, exsafar,   0,        extrema, extrema, extrema_state, init_exsafar,  ROT0, "Extrema", "Safari (Extrema, Ukraine, V. 43.14)",          MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
GAME( 2003, exsafara,  exsafar,  extrema, extrema, extrema_state, init_exsafar,  ROT0, "Extrema", "Safari (Extrema, Ukraine, V. 43.08)",          MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
GAME( 2003, exsafarb,  exsafar,  extrema, extrema, extrema_state, init_exsafar,  ROT0, "Extrema", "Safari (Extrema, Ukraine, V. 42.07)",          MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
GAME( 2003, exsafarc,  exsafar,  extrema, extrema, extrema_state, init_exsafar,  ROT0, "Extrema", "Safari (Extrema, Ukraine, V. 42.04)",          MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
GAME( 2004, strlink,   0,        extrema, extrema, extrema_state, init_strlink,  ROT0, "Extrema", "Strong Link (Ukraine, V. 43.48)",              MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
GAME( 2004, strlinka,  strlink,  extrema, extrema, extrema_state, init_strlink,  ROT0, "Extrema", "Strong Link (Ukraine, V. 43.45)",              MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
GAME( 200?, extrmth,   0,        extrema, extrema, extrema_state, init_extrmth,  ROT0, "Extrema", "Treasure Hunt (Extrema, Ukraine, V. 34.03)",   MACHINE_NO_SOUND | MACHINE_NOT_WORKING ) // other string has it as 3.4.03
GAME( 200?, extrmtha,  extrmth,  extrema, extrema, extrema_state, init_extrmth,  ROT0, "Extrema", "Treasure Hunt (Extrema, Ukraine, V. 34.02)",   MACHINE_NO_SOUND | MACHINE_NOT_WORKING ) // other string has it as 3.4.02
GAME( 200?, extrmti,   0,        extrema, extrema, extrema_state, init_extrmti,  ROT0, "Extrema", "Treasure Island (Extrema, Ukraine, V. 32.49)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING ) // other string has it as 3.2.49
