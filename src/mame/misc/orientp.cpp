...
void orientalpearl_state::orientp(machine_config &config)
{
	...
	i8051_device &maincpu(I80C51(config, "mcu", XTAL(10'738'000)));
	maincpu.set_addrmap(AS_PROGRAM, &orientalpearl_state::mcu_map);
	maincpu.set_addrmap(AS_IO, &orientalpearl_state::mcu_io_map);
...
ROM_START( east8 )
    ...
    ROM_LOAD( "at89s51.u39", 0x0000, 0x1000, BAD_DUMP CRC(a55b63a8) SHA1(9ef88bba4a46ccd969d80882e9c36eb2f0c9e4bf) ) //  Microcontroller Protection. Read Unprotected, Wrong
