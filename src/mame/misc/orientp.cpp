...
ROM_START( east8a )
    ...
    ROM_REGION( 0x1000, "mcu", 0 )
    ROM_LOAD( "at89s51.u39", 0x0000, 0x1000, BAD_DUMP CRC(a55b63a8) SHA1(9ef88bba4a46ccd969d80882e9c36eb2f0c9e4bf) ) //  Microcontroller Protection. From the set 2. Marked as Bad dump for now
 
    ROM_REGION( 0x40000, "oki", ROMREGION_ERASE00 )
    ROM_LOAD( "w27c020.bin", 0x00000, 0x40000, CRC(f962ed1c) BAD_DUMP SHA1(c69cd9619c794e77a0122fc82d36662494ceb0be) ) //  Voices Rom.  From the set 1. Marked as Bad dump for now
