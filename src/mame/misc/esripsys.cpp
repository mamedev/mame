...
ROM_START( turbosubb8 )
	...
	ROM_REGION( 0xc000, "sound_data", 0)
	ROM_LOAD( "turbosub.u69", 0x0000, 0x4000, CRC(6dda8721) SHA1(c69e2ef1527559bc6d54a954c6b623bff832006c) )
	ROM_LOAD( "turbosub.u68", 0x4000, 0x4000, CRC(db86b699) SHA1(69059305f5650fc94bccd22c1486417554ac9c41) )
	ROM_LOAD( "turbosub.u67", 0x8000, 0x4000, CRC(bff729ea) SHA1(b95e37737a1dc8480c32e8abeff36b7b56fa12a1) )

	ROM_REGION( 0x40000, "4bpp", 0)
	ROM_LOAD( "turbosub.u44", 0x00000, 0x4000, CRC(bc1f9dea) SHA1(a581b8c75c08f73571c98122c0c0b3e05757db84) )
	ROM_LOAD( "turbosub.u49", 0x10000, 0x4000, CRC(4f512477) SHA1(c91d44f6259dca0e28f21bccce3e68906a31695d) )
	ROM_LOAD( "turbosub.u54", 0x20000, 0x4000, CRC(6d811d60) SHA1(b8945e9a975ada89053f482a8ec0320ac659238a) )
	ROM_LOAD( "turbosub.u59", 0x30000, 0x4000, CRC(0500f3d0) SHA1(459c45d4d552c02cabf9b1e1d927415b9b04ff32) )

	ROM_LOAD( "turbosub.u43", 0x04000, 0x4000, CRC(38fa7f84) SHA1(d4f7d42742e265973a40094657011cff201cbbe7) )
	ROM_LOAD( "turbosub.u48", 0x14000, 0x4000, CRC(e2b73a98) SHA1(e46158e4730f3d7f83e322680e4e5abf4c866af8) )
	ROM_LOAD( "turbosub.u53", 0x24000, 0x4000, CRC(cb2100a8) SHA1(cc7e646b2fb66e685fb2d1bf86ec2fc84358c431) )
	ROM_LOAD( "turbosub.u58", 0x34000, 0x4000, CRC(255df9d9) SHA1(aa89ffe4f0780977f829b27c35d2c34806450ebf) )

	ROM_LOAD( "turbosub.u42", 0x08000, 0x4000, CRC(00bfe74c) SHA1(314a6ed28d07e24d56eeef43f550f4bdf4cc789a) )
	ROM_LOAD( "turbosub.u47", 0x18000, 0x4000, CRC(eabc8e08) SHA1(44097f6320417f9538dcee45dec4d0402e4d8ab9) )
	ROM_LOAD( "turbosub.u52", 0x28000, 0x4000, CRC(e81f381f) SHA1(eae0fd3e14b32e8a32c656090e5bbb7dc55ab256) )
	ROM_LOAD( "turbosub.u57", 0x38000, 0x4000, CRC(76880da6) SHA1(ebbe4a1f84d441172984750c7b66c1a13fe736cc) )

	ROM_LOAD( "turbosub.u41", 0x0c000, 0x4000, CRC(93210509) SHA1(9dd1a850bf75349f6f11c51ccea21d28dd2a1251) )
	ROM_LOAD( "turbosub.u46", 0x1c000, 0x4000, CRC(e8f23e3e) SHA1(e2d95e7cbad46fd20d19592de0c6d26e5e7073e3) )
	ROM_LOAD( "turbosub.u51", 0x2c000, 0x4000, CRC(88fb898c) SHA1(e0b73a909104a64195a58394c21834266ad48744) )
	ROM_LOAD( "turbosub.u56", 0x3c000, 0x4000, CRC(9398c41a) SHA1(84730b1e9b489b35df14fc55367f5647ee29b57a) )

	ROM_REGION( 0x40000, "8bpp_l", 0)
	ROM_LOAD( "turbosub.u4",  0x00000, 0x4000, CRC(41178df4) SHA1(b0c14def4f0f11678345eedd05be02e1b636e32a) )
	ROM_LOAD( "turbosub.u14", 0x10000, 0x4000, CRC(7ca6ea75) SHA1(e8d21a7e8e28736b0e876571794ea64721bde7a5) )
	ROM_LOAD( "turbosub.u24", 0x20000, 0x4000, CRC(d73de17f) SHA1(91608fc137f1f1383e55d3e02c10b0627677af57) )
	ROM_LOAD( "turbosub.u34", 0x30000, 0x4000, CRC(383978eb) SHA1(99a4cf9abd987692e962ac267d7446fadea04a61) )

	ROM_LOAD( "turbosub.u3",  0x04000, 0x4000, CRC(7d43d0d9) SHA1(06da1ccc079328841e9275fb8a6529598f978b1a) )
	ROM_LOAD( "turbosub.u13", 0x14000, 0x4000, CRC(af47888e) SHA1(8a95432c40620d31a2812b38059a38785101767a) )
	ROM_LOAD( "turbosub.u23", 0x24000, 0x4000, CRC(cc6250fc) SHA1(5dcf148d4eae4b76d2402f93dd2c740ac35365ed) )
	ROM_LOAD( "turbosub.u33", 0x34000, 0x4000, CRC(76352bb4) SHA1(9ef653b25b0bdc36e8b2b5e162a965373a47fed6) )

	ROM_LOAD( "turbosub.u2",  0x08000, 0x4000, CRC(f379b9d6) SHA1(3456b51372a184c102bd9e67a88c152f00cc5b75) )
	ROM_LOAD( "turbosub.u12", 0x18000, 0x4000, CRC(781be78a) SHA1(4fd30559e15f1c5bedfd267e0a8f496a67365eeb) )
	ROM_LOAD( "turbosub.u22", 0x28000, 0x4000, CRC(9665210b) SHA1(41af3357b242bcddf0fa81b9dbcce93d51117177) )
	ROM_LOAD( "turbosub.u32", 0x38000, 0x4000, CRC(3139bcaa) SHA1(cd5410d5ed72a7daa686ef8b79b0aab4a6029d9a) )

	ROM_LOAD( "turbosub.u1",  0x0c000, 0x4000, CRC(0f82059a) SHA1(6fcaa5a85f63a7fbe7a775349fa45d1de86664b6) )
	ROM_LOAD( "turbosub.u11", 0x1c000, 0x4000, CRC(fb9957ea) SHA1(636a118500f531408144ec6bdd06f6ab124f70b3) )
	ROM_LOAD( "turbosub.u21", 0x2c000, 0x4000, CRC(2fe2dea4) SHA1(74f3ac4159b488a8908a70e486d8f19729c1cc6e) )
	ROM_LOAD( "turbosub.u31", 0x3c000, 0x4000, CRC(ec2fc941) SHA1(996856127a54c81944c0b5615affe6ab9ffd1c25) )

	ROM_REGION( 0x40000, "8bpp_r", 0)
	ROM_LOAD( "turbosub.u9",  0x00000, 0x4000, CRC(8efe1d3b) SHA1(47671be16922177fa78325ffeccdf09326b66298) )
	ROM_LOAD( "turbosub.u19", 0x10000, 0x4000, CRC(aedfadf8) SHA1(b85706af6ea4d604671345016d8101979311e7f6) )
	ROM_LOAD( "turbosub.u29", 0x20000, 0x4000, CRC(6e33feca) SHA1(5c6dfef9788712afcef2f8d53c816103f58b877d) )
	ROM_LOAD( "turbosub.u39", 0x30000, 0x4000, CRC(6bd55a6e) SHA1(4c7dacfd58fc8e308b758ebe1f36254b061d3fa8) )

	ROM_LOAD( "turbosub.u8",  0x04000, 0x4000, CRC(0fe731d0) SHA1(81fe7b499947b9aa11f5ff68ae8433ca1fd64776) )
	ROM_LOAD( "turbosub.u18", 0x14000, 0x4000, CRC(5e5dfcc6) SHA1(20a43917093fb7639b1cbe91623a5072addd2926) )
	ROM_LOAD( "turbosub.u28", 0x24000, 0x4000, CRC(a132c340) SHA1(0bc8dda5b184a784b42a67e9a23bb9a2894a4c4f) )
	ROM_LOAD( "turbosub.u38", 0x34000, 0x4000, CRC(d6bd41ea) SHA1(95cf80b5b717aba974ac025fa4e5d70cb68b3243) )

	ROM_LOAD( "turbosub.u7",  0x08000, 0x4000, CRC(ba1cec21) SHA1(3b375a654c443787fa30a9dc9e34e4586d32a303) )
	ROM_LOAD( "turbosub.u17", 0x18000, 0x4000, CRC(7b0bee27) SHA1(1958c4b8a12bdda90b93bc67e16ba23f8f0313bb) )
	ROM_LOAD( "turbosub.u27", 0x28000, 0x4000, CRC(393ce06e) SHA1(e45d9f71667b133310e23976ddc55c5d50639edf) )
	ROM_LOAD( "turbosub.u37", 0x38000, 0x4000, CRC(b3455eeb) SHA1(733ab1f43d463946399b7f4df6d393ccd40409f1) )

	ROM_LOAD( "turbosub.u6",  0x0c000, 0x4000, CRC(11b91b26) SHA1(abb114c489eebefbbb6653178f4d4f7235d7710a) )
	ROM_LOAD( "turbosub.u16", 0x1c000, 0x4000, CRC(1e36ac5e) SHA1(e32525dc66d974d68cde51471f6943fff78d07d3) )
	ROM_LOAD( "turbosub.u26", 0x2c000, 0x4000, CRC(2603a199) SHA1(8863ae79a227d763135b75467345027efd59590a) )
	ROM_LOAD( "turbosub.u36", 0x3c000, 0x4000, CRC(87f7cd28) SHA1(59f3cf5bc7c8278aae29b9a3da3b41ec1900065d) )
