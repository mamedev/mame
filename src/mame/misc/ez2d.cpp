...
- Needs AS99127F emulation on SMBus/ACPI to proceed;
...
ROM_START( asuscubx )
	ROM_REGION32_LE(0x40000, "pci:04.0", 0)
...
GAME( 2001, ez2d2m,   0,      ez2d, 0, ez2d_state, empty_init, ROT0, "Amuse World", "Ez2dancer 2nd Move", MACHINE_NOT_WORKING | MACHINE_NO_SOUND )
