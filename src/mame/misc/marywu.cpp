...
static INPUT_PORTS_START( marywu )
    ...
    PORT_BIT(0x80, IP_ACTIVE_LOW,  IPT_GAMBLE_KEYOUT) PORT_IMPULSE(01)  PORT_NAME("P1.7")PORT_CODE(KEYCODE_V)  // Key out? If press during gameplay, it will cause error 30. If press during startup, it will cause error 76.
INPUT_PORTS_END
