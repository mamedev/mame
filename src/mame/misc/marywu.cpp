...
static INPUT_PORTS_START( mary1s )
	...
	PORT_BIT(0x40, IP_ACTIVE_HIGH, IPT_BUTTON5) PORT_CODE(KEYCODE_L) // Hopper SW  P1.6. if IP_ACTIVE_LOW  will cause error 30
	PORT_BIT(0x80, IP_ACTIVE_LOW,  IPT_BUTTON6) PORT_CODE(KEYCODE_Z) // 洗分 SW    P1.7. if IP_ACTIVE_HIGH will cause error 76.
INPUT_PORTS_END	
