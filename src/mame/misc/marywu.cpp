...
/*************************************************************************
  ...
  * Add	coin acceptor, hopper sensor, electromechanical counters IN and OUT.
  * Error 30, Currently bypassed but after start will cause error 02.
...
static INPUT_PORTS_START( marywu )
	...
	PORT_START("KEYS2")
	PORT_BIT(0x80, IP_ACTIVE_HIGH,  IPT_COIN1) PORT_CODE(KEYCODE_5)  // dsp9. if IP_ACTIVE_LOW will cause error 30.
