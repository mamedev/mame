...
static INPUT_PORTS_START( bsuprem )
	...
	PORT_BIT(0x04, IP_ACTIVE_LOW, IPT_CUSTOM) PORT_READ_LINE_DEVICE_MEMBER("hopper_25", FUNC(ticket_dispenser_device::line_r))
	PORT_BIT(0x08, IP_ACTIVE_LOW, IPT_CUSTOM) PORT_READ_LINE_DEVICE_MEMBER("hopper_100", FUNC(ticket_dispenser_device::line_r))
	PORT_BIT(0x10, IP_ACTIVE_LOW, IPT_COIN1)
	PORT_BIT(0x20, IP_ACTIVE_LOW, IPT_CUSTOM) PORT_READ_LINE_DEVICE_MEMBER("hopper_5", FUNC(ticket_dispenser_device::line_r))
	PORT_BIT(0x40, IP_ACTIVE_LOW, IPT_UNUSED)
