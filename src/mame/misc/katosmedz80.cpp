...
***************************************************************************************************
  ...
  |                    IC1        IC7                 IC9                                                   |
  !    ............   .-------.  .---------------.   .-----.     .-------------------------.    .-----.     |
  |      CN3(12)      |  NEC  |  | G25 V         |   | OKI |     | SHARP LH0080B           |    |XTAL |     |
  | :CN4(2)           |UPC2002|  |    27C1000-15 |   |M6295|     | IC16           Z80B-CPU |    |12MHz|     |
  |                   '-------'  '---------------'   '-----'     '-------------------------'    '-----'     |
  | :                             IC8        .-----------------------.  .---------------.     .----------.  |
  | :CN5                (VR1)    .---------. | NEC D71055C           |  | G25 A         | IC20| 74HCU04  |  |
  | :(7)                         | 74HC574 | |                  IC10 |  | IC17   27C256 |     +----------+  |
  | :                            '---------' '-----------------------'  '---------------' IC21| 74HC4040 |  |
  | :          IC2                               IC11        IC13                             '----------'  |
  |           .---.    .---------------------.  .--------.  .---------.  .--------------.     .----------.  |
