...
ROM_START(plycntre3)
	...
	DISK_IMAGE("playcenter_e_14_0_t", 0, SHA1(b7c7fce1522e64fc5132f223d8a73555c24002a9)) // From an operator, may contain user data. Contains a BIOS for a Trident card (C:\videorom.bin), probably a Trident Blade 3D (PICR 1023:9880)
ROM_END
