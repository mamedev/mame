...
GAMEL(1985, pbactiont,  pbaction, pbactiont, pbaction, pbaction_tecfri_state, empty_init,     ROT90, "Tehkan (Tecfri license)", "Pinball Action (Tecfri license, set 1, with external display)",    MACHINE_SUPPORTS_SAVE, layout_pbactiont )
GAME( 1985, pbactiont2, pbaction, pbaction,  pbaction, pbaction_state,        empty_init,     ROT90, "Tehkan (Tecfri license)", "Pinball Action (Tecfri license, set 2, without external display)", MACHINE_SUPPORTS_SAVE )
