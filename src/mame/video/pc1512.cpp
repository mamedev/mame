...
uint8_t pc1512_state::video_ram_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	uint8_t data = 0;
...
void pc1512_state::video_ram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	switch (get_display_mode(m_vdu_mode))
	{
	case ALPHA_40:
...
uint8_t pc1512_state::vdu_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	uint8_t data = 0;
...
void pc1512_state::vdu_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	switch (offset)
	{
