...
uint16_t gradius3_state::gradius3_gfxrom_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	return (m_gfxrom[2 * offset + 1] << 8) | m_gfxrom[2 * offset];
}

void gradius3_state::gradius3_gfxram_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
