...
void ssrj_state::vram1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_vram1[offset] = data;
...
void ssrj_state::vram2_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_vram2[offset] = data;
...
void ssrj_state::vram4_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_vram4[offset] = data;
