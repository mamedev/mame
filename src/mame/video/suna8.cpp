...
uint8_t suna8_state::banked_paletteram_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	offset += m_palettebank * 0x200;
	return m_banked_paletteram[offset];
}

uint8_t suna8_state::suna8_banked_spriteram_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	offset += m_spritebank * 0x2000;
	return m_spriteram[offset];
}

void suna8_state::suna8_spriteram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void suna8_state::suna8_banked_spriteram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	offset += m_spritebank * 0x2000;
	m_spriteram[offset] = data;
#if TILEMAPS
...
*/
void suna8_state::brickzn_banked_paletteram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
