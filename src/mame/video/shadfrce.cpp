...
void shadfrce_state::fgvideoram_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void shadfrce_state::bg0videoram_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void shadfrce_state::bg1videoram_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void shadfrce_state::bg0scrollx_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	m_bg0tilemap->set_scrollx(0, data & 0x1ff );
}

void shadfrce_state::bg0scrolly_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	m_bg0tilemap->set_scrolly(0, data  & 0x1ff );
}

void shadfrce_state::bg1scrollx_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	m_bg1tilemap->set_scrollx(0, data  & 0x1ff );
}

void shadfrce_state::bg1scrolly_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
