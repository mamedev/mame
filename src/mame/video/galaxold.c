...
PALETTE_INIT_MEMBER(galaxold_state,galaxold)
{
	...
	palette.set_pen_color(BULLETS_COLOR_BASE+0,MAKE_RGB(0xef,0xef,0x00));
	palette.set_pen_color(BULLETS_COLOR_BASE+1,MAKE_RGB(0xef,0xef,0xef));
}
...
PALETTE_INIT_MEMBER(galaxold_state,scrambold)
{
	...
	palette.set_pen_color(BACKGROUND_COLOR_BASE,MAKE_RGB(0,0,0x56));
}
...
PALETTE_INIT_MEMBER(galaxold_state,darkplnt)
{
	...
	palette.set_pen_color(BULLETS_COLOR_BASE+0,MAKE_RGB(0xef,0x00,0x00));
	palette.set_pen_color(BULLETS_COLOR_BASE+1,MAKE_RGB(0x00,0x00,0xef));
}
