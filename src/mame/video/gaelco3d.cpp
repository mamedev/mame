...
void gaelco3d_state::gaelco3d_render_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
...
void gaelco3d_state::gaelco3d_paletteram_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void gaelco3d_state::gaelco3d_paletteram_020_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	m_poly->wait("Palette change");
