...
uint16_t harddriv_state::hdgsp_control_lo_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	return m_gsp_control_lo[offset];
}


void harddriv_state::hdgsp_control_lo_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
uint16_t harddriv_state::hdgsp_control_hi_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	return m_gsp_control_hi[offset];
}


void harddriv_state::hdgsp_control_hi_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	int val = (offset >> 3) & 1;
...
uint16_t harddriv_state::hdgsp_vram_2bpp_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	return 0;
}


void harddriv_state::hdgsp_vram_1bpp_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void harddriv_state::hdgsp_vram_2bpp_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
uint16_t harddriv_state::hdgsp_paletteram_lo_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
void harddriv_state::hdgsp_paletteram_lo_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	/* note that the palette is only accessed via the first 256 entries */
	/* others are selected via the palette bank */
	offset = m_gfx_palettebank * 0x100 + (offset & 0xff);
...
uint16_t harddriv_state::hdgsp_paletteram_hi_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	/* note that the palette is only accessed via the first 256 entries */
	/* others are selected via the palette bank */
	offset = m_gfx_palettebank * 0x100 + (offset & 0xff);
...
void harddriv_state::hdgsp_paletteram_hi_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	/* note that the palette is only accessed via the first 256 entries */
	/* others are selected via the palette bank */
	offset = m_gfx_palettebank * 0x100 + (offset & 0xff);
