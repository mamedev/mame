...
public:
	...
	uint32_t id_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	uint32_t revision_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	uint32_t softreset_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void softreset_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	void startrender_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t param_base_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void param_base_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t region_base_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void region_base_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t vo_border_col_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void vo_border_col_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t fb_r_ctrl_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void fb_r_ctrl_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t fb_w_ctrl_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void fb_w_ctrl_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t fb_w_linestride_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void fb_w_linestride_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t fb_r_sof1_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void fb_r_sof1_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t fb_r_sof2_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void fb_r_sof2_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t fb_r_size_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void fb_r_size_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t fb_w_sof1_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void fb_w_sof1_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t fb_w_sof2_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void fb_w_sof2_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t fb_x_clip_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void fb_x_clip_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t fb_y_clip_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void fb_y_clip_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t fpu_param_cfg_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void fpu_param_cfg_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t isp_backgnd_t_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void isp_backgnd_t_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t spg_hblank_int_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void spg_hblank_int_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t spg_vblank_int_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void spg_vblank_int_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t spg_control_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void spg_control_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t spg_hblank_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void spg_hblank_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t spg_load_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void spg_load_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t spg_vblank_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void spg_vblank_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t spg_width_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void spg_width_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t text_control_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void text_control_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t vo_control_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void vo_control_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t vo_startx_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void vo_startx_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t vo_starty_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void vo_starty_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t pal_ram_ctrl_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void pal_ram_ctrl_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t spg_status_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);

	uint32_t ta_ol_base_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void ta_ol_base_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t ta_isp_base_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void ta_isp_base_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t ta_ol_limit_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void ta_ol_limit_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t ta_isp_limit_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void ta_isp_limit_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t ta_next_opb_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	uint32_t ta_itp_current_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	uint32_t ta_alloc_ctrl_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void ta_alloc_ctrl_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t ta_list_init_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void ta_list_init_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t ta_yuv_tex_base_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void ta_yuv_tex_base_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t ta_yuv_tex_ctrl_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void ta_yuv_tex_ctrl_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t ta_yuv_tex_cnt_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void ta_yuv_tex_cnt_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	void ta_list_cont_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t ta_next_opb_init_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void ta_next_opb_init_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);


	uint32_t fog_table_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void fog_table_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t palette_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void palette_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);

	uint32_t sb_pdstap_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void sb_pdstap_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t sb_pdstar_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void sb_pdstar_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t sb_pdlen_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void sb_pdlen_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t sb_pddir_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void sb_pddir_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t sb_pdtsel_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void sb_pdtsel_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t sb_pden_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void sb_pden_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t sb_pdst_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void sb_pdst_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t sb_pdapro_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void sb_pdapro_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);

	uint32_t pvr2_ta_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void pvr2_ta_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	void pvrs_ta_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t elan_regs_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void elan_regs_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	void ta_fifo_poly_w(address_space &space, offs_t offset, uint64_t data, uint64_t mem_mask = U64(0xffffffffffffffff));
	void ta_fifo_yuv_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
