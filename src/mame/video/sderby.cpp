...
void sderby_state::sderby_videoram_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void sderby_state::sderby_md_videoram_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void sderby_state::sderby_fg_videoram_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void sderby_state::sderby_scroll_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
