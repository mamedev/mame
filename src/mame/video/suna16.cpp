...
void suna16_state::flipscreen_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void suna16_state::bestbest_flipscreen_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	if (ACCESSING_BITS_0_7)
	{
...
uint16_t suna16_state::paletteram_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	return m_paletteram[offset + m_color_bank * 256];
}

void suna16_state::paletteram_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
