...
UINT32 galspnbl_state::screen_update_galspnbl(screen_device &screen, bitmap_ind16 &bitmap, const rectangle &cliprect)
{
	...
	m_sprgen->galspnbl_draw_sprites(screen, m_gfxdecode, bitmap, cliprect, 0,  m_spriteram, m_spriteram.bytes());
...
//                  16*sx + screenscroll,8*sy,
	...
	m_sprgen->galspnbl_draw_sprites(screen, m_gfxdecode, bitmap, cliprect, 1, m_spriteram, m_spriteram.bytes());
	return 0;
}
