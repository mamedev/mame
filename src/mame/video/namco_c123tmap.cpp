...
void namco_c123tmap_device::c123_tilemap_invalidate(void)
{
	for (int i = 0; i < 6; i++)
	{
...
void namco_c123tmap_device::c123_tilemap_init(int gfxbank, void *maskBaseAddr, c123_tilemap_delegate tilemap_cb)
{
	...
	m_c123_TilemapInfo.tmap[0] = &machine().tilemap().create(*m_gfxdecode, tilemap_get_info_delegate(FUNC(namco_c123tmap_device::get_tile_info<0x0000>), this), TILEMAP_SCAN_ROWS, 8, 8, 64, 64);
	m_c123_TilemapInfo.tmap[1] = &machine().tilemap().create(*m_gfxdecode, tilemap_get_info_delegate(FUNC(namco_c123tmap_device::get_tile_info<0x1000>), this), TILEMAP_SCAN_ROWS, 8, 8, 64, 64);
	m_c123_TilemapInfo.tmap[2] = &machine().tilemap().create(*m_gfxdecode, tilemap_get_info_delegate(FUNC(namco_c123tmap_device::get_tile_info<0x2000>), this), TILEMAP_SCAN_ROWS, 8, 8, 64, 64);
	m_c123_TilemapInfo.tmap[3] = &machine().tilemap().create(*m_gfxdecode, tilemap_get_info_delegate(FUNC(namco_c123tmap_device::get_tile_info<0x3000>), this), TILEMAP_SCAN_ROWS, 8, 8, 64, 64);

	/* two non-scrolling tilemaps */
	m_c123_TilemapInfo.tmap[4] = &machine().tilemap().create(*m_gfxdecode, tilemap_get_info_delegate(FUNC(namco_c123tmap_device::get_tile_info<0x4008>), this), TILEMAP_SCAN_ROWS, 8, 8, 36, 28);
	m_c123_TilemapInfo.tmap[5] = &machine().tilemap().create(*m_gfxdecode, tilemap_get_info_delegate(FUNC(namco_c123tmap_device::get_tile_info<0x4408>), this), TILEMAP_SCAN_ROWS, 8, 8, 36, 28);
...
void namco_c123tmap_device::c123_tilemap_draw(screen_device &screen, bitmap_ind16 &bitmap, const rectangle &cliprect, int pri)
{
	for (int i = 0; i < 6; i++)
	{
...
void namco_c123tmap_device::c123_SetTilemapVideoram(int offset, uint16_t newword)
{
...
WRITE16_MEMBER(namco_c123tmap_device::c123_tilemap_videoram_w)
{
...
READ16_MEMBER(namco_c123tmap_device::c123_tilemap_videoram_r)
{
	return m_c123_TilemapInfo.videoram[offset];
}

void namco_c123tmap_device::c123_SetTilemapControl(int offset, uint16_t newword)
{
...
WRITE16_MEMBER(namco_c123tmap_device::c123_tilemap_control_w)
{
...
READ16_MEMBER(namco_c123tmap_device::c123_tilemap_control_r)
{
