...
void nbmj8991_state::palette_type1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	int r, g, b;
...
void nbmj8991_state::palette_type2_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	int r, g, b;
...
void nbmj8991_state::palette_type3_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	int r, g, b;
...
******************************************************************************/
void nbmj8991_state::blitter_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t nbmj8991_state::clut_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_clut[offset];
}

void nbmj8991_state::clut_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
