...
uint8_t avigo_state::vid_memory_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	if (!offset)
...
void avigo_state::vid_memory_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	if (!offset)
	{
