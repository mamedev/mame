...
void firetrap_state::firetrap_fgvideoram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_fgvideoram[offset] = data;
	m_fg_tilemap->mark_tile_dirty(offset & 0x3ff);
}

void firetrap_state::firetrap_bg1videoram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_bg1videoram[offset] = data;
	m_bg1_tilemap->mark_tile_dirty(offset & 0x6ff);
}

void firetrap_state::firetrap_bg2videoram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void firetrap_state::firetrap_bg1_scrollx_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_scroll1_x[offset] = data;
	m_bg1_tilemap->set_scrollx(0, m_scroll1_x[0] | (m_scroll1_x[1] << 8));
}

void firetrap_state::firetrap_bg1_scrolly_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_scroll1_y[offset] = data;
	m_bg1_tilemap->set_scrolly(0, -(m_scroll1_y[0] | (m_scroll1_y[1] << 8)));
}

void firetrap_state::firetrap_bg2_scrollx_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_scroll2_x[offset] = data;
	m_bg2_tilemap->set_scrollx(0, m_scroll2_x[0] | (m_scroll2_x[1] << 8));
}

void firetrap_state::firetrap_bg2_scrolly_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
