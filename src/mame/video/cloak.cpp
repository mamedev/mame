...
void cloak_state::cloak_paletteram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void cloak_state::cloak_clearbmp_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
//  m_screen->update_now();
...
uint8_t cloak_state::graph_processor_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void cloak_state::graph_processor_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	switch (offset)
	{
...
void cloak_state::cloak_videoram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void cloak_state::cloak_flipscreen_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
