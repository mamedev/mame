...
uint16_t rmnimbus_state::nimbus_video_io_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	uint16_t result = 0;
...
void rmnimbus_state::nimbus_video_io_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
