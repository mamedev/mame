...
public:
	...
	void K055555_word_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	void K055555_long_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
