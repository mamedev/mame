...
uint32_t taitojc_state::taitojc_palette_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
	return m_palette_ram[offset];
}

void taitojc_state::taitojc_palette_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	int r, g, b;
	uint32_t color;
...
uint32_t taitojc_state::taitojc_tile_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
	return m_tile_ram[offset];
}

uint32_t taitojc_state::taitojc_char_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
	return m_char_ram[offset];
}

void taitojc_state::taitojc_tile_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	COMBINE_DATA(m_tile_ram.get() + offset);
	m_tilemap->mark_tile_dirty(offset);
}

void taitojc_state::taitojc_char_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
