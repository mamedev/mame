...
void contra_state::contra_fg_vram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_fg_vram[offset] = data;
	m_fg_tilemap->mark_tile_dirty(offset);
}

void contra_state::contra_fg_cram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_fg_cram[offset] = data;
	m_fg_tilemap->mark_tile_dirty(offset);
}

void contra_state::contra_bg_vram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_bg_vram[offset] = data;
	m_bg_tilemap->mark_tile_dirty(offset);
}

void contra_state::contra_bg_cram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_bg_cram[offset] = data;
	m_bg_tilemap->mark_tile_dirty(offset);
}

void contra_state::contra_text_vram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_tx_vram[offset] = data;
	m_tx_tilemap->mark_tile_dirty(offset);
}

void contra_state::contra_text_cram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_tx_cram[offset] = data;
	m_tx_tilemap->mark_tile_dirty(offset);
}

void contra_state::contra_K007121_ctrl_0_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void contra_state::contra_K007121_ctrl_1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
