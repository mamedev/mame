 ...
 **************************************************************************/
void vigilant_state::paletteram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	int bank,r,g,b;
 ...
 **************************************************************************/
void vigilant_state::vigilant_horiz_scroll_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	if (offset==0)
...
***************************************************************************/
void vigilant_state::vigilant_rear_horiz_scroll_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	if (offset==0)
 ...
 **************************************************************************/
void vigilant_state::vigilant_rear_color_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
