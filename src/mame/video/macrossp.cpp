...
void macrossp_state::macrossp_scra_videoram_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
...
void macrossp_state::macrossp_scrb_videoram_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
...
void macrossp_state::macrossp_scrc_videoram_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
...
void macrossp_state::macrossp_text_videoram_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
