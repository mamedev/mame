...
uint32_t turrett_state::video_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
	uint32_t ret = 0;
...
void turrett_state::video_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	switch (offset)
	{
		case 0:
...
void turrett_state::dma_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
