...
void midvunit_state::midvunit_dma_queue_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
...
uint32_t midvunit_state::midvunit_dma_queue_entries_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
...
uint32_t midvunit_state::midvunit_dma_trigger_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
	if (offset)
	{
		if (LOG_DMA && machine().input().code_pressed(KEYCODE_L))
...
void midvunit_state::midvunit_page_control_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
...
uint32_t midvunit_state::midvunit_page_control_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
...
void midvunit_state::midvunit_video_control_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
...
uint32_t midvunit_state::midvunit_scanline_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
...
void midvunit_state::midvunit_videoram_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
...
uint32_t midvunit_state::midvunit_videoram_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
...
void midvunit_state::midvunit_paletteram_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	int newword;
...
void midvunit_state::midvunit_textureram_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
...
uint32_t midvunit_state::midvunit_textureram_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
	uint8_t *base = (uint8_t *)m_textureram.target();
