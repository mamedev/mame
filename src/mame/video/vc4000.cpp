...
uint8_t vc4000_state::vc4000_video_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	uint8_t data=0;
...
void vc4000_state::vc4000_video_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t vc4000_state::vc4000_vsync_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
