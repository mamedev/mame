...
void iqblock_state::fgvideoram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_fgvideoram[offset] = data;
	m_fg_tilemap->mark_tile_dirty(offset);
}

void iqblock_state::bgvideoram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_bgvideoram[offset] = data;
	m_bg_tilemap->mark_tile_dirty(offset & 0x7ff);
}

void iqblock_state::fgscroll_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
