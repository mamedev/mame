...
void skns_state::pal_regs_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
...
void skns_state::palette_ram_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	int r,g,b;
...
void skns_state::tilemapA_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
...
void skns_state::tilemapB_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	COMBINE_DATA(&m_tilemapB_ram[offset]);
	m_tilemap_B->mark_tile_dirty(offset);
}

void skns_state::v3_regs_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
