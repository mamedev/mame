...
void pc4_state::lcd_control_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	if (BIT(data, 7))
	{
		m_ac_mode = 0;
...
uint8_t pc4_state::lcd_control_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void pc4_state::lcd_offset_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_cursor_pos = m_ac = (data%0xa0);
}


void pc4_state::lcd_data_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	if (m_ac_mode == 0)
		m_ddram[m_ac] = data;
	else
...
uint8_t pc4_state::lcd_data_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	uint8_t data;
