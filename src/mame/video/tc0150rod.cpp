...
uint16_t tc0150rod_device::word_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	return m_ram[offset];
}

void tc0150rod_device::word_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
