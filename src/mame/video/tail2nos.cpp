...
void tail2nos_state::tail2nos_txvideoram_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	COMBINE_DATA(&m_txvideoram[offset]);
	m_tx_tilemap->mark_tile_dirty(offset);
}

void tail2nos_state::tail2nos_zoomdata_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void tail2nos_state::tail2nos_gfxbank_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	// -------- --pe-b-b
	// p = palette bank
	// b = tile bank
