...
void sspeedr_state::sspeedr_driver_horz_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_driver_horz = (m_driver_horz & 0x100) | data;
}


void sspeedr_state::sspeedr_driver_horz_2_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_driver_horz = (m_driver_horz & 0xff) | ((data & 1) << 8);
}


void sspeedr_state::sspeedr_driver_vert_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_driver_vert = data;
}


void sspeedr_state::sspeedr_driver_pic_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_driver_pic = data & 0x1f;
}


void sspeedr_state::sspeedr_drones_horz_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_drones_horz = (m_drones_horz & 0x100) | data;
}


void sspeedr_state::sspeedr_drones_horz_2_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_drones_horz = (m_drones_horz & 0xff) | ((data & 1) << 8);
}


void sspeedr_state::sspeedr_drones_mask_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_drones_mask = data & 0x3f;
}


void sspeedr_state::sspeedr_drones_vert_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_drones_vert[offset] = data;
}


void sspeedr_state::sspeedr_track_horz_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_track_horz = (m_track_horz & 0x100) | data;
}


void sspeedr_state::sspeedr_track_horz_2_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_track_horz = (m_track_horz & 0xff) | ((data & 1) << 8);
}


void sspeedr_state::sspeedr_track_vert_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_track_vert[offset] = data & 0x7f;
}


void sspeedr_state::sspeedr_track_ice_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
