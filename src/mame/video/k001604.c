...
void k001604_device::device_start()
{
	...
	m_gfxdecode->set_gfx(m_gfx_index[0], auto_alloc_clear(machine(), gfx_element(machine(), *m_gfxdecode->palette(), k001604_char_layout_layer_8x8, (UINT8*)&m_char_ram[0], m_gfxdecode->palette()->entries() / 16, 0)));
	m_gfxdecode->set_gfx(m_gfx_index[1], auto_alloc_clear(machine(), gfx_element(machine(), *m_gfxdecode->palette(), k001604_char_layout_layer_16x16, (UINT8*)&m_char_ram[0], m_gfxdecode->palette()->entries() / 16, 0)));
