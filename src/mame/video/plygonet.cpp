...
uint32_t polygonet_state::polygonet_ttl_ram_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
...
void polygonet_state::polygonet_ttl_ram_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	uint32_t *vram = (uint32_t *)m_ttl_vram;
...
uint32_t polygonet_state::polygonet_roz_ram_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
...
void polygonet_state::polygonet_roz_ram_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	uint32_t *vram = (uint32_t *)m_roz_vram;
