...
void atarigt_state::get_alpha_tile_info(tilemap_t &tilemap, tile_data &tileinfo, tilemap_memory_index tile_index)
{
...
void atarigt_state::get_playfield_tile_info(tilemap_t &tilemap, tile_data &tileinfo, tilemap_memory_index tile_index)
{
	uint16_t data = tilemap.basemem_read(tile_index);
...
tilemap_memory_index atarigt_state::atarigt_playfield_scan(uint32_t col, uint32_t row, uint32_t num_cols, uint32_t num_rows)
{
