...
******************************************************************************/
uint16_t niyanpai_state::palette_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	return m_palette_ptr[offset];
}

void niyanpai_state::palette_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	int r, g, b;
	int offs_h, offs_l;
...
******************************************************************************/
void niyanpai_state::blitter_0_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask){ blitter_w(0, offset, data); }
void niyanpai_state::blitter_1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask){ blitter_w(1, offset, data); }
void niyanpai_state::blitter_2_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask){ blitter_w(2, offset, data); }

uint8_t niyanpai_state::blitter_0_r(address_space &space, offs_t offset, uint8_t mem_mask){ return blitter_r(0, offset); }
uint8_t niyanpai_state::blitter_1_r(address_space &space, offs_t offset, uint8_t mem_mask){ return blitter_r(1, offset); }
uint8_t niyanpai_state::blitter_2_r(address_space &space, offs_t offset, uint8_t mem_mask){ return blitter_r(2, offset); }

void niyanpai_state::clut_0_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask){ clut_w(0, offset, data); }
void niyanpai_state::clut_1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask){ clut_w(1, offset, data); }
void niyanpai_state::clut_2_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask){ clut_w(2, offset, data); }

void niyanpai_state::clutsel_0_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask){ clutsel_w(0, data); }
void niyanpai_state::clutsel_1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask){ clutsel_w(1, data); }
void niyanpai_state::clutsel_2_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask){ clutsel_w(2, data); }
