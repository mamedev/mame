...
******************************************************************************/
uint8_t nbmj8900_state::palette_type1_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_palette_ptr[offset];
}

void nbmj8900_state::palette_type1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	int r, g, b;
...
uint8_t nbmj8900_state::palette_type2_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_palette_ptr[offset];
}

void nbmj8900_state::palette_type2_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	int r, g, b;
...
uint8_t nbmj8900_state::palette_type3_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_palette_ptr[offset];
}

void nbmj8900_state::palette_type3_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	int r, g, b;
...
void nbmj8900_state::clutsel_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_clutsel = data;
}

uint8_t nbmj8900_state::clut_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_clut[offset];
}

void nbmj8900_state::clut_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
******************************************************************************/
void nbmj8900_state::blitter_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	switch (offset)
	{
...
void nbmj8900_state::scrolly_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_scrolly = data;
}

void nbmj8900_state::vramsel_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void nbmj8900_state::romsel_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_gfxrom = (data & 0x0f);
