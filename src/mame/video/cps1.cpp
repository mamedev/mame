...
WRITE8_MEMBER(cps2_state::cps2_objram_bank_w)
{
...
void cps_state::cps1_render_stars( screen_device &screen, bitmap_ind16 &bitmap, const rectangle &cliprect )
{
	...
	if (!m_stars_rom && (m_stars_enabled[0] || m_stars_enabled[1]))
	{
#ifdef MAME_DEBUG
