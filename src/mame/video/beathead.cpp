...
void beathead_state::vram_transparent_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
...
void beathead_state::vram_bulk_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
...
void beathead_state::vram_latch_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	/* latch the address */
...
void beathead_state::vram_copy_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
...
void beathead_state::finescroll_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
...
uint32_t beathead_state::hsync_ram_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
...
void beathead_state::hsync_ram_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
