...
void btoads_state::misc_control_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void btoads_state::display_control_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void btoads_state::scroll0_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	/* allow multiple changes during display */
//  m_screen->update_now();
...
void btoads_state::scroll1_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	/* allow multiple changes during display */
//  m_screen->update_now();
	m_screen->update_partial(m_screen->vpos());
...
void btoads_state::paletteram_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	m_tlc34076->write(space, offset/2, data);
}


uint16_t btoads_state::paletteram_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
void btoads_state::vram_bg0_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	COMBINE_DATA(&m_vram_bg0[offset & 0x3fcff]);
}


void btoads_state::vram_bg1_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	COMBINE_DATA(&m_vram_bg1[offset & 0x3fcff]);
}


uint16_t btoads_state::vram_bg0_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	return m_vram_bg0[offset & 0x3fcff];
}


uint16_t btoads_state::vram_bg1_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
void btoads_state::vram_fg_display_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	if (ACCESSING_BITS_0_7)
...
void btoads_state::vram_fg_draw_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	if (ACCESSING_BITS_0_7)
...
uint16_t btoads_state::vram_fg_display_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	return m_vram_fg_display[offset];
}


uint16_t btoads_state::vram_fg_draw_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
