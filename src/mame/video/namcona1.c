...
void namcona1_state::video_start()
{
	...
	m_gfxdecode->set_gfx(0, auto_alloc( machine(), gfx_element( machine(), m_palette, cg_layout_8bpp, (UINT8 *)m_cgram, m_palette->entries()/256, 0 )));
	m_gfxdecode->set_gfx(1, auto_alloc( machine(), gfx_element( machine(), m_palette, cg_layout_4bpp, (UINT8 *)m_cgram, m_palette->entries()/16, 0 )));
	m_gfxdecode->set_gfx(2, auto_alloc( machine(), gfx_element( machine(), m_palette, shape_layout, (UINT8 *)m_shaperam, m_palette->entries()/2, 0 )));
