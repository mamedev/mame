...
template<int Layer>
TILE_GET_INFO_MEMBER(lordgun_state::get_tile_info)
{
...
uint32_t lordgun_state::screen_update(screen_device &screen, bitmap_ind16 &bitmap, const rectangle &cliprect)
{
	int layers_ctrl = -1;
