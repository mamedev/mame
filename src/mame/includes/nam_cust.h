...
#define ROM_REGION_NAMCO_50XX( region ) \
	ROM_REGION( 0x800, RGNCLASS_CPU, region, 0 ) /* 2k for the 50xx  */ \
...
#define ROM_REGION_NAMCO_51XX( region ) \
	ROM_REGION( 0x400, RGNCLASS_CPU, region, 0 ) /* 1k for the 51xx  */ \
...
#define ROM_REGION_NAMCO_52XX( region ) \
	ROM_REGION( 0x400, RGNCLASS_CPU, region, 0 ) /* 1k for the 52xx  */ \
...
#define ROM_REGION_NAMCO_53XX( region ) \
	ROM_REGION( 0x400, RGNCLASS_CPU, region, 0 ) /* 1k for the 53xx  */ \
...
#define ROM_REGION_NAMCO_54XX( region ) \
	ROM_REGION( 0x400, RGNCLASS_CPU, region, 0 ) /* 1k for the 54xx  */ \
