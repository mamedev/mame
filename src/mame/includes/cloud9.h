...
public:
	...
	void cloud9_led_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void cloud9_coin_counter_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	...
	void cloud9_video_control_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void cloud9_paletteram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void cloud9_videoram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
