...
class imds2_state : public driver_device
{
	...
	void imds2_kb_port_p1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t imds2_kb_port_t0_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t imds2_kb_port_t1_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void imds2_ioc_dbbout_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void imds2_ioc_f0_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void imds2_ioc_set_f1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void imds2_ioc_reset_f1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t imds2_ioc_status_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t imds2_ioc_dbbin_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t imds2_ipc_dbbout_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	...
	uint8_t imds2_pio_port_p1_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
