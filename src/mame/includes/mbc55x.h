...
public:
	...
	//uint8_t pic8259_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	//void pic8259_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	//uint8_t mbc55x_disk_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	//void mbc55x_disk_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t mbc55x_usart_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void mbc55x_usart_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	//uint8_t mbc55x_kb_usart_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	//void mbc55x_kb_usart_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t vram_page_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void vram_page_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t ppi8255_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void ppi8255_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	...
	uint8_t mbc55x_ppi_porta_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t mbc55x_ppi_portb_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t mbc55x_ppi_portc_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	...
	uint8_t mbcpic8259_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void mbcpic8259_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t mbcpit8253_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void mbcpit8253_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t mbc55x_disk_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void mbc55x_disk_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t mbc55x_kb_usart_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void mbc55x_kb_usart_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
