...
class towns_state : public driver_device
{
	...
	uint8_t towns_system_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void towns_system_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t towns_intervaltimer2_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void towns_intervaltimer2_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t towns_sys6c_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void towns_sys6c_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t towns_dma1_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void towns_dma1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t towns_dma2_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void towns_dma2_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t towns_floppy_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void towns_floppy_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t towns_keyboard_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void towns_keyboard_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t towns_port60_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void towns_port60_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t towns_sys5e8_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void towns_sys5e8_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t towns_sound_ctrl_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void towns_sound_ctrl_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t towns_padport_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void towns_pad_mask_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t towns_cmos_low_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void towns_cmos_low_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t towns_cmos_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void towns_cmos_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t towns_sys480_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void towns_sys480_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t towns_video_404_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void towns_video_404_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t towns_cdrom_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void towns_cdrom_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t towns_rtc_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void towns_rtc_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void towns_rtc_select_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t towns_volume_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void towns_volume_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t towns_41ff_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);

	uint8_t towns_gfx_high_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void towns_gfx_high_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t towns_gfx_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void towns_gfx_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t towns_video_cff80_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void towns_video_cff80_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t towns_video_cff80_mem_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void towns_video_cff80_mem_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t towns_video_440_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void towns_video_440_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t towns_video_5c8_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void towns_video_5c8_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t towns_video_fd90_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void towns_video_fd90_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t towns_video_ff81_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t towns_video_unknown_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void towns_video_ff81_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t towns_spriteram_low_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void towns_spriteram_low_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
...
public:
	...
	uint16_t towns_fdc_dma_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void towns_fdc_dma_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	void towns_cdrom_set_irq(int line,int state);
	uint8_t towns_cd_get_track();
	uint16_t towns_cdrom_dma_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void rtc_hour();
	void rtc_minute();
	uint16_t towns_scsi_dma_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void towns_scsi_dma_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
};
