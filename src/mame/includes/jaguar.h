...
public:
	...
	uint32_t eeprom_clk(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	uint32_t eeprom_cs(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	uint32_t misc_control_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void misc_control_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t gpuctrl_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void gpuctrl_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t dspctrl_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void dspctrl_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t joystick_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void joystick_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	void latch_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t eeprom_data_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	...
	void gpu_jump_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t gpu_jump_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	uint32_t cojagr3k_main_speedup_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	uint32_t main_gpu_wait_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void area51_main_speedup_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	void area51mx_main_speedup_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint16_t gpuctrl_r16(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void gpuctrl_w16(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint16_t blitter_r16(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void blitter_w16(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint16_t serial_r16(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void serial_w16(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint16_t dspctrl_r16(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void dspctrl_w16(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint16_t eeprom_cs16(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	uint16_t eeprom_clk16(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void eeprom_w16(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint16_t joystick_r16(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void joystick_w16(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint32_t shared_ram_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void shared_ram_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t rom_base_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void rom_base_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t cart_base_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void cart_base_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t wave_rom_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void wave_rom_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t dsp_ram_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void dsp_ram_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t gpu_clut_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void gpu_clut_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t gpu_ram_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void gpu_ram_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint16_t shared_ram_r16(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void shared_ram_w16(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint16_t rom_base_r16(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void rom_base_w16(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint16_t cart_base_r16(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void cart_base_w16(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint16_t wave_rom_r16(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void wave_rom_w16(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint16_t dsp_ram_r16(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void dsp_ram_w16(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint16_t gpu_clut_r16(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void gpu_clut_w16(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint16_t gpu_ram_r16(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void gpu_ram_w16(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint16_t butch_regs_r16(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void butch_regs_w16(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint32_t butch_regs_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void butch_regs_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	void init_jaguar();
	void init_jaguarcd();
	void init_area51mx();
	void init_maxforce();
	...
	// from audio/jaguar.c
	uint16_t jerry_regs_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void jerry_regs_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint32_t serial_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	...
	uint16_t tom_regs_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void tom_regs_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
...
protected:
	...
	// from audio/jaguar.c
	void update_gpu_irq();
	void dsp_flags_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
