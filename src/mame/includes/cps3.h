...
public:
	...
	uint32_t cps3_ssram_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void cps3_ssram_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	void cps3_0xc0000000_ram_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	void cram_bank_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t cram_data_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void cram_data_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t cps3_gfxflash_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void cps3_gfxflash_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t cps3_flash1_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	uint32_t cps3_flash2_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void cps3_flash1_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	void cps3_flash2_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	void cram_gfxflash_bank_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t cps3_vbl_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	uint32_t cps3_unk_io_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	uint32_t cps3_40C0000_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	uint32_t cps3_40C0004_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	uint32_t cps3_eeprom_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void cps3_eeprom_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	void cps3_ss_bank_base_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	void cps3_ss_pal_base_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	void cps3_palettedma_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	void cps3_characterdma_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	void cps3_irq10_ack_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	void cps3_irq12_ack_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	void cps3_unk_vidregs_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t cps3_colourram_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void cps3_colourram_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	void init_sfiii3();
	void init_sfiii();
	void init_redearth();
	void init_jojo();
