...
public:
	...
	int m_video_control;
	void pcw16_palette_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t pcw16_bankhw_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void pcw16_bankhw_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void pcw16_video_control_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t pcw16_keyboard_data_shift_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void pcw16_keyboard_data_shift_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t pcw16_keyboard_status_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void pcw16_keyboard_control_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t rtc_year_invalid_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t rtc_month_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t rtc_days_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t rtc_hours_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t rtc_minutes_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t rtc_seconds_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t rtc_256ths_seconds_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void rtc_control_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void rtc_seconds_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void rtc_minutes_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void rtc_hours_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void rtc_days_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void rtc_month_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void rtc_year_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t pcw16_system_status_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t pcw16_timer_interrupt_counter_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void pcw16_system_control_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t pcw16_mem_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void pcw16_mem_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	...
	void palette_init_pcw16(palette_device &palette);
	uint32_t screen_update_pcw16(screen_device &screen, bitmap_ind16 &bitmap, const rectangle &cliprect);
	void pcw16_timer_callback(timer_device &timer, void *ptr, int32_t param);
	void rtc_timer_callback(timer_device &timer, void *ptr, int32_t param);
