...
public:
	...
	uint16_t vertigo_io_convert(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	uint16_t vertigo_io_adc(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	uint16_t vertigo_coin_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void vertigo_wsot_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	void vertigo_audio_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint16_t vertigo_sio_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void vertigo_motor_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint16_t vertigo_pit8254_lsb_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
