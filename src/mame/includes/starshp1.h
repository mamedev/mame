...
public:
	...
	void starshp1_collision_reset_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void starshp1_analog_in_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void starshp1_misc_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t starshp1_rng_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
