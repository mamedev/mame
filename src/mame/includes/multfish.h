...
public:
	...
	void igrosoft_gamble_vid_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void igrosoft_gamble_bank_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	...
	void igrosoft_gamble_rambank_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t ray_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void igrosoft_gamble_hopper_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void rollfr_hopper_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void igrosoft_gamble_lamps1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void igrosoft_gamble_lamps2_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void igrosoft_gamble_lamps3_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
