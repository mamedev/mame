...
public:
	...
	int m_ir_xmax;
	int m_ir_ymax;
	void irobot_nvram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void irobot_clearirq_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void irobot_clearfirq_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t irobot_sharedmem_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void irobot_sharedmem_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void irobot_statwr_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void irobot_out0_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void irobot_rom_banksel_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void irobot_control_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t irobot_control_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t irobot_status_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void irobot_paletteram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
