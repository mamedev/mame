...
public:
	...
	uint8_t carpolo_ball_screen_collision_cause_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t carpolo_car_ball_collision_x_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t carpolo_car_ball_collision_y_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t carpolo_car_car_collision_cause_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t carpolo_car_goal_collision_cause_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t carpolo_car_ball_collision_cause_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t carpolo_car_border_collision_cause_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t carpolo_interrupt_cause_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void carpolo_ball_screen_interrupt_clear_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void carpolo_car_car_interrupt_clear_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void carpolo_car_goal_interrupt_clear_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void carpolo_car_ball_interrupt_clear_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void carpolo_car_border_interrupt_clear_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void carpolo_timer_interrupt_clear_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void init_carpolo();
