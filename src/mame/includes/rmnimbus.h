...
public:
	...
	uint8_t nimbus_mcu_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void nimbus_mcu_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	...
	void fdc_ctl_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t nimbus_pc8031_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void nimbus_pc8031_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t nimbus_pc8031_iou_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void nimbus_pc8031_iou_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t nimbus_pc8031_port_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void nimbus_pc8031_port_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t nimbus_iou_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void nimbus_iou_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void nimbus_sound_ay8910_porta_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void nimbus_sound_ay8910_portb_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t nimbus_mouse_js_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void nimbus_mouse_js_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint16_t nimbus_video_io_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void nimbus_video_io_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	...
	void nimbus_via_write_portb(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	...
	uint8_t cascade_callback(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
