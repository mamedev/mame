...
public:
	...
	void attram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t vidram_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void vidram_bank_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void display_disable_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
