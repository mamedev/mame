...
class dc_state : public driver_device
{
	...
	void dc_arm_aica_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	...
	uint64_t dc_sysctrl_r(address_space &space, offs_t offset, uint64_t mem_mask = U64(0xffffffffffffffff));
	void dc_sysctrl_w(address_space &space, offs_t offset, uint64_t data, uint64_t mem_mask = U64(0xffffffffffffffff));
	uint64_t dc_gdrom_r(address_space &space, offs_t offset, uint64_t mem_mask = U64(0xffffffffffffffff));
	void dc_gdrom_w(address_space &space, offs_t offset, uint64_t data, uint64_t mem_mask = U64(0xffffffffffffffff));
	uint64_t dc_g2_ctrl_r(address_space &space, offs_t offset, uint64_t mem_mask = U64(0xffffffffffffffff));
	void dc_g2_ctrl_w(address_space &space, offs_t offset, uint64_t data, uint64_t mem_mask = U64(0xffffffffffffffff));
	uint64_t dc_modem_r(address_space &space, offs_t offset, uint64_t mem_mask = U64(0xffffffffffffffff));
	void dc_modem_w(address_space &space, offs_t offset, uint64_t data, uint64_t mem_mask = U64(0xffffffffffffffff));
	void g1_irq(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void pvr_irq(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
