...
//  uint16_t          m_spritebank_eof[8];
	...
	void growl_coin_word_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	void taitof2_4p_coin_word_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	void ninjak_coin_word_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint16_t ninjak_input_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	uint16_t cameltry_paddle_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	uint16_t mjnquest_dsw_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	uint16_t mjnquest_input_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void mjnquest_inputselect_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	void sound_bankswitch_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t driveout_sound_command_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void oki_bank_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void driveout_sound_command_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	void cchip2_word_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint16_t cchip2_word_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void taitof2_sprite_extension_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	void taitof2_spritebank_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	void koshien_spritebank_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	void cameltrya_porta_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void init_driveout();
	void init_cameltry();
	void init_mjnquest();
	void init_finalb();
	...
	void video_start_taitof2_dondokod();
	void video_start_taitof2_driftout();
	void video_start_taitof2_finalb();
	void video_start_taitof2_megab();
	void video_start_taitof2_thundfox();
	void video_start_taitof2_ssi();
	void video_start_taitof2_gunfront();
	void video_start_taitof2_growl();
	void video_start_taitof2_mjnquest();
	void video_start_taitof2_footchmp();
	void video_start_taitof2_hthero();
	void video_start_taitof2_koshien();
	void video_start_taitof2_yuyugogo();
	void video_start_taitof2_ninjak();
	void video_start_taitof2_solfigtr();
	void video_start_taitof2_pulirula();
	void video_start_taitof2_metalb();
	void video_start_taitof2_qzchikyu();
	void video_start_taitof2_yesnoj();
	void video_start_taitof2_deadconx();
	void video_start_taitof2_deadconxj();
	void video_start_taitof2_dinorex();
	void video_start_taitof2_quiz();
