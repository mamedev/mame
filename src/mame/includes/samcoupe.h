...
public:
	...
	uint8_t *m_videoram;
	void samcoupe_ext_mem_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t samcoupe_disk_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void samcoupe_disk_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t samcoupe_pen_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void samcoupe_clut_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t samcoupe_status_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void samcoupe_line_int_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t samcoupe_lmpr_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void samcoupe_lmpr_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t samcoupe_hmpr_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void samcoupe_hmpr_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t samcoupe_vmpr_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void samcoupe_vmpr_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t samcoupe_midi_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void samcoupe_midi_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t samcoupe_keyboard_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void samcoupe_border_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	...
	void samcoupe_lpt2_strobe_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t samcoupe_rtc_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void samcoupe_rtc_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);

	uint8_t sam_bank1_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void sam_bank1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t sam_bank2_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void sam_bank2_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t sam_bank3_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void sam_bank3_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t sam_bank4_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void sam_bank4_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
