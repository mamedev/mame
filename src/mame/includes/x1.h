...
public:
	...
	*/
	...
	uint8_t x1_mem_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void x1_mem_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t x1_io_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void x1_io_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t x1_sub_io_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void x1_sub_io_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t x1_rom_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void x1_rom_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void x1_rom_bank_0_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void x1_rom_bank_1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t x1_fdc_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void x1_fdc_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t x1_pcg_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void x1_pcg_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void x1_pal_r_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void x1_pal_g_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void x1_pal_b_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void x1_ex_gfxram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void x1_scrn_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void x1_pri_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void x1_6845_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t x1_kanji_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void x1_kanji_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t x1_emm_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void x1_emm_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t x1turbo_pal_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t x1turbo_txpal_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t x1turbo_txdisp_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t x1turbo_gfxpal_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void x1turbo_pal_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void x1turbo_txpal_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void x1turbo_txdisp_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void x1turbo_gfxpal_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void x1turbo_blackclip_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t x1turbo_mem_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void x1turbo_mem_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t x1turbo_io_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void x1turbo_io_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void x1turboz_4096_palette_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t x1turboz_blackclip_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t x1turbo_bank_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void x1turbo_bank_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t x1_porta_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t x1_portb_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t x1_portc_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void x1_porta_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void x1_portb_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void x1_portc_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void init_x1_kanji();
