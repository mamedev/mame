...
public:
	...
	DECLARE_WRITE_LINE_MEMBER(irq_0);
	...
	DECLARE_WRITE_LINE_MEMBER(irq_8);
	DECLARE_WRITE_LINE_MEMBER(irq_9);
	DECLARE_WRITE_LINE_MEMBER(irq_a);
	DECLARE_WRITE_LINE_MEMBER(irq_b);
	DECLARE_WRITE_LINE_MEMBER(irq_c);
	DECLARE_WRITE_LINE_MEMBER(irq_d);
	DECLARE_WRITE_LINE_MEMBER(irq_e);
	DECLARE_WRITE_LINE_MEMBER(irq_f);
