...
public:
	...
	void dgnbeta_ram_b3_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void dgnbeta_ram_b4_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void dgnbeta_ram_b5_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void dgnbeta_ram_b6_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void dgnbeta_ram_b7_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void dgnbeta_ram_b8_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void dgnbeta_ram_b9_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void dgnbeta_ram_bA_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void dgnbeta_ram_bB_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void dgnbeta_ram_bC_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void dgnbeta_ram_bD_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void dgnbeta_ram_bE_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void dgnbeta_ram_bF_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void dgnbeta_ram_bG_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t d_pia0_pa_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	...
	// Page IO at FE00
	uint8_t dgn_beta_page_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void dgn_beta_page_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	MC6845_UPDATE_ROW(crtc_update_row);

	/*  WD2797 FDC */
	uint8_t dgnbeta_wd2797_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void dgnbeta_wd2797_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
