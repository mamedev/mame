...
public:
	...
	uint32_t is64_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void is64_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t open_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void open_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t rdram_reg_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void rdram_reg_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t mi_reg_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void mi_reg_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t vi_reg_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void vi_reg_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t ai_reg_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void ai_reg_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t pi_reg_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void pi_reg_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t ri_reg_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void ri_reg_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t si_reg_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void si_reg_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t dd_reg_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	...
	void sp_reg_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	void sp_set_status(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
