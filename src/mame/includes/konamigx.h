...
public:
	...
	void get_gx_psac3_alt_tile_info(tilemap_t &tilemap, tile_data &tileinfo, tilemap_memory_index tile_index);
	void get_gx_psac1a_tile_info(tilemap_t &tilemap, tile_data &tileinfo, tilemap_memory_index tile_index);
	void get_gx_psac1b_tile_info(tilemap_t &tilemap, tile_data &tileinfo, tilemap_memory_index tile_index);
	void machine_start_konamigx();
	void machine_reset_konamigx();
	void video_start_konamigx_5bpp();
	void video_start_dragoonj();
	void video_start_le2();
	void video_start_konamigx_6bpp();
	void video_start_opengolf();
	void video_start_racinfrc();
	void video_start_konamigx_type3();
	void video_start_konamigx_type4();
	void video_start_konamigx_type4_vsn();
	void video_start_konamigx_type4_sd2();
	...
	void konamigx_type2_vblank_irq(device_t &device);
	void konamigx_type2_scanline(timer_device &timer, void *ptr, int32_t param);
	void konamigx_type4_scanline(timer_device &timer, void *ptr, int32_t param);
	void k054539_irq_gen(int state);
	void dmaend_callback(void *ptr, int32_t param);
	void boothack_callback(void *ptr, int32_t param);
