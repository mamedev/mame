...
public:
	...
	int m_print_count;
	void ga2_dpram_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint16_t ga2_dpram_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void sonic_level_load_protection(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint16_t brival_protection_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void brival_protection_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	void darkedge_protection_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint16_t darkedge_protection_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void dbzvrvs_protection_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint16_t dbzvrvs_protection_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	uint16_t arabfgt_protection_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void arabfgt_protection_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint16_t arf_wakeup_protection_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void jleague_protection_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint16_t arescue_dsp_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void arescue_dsp_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint16_t system32_paletteram_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void system32_paletteram_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint32_t multi32_paletteram_0_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void multi32_paletteram_0_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t multi32_paletteram_1_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void multi32_paletteram_1_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint16_t system32_videoram_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void system32_videoram_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint32_t multi32_videoram_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void multi32_videoram_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint16_t system32_sprite_control_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void system32_sprite_control_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint32_t multi32_sprite_control_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void multi32_sprite_control_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint16_t system32_spriteram_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void system32_spriteram_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint32_t multi32_spriteram_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void multi32_spriteram_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint16_t system32_mixer_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void system32_mixer_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	void multi32_mixer_0_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	void multi32_mixer_1_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint16_t interrupt_control_16_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void interrupt_control_16_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint32_t interrupt_control_32_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void interrupt_control_32_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	...
	uint32_t io_chip_0_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void io_chip_0_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t io_chip_1_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void io_chip_1_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint16_t io_expansion_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void io_expansion_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint32_t io_expansion_0_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void io_expansion_0_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t io_expansion_1_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void io_expansion_1_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint16_t analog_custom_io_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void analog_custom_io_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint16_t extra_custom_io_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void orunners_custom_io_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint16_t sonic_custom_io_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void sonic_custom_io_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	void random_number_16_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint16_t random_number_16_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void random_number_32_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t random_number_32_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	uint16_t shared_ram_16_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void shared_ram_16_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint32_t shared_ram_32_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void shared_ram_32_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	void sound_int_control_lo_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void sound_int_control_hi_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void sound_bank_lo_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void sound_bank_hi_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t sound_dummy_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void sound_dummy_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
