...
public:
	...
	uint16_t darius_ioc_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void darius_ioc_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	void sound_bankswitch_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void adpcm_command_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void darius_fm0_pan(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void darius_fm1_pan(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void darius_psg0_pan(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void darius_psg1_pan(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void darius_da_pan(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t adpcm_command_read(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t readport2(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t readport3(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void adpcm_nmi_disable(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void adpcm_nmi_enable(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void darius_fg_layer_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	void darius_write_portA0(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void darius_write_portA1(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void darius_write_portB0(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void darius_write_portB1(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	...
	void update_da(  );
	void darius_adpcm_int(int state);
};
