...
public:
	...
	void pancontrol(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void tc0100scn_dual_screen_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
