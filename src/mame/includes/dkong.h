...
public:
	...
	uint8_t hb_dma_read_byte(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void hb_dma_write_byte(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void dkong3_coin_counter_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t dkong_in2_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t dkongjr_in2_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t s2650_mirror_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void s2650_mirror_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t epos_decrypt_rom(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void s2650_data_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void s2650_fo_w(int state);
	uint8_t s2650_port0_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t s2650_port1_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void dkong3_2a03_reset_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t strtheat_inputport_0_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t strtheat_inputport_1_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void nmi_mask_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void braze_a15_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void dkong_videoram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void dkongjr_gfxbank_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void dkong3_gfxbank_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void dkong_palettebank_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void radarscp_grid_enable_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void radarscp_grid_color_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void dkong_flipscreen_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void dkong_spritebank_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void dkong_voice_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void dkong_audio_irq_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t p8257_ctl_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void p8257_ctl_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void p8257_drq_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void dkong_z80dma_rdy_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t braze_eeprom_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void braze_eeprom_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void init_strtheat();
	void init_herodk();
	void init_dkingjr();
	void init_drakton();
	void init_dkongx();
	void dkong_bg_tile_info(tilemap_t &tilemap, tile_data &tileinfo, tilemap_memory_index tile_index);
	void radarscp1_bg_tile_info(tilemap_t &tilemap, tile_data &tileinfo, tilemap_memory_index tile_index);
	void machine_start_dkong2b();
	void machine_reset_dkong();
	void video_start_dkong();
	void video_start_dkong_base();
	void palette_init_dkong2b(palette_device &palette);
	void machine_start_dkong3();
	void palette_init_dkong3(palette_device &palette);
	void machine_start_radarscp();
	void palette_init_radarscp(palette_device &palette);
	void machine_start_radarscp1();
	void palette_init_radarscp1(palette_device &palette);
	void machine_start_s2650();
	void machine_reset_strtheat();
	void machine_reset_drakton();
	void M58817_command_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t M58817_status_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t dkong_voice_status_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t dkong_tune_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void dkong_p1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
