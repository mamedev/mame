...
public:
	...
	void palette_init_pdp1(palette_device &palette);
	...
	void pdp1_interrupt(device_t &device);
	void reader_callback(void *ptr, int32_t param);
	void puncher_callback(void *ptr, int32_t param);
	void tyo_callback(void *ptr, int32_t param);
	void dpy_callback(void *ptr, int32_t param);
