...
public:
	...
	void to770_sys_portb_out(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void to770_timer_port_out(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t to770_gatearray_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void to770_gatearray_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	...
	uint8_t mo5_gatearray_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void mo5_gatearray_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void mo5_update_cart_bank_postload();
	void mo5_cartridge_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t mo5_cartridge_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void mo5_ext_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void machine_reset_mo5();
	void machine_start_mo5();
	void to9_ieee_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t to9_ieee_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t to9_gatearray_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void to9_gatearray_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t to9_vreg_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void to9_vreg_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void to9_update_cart_bank_postload();
	void to9_cartridge_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t to9_cartridge_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	...
	void to8_cartridge_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t to8_cartridge_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t to8_floppy_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void to8_floppy_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t to8_gatearray_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void to8_gatearray_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t to8_vreg_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void to8_vreg_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t to8_sys_porta_in(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	...
	uint8_t to9p_timer_port_in(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void to9p_timer_port_out(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void machine_reset_to9p();
	void machine_start_to9p();
	...
	void mo6_vreg_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void machine_reset_mo6();
	void machine_start_mo6();
	uint8_t mo5nr_net_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void mo5nr_net_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t mo5nr_prn_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void mo5nr_prn_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t mo5nr_sys_portb_in(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void mo5nr_sys_porta_out(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	...
	void to8_sys_lo_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void to8_sys_hi_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void to8_data_lo_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void to8_data_hi_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	...
	void video_start_thom();

	uint8_t to7_5p14_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void to7_5p14_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t to7_5p14sd_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
...
public:
	...
	/* read data register */
	uint8_t porta_in(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
