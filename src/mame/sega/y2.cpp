...
ROM_START( higurashi ) //ひぐらしの哭く頃に 雀 / Higurashi no Naku Koro ni Jan - AM-Y2 ROM_V0 PCB (also has a XILINX XC2C64A etched 0012)
...
GAME( 2009, higurashi,  0,         system_board_y2, system_board_y2,  system_board_y2_state, empty_init, ROT0, "AQ Interactive",             "Higurashi no Naku Koro ni Jan (Japan)",                                                                   MACHINE_IS_SKELETON )
