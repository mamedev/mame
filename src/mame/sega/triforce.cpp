...
/* Main board */
/*Triforce*/GAME( 2002, triforce, 0,        triforce_base, triforce, triforce_state, empty_init, ROT0, "Sega",                               "Triforce BIOS", MACHINE_NO_SOUND | MACHINE_NOT_WORKING|MACHINE_IS_BIOS_ROOT )

/* GDT-xxxx (Sega GD-ROM games) */
/* 0001  */ GAME( 2002, vs2002j,  triforce, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Amusement Vision",            "Virtua Striker 2002 (Japan) (GDT-0001)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0002  */ GAME( 2002, vs2002ex, triforce, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Amusement Vision",            "Virtua Striker 2002 (Export) (GDT-0002)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
// 0003
// 0004     GAME( 2003, fzeroaxo, fzeroax,  triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Amusement Vision / Nintendo", "F-Zero AX (GDT-0004)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
// 0004A    GAME( 2003, fzeroaxa, fzeroax,  triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Amusement Vision / Nintendo", "F-Zero AX (Rev A) (GDT-0004A)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
// 0004B    GAME( 2003, fzeroaxb, fzeroax,  triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Amusement Vision / Nintendo", "F-Zero AX (Rev B) (GDT-0004B)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0004C */ GAME( 2003, fzeroaxc, fzeroax,  triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Amusement Vision / Nintendo", "F-Zero AX (Rev C) (GDT-0004C)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0004D */ GAME( 2003, fzeroaxd, fzeroax,  triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Amusement Vision / Nintendo", "F-Zero AX (Rev D) (GDT-0004D)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0004E */ GAME( 2003, fzeroax,  triforce, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Amusement Vision / Nintendo", "F-Zero AX (Rev E) (GDT-0004E)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
// 0005     GAME( 2003, avalonso, avalons,  triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon - The Wizard Master (server) (GDT-0005)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0005A */ GAME( 2003, avalonsa, avalons,  triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon - The Wizard Master (server, Rev A) (GDT-0005A)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
// 0005B    GAME( 2003, avalonsb, avalons,  triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon - The Wizard Master (server, Rev B) (GDT-0005B)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0005C */ GAME( 2003, avalonsc, avalons,  triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon - The Wizard Master (server, Rev C) (GDT-0005C)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
// 0005D    GAME( 2003, avalonsd, avalons,  triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon - The Wizard Master (server, Rev D) (GDT-0005D)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0005E */ GAME( 2003, avalonse, avalons,  triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon - The Wizard Master (server, Rev E) (GDT-0005E)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0005F */ GAME( 2003, avalonsf, avalons,  triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon - The Wizard Master (server, Rev F) (GDT-0005F)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0005G */ GAME( 2003, avalons,  triforce, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon - The Wizard Master (server, Rev G) (GDT-0005G)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
// 0006     GAME( 2003, avalonco, avalonc,  triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon - The Wizard Master (client) (GDT-0006)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0006A */ GAME( 2003, avalonca, avalonc,  triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon - The Wizard Master (client, Rev A) (GDT-0006A)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
// 0006B    GAME( 2003, avaloncb, avalonc,  triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon - The Wizard Master (client, Rev B) (GDT-0006B)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0006C */ GAME( 2003, avaloncc, avalonc,  triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon - The Wizard Master (client, Rev C) (GDT-0006C)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
// 0006D    GAME( 2003, avaloncd, avalonc,  triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon - The Wizard Master (client, Rev D) (GDT-0006D)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0006E */ GAME( 2003, avalonce, avalonc,  triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon - The Wizard Master (client, Rev E) (GDT-0006E)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0006F */ GAME( 2003, avaloncf, avalonc,  triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon - The Wizard Master (client, Rev F) (GDT-0006F)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0006G */ GAME( 2003, avalonc,  triforce, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon - The Wizard Master (client, Rev G) (GDT-0006G)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
// 0007  F-Zero AX (Asia)
// 0008     GAME( 2003, gekpuryao,gekpurya, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Wow Entertainment",           "Gekitou Pro Yakyuu Mizushima Shinji All Stars vs. Pro Yakyuu (GDT-0008)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
// 0008A    GAME( 2003, gekpuryaa,gekpurya, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Wow Entertainment",           "Gekitou Pro Yakyuu Mizushima Shinji All Stars vs. Pro Yakyuu (Rev A) (GDT-0008A)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0008B */ GAME( 2003, gekpuryb, gekpurya, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Wow Entertainment",           "Gekitou Pro Yakyuu Mizushima Shinji All Stars vs. Pro Yakyuu (Rev B) (GDT-0008B)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0008C */ GAME( 2003, gekpurya, triforce, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Wow Entertainment",           "Gekitou Pro Yakyuu Mizushima Shinji All Stars vs. Pro Yakyuu (Rev C) (GDT-0008C)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
// 0009     GAME( 2004, avalns11, avalns13, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon 1.? - ??? (server) (GDT-0009)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0009A */ GAME( 2004, avalns12, avalns13, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon 1.2 - Summon The New Monsters (server, Rev A) (GDT-0009A)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
// 0009B    GAME( 2004, avals13b, avalns13, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon 1.? - ??? (server, Rev B) (GDT-0009B)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0009C */ GAME( 2004, avalns13, triforce, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon 1.3 - Chaotic Sabbat (server, Rev C) (GDT-0009C)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
// 0010     GAME( 2004, avalnc11, avalnc13, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon 1.? - ??? (client) (GDT-0010)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0010A */ GAME( 2004, avalnc12, avalnc13, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon 1.2 - Summon The New Monsters (client, Rev A) (GDT-0010A)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
// 0010B    GAME( 2004, avalc13b, avalnc13, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon 1.? - ??? (client, Rev B) (GDT-0010B)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0010C */ GAME( 2004, avalnc13, triforce, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon 1.3 - Chaotic Sabbat (client, Rev C) (GDT-0010C)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0011  */ GAME( 2003, tfupdate, triforce, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega",                               "Triforce DIMM Updater (3.17) (GDT-0011)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0012  */ GAME( 2004, vs2002t3, triforce, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Amusement Vision",            "Virtua Striker 2002 (Type 3) (GDT-0012)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
// 0013     GAME( 2004, vs4jo,    vs4j,     triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega",                               "Virtua Striker 4 (Japan) (GDT-0013)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
// 0013A    GAME( 2004, vs4ja,    vs4j,     triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega",                               "Virtua Striker 4 (Japan, Rev A) (GDT-0013A)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
// 0013B    GAME( 2004, vs4jb,    vs4j,     triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega",                               "Virtua Striker 4 (Japan, Rev B) (GDT-0013B)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0013C */ GAME( 2004, vs4jc,    vs4j,     triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega",                               "Virtua Striker 4 (Japan, Rev C) (GDT-0013C)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
// 0013D    GAME( 2004, vs4jd,    vs4j,     triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega",                               "Virtua Striker 4 (Japan, Rev D) (GDT-0013D)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0013E */ GAME( 2005, vs4j,     triforce, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega",                               "Virtua Striker 4 (Japan, Rev E) (GDT-0013E)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0014  */ GAME( 2004, vs4eo,    vs4,      triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega",                               "Virtua Striker 4 (Asia) (GDT-0014)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
// 0014A    GAME( 2004, vs4ea,    vs4,      triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega",                               "Virtua Striker 4 (Asia, Rev A) (GDT-0014A)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0014B */ GAME( 2005, vs4e,     vs4,      triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega",                               "Virtua Striker 4 (Asia, Rev B) (GDT-0014B)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0015  */ GAME( 2004, vs4o,     vs4,      triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega",                               "Virtua Striker 4 (Export) (GDT-0015)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0015A */ GAME( 2005, vs4,      triforce, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega",                               "Virtua Striker 4 (Export, Rev A) (GDT-0015A)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
// 0016     GAME( 2004, avalons20,triforce, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon 2.0 - Eutaxy and Commandment (server) (GDT-0016)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
// 0017     GAME( 2004, avalon20o,avalon20, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon 2.0 - Eutaxy and Commandment (client) (GDT-0017)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
// 0017A    GAME( 2004, avalon20a,avalon20, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon 2.0 - Eutaxy and Commandment (client, Rev A) (GDT-0017A)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0017B */ GAME( 2004, avalon20, triforce, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon 2.0 - Eutaxy and Commandment (client, Rev B) (GDT-0017B)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
// 0018     GAME( 2005, avalns25o,avalns25, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon 2.5 - War of the Key (server) (GDT-0018)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0018A */ GAME( 2005, avalns25a,avalns25, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon 2.5 - War of the Key (server, Rev A) (GDT-0018A)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0018B */ GAME( 2005, avalns25, triforce, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon 2.5 - War of the Key (server, Rev B) (GDT-0018B)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
// 0019     GAME( 2005, avalnc25o,avalnc25, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon 2.5 - War of the Key (client) (GDT-0019)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0019A */ GAME( 2005, avalnc25a,avalnc25, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon 2.5 - War of the Key (client, Rev A) (GDT-0019A)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0019B */ GAME( 2005, avalnc25, triforce, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega / Hitmaker",                    "The Key Of Avalon 2.5 - War of the Key (client, Rev B) (GDT-0019B)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
// 0020     GAME( 2006, vs42006o, vs42006,  triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega",                               "Virtua Striker 4 Ver.2006 (Japan) (GDT-0020)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
// 0020A    GAME( 2006, vs42006a, vs42006,  triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega",                               "Virtua Striker 4 Ver.2006 (Japan, Rev A) (GDT-0020A)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0020B */ GAME( 2006, vs42006b, vs42006,  triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega",                               "Virtua Striker 4 Ver.2006 (Japan, Rev B) (GDT-0020B)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
// 0020C    GAME( 2006, vs42006c, vs42006,  triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega",                               "Virtua Striker 4 Ver.2006 (Japan, Rev C) (GDT-0020C)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0020D */ GAME( 2006, vs42006,  triforce, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega",                               "Virtua Striker 4 Ver.2006 (Japan, Rev D) (GDT-0020D)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0021  */ GAME( 2006, vs42k6ex, triforce, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega",                               "Virtua Striker 4 Ver.2006 (Export) (GDT-0021)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
// 0022     GAME( 2006, tcfboxo,  tcfboxa,  triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega",                               "Triforce Firmware Update For Compact Flash Box (GDT-0022)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 0022A */ GAME( 2009, tcfboxa,  triforce, triforcegd,    triforce, triforce_state, empty_init, ROT0, "Sega",                               "Triforce Firmware Update For Compact Flash Box (4.01) (GDT-0022A)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )

// 837-xxxxx (Sega cart games)
/* 14343-4S1  */ GAME( 2003, fzeroaxm, triforce, triforce_base, triforce, triforce_state, empty_init, ROT0, "Sega / Amusement Vision / Nintendo", "F-Zero AX Monster Ride", MACHINE_NO_SOUND | MACHINE_NOT_WORKING ) // 2003/09/04
/* 14343-4T1  */ GAME( 2005, mkartagp, triforce, triforce_base, triforce, triforce_state, empty_init, ROT0, "Namco / Nintendo", "Mario Kart Arcade GP (Japan, MKA1 Ver.A1)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 14343-4T1  */ GAME( 2006, mkartagpc,mkartagp, triforce_base, triforce, triforce_state, empty_init, ROT0, "Namco / Nintendo", "Mario Kart Arcade GP (Japan, MKA1 Ver.C, update)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 14343-R4S0 */ GAME( 2007, mkartag2, triforce, triforce_base, triforce, triforce_state, empty_init, ROT0, "Namco / Nintendo", "Mario Kart Arcade GP 2 (Japan, MK21 Ver.A)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
/* 14343-R4S0 */ GAME( 2007, mkartag2a,mkartag2, triforce_base, triforce, triforce_state, empty_init, ROT0, "Namco / Nintendo", "Mario Kart Arcade GP 2 (Japan, MK21 Ver.A, alt dump)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING )
