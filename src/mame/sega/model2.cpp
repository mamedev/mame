...
GAME( 1994, daytona,    0,        daytona,      daytona,   model2o_state,      empty_init, ROT0, "Sega", "Daytona USA (Revision A)", MACHINE_IMPERFECT_CONTROLS )
GAME( 1994, daytonase,  daytona,  daytona,      daytona,   model2o_state,      empty_init, ROT0, "Sega", "Daytona USA Special Edition (Revision A)", MACHINE_IMPERFECT_CONTROLS )
GAME( 1993, daytona93,  daytona,  daytona,      daytona,   model2o_state,      empty_init, ROT0, "Sega", "Daytona USA", MACHINE_IMPERFECT_CONTROLS )
GAME( 1994, daytonas,   daytona,  daytona,      daytona,   model2o_state,      empty_init, ROT0, "Sega", "Daytona USA (with Saturn advertisements)", MACHINE_IMPERFECT_CONTROLS | MACHINE_IMPERFECT_CONTROLS )
GAME( 1994?,daytonat,   daytona,  daytona,      daytona,   model2o_state,      empty_init, ROT0, "hack (Kyle Hodgetts)", "Daytona USA (Turbo hack, set 1)", MACHINE_NOT_WORKING | MACHINE_IMPERFECT_CONTROLS )
GAME( 1994?,daytonata,  daytona,  daytona,      daytona,   model2o_state,      empty_init, ROT0, "hack (Kyle Hodgetts)", "Daytona USA (Turbo hack, set 2)", MACHINE_NOT_WORKING | MACHINE_IMPERFECT_CONTROLS )
GAME( 2001, daytonam,   daytona,  daytona_maxx, daytona,   model2o_maxx_state, empty_init, ROT0, "hack (Kyle Hodgetts)", "Daytona USA (To The MAXX)", MACHINE_NOT_WORKING | MACHINE_IMPERFECT_CONTROLS )
GAME( 2003, daytonagtx, daytona,  daytona_gtx,  daytona,   model2o_gtx_state,  empty_init, ROT0, "hack (Kyle Hodgetts)", "Daytona USA (GTX 2004 Edition)", MACHINE_NOT_WORKING | MACHINE_IMPERFECT_CONTROLS )
