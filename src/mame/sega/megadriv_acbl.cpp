...
GAME( 1995, contrambc, 0,        conny,      conny,    md_conny_state,         init_conny_bit6<0x860000>, ROT0, "bootleg (Conny / Chuangyi)", "Contra (Conny bootleg of Mega Drive version)", MACHINE_NOT_WORKING ) // has shuffled levels compared to retail, test me
...
GAME( 1996, mickeycmb, 0,        conny,      conny,    md_conny_state,         init_conny_bit7<0x8c0000>, ROT0, "bootleg (Conny)",            "The Great Hongyun Shu 1996 (Conny bootleg of Mega Drive version)", MACHINE_NOT_WORKING ) // test me
