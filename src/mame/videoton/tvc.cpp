...
static INPUT_PORTS_START( tvc )
	...
	PORT_BIT(0x20, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME(u8"Í") PORT_CODE(KEYCODE_1_PAD)   PORT_CHAR(0x00cd)
	...
	PORT_BIT(0x08, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME(u8"ü") PORT_CODE(KEYCODE_2_PAD)   PORT_CHAR(0x00fc)
	PORT_BIT(0x10, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME("*") PORT_CODE(KEYCODE_ASTERISK)  PORT_CHAR('*')
	PORT_BIT(0x20, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME(u8"ó") PORT_CODE(KEYCODE_3_PAD)   PORT_CHAR(0x00f3)
	PORT_BIT(0x40, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME(u8"ö") PORT_CODE(KEYCODE_4_PAD)   PORT_CHAR(0x00f6)
	...
	PORT_BIT(0x08, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME(u8"ő") PORT_CODE(KEYCODE_5_PAD)   PORT_CHAR(0x0151)
	PORT_BIT(0x10, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME("[") PORT_CODE(KEYCODE_OPENBRACE) PORT_CHAR('[')  PORT_CHAR('{')
	PORT_BIT(0x20, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME(u8"ú") PORT_CODE(KEYCODE_6_PAD)   PORT_CHAR(0x00fa)
	...
	PORT_BIT(0x08, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME(u8"á") PORT_CODE(KEYCODE_7_PAD)   PORT_CHAR(0x00e1)
	PORT_BIT(0x10, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME("Enter") PORT_CODE(KEYCODE_ENTER) PORT_CHAR(13)
	PORT_BIT(0x20, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME(u8"ű") PORT_CODE(KEYCODE_8_PAD)   PORT_CHAR(0x0171)
	PORT_BIT(0x40, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME(u8"é") PORT_CODE(KEYCODE_9_PAD)   PORT_CHAR(0x00e9)
