...
ROM_START( ncv1 )
	ROM_REGION( 0x100000,RGNCLASS_CPU, "main", 0 )		/* 16MB for Main CPU */
...
ROM_START( ncv2 )
	...
	ROM_REGION( 0x400000,RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )	/* 4MB character generator */
