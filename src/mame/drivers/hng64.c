...
static ADDRESS_MAP_START( hng_map, ADDRESS_SPACE_PROGRAM, 32 )
	...
	AM_RANGE(0x04000000, 0x05ffffff) AM_WRITENOP AM_ROM AM_REGION(RGNCLASS_USER, "user3",0) AM_BASE(&hng_cart)
...
//  AM_RANGE(0x1F7021C4, 0x1F7021C7) AM_WRITE(SMH_NOP)        // ?? often
	...
	// BIOS
	AM_RANGE(0x1fc00000, 0x1fc7ffff) AM_WRITENOP AM_ROM AM_REGION(RGNCLASS_USER, "user1", 0) AM_BASE(&rombase)
...
{
	int i ;
	const UINT8 *rom = memory_region(machine, RGNCLASS_USER, "user2");
...
ROM_START( hng64 )
	ROM_REGION32_BE( 0x0100000, RGNCLASS_USER, "user1", 0 ) /* 512k for R4300 BIOS code */
	ROM_LOAD ( "brom1.bin", 0x000000, 0x080000,  CRC(a30dd3de) SHA1(3e2fd0a56214e6f5dcb93687e409af13d065ea30) )
	ROM_REGION( 0x0100000, RGNCLASS_USER, "user2", 0 ) /* KL5C80 BIOS and unknown ROM */
	...
	/* To placate MAME */
	ROM_REGION32_LE( 0x2000000, RGNCLASS_USER, "user3", ROMREGION_ERASEFF ) /* Program Code, mapped at ??? maybe banked?  LE? */
	ROM_REGION( 0x4000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE | ROMREGION_ERASEFF )
	ROM_REGION( 0x4000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE | ROMREGION_ERASEFF )
	ROM_REGION( 0x1000000, RGNCLASS_GFX, "gfx3", ROMREGION_ERASEFF )
	ROM_REGION16_BE( 0x0c00000, RGNCLASS_GFX, "gfx4", ROMREGION_ERASEFF )
	ROM_REGION( 0x1000000, RGNCLASS_SOUND, "samples", ROMREGION_ERASEFF ) /* Sound Samples? */
ROM_END
...
ROM_START( roadedge )
	...
	ROM_REGION32_LE( 0x2000000, RGNCLASS_USER, "user3", 0 ) /* Program Code, mapped at ??? maybe banked?  LE? */
	...
	/* X,Y,Z Vertex ROMs */
	ROM_REGION( 0x0c00000, RGNCLASS_GFX, "gfx4", ROMREGION_NODISPOSE )
	...
	ROM_REGION( 0x1000000, RGNCLASS_SOUND, "samples", ROMREGION_DISPOSE ) /* Sound Samples? */
...
ROM_START( sams64_2 )
	...
	/* Scroll Characters 8x8x8 / 16x16x8 */
	ROM_REGION( 0x4000000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )
	...
	/* Sprite Characters - 8x8x8 / 16x16x8 */
	ROM_REGION( 0x4000000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE )
	...
	/* X,Y,Z Vertex ROMs */
	ROM_REGION( 0x1800000, RGNCLASS_GFX, "gfx4", ROMREGION_NODISPOSE )
...
ROM_START( fatfurwa )
	...
	/* X,Y,Z Vertex ROMs */
	ROM_REGION16_BE( 0x0c00000, RGNCLASS_GFX, "gfx4", ROMREGION_NODISPOSE )
