...
ROM_START( skyraid )
	...
	ROM_REGION( 0x0200, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) /* alpha numerics */
	ROM_LOAD( "030598.h2", 0x0000, 0x200, CRC(2a7c5fa0) SHA1(93a79e5948dfcd9b6c2ff390e85a43f7a8cac327) )

	ROM_REGION( 0x0800, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE ) /* sprites */
	ROM_LOAD( "030599.m7", 0x0000, 0x800, CRC(0cd179ea) SHA1(e3c763f76e6103e5909e7b5a979206b262d6e96a) )

	ROM_REGION( 0x0100, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE ) /* missiles */
	...
	ROM_REGION( 0x0800, RGNCLASS_USER, "user1", 0 ) /* terrain */
	...
	ROM_REGION( 0x0100, RGNCLASS_USER, "user2", 0 ) /* trapezoid */
