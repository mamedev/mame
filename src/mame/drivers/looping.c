...
ROM_START( looping )
	ROM_REGION( 0x8000, RGNCLASS_CPU, "main", 0 ) /* TMS9995 code */
	...
	ROM_REGION( 0x3800, RGNCLASS_CPU, "audio", 0 ) /* TMS9980 code */
	...
	ROM_REGION( 0x1000, RGNCLASS_CPU, "mcu", 0 ) /* COP420 microcontroller code */
	...
	ROM_REGION( 0x0020, RGNCLASS_PROMS, "proms", 0 ) /* color prom */
