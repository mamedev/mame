...
static INPUT_PORTS_START( nwktr )
	...
	PORT_DIPNAME( 0x40, 0x00, "Disable Machine Init" ) PORT_DIPLOCATION("SW:2") // Having this on disables force feedback for all games
	...
	PORT_START("ANALOG1")
	PORT_BIT( 0x7ff, 0x400, IPT_PADDLE ) PORT_PLAYER(1) PORT_NAME("Steering Wheel") PORT_MINMAX(0x000, 0x7ff) PORT_SENSITIVITY(100) PORT_KEYDELTA(60)

	PORT_START("ANALOG2")
	PORT_BIT( 0x7ff, 0x000, IPT_PEDAL ) PORT_PLAYER(1) PORT_NAME("Gas Pedal") PORT_MINMAX(0x000, 0x7ff) PORT_SENSITIVITY(100) PORT_KEYDELTA(60)

	PORT_START("ANALOG3")
	PORT_BIT( 0x7ff, 0x000, IPT_PEDAL2 ) PORT_PLAYER(1) PORT_NAME("Brake Pedal") PORT_MINMAX(0x000, 0x7ff) PORT_SENSITIVITY(100) PORT_KEYDELTA(60)

	PORT_START("ANALOG4")
	PORT_BIT( 0x7ff, 0x000, IPT_PEDAL3 ) PORT_PLAYER(1) PORT_NAME("Handbrake Lever") PORT_MINMAX(0x000, 0x7ff) PORT_SENSITIVITY(100) PORT_KEYDELTA(60)

	PORT_START("ANALOG5")
	PORT_BIT( 0x7ff, 0x000, IPT_PEDAL ) PORT_PLAYER(2) PORT_NAME("Clutch Pedal") PORT_MINMAX(0x000, 0x7ff) PORT_SENSITIVITY(100) PORT_KEYDELTA(60)
INPUT_PORTS_END
