...
*/
	...
	prom_6330 = memory_region(machine, RGNCLASS_PROMS, "proms");
...
ROM_START( benberob )
	ROM_REGION( 0x10000, RGNCLASS_CPU, "main", 0 ) //MAIN PRG
	...
	ROM_REGION( 0x10000, RGNCLASS_CPU, "audio", 0 ) //SOUND
	ROM_LOAD( "a26_12.5",    0x0000, 0x4000, CRC(7fd728f3) SHA1(772c14d9254e43a56f1e67ad4dd5d7840df50e34) )

	ROM_REGION( 0x20000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) //CHR
	...
	ROM_REGION( 0x0060, RGNCLASS_PROMS, "proms", 0 ) //COLOR (all identical!)
...
static void init_common(running_machine *machine)
{
	...
	rom = cpu1_base = memory_region(machine, RGNCLASS_CPU, "main");
	buf = gfx1_base;
