...
static MACHINE_CONFIG_START( qix_base, qix_state )
	...
	MCFG_PIA6821_READPA_HANDLER(IOPORT("P1"))
	MCFG_PIA6821_READPB_HANDLER(IOPORT("COIN"))

	MCFG_DEVICE_ADD("pia1", PIA6821, 0)
	MCFG_PIA6821_READPA_HANDLER(IOPORT("SPARE"))
	MCFG_PIA6821_READPB_HANDLER(IOPORT("IN0"))

	MCFG_DEVICE_ADD("pia2", PIA6821, 0)
	MCFG_PIA6821_READPA_HANDLER(IOPORT("P2"))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(qix_state, qix_coinctl_w))
...
static MACHINE_CONFIG_DERIVED( mcu, qix )
	...
	MCFG_PIA6821_READPB_HANDLER(READ8(qix_state, qixmcu_coin_r))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(qix_state, qixmcu_coin_w))

	MCFG_DEVICE_MODIFY("pia2")
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(qix_state, qixmcu_coinctrl_w))
MACHINE_CONFIG_END
...
static MACHINE_CONFIG_DERIVED( slither, qix_base )
	...
	MCFG_DEVICE_MODIFY("pia1")
	MCFG_PIA6821_READPA_HANDLER(READ8(qix_state, slither_trak_lr_r))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(qix_state, slither_76489_0_w))

	MCFG_DEVICE_MODIFY("pia2")
	MCFG_PIA6821_READPA_HANDLER(READ8(qix_state, slither_trak_ud_r))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(qix_state, slither_76489_1_w))
