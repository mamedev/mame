...
static MACHINE_CONFIG_START( qix_base, qix_state )
	...
	MCFG_CPU_ADD("maincpu", M6809E, MAIN_CLOCK_OSC/4/4)  /* 1.25 MHz */
...
GAME( 1982, kram3,    kram,     kram3,    kram,     qix_state,     kram3,    ROT0,   "Taito America Corporation", "Kram (encrypted)", GAME_NOT_WORKING | GAME_SUPPORTS_SAVE )
