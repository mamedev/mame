...
static ADDRESS_MAP_START( ps3v1_writemem, ADDRESS_SPACE_PROGRAM, 32 )
	...
	AM_RANGE(0x02000000, 0x021fffff) AM_WRITE(SMH_ROM) // data ROM
	AM_RANGE(0x03000000, 0x03003fff) AM_WRITE(SMH_RAM) AM_BASE(&spriteram32) AM_SIZE(&spriteram_size)	// sprites (might be a bit longer)
...
ROM_START( soldivid )
	...
	ROM_REGION( 0x3800000, RGNCLASS_GFX, "gfx1", ROMTEST_GFX )
	/* This Space Empty! */
	...
	ROM_REGION( 0x400000, RGNCLASS_SOUND, "ymf", 0 )
...
ROM_START( s1945ii )
	...
	ROM_REGION( 0x2000000, RGNCLASS_GFX, "gfx1", ROMTEST_GFX )	/* Tiles */
	...
	ROM_REGION( 0x800000, RGNCLASS_SOUND, "ymf", 0 ) /* Samples */
...
ROM_START( daraku )
	...
	ROM_REGION( 0x3400000, RGNCLASS_GFX, "gfx1", ROMTEST_GFX )
...
ROM_START( sbomberb )
	...
	ROM_REGION( 0x2800000, RGNCLASS_GFX, "gfx1", ROMTEST_GFX )
...
ROM_START( dragnblz )
	...
	ROM_REGION( 0x2c00000, RGNCLASS_GFX, "gfx1", ROMTEST_GFX )	/* Sprites */
...
ROM_START( mjgtaste )
	...
	ROM_REGION( 0x2c00000, RGNCLASS_GFX, "gfx1", ROMTEST_GFX | ROMREGION_ERASE00 )	/* Sprites */
...
//  ROM_LOAD32_WORD( "10h.u59",0x2800002, 0x200000, CRC(30e304c4) SHA1(1d866276bfe7f7524306a880d225aaf11ac2e5dd) ) /* From Dragon Blaze */
	...
	ROM_REGION( 0x800000, RGNCLASS_SOUND, "ymf", 0 ) /* Samples - Not Dumped */
