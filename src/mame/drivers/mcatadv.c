...
{
	UINT8 *rom = memory_region(machine, RGNCLASS_CPU, "sound") + 0x10000;
...
{
	UINT8 *z80rom = memory_region(machine, RGNCLASS_CPU, "sound") + 0x10000;
...
ROM_START( mcatadv )
	ROM_REGION( 0x100000, RGNCLASS_CPU, "main", 0 ) /* M68000 */
	...
	ROM_REGION( 0x80000, RGNCLASS_SOUND, "ym", 0 ) /* Samples - ADPCM or Delta-T? */
...
ROM_START( catt )
	...
	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx2", 0 ) /* BG0 */
	...
	ROM_REGION( 0x100000, RGNCLASS_SOUND, "ym", 0 ) /* Samples - ADPCM or Delta-T? */
...
ROM_START( nost )
	...
	ROM_REGION( 0x050000, RGNCLASS_CPU, "sound", 0 ) /* Z80-A */
	...
	ROM_REGION( 0x180000, RGNCLASS_GFX, "gfx2", 0 ) /* BG0 */
	...
	ROM_REGION( 0x180000, RGNCLASS_GFX, "gfx3", 0 ) /* BG1 */
