...
{
	memory_configure_bank(1, 0, 2, memory_region(machine, RGNCLASS_GFX, "gfx1"), 0x2000);
...
ROM_START( kangaroo )
	...
	ROM_REGION( 0x0800, RGNCLASS_CPU, "mcu", 0 )	/* code for the 8841 custom MCU */
	ROM_LOAD( "8841.rom",    0x0000, 0x0800, NO_DUMP )

	ROM_REGION( 0x0800, RGNCLASS_USER, "user1", 0 )	/* data for the 8841 custom MCU */
