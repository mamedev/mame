...
ROM_START( marble )
	ROM_REGION( 0x88000, RGNCLASS_CPU, "main", 0 )	/* 8.5*64k for 68000 code & slapstic ROM */
	...
	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE | ROMREGION_INVERT | ROMREGION_ERASEFF )
	...
	ROM_REGION( 0x400, RGNCLASS_PROMS, "proms", 0 )	/* graphics mapping PROMs */
...
ROM_START( peterpak )
	...
	ROM_REGION( 0x180000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE | ROMREGION_INVERT | ROMREGION_ERASEFF )
...
ROM_START( indytemp )
	...
	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE | ROMREGION_INVERT | ROMREGION_ERASEFF )
...
ROM_START( roadrunn )
	...
	ROM_REGION( 0x300000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE | ROMREGION_INVERT | ROMREGION_ERASEFF )
...
ROM_START( roadblst )
	...
	ROM_REGION( 0x380000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE | ROMREGION_INVERT | ROMREGION_ERASEFF )
