...
ROM_START( aes )
	...
	ROM_SYSTEM_BIOS( 14, "jamma", "Hack for AES to JAMMA adapter" )
	ROM_LOAD16_WORD_SWAP_BIOS( 14, "aesjamma.bin", 0x00000, 0x020000, CRC(05e105fa) SHA1(81fc763fd0b80d1d1ace95a98f2acf7325e377ad) ) // Hack found on an AES to JAMMA adapter. Text inside the ROM: "NEO-GEO SYSTEM PROGRAM VERSION 0 COPYRIGHT BY SNK CORPORATION REVISED BY X INTERNATIONAL COMPUTER CO. 1990"
