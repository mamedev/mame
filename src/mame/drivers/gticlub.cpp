...
static INPUT_PORTS_START( gticlub_common )
	PORT_START("IN0")
...
static INPUT_PORTS_START( gticlub )
	...
	PORT_BIT( 0x3ff, 0x200, IPT_PADDLE ) PORT_NAME("Steering Wheel") PORT_MINMAX(0x000,0x3ff) PORT_SENSITIVITY(25) PORT_KEYDELTA(20)

	PORT_START("AN1")
	PORT_BIT( 0x3ff, 0x000, IPT_PEDAL ) PORT_NAME("Accelerator") PORT_MINMAX(0x000,0x3ff) PORT_SENSITIVITY(25) PORT_KEYDELTA(20)

	PORT_START("AN2")
	PORT_BIT( 0x3ff, 0x000, IPT_PEDAL2 ) PORT_NAME("Brake") PORT_MINMAX(0x000,0x3ff) PORT_SENSITIVITY(25) PORT_KEYDELTA(20)

	PORT_START("AN3")
	PORT_BIT( 0x3ff, 0x000, IPT_PEDAL3 ) PORT_NAME("Handbrake") PORT_MINMAX(0x000,0x3ff) PORT_SENSITIVITY(25) PORT_KEYDELTA(20)
...
static INPUT_PORTS_START( slrasslt )
	...
	PORT_MODIFY("IN0")
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_START1 ) PORT_NAME("View Shift")
	...
	PORT_START("AN0")
	PORT_BIT( 0x3ff, 0x000, IPT_AD_STICK_Y ) PORT_MINMAX(0x000,0x3ff) PORT_SENSITIVITY(100) PORT_KEYDELTA(25)

	PORT_START("AN1")
	PORT_BIT( 0x3ff, 0x000, IPT_AD_STICK_X ) PORT_MINMAX(0x000,0x3ff) PORT_SENSITIVITY(100) PORT_KEYDELTA(25) PORT_REVERSE
	
INPUT_PORTS_END

static INPUT_PORTS_START( thunderh ) //Temporary until analog/gun input support
	PORT_INCLUDE(gticlub_common)
...
static INPUT_PORTS_START( hangplt )
	...
	PORT_MODIFY("IN0")
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_START1 ) PORT_NAME("Start Button")
	...
	PORT_START("AN0")
	PORT_BIT( 0x3ff, 0x000, IPT_AD_STICK_X ) PORT_NAME("Rudder") PORT_MINMAX(0x000,0x3ff) PORT_SENSITIVITY(25) PORT_KEYDELTA(20) PORT_REVERSE

	PORT_START("AN1")
	PORT_BIT( 0x3ff, 0x000, IPT_AD_STICK_Y ) PORT_NAME("Control Bar") PORT_MINMAX(0x000,0x3ff) PORT_SENSITIVITY(25) PORT_KEYDELTA(20) PORT_REVERSE
