...
static MACHINE_CONFIG_START( s11, s11_state )
	...
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(s11_state, dig0_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(s11_state, dig1_w))
	...
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(s11_state, pia2c_pa_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(s11_state, pia2c_pb_w))
	MCFG_PIA6821_IRQA_HANDLER(WRITELINE(s11_state, pia_irq))
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(s11_state, pia_irq))
	...
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(s11_state, pia34_pa_w))
	...
	MCFG_PIA6821_IRQA_HANDLER(DEVWRITELINE("bgcpu", m6809_device, firq_line))
	MCFG_PIA6821_IRQB_HANDLER(DEVWRITELINE("bgcpu", m6809_device, nmi_line))
MACHINE_CONFIG_END
