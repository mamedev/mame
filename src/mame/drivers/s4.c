...
static const pia6821_interface pia0_intf =
{
	...
	DEVCB_DRIVER_LINE_MEMBER(s4_state, pia0_ca2_w),		/* line CA2 out */
	DEVCB_DRIVER_LINE_MEMBER(s4_state, pia0_cb2_w),		/* line CB2 out */
...
static const pia6821_interface pia1_intf =
{
	...
	DEVCB_DRIVER_LINE_MEMBER(s4_state, pia1_ca2_w),		/* line CA2 out */
	DEVCB_DRIVER_LINE_MEMBER(s4_state, pia1_cb2_w),		/* line CB2 out */
	DEVCB_CPU_INPUT_LINE("maincpu", M6800_IRQ_LINE),		/* IRQA */
	DEVCB_CPU_INPUT_LINE("maincpu", M6800_IRQ_LINE)		/* IRQB */
};

READ_LINE_MEMBER( s4_state::pia2_ca1_r )
{
	return BIT(ioport("DIAGS")->read(), 2); // advance button
}

READ_LINE_MEMBER( s4_state::pia2_cb1_r )
{
...
static const pia6821_interface pia2_intf =
{
	...
	DEVCB_NULL,		/* port B in */
	DEVCB_DRIVER_LINE_MEMBER(s4_state, pia2_ca1_r),		/* line CA1 in */
	DEVCB_DRIVER_LINE_MEMBER(s4_state, pia2_cb1_r),		/* line CB1 in */
	DEVCB_NULL,		/* line CA2 in */
	DEVCB_NULL,		/* line CB2 in */
	DEVCB_DRIVER_MEMBER(s4_state, dig0_w),		/* port A out */
	DEVCB_DRIVER_MEMBER(s4_state, dig1_w),		/* port B out */
	DEVCB_DRIVER_LINE_MEMBER(s4_state, pia2_ca2_w),		/* line CA2 out */
	DEVCB_DRIVER_LINE_MEMBER(s4_state, pia2_cb2_w),		/* line CB2 out */
	DEVCB_CPU_INPUT_LINE("maincpu", M6800_IRQ_LINE),		/* IRQA */
	DEVCB_CPU_INPUT_LINE("maincpu", M6800_IRQ_LINE)		/* IRQB */
};
...
static const pia6821_interface pia3_intf =
{
	...
	DEVCB_DRIVER_LINE_MEMBER(s4_state, pia3_ca2_w),		/* line CA2 out */
	DEVCB_DRIVER_LINE_MEMBER(s4_state, pia3_cb2_w),		/* line CB2 out */
	DEVCB_CPU_INPUT_LINE("maincpu", M6800_IRQ_LINE),		/* IRQA */
	DEVCB_CPU_INPUT_LINE("maincpu", M6800_IRQ_LINE)		/* IRQB */
};

READ_LINE_MEMBER( s4_state::pia4_cb1_r )
{
	return m_cb1;
}
...
static const pia6821_interface pia4_intf =
{
	...
	DEVCB_DRIVER_LINE_MEMBER(s4_state, pia4_cb1_r),		/* line CB1 in */
	DEVCB_NULL,		/* line CA2 in */
	DEVCB_NULL,		/* line CB2 in */
...
static MACHINE_CONFIG_START( s4, s4_state )
	...
	MCFG_TIMER_DRIVER_ADD_PERIODIC("irq", s4_state, irq, attotime::from_hz(1000))
...
GAME(1979,flash_l1, 0,        s4a, s4, driver_device, 0, ROT0, "Williams", "Flash (L-1)", GAME_IS_SKELETON_MECHANICAL)
GAME(1979,flash_t1, flash_l1, s4a, s4, driver_device, 0, ROT0, "Williams", "Flash (T-1) Ted Estes", GAME_IS_SKELETON_MECHANICAL)
GAME(1979,stlwr_l2, 0,        s4a, s4, driver_device, 0, ROT0, "Williams", "Stellar Wars (L-2)", GAME_MECHANICAL | GAME_NO_SOUND)
GAME(1978,pomp_l1,  0,        s4a, s4, driver_device, 0, ROT0, "Williams", "Pompeii (Shuffle) (L-1)", GAME_IS_SKELETON_MECHANICAL)
GAME(1978,arist_l1, 0,        s4a, s4, driver_device, 0, ROT0, "Williams", "Aristocrat (Shuffle) (L-1)", GAME_IS_SKELETON_MECHANICAL)
GAME(1978,topaz_l1, 0,        s4a, s4, driver_device, 0, ROT0, "Williams", "Topaz (Shuffle) (L-1)", GAME_IS_SKELETON_MECHANICAL)
GAME(1979,taurs_l1, 0,        s4a, s4, driver_device, 0, ROT0, "Williams", "Taurus (Shuffle) (L-1)", GAME_IS_SKELETON_MECHANICAL)
GAME(1979,kingt_l1, 0,        s4a, s4, driver_device, 0, ROT0, "Williams", "King Tut (Shuffle) (L-1)", GAME_IS_SKELETON_MECHANICAL)
GAME(1980,omni_l1,  0,        s4a, s4, driver_device, 0, ROT0, "Williams", "Omni (Shuffle) (L-1)", GAME_IS_SKELETON_MECHANICAL)
