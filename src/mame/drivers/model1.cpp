...
static INPUT_PORTS_START( wingwar )
	...
	PORT_BIT( 0xff, 0x01, IPT_AD_STICK_Z ) PORT_MINMAX(1,0xff) PORT_SENSITIVITY(100) PORT_KEYDELTA(16)
...
static INPUT_PORTS_START( swa )
	...
	PORT_START("AN.2")   /* Throttle */
	PORT_BIT( 0xff, 0x01, IPT_AD_STICK_Z ) PORT_MINMAX(0x01,0xff) PORT_SENSITIVITY(100) PORT_KEYDELTA(16) PORT_REVERSE
