...
static INPUT_PORTS_START( konblands )
	PORT_START("DSW1")
	PORT_DIPNAME( 0xff, 0x00, DEF_STR( Coinage ) )		PORT_DIPLOCATION("DSW1:1,2,3,4,5,6,7,8")
	PORT_DIPSETTING(    0xdd, DEF_STR( 4C_1C ) )
	PORT_DIPSETTING(    0xaa, DEF_STR( 3C_1C ) )
	PORT_DIPSETTING(    0x77, DEF_STR( 2C_1C ) )
	PORT_DIPSETTING(    0xbb, DEF_STR( 3C_2C ) )
	PORT_DIPSETTING(    0xee, DEF_STR( 4C_3C ) )
	PORT_DIPSETTING(    0x00, DEF_STR( 1C_1C ) )
	PORT_DIPSETTING(    0x88, DEF_STR( 2C_3C ) )
	PORT_DIPSETTING(    0xcc, DEF_STR( 3C_4C ) )
	PORT_DIPSETTING(    0x11, DEF_STR( 1C_2C ) )
	PORT_DIPSETTING(    0x99, DEF_STR( 2C_5C ) )
	PORT_DIPSETTING(    0x22, DEF_STR( 1C_3C ) )
	PORT_DIPSETTING(    0x33, DEF_STR( 1C_4C ) )
	PORT_DIPSETTING(    0x44, DEF_STR( 1C_5C ) )
	PORT_DIPSETTING(    0x55, DEF_STR( 1C_6C ) )
	PORT_DIPSETTING(    0x66, DEF_STR( 1C_7C ) )
	PORT_DIPSETTING(    0xff, DEF_STR( Free_Play ) )
