...
public:
	...
	void controller_select_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
...
uint8_t beaminv_state::v128_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void beaminv_state::controller_select_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t beaminv_state::controller_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
