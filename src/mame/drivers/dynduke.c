...
ROM_START( dynduke )
	...
	ROM_REGION( 0x100000, RGNCLASS_CPU, "slave", 0 ) /* v30 sub cpu */
	...
	ROM_REGION( 0x20000*2, RGNCLASS_CPU, "audio", 0 ) /* sound Z80 */
	...
	ROM_REGION( 0x180000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE )
