...
{
	UINT8 *snd = memory_region(machine, RGNCLASS_SOUND, "upd");
...
ROM_START( rpunch )
	...
	ROM_REGION( 0x80000, RGNCLASS_GFX, "gfx1", ROMREGION_ERASEFF )
	...
	ROM_REGION( 0x80000, RGNCLASS_GFX, "gfx2", ROMREGION_ERASEFF )
	...
	ROM_REGION( 0x80000, RGNCLASS_GFX, "gfx3", ROMREGION_ERASEFF )
	...
	ROM_REGION( 0x60000, RGNCLASS_SOUND, "upd", 0 )
