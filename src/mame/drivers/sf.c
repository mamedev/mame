...
{
	memory_set_bankptr(1,memory_region(machine, RGNCLASS_CPU, "audio2")+0x8000*(data+1));
}
...
ROM_START( sf )
	...
	ROM_REGION( 0x10000, RGNCLASS_CPU, "audio", 0 )	/* 64k for the music CPU */
	ROM_LOAD( "sf-02.bin", 0x0000, 0x8000, CRC(4a9ac534) SHA1(933645f8db4756aa2a35a843c3ac6f93cb8d565d) )

	ROM_REGION( 0x40000, RGNCLASS_CPU, "audio2", 0 )	/* 256k for the samples CPU */
	...
	ROM_REGION( 0x1c0000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE )
...
ROM_START( sfp )
	...
	ROM_REGION( 0x10000, RGNCLASS_CPU, "audio2", 0 )	/* 256k for the samples CPU */
	...
	ROM_REGION( 0xc0000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE )
