...
ROM_START( pitbossa ) /* Program roms were hand labeled */
	ROM_REGION( 0x10000, "maincpu", 0 ) /* Roms also found labeled simply as "PBHD" U5 through U7 */
	...
	ROM_LOAD( "2214-03.u7-0",  0x4000, 0x2000, CRC(023e8cb8) SHA1(cdb180a94d801137466c13ddfaf65918cb608c5a) )
