...
static ADDRESS_MAP_START( m2_main, ADDRESS_SPACE_PROGRAM, 64 )
	...
	AM_RANGE(0xfff00000, 0xffffffff) AM_ROM AM_REGION(RGNCLASS_USER, "user1", 0) AM_SHARE(2)
ADDRESS_MAP_END
...
ROM_START(polystar)
	ROM_REGION64_BE(0x200000, RGNCLASS_USER, "user1", 0)	/* boot rom */
	ROM_LOAD16_WORD("623b01.8q", 0x000000, 0x200000, CRC(bd879f93) SHA1(e2d63bfbd2b15260a2664082652442eadea3eab6))

	ROM_REGION( 0x80, RGNCLASS_USER, "user2", 0 ) /* serial eeprom */
...
ROM_START(heatof11)
	...
	ROM_REGION( 0x2000, RGNCLASS_USER, "user2", 0 ) /* timekeeper eeprom */
...
ROM_START(evilngt)
	...
	ROM_REGION( 0x1000, RGNCLASS_USER, "user2", 0 ) /* timekeeper eeprom */
...
ROM_START(totlvice)
	...
	ROM_REGION( 0x100000, RGNCLASS_USER, "user2", 0 ) /* sound rom on sub board */
