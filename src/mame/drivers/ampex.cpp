...
static INPUT_PORTS_START( ampex )
	...
	PORT_BIT(0x20, IP_ACTIVE_HIGH, IPT_UNKNOWN) // 0x0a (cursor down?)
	...
	PORT_BIT(0x10, IP_ACTIVE_HIGH, IPT_UNKNOWN) // 0x0c (cursor right?)
	PORT_BIT(0x20, IP_ACTIVE_HIGH, IPT_UNKNOWN) // 0x1e (Home?)
	PORT_BIT(0x40, IP_ACTIVE_HIGH, IPT_UNKNOWN) // 0x7f (cursor left?)
	PORT_BIT(0x80, IP_ACTIVE_HIGH, IPT_UNUSED)
	...
	PORT_BIT(0x20, IP_ACTIVE_HIGH, IPT_UNKNOWN) // 0x0b (cursor up?)
	PORT_BIT(0x40, IP_ACTIVE_HIGH, IPT_UNKNOWN) // 0x08 (Line Ins?)
	PORT_BIT(0x80, IP_ACTIVE_HIGH, IPT_UNUSED)
