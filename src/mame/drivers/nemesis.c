...
static ADDRESS_MAP_START( hcrash_map, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0x102000, 0x102fff) AM_READ(SMH_RAM) AM_WRITE(nemesis_videoram2b_word_w) AM_BASE(&nemesis_videoram2b)	/* VRAM 2 */
	AM_RANGE(0x103000, 0x103fff) AM_READ(SMH_RAM) AM_WRITE(nemesis_videoram2f_word_w) AM_BASE(&nemesis_videoram2f)	/* VRAM 2 */
	...
	AM_RANGE(0x190000, 0x1903ff) AM_READ(SMH_RAM) AM_WRITE(SMH_RAM) AM_BASE(&nemesis_xscroll1)
	AM_RANGE(0x190400, 0x1907ff) AM_READ(SMH_RAM) AM_WRITE(SMH_RAM) AM_BASE(&nemesis_xscroll2)
	AM_RANGE(0x190800, 0x190eff) AM_RAM			/* not used */
	AM_RANGE(0x190f00, 0x190f7f) AM_READ(SMH_RAM) AM_WRITE(SMH_RAM) AM_BASE(&nemesis_yscroll1)
	AM_RANGE(0x190f80, 0x190fff) AM_READ(SMH_RAM) AM_WRITE(SMH_RAM) AM_BASE(&nemesis_yscroll2)
...
ROM_START( nemesis )
	ROM_REGION( 0x40000, RGNCLASS_CPU, "main", 0 )    /* 4 * 64k for code and rom */
	...
	ROM_REGION( 0x10000, RGNCLASS_CPU, "audio", 0 )    /* 64k for sound */
	ROM_LOAD(      "456-d09.9c",   0x00000, 0x4000, CRC(26bf9636) SHA1(009dcbf18ea6230fc75a72232bd4fc29ad28dbf0) )

	ROM_REGION( 0x0200,  RGNCLASS_SOUND, "konami", 0 )      /* 2x 256 byte for 0005289 wavetable data */
...
ROM_START( rf2 )
	ROM_REGION( 0xc0000, RGNCLASS_CPU, "main", 0 )    /* 5 * 64k for code and rom */
...
ROM_START( salamand )
	...
	ROM_REGION( 0x04000, RGNCLASS_SOUND, "vlm", 0 )    /* VLM5030 data? */
	ROM_LOAD(      "587-d08.8g",       0x00000, 0x04000, CRC(f9ac6b82) SHA1(3370fc3a7f82e922e19d54afb3bca7b07fa4aa9a) )

	ROM_REGION( 0x20000, RGNCLASS_SOUND, "konami", 0 )    /* 007232 data */
...
ROM_START( citybomb )
	ROM_REGION( 0x1c0000, RGNCLASS_CPU, "main", 0 )
	...
	ROM_REGION( 0x80000, RGNCLASS_SOUND, "konami1", 0 )    /* 007232 data */
...
ROM_START( kittenk )
	ROM_REGION( 0x140000, RGNCLASS_CPU, "main", 0 )
...
ROM_START( hcrash )
	...
	ROM_REGION( 0x80000, RGNCLASS_SOUND, "vlm", 0 )  /* VLM5030 data data */
	...
	ROM_REGION( 0x80000, RGNCLASS_SOUND, "konami", 0 )  /* 007232 data */
