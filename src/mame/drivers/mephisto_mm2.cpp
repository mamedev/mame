...
ROM_START( mm2c )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD("mm2c_1.bin", 0x8000, 0x4000, CRC(e2daac82) SHA1(c9fa59ca92362f8ee770733073bfa2ab8c7904ad) )
	ROM_LOAD("mm2c_2.bin", 0xc000, 0x4000, CRC(5e296939) SHA1(badd2a377259cf738cd076d8fb245c3dc284c24d) )
ROM_END
