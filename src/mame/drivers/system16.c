...
{
	UINT8 *mem = memory_region(machine, RGNCLASS_CPU, "sound");
...
static ADDRESS_MAP_START( sound_readmem_7759, ADDRESS_SPACE_PROGRAM, 8 )
	AM_RANGE(0x0000, 0x7fff) AM_READ(SMH_ROM)
	AM_RANGE(0x8000, 0xdfff) AM_READ(SMH_BANK1)
	AM_RANGE(0xe800, 0xe800) AM_READ(soundlatch_r)
	AM_RANGE(0xf800, 0xffff) AM_READ(SMH_RAM)
ADDRESS_MAP_END
...
{
	int offs, size = memory_region_length(machine, RGNCLASS_CPU, "sound") - 0x10000;

	upd7759_reset_w(0, data & 0x40);
	offs = 0x10000 + (data * 0x4000) % size;
	memory_set_bankptr(1, memory_region(machine, RGNCLASS_CPU, "sound") + offs);
}
...
static DRIVER_INIT( tturfbl )
{
	...
	mem = memory_region(machine, RGNCLASS_CPU, "sound");
...
ROM_START( bayrtbl1 )
	ROM_REGION( 0xc0000, RGNCLASS_CPU, "main", 0 ) /* 68000 code */
	...
	ROM_REGION( 0x30000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE | ROMREGION_INVERT ) /* tiles */
	...
	ROM_REGION( 0x80000, RGNCLASS_GFX, "gfx2", 0 ) /* sprites */
	...
	ROM_REGION( 0x50000, RGNCLASS_CPU, "sound", 0 ) /* sound CPU */
...
ROM_START( bayrtbl2 )
	...
	ROM_REGION( 0x080000, RGNCLASS_GFX, "gfx2", 0 ) /* sprites */
...
// sys16B
ROM_START( dduxbl )
	ROM_REGION( 0x0c0000, RGNCLASS_CPU, "main", 0 ) /* 68000 code */
	...
	ROM_REGION( 0xa0000, RGNCLASS_GFX, "gfx2", 0 ) //* sprites */
	...
	ROM_REGION( 0x10000, RGNCLASS_CPU, "sound", 0 ) /* sound CPU */
...
ROM_START( eswatbl )
	...
	ROM_REGION( 0xc0000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) /* tiles */
	...
	ROM_REGION( 0x180000, RGNCLASS_GFX, "gfx2", 0 ) /* sprites */
...
// sys16B
ROM_START( fpointbl )
	ROM_REGION( 0x020000, RGNCLASS_CPU, "main", 0 ) /* 68000 code */
...
// protected code
	...
	ROM_REGION( 0x60000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE | ROMREGION_INVERT ) /* tiles */
	...
	ROM_REGION( 0x1c0000, RGNCLASS_GFX, "gfx2", 0 ) /* sprites */
	/* wrong! */
	...
	ROM_REGION( 0x30000, RGNCLASS_CPU, "sound", 0 ) /* sound CPU */
...
ROM_START( goldnab2 )
	...
	ROM_REGION( 0x20000, RGNCLASS_CPU, "sound", 0 ) /* sound CPU + samples */
...
ROM_START( passht4b )
	ROM_REGION( 0x20000, RGNCLASS_CPU, "main", 0 ) /* 68000 code */
	...
	ROM_REGION( 0x60000, RGNCLASS_GFX, "gfx2", 0 ) /* sprites */
	...
	ROM_REGION( 0x20000, RGNCLASS_CPU, "sound", 0 ) /* sound CPU */
...
ROM_START( passshtb )
	...
	ROM_REGION( 0x30000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) /* tiles */
...
ROM_START( shinoblb )
	...
	ROM_REGION16_BE( 0x080000, RGNCLASS_GFX, "gfx2", 0 ) /* sprites */
	...
	ROM_REGION( 0x08000, RGNCLASS_SOUND, "samples", 0 ) /* sound samples (played by what?, not the same as the original) */
...
ROM_START( shinobld )
	...
	ROM_REGION( 0x30000, RGNCLASS_GFX, "gfx1", ROMREGION_INVERT | ROMREGION_DISPOSE ) /* tiles */
	...
	ROM_REGION( 0x10000, RGNCLASS_CPU, "sound", 0 ) /* sound CPU + data */
	ROM_LOAD( "16.bin", 0x0000, 0x10000, CRC(52c8364e) SHA1(01d30b82f92498d155d2e31d43d58dff0285cce3) )
ROM_END

// sys16B
ROM_START( tetrisbl )
	ROM_REGION( 0x040000, RGNCLASS_CPU, "main", ROMREGION_ERASEFF ) /* 68000 code */
	...
	ROM_REGION( 0x020000, RGNCLASS_GFX, "gfx2", 0 ) /* sprites */
	...
	ROM_REGION( 0x40000, RGNCLASS_CPU, "sound", 0 ) /* sound CPU */
...
ROM_START( beautyb )
	ROM_REGION( 0x010000, RGNCLASS_CPU, "main", ROMREGION_ERASEFF ) /* 68000 code */
	...
	ROM_REGION( 0x020000, RGNCLASS_GFX, "gfx2", ROMREGION_ERASEFF ) /* sprites */
	/* no sprites on this */
	...
	ROM_REGION( 0x0144, RGNCLASS_USER, "user1", 0 )
