...
static MACHINE_DRIVER_START( rohga )
	...
	MDRV_CPU_ADD("audio", H6280,32220000/4/3) /* verified on pcb (8.050Mhz is XIN on pin 10 of H6280 */
...
ROM_START( rohga ) /* Asia/Europe v5.0 */
	...
	ROM_REGION( 0x600000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE )
...
ROM_START( wizdfire )
	...
	ROM_REGION( 0x400000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE )
	...
	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx5", ROMREGION_DISPOSE )
...
ROM_START( nitrobal )
	...
	ROM_REGION( 0x300000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE )
	...
	ROM_REGION( 0x80000, RGNCLASS_GFX, "gfx5", ROMREGION_DISPOSE )
...
ROM_START( schmeisr )
	...
	ROM_REGION( 0x040000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )
	/* Filled in later */

	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE ) /* Encrypted tiles */
	...
	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE ) /* Encrypted tiles */
