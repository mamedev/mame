...
{
	return (!sound_cpu_ready) ? 0x01 : 0x00;
}
...
static ADDRESS_MAP_START( main_map, ADDRESS_SPACE_PROGRAM, 8 )
	...
	AM_RANGE(0xc300, 0xc300) AM_READ_PORT("BUTTONS")
	AM_RANGE(0xc400, 0xc400) AM_READ_PORT("UNK")
	AM_RANGE(0xc500, 0xc500) AM_READ_PORT("DSW")
...
static GFXDECODE_START( mainsnk )
	...
	GFXDECODE_ENTRY( "gfx2", 0x0, sprite_layout,	0, 16 )
GFXDECODE_END
...
GAME( 1985, canvas,    0,   canvas,  canvas,  0,   ROT0, "SNK", "Canvas Croquis", GAME_IMPERFECT_GRAPHICS) // some gfx banks might be wrong...
