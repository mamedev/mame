...
static INPUT_PORTS_START( jwildb52 )
	...
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x04, 0x04, "Max P? 2" )          PORT_DIPLOCATION("SW1:3")  // unknown
	PORT_DIPSETTING(    0x04, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x08, 0x08, "S-Credit" )          PORT_DIPLOCATION("SW1:4")  // unknown
	PORT_DIPSETTING(    0x08, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x10, 0x10, "Double Down Bet" )   PORT_DIPLOCATION("SW1:5")  // OK
	PORT_DIPSETTING(    0x10, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x20, 0x20, "D.D.C." )            PORT_DIPLOCATION("SW1:6")  // double down something???
	PORT_DIPSETTING(    0x20, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x40, 0x40, "Pay Out" )           PORT_DIPLOCATION("SW1:7")  // OK
	PORT_DIPSETTING(    0x40, "Credits Only" )
	PORT_DIPSETTING(    0x00, "Credits / Coins" )
...
static INPUT_PORTS_START( jwildb52a )
	...
	PORT_MODIFY("DSW1")
	PORT_DIPNAME( 0x01, 0x01, "Music" )              PORT_DIPLOCATION("SW1:1")  // unknown
	PORT_DIPSETTING(    0x01, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x02, 0x02, "Progressive Jackpot" ) PORT_DIPLOCATION("SW1:2")  // OK
	PORT_DIPSETTING(    0x02, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x04, 0x04, "Max P" )             PORT_DIPLOCATION("SW1:3")  // unknown
	PORT_DIPSETTING(    0x04, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x08, 0x08, "S-Credit" )          PORT_DIPLOCATION("SW1:4")  // unknown
	PORT_DIPSETTING(    0x08, DEF_STR( Off ) )
	...
	PORT_DIPSETTING(    0x20, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x40, 0x40, "Pay Out" )           PORT_DIPLOCATION("SW1:7")  // re-check
	PORT_DIPSETTING(    0x40, "Credits Only" )
	PORT_DIPSETTING(    0x00, "Credits / Coins" )
	PORT_DIPNAME( 0x80, 0x80, "Odds Table" )        PORT_DIPLOCATION("SW1:8")  // OK
	PORT_DIPSETTING(    0x80, DEF_STR( On ) )
	...
	PORT_DIPSETTING(    0x04, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x08, 0x08, "ATP" )               PORT_DIPLOCATION("SW2:4")  // attendant to pay?
	PORT_DIPSETTING(    0x08, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x10, 0x10, "Speed" )             PORT_DIPLOCATION("SW2:5")  // unknown
	PORT_DIPSETTING(    0x10, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x20, 0x20, "Invert Winning Card Colors" ) PORT_DIPLOCATION("SW2:6")  // OK
	PORT_DIPSETTING(    0x20, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0xc0, 0xc0, "Max Coin In" )       PORT_DIPLOCATION("SW2:7,8")  // OK
	PORT_DIPSETTING(    0x00, "10" )
...
GAMEL( 199?, jwildb52a, jwildb52, jwildb52, jwildb52a, sigmab52_state, jwildb52, ROT0, "Sigma", "Joker's Wild (B52 system, set 2)",        GAME_NOT_WORKING, layout_sigmab52 )
