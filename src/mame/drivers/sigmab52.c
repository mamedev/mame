...
static INPUT_PORTS_START( jwildb52 )
	...
	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_POKER_HOLD2 )    PORT_IMPULSE(1)
	...
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_GAMBLE_SERVICE ) PORT_NAME("Books") PORT_TOGGLE
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_OTHER ) PORT_CODE(KEYCODE_R) PORT_NAME("Reset")
	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_OTHER ) PORT_CODE(KEYCODE_T) PORT_NAME("Last") PORT_TOGGLE
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_GAMBLE_DOOR ) PORT_NAME("Machine Door")
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_SERVICE )
	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_OTHER ) PORT_CODE(KEYCODE_J) PORT_NAME("Hopper Weight Switch")
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_OTHER )  // Hold 1

	PORT_START("IN2")
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_OTHER ) PORT_CODE(KEYCODE_W) PORT_NAME("Attendant Call")
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_OTHER )  // Hold 2
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_OTHER ) PORT_CODE(KEYCODE_Y) PORT_NAME("Drop Door")
	...
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_OTHER ) PORT_CODE(KEYCODE_K) PORT_NAME("Meter Wire")

	PORT_START("IN3")
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_OTHER ) PORT_CODE(KEYCODE_3_PAD)
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_OTHER ) PORT_CODE(KEYCODE_4_PAD)
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_OTHER ) PORT_CODE(KEYCODE_5_PAD)
	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_OTHER ) PORT_CODE(KEYCODE_6_PAD)
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_OTHER ) PORT_CODE(KEYCODE_7_PAD)
	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_OTHER ) PORT_CODE(KEYCODE_U) PORT_NAME("Validator Door")
	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_OTHER ) PORT_CODE(KEYCODE_8_PAD)
	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_COIN1 ) PORT_CHANGED_MEMBER(DEVICE_SELF, sigmab52_state, coin_drop_start, NULL)

	PORT_START("DSW1")
	PORT_DIPNAME( 0x01, 0x01, "Max P? 1" )            PORT_DIPLOCATION("SW1:1")  // unknown
	PORT_DIPSETTING(    0x01, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x02, 0x02, "Progressive Jackpot" ) PORT_DIPLOCATION("SW1:2")  // OK
	PORT_DIPSETTING(    0x02, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x04, 0x04, "Max Hopper Payout" )   PORT_DIPLOCATION("SW1:3")  // not checked
	PORT_DIPSETTING(    0x04, "400" )
	PORT_DIPSETTING(    0x00, "1000" )
	PORT_DIPNAME( 0x08, 0x08, "Credit Limit (Per 1 Game)" ) PORT_DIPLOCATION("SW1:4")  // not checked
	PORT_DIPSETTING(    0x08, "No Limit" )
	PORT_DIPSETTING(    0x00, "Up To 1200" )
	PORT_DIPNAME( 0x10, 0x10, "Double Down Bet" )      PORT_DIPLOCATION("SW1:5")  // OK
	PORT_DIPSETTING(    0x10, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x20, 0x20, "Double Down Per Hand" ) PORT_DIPLOCATION("SW1:6")  // OK
	PORT_DIPSETTING(    0x20, "Once" )
	PORT_DIPSETTING(    0x00, "Up to 10,000" )
	PORT_DIPNAME( 0x40, 0x40, "Play Mode" )         PORT_DIPLOCATION("SW1:7")  // OK
	PORT_DIPSETTING(    0x40, "Coins" )
	PORT_DIPSETTING(    0x00, "Credits" )
	PORT_DIPNAME( 0x80, 0x80, "Odds Table" )        PORT_DIPLOCATION("SW1:8")  // OK
	PORT_DIPSETTING(    0x80, DEF_STR( On ) )
	PORT_DIPSETTING(    0x00, DEF_STR( Off ) )

	PORT_START("DSW2")
	PORT_DIPNAME( 0x0f, 0x0f, "Payout Table #" )    PORT_DIPLOCATION("JW:1,2,3,4")  // OK
	PORT_DIPSETTING(    0x0f, "1" )  // Payout Table ID - BP55114-V1104
	...
	PORT_DIPNAME( 0x30, 0x00, "Top Award" )         PORT_DIPLOCATION("JW:5,6")  // OK
	PORT_DIPSETTING(    0x00, "10000" )
	PORT_DIPSETTING(    0x30, "5000" )
	PORT_DIPSETTING(    0x20, "6000" )
	PORT_DIPSETTING(    0x10, "8000" )
	PORT_DIPNAME( 0x40, 0x40, "Card Type" )         PORT_DIPLOCATION("SW1:9")  // OK
	PORT_DIPSETTING(    0x40, "Real" )
	PORT_DIPSETTING(    0x00, "Large Index" )
	PORT_DIPNAME( 0x80, 0x80, "Background Color" )  PORT_DIPLOCATION("SW1:10")  // OK
	PORT_DIPSETTING(    0x80, "Blue" )
	PORT_DIPSETTING(    0x00, "Black" ) // manual says green

	PORT_START("DSW3")
	PORT_DIPNAME( 0x07, 0x07, "Game Denomination" )     PORT_DIPLOCATION("SW2:1,2,3")  // OK
	PORT_DIPSETTING(    0x07, "Nickle" )
	PORT_DIPSETTING(    0x06, "Dime" )
	PORT_DIPSETTING(    0x05, "Quarter" )
	PORT_DIPSETTING(    0x04, "Half Dollar" )
	PORT_DIPSETTING(    0x03, "$1" )
	PORT_DIPSETTING(    0x02, "$5" )
	PORT_DIPSETTING(    0x01, "$25" )
	PORT_DIPSETTING(    0x00, "$100" )
	PORT_DIPNAME( 0x08, 0x08, "Attendant To Pay" )      PORT_DIPLOCATION("SW2:4")  // not checked
	PORT_DIPSETTING(    0x08, "Hopper & Attendant")
	PORT_DIPSETTING(    0x00, "Attendant Only" )
	PORT_DIPNAME( 0x10, 0x10, "Attendant Sound Plays" ) PORT_DIPLOCATION("SW2:5")  // not checked
	PORT_DIPSETTING(    0x10, "Once" )
	PORT_DIPSETTING(    0x00, "Continues Until Reset" )
	PORT_DIPNAME( 0x20, 0x20, "Double Down Button" )    PORT_DIPLOCATION("SW2:6")  // OK
	PORT_DIPSETTING(    0x20, "Seperate Button" )
	PORT_DIPSETTING(    0x00, "On 'Hold 1' Button" )
	PORT_DIPNAME( 0xc0, 0xc0, "Max Bet" )               PORT_DIPLOCATION("SW2:7,8")  // OK
	...
	PORT_DIPNAME( 0x40, 0x40, "Button Layout" )   PORT_DIPLOCATION("SW2:9")  // unknown
	PORT_DIPSETTING(    0x40, "A" )
	PORT_DIPSETTING(    0x00, "B" )
	PORT_DIPNAME( 0x80, 0x80, "Bank" )            PORT_DIPLOCATION("SW2:10")  // not sure exactly but needs to be on for certain sets
	PORT_DIPSETTING(    0x80, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
INPUT_PORTS_END


static INPUT_PORTS_START( jwildb52a )
	PORT_INCLUDE( jwildb52 )

	PORT_MODIFY("DSW1")
	PORT_DIPNAME( 0x01, 0x00, "Music" )              PORT_DIPLOCATION("SW1:1")  // OK - only plays every 10 minutes for 30 seconds
	PORT_DIPSETTING(    0x01, DEF_STR( Off ) )  // manual says plays at game over???
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x02, 0x02, "Progressive Jackpot" ) PORT_DIPLOCATION("SW1:2")  // OK
	PORT_DIPSETTING(    0x02, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	...
	PORT_MODIFY("DSW2")
	PORT_DIPNAME( 0x0f, 0x0f, "Payout %" )          PORT_DIPLOCATION("JW:1,2,3,4")  // OK
	PORT_DIPSETTING(    0x0c, "86" )  // Payout Table ID - WPO2001-054
	PORT_DIPSETTING(    0x0f, "88" )
	PORT_DIPSETTING(    0x0e, "90" )
	PORT_DIPSETTING(    0x0d, "92" )
	PORT_DIPSETTING(    0x0b, "94" )
	PORT_DIPSETTING(    0x07, "96" )
	PORT_DIPSETTING(    0x03, "97" )
	PORT_DIPNAME( 0x30, 0x30, "Top Award" )         PORT_DIPLOCATION("JW:5,6")  // OK
	PORT_DIPSETTING(    0x30, "5000" )
	PORT_DIPSETTING(    0x10, "4795" )
	PORT_DIPSETTING(    0x20, "4000" )
	PORT_DIPSETTING(    0x00, "2500" )
	PORT_DIPNAME( 0x40, 0x40, "Card Type" )         PORT_DIPLOCATION("SW1:9")  // OK
	PORT_DIPSETTING(    0x40, "Crest" )
	PORT_DIPSETTING(    0x00, "Sigma" )
	PORT_DIPNAME( 0x80, 0x80, "Background Color" )  PORT_DIPLOCATION("SW1:10")  // OK
	PORT_DIPSETTING(    0x80, "Blue" )
	PORT_DIPSETTING(    0x00, "Black" )

	PORT_MODIFY("DSW3")
	PORT_DIPNAME( 0x03, 0x01, "Game Denomination" ) PORT_DIPLOCATION("SW2:1,2")  // OK
	PORT_DIPSETTING(    0x01, "Nickle" )
	PORT_DIPSETTING(    0x02, "Quarter" )
	PORT_DIPSETTING(    0x03, "Credit" )
	PORT_DIPSETTING(    0x00, "$1" )
	PORT_DIPNAME( 0x04, 0x04, "Half Double Bet" )   PORT_DIPLOCATION("SW2:3")  // OK
	PORT_DIPSETTING(    0x04, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x08, 0x08, "Attendant To Pay" )  PORT_DIPLOCATION("SW2:4")  // not checked
	PORT_DIPSETTING(    0x08, "Hopper & Attendant")
	PORT_DIPSETTING(    0x00, "Attendant Only" )
	PORT_DIPNAME( 0x10, 0x10, "Speed" )             PORT_DIPLOCATION("SW2:5")  // unknown
	PORT_DIPSETTING(    0x10, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x20, 0x20, "Invert Winning Cards" ) PORT_DIPLOCATION("SW2:6")  // OK
	PORT_DIPSETTING(    0x20, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0xc0, 0xc0, "Max Coin In" )       PORT_DIPLOCATION("SW2:7,8")  // OK
	PORT_DIPSETTING(    0x00, "10" )
	PORT_DIPSETTING(    0x40, "8" )
	PORT_DIPSETTING(    0xc0, "5" )
	PORT_DIPSETTING(    0x80, "3" )
...
static INPUT_PORTS_START( s8waysfc )
	...
	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_GAMBLE_BET )     PORT_NAME("One Bet")
	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_BUTTON1 )     PORT_CODE(KEYCODE_N)     PORT_NAME("Maximum Bet")
	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_GAMBLE_PAYOUT )  PORT_NAME("Collect / Payout")

	PORT_MODIFY("DSW1")
	PORT_DIPNAME( 0x01, 0x00, "Music" )              PORT_DIPLOCATION("SW1:1")  // OK - only plays every 10 minutes for 10-12 seconds
	PORT_DIPSETTING(    0x01, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x02, 0x02, "Progressive Jackpot" ) PORT_DIPLOCATION("SW1:2")  //
	PORT_DIPSETTING(    0x02, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x04, 0x04, "Max Hopper Payout" )   PORT_DIPLOCATION("SW1:3")  // unknown
	PORT_DIPSETTING(    0x04, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x08, 0x08, "Won Credit" )        PORT_DIPLOCATION("SW1:4")  // unknown
	PORT_DIPSETTING(    0x08, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x10, 0x10, "Reel" )              PORT_DIPLOCATION("SW1:5")  // ?
	PORT_DIPSETTING(    0x10, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x20, 0x00, "Sound" )             PORT_DIPLOCATION("SW1:6")  // OK
	PORT_DIPSETTING(    0x20, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x40, 0x40, "Play Mode" )         PORT_DIPLOCATION("SW1:7")  // OK
	PORT_DIPSETTING(    0x40, "Credits" )
	PORT_DIPSETTING(    0x00, "Coins" )
	PORT_DIPNAME( 0x80, 0x80, DEF_STR( Unused ) )   PORT_DIPLOCATION("SW1:8")  // OK
	PORT_DIPSETTING(    0x80, DEF_STR( On ) )
	PORT_DIPSETTING(    0x00, DEF_STR( Off ) )

	PORT_MODIFY("DSW2")
	PORT_DIPNAME( 0x0f, 0x0f, "Payout %" )          PORT_DIPLOCATION("JW:1,2,3,4")  // OK
	PORT_DIPSETTING(    0x0f, "88" )  // Payout Table ID - DV98103-011
	PORT_DIPSETTING(    0x0e, "90" )
	PORT_DIPSETTING(    0x0d, "92" )
	PORT_DIPSETTING(    0x0b, "94" )
	PORT_DIPSETTING(    0x07, "96" )
	PORT_DIPNAME( 0x10, 0x10, DEF_STR( Unused ) )   PORT_DIPLOCATION("JW:5")  // OK
	PORT_DIPSETTING(    0x10, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x20, 0x20, DEF_STR( Unused ) )   PORT_DIPLOCATION("JW:6")  // OK
	PORT_DIPSETTING(    0x20, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
/*	PORT_DIPNAME( 0x30, 0x30, "Unknown" )           PORT_DIPLOCATION("JW:5,6")  // unknown
	PORT_DIPSETTING(    0x30, "5000" )
	PORT_DIPSETTING(    0x10, "4795" )
	PORT_DIPSETTING(    0x20, "4000" )
	PORT_DIPSETTING(    0x00, "2500" )	*/
	PORT_DIPNAME( 0x40, 0x40, DEF_STR( Unused ) )   PORT_DIPLOCATION("SW1:9")  // OK
	PORT_DIPSETTING(    0x40, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x80, 0x80, DEF_STR( Unused ) )   PORT_DIPLOCATION("SW1:10")  // OK
	PORT_DIPSETTING(    0x80, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	...
	PORT_DIPSETTING(    0x03, "Credit" )
	PORT_DIPSETTING(    0x00, "$1" )
	PORT_DIPNAME( 0x04, 0x04, DEF_STR( Unused ) )   PORT_DIPLOCATION("SW2:3")  // OK
	PORT_DIPSETTING(    0x04, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x08, 0x08, "Attendant To Pay" )      PORT_DIPLOCATION("SW2:4")  // not checked
	PORT_DIPSETTING(    0x08, "Hopper & Attendant")
	PORT_DIPSETTING(    0x00, "Attendant Only" )
	PORT_DIPNAME( 0x10, 0x10, "Reel Speed" )        PORT_DIPLOCATION("SW2:5")  // OK
	PORT_DIPSETTING(    0x10, "Slow" )
	PORT_DIPSETTING(    0x00, "Fast" )
	PORT_DIPNAME( 0x20, 0x00, "Invert Winners" )    PORT_DIPLOCATION("SW2:6")  // OK
	PORT_DIPSETTING(    0x20, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x40, 0x40, DEF_STR( Unused ) )   PORT_DIPLOCATION("SW2:7")  // OK
	PORT_DIPSETTING(    0x40, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x80, 0x80, DEF_STR( Unused ) )   PORT_DIPLOCATION("SW2:8")  // OK
	PORT_DIPSETTING(    0x80, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )

	PORT_MODIFY("DSW4")
//	PORT_BIT( 0x3f, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_DIPNAME( 0x40, 0x40, DEF_STR( Unused ) )   PORT_DIPLOCATION("SW2:9")  // OK
	PORT_DIPSETTING(    0x40, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x80, 0x80, DEF_STR( Unused ) )   PORT_DIPLOCATION("SW2:10")  // OK
	PORT_DIPSETTING(    0x80, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
INPUT_PORTS_END
...
GAMEL( 199?, jwildb52,  0,        jwildb52, jwildb52,  sigmab52_state, jwildb52, ROT0, "Sigma", "Joker's Wild (B52 system, set 1)",        GAME_NOT_WORKING, layout_sigmab52 )   // V.045NMV
GAMEL( 199?, jwildb52a, jwildb52, jwildb52, jwildb52a, sigmab52_state, jwildb52, ROT0, "Sigma", "Joker's Wild (B52 system, set 2)",        GAME_NOT_WORKING, layout_sigmab52 )  // V.031WM
GAMEL( 199?, jwildb52h, jwildb52, jwildb52, jwildb52,  sigmab52_state, jwildb52, ROT0, "Sigma", "Joker's Wild (B52 system, Harrah's GFX)", GAME_NOT_WORKING, layout_sigmab52 )   // V.045NMV
GAME ( 1989, s8waysfc,  0,        jwildb52, s8waysfc,  sigmab52_state, jwildb52, ROT0, "Sigma", "Super 8 Ways FC (Fruit combination)",     GAME_NOT_WORKING )  // V.???
