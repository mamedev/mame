...
GAME(1984,	dvlridei,	dvlrider,	zac_2,	zac_2,	zac_2,	ROT0,	"Zaccaria",				"Devil Riders (Italian speech)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1984,	dvlrideg,	dvlrider,	zac_2,	zac_2,	zac_2,	ROT0,	"Zaccaria",				"Devil Riders (German speech)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1983,	farfalla,	0,			zac_2,	zac_2,	zac_2,	ROT0,	"Zaccaria",				"Farfalla",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1983,	farfalli,	farfalla,	zac_2,	zac_2,	zac_2,	ROT0,	"Zaccaria",				"Farfalla (Italian speech)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1983,	farfallg,	farfalla,	zac_2,	zac_2,	zac_2,	ROT0,	"Zaccaria",				"Farfalla (German speech)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
...
GAME(1983,	pinchamg,	pinchamp,	zac_2,	zac_2,	zac_2,	ROT0,	"Zaccaria",				"Pinball Champ (German speech)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1983,	pinchami,	pinchamp,	zac_2,	zac_2,	zac_2,	ROT0,	"Zaccaria",				"Pinball Champ (Italian speech)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1983,	pincham7,	pinchamp,	zac_2,	zac_2,	zac_2,	ROT0,	"Zaccaria",				"Pinball Champ (7 digits)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1983,	pincha7g,	pinchamp,	zac_2,	zac_2,	zac_2,	ROT0,	"Zaccaria",				"Pinball Champ (7 digits German speech)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1983,	pincha7i,	pinchamp,	zac_2,	zac_2,	zac_2,	ROT0,	"Zaccaria",				"Pinball Champ (7 digits Italian speech)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1985,	poolcham,	0,			zac_2,	zac_2,	zac_2,	ROT0,	"Zaccaria",				"Pool Champion",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1985,	poolchai,	poolcham,	zac_2,	zac_2,	zac_2,	ROT0,	"Zaccaria",				"Pool Champion (Italian speech)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1985,	poolchap,	poolcham,	zac_2,	zac_2,	zac_2,	ROT0,	"Zaccaria",				"Pool Champion (alternate sound)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
...
GAME(1983,	tmacfzac,	tmachzac,	zac_2,	zac_2,	zac_2,	ROT0,	"Zaccaria",				"Time Machine (Zaccaria French speech)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
