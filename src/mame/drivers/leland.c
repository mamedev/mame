...
ROM_START( cerberus )
    ROM_REGION( 0x10000, RGNCLASS_CPU, "master", 0 )
    ...
    ROM_REGION( 0x10000, RGNCLASS_CPU, "slave", 0 )
	...
	ROM_REGION( 0x06000, RGNCLASS_GFX, "gfx1", 0 )
	...
	ROM_REGION( 0x20000, RGNCLASS_USER, "user1", 0 )   /* Ordering: 70/92/69/91/68/90/67/89 */
...
ROM_START( mayhem )
	ROM_REGION( 0x28000, RGNCLASS_CPU, "master", 0 )
	...
	ROM_REGION( 0x28000, RGNCLASS_CPU, "slave", 0 )
	...
	ROM_REGION( 0x0c000, RGNCLASS_GFX, "gfx1", 0 )
...
ROM_START( dangerz )
	ROM_REGION( 0x20000, RGNCLASS_CPU, "master", 0 )
...
ROM_START( basebal2 )
	ROM_REGION( 0x38000, RGNCLASS_CPU, "master", 0 )
...
ROM_START( redlin2p )
	...
	ROM_REGION( 0x80000, RGNCLASS_CPU, "slave", 0 )
	...
	ROM_REGION( 0x0300, RGNCLASS_PLDS, "plds", 0 )
...
ROM_START( offroad )
	ROM_REGION( 0x40000, RGNCLASS_CPU, "master", 0 )
...
ROM_START( offroadt )
	ROM_REGION( 0x040000, RGNCLASS_CPU, "master", 0 )
	...
	ROM_REGION( 0x90000, RGNCLASS_CPU, "slave", 0 )
...
ROM_START( pigout )
	...
	ROM_REGION( 0x080000, RGNCLASS_CPU, "slave", 0 )
	...
	ROM_REGION( 0x40000, RGNCLASS_USER, "user1", 0 )   /* Ordering: 70/92/69/91/68/90/67/89 */
...
static DRIVER_INIT( cerberus )
{
	...
	memory_set_bankptr(1, memory_region(machine, RGNCLASS_CPU, "master") + 0x2000);
	memory_set_bankptr(2, memory_region(machine, RGNCLASS_CPU, "master") + 0xa000);
	memory_set_bankptr(3, memory_region(machine, RGNCLASS_CPU, "slave") + 0x2000);
