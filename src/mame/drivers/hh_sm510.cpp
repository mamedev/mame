...
public:
	...
	void biatlon(machine_config &config);
...
void gnw_mmouse_state::biatlon(machine_config &config)
{
...
ROM_START( biatlon )
	...
	ROM_LOAD( "biatlon.svg", 0, 116377, CRC(fadf729e) SHA1(671f9496e2bfe7b4800ee7bad039485e19958428) )
ROM_END
...
CONS( 1989, biatlon,      gnw_mmouse,  0, biatlon,      gnw_mmouse,   gnw_mmouse_state,   empty_init, "bootleg (Elektronika)", "Biatlon", MACHINE_SUPPORTS_SAVE | MACHINE_REQUIRES_ARTWORK )
