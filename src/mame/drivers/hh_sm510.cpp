...
CONS( 1989, krybolov,     gnw_mmouse,  0, krybolov,     gnw_mmouse,   gnw_mmouse_state,   empty_init, "bootleg (Elektronika)", "Kot-rybolov", MACHINE_SUPPORTS_SAVE | MACHINE_REQUIRES_ARTWORK )
