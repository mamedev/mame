...
INPUT_PORTS_START( dangerex )
	PORT_START("IN0")		/* e00000 */
	PORT_BIT( 0x000f, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_SPECIAL )		// Toggle 0 - D4
	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_SPECIAL )		// Toggle 1 - D5
	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_SPECIAL )		// Step SW - D6
	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_SPECIAL )		// Freeze - D7
	...
	PORT_START("IN1")      /* e00002 */
	PORT_BIT( 0x000f, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_SPECIAL ) 		// Test Yellow - D4
	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_SPECIAL )		// Test Blue - D5
	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_SPECIAL )		// Test Blue - D6
	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_SPECIAL )		// Test Blue - D7
	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_UNUSED )
...
DRIVER_INIT_MEMBER(atarig42_state,dangerex)
{
...
GAME( 1992, dangerex, 0,        atarig42_0x400, dangerex, atarig42_state, dangerex, ROT0, "Atari Games", "Danger Express (prototype)", 0 )
