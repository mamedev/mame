...
ROM_START( roadriot )
	ROM_REGION( 0x80004, RGNCLASS_CPU, "main", 0 )	/* 68000 code */
	...
	ROM_REGION( 0x2000, RGNCLASS_CPU, "asic65", 0 )	/* ASIC65 TMS32015 code */
	ROM_LOAD( "136089-1012.3f", 0x00000, 0x0a80, CRC(7c5498e7) SHA1(9d8b235baf7b75bef8ef9b168647c5b2b80b2cb3) )

	ROM_REGION( 0x14000, RGNCLASS_CPU, "jsa", 0 )	/* 6502 code */
	...
	ROM_REGION( 0x100000, RGNCLASS_SOUND, "adpcm", 0 )	/* 1MB for ADPCM samples */
	...
	ROM_REGION( 0x0600, RGNCLASS_PROMS, "proms", ROMREGION_DISPOSE )	/* microcode for growth renderer */
...
ROM_START( guardian )
	...
	ROM_REGION16_BE( 0x600000, RGNCLASS_GFX, "gfx3", 0 )
	...
	ROM_REGION( 0x1500, RGNCLASS_PLDS, "plds", ROMREGION_DISPOSE )
...
static DRIVER_INIT( guardian )
{
	...
	*(UINT16 *)&memory_region(machine, RGNCLASS_CPU, "main")[0x80000] = 0x4E75;
