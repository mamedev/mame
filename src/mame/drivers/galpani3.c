...
ROM_START( galpani3 )
	...
	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx1", 0 ) /* Sprites - RLE encoded */
	ROM_LOAD( "gp320000.1", 0x000000, 0x200000, CRC(a0112827) SHA1(0a6c78d71b75a1d78215aab3104176aa1769b14f) )

	ROM_REGION( 0xa00000, RGNCLASS_GFX, "gfx2", 0 ) /* Backgrounds - RLE encoded */
	...
	ROM_REGION( 0x300000, RGNCLASS_SOUND, "ymz", 0 ) /* Samples */
	...
	ROM_REGION( 0x20000, RGNCLASS_USER, "user1", 0 ) /* MCU Code? */
...
{
	UINT16 *patchrom = (UINT16 *)memory_region(machine, RGNCLASS_CPU, "main");
