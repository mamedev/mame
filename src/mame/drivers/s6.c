...
static MACHINE_CONFIG_START( s6, s6_state )
	...
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(s6_state, sol0_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(s6_state, sol1_w))
	MCFG_PIA6821_CA2_HANDLER(WRITELINE(s6_state, pia22_ca2_w))
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(s6_state, pia22_cb2_w))
	...
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(s6_state, lamp0_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(s6_state, lamp1_w))
	MCFG_PIA6821_CA2_HANDLER(WRITELINE(s6_state, pia24_ca2_w))
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(s6_state, pia24_cb2_w))
	MCFG_PIA6821_IRQA_HANDLER(DEVWRITELINE("maincpu", m6800_cpu_device, irq_line))
	MCFG_PIA6821_IRQB_HANDLER(DEVWRITELINE("maincpu", m6800_cpu_device, irq_line))

	MCFG_DEVICE_ADD("pia28", PIA6821, 0)
	MCFG_PIA6821_READPA_HANDLER(READ8(s6_state, dips_r))
	MCFG_PIA6821_READCA1_HANDLER(READLINE(s6_state, pia28_ca1_r))
	MCFG_PIA6821_READCB1_HANDLER(READLINE(s6_state, pia28_cb1_r))
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(s6_state, dig0_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(s6_state, dig1_w))
	MCFG_PIA6821_CA2_HANDLER(WRITELINE(s6_state, pia28_ca2_w))
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(s6_state, pia28_cb2_w))
	MCFG_PIA6821_IRQA_HANDLER(DEVWRITELINE("maincpu", m6800_cpu_device, irq_line))
	MCFG_PIA6821_IRQB_HANDLER(DEVWRITELINE("maincpu", m6800_cpu_device, irq_line))

	MCFG_DEVICE_ADD("pia30", PIA6821, 0)
	MCFG_PIA6821_READPA_HANDLER(READ8(s6_state, switch_r))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(s6_state, switch_w))
	MCFG_PIA6821_CA2_HANDLER(WRITELINE(s6_state, pia30_ca2_w))
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(s6_state, pia30_cb2_w))
	MCFG_PIA6821_IRQA_HANDLER(DEVWRITELINE("maincpu", m6800_cpu_device, irq_line))
	MCFG_PIA6821_IRQB_HANDLER(DEVWRITELINE("maincpu", m6800_cpu_device, irq_line))
	...
	MCFG_PIA6821_READPB_HANDLER(READ8(s6_state, dac_r))
	MCFG_PIA6821_READCB1_HANDLER(READLINE(s6_state, pias_cb1_r))
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(s6_state, dac_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(s6_state, pias_pb_w))
	MCFG_PIA6821_CA2_HANDLER(WRITELINE(s6_state, pias_ca2_w))
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(s6_state, pias_cb2_w))
