...
static INPUT_PORTS_START( srollnd )
	PORT_START("IN0")
...
GAME( 1998, srollnd,     0,         srollnd,          srollnd,  gaelco2_state, init_play2000,  ROT0, "Nova Desitec", "Super Roller (v7.0)",  MACHINE_NOT_WORKING ) // missing ds5002fp dump
