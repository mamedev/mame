...
ROM_START( megatech )
	...
	MEGATECH_GAME_REGION("game0",MEGATECH_GAME_IS_GEN) \
	MEGATECH_GAME_REGION("game1",MEGATECH_GAME_IS_GEN) \
	MEGATECH_GAME_REGION("game2",MEGATECH_GAME_IS_GEN) \
	MEGATECH_GAME_REGION("game3",MEGATECH_GAME_IS_GEN) \
	MEGATECH_GAME_REGION("game4",MEGATECH_GAME_IS_GEN) \
	MEGATECH_GAME_REGION("game5",MEGATECH_GAME_IS_GEN) \
	MEGATECH_GAME_REGION("game6",MEGATECH_GAME_IS_GEN) \
	MEGATECH_GAME_REGION("game7",MEGATECH_GAME_IS_GEN) \

	
ROM_END

/* Game 01 - Altered Beast (Genesis) */
#define MEGATECH_GAME01(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
#define MEGATECH_GAME02(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_shar2 ) /* Space Harrier 2 */
	MEGATECH_BIOS
	MEGATECH_GAME02("game0")
ROM_END

/* Game 03 - Super Thunder Blade */
#define MEGATECH_GAME03(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_stbld ) /* Super Thunder Blade */
	MEGATECH_BIOS
	MEGATECH_GAME03("game0")
ROM_END

/* Game 04 - Great Golf (SMS) */
#define MEGATECH_GAME04(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_SMS) \
...
ROM_START( mt_ggolf ) /* Great Golf */
	MEGATECH_BIOS
	MEGATECH_GAME04("game0")
ROM_END

/* Game 05 - Great Soccer (SMS) - bad dump */
#define MEGATECH_GAME05(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_SMS) \
...
ROM_START( mt_gsocr ) /* Great Soccer */
	MEGATECH_BIOS
	MEGATECH_GAME05("game0")
ROM_END

/* Game 06 - Out Run (SMS) */
#define MEGATECH_GAME06(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_SMS) \
...
ROM_START( mt_orun ) /* Out Run */
	MEGATECH_BIOS
	MEGATECH_GAME06("game0")
ROM_END

/* Game 07 - Alien Syndrome (SMS) */
#define MEGATECH_GAME07(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_SMS) \
...
ROM_START( mt_asyn ) /* Alien Syndrome */
	MEGATECH_BIOS
	MEGATECH_GAME07("game0")
ROM_END

/* Game 08 - Shinobi (SMS) */
#define MEGATECH_GAME08(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_SMS) \
...
#define MEGATECH_GAME09(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_SMS) \
...
#define MEGATECH_GAME10(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_SMS) \
...
#define MEGATECH_GAME11(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_tfor2 ) /* Thunder Force 2 */
	MEGATECH_BIOS
	MEGATECH_GAME11("game0")
ROM_END

/* Game 13 - Astro Warrior (SMS) */
#define MEGATECH_GAME13(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_SMS) \
...
ROM_START( mt_astro ) /* Astro Warrior */
	MEGATECH_BIOS
	MEGATECH_GAME13("game0")
ROM_END

/* Game 19 - Great Football (SMS) */
#define MEGATECH_GAME19(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_SMS) \
...
ROM_START( mt_gfoot ) /* Great Football */
	MEGATECH_BIOS
	MEGATECH_GAME19("game0")
ROM_END

/* Game 20 - Last Battle */
#define MEGATECH_GAME20(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_lastb ) /* Last Battle */
	MEGATECH_BIOS
	MEGATECH_GAME20("game0")
ROM_END

/* Game 21 - World Championship Soccer (Genesis) */
#define MEGATECH_GAME21(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_wcsoc ) /* World Championship Soccer */
	MEGATECH_BIOS
	MEGATECH_GAME21("game0")
ROM_END

/* Game 22 - Tetris */
#define MEGATECH_GAME22(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_tetri ) /* Tetris */
	MEGATECH_BIOS
	MEGATECH_GAME22("game0")
ROM_END

/* Game 23 - Ghouls and Ghosts (Genesis) */
#define MEGATECH_GAME23(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_gng ) /* Ghouls and Ghosts */
	MEGATECH_BIOS
	MEGATECH_GAME23("game0")
ROM_END

/* Game 24 - Super Hang-On (Genesis) */
#define MEGATECH_GAME24(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_shang ) /* Super Hang-On */
	MEGATECH_BIOS
	MEGATECH_GAME24("game0")
ROM_END

/* Game 25 - Golden Axe (Genesis) */
#define MEGATECH_GAME25(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_fwrld ) /* Forgotten Worlds */
	MEGATECH_BIOS
	MEGATECH_GAME26("game0")
ROM_END

/* Game 27 - Mystic Defender */
#define MEGATECH_GAME27(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_mystd ) /* Mystic Defender */
	MEGATECH_BIOS
	MEGATECH_GAME27("game0")
ROM_END

/* Game 28 - The Revenge of Shinobi */
#define MEGATECH_GAME28(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_revsh ) /* The Revenge Of Shinobi */
	MEGATECH_BIOS
	MEGATECH_GAME28("game0")
ROM_END

/* Game 29 - Parlour Games (SMS) */
#define MEGATECH_GAME29(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_SMS) \
...
ROM_START( mt_parlg ) /* Parlour Games */
	MEGATECH_BIOS
	MEGATECH_GAME29("game0")
ROM_END

/* Game 31 - Arnold Palmer Tournament Gold */
#define MEGATECH_GAME31(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_tgolf ) /* Arnold Palmer Tournament Golf */
	MEGATECH_BIOS
	MEGATECH_GAME31("game0")
ROM_END

/* Game 32 - Super Real Basketball */
/* why is this pre-swapped like a console dump?? */
#define MEGATECH_GAME32(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_srbb ) /* Super Real Basketball */
	MEGATECH_BIOS
	MEGATECH_GAME32("game0")
ROM_END

/* Game 35 - Tommy Lasorda Baseball */
#define MEGATECH_GAME35(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
/* Game 36 - Columns */
#define MEGATECH_GAME36(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_cols ) /* Columns */
	MEGATECH_BIOS
	MEGATECH_GAME36("game0")
ROM_END

/* Game 38 - ESWAT */
#define MEGATECH_GAME38(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_eswat ) /* ESWAT */
	MEGATECH_BIOS
	MEGATECH_GAME38("game0")
ROM_END

/* Game 39 - Super Monaco Grand Prix (Genesis) */
#define MEGATECH_GAME39(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_smgp ) /* Super Monaco Grand Prix */
	MEGATECH_BIOS
	MEGATECH_GAME39("game0")
ROM_END

/* Game 40 - Moon Walker */
#define MEGATECH_GAME40(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_mwalk ) /* Moon Walker */
	MEGATECH_BIOS
	MEGATECH_GAME40("game0")
ROM_END

/* Game 41 - Crackdown */
#define MEGATECH_GAME41(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_crack ) /* Crackdown */
	MEGATECH_BIOS
	MEGATECH_GAME41("game0")
ROM_END

/* Game 43 - Shadow Dancer */
#define MEGATECH_GAME43(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_shado ) /* Shadow Dancer */
	MEGATECH_BIOS
	MEGATECH_GAME43("game0")
ROM_END

/* Game 44 - Arrow Flash */
#define MEGATECH_GAME44(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_arrow ) /* Arrow Flash */
	MEGATECH_BIOS
	MEGATECH_GAME44("game0")
ROM_END

/* Game 47 - Alien Storm */
#define MEGATECH_GAME47(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_astrm ) /* Alien Storm */
	MEGATECH_BIOS
	MEGATECH_GAME47("game0")
ROM_END

/* Game 48 - Wrestle War */
#define MEGATECH_GAME48(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_wwar ) /* Wrestle War */
	MEGATECH_BIOS
	MEGATECH_GAME48("game0")
ROM_END

/* Game 49 - Bonanza Bros. */
#define MEGATECH_GAME49(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_bbros ) /* Bonanza Bros. */
	MEGATECH_BIOS
	MEGATECH_GAME49("game0")
ROM_END

/* Game 51 - Streets of Rage */
#define MEGATECH_GAME51(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_srage ) /* Streets of Rage */
	MEGATECH_BIOS
	MEGATECH_GAME51("game0")
ROM_END

/* Game 52 - Sonic The Hedgehog (Genesis) */
#define MEGATECH_GAME52(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_sonic ) /* Sonic The Hedgehog */
	MEGATECH_BIOS
	MEGATECH_GAME52("game0")
ROM_END

#define MEGATECH_GAME52ALT(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_sonia ) /* Sonic (alt)*/
	MEGATECH_BIOS
	MEGATECH_GAME52ALT("game0")
ROM_END

/* Game 53 - Fire Shark */
#define MEGATECH_GAME53(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_fshrk ) /* Fire Shark */
	MEGATECH_BIOS
	MEGATECH_GAME53("game0")
ROM_END

/* Game 54 - Spiderman */
#define MEGATECH_GAME54(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_spman ) /* Spiderman */
	MEGATECH_BIOS
	MEGATECH_GAME54("game0")
ROM_END

/* Game 57 - Golden Axe 2 (Genesis) */
#define MEGATECH_GAME57(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_gaxe2 ) /* Golden Axe 2 */
	MEGATECH_BIOS
	MEGATECH_GAME57("game0")
ROM_END

/* Game 58 - Sports Talk Football */
#define MEGATECH_GAME58(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_stf ) /* Sports Talk Football */
	MEGATECH_BIOS
	MEGATECH_GAME58("game0")
ROM_END

/* Game 59 - Mario Lemieux Hockey */
#define MEGATECH_GAME59(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_mlh ) /* Mario Lemieux Hockey */
	MEGATECH_BIOS
	MEGATECH_GAME59("game0")
ROM_END

/* Game 60 - Kid Chameleon */
#define MEGATECH_GAME60(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_kcham ) /* Kid Chameleon */
	MEGATECH_BIOS
	MEGATECH_GAME60("game0")
ROM_END

/* Game 61 - Turbo Outrun */
#define MEGATECH_GAME61(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
...
ROM_START( mt_tout ) /* Turbo Outrun */
	MEGATECH_BIOS
	MEGATECH_GAME61("game0")
ROM_END

/* Game 62 - Sonic The Hedgehog 2 */
#define MEGATECH_GAME62(GAME_REGION) \
	MEGATECH_GAME_REGION(GAME_REGION,MEGATECH_GAME_IS_GEN) \
