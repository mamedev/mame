...
static INPUT_PORTS_START( senpmate ) // hold Pause during power on for Test Menu
	...
	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON6 ) PORT_CODE(KEYCODE_F2) PORT_NAME("Console Reset")
	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON4 ) PORT_NAME("Player Select")
	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON5 ) PORT_NAME("Player Start")
