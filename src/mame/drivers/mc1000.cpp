...
static INPUT_PORTS_START( mc1000 )
	...
	PORT_BIT( 0xe0, IP_ACTIVE_LOW, IPT_UNUSED )
        ...
        /*
        MC1000 actually supports 4 joysticks via extension cable
        i'll leave the lines below commented because i don't know how fine it works
        */
        
	//PORT_START("JOYC") /* Player 3 */
	//PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNUSED )
	//PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_UP ) PORT_PLAYER(3)    /* = 'K' */
	//PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN ) PORT_PLAYER(3)  /* = 'S' */
	//PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT ) PORT_PLAYER(3)  /* = 'Enter' */
	//PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT ) PORT_PLAYER(3) /* = '3' */
	//PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON1 ) PORT_PLAYER(3)        /* = ';' */
	//PORT_BIT( 0xc0, IP_ACTIVE_LOW, IPT_UNUSED )

	//PORT_START("JOYD") /* Player 4 */
	//PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON1 ) PORT_PLAYER(4)        /* = 'B' */
	//PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_UP ) PORT_PLAYER(4)    /* = 'J' */
	//PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN ) PORT_PLAYER(4)  /* = 'R' */
	//PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT ) PORT_PLAYER(4)  /* = 'Z' */
	//PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT ) PORT_PLAYER(4) /* = '2' */
	//PORT_BIT( 0xe0, IP_ACTIVE_LOW, IPT_UNUSED )
