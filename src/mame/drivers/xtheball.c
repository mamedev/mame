...
static ADDRESS_MAP_START( main_map, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0x04000000, 0x057fffff) AM_ROM AM_REGION(RGNCLASS_USER, "user2", 0)
...
ROM_START( xtheball )
	ROM_REGION16_LE( 0x10000, RGNCLASS_USER, "user1", 0 )	/* 34010 code */
	...
	ROM_REGION16_LE( 0x300000, RGNCLASS_USER, "user2", 0 )	/* 34010 code */
