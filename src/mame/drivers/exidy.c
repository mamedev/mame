...
static ADDRESS_MAP_START( sidetrac_map, ADDRESS_SPACE_PROGRAM, 8 )
	...
	AM_RANGE(0xff00, 0xffff) AM_ROM AM_REGION(RGNCLASS_CPU, "main", 0x3f00)
ADDRESS_MAP_END
...
ROM_START( sidetrac )
	...
	ROM_REGION( 0x0200, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )
...
ROM_START( targ )
	...
	ROM_REGION( 0x0140, RGNCLASS_PROMS, "proms", 0 )
	...
	ROM_REGION( 0x0020, RGNCLASS_SOUND, "targ", 0 )
...
ROM_START( mtrap )
	...
	ROM_REGION( 0x8000, RGNCLASS_CPU, "audio", 0 )
	...
	ROM_REGION( 0x4000, RGNCLASS_CPU, "cvsd", 0 ) /* 16k for digital sound processor */
...
static DRIVER_INIT( phantoma )
{
	...
	memory_set_bankptr(1, memory_region(machine, RGNCLASS_CPU, "main") + 0xf800);
}
