...
static MACHINE_CONFIG_START( arachnid, arachnid_state )
	...
	MCFG_PIA6821_READPA_HANDLER(READ8(arachnid_state, pia_u4_pa_r))
	MCFG_PIA6821_READPB_HANDLER(READ8(arachnid_state, pia_u4_pb_r))
	MCFG_PIA6821_READCA1_HANDLER(READLINE(arachnid_state, pia_u4_pca_r))
	MCFG_PIA6821_READCA2_HANDLER(READLINE(arachnid_state, pia_u4_pcb_r))
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(arachnid_state, pia_u4_pa_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(arachnid_state, pia_u4_pb_w))
	MCFG_PIA6821_CA2_HANDLER(WRITELINE(arachnid_state, pia_u4_pca_w))
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(arachnid_state, pia_u4_pcb_w))

	MCFG_DEVICE_ADD(PIA6821_U17_TAG, PIA6821, 0)
	MCFG_PIA6821_READPA_HANDLER(READ8(arachnid_state, pia_u17_pa_r))
	MCFG_PIA6821_READCA1_HANDLER(READLINE(arachnid_state, pia_u17_pca_r))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(arachnid_state, pia_u17_pb_w))
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(arachnid_state, pia_u17_pcb_w))
