...
static INPUT_PORTS_START( bosco )
	...
	PORT_DIPSETTING(    0x30, "15K 50K" )         PORT_CONDITION("DSWB",0xc0,PORTCOND_NOTEQUALS,0xc0)	/* Began with 1, 2 or 3 fighters */
	PORT_DIPSETTING(    0x38, "20K 70K" )         PORT_CONDITION("DSWB",0xc0,PORTCOND_NOTEQUALS,0xc0)
	PORT_DIPSETTING(    0x08, "10K 50K 50K" )     PORT_CONDITION("DSWB",0xc0,PORTCOND_NOTEQUALS,0xc0)
	PORT_DIPSETTING(    0x10, "15K 50K 50K" )     PORT_CONDITION("DSWB",0xc0,PORTCOND_NOTEQUALS,0xc0)
	PORT_DIPSETTING(    0x18, "15K 70K 70K" )     PORT_CONDITION("DSWB",0xc0,PORTCOND_NOTEQUALS,0xc0)
	PORT_DIPSETTING(    0x20, "20K 70K 70K" )     PORT_CONDITION("DSWB",0xc0,PORTCOND_NOTEQUALS,0xc0)
	PORT_DIPSETTING(    0x28, "30K 100K 100K" )   PORT_CONDITION("DSWB",0xc0,PORTCOND_NOTEQUALS,0xc0)
	PORT_DIPSETTING(    0x00, DEF_STR( None ) )   PORT_CONDITION("DSWB",0xc0,PORTCOND_NOTEQUALS,0xc0)
	PORT_DIPSETTING(    0x30, "30K 100K 100K" )   PORT_CONDITION("DSWB",0xc0,PORTCOND_EQUALS,0xc0)		/* Began with 5 fighters */
	PORT_DIPSETTING(    0x38, "30K 120K 120K" )   PORT_CONDITION("DSWB",0xc0,PORTCOND_EQUALS,0xc0)
	PORT_DIPSETTING(    0x08, "15K 70K" )         PORT_CONDITION("DSWB",0xc0,PORTCOND_EQUALS,0xc0)
	PORT_DIPSETTING(    0x10, "20K 70K" )         PORT_CONDITION("DSWB",0xc0,PORTCOND_EQUALS,0xc0)
	PORT_DIPSETTING(    0x18, "20K 100K" )        PORT_CONDITION("DSWB",0xc0,PORTCOND_EQUALS,0xc0)
	PORT_DIPSETTING(    0x20, "30K 120K" )        PORT_CONDITION("DSWB",0xc0,PORTCOND_EQUALS,0xc0)
	PORT_DIPSETTING(    0x28, "30K 80K 80K" )     PORT_CONDITION("DSWB",0xc0,PORTCOND_EQUALS,0xc0)
...
static INPUT_PORTS_START( galaga )
	...
	PORT_DIPSETTING(    0x20, "20K 60K 60K" )     PORT_CONDITION("DSWB",0xc0,PORTCOND_NOTEQUALS,0xc0)	/* Began with 2, 3 or 4 fighters */
	PORT_DIPSETTING(    0x18, "20K 60K" )         PORT_CONDITION("DSWB",0xc0,PORTCOND_NOTEQUALS,0xc0)
	PORT_DIPSETTING(    0x10, "20K 70K 70K" )     PORT_CONDITION("DSWB",0xc0,PORTCOND_NOTEQUALS,0xc0)
	PORT_DIPSETTING(    0x30, "20K 80K 80K" )     PORT_CONDITION("DSWB",0xc0,PORTCOND_NOTEQUALS,0xc0)
	PORT_DIPSETTING(    0x38, "30K 80K" )         PORT_CONDITION("DSWB",0xc0,PORTCOND_NOTEQUALS,0xc0)
	PORT_DIPSETTING(    0x08, "30K 100K 100K" )   PORT_CONDITION("DSWB",0xc0,PORTCOND_NOTEQUALS,0xc0)
	PORT_DIPSETTING(    0x28, "30K 120K 120K" )   PORT_CONDITION("DSWB",0xc0,PORTCOND_NOTEQUALS,0xc0)
	PORT_DIPSETTING(    0x00, DEF_STR( None ) )   PORT_CONDITION("DSWB",0xc0,PORTCOND_NOTEQUALS,0xc0)
	PORT_DIPSETTING(    0x20, "30K 100K 100K" )   PORT_CONDITION("DSWB",0xc0,PORTCOND_EQUALS,0xc0)		/* Began with 5 fighters */
	PORT_DIPSETTING(    0x18, "30K 150K" )        PORT_CONDITION("DSWB",0xc0,PORTCOND_EQUALS,0xc0)
	PORT_DIPSETTING(    0x10, "30K 120K 120K" )   PORT_CONDITION("DSWB",0xc0,PORTCOND_EQUALS,0xc0)
	PORT_DIPSETTING(    0x30, "30K 150K 150K" )   PORT_CONDITION("DSWB",0xc0,PORTCOND_EQUALS,0xc0)
	PORT_DIPSETTING(    0x38, "30K Only" )        PORT_CONDITION("DSWB",0xc0,PORTCOND_EQUALS,0xc0)
	PORT_DIPSETTING(    0x08, "30K 100K" )        PORT_CONDITION("DSWB",0xc0,PORTCOND_EQUALS,0xc0)
	PORT_DIPSETTING(    0x28, "30K 120K" )        PORT_CONDITION("DSWB",0xc0,PORTCOND_EQUALS,0xc0)
	PORT_DIPSETTING(    0x00, DEF_STR( None ) )   PORT_CONDITION("DSWB",0xc0,PORTCOND_EQUALS,0xc0)
	PORT_DIPNAME( 0xc0, 0x80, DEF_STR( Lives ) )		PORT_DIPLOCATION("SW2:7,8")
