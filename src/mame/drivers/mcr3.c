...
ROM_START( demoderm )
	...
	ROM_REGION( 0x04000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE | ROMREGION_INVERT )
...
ROM_START( maxrpm )
	...
	ROM_REGION( 0x08000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE | ROMREGION_INVERT )
...
ROM_START( rampage )
	...
	ROM_REGION( 0x40000, RGNCLASS_CPU, "sg", 0 )  /* 256k for the Sounds Good board */
...
ROM_START( spyhunt )
	...
	ROM_REGION( 0x8000, RGNCLASS_CPU, "csd", 0 )  /* 32k for the Chip Squeak Deluxe */
	...
	ROM_REGION( 0x01000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE )
...
ROM_START( turbotag )
	...
	ROM_REGION( 0x10000, RGNCLASS_CPU, "ssio", ROMREGION_ERASE00 )
