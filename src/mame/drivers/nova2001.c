...
static ADDRESS_MAP_START( ninjakun_cpu1_map, ADDRESS_SPACE_PROGRAM, 8 )
	...
	AM_RANGE(0x8000, 0x8000) AM_DEVWRITE("ay1", ay8910_address_w)
	AM_RANGE(0x8001, 0x8001) AM_DEVREADWRITE("ay1", ay8910_r, ay8910_data_w)
	AM_RANGE(0x8002, 0x8002) AM_DEVWRITE("ay2", ay8910_address_w)
	AM_RANGE(0x8003, 0x8003) AM_DEVREADWRITE("ay2", ay8910_r, ay8910_data_w)
...
static ADDRESS_MAP_START( pkunwar_map, ADDRESS_SPACE_PROGRAM, 8 )
	...
	AM_RANGE(0xa000, 0xa000) AM_DEVWRITE("ay1", ay8910_address_w)
	AM_RANGE(0xa001, 0xa001) AM_DEVREADWRITE("ay1", ay8910_r, ay8910_data_w)
	AM_RANGE(0xa002, 0xa002) AM_DEVWRITE("ay2", ay8910_address_w)
	AM_RANGE(0xa003, 0xa003) AM_DEVREADWRITE("ay2", ay8910_r, ay8910_data_w)
...
static ADDRESS_MAP_START( raiders5_cpu1_map, ADDRESS_SPACE_PROGRAM, 8 )
	...
	AM_RANGE(0xc000, 0xc000) AM_DEVWRITE("ay1", ay8910_address_w)
	AM_RANGE(0xc001, 0xc001) AM_DEVREADWRITE("ay1", ay8910_r, ay8910_data_w)
	AM_RANGE(0xc002, 0xc002) AM_DEVWRITE("ay2", ay8910_address_w)
	AM_RANGE(0xc003, 0xc003) AM_DEVREADWRITE("ay2", ay8910_r, ay8910_data_w)
...
ROM_START( pkunwar )
	...
	ROM_REGION( 0x10000, "gfx1", ROMREGION_DISPOSE )	// (need lineswapping)
...
ROM_START( raiders5 )
	...
	ROM_REGION( 0x8000, "gfx1", ROMREGION_DISPOSE )	// (need lineswapping)
	...
	ROM_REGION( 0x4000, "gfx2", ROMREGION_DISPOSE )	// (need lineswapping)
