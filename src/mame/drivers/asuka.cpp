...
static INPUT_PORTS_START( bonzeadv )
	...
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT ) PORT_8WAY PORT_COCKTAIL // as with all c-chip thought ADC reads this ends up on 0x80 instead of 0x08
...
ROM_START( bonzeadv )
	...
	ROM_LOAD( "cchip_b41-05.4", 0x0000, 0x2000, CRC(75c52553) SHA1(87bbaefab90e7d43f63556fbae3e937baf9d397b) )
...
ROM_START( bonzeadvp ) /* Labels consists of hand written checksum values of the ROMs */
	...
	ROM_REGION( 0x2000, "cchip:cchip_eprom", 0 )
	ROM_LOAD( "cchip_b41-05.4", 0x0000, 0x2000, CRC(75c52553) SHA1(87bbaefab90e7d43f63556fbae3e937baf9d397b) ) /* is the C-Chip the same as the final? */
