...
{
	seta2(config);
	m_maincpu->set_clock(32530470/2); // verified
	...
	subdevice<x1_010_device>("x1snd")->set_clock(32530470/2); // verified; reference : https://youtu.be/6f-znVzcrmg
}
...
void seta2_state::grdians(machine_config &config)
{
	...
	subdevice<x1_010_device>("x1snd")->set_clock(32530470/2); // verified; reference : https://youtu.be/Ung9XeLisV0
}
