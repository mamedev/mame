...
static INPUT_PORTS_START( grdians )
	...
	PORT_DIPNAME( 0x0004, 0x0004, DEF_STR( Extra Life At ) ) PORT_DIPLOCATION("SW1:3")
	PORT_DIPSETTING(      0x0004, DEF_STR( "300,000 Points" ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( "500,000 Points" ) )
