...
{
	memory_set_bankptr(4, memory_region(machine, RGNCLASS_SOUND, "scsp") + 0x200000);
	memory_set_bankptr(5, memory_region(machine, RGNCLASS_SOUND, "scsp") + 0x600000);

	// copy the 68k vector table into RAM
	memcpy(model2_soundram, memory_region(machine, RGNCLASS_CPU, "audio")+0x80000, 16);
}
...
static ADDRESS_MAP_START( model2_base_mem, ADDRESS_SPACE_PROGRAM, 32 )
	...
	AM_RANGE(0x02000000, 0x03ffffff) AM_ROM AM_REGION(RGNCLASS_USER, "user1", 0)

	// "extra" data
	AM_RANGE(0x06000000, 0x06ffffff) AM_ROM AM_REGION(RGNCLASS_USER, "user1", 0x1000000)
...
static ADDRESS_MAP_START( model2o_mem, ADDRESS_SPACE_PROGRAM, 32 )
	...
	AM_RANGE(0x00220000, 0x0023ffff) AM_ROM AM_REGION(RGNCLASS_CPU, "main", 0x20000)
...
static ADDRESS_MAP_START( model1_snd, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0x080000, 0x0bffff) AM_ROM AM_REGION(RGNCLASS_CPU, "audio", 0x20000)	// mirror of second program ROM
...
static WRITE16_HANDLER( model2snd_ctrl )
{
	...
	if (memory_region_length(machine, RGNCLASS_SOUND, "scsp") > 0x800000)
	{
		UINT8 *snd = memory_region(machine, RGNCLASS_SOUND, "scsp");
		if (data & 0x20)
		{
...
static ADDRESS_MAP_START( model2_snd, ADDRESS_SPACE_PROGRAM, 16 )
	AM_RANGE(0x000000, 0x07ffff) AM_RAM AM_REGION(RGNCLASS_CPU, "audio", 0) AM_BASE(&model2_soundram)
	AM_RANGE(0x100000, 0x100fff) AM_READWRITE(SCSP_0_r, SCSP_0_w)
	AM_RANGE(0x400000, 0x400001) AM_WRITE(model2snd_ctrl)
	AM_RANGE(0x600000, 0x67ffff) AM_ROM AM_REGION(RGNCLASS_CPU, "audio", 0x80000)
	AM_RANGE(0x800000, 0x9fffff) AM_ROM AM_REGION(RGNCLASS_SOUND, "scsp", 0)
...
static ADDRESS_MAP_START( copro_sharc_map, ADDRESS_SPACE_DATA, 32 )
	...
	AM_RANGE(0x1c00000, 0x1dfffff) AM_ROM AM_REGION(RGNCLASS_USER, "user5", 0)
ADDRESS_MAP_END
...
static ADDRESS_MAP_START( copro_tgp_map, ADDRESS_SPACE_PROGRAM, 32 )
	...
	AM_RANGE(0xff800000, 0xff9fffff) AM_ROM AM_REGION(RGNCLASS_CPU, "tgp", 0)
ADDRESS_MAP_END
...
#define MODEL2_CPU_BOARD \
	ROM_REGION( 0xc0000, RGNCLASS_USER, "user5", 0 ) \
...
#define MODEL2A_VID_BOARD \
	ROM_REGION( 0x180000, RGNCLASS_USER, "user6", 0 ) \
...
ROM_START( zeroguna )
	ROM_REGION( 0x200000, RGNCLASS_CPU, "main", 0 ) // i960 program
	...
	ROM_REGION32_LE( 0x2000000, RGNCLASS_USER, "user1", 0 ) // Data
	...
	ROM_REGION( 0x800000, RGNCLASS_CPU, "tgp", ROMREGION_ERASE00 ) // TGP data (COPRO sockets)

	ROM_REGION( 0x800000, RGNCLASS_USER, "user2", 0 ) // Models
	...
	ROM_REGION( 0x400000, RGNCLASS_USER, "user3", 0 ) // Textures
...
ROM_START( zerogun )
	...
	ROM_REGION( 0x800000, RGNCLASS_USER, "user5", ROMREGION_ERASE00 ) // Coprocessor Data ROM
...
ROM_START( gunblade )
	...
	ROM_REGION( 0x800000, RGNCLASS_USER, "user5", 0 ) // Coprocessor Data ROM
	...
	ROM_REGION( 0x1000000, RGNCLASS_USER, "user2", 0 ) // Models
	...
	ROM_REGION( 0x800000, RGNCLASS_USER, "user3", 0 ) // Textures
	...
	ROM_REGION( 0x800000, RGNCLASS_SOUND, "scsp", 0 ) // Samples
...
ROM_START( vf2 )
	...
	ROM_REGION32_LE( 0x2400000, RGNCLASS_USER, "user1", 0 ) // Data
	...
	ROM_REGION( 0x2000000, RGNCLASS_USER, "user2", 0 ) // Models
	...
	ROM_REGION( 0x1000000, RGNCLASS_USER, "user3", 0 ) // Textures
...
ROM_START( srallyc )
	...
	ROM_REGION( 0x800000, RGNCLASS_CPU, "tgp", 0 ) // TGP program? (COPRO socket)
	...
	ROM_REGION( 0x20000, RGNCLASS_CPU, "cpu4", 0) // Communication program
	...
	ROM_REGION( 0x010000, RGNCLASS_USER, "user4", 0 ) // Unknown (on "amp" board)
...
ROM_START( manxtt )
	...
	ROM_COPY( RGNCLASS_USER, "user1", 0xc00000, 0xd00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0xc00000, 0xe00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0xc00000, 0xf00000, 0x100000 )
...
ROM_START( motoraid )
	...
	ROM_COPY( RGNCLASS_USER, "user1", 0x1800000, 0x1900000, 0x100000 ) // rgn,srcoffset,offset,length.
	ROM_COPY( RGNCLASS_USER, "user1", 0x1800000, 0x1a00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x1800000, 0x1b00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x1800000, 0x1c00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x1800000, 0x1d00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x1800000, 0x1e00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x1800000, 0x1f00000, 0x100000 )
...
ROM_START( skytargt )
	...
	ROM_COPY( RGNCLASS_USER, "user1", 0x1000000, 0x1100000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x1000000, 0x1200000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x1000000, 0x1300000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x1000000, 0x1400000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x1000000, 0x1500000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x1000000, 0x1600000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x1000000, 0x1700000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x1000000, 0x1800000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x1000000, 0x1900000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x1000000, 0x1a00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x1000000, 0x1b00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x1000000, 0x1c00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x1000000, 0x1d00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x1000000, 0x1e00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x1000000, 0x1f00000, 0x100000 )
...
ROM_START( dynmcopc )
	...
	ROM_REGION( 0x800000, RGNCLASS_CPU, "cpu2", ROMREGION_ERASE00 ) // TGPx4 program (COPRO sockets)
...
ROM_START( stcc )
	...
	ROM_COPY(RGNCLASS_USER, "user1", 0x800000, 0x900000, 0x100000)
	ROM_COPY(RGNCLASS_USER, "user1", 0x800000, 0xa00000, 0x100000)
	ROM_COPY(RGNCLASS_USER, "user1", 0x800000, 0xb00000, 0x100000)
	ROM_COPY(RGNCLASS_USER, "user1", 0x800000, 0xc00000, 0x100000)
	ROM_COPY(RGNCLASS_USER, "user1", 0x800000, 0xd00000, 0x100000)
	ROM_COPY(RGNCLASS_USER, "user1", 0x800000, 0xe00000, 0x100000)
	ROM_COPY(RGNCLASS_USER, "user1", 0x800000, 0xf00000, 0x100000)

	ROM_REGION( 0x800000, RGNCLASS_CPU, "cpu2", 0 ) // TGPx4 program
	...
	ROM_REGION( 0x900000, RGNCLASS_USER, "user2", 0 ) // Models
	...
	ROM_REGION( 0x900000, RGNCLASS_USER, "user3", 0 ) // Textures
	...
	ROM_REGION( 0x20000, RGNCLASS_CPU, "cpu3", 0) // DSB program
	...
	ROM_REGION( 0x800000, RGNCLASS_SOUND, "mpeg", 0 ) // MPEG audio data
...
ROM_START( hotd )
	...
	ROM_COPY( RGNCLASS_USER, "user1", 0x1800000, 0x1900000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x1800000, 0x1a00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x1800000, 0x1b00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x1800000, 0x1c00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x1800000, 0x1d00000, 0x100000 )
...
ROM_START( waverunr )
	...
	ROM_COPY( RGNCLASS_USER, "user2", 0x1000000, 0x1100000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user2", 0x1000000, 0x1200000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user2", 0x1000000, 0x1300000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user2", 0x1000000, 0x1400000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user2", 0x1000000, 0x1500000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user2", 0x1000000, 0x1600000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user2", 0x1000000, 0x1700000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user2", 0x1000000, 0x1800000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user2", 0x1000000, 0x1900000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user2", 0x1000000, 0x1a00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user2", 0x1000000, 0x1b00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user2", 0x1000000, 0x1c00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user2", 0x1000000, 0x1d00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user2", 0x1000000, 0x1e00000, 0x100000 )
	...
	ROM_COPY( RGNCLASS_USER, "user3", 0x800000, 0x900000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user3", 0x800000, 0xa00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user3", 0x800000, 0xb00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user3", 0x800000, 0xc00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user3", 0x800000, 0xd00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user3", 0x800000, 0xe00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user3", 0x800000, 0xf00000, 0x100000 )
...
ROM_START( rchase2 )
	...
	ROM_REGION( 0x800000, RGNCLASS_USER, "user5", ROMREGION_ERASEFF ) // Coprocessor Data ROM
	/* empty?? */
...
ROM_START( bel )
	...
	ROM_REGION( 0xc00000, RGNCLASS_USER, "user3", 0 ) // Textures
...
ROM_START( overrev )
	...
	ROM_REGION( 0x800000, RGNCLASS_USER, "user2", 0 ) // Models (TGP sockets)
	...
	ROM_REGION( 0x400000, RGNCLASS_USER, "user3", 0 ) // Textures (TEXTURE sockets)
...
ROM_START( topskatr )
	...
	ROM_REGION( 0x400000, RGNCLASS_USER, "user2", 0 ) // Models
	...
	ROM_REGION( 0x1000000, RGNCLASS_SOUND, "mpeg", 0 ) // MPEG audio data
...
ROM_START( doaa )
	...
	ROM_REGION( 0x1800000, RGNCLASS_USER, "user2", 0 ) // Models
...
ROM_START( von )
	...
	ROM_REGION( 0x20000, RGNCLASS_CPU, "cpu3", 0) // Communication program
	ROM_LOAD16_WORD_SWAP("epr-18643a.7", 0x000000,  0x20000, CRC(b5e048ec) SHA1(8182e05a2ffebd590a936c1359c81e60caa79c2a) )
...
ROM_START( vstriker )
	...
	ROM_REGION( 0x600000, RGNCLASS_SOUND, "scsp", 0 ) // Samples
...
ROM_START( fvipers )
	...
	ROM_COPY( RGNCLASS_USER, "user1", 0x1000000, 0x1100000, 0x100000 ) // rgn,srcoffset,offset,length.
	ROM_COPY( RGNCLASS_USER, "user1", 0x1000000, 0x1200000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x1000000, 0x1300000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x1000000, 0x1400000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x1000000, 0x1500000, 0x100000 )
	...
	ROM_REGION( 0xc00000, RGNCLASS_USER, "user2", 0 ) // Models
...
ROM_START( daytona )
	...
	ROM_COPY( RGNCLASS_USER, "user1", 0x800000, 0x900000, 0x100000 ) // rgn,srcoffset,offset,length.
	ROM_COPY( RGNCLASS_USER, "user1", 0x800000, 0xa00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x800000, 0xb00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x800000, 0xc00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x800000, 0xd00000, 0x100000 )
	...
	ROM_REGION32_LE( 0x1000000, RGNCLASS_USER, "user2", 0 ) // Models
	...
	ROM_REGION16_LE( 0x1000000, RGNCLASS_USER, "user3", 0 ) // Textures
	...
	ROM_REGION( 0x80000, RGNCLASS_CPU, "audio", 0 ) // Sound program
	...
	ROM_REGION( 0x400000, RGNCLASS_SOUND, "sega1", 0 ) // Samples
	...
	ROM_REGION( 0x400000, RGNCLASS_SOUND, "sega2", 0 ) // Samples
	...
	ROM_REGION( 0x10000, RGNCLASS_USER, "user7", 0 ) // Unknown ROM
...
ROM_START( dayton93 )
	...
	ROM_COPY( RGNCLASS_USER, "user1", 0x900000, 0xa00000, 0x100000 ) // rgn,srcoffset,offset,length.
	ROM_COPY( RGNCLASS_USER, "user1", 0x900000, 0xb00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x900000, 0xc00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x900000, 0xd00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x900000, 0xe00000, 0x100000 )
	ROM_COPY( RGNCLASS_USER, "user1", 0x900000, 0xf00000, 0x100000 )
...
ROM_START( vcop )
	...
	ROM_REGION( 0x800000, RGNCLASS_CPU, "tgp", ROMREGION_ERASE00 ) // TGP program
...
ROM_START( desert )
	...
	ROM_REGION( 0x20000, RGNCLASS_CPU, "cpu4", ROMREGION_ERASE00 ) // Communication program
