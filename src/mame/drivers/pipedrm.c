...
static MACHINE_RESET( pipedrm )
{
	...
	memory_configure_bank(1, 0, 8, memory_region(machine, RGNCLASS_CPU, "main") + 0x10000, 0x2000);
	memory_set_bank(1, 0);

	/* initialize sound bank */
	memory_configure_bank(2, 0, 2, memory_region(machine, RGNCLASS_CPU, "audio") + 0x10000, 0x8000);
	memory_set_bank(2, 0);
	/* state save */
...
ROM_START( pipedrm )
	...
	ROM_COPY( RGNCLASS_GFX, "gfx1", 0x080000, 0x080000, 0x80000 )
