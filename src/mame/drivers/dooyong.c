...
ROM_START( lastday )
	ROM_REGION( 0x30000, RGNCLASS_CPU, "main", 0 )	/* 64k for code + 128k for banks */
	...
	ROM_REGION( 0x8000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )	/* chars */
	ROM_LOAD( "lday2.bin",    0x0000, 0x8000, CRC(83eb572c) SHA1(e915afd55d505bce202206c9ecfa89bad561ef6c) )	/* empty */
	ROM_CONTINUE(             0x0000, 0x8000 )

	ROM_REGION( 0x40000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE )	/* sprites */
	...
	ROM_REGION( 0x20000, RGNCLASS_GFX, "gfx5", 0 )	/* background tilemaps */
	...
	ROM_REGION( 0x20000, RGNCLASS_GFX, "gfx6", 0 )	/* fg tilemaps */
...
ROM_START( lastdaya )
	...
	ROM_REGION( 0x20000, RGNCLASS_GFX, "gfx5", 0 )	/* bg tilemaps */
...
ROM_START( pollux )
	...
	ROM_REGION( 0x80000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE )	/* tiles */
...
ROM_START( bluehawk )
	...
	ROM_REGION( 0x20000, RGNCLASS_SOUND, "oki", 0 )	/* OKI6295 samples */
...
ROM_START( sadari )
	...
	ROM_REGION( 0x80000, RGNCLASS_GFX, "gfx2", 0 )	/* tiles + tilemaps (together!) */
...
ROM_START( gundl94 )
	...
	ROM_REGION( 0x40000, RGNCLASS_GFX, "gfx2", 0 )	/* tiles + tilemaps (together!) */
	...
	ROM_REGION( 0x40000, RGNCLASS_GFX, "gfx3", 0 )	/* tiles + tilemaps (together!) */
	...
	ROM_REGION( 0x30000, RGNCLASS_CPU, "cpu2", 0 )	/* extra z80 rom? this doesn't seem to belong to this game! */
	ROM_LOAD( "gd94_011.j9",  0x00000, 0x20000, CRC(d8ad0208) SHA1(5df0f94ef86d7a03bde546e7aafdc0caf8a17076) )
	ROM_RELOAD(               0x10000, 0x20000 )				/* banked at 0x8000-0xbfff */

	ROM_REGION( 0x40000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE )	/* more tiles? they don't seem to belong to this game! */
...
ROM_START( superx )
	ROM_REGION( 0x40000, RGNCLASS_CPU, "main", 0 )	/* 64k for code + 128k for banks */
	...
	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx5", 0 )	/* tiles + tilemaps (together!) */
	...
	ROM_REGION( 0x80000, RGNCLASS_GFX, "gfx6", 0 )	/* top 4 bits of tilemaps */
	...
	ROM_REGION( 0x40000, RGNCLASS_SOUND, "oki", 0 )	/* OKI6295 samples */
...
ROM_START( popbingo )
	...
	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )	/* sprite */
	...
	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx2", 0 )	/* tiles + tilemaps (together!) */
