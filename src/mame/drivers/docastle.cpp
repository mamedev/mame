...
uint8_t docastle_state::idsoccer_adpcm_status_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void docastle_state::idsoccer_adpcm_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	if (data & 0x80)
	{
		m_adpcm_idle = 1;
