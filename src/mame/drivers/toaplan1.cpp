...
ROM_START( demonwld1 ) // has the same sound rom and same attract order as the parent set, but still a 1989 copyright
	ROM_REGION( 0x040000, "maincpu", 0 )    /* Main 68K code */ // roms had an additional 'N' stamped on them
