...
ROM_START( aladmdb )
	...
	ROM_LOAD( "aladd_pic16c57.bin", 0x0000, 0x1000, CRC(b5404c1d) SHA1(83ea746ac4313b027af04edee6a0fdb7f3355555) ) // Unprotected
ROM_END
...
ROM_START( jparkmb ) // Same PCB as twinktmb, JPA-028 label
	...
	// Not hooked up yet
	ROM_REGION( 0x1000, "pic", ROMREGION_ERASE00 )
	ROM_LOAD( "jurpark_pic16c57.bin", 0x0000, 0x1000, CRC(20c89c4d) SHA1(b3c61b314a71601267ea6c2d48e3c15d158968ca) ) // Unprotected
ROM_END
...
GAME( 1993, jparkmb,  0, md_bootleg,   twinktmb, md_boot_state, init_jparkmb,  ROT0, "bootleg / Sega",   "Jurassic Park (bootleg of Megadrive version)",                                          MACHINE_UNEMULATED_PROTECTION | MACHINE_NOT_WORKING ) // Needs PIC hook up
