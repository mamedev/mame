...
static ADDRESS_MAP_START( dsk2_dsp32_map, ADDRESS_SPACE_PROGRAM, 32 )
	...
	AM_RANGE(0x400000, 0x5fffff) AM_ROM AM_REGION(RGNCLASS_USER, "user4", 0)
	AM_RANGE(0xfff800, 0xffffff) AM_RAM
ADDRESS_MAP_END
...
ROM_START( harddriv )
	ROM_REGION( 0x100000, RGNCLASS_CPU, "main", 0 )		/* 1MB for 68000 code */
	...
	ROM_REGION( 0x20000, RGNCLASS_CPU, "sound", 0 )		/* 2*64k for audio 68000 code */
	...
	ROM_REGION16_BE( 0x60000, RGNCLASS_USER, "user1", 0 )	/* 384k for ADSP object ROM */
	...
	ROM_REGION( 0x40000, RGNCLASS_SOUND, "serialroms", 0 )		/* 4*128k for audio serial ROMs */
...
ROM_START( stunrun )
	...
	ROM_REGION( 0x100000, RGNCLASS_SOUND, "adpcm", 0 )	/* 256k for ADPCM samples */
...
ROM_START( racedriv )
	...
	ROM_REGION16_BE( 0x51000, RGNCLASS_USER, "user3", 0 )	/* 256k for DSK ROMs + 64k for RAM + 4k for ZRAM */
	...
	ROM_REGION( 0x50000, RGNCLASS_SOUND, "serialroms", 0 )		/* 10*128k for audio serial ROMs */
	ROM_LOAD( "136052-1123.65a", 0x000000, 0x010000, CRC(a88411dc) SHA1(1fd53c7eadffa163d5423df2f8338757e58d5f2e) )
	ROM_LOAD( "136052-1124.55a", 0x010000, 0x010000, CRC(071a4309) SHA1(c623bd51d6a4a56503fbf138138854d6a30b11d6) )
	ROM_LOAD( "136052-3125.45a", 0x020000, 0x010000, CRC(856548ff) SHA1(e8a17b274185c5e4ecf5f9f1c211e18b3ef2456d) )
	ROM_LOAD( "136052-1126.30a", 0x030000, 0x010000, CRC(f46ef09c) SHA1(ba62f73ee3b33d8f26b430ffa468f8792dca23de) )
...
ROM_START( steeltal )
    ...
    ROM_REGION( 0x015D, RGNCLASS_PLDS, "plds", 0 )
...
ROM_START( strtdriv )
	ROM_REGION( 0x200000, RGNCLASS_CPU, "main", 0 )		/* 2MB for 68000 code */
	...
	ROM_REGION( 0x10000 + 0x10000, RGNCLASS_CPU, "asic65", 0 )	/* dummy region for ADSP 2105 */
	ROM_LOAD( "136091-0033.10j", 0x000000, 0x010000, CRC(57504ab6) SHA1(ec8361b7da964c07ca0da48a87537badc3986fe0) )

	ROM_REGION( 0x60000, RGNCLASS_USER, "user1", 0 )		/* 384k for object ROM */
	...
	ROM_REGION16_BE( 0x100000, RGNCLASS_USER, "user5", 0 )
...
ROM_START( hdrivair )
	...
	ROM_REGION( 0x10000 + 0x10000, RGNCLASS_CPU, "dsp32", 0 )	/* dummy region for ADSP 2105 */
	...
	ROM_REGION( 0xc0000, RGNCLASS_USER, "user1", 0 )		/* 768k for object ROM */
	...
	ROM_REGION16_BE( 0x140000, RGNCLASS_USER, "user3", 0 )/* 1MB for DSK ROMs + 256k for RAM */
	...
	ROM_REGION32_LE( 0x200000, RGNCLASS_USER, "user4", 0 )/* 2MB for ASIC61 ROMs */
...
static void init_ds3(running_machine *machine)
{
	...
	{
		UINT8 *snd = memory_region(machine, RGNCLASS_CPU, "main" + hdcpu_sound);
	...
	{
		UINT8 *dsp = memory_region(machine, RGNCLASS_CPU, "main" + hdcpu_sounddsp);
