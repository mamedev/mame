...
public:
	...
	uint8_t shared_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void shared_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t vram1_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void vram1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t vram2_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	...
	uint8_t vblank_ack_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void vbl_ctrl_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void keyboard_row_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	...
	uint8_t fdcdma_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void fdcdma_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
...
uint8_t fanucspmg_state::shared_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_shared[offset];
}

void fanucspmg_state::shared_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_shared[offset] = data;
}

uint8_t fanucspmg_state::get_slave_ack(address_space &space, offs_t offset, uint8_t mem_mask)
{
	if(offset == 7)
...
uint8_t fanucspmg_state::fdcdma_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_fdc->dma_r();
}

void fanucspmg_state::fdcdma_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_fdc->dma_w(data);
}

void fanucspmg_state::dma_page_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint16_t fanucspmg_state::magic_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
uint8_t fanucspmg_state::vram1_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_vram[m_vram_bank + offset];
}

void fanucspmg_state::vram1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_vram[m_vram_bank + offset] = data;
}

uint8_t fanucspmg_state::vram2_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_vram[m_vram_bank + offset + 0x600];
}

void fanucspmg_state::vram2_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_vram[m_vram_bank + offset + 0x600] = data;
}

void fanucspmg_state::vram_bank_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_vram_bank = (data & 7) * 0xc00;
}

uint8_t fanucspmg_state::vblank_ack_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void fanucspmg_state::vbl_ctrl_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_vbl_ctrl = data;
}
...
void fanucspmg_state::keyboard_row_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_keyboard_row = data;
}

uint8_t fanucspmg_state::keyboard_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return 0;
}
...
void fanucspmg_state::video_ctrl_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_video_ctrl = data;
}
...
uint8_t fanucspmg_state::memory_read_byte(address_space &space, offs_t offset, uint8_t mem_mask)
{
	address_space& prog_space = m_maincpu->space(AS_PROGRAM);
	return prog_space.read_byte(offset | (m_dma_page << 16));
}

void fanucspmg_state::memory_write_byte(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	address_space& prog_space = m_maincpu->space(AS_PROGRAM);
