...
ROM_START( magslot ) // All labels have SLOT canceled with a black pen. No sum matches the one on label.
	...
	ROM_LOAD16_WORD_SWAP( "93c46.u136", 0x00, 0x080, NO_DUMP )
ROM_END
...
GAME( 2003, magslot, 0, magslot, magslot, rbmk_state, empty_init, ROT0,  "GMS", "Magic Slot (normal 1.0C)",               MACHINE_NOT_WORKING ) // needs implementing of 3rd GFX layer, correct GFX decode, PIC dump and core, inputs
