...
void nbmj9195_state::sailorws_sound_io_map(address_map &map)
{
...
static INPUT_PORTS_START( psailor1 )
	...
	PORT_DIPSETTING(    0x20, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x40, 0x40, "Character Display Test" )    PORT_DIPLOCATION("DSWB:7") // marked as unused in manual
	PORT_DIPSETTING(    0x40, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
...
ROM_START( mjuraden )
	...
	ROM_REGION( 0x400000, "blitter", 0 ) /* gfx */
...
ROM_START( mmehyou )
	...
	ROM_REGION( 0x260000, "blitter", 0 ) /* gfx */
...
ROM_START( wcatcher )
	...
	ROM_REGION( 0x280000, "blitter", 0 ) /* gfx */
...
ROM_START( yosimoto )
	...
	ROM_REGION( 0x300000, "blitter", 0 ) /* gfx */
