...
void nbmj9195_state::soundbank_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	membank("soundbank")->set_entry(data & 0x03);
}

void nbmj9195_state::outcoin_flag_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void nbmj9195_state::inputportsel_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void nbmj9195_state::dipswbitsel_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	switch (data & 0xc0)
	{
		case 0x00:
...
void nbmj9195_state::mscoutm_inputportsel_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_mscoutm_inputport = (data ^ 0x1f);
}

uint8_t nbmj9195_state::mscoutm_dipsw_0_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	// DIPSW A
...
uint8_t nbmj9195_state::mscoutm_dipsw_1_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	// DIPSW B
...
uint8_t nbmj9195_state::mscoutm_cpu_portb_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
uint8_t nbmj9195_state::mscoutm_cpu_portc_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	// PLAYER2 KEY
	switch (m_mscoutm_inputport)
	{
...
uint8_t nbmj9195_state::others_cpu_porta_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	// COIN IN, ETC...
	return ((ioport("SYSTEM")->read() & 0xfe) | m_outcoin_flag);
}

uint8_t nbmj9195_state::others_cpu_portb_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	// PLAYER1 KEY, DIPSW A/B
	switch (m_inputport)
	{
...
uint8_t nbmj9195_state::others_cpu_portc_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	// PLAYER2 KEY
	switch (m_inputport)
	{
...
void nbmj9195_state::soundcpu_porte_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
