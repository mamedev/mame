...
uint16_t st_state::fdc_data_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	uint8_t data = 0;
...
void st_state::fdc_data_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	if (m_fdc_mode & DMA_MODE_SECTOR_COUNT)
	{
...
uint16_t st_state::dma_status_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	uint16_t data = 0;
...
void st_state::dma_mode_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
uint8_t st_state::dma_counter_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	uint8_t data = 0;
...
void st_state::dma_base_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	switch (offset)
	{
	case 0:
...
uint8_t st_state::mmu_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_mmu;
}
...
void st_state::mmu_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void st_state::berr_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	m_maincpu->set_input_line(M68K_LINE_BUSERROR, ASSERT_LINE);
	m_maincpu->set_input_line(M68K_LINE_BUSERROR, CLEAR_LINE);
}

uint16_t st_state::berr_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
uint8_t st_state::ikbd_port1_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	/*
...
uint8_t st_state::ikbd_port2_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	/*
...
void st_state::ikbd_port2_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	/*
...
void st_state::ikbd_port3_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	/*
...
uint8_t st_state::ikbd_port4_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	/*
...
void st_state::ikbd_port4_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	/*
...
uint16_t megast_state::fpu_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
void megast_state::fpu_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
}
...
uint8_t ste_state::sound_dma_control_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
uint8_t ste_state::sound_dma_base_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	uint8_t data = 0;
...
uint8_t ste_state::sound_dma_counter_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	uint8_t data = 0;
...
uint8_t ste_state::sound_dma_end_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	uint8_t data = 0;
...
uint8_t ste_state::sound_mode_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void ste_state::sound_dma_control_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void ste_state::sound_dma_base_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	switch (offset)
	{
	case 0x00:
...
void ste_state::sound_dma_end_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	switch (offset)
	{
	case 0x00:
...
void ste_state::sound_mode_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint16_t ste_state::microwire_data_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	return m_mw_data;
}
...
void ste_state::microwire_data_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
uint16_t ste_state::microwire_mask_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	return m_mw_mask;
}
...
void ste_state::microwire_mask_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	if (!m_microwire_timer->enabled())
	{
		m_mw_mask = data;
...
uint16_t megaste_state::cache_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	return m_cache;
}
...
void megaste_state::cache_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	m_cache = data;
...
uint16_t stbook_state::config_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	/*
...
void stbook_state::lcd_control_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	/*
...
void st_state::psg_pa_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	/*
...
void stbook_state::psg_pa_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	/*
