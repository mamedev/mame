...
ROM_START( badbog )
	...
	ROM_LOAD32_WORD("Bad_Bog_5of6.u09", 0x0200000, 0x0080000, CRC(66d5a7f7) SHA1(1a1f845a97677c43ff1090231434ae9d3d36ab4c) )
...
ROM_START( goldra )
	...
	ROM_LOAD32_WORD("Golden_Ra_5of6.u09", 0x0200000, 0x0080000, CRC(b1cac0e7) SHA1(87f393a75c09e96a7fb893a767edcc81044e4fe3) )
...
ROM_START( petshopa )
	ARISTOCRAT_MK5_BIOS
	ROM_REGION( 0x400000, "game_prg", ROMREGION_ERASEFF )
	ROM_LOAD32_WORD("Pet Shop.u11", 0x0000002, 0x007fffd, CRC(bfaa9216) SHA1(19f1c7de05ff7f5f9f370be00cf8f0635e966809) ) // wrong size!
...
ROM_START( topbana )
	ARISTOCRAT_MK5_BIOS
	ROM_REGION( 0x400000, "game_prg", ROMREGION_ERASEFF )
	ROM_LOAD32_WORD("Top Banana.u11", 0x0000002, 0x007fffa, CRC(140a73bc) SHA1(3fd88797b6310f5849e901d032fbeb8a2d8604fb) )
