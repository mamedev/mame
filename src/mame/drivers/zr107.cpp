...
static INPUT_PORTS_START( midnrun )
	...
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON5 ) PORT_NAME("AT/MT Switch")				PORT_CONDITION("IN3", 0x02, NOTEQUALS, 0x00)
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON5 ) PORT_NAME("AT/MT Switch") PORT_TOGGLE 	PORT_CONDITION("IN3", 0x02, EQUALS, 0x00)
