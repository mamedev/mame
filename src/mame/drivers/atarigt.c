...
ROM_START( tmek )
	ROM_REGION( 0x200000, RGNCLASS_CPU, "main", 0 )	/* 8*64k for 68000 code */
	...
	ROM_REGION16_BE( 0x1000000, RGNCLASS_GFX, "gfx3", 0 )
...
ROM_START( primrage )
	...
	ROM_REGION16_BE( 0x2000000, RGNCLASS_GFX, "gfx3", 0 )
