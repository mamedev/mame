...
MACHINE_CONFIG_START(toaplan2_state::truxton2)
	...
	MCFG_OKIM6295_ADD("oki1", XTAL(16'000'000)/4, PIN7_LOW)
...
MACHINE_CONFIG_START(toaplan2_state::fixeightbl)
	...
	MCFG_OKIM6295_ADD("oki1", XTAL(14'000'000)/16, PIN7_LOW)
	MCFG_SOUND_ROUTE(ALL_OUTPUTS, "mono", 1.0)
...
MACHINE_CONFIG_START(toaplan2_state::pwrkick)
	...
	MCFG_SPEAKER_STANDARD_MONO("mono")
	/* empty YM2151 socket*/
	MCFG_OKIM6295_ADD("oki1", XTAL(27'000'000)/8, PIN7_HIGH) // not confirmed
	MCFG_SOUND_ROUTE(ALL_OUTPUTS, "mono", 0.5)
MACHINE_CONFIG_END
