...
ROM_START( ataxx )
	...
	ROM_REGION( 0x00001, RGNCLASS_USER, "user1", ROMREGION_ERASEFF ) /* X-ROM (data used by main processor) */
    /* Empty / not used */
ROM_END
...
ROM_START( wsf )
	ROM_REGION( 0x50000, RGNCLASS_CPU, "master", 0 )
	...
	ROM_REGION( 0x100000, RGNCLASS_CPU, "slave", 0 )
	...
	ROM_REGION( 0x60000, RGNCLASS_GFX, "gfx1", 0 )
	...
	ROM_REGION( 0x20000, RGNCLASS_USER, "user1", 0 ) /* X-ROM (data used by main processor) */
	...
	ROM_REGION( 0x20000, RGNCLASS_SOUND, "dac", 0 ) /* externally clocked DAC data */
	ROM_LOAD( "30021-01.u8",   0x00000, 0x20000, CRC(bb91dc10) SHA1(a7d8676867b5cfe1049040e593985af57ef04334) )
ROM_END


ROM_START( indyheat )
	ROM_REGION( 0x90000, RGNCLASS_CPU, "master", 0 )
	...
	ROM_REGION( 0x160000, RGNCLASS_CPU, "slave", 0 )
	...
	ROM_REGION( 0x40000, RGNCLASS_USER, "user1", 0 ) /* X-ROM (data used by main processor) */
	...
	ROM_REGION( 0x40000, RGNCLASS_SOUND, "dac", 0 ) /* externally clocked DAC data */
...
ROM_START( brutforc )
	...
	ROM_REGION( 0x80000, RGNCLASS_SOUND, "dac", 0 ) /* externally clocked DAC data */
...
ROM_START( asylum )
	...
	ROM_REGION( 0x1e0000, RGNCLASS_CPU, "slave", 0 )
