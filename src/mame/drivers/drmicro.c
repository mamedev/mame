...
{
	UINT8 *PCM = memory_region(machine, RGNCLASS_SOUND, "adpcm");
...
ROM_START( drmicro )
	...
	ROM_REGION( 0x04000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) // gfx 1
	...
	ROM_REGION( 0x06000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE ) // gfx 2
	...
	ROM_REGION( 0x04000, RGNCLASS_SOUND, "adpcm", 0 ) // samples
	...
	ROM_REGION( 0x00220, RGNCLASS_PROMS, "proms", 0 ) // PROMs
