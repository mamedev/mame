...
{
	memory_set_bankptr(2, memory_region(machine, RGNCLASS_CPU, "sound") + 0x10000 + (data&0xf)*0x4000);
}
...
ROM_START( moo ) /* Version EA - Euro Ver A */
	...
	ROM_REGION( 0x800000, RGNCLASS_GFX, "gfx2", 0 )
	/* sprites */
...
ROM_START( bucky )
	ROM_REGION( 0x240000, RGNCLASS_CPU, "main", 0 )
	/* main program */
	...
	ROM_REGION( 0x400000, RGNCLASS_SOUND, "konami", 0 )
	/* K054539 samples */
...
ROM_START( moobl )
	...
	ROM_REGION( 0x340000, RGNCLASS_SOUND, "oki", 0 )
