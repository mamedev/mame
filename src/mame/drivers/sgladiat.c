...
ROM_START( sgladiat )
	...
	ROM_REGION( 0x2000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE ) /* background tiles */
	ROM_LOAD( "glad.012",	0x0000, 0x2000, CRC(b7dd519f) SHA1(7bd760e54712648105d1049e678fa6b9effa600b) )

	ROM_REGION( 0x6000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE ) /* 16x16 sprites */
	...
	ROM_REGION( 0xc00, RGNCLASS_PROMS, "proms", 0 )
