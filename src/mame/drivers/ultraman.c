...
ROM_START( ultraman )
	...
	ROM_REGION( 0x010000, RGNCLASS_CPU, "audio", 0 )	/* Z80 code */
	...
	ROM_REGION( 0x080000, RGNCLASS_GFX, "gfx2", 0 )	/* BG 1  */
	...
	ROM_REGION( 0x080000, RGNCLASS_GFX, "gfx3", 0 ) /* BG 2 */
	...
	ROM_REGION( 0x080000, RGNCLASS_GFX, "gfx4", 0 ) /* BG 3 */
	...
	ROM_REGION( 0x040000, RGNCLASS_SOUND, "oki", 0 )	/* M6295 data */
