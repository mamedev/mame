...
ROM_START( gunforce )
	...
	ROM_REGION( 0x100000, "sound", 0 )	/* 1MB for the audio CPU - encrypted V30 = NANAO custom D80001 (?) */
...
ROM_START( inthunt )
	...
	ROM_REGION( 0x100000, "sound", 0 )	/* Irem D8000011A1 */
...
ROM_START( ssoldier )
	...
	ROM_REGION( 0x800000, "gfx2", ROMREGION_DISPOSE ) /* Sprites */
...
static DRIVER_INIT( majtitl2 )
{
	...
	memory_install_readwrite_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0xf0000, 0xf3fff, 0, 0, m92_eeprom_r, m92_eeprom_w);
...
static DRIVER_INIT( lethalth )
{
	...
	memory_install_write_handler(machine, 0, ADDRESS_SPACE_IO, 0x20, 0x21, 0, 0, SMH_NOP);
}
