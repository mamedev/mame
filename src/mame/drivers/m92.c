...
ROM_START( bmaster ) /* M92-B-B PCB used for program rom locations */
	...
	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) /* Tiles */
	...
	ROM_REGION( 0x80000, RGNCLASS_SOUND, "irem", 0 )
...
ROM_START( skingame )
	...
	ROM_REGION( 0x4000, RGNCLASS_USER, "user1", 0 )	/* EEPROM */
...
ROM_START( gunforce )
	...
	ROM_REGION( 0x100000, RGNCLASS_CPU, "sound", 0 )	/* 1MB for the audio CPU - encrypted V30 = NANAO custom D80001 (?) */
	...
	ROM_REGION( 0x20000, RGNCLASS_SOUND, "irem", 0 )
...
ROM_START( inthunt )
	...
	ROM_REGION( 0x100000, RGNCLASS_CPU, "sound", 0 )	/* Irem D8000011A1 */
	...
	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) /* Tiles */
...
ROM_START( mysticri )
	...
	ROM_REGION( 0x40000, RGNCLASS_SOUND, "irem", 0 )
...
ROM_START( ssoldier )
	...
	ROM_REGION( 0x800000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE ) /* Sprites */
...
ROM_START( dsccr94j )
	...
	ROM_REGION( 0x100000, RGNCLASS_SOUND, "irem", 0 )
