...
static INPUT_PORTS_START( icanpian ) 
	...
	PORT_START("P2")
	PORT_BIT( 0xffff, IP_ACTIVE_HIGH, IPT_UNKNOWN ) // might be some kind of seeprom in here? (or not? only I Can Play Guitar seems to offer a 'resume', something does get accessed on startup tho?)

	PORT_START("P3")
	// uses multiplexed ports instead

	PORT_START("INC_0")
	PORT_BIT( 0x0001, IP_ACTIVE_HIGH, IPT_BUTTON1 ) PORT_PLAYER(5) PORT_NAME("Change Instrument (no display mode)")
	PORT_BIT( 0x0002, IP_ACTIVE_HIGH, IPT_BUTTON2 ) PORT_PLAYER(5) PORT_NAME("Cycle Hands")
	PORT_BIT( 0x0004, IP_ACTIVE_HIGH, IPT_BUTTON3 ) PORT_PLAYER(5) PORT_NAME("Display Mode 1")
	PORT_BIT( 0x0008, IP_ACTIVE_HIGH, IPT_BUTTON4 ) PORT_PLAYER(5) PORT_NAME("Display Mode 2")
	PORT_BIT( 0x0010, IP_ACTIVE_HIGH, IPT_BUTTON5 ) PORT_PLAYER(5) PORT_NAME("Display Mode 3")
	PORT_BIT( 0x0020, IP_ACTIVE_HIGH, IPT_BUTTON6 ) PORT_PLAYER(5) PORT_NAME("Display Mode 4")
	...
	PORT_START("INC_1")
	PORT_BIT( 0x0001, IP_ACTIVE_HIGH, IPT_BUTTON1 )  PORT_PLAYER(4) PORT_NAME("Tempo Up")
	PORT_BIT( 0x0002, IP_ACTIVE_HIGH, IPT_BUTTON2 )  PORT_PLAYER(4) PORT_NAME("Tempo Default")
	PORT_BIT( 0x0004, IP_ACTIVE_HIGH, IPT_BUTTON3 )  PORT_PLAYER(4) PORT_NAME("Tempo Down")
	PORT_BIT( 0x0008, IP_ACTIVE_HIGH, IPT_BUTTON4 )  PORT_PLAYER(4) PORT_NAME("Pause")
	PORT_DIPNAME( 0x0010, 0x0000, "C1-5"  ) // is one of these the metronome button?
	PORT_DIPSETTING(      0x0000, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0010, DEF_STR( On ) )
	PORT_DIPNAME( 0x0020, 0x0000, "C1-6"  ) // is one of these the metronome button?
	PORT_DIPSETTING(      0x0000, DEF_STR( Off ) )
	...
	PORT_DIPNAME( 0x0020, 0x0000, "C2-6"  ) // is one of these the metronome button?
	PORT_DIPSETTING(      0x0000, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0020, DEF_STR( On ) )
	PORT_BIT( 0xffc0, IP_ACTIVE_HIGH, IPT_UNKNOWN )
INPUT_PORTS_END
