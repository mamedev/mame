...
CONS( 2005, jak_capb, 0, 0, jakks, batman, spg2xx_game_state, empty_init, "JAKKS Pacific Inc", "Classic Arcade Pinball (JAKKS Pacific TV Game)",           MACHINE_NOT_WORKING | MACHINE_IMPERFECT_SOUND | MACHINE_IMPERFECT_GRAPHICS )
