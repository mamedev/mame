...
ROM_START( ringrage )
	...
	ROM_REGION16_BE(0x800000, RGNCLASS_SOUND, "ensoniq.0" , ROMREGION_ERASE00 )	// V1: 2 banks
...
ROM_START( commandw )
	...
	ROM_REGION16_BE(0x800000, RGNCLASS_SOUND, "ensoniq.0" , ROMREGION_ERASE00 )	// V2: 4 banks, only 2 populated
...
ROM_START( cupfinal )
	...
	ROM_REGION(0x180000, RGNCLASS_CPU, "audio", 0)	/* 68000 sound CPU */
...
ROM_START( trstar )
	...
	ROM_REGION(0x140000, RGNCLASS_CPU, "audio", 0)	/* 68000 sound CPU */
...
ROM_START( dungeonm )
	...
	ROM_REGION(0x800000, RGNCLASS_GFX, "gfx2" , ROMREGION_DISPOSE) /* Tiles */
...
ROM_START( kaiserkn )
	...
	ROM_REGION(0x1a00000, RGNCLASS_GFX, "gfx1" , ROMREGION_DISPOSE) /* Sprites */
	...
	ROM_REGION(0xc00000, RGNCLASS_GFX, "gfx2" , ROMREGION_DISPOSE) /* Tiles */
	...
	ROM_REGION16_BE(0x1000000, RGNCLASS_SOUND, "ensoniq.0" , ROMREGION_ERASE00 )	// V2: 4 banks
	// empty
...
ROM_START( bublbob2 )
	...
	ROM_REGION(0x180000, RGNCLASS_CPU, "audio", 0)	/* sound CPU */
...
ROM_START( bubsympb )
	...
	ROM_REGION(0x300000, RGNCLASS_GFX, "gfx1" , ROMREGION_DISPOSE) /* Sprites (5bpp) */
	...
	ROM_REGION(0x100000, RGNCLASS_SOUND, "oki" , ROMREGION_ERASE00 ) // OKI6295 samples
...
ROM_START( spcinvdj )
	...
	ROM_REGION16_BE(0x400000, RGNCLASS_SOUND, "ensoniq.0" , ROMREGION_ERASE00 )	// V2: 4 banks, only 1 populated
...
ROM_START( kirameki )
	...
	ROM_REGION(0x400000, RGNCLASS_CPU, "audio", 0)	/* 68000 sound CPU */
...
{
	UINT32 *RAM = (UINT32 *)memory_region(machine, RGNCLASS_CPU, "main");
...
static WRITE32_HANDLER( bubsympb_oki_w )
{
	...
	{
		UINT8 *snd = memory_region(machine, RGNCLASS_SOUND, "oki");
