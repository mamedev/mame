...
ROM_START( mgolf )
	...
	ROM_REGION( 0x0400, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) /* tiles */
	...
	ROM_REGION( 0x0100, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE ) /* sprites */
	...
	ROM_REGION( 0x0200, RGNCLASS_PROMS, "proms", ROMREGION_DISPOSE )
