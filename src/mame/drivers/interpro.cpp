...
static SLOT_INTERFACE_START(interpro_scsi_devices)
	...
	SLOT_INTERFACE_INTERNAL(INTERPRO_SCSI_ADAPTER_TAG, NCR5390)
SLOT_INTERFACE_END
...
static ADDRESS_MAP_START(interpro_main_map, AS_0, 32, interpro_state)
	...
	AM_RANGE(0x40000000, 0x4000003f) AM_DEVICE(INTERPRO_MCTL_TAG, interpro_fmcc_device, map)
...
static ADDRESS_MAP_START(interpro_io_map, AS_1, 32, interpro_state)
	...
	AM_RANGE(0x40000000, 0x4000004f) AM_DEVICE(INTERPRO_MCTL_TAG, interpro_fmcc_device, map)
	AM_RANGE(0x4f007e00, 0x4f007eff) AM_DEVICE(INTERPRO_SGA_TAG, interpro_sga_device, map)
...
static MACHINE_CONFIG_START(ip2800, interpro_state)
	...
	MCFG_DEVICE_ADD(INTERPRO_SCSI_HA_TAG, NCR539X, XTAL_12_5MHz)
	...
	// memory controller
	MCFG_DEVICE_ADD(INTERPRO_MCTL_TAG, INTERPRO_FMCC, 0)
