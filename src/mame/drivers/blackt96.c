...
static MACHINE_DRIVER_START( blackt96 )
	MDRV_CPU_ADD("main", M68000, 18000000 /2)
	MDRV_CPU_PROGRAM_MAP(blackt96_map,0)
	MDRV_CPU_VBLANK_INT("main", irq1_line_hold)

	MDRV_CPU_ADD("audio", PIC16C57, 8000000)	/* ? */
...
ROM_START( blackt96 )
	...
	ROM_REGION( 0x80000, RGNCLASS_CPU, "audio", 0 ) /* PIC16c57 Code */
	...
	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx1", 0 ) // bg tiles
	...
	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx2", 0 ) // sprite tiles
	...
	ROM_REGION( 0x20000, RGNCLASS_GFX, "gfx3", 0 ) // txt tiles
