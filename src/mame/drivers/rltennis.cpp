...
ROM_START( rltennisa )
	...
	ROM_REGION( 0x2161, "plds", 0 )
	ROM_LOAD( "gal16v8.ic23", 0x000, 0x09ab, BAD_DUMP CRC(71706180) SHA1(a62f5387d62d805927ed137e9fa176747365d748) ) // JEDEC file, conversion to bin needed
	ROM_LOAD( "gal22v10.ic2", 0x9ab, 0x17b6, BAD_DUMP CRC(64096fe9) SHA1(49c751d9672cd64bbe565c772e99fda3eabb3b56) ) // JEDEC file, conversion to bin needed
ROM_END
