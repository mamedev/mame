...
static ADDRESS_MAP_START( mpu4_6809_map, ADDRESS_SPACE_PROGRAM, 8 )
	...
	AM_RANGE(0xC000, 0xFFFF) AM_ROM	AM_REGION(RGNCLASS_CPU, "main",0)  /* 64k EPROM on board, only this region read */
ADDRESS_MAP_END
...
ROM_START( dealem )
	ROM_REGION( 0x10000, RGNCLASS_CPU, "main", ROMREGION_ERASE00  )
...
ROM_START( crmaze )
	...
	ROM_REGION( 0x800000, RGNCLASS_CPU, "video", 0 )
...
ROM_START( mating )
	...
	ROM_REGION( 0x200000, RGNCLASS_SOUND, "oki", 0 )
