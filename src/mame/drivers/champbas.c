...
ROM_START( talbot )
	...
	ROM_REGION( 0x2000, RGNCLASS_CPU, "MCU", 0 )
	ROM_LOAD( "8201.bin", 0x0000, 0x2000, CRC(b77931ac) SHA1(405b02585e80d95a2821455538c5c2c31ce262d1) )

	ROM_REGION( 0x1000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )	// chars
...
ROM_START( champbas )
	...
	ROM_REGION( 0x2000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )	// chars + sprites: rearranged by DRIVER_INIT to leave only chars
	ROM_LOAD( "champbb.4", 0x0000, 0x2000, CRC(1930fb52) SHA1(cae0b2701c2b53b79e9df3a7496442ba3472e996) )

	ROM_REGION( 0x2000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE )	// chars + sprites: rearranged by DRIVER_INIT to leave only sprites
...
ROM_START( exctsccr )
	...
	ROM_REGION( 0x04000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )	// 3bpp chars + sprites: rearranged by DRIVER_INIT to leave only chars
	...
	ROM_REGION( 0x04000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE )	// 3bpp chars + sprites: rearranged by DRIVER_INIT to leave only sprites
	ROM_LOAD( "5_b5.bin",     0x0000, 0x2000, CRC(35f4f8c9) SHA1(cdf5bbfea9abdd338938e5f4499d2d71ce3c6237) ) /* planes 0,1 */

	ROM_REGION( 0x02000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE )	// 4bpp sprites
...
ROM_START( exctsccb )
	...
	ROM_REGION( 0x10000, RGNCLASS_CPU, "sub", 0 )	/* sound */
...
static DRIVER_INIT(champbas)
{
	...
	UINT8 *rom1 = memory_region(machine, RGNCLASS_GFX, "gfx1");
	UINT8 *rom2 = memory_region(machine, RGNCLASS_GFX, "gfx2");
