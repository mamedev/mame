...
ROM_START( suprslam )
	...
	ROM_REGION( 0x200000, "gfx1", ROMREGION_DISPOSE ) /* 8x8x4 'Screen' Layer GFX */
	ROM_LOAD( "eb26ic43.bin", 0x000000, 0x200000, CRC(9dfb0959) SHA1(ba479192a422a55efcf8aa7ff995c914525b4a56) )

	ROM_REGION( 0x800000, "gfx2", ROMREGION_DISPOSE ) /* 16x16x4 Sprites GFX */
	...
	ROM_REGION( 0x400000, "gfx3", ROMREGION_DISPOSE ) /* 16x16x4 BG GFX */
