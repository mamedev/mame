...
static ADDRESS_MAP_START( taitojc_map, ADDRESS_SPACE_PROGRAM, 32 )
	...
	AM_RANGE(0x00400000, 0x01bfffff) AM_ROM AM_REGION(RGNCLASS_GFX, "gfx1", 0)
...
static ADDRESS_MAP_START( hc11_pgm_map, ADDRESS_SPACE_PROGRAM, 8 )
	...
	AM_RANGE(0x8000, 0xffff) AM_ROM AM_REGION(RGNCLASS_USER, "user1", 0)
ADDRESS_MAP_END
...
{
	UINT16 *rom = (UINT16*)memory_region(machine, RGNCLASS_GFX, "gfx2");
...
ROM_START( sidebs )
	ROM_REGION(0x200000, RGNCLASS_CPU, "main", 0)		/* 68040 code */
	...
	ROM_REGION( 0x180000, RGNCLASS_CPU, "audio", 0 )		/* 68000 Code */
	...
	ROM_REGION( 0x010000, RGNCLASS_USER, "user1", 0 )		/* MC68HC11M0 code */
	ROM_LOAD( "e17-23.065",  0x000000, 0x010000, CRC(80ac1428) SHA1(5a2a1e60a11ecdb8743c20ddacfb61f9fd00f01c) )

	ROM_REGION( 0x00080, RGNCLASS_USER, "user2", 0 )		/* eeprom */
	ROM_FILL( 0x0000, 0x0080, 0 )

	ROM_REGION( 0x1800000, RGNCLASS_GFX, "gfx1", 0 )
	...
	ROM_REGION( 0x1000000, RGNCLASS_GFX, "gfx2", 0 )		/* only accessible to the TMS */
...
ROM_START( dendeg )
	...
	ROM_REGION( 0x40000, RGNCLASS_USER, "user3", 0 )		/* train board, OKI6295 sound samples */
