...
ROM_START( exedexes )
	...
	ROM_REGION( 0x08000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE )
	...
	ROM_REGION( 0x6000, RGNCLASS_GFX, "gfx5", 0 )	/* background tilemaps */
	...
	ROM_REGION( 0x0b20, RGNCLASS_PROMS, "proms", 0 )
