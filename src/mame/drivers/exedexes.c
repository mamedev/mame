...
static GFXDECODE_START( exedexes )
	...
	GFXDECODE_ENTRY( REGION_GFX2, 0, tilelayout,           64*4, 64 ) /* 32x32 Tiles */
	GFXDECODE_ENTRY( REGION_GFX3, 0, spritelayout,       2*64*4, 16 ) /* 16x16 Tiles */
	GFXDECODE_ENTRY( REGION_GFX4, 0, spritelayout, 2*64*4+16*16, 16 ) /* Sprites */
GFXDECODE_END
