...
ROM_START( route16 )
	...
	ROM_REGION( 0x0200, RGNCLASS_PROMS, "proms", 0 ) /* Intersil IM5623CPE proms compatible with 82s129 */
...
ROM_START( speakres )
	...
	ROM_REGION( 0x10000, RGNCLASS_CPU, "cpu2", 0 )     /* 64k for the second CPU */
...
{
	UINT8 *ROM = memory_region(machine, RGNCLASS_CPU, "cpu1");
