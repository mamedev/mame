...
ROM_START( macrossp )
	...
	ROM_REGION( 0x1000000, RGNCLASS_GFX, "gfx1", 0 ) /* sprites - 16x16x8 */
	...
	ROM_REGION( 0x800000, RGNCLASS_GFX, "gfx2", 0 ) /* backgrounds - 16x16x8 */
	...
	ROM_REGION( 0x800000, RGNCLASS_GFX, "gfx3", 0 ) /* backgrounds - 16x16x8 */
	...
	ROM_REGION( 0x800000, RGNCLASS_GFX, "gfx4", 0 ) /* backgrounds - 16x16x8 */
	...
	ROM_REGION( 0x400000, RGNCLASS_GFX, "gfx5", 0 ) /* foreground - 16x16x4 */
	ROM_LOAD( "bp964a.u19", 0x000000, 0x080000, CRC(19c7acd9) SHA1(b7631e74f359c5570c44addf46c3e96c80adc6c3) )

	ROM_REGION16_BE( 0x800000, RGNCLASS_SOUND, "ensoniq.0", ROMREGION_ERASEFF )
	ROM_LOAD16_BYTE( "bp964a.u24", 0x000000, 0x400000, CRC(93f90336) SHA1(75daa2f8cedc732cf5ef98254f61748c94b94aea) )

	ROM_REGION16_BE( 0x400000, RGNCLASS_SOUND, "ensoniq.1", 0 )
	ROM_COPY( RGNCLASS_SOUND, "ensoniq.0", 0x400000, 0x000000, 0x400000 )
ROM_END
...
ROM_START( quizmoon )
	...
	ROM_REGION( 0x0200000, RGNCLASS_GFX, "gfx4", 0 )
	ROM_LOAD( "u17.bin", 0x0000000, 0x0200000, CRC(ff93c949) SHA1(13917d73a6cb70d03d0335bd816bf6b094758d0b) )

	ROM_REGION( 0x400000, RGNCLASS_GFX, "gfx5", ROMREGION_ERASE00 )
	/* nothing on this game? */

	ROM_REGION16_BE( 0x800000, RGNCLASS_SOUND, "ensoniq.0", 0 )
	...
	ROM_REGION16_BE( 0x800000, RGNCLASS_SOUND, "ensoniq.2", 0 )
	...
	ROM_REGION16_BE( 0x400000, RGNCLASS_SOUND, "ensoniq.3", 0 )
	ROM_COPY( RGNCLASS_SOUND, "ensoniq.2", 0x400000, 0x000000, 0x400000 )
ROM_END
