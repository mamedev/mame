...
ROM_START( darius2d )
	ROM_REGION( 0x100000, RGNCLASS_CPU, "main", 0 )	/* 512K for 68000 code */
	...
	ROM_COPY( RGNCLASS_GFX, "gfx1", 0x000000, 0x000000, 0x100000 )	/* SCR (screen 2) */
...
//  ROM_LOAD( "c07-04.48", 0x80000, 0x80000, CRC(50421e81) SHA1(27ac420602f1dac00dc32903543a518e6f47fb2f) )
	...
	ROM_REGION( 0x001000, RGNCLASS_USER, "user1", 0 )	/* unknown roms */
...
ROM_START( warriorb )
	...
	ROM_REGION( 0x300000, RGNCLASS_SOUND, "ym", 0 )	/* ADPCM samples */
	...
	ROM_REGION( 0x01000, RGNCLASS_USER, "user1", 0 )	/* unknown roms */
