...
ROM_START( stoneage )
	...
	ROM_REGION( 0x40000, RGNCLASS_SOUND, "oki1", 0 ) /* Oki samples */
...
ROM_START( edrandy ) /* World ver 3 */
	...
	ROM_REGION( 0x500000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE )
...
ROM_START( edrandy1 ) /* World ver 1 */
	...
	ROM_REGION( 0x020000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) /* Original graphics, later revised for the World sets above?? */
...
ROM_START( mutantf ) /* World ver 5 */
	...
	ROM_REGION( 0x0a0000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) /* chars */
	...
	ROM_REGION( 0x40000, RGNCLASS_GFX, "gfx5", ROMREGION_DISPOSE ) /* sprites 2 */
	...
	ROM_REGION( 0x40000, RGNCLASS_SOUND, "oki1", 0 )	/* ADPCM samples */
	ROM_LOAD( "maf-10.20l",    0x00000, 0x40000, CRC(7c57f48b) SHA1(9a5624553b3b038d70f9b517f410a635c00a8771) )

	ROM_REGION( 0x80000, RGNCLASS_SOUND, "oki2", 0 )	/* ADPCM samples */
