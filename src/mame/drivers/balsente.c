...
ROM_START( sentetst )
	ROM_REGION( 0x40000, RGNCLASS_CPU, "main", 0 )     /* 64k for code for the first CPU, plus 128k of banked ROMs */
	ROM_LOAD( "sdiagef.bin",  0x2e000, 0x2000, CRC(2a39fc53) SHA1(04ea68bfad455cc928e57390eba5597c38bbab69) )

	ROM_REGION( 0x10000, RGNCLASS_CPU, "audio", 0 )		/* 64k for Z80 */
	ROM_LOAD( "sentesnd",     0x00000, 0x2000, CRC(4dd0a525) SHA1(f0c447adc5b67917851a9df978df851247e75c43) )

	ROM_REGION( 0x10000, RGNCLASS_GFX, "gfx1", 0 )		/* up to 64k of sprites */
...
ROM_START( nametune )
	ROM_REGION( 0x70000, RGNCLASS_CPU, "main", 0 )     /* 64k for code for the first CPU, plus 128k of banked ROMs */
...
ROM_START( grudge )
	...
	ROM_REGION( 0x8000, RGNCLASS_GFX, "gfx1", 0 )		/* up to 64k of sprites */
...
ROM_START( shrike )
	...
	ROM_REGION( 0x4000, RGNCLASS_CPU, "68k", 0 )		/* 16k for M68000 */
	...
	ROM_REGION( 0x20000, RGNCLASS_GFX, "gfx1", 0 )		/* up to 128k of banked sprites */
