...
ROM_START( cbuster )
	...
	ROM_REGION( 0x20000, RGNCLASS_SOUND, "oki1", 0 )	/* ADPCM samples */
	ROM_LOAD( "fu12-.rom",     0x00000, 0x20000, CRC(2d1d65f2) SHA1(be3d57b9976ddf7ee6d20ee9e78fe826ee411d79) )

	ROM_REGION( 0x20000, RGNCLASS_SOUND, "oki2", 0 )	/* ADPCM samples */
...
static DRIVER_INIT( twocrude )
{
	...
	RAM = memory_region(machine, RGNCLASS_GFX, "gfx3") + 0x080000;
	PTR = memory_region(machine, RGNCLASS_GFX, "gfx3") + 0x140000;
