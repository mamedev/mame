...
ROM_START( asurabld )
	ROM_REGION( 0x200000, RGNCLASS_CPU, "main", 0 ) /* M68020 */
	...
	ROM_REGION( 0x090000, RGNCLASS_CPU, "sound", 0 ) /* Z80 */
	...
	ROM_REGION( 0x0800000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE )
	...
	ROM_REGION( 0x0800000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE )
