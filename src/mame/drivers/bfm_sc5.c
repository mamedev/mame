...
ROM_START( sc5dndcl )
	...
	ROM_REGION( 0x400000, "altrevs", 0 )
	// sc5
	ROM_LOAD16_BYTE( "95419892.lo", 0x00001, 0x080000, CRC(6fb61650) SHA1(2a89170ddca11fb86edb5072ed4841260c7b1501) ) // R3068 CLUB
...
ROM_START( sc5dndwb )
	...
	ROM_LOAD16_BYTE( "95422010.lo", 0x00001, 0x080000, CRC(aa27467d) SHA1(28e834b798ce2778cec8001fa553a9d82094ef73) ) // one of these was in sc_dndtp
	ROM_LOAD16_BYTE( "95422011.hi", 0x00000, 0x080000, CRC(3fd5debb) SHA1(d511226c039f2b41c3122863a9764adc4a9330bf) ) // check where these actually belong
	...
	ROM_LOAD16_BYTE( "95423010.lo", 0x00001, 0x080000, CRC(62f9f024) SHA1(46bfb758ed6508b4e01779038a5a94da22e7b3b7) ) // one of these was in sc_dndtp
	ROM_LOAD16_BYTE( "95423011.hi", 0x00000, 0x080000, CRC(a27f40db) SHA1(78c8eff3c6066005b5b044c95aef0bb0fb53ac18) ) // check where these actually belong
...
ROM_START( sc5manic )
	...
	ROM_LOAD16_BYTE( "95422064.lo", 0x00001, 0x080000, CRC(82b62da6) SHA1(8c7f9bab82027dcdba3c3587d607a3deabeb5e47) ) // was in manic dndww set
...
ROM_START( sc5monop )
	ROM_REGION( 0x400000, "maincpu", ROMREGION_ERASEFF )
	// sc5
	// mismatched rom, probably doesn't belong here..
...
ROM_START( sc5ttpie )
	...
	ROM_LOAD16_BYTE( "95422029.hi", 0x00000, 0x080000, CRC(d53e86be) SHA1(72f1b6b21f284b27bd63fcea90826a88c6b16bef) ) // half of this pair was in dnd, check where it belongs
	ROM_LOAD16_BYTE( "95422028.lo", 0x00001, 0x080000, CRC(55ecfc66) SHA1(ba6b8befe37318ecec9cce1ea3029afa701f1cff) ) //
	ROM_LOAD16_BYTE( "95423028.lo", 0x00001, 0x080000, CRC(6a81fb48) SHA1(9e75c7601efd70aa91f9306b0ffd8d0a515912f6) ) // half of this pair was in dnd, check where it belongs
...
GAME( 200?, ad5crcpt	,0,			sc5, sc5, 0, ROT0, "BFM","Cops 'n' Robbers Community Party (Bellfruit) (Adder 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5adjb		,0,			sc5, sc5, 0, ROT0, "BFM","Ant & Dec's Jiggy Bank (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5adwta	,0,			sc5, sc5, 0, ROT0, "BFM","Ant & Dec's Saturday Night Takeaway Win The Ads (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5a40		,0,			sc5, sc5, 0, ROT0, "Mazooma","Around The Board In 40 Days (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5bantm	,0,			sc5, sc5, 0, ROT0, "Mazooma","Bantam Of The Opera (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5bar7		,0,			sc5, sc5, 0, ROT0, "BFM","Bar 7's (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5batl		,0,			sc5, sc5, 0, ROT0, "BFM","Battleships & Cruisers (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5bob		,0,			sc5, sc5, 0, ROT0, "Mazooma","Bobby Dazzler (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5bull		,0,			sc5, sc5, 0, ROT0, "BFM","Bullseye (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, ad5bull		,0,			sc5, sc5, 0, ROT0, "BFM","Bullseye (Bellfruit) (Adder 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5butch	,0,			sc5, sc5, 0, ROT0, "BFM","Butch Cashidy & The Sundance Quid (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5cabin	,0,			sc5, sc5, 0, ROT0, "Mazooma","Cabin Fever (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5cari		,0,			sc5, sc5, 0, ROT0, "Qps","Caribbean Cash (Qps) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5cblas	,0,			sc5, sc5, 0, ROT0, "BFM","Cash Blast (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5casxt	,0,			sc5, sc5, 0, ROT0, "Mazooma","Casino Xtravaganza  (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5chavi	,0,			sc5, sc5, 0, ROT0, "BFM","Chav It (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5chavy	,0,			sc5, sc5, 0, ROT0, "Mazooma","Chavy Chase (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5clue		,0,			sc5, sc5, 0, ROT0, "Mazooma","Cluedo (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5cmani	,0,			sc5, sc5, 0, ROT0, "BFM","Colour Mania (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5cj		,0,			sc5, sc5, 0, ROT0, "BFM","Cool Jewels (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5ctl		,0,			sc5, sc5, 0, ROT0, "BFM","Cop The Lot (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5crsc		,0,			sc5, sc5, 0, ROT0, "BFM","Cops 'n' Robbers Safe Cracker (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, ad5crsc		,0,			sc5, sc5, 0, ROT0, "BFM","Cops 'n' Robbers Safe Cracker (Bellfruit) (Adder 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5coro		,0,			sc5, sc5, 0, ROT0, "Mazooma","Coronation Street (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5count	,0,			sc5, sc5, 0, ROT0, "BFM","Countdown (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5cf		,0,			sc5, sc5, 0, ROT0, "BFM","Crazy Fruits (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5crnjw	,0,			sc5, sc5, 0, ROT0, "BFM","Crown Jewels (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5dnd		,0,			sc5, sc5, 0, ROT0, "BFM","Deal Or No Deal (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, ad5dnd		,0,			sc5, sc5, 0, ROT0, "BFM","Deal Or No Deal (Bellfruit) (Adder 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5dndbb	,0,			sc5, sc5, 0, ROT0, "BFM","Deal Or No Deal Break The Bank (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5dndcl	,0,			sc5, sc5, 0, ROT0, "BFM","Deal Or No Deal Club (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, ad5dndcl	,0,			sc5, sc5, 0, ROT0, "BFM","Deal Or No Deal Club (Bellfruit) (Adder 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5dnddd	,0,			sc5, sc5, 0, ROT0, "BFM","Deal Or No Deal Double Deal Or No Deal (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, ad5dnddd	,0,			sc5, sc5, 0, ROT0, "BFM","Deal Or No Deal Double Deal Or No Deal (Bellfruit) (Adder 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5dndhf	,0,			sc5, sc5, 0, ROT0, "BFM","Deal Or No Deal Hall Of Fame (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5dndys	,0,			sc5, sc5, 0, ROT0, "BFM","Deal Or No Deal It's Your Show (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5dndlp	,0,			sc5, sc5, 0, ROT0, "BFM","Deal Or No Deal Let's Play Deal Or No Deal (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5dndra	,0,			sc5, sc5, 0, ROT0, "BFM","Deal Or No Deal Red Alert (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5dndbd	,0,			sc5, sc5, 0, ROT0, "BFM","Deal Or No Deal The Big Deal (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5dndbr	,0,			sc5, sc5, 0, ROT0, "BFM","Deal Or No Deal The Big Reds (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5dndcc	,0,			sc5, sc5, 0, ROT0, "BFM","Deal Or No Deal The Crazy Chair (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5dnddw	,0,			sc5, sc5, 0, ROT0, "BFM","Deal Or No Deal The Deal Wheel (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5dnddf	,0,			sc5, sc5, 0, ROT0, "BFM","Deal Or No Deal The Dream Factory (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5dndpg	,0,			sc5, sc5, 0, ROT0, "BFM","Deal Or No Deal The Perfect Game (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, ad5dndpg	,0,			sc5, sc5, 0, ROT0, "BFM","Deal Or No Deal The Perfect Game (Bellfruit) (Adder 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5dndtp	,0,			sc5, sc5, 0, ROT0, "BFM","Deal Or No Deal The Power (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5dndww	,0,			sc5, sc5, 0, ROT0, "BFM","Deal Or No Deal The Walk Of Wealth (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5dndtr	,0,			sc5, sc5, 0, ROT0, "BFM","Deal Or No Deal Think Red (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5dndwb	,0,			sc5, sc5, 0, ROT0, "BFM","Deal Or No Deal What's In Your Box (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5dmine	,0,			sc5, sc5, 0, ROT0, "BFM","Diamond Mine (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5ddosh	,0,			sc5, sc5, 0, ROT0, "BFM","Doctor Dosh (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5dhh		,0,			sc5, sc5, 0, ROT0, "BFM","Dough Ho Ho (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5dough	,0,			sc5, sc5, 0, ROT0, "BFM","Dough Selecta (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5ducks	,0,			sc5, sc5, 0, ROT0, "Mazooma","Ducks Of Hazzard (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5emmer	,0,			sc5, sc5, 0, ROT0, "Mazooma","Emmerdale (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, ad5evol		,0,			sc5, sc5, 0, ROT0, "Qps","Evolution (Qps) (Adder 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5fguy		,0,			sc5, sc5, 0, ROT0, "BFM","Family Guy (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5fbspn	,0,			sc5, sc5, 0, ROT0, "BFM","Fat Boy Spin (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5fmj		,0,			sc5, sc5, 0, ROT0, "Mazooma","Full Metal Jackpot (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5glad		,0,			sc5, sc5, 0, ROT0, "Mazooma","Gladiator (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5gd		,0,			sc5, sc5, 0, ROT0, "BFM","Gold Digger (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5gdmz		,0,			sc5, sc5, 0, ROT0, "Mazooma","Gold Digger (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5gdclb	,0,			sc5, sc5, 0, ROT0, "BFM","Gold Digger Club (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5gball	,0,			sc5, sc5, 0, ROT0, "BFM","Golden Balls (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5gg		,0,			sc5, sc5, 0, ROT0, "Mazooma","Golden Game (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5ggg		,0,			sc5, sc5, 0, ROT0, "Mazooma","Grand Golden Game (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5gunp		,0,			sc5, sc5, 0, ROT0, "BFM","Gunpowder Slot (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5hapnt	,0,			sc5, sc5, 0, ROT0, "BFM","Happy Notes (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5hellb	,0,			sc5, sc5, 0, ROT0, "BFM","Hells Bells (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5hill		,0,			sc5, sc5, 0, ROT0, "BFM","Hill Billionaire (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5hiss		,0,			sc5, sc5, 0, ROT0, "Qps","Hissing Quid (Qps) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5hotdg	,0,			sc5, sc5, 0, ROT0, "BFM","Hot Dog (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5hotrd	,0,			sc5, sc5, 0, ROT0, "BFM","Hot Rod (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5hotsh	,0,			sc5, sc5, 0, ROT0, "BFM","Hot Shots (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5hotwd	,0,			sc5, sc5, 0, ROT0, "BFM","Hot Wad (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5celeb	,0,			sc5, sc5, 0, ROT0, "BFM","I'm A Celebrity (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5inspn	,0,			sc5, sc5, 0, ROT0, "Mazooma","Inner Spin (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5ijob		,0,			sc5, sc5, 0, ROT0, "Mazooma","Italian Job (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5jjok		,0,			sc5, sc5, 0, ROT0, "BFM","Jackpot Jokers (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5ldvl		,0,			sc5, sc5, 0, ROT0, "Mazooma","Little Devil (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5lotrr	,0,			sc5, sc5, 0, ROT0, "BFM","Lord Of The Rings - Return Of The King (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5manic	,0,			sc5, sc5, 0, ROT0, "BFM","Manic Miner (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5mmm		,0,			sc5, sc5, 0, ROT0, "Mazooma","Mental Money Monsters (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5mmad		,0,			sc5, sc5, 0, ROT0, "Mazooma","Money Madness (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5monsp	,0,			sc5, sc5, 0, ROT0, "BFM","Money Spinner (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5monop	,0,			sc5, sc5, 0, ROT0, "Mazooma","Monopoly (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, ad5monop	,0,			sc5, sc5, 0, ROT0, "Mazooma","Monopoly (Mazooma) (Adder 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5mcas		,0,			sc5, sc5, 0, ROT0, "Mazooma","Monopoly Casino (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5mdm		,0,			sc5, sc5, 0, ROT0, "BFM","Monopoly Double Money (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5mhn		,0,			sc5, sc5, 0, ROT0, "Mazooma","Monopoly Here & Now (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5mhp		,0,			sc5, sc5, 0, ROT0, "BFM","Monopoly Hot Property (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5mmb		,0,			sc5, sc5, 0, ROT0, "BFM","Monopoly Money Bags (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5mrh		,0,			sc5, sc5, 0, ROT0, "Mazooma","Monopoly Red Hot (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5mr2r		,0,			sc5, sc5, 0, ROT0, "Mazooma","Monopoly Road To Riches (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, ad5mr2r		,0,			sc5, sc5, 0, ROT0, "Mazooma","Monopoly Road To Riches (Mazooma) (Adder 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5mww		,0,			sc5, sc5, 0, ROT0, "Mazooma","Monopoly Wonders Of The World (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, ad5mww		,0,			sc5, sc5, 0, ROT0, "Mazooma","Monopoly Wonders Of The World (Mazooma) (Adder 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5nmare	,0,			sc5, sc5, 0, ROT0, "BFM","A Nightmare On Elm Street (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5potp		,0,			sc5, sc5, 0, ROT0, "BFM","Pick Of The Pack (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5pp		,0,			sc5, sc5, 0, ROT0, "Mazooma","Pink Panther (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, ad5pp		,0,			sc5, sc5, 0, ROT0, "Mazooma","Pink Panther (Mazooma) (Adder 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5ppcr		,0,			sc5, sc5, 0, ROT0, "Mazooma","Pink Panther Clouseau's Revenge (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5ppctc	,0,			sc5, sc5, 0, ROT0, "BFM","Pink Panther Crack The Code (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5ppdym	,0,			sc5, sc5, 0, ROT0, "Mazooma","Pink Panther Double Your Money (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5ppsag	,0,			sc5, sc5, 0, ROT0, "Mazooma","Pink Panther Strikes Again (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5pony		,0,			sc5, sc5, 0, ROT0, "BFM","Pony Express (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5popey	,0,			sc5, sc5, 0, ROT0, "Mazooma","Popeye (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5pog		,0,			sc5, sc5, 0, ROT0, "BFM","Pots Of Gold (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5pwrpl	,0,			sc5, sc5, 0, ROT0, "Mazooma","Power Play (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5pwrbl	,0,			sc5, sc5, 0, ROT0, "BFM","Powerball (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5quidv	,0,			sc5, sc5, 0, ROT0, "Mazooma","Quid Vicious (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5rhx		,0,			sc5, sc5, 0, ROT0, "Mazooma","Red Hot X (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5rhxcs	,0,			sc5, sc5, 0, ROT0, "Mazooma","Red Hot X Casino (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5redsq	,0,			sc5, sc5, 0, ROT0, "Mazooma","Red Square (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5rosts	,0,			sc5, sc5, 0, ROT0, "BFM","Ronnie O'Sullivan's Tournament Snooker (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5rovrt	,0,			sc5, sc5, 0, ROT0, "Mazooma","Rovers Return (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5smtm		,0,			sc5, sc5, 0, ROT0, "Mazooma","Show Me The Money (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5showt	,0,			sc5, sc5, 0, ROT0, "BFM","Showtime (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5slad		,0,			sc5, sc5, 0, ROT0, "BFM","Snakes & Ladders (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5spice	,0,			sc5, sc5, 0, ROT0, "BFM","Spice It Up (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5swywm	,0,			sc5, sc5, 0, ROT0, "Mazooma","Spin When Your Winning (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5sus		,0,			sc5, sc5, 0, ROT0, "Qps","Suits U Sir (Qps) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, ad5sslam	,0,			sc5, sc5, 0, ROT0, "BFM","Super Slam (Bellfruit) (Adder 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5swbak	,0,			sc5, sc5, 0, ROT0, "Mazooma","Switch Back (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5ttpie	,0,			sc5, sc5, 0, ROT0, "BFM","Take The Piece (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5typ		,0,			sc5, sc5, 0, ROT0, "BFM","Take Your Pick (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5tbox		,0,			sc5, sc5, 0, ROT0, "Mazooma","Top Box (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5tpsht	,0,			sc5, sc5, 0, ROT0, "Mazooma","Top Of The Shots (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5trail	,0,			sc5, sc5, 0, ROT0, "Mazooma","Trailblazer (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5vivam	,0,			sc5, sc5, 0, ROT0, "BFM","Viva Mexico (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5wldjk	,0,			sc5, sc5, 0, ROT0, "Mazooma","Wild Jackpots (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5adsnt	,0,			sc5, sc5, 0, ROT0, "BFM","Ant & Dec's Saturday Night Takeaway (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5bpb		,0,			sc5, sc5, 0, ROT0, "BFM","Bully's Prize Board (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5bsp		,0,			sc5, sc5, 0, ROT0, "BFM","Bully's Star Prize (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5chain	,0,			sc5, sc5, 0, ROT0, "BFM","Chain Reaction (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5clown	,0,			sc5, sc5, 0, ROT0, "BFM","Clown Around (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5copsr	,0,			sc5, sc5, 0, ROT0, "BFM","Cops 'n' Robbers (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, ad5copsr	,0,			sc5, sc5, 0, ROT0, "BFM","Cops 'n' Robbers (Bellfruit) (Adder 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5dndbe	,0,			sc5, sc5, 0, ROT0, "BFM","Deal Or No Deal Beat The Banker (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5dndbc	,0,			sc5, sc5, 0, ROT0, "BFM","Deal Or No Deal Box Clever (Bellfruit) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5mowow	,0,			sc5, sc5, 0, ROT0, "Mazooma","Monopoly Wheel Of Wealth (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, ad5mowow	,0,			sc5, sc5, 0, ROT0, "Mazooma","Monopoly Wheel Of Wealth (Mazooma) (Adder 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, sc5nunsm	,0,			sc5, sc5, 0, ROT0, "Mazooma","Nuns 'n' Roses (Mazooma) (Scorpion 5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
