...
ROM_START( j6cshrd )
	...
	ROM_LOAD16_BYTE( "cash_raiders_p2_23c4.bin"   , 0x000000, 0x020000, CRC(d61e26bf) SHA1(282d9455a8ab401a0eb04703b5e1b8f9ab37bfea) )
	ROM_LOAD16_BYTE( "cash_raiders_std_9661.bin"   , 0x000000, 0x020000, CRC(b97d1093) SHA1(e36d2c924e66f5868026bc0f1e31df955a49f874) )

	ROM_REGION( 0x80000, "upd", ROMREGION_ERASE00 )
	ROM_LOAD( "cashraider8b11as1_24-9-98.bin" , 0x000000, 0x080000, CRC(8d28ba3c) SHA1(5d403bdc4cfd6a3e14c1e9458dcda112ed1770c5) )
...
ROM_START( j6showtm )
	...
	ROM_REGION( 0x1000000, "altrevs", 0 )
	ROM_LOAD16_BYTE( "its_showtime_v1-2_(27c010)"   , 0x000000, 0x020000, CRC(e5db5a67) SHA1(6bdd8f48edb6c6dce9dc6ac742825b30e2efda40) )
	ROM_LOAD16_BYTE( "its_showtime_v1a1_(27c010)"   , 0x000000, 0x020000, CRC(c10295cf) SHA1(076f25a24a08e0d3657ac90f54a29af1e22603d9) )
	ROM_LOAD16_BYTE( "its_showtime_v2-1_(27c010)"   , 0x000000, 0x020000, CRC(b5ea1f52) SHA1(08d6bc1add1e659b59e2edc9de88dd976587ece3) )
	ROM_LOAD16_BYTE( "its_showtime_v2-2_(27c010)"   , 0x000000, 0x020000, CRC(ae952cf9) SHA1(e27c616e74eb139daf98479fed0cc1bfcf5619b5) )
...
ROM_START( j6montlk )
	ROM_REGION( 0x1000000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "money_talks_8_3-1.bin"   , 0x000000, 0x020000, CRC(42936de2) SHA1(e9ba9f2af8a6e2bcf887976f50ff7e3e3dcf86d7) )
	ROM_LOAD16_BYTE( "money_talks_8_3-2.bin"   , 0x000001, 0x020000, CRC(25ad84ed) SHA1(f704eceadc6f4f422f6ff421837aa6c9f2f533f7) )
	...
	ROM_LOAD16_BYTE( "money_talks_8_3i1.bin"   , 0x000000, 0x020000, CRC(4edec3d3) SHA1(fa05a84819f4fc7f128b149ea4fcd6edee6d3b78) )
...
ROM_START( j6pacman )
	...
	ROM_LOAD( "pacman_plus_snd_1_65e5.bin"    , 0x000000, 0x080000, CRC(f0130ebe) SHA1(fd623add85d2faa556561f5b5b74c7c17d4ba02a) )
...
ROM_START( j6pog )
	...
	ROM_LOAD16_BYTE( "ace_pog_v3-2_(27c010)"   , 0x000000, 0x020000, CRC(28a2a74c) SHA1(c95a6a0a89cf942ba2460c46185e782f0445df2f) )
	ROM_LOAD16_BYTE( "ace_pog_v3a1_(27c010)"   , 0x000000, 0x020000, CRC(5b37fafc) SHA1(0aa7d0d813832f99150521d97ed754fa1f5f5fc6) )
...
ROM_START( j6cpala )
	...
	ROM_REGION( 0x80000, "upd", ROMREGION_ERASE00 )
	ROM_LOAD( "cpalace22-06-98_68d0a91.bin" , 0x0000, 0x080000, CRC(56d581e0) SHA1(d22796ec6d96f4d4ea10dfdb925ceaff032fe7d0) )
...
ROM_START( j6shoot )
	ROM_REGION( 0x1000000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "shoot_out_p1"  , 0x00000, 0x020000, CRC(d1797023) SHA1(6a75451b0e5954c87f65f333a5fc73d3ac43d1f4) )
	//ROM_LOAD( "shoot_ou" , 0x0000, 0x020000, CRC(d1797023) SHA1(6a75451b0e5954c87f65f333a5fc73d3ac43d1f4) )
