...
static ADDRESS_MAP_START( tms_program_map, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0x00800000, 0x00ffffff) AM_MIRROR(0xf8000000) AM_ROM AM_REGION(RGNCLASS_USER, "user1", 0x100000)
	AM_RANGE(0x02000000, 0x027fffff) AM_MIRROR(0xf8000000) AM_ROM AM_REGION(RGNCLASS_USER, "user1", 0)
...
ROM_START( cluedo )
	...
	ROM_COPY( RGNCLASS_USER, "user1", 0x000000, 0x100000, 0x100000 )

	ROM_REGION( 0x80000, RGNCLASS_SOUND, "upd", 0 )
