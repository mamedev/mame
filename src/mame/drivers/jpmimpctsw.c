...
ROM_START( j6frc10d )
	...
	ROM_LOAD16_BYTE( "f1015p2", 0x000000, 0x020001, CRC(36508a26) SHA1(e31a3e2e5e1048e087ef112cd9ef949a4e60228b) )
	j6frc10_sound
ROM_END
...
ROM_START( j6hapyhr )
	...
	ROM_LOAD16_BYTE( "20427.bin", 0x000001, 0x020001, CRC(3de94b07) SHA1(ce1a712845ccc5fa9ef92b3d07f8872afeec88f8) ) 
	j6hapyhr_sound
ROM_END
...
ROM_START( j6hapyhrb )
	...
	ROM_LOAD16_BYTE( "20427.bin", 0x000001, 0x020001, CRC(3de94b07) SHA1(ce1a712845ccc5fa9ef92b3d07f8872afeec88f8) ) // aka happyhour.p2
	j6hapyhr_sound
ROM_END
