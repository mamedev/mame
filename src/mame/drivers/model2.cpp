...
ROM_START( manxtta ) // Manx TT Superbike DX Revision A, Model 2A
	ROM_REGION( 0x200000, "maincpu", 0 ) // i960 program
	ROM_LOAD32_WORD( "epr-18822d.12", 0x000000, 0x020000, BAD_DUMP CRC(4f435990) SHA1(0fcf64598384012caea27394280de89a9348a47d) ) // Not dumped on this set (should be EPR-18744.12)
	ROM_LOAD32_WORD( "epr-18823d.13", 0x000002, 0x020000, BAD_DUMP CRC(b8eddb5c) SHA1(7e3b97e3370e68d92922e8999246064196610270) ) // Not dumped on this set (should be EPR-18745.13)
	ROM_LOAD32_WORD( "epr-18824d.14", 0x040000, 0x020000, BAD_DUMP CRC(aca9f61f) SHA1(629db70371ea9986ef75557044b5e98329712418) ) // Not dumped on this set
	ROM_LOAD32_WORD( "epr-18825d.15", 0x040002, 0x020000, BAD_DUMP CRC(5a1d7799) SHA1(bb5e8a5a3b766b5dc4285ecba330094caf8a71e6) ) // Not dumped on this set
	...
	ROM_REGION( 0x080000, "audiocpu", 0 ) // Sound program
	ROM_LOAD16_WORD_SWAP( "epr-18746.30", 0x000000, 0x040000, CRC(ad6f40ec) SHA1(27aa0477dc325162766d459ffe95b61ee65dd28f) )

	ROM_REGION16_BE( 0x800000, "samples", 0 ) // Samples
	ROM_LOAD16_WORD_SWAP( "mpr-18763.31", 0x000000, 0x200000, CRC(1bcb2283) SHA1(a4a8a2f8f0901bfb57778351210ccfc421cacbd4) )
	ROM_LOAD16_WORD_SWAP( "mpr-18764.32", 0x200000, 0x200000, CRC(0dc6a860) SHA1(cb2ada0f8a592940de11ee781ad4beb5095c3b37) )
	ROM_LOAD16_WORD_SWAP( "mpr-18765.36", 0x400000, 0x200000, CRC(ca4a803c) SHA1(70b59da8f2532a02e980caba5bb86ec13a4d7ab5) )
	ROM_LOAD16_WORD_SWAP( "mpr-18766.37", 0x600000, 0x200000, CRC(e41892ea) SHA1(9ef5e26db4abf0ed36df63fc246b568e1c5d6cfa) )
