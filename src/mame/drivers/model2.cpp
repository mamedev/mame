...
static INPUT_PORTS_START( model2 )
	...
	PORT_START("DSW")
	PORT_DIPUNUSED_DIPLOC(0x01, 0x01, "DSW:1")
	PORT_DIPUNUSED_DIPLOC(0x02, 0x02, "DSW:2")
	PORT_DIPUNUSED_DIPLOC(0x04, 0x04, "DSW:3")
	PORT_DIPUNUSED_DIPLOC(0x08, 0x08, "DSW:4")
	PORT_DIPUNUSED_DIPLOC(0x10, 0x10, "DSW:5")
	PORT_DIPUNUSED_DIPLOC(0x20, 0x20, "DSW:6")
	PORT_DIPUNUSED_DIPLOC(0x40, 0x40, "DSW:7")
	PORT_DIPUNUSED_DIPLOC(0x80, 0x80, "DSW:8")
INPUT_PORTS_END
