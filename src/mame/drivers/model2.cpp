...
ROM_START( vf2 ) /* Virtua Fighter 2 Version 2.1, Model 2A */
	...
	ROM_REGION( 0x1000000, "user3", ROMREGION_ERASEFF ) // Textures
...
ROM_START( stcc ) /* Sega Touring Car Championship, Model 2C - Defaults to Japan, Twin & Default View set to Bird's */
	...
	ROM_COPY( "user3", 0x000000, 0x400000, 0x400000 )
...
ROM_START( lastbrnx ) /* Last Bronx Revision A (Export), Model 2B */
	...
	ROM_REGION( 0x800000, "user3", ROMREGION_ERASEFF ) // Textures
...
ROM_START( doaa ) /* Dead or Alive Revision A, Model 2A, Sega Game ID# 833-11341, ROM board ID# 834-11342, 837-12880 security board */
	...
	ROM_COPY("user1", 0x1800000, 0x1c00000, 0x400000 )

	ROM_REGION( 0x800000, "tgp", ROMREGION_ERASE00 ) // TGP data (COPRO sockets)

	ROM_REGION( 0x2000000, "user2", ROMREGION_ERASEFF ) // Models
...
ROM_START( daytona93 ) /* Daytona USA (Deluxe cabinet, '93 version. There is said to be a Deluxe '94 edition) */
	...
	ROM_COPY( "user1", 0x900000, 0xa00000, 0x100000 )
...
GAME( 1997, motoraid,  0,       manxtt,       manxtt,   model2a_state, 0,       ROT0, "Sega",   "Motor Raid - Twin", MACHINE_NOT_WORKING|MACHINE_IMPERFECT_GRAPHICS )
GAME( 1997, motoraiddx,motoraid,manxtt,       manxtt,   model2a_state, 0,       ROT0, "Sega",   "Motor Raid - Twin/DX", MACHINE_NOT_WORKING|MACHINE_IMPERFECT_GRAPHICS )
...
GAME( 1994, vstriker,  0,        model2b,      model2,  model2b_state, 0,        ROT0, "Sega",   "Virtua Striker (Revision A)", MACHINE_NOT_WORKING|MACHINE_IMPERFECT_GRAPHICS )
GAME( 1994, vstrikero, vstriker, model2b,      model2,  model2b_state, 0,        ROT0, "Sega",   "Virtua Striker", MACHINE_NOT_WORKING|MACHINE_IMPERFECT_GRAPHICS )
