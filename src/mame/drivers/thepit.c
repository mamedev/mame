...
ROM_START( thepit )
	...
	ROM_REGION( 0x1800, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) /* chars and sprites */
...
ROM_START( intrepid )
	...
	ROM_REGION( 0x2000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) /* chars and sprites */
...
ROM_START( funnymou )
	...
	ROM_REGION( 0x3000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) /* chars and sprites */
