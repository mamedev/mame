...
ROM_START( friskyt )
	...
	ROM_REGION( 0x10000, RGNCLASS_CPU, "mcu", 0 )	/* 64k for the protection mcu */
	ROM_COPY( RGNCLASS_CPU, "main", 0x0000, 0x8000, 0x8000 )	/* shares the main program ROMs and RAM with the main CPU. */
