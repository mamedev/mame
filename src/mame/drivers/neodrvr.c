...
#define NEOGEO_BIOS \
	ROM_REGION16_BE( 0x20000, RGNCLASS_USER, "mainbios", 0 ) 													\
...
#define NEO_BIOS_AUDIO_64K(name, hash) 																			\
	NEOGEO_BIOS 																								\
																												\
	ROM_REGION( 0x20000, RGNCLASS_USER, "audiobios", 0 )														\
...
#define NEO_BIOS_AUDIO_128K(name, hash) 																		\
	...
	ROM_LOAD( "sm1.sm1", 0x00000, 0x20000, CRC(97cf998b) SHA1(977387a7c76ef9b21d0b01fa69830e949a9a9626) )		\
																												\
	ROM_REGION( 0x30000, RGNCLASS_CPU, "audio", 0 )													\
...
#define NEO_BIOS_AUDIO_256K(name, hash) 																		\
	...
	ROM_LOAD( "sm1.sm1", 0x00000, 0x20000, CRC(97cf998b) SHA1(977387a7c76ef9b21d0b01fa69830e949a9a9626) )		\
																												\
	ROM_REGION( 0x50000, RGNCLASS_CPU, "audio", 0 )													\
...
#define NEO_BIOS_AUDIO_512K(name, hash) 																		\
	...
	ROM_LOAD( "sm1.sm1", 0x00000, 0x20000, CRC(97cf998b) SHA1(977387a7c76ef9b21d0b01fa69830e949a9a9626) )		\
																												\
	ROM_REGION( 0x90000, RGNCLASS_CPU, "audio", 0 )													\
...
#define NEO_SFIX_32K(name, hash) 																				\
	ROM_REGION( 0x20000, RGNCLASS_GFX, "fixed", 0 ) 												\
	ROM_LOAD( name,       0x000000, 0x08000, hash ) 															\
																												\
	ROM_REGION( 0x20000, RGNCLASS_GFX, "fixedbios", 0 ) 													\
...
#define ROM_Y_ZOOM																								\
	ROM_REGION( 0x10000, RGNCLASS_GFX, "zoomy", 0 )														\
...
ROM_START( nam1975 ) /* MVS AND AES VERSION */
	...
	ROM_REGION( 0x300000, RGNCLASS_GFX, "sprites", ROMREGION_DISPOSE )
...
ROM_START( bstars )
	...
	ROM_REGION( 0x200000, RGNCLASS_SOUND, "ym", 0 )
	...
	ROM_REGION( 0x080000, RGNCLASS_SOUND, "ym.deltat", 0 )
...
ROM_START( tpgolf ) /* MVS AND AES VERSION */
	...
	ROM_REGION( 0x200000, RGNCLASS_SOUND, "ym.deltat", 0 )
	...
	ROM_REGION( 0x400000, RGNCLASS_GFX, "sprites", ROMREGION_DISPOSE )
...
ROM_START( mahretsu )
	...
	ROM_REGION( 0x100000, RGNCLASS_SOUND, "ym", 0 )
	...
	ROM_REGION( 0x200000, RGNCLASS_GFX, "sprites", ROMREGION_DISPOSE )
...
ROM_START( maglord )
	...
	ROM_REGION( 0x100000, RGNCLASS_SOUND, "ym.deltat", 0 )
...
ROM_START( ncombat )
	...
	ROM_REGION( 0x180000, RGNCLASS_SOUND, "ym", 0 )
...
ROM_START( lbowling )
	...
	ROM_REGION( 0x100000, RGNCLASS_GFX, "sprites", ROMREGION_DISPOSE )
...
ROM_START( kotm2 )
	...
	ROM_REGION( 0x300000, RGNCLASS_SOUND, "ym", 0 )
	...
	ROM_REGION( 0x600000, RGNCLASS_GFX, "sprites", ROMREGION_DISPOSE )
...
ROM_START( bstars2 )
	...
	ROM_REGION( 0x280000, RGNCLASS_SOUND, "ym", 0 )
...
ROM_START( 3countb ) /* MVS AND AES VERSION */
	...
	ROM_REGION( 0x400000, RGNCLASS_SOUND, "ym", 0 )
	...
	ROM_REGION( 0x0800000, RGNCLASS_GFX, "sprites", ROMREGION_DISPOSE )
...
ROM_START( aof ) /* MVS AND AES VERSION */
	...
	ROM_REGION( 0x800000, RGNCLASS_GFX, "sprites", ROMREGION_DISPOSE )
...
ROM_START( samsho ) /* MVS VERSION */
	...
	ROM_REGION( 0xa00000, RGNCLASS_GFX, "sprites", ROMREGION_DISPOSE )
...
ROM_START( samshoh ) /* AES VERSION */
	...
	ROM_REGION( 0x900000, RGNCLASS_GFX, "sprites", ROMREGION_DISPOSE )
	ROM_LOAD16_BYTE( "045-c1.bin", 0x000000, 0x200000, CRC(2e5873a4) SHA1(65c74c1e2d34390666bbb630df7d1f4c9570c3db) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "045-c2.bin", 0x000001, 0x200000, CRC(04febb10) SHA1(16a8cbf0fd9468e81bf9eab6dbe7a8e3623a843e) ) /* Plane 2,3 */
	ROM_LOAD16_BYTE( "045-c3.bin", 0x400000, 0x200000, CRC(f3dabd1e) SHA1(c80e52df42be9f8b2e89b467b11ab140a480cee8) ) /* Plane 0,1 */
	ROM_LOAD16_BYTE( "045-c4.bin", 0x400001, 0x200000, CRC(935c62f0) SHA1(0053d40085fac14096b683f4341f65e543b71dc1) ) /* Plane 2,3 */
...
ROM_START( kof94 )
	...
	ROM_REGION( 0x600000, RGNCLASS_SOUND, "ym", 0 )
	...
	ROM_REGION( 0x1000000, RGNCLASS_GFX, "sprites", ROMREGION_DISPOSE )
...
ROM_START( aof2 )
	...
	ROM_REGION( 0x500000, RGNCLASS_SOUND, "ym", 0 )
...
ROM_START( wh2 )
	...
	ROM_REGION( 0xc00000, RGNCLASS_GFX, "sprites", ROMREGION_DISPOSE )
...
ROM_START( samsho2 ) /* MVS AND AES VERSION */
	...
	ROM_REGION( 0x700000, RGNCLASS_SOUND, "ym", 0 )
...
ROM_START( fatfury3 ) /* MVS AND AES VERSION */
	...
	ROM_REGION( 0xa00000, RGNCLASS_SOUND, "ym", 0 )
	...
	ROM_REGION( 0x1400000, RGNCLASS_GFX, "sprites", ROMREGION_DISPOSE )
...
ROM_START( zupapa ) /* Original Version - Encrypted GFX */
	...
	ROM_REGION( 0x0200000, RGNCLASS_SOUND, "ym", 0 )
...
ROM_START( galaxyfg )
	...
	ROM_REGION( 0xe00000, RGNCLASS_GFX, "sprites", ROMREGION_DISPOSE )
...
ROM_START( pbobblen ) /* MVS VERSION */
	...
	ROM_REGION( 0x380000, RGNCLASS_SOUND, "ym", 0 )
	...
	ROM_REGION( 0x500000, RGNCLASS_GFX, "sprites", ROMREGION_DISPOSE )
...
ROM_START( kof95 )
	...
	ROM_REGION( 0x900000, RGNCLASS_SOUND, "ym", 0 )
	...
	ROM_REGION( 0x1a00000, RGNCLASS_GFX, "sprites", ROMREGION_DISPOSE )
...
ROM_START( pulstar )
	...
	ROM_REGION( 0x800000, RGNCLASS_SOUND, "ym", 0 )
	...
	ROM_REGION( 0x1c00000, RGNCLASS_GFX, "sprites", ROMREGION_DISPOSE )
...
ROM_START( rbff1 ) /* MVS AND AES VERSION */
	...
	ROM_REGION( 0xc00000, RGNCLASS_SOUND, "ym", 0 )
	ROM_LOAD( "069-v1.bin", 0x000000, 0x400000, CRC(2bdbd4db) SHA1(5f4fecf69c2329d699cbd45829c19303b1e2a80e) )
	ROM_LOAD( "069-v2.bin", 0x400000, 0x400000, CRC(a698a487) SHA1(11b8bc53bc26a51f4a408e900e3769958625c4ed) )
...
ROM_START( sdodgeb )
	...
	ROM_REGION( 0x0c00000, RGNCLASS_GFX, "sprites", ROMREGION_DISPOSE )
...
ROM_START( kof96 ) /* MVS VERSION */
	...
	ROM_REGION( 0x2000000, RGNCLASS_GFX, "sprites", ROMREGION_DISPOSE )
...
ROM_START( wakuwak7 )
	...
	ROM_REGION( 0x1800000, RGNCLASS_GFX, "sprites", ROMREGION_DISPOSE )
...
ROM_START( kof97 )
	...
	ROM_REGION( 0x2800000, RGNCLASS_GFX, "sprites", ROMREGION_DISPOSE )
...
ROM_START( magdrop3 )
	...
	ROM_REGION( 0x480000, RGNCLASS_SOUND, "ym", 0 )
...
ROM_START( lastblad ) /* MVS VERSION */
	...
	ROM_REGION( 0x1000000, RGNCLASS_SOUND, "ym", 0 )
...
ROM_START( rbff2 ) /* MVS VERSION */
	...
	ROM_REGION( 0x0e00000, RGNCLASS_SOUND, "ym", 0 )
	...
	ROM_REGION( 0x3000000, RGNCLASS_GFX, "sprites", ROMREGION_DISPOSE )
...
ROM_START( kof98 ) /* encrypted code + protection */
	...
	ROM_REGION( 0x4000000, RGNCLASS_GFX, "sprites", ROMREGION_DISPOSE )
...
ROM_START( kof99 ) /* Original Version - Encrypted Code & GFX */ /* AES VERSION */
	ROM_REGION( 0x900000, RGNCLASS_CPU, "main", 0 )
...
ROM_START( ganryu ) /* Original Version - Encrypted GFX */
	...
	ROM_REGION( 0x0400000, RGNCLASS_SOUND, "ym", 0 )
...
ROM_START( garou )
	...
	/* The Encrypted Boards do _not_ have an s1 rom, data for it comes from the Cx ROMs */
	ROM_REGION( 0x80000, RGNCLASS_GFX, "fixed", 0 )	/* larger char set */
	ROM_FILL(                 0x000000, 0x20000, 0 )
	ROM_REGION( 0x20000, RGNCLASS_GFX, "fixedbios", 0 )
	ROM_LOAD( "sfix.sfx",  0x000000, 0x20000, CRC(354029fc) SHA1(4ae4bf23b4c2acff875775d4cbff5583893ce2a1) )
...
ROM_START( preisle2 ) /* Original Version, Encrypted GFX */
	...
	ROM_REGION( 0x0600000, RGNCLASS_SOUND, "ym", 0 )
...
ROM_START( kof2000 ) /* Original Version, Encrypted Code + Sound + GFX Roms */
	...
	ROM_REGION( 0x40000, RGNCLASS_USER, "audioencrypted", 0 )
...
ROM_START( mslug4 ) /* Original Version - Encrypted GFX */ /* MVS VERSION */
	...
	/* The M1 ROM is encrypted, we load it here for reference and replace it with a decrypted version */
	ROM_REGION( 0x20000, RGNCLASS_USER, "audioencrypted", 0 )
...
ROM_START( matrim ) /* Encrypted Set */ /* MVS AND AES VERSION */
	...
	/* The Encrypted Boards do _not_ have an s1 rom, data for it comes from the Cx ROMs */
	ROM_REGION( 0x80000, RGNCLASS_GFX, "fixed", 0 )
...
ROM_START( pnyaa ) /* Encrypted Set */ /* MVS VERSION */
	...
	ROM_REGION( 0x80000, RGNCLASS_USER, "audioencrypted", 0 )
	/* Encrypted, we load it here for reference and replace with decrypted ROM */
...
ROM_START( ms5pcb ) /* Encrypted Set */
	...
	ROM_REGION16_BE( 0x80000, RGNCLASS_USER, "mainbios", 0 )
...
ROM_START( svcpcb ) /* Encrypted Set, JAMMA PCB */
	ROM_REGION( 0x2000000, RGNCLASS_CPU, "main", 0 )
...
ROM_START( svcboot ) /* bootleg */
	...
	ROM_CONTINUE(           0x00000, 0x10000 )
	ROM_COPY( RGNCLASS_CPU, "audio",  0x00000, 0x10000, 0x10000 )
...
ROM_START( kf2k3pcb ) /* Encrypted Set, JAMMA PCB */
	...
	ROM_REGION( 0x100000, RGNCLASS_GFX, "fixed", 0 ) /* larger char set */
	...
	ROM_REGION( 0x6000000, RGNCLASS_GFX, "sprites", ROMREGION_DISPOSE )
	/* Encrypted */
...
ROM_START( kof2003 ) /* Encrypted Code + Sound + GFX Roms */ /* MVS VERSION */
	...
	ROM_REGION( 0x080000, RGNCLASS_USER, "audioencrypted", 0 )
	/* The M1 ROM is encrypted, we load it here for reference and replace it with a decrypted version */
...
ROM_START( kf2k3bla ) /* bootleg */
	ROM_REGION( 0x700000, RGNCLASS_CPU, "main", 0 )
...
ROM_START( vliner )
	...
	ROM_REGION( 0x200000, RGNCLASS_SOUND, "ym", ROMREGION_ERASE00 )
...
ROM_START( ct2k3sp ) /*  Protected hack/bootleg of kof2001 Phenixsoft */
	...
	ROM_REGION( 0x40000, RGNCLASS_GFX, "fixed", 0 )
...
ROM_START( kf10thep ) /* this is a hack of kof2002 much like the various korean hacks / bootlegs of games */
	...
	ROM_REGION( 0x200000, RGNCLASS_USER, "audioencrypted", 0 )
...
ROM_START( neogeo )
	...
	ROM_REGION( 0x100000, RGNCLASS_CPU, "main", ROMREGION_ERASEFF )
	...
	ROM_REGION( 0x20000, RGNCLASS_GFX, "fixed", ROMREGION_ERASEFF )

	ROM_REGION( 0x20000, RGNCLASS_GFX, "fixedbios", 0 )
	ROM_LOAD( "sfix.sfx",  0x000000, 0x20000, CRC(354029fc) SHA1(4ae4bf23b4c2acff875775d4cbff5583893ce2a1) )

	ROM_REGION( 0x10000, RGNCLASS_SOUND, "ym", ROMREGION_ERASEFF )

	NO_DELTAT_REGION

	ROM_REGION( 0x100000, RGNCLASS_GFX, "sprites", ROMREGION_DISPOSE | ROMREGION_ERASEFF )
ROM_END
...
static TIMER_CALLBACK( svcpcb_bios_timer_callback )
{
	...
	memory_set_bankptr(NEOGEO_BANK_BIOS, memory_region(machine, RGNCLASS_USER, "mainbios")+0x20000+harddip3*0x20000);
}
