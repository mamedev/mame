...
ROM_START( magicbub )
	...
	ROM_REGION( 0x200000*8, RGNCLASS_GFX, "gfx1", ROMREGION_ERASEFF | ROMREGION_DISPOSE )	/* 16x16x8 */
	...
	ROM_REGION( 0x080000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE )	/* 16x16x4 */
...
ROM_START( paprazzi )
	...
	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE )	/* 16x16x4 */
	...
	ROM_REGION( 0x080000 * 2, RGNCLASS_SOUND, "oki", 0 )	/* Samples */
