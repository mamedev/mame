...
{
	const INT32 *pPointData = (INT32 *)memory_region( Machine, RGNCLASS_USER, "user2" );
...
InitDSP( void )
{
	UINT16 *pMem = (UINT16 *)memory_region(Machine, RGNCLASS_CPU, "dspmaster");
	/**
...
{
	UINT16 *ptrom = (UINT16 *)memory_region(machine, RGNCLASS_USER, "user2");
...
{
	const UINT16 *pSrc = (UINT16 *)memory_region( machine, RGNCLASS_USER, "user3" );
	return pSrc[offset];
}
...
static WRITE16_HANDLER( winrun_dspbios_w )
{
	...
	if( offset==0xfff )
	{
		UINT16 *mem = (UINT16 *)memory_region(machine, RGNCLASS_CPU, "dsp");
...
ROM_START( aircombu )
	ROM_REGION( 0x100000, RGNCLASS_CPU, "main", 0 ) /* Master */
	...
	ROM_REGION( 0x80000, RGNCLASS_CPU, "slave", 0 ) /* Slave */
	...
	ROM_REGION( 0x030000, RGNCLASS_CPU, "audio", 0 ) /* Sound */
	...
	ROM_REGION( 0x20000, RGNCLASS_CPU, "dspmaster", 0 ) /* Master DSP */
	ROM_LOAD( "c67.bin", 0, 0x2000, CRC(6bd8988e) SHA1(c9ec18d5f88d53976b94444eedc64d5568155958) )
	ROM_REGION( 0x20000, RGNCLASS_CPU, "dspslave", 0 ) /* Slave DSP */
	ROM_LOAD( "c67.bin", 0, 0x2000, CRC(6bd8988e) SHA1(c9ec18d5f88d53976b94444eedc64d5568155958) )
	...
	ROM_REGION16_BE( 0x200000, RGNCLASS_USER, "user1", 0 ) /* collision */
	...
	ROM_REGION32_BE( 0x400000, RGNCLASS_USER, "user2", ROMREGION_ERASE )		/* 24bit signed point data */
	...
	ROM_REGION( 0x200000, RGNCLASS_SOUND, "c140", 0 ) /* sound samples */
...
ROM_START( aircombj )
	...
	ROM_REGION( 0x080000, RGNCLASS_CPU, "slave", 0 ) /* Slave */
...
ROM_START( cybsled )
	...
	ROM_REGION( 0x100000, RGNCLASS_CPU, "slave", 0 ) /* Slave */
	...
	ROM_REGION16_BE( 0x200000, RGNCLASS_USER, "user1", 0 ) /* 68k */
...
ROM_START( driveyes )
	ROM_REGION( 0x40000, RGNCLASS_CPU, "main", 0 ) /* C68C - 68k code */
	...
	ROM_REGION( 0x40000, RGNCLASS_CPU, "slave", 0 ) /* C68 - 68k code */
	...
	ROM_REGION( 0x30000, RGNCLASS_CPU, "audio", 0 ) /* Sound */
/*
...
*/
	...
	ROM_REGION( 0x10000, RGNCLASS_CPU, "mcu", 0 ) /* I/O MCU */
	ROM_LOAD( "sys2mcpu.bin",  0x000000, 0x002000, CRC(a342a97e) SHA1(2c420d34dba21e409bf78ddca710fc7de65a6642) )
	ROM_LOAD( "sys2c65c.bin",  0x008000, 0x008000, CRC(a5b2a4ff) SHA1(068bdfcc71a5e83706e8b23330691973c1c214dc) )

	ROM_REGION( 0x20000, RGNCLASS_CPU, "dsp", ROMREGION_ERASEFF ) /* C67 - DSP */
	...
	ROM_REGION16_BE( 0x100000, RGNCLASS_USER, "user1", 0 ) /* 68k */
	...
	ROM_REGION16_BE( 0xc0000, RGNCLASS_USER, "user2", 0 ) /* 3d objects */
	...
	ROM_REGION( 0x100000, RGNCLASS_SOUND, "c140", 0 ) /* sound samples */
...
ROM_START( starblad )
	...
	ROM_REGION16_BE( 0x40000, RGNCLASS_USER, "user1", 0 )
...
ROM_START( winrun )
	ROM_REGION( 0x40000, RGNCLASS_CPU, "main", 0 ) /* 68k code */
	...
	ROM_REGION( 0x40000, RGNCLASS_CPU, "slave", 0 ) /* 68k code */
	...
	ROM_REGION( 0x20000, RGNCLASS_CPU, "dsp", ROMREGION_ERASEFF ) /* DSP */

	ROM_REGION( 0x80000, RGNCLASS_CPU, "gpu", 0 ) /* 68k code */
	...
	ROM_REGION16_BE( 0x80000, RGNCLASS_USER, "user1", 0 ) /* 68k */
	...
	ROM_REGION16_BE( 0x80000, RGNCLASS_USER, "user2", 0 ) /* 3d objects */
	...
	ROM_REGION16_BE( 0x100000, RGNCLASS_USER, "user3", 0 ) /* bitmapped graphics */
...
ROM_START( winrun91 )
	...
	ROM_REGION16_BE( 0x80000, RGNCLASS_USER, "user2", 0 ) /* winrun91 - 3d objects */
...
static void namcos21_init( int game_type )
{
	...
	mpDataROM = (UINT16 *)memory_region( Machine, RGNCLASS_USER, "user1" );
	InitDSP();
	mbNeedsKickstart = 20;
...
{
	UINT16 *pMem = (UINT16 *)memory_region(machine, RGNCLASS_CPU, "dsp");
	int pc = 0;
	pMem[pc++] = 0xff80; /* b */
	pMem[pc++] = 0;
...
{
	UINT16 *mem = (UINT16 *)memory_region(machine, RGNCLASS_CPU, "main");
