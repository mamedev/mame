...
//  MCFG_WATCHDOG_VBLANK_INIT(8)
	...
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(mcr68_state, zwackery_pia0_w))
	MCFG_PIA6821_IRQA_HANDLER(WRITELINE(mcr68_state, zwackery_pia_irq))
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(mcr68_state, zwackery_pia_irq))

	MCFG_DEVICE_ADD("pia1", PIA6821, 0)
	MCFG_PIA6821_READPA_HANDLER(READ8(mcr68_state,zwackery_port_1_r))
	MCFG_PIA6821_READPB_HANDLER(READ8(mcr68_state, zwackery_port_2_r))
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(mcr68_state, zwackery_pia1_w))
	MCFG_PIA6821_CA2_HANDLER(WRITELINE(mcr68_state, zwackery_ca2_w))

	MCFG_DEVICE_ADD("pia2", PIA6821, 0)
	MCFG_PIA6821_READPA_HANDLER(READ8(mcr68_state, zwackery_port_3_r))
