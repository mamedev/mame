...
ROM_START( zwackery )
	...
	ROM_REGION( 0x20000, RGNCLASS_CPU, "csd", 0 )
	...
	ROM_REGION( 0x8000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE | ROMREGION_INVERT )
	...
	ROM_REGION( 0x8000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE )	/* bg color maps */
	...
	ROM_REGION( 0x000D, RGNCLASS_PLDS, "plds", ROMREGION_DISPOSE )
...
ROM_START( xenophob )
	...
	ROM_REGION( 0x40000, RGNCLASS_CPU, "sg", 0 )  /* Sounds Good board */
	...
	ROM_REGION( 0x0006, RGNCLASS_PLDS, "plds", ROMREGION_DISPOSE )
...
ROM_START( archrivl )
	...
	ROM_REGION( 0x90000, RGNCLASS_CPU, "cvsd", 0 )  /* Audio System board */
	...
	ROM_REGION( 0x1200, RGNCLASS_PLDS, "plds", ROMREGION_DISPOSE )
...
ROM_START( trisport )
	...
	ROM_REGION( 0x1400, RGNCLASS_PLDS, "plds", ROMREGION_DISPOSE )
