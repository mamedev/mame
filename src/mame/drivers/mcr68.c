...
ROM_START( zwackery )
	...
	ROM_REGION( 0x8000, "gfx1", ROMREGION_DISPOSE | ROMREGION_INVERT )
	...
	ROM_REGION( 0x8000, "gfx3", ROMREGION_DISPOSE )	/* bg color maps */
	...
	ROM_REGION( 0x000D, "plds", ROMREGION_DISPOSE )
...
ROM_START( trisport )
	...
	ROM_REGION( 0x1400, "plds", ROMREGION_DISPOSE )
