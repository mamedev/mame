...
ROM_START( sc1clatta )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "club_attraction_393717553_prom_b.bin"    , 0x0000, 0x8000, CRC(06f41627) SHA1(0e54314147a5f0d833d83f6f0ee828bd1c875f3e) )
	ROM_LOAD( "club_attraction_393717552_prom_a.bin"    , 0x8000, 0x8000, CRC(795e93cf) SHA1(017fa5ea3d9ad1f7a7a619d88a5892a9ffe6f3bc) )
ROM_END
...
ROM_START( sc1barcd )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "95740352_b.bin" , 0x0000, 0x8000, CRC(6dc3cfd3) SHA1(d71d433ae560ac4db345630ee7f04a7cfb7e933e) )
	ROM_LOAD( "95740351_a.bin" , 0x8000, 0x8000, CRC(0891350b) SHA1(ea1295768738b9b89eac19d04411220a8c9d10c7) )
...
ROM_START( sc1barcda )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "barcode_5_10p_b.bin"  , 0x0000, 0x8000, CRC(69d4d0b2) SHA1(bb73b917cf414623dcd239c5daeeccb4e0ccc2ed) )
	ROM_LOAD( "barcode_5_10p_a.bin"  , 0x8000, 0x8000, CRC(e864aba1) SHA1(b3f707b6d5f3d7236e4a5e9ed78c61a78c3e8196) )
...
ROM_START( sc1cshat )
	...
	ROM_LOAD( "957172.40_b_std_var%.bin"   , 0x0000, 0x008000, CRC(5e4381f9) SHA1(ae6d64c42ae7ddc2ed0ab5c3b56222090004d88a) )
	ROM_LOAD( "957182.20_var%_proto_a.bin"   , 0x0000, 0x008000, CRC(3a2dd72d) SHA1(29d962702095aa0f252210da68a89c557fa9db69) )
	ROM_LOAD( "957182.39_74-78_proto_a.bin"   , 0x0000, 0x008000, CRC(f890b2d3) SHA1(e714973c63486e6983912fb6aebee3a71e003be5) )
	ROM_LOAD( "957182.39_proto_var%.bin"  , 0x0000, 0x008000, CRC(43f452a7) SHA1(13ef94b4a4ecf729dfe481da26804f2e6f0631b0) )
	ROM_LOAD( "957272.40_74-78b.bin" , 0x0000, 0x008000, CRC(e72d4241) SHA1(487a00f49fa5451f39c2400f6f23a5f067afaa66) )
	ROM_LOAD( "957282.20_74-78_proto_a.bin"   , 0x0000, 0x008000, CRC(7e557f21) SHA1(49bbbbafff757acd078d156bae2c942991f055af) )
ROM_END

ROM_START( sc1cshata )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "957272.21_74-78b.bin" , 0x0000, 0x8000, CRC(531e97fb) SHA1(c7ae94c503f9e13d68ae463dd19212f146b0e8bc) )
	ROM_LOAD( "957272.20_74-78_standard.bin"  , 0x8000, 0x8000, CRC(06def19d) SHA1(721d8ffc7e6b0e76f097d82b3be7618d97d73041) )
ROM_END

ROM_START( sc1cshatb )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "957172.71_20p_std_b.bin"   , 0x0000, 0x8000, CRC(79870574) SHA1(89e5db89064a9e24bc37389d78f4defb7d2f479b) )
	ROM_LOAD( "957172.70_20_n.p_a.bin"   , 0x8000, 0x8000, CRC(4e90868a) SHA1(f88a1b578b2d9091f5e5212768547db19e6b5379) )
ROM_END

ROM_START( sc1cshatc )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "957172.21_var%_b.bin"  , 0x0000, 0x8000, CRC(ea705443) SHA1(fdd941b5e6785d97e990f4ca74578e539512422b) )
	ROM_LOAD( "957172.20_std_var%_a.bin"   , 0x8000, 0x8000, CRC(e67fc9e1) SHA1(39ac2c30d605f2b3109a57c6633a597e77651e79) )
ROM_END
...
ROM_START( sc1cshcda )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "95717128_var%_b.bin"  , 0x0000, 0x8000, CRC(10662200) SHA1(79a35b88eca408ae2f5daead498662303e0360e1) )
	ROM_LOAD( "95717127_var%_a.bin"  , 0x8000, 0x8000, CRC(1f7ef1ec) SHA1(9f8f43037788787f4f11501689cb82eeebc6d7f8) )
ROM_END

ROM_START( sc1cshcdb )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "95719104b_c.cards_78%.bin"  , 0x0000, 0x8000, CRC(e9055e1b) SHA1(8c6b7e164c9998c3b932e16c3c4e4a95beb29f50) )
	ROM_LOAD( "95719103a_c.cards_78%.bin"  , 0x8000, 0x8000, CRC(af65962c) SHA1(d10dd9e1bbdd1e506d5f8732ffbb6521e34fbefe) )
ROM_END
...
ROM_START( sc1cexpla )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "95717084b_mk1.bin" , 0x0000, 0x8000, CRC(e2d973be) SHA1(56ed3e3d6caf12f82d6ccc1527ff8da215e09cb0) )
	ROM_LOAD( "95717083a_mk1.bin" , 0x8000, 0x8000, CRC(949c2d18) SHA1(26db983c7d8624c3fd0461dba2336d5c59be29f0) )
ROM_END

ROM_START( sc1cexplb )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "95717084b_mk2_var%.bin"  , 0x0000, 0x8000, CRC(e2d973be) SHA1(56ed3e3d6caf12f82d6ccc1527ff8da215e09cb0) )
	ROM_LOAD( "95717083a_mk2_var%.bin"  , 0x8000, 0x8000, CRC(1fe1b3a1) SHA1(dd10d74c71a455900a2325ac9d7b3c8e45eb9c6c) )
ROM_END
...
ROM_START( sc1cshwz )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "95717206b_std.bin" , 0x0000, 0x8000, CRC(2478530f) SHA1(be82a4e36a3c076b9e94fa2364904ca463b6b4ed) )
	ROM_LOAD( "95717205a_std.bin" , 0x8000, 0x8000, CRC(795bbeea) SHA1(22e0fc9bc3c70e05e51cb98837a9c706eb2ca080) )

	ROM_REGION( 0x10000, "altrevs", 0 )//these seem to be halves without a partner, do these share the same b ROM?
	ROM_LOAD( "95718205a_std_ptel.bin"  , 0x0000, 0x008000, CRC(c88f476c) SHA1(a5d8f12ade77bdb100ece5f2eecec35ae09f3b0e) )
	ROM_LOAD( "95718210a_proto_var.bin"  , 0x0000, 0x008000, CRC(0997c4e9) SHA1(1013a12803796d3926cceeb671c7c07cc66d418e) )
	ROM_LOAD( "95728205a_74-78_adj_proto.bin"   , 0x0000, 0x008000, CRC(1cdadddb) SHA1(33c7ed10b1c9ddc0fc6065ad9b1cf80ee9f8e958) )
	ROM_LOAD( "95728210a_74-78_proto.bin"  , 0x0000, 0x008000, CRC(5c502423) SHA1(4fc93de9dd3aff7a8a8f828760d8b095b7a13630) )

ROM_END

ROM_START( sc1cshwza )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "95727206b_74-78_adj.bin"  , 0x0000, 0x8000, CRC(2b0ea9dc) SHA1(a9099abe2cf4cdf119a00e5a218507798d410eff) )
...
ROM_START( sc1clbwa )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "club_wise_95717551b.bin"  , 0x0000, 0x8000, CRC(0528a718) SHA1(27f4225c948d93ce1c833679f97e045f3b7a6aac) )
	ROM_LOAD( "club_wise_95717550a.bin"  , 0x8000, 0x8000, CRC(5b305f11) SHA1(592ea71fcb72eaa90fd421e3bd3761cfd686b019) )
	sc1_clbw_sound
ROM_END
...
ROM_START( sc1copsa )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "cops_&_robbers_5p_v1-3_b_(27256)"      , 0x0000, 0x008000, CRC(6f5425d6) SHA1(7673841ccfe16eaa0a5cfca1596383f7711f2dbe) )
	ROM_LOAD( "cops_&_robbers_5p_v1-3_a_(27256)"      , 0x8000, 0x008000, CRC(29513083) SHA1(f2ce0b573d6756e7d835488b8d8eed3266787255) )
...
ROM_START( sc1copdx )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "cops_&_robbers_deluxe_5p-10p_6_p2_95840220_(27256)"        , 0x0000, 0x8000, CRC(32a22682) SHA1(c173688ace476a2ada398d5e7b5dfed5306e3c50) )
	ROM_LOAD( "cops_&_robbers_deluxe_5p-10p_6_p1_95840219_(27256)"        , 0x8000, 0x8000, CRC(47867f55) SHA1(33f879a8e1e4e2f53b5da8b4ee597bd3870c75d1) )

	ROM_REGION( 0x40000, "upd", 0 )
	ROM_LOAD( "cops_&_robbers_deluxe_sound_1_295_(27512)"       , 0x00000, 0x10000, CRC(81227c21) SHA1(6af8e15f8405fdfbaa3a8853ec7ec62fe5ec34ae) )
	ROM_LOAD( "cops_&_robbers_deluxe_sound_2_296_(27512)"       , 0x10000, 0x10000, CRC(8ecf1f5e) SHA1(4159b5c3800708cde94ce62a5e07b58ad8aaedf8) )
ROM_END
...
ROM_START( sc1dblch )
	...
	ROM_LOAD( "95717787_10p20p.bin" , 0x0000, 0x008000, CRC(69ba126c) SHA1(f59aa5a632d0bc5102c206f986f86b6c7c1352fb) )
	ROM_LOAD( "95717789_10p.bin" , 0x0000, 0x008000, CRC(fc338d38) SHA1(65457f2611ffa22ac35f1e7ad10c290c01b9c3ac) )
	ROM_LOAD( "95717790_5p.bin" , 0x0000, 0x008000, CRC(c82e57f9) SHA1(456ce5290db322292170412a00f0252b86743ed0) )
...
ROM_START( sc1linx )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "95710138_b.bin" , 0x0000, 0x8000, CRC(e731dc61) SHA1(c65b2c7006e58e924370261bdb5ac3f5e3e86471) )
	ROM_LOAD( "95710137_a.bin" , 0x8000, 0x8000, CRC(29c6b8b1) SHA1(643d06a5064ba74902bfbe115b1bd7b1abe14381) )
ROM_END

ROM_START( sc1linxa )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "linx_20p_std_95717316_b.bin"    , 0x0000, 0x8000, CRC(419b3d7e) SHA1(83b27914cb95afc1053578a279dc936181562217) )
	ROM_LOAD( "linx_20p_n.p.a_95717315.bin"   , 0x8000, 0x8000, CRC(ea53e0e1) SHA1(d8d57d44188a33e2751bfc4f21249efc32815877) )
ROM_END

ROM_START( sc1linxp )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "linx_var%_data_10p_b.bin"    , 0x0000, 0x8000, CRC(c23fc39c) SHA1(4e6d2a16606544c00bd175ade4d9e6491ec317ff) )
	ROM_LOAD( "linx_10p_a.bin"  , 0x8000, 0x8000, CRC(87d8907c) SHA1(3584441870b0a57284e831b0e68422fa3138b4bf) )
ROM_END
...
ROM_START( sc1sir )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "s.i.rich_2p_2.40_p2_9.3.90_1a96.bin"     , 0x0000, 0x8000, CRC(618841ca) SHA1(2e690ca91da0a1ff36245a6f1e2ad681a6ed4f32) )
	ROM_LOAD( "s.i.rich_2p_2.40_p1_9.3.90_0b49.bin"     , 0x8000, 0x8000, CRC(c54703f8) SHA1(9ac3af9021cf5012562b0ab057a30e11e01eef65) )
...
ROM_START( sc1sira )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "95717078_proto.bin" , 0x0000, 0x8000, CRC(7a83b794) SHA1(8befa43c7afa37a296b309730d5cdfd32dfc363d) )
	ROM_LOAD( "95717077_proto.bin" , 0x8000, 0x8000, CRC(38691d92) SHA1(17f33f74d221ac37249a04846670a1a1c0ee618e) )
ROM_END

ROM_START( sc1sirb )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "s.i.rich_5p_2.40_p2_9.3.90.bin"    , 0x0000, 0x8000, CRC(cd3df765) SHA1(798d051afbba5a474b1b619621e4425f5ff7f8db) )
	ROM_LOAD( "s.i.rich_5p_2.40_p1_9.3.90.bin"    , 0x8000, 0x8000, CRC(6a37f38d) SHA1(1e7640446ecb6e00d57a92ab3592c389a172f257) )
ROM_END

ROM_START( sc1sirc )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "strike_it_rich_a.bin"   , 0x0000, 0x008000, CRC(92ddbbca) SHA1(d888e663d0965d99dbfa68e3aed995e31411f2ba) )//right way round?
	ROM_LOAD( "strike_it_rich_b.bin"   , 0x8000, 0x008000, CRC(bdafc4c9) SHA1(5ffc46088818f0e89eb840e039296945905ca4f3) )
ROM_END
...
ROM_START( sc1tri )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "20p_b.bin" , 0x0000, 0x8000, CRC(ef5bc525) SHA1(2881b9292f9dd7376997992941e07d288640703b) )
	ROM_LOAD( "20p_a.bin" , 0x8000, 0x8000, CRC(d162ebd5) SHA1(cfab100ab8cc34b61108fc7b8a3ec1f1b22f90ba) )
ROM_END

ROM_START( sc1tria )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "957172.42_std_var%_b.bin"   , 0x0000, 0x8000, CRC(d8d70cac) SHA1(8137ab06912bc27f26bcbb800a09b095ba2175bb) )
	ROM_LOAD( "957172.41_std_var%_a.bin"   , 0x8000, 0x8000, CRC(b314f739) SHA1(793c01f292c5144a1f5975b276b4985c565a2833) )
ROM_END

ROM_START( sc1triap )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "957172.42_std_var%_b.bin"   , 0x0000, 0x8000, CRC(d8d70cac) SHA1(8137ab06912bc27f26bcbb800a09b095ba2175bb) )
	ROM_LOAD( "957182.41_proto_var%_a.bin"   , 0x8000, 0x8000, CRC(1af55594) SHA1(9e65c7bbb37d75662e4243fc6ba13f249183e2a3) )
ROM_END

ROM_START( sc1trib )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "957272.42_std_b.bin"  , 0x0000, 0x8000, CRC(634b1927) SHA1(60f2bf02a12021da3c7995122dff85ce7831ed42) )
	ROM_LOAD( "957272.41_std_a.bin"  , 0x8000, 0x8000, CRC(635ded7e) SHA1(3e8bda8c2fa6fc8e46ba3e3a70dfb183fad3223b) )
ROM_END

ROM_START( sc1tribp )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "957272.42_std_b.bin"  , 0x0000, 0x8000, CRC(634b1927) SHA1(60f2bf02a12021da3c7995122dff85ce7831ed42) )
	ROM_LOAD( "957282.41_proto_std_a.bin"   , 0x8000, 0x8000, CRC(e5999ec8) SHA1(0a11544da03fc2197dc2cc6780cbaeee55372069) )
ROM_END
...
ROM_START( sc1winst )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "95717110_var%_b.bin"  , 0x0000, 0x8000, CRC(1c2ebd26) SHA1(462baa4df7c01d101798df1d90bb5719cdc9647e) )
	ROM_LOAD( "95717109_var%_a.bin"  , 0x8000, 0x8000, CRC(f8b03a06) SHA1(b919366b432d23fd9f0c986e112650048621d7b2) )
...
ROM_START( sc1winstp )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "95717110_var%_b.bin"  , 0x0000, 0x8000, CRC(1c2ebd26) SHA1(462baa4df7c01d101798df1d90bb5719cdc9647e) )
	ROM_LOAD( "95718109_proto_var%_a.bin"   , 0x8000, 0x8000, CRC(05d5ad4a) SHA1(5e165499601978e88159726f83310576216853c4) )
...
ROM_START( sc1winsta )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "95719110b_ws_78%.bin"  , 0x0000, 0x8000, CRC(5871aad0) SHA1(6677c94b74a2e2dcece3fdcd730fbc8034833a7d) )
	ROM_LOAD( "95719109a_ws_78%.bin"  , 0x0000, 0x8000, CRC(cea7ff32) SHA1(ce20742bcad1eea450affab81822cfdaaf927984) )
...
ROM_START( sc1csclb )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "cash_classic_sa1-082_5p.bin"   , 0x0000, 0x010000, CRC(42d68675) SHA1(ed191e03bc7b42ae1884657b4559588eeedbdf31) )
...
ROM_START( sc1csclc )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "cash_classic_2p_sa1-083.bin"   , 0x0000, 0x010000, CRC(36a45c0d) SHA1(51eb91e42297894ae575502903833e219ac5add9) )
...
ROM_START( sc1moonl )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "moon_lite_5p_86var_v5.1.bin"    , 0x8000, 0x8000, CRC(31db928a) SHA1(0e07c11bf85a13df62bb704a03a42712d6e7ff62) )
...
ROM_START( sc1ltdv )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "little_devil_v4_arcade.bin"   , 0x8000, 0x8000, CRC(ff32cdcf) SHA1(84bb86e30ace57aa8f591a3778801d44fb3f8fe1) )
...
ROM_START( sc1clins )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "cashlines5p2.40p2_9.3.90.bin" , 0x0000, 0x8000, CRC(068959a2) SHA1(6c212ceb756024662ed880b66b4c6aac21b0c726) )
	ROM_LOAD( "cashlines5p2.40p1_9.3.90.bin" , 0x8000, 0x8000, CRC(cb69c335) SHA1(8fe302274d01e98f8636fbc44eb4736180345b16) )
...
ROM_START( sc1clinsa )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "cashlines2p2.40p2_9.3.90.bin" , 0x0000, 0x8000, CRC(0a4d6692) SHA1(9437a0ed1fb9eb706dede7a6b1670e2bd873d7fe) )
	ROM_LOAD( "cashlines2p2.40p1_9.3.90.bin" , 0x8000, 0x8000, CRC(4dcdfcd1) SHA1(38b67a2450ededd9cf27b9f5d5fffe45f4e4b80d) )
...
ROM_START( sc1clinsb )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "clines_proto_b.bin"  , 0x0000, 0x8000, CRC(fca396e1) SHA1(3304a58a30fd0c79e8d1decd4bd8792d3acbad3e) )
	ROM_LOAD( "clines_proto_a.bin"  , 0x8000, 0x8000, CRC(0977e287) SHA1(e937a3787d4cd056c5f9944bca1532b84ed335f6) )//95718066
	ROM_REGION( 0x200000, "upd", ROMREGION_ERASE00 )
ROM_END
...
ROM_START( sc1clinsd )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "957172.01_all_cash.bin"  , 0x0000, 0x8000, CRC(27d941cf) SHA1(797d47c15d6a52f5647a566eb8ad1985324d81cb) )
	ROM_LOAD( "957172.00_all_cash.bin"  , 0x8000, 0x8000, CRC(cafc2409) SHA1(125f7c1826e58619a53b56ecd4f5b0b7f607aeef) )
	ROM_REGION( 0x200000, "upd", ROMREGION_ERASE00 )
ROM_END

ROM_START( sc1clinse ) // bad? (SUMCHECK ERROR)
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "957171.12_var%_b.bin"  , 0x0000, 0x8000, CRC(80243558) SHA1(6b7cc811998d11397e5fa03a50154d165997ae7b) )
	ROM_LOAD( "957171.11_var%_a.bin"  , 0x8000, 0x8000, CRC(1e74ef1a) SHA1(6c70f9b7f3caf6a5e9734b2e4ee74985c2b169d6) )
	ROM_REGION( 0x200000, "upd", ROMREGION_ERASE00 )
ROM_END
...
ROM_START( sc1hipt )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "high_point_6_b_20p.bin"    , 0x0000, 0x8000, CRC(535c1df1) SHA1(99d3033ee708c27134d461591eb7d19a573768d4) )
	ROM_LOAD( "high_point_6_a_20p.bin"    , 0x8000, 0x8000, CRC(228c3eef) SHA1(c60da857fa5630809b072c20cf1f24ee26c38d0b) )
	ROM_REGION( 0x200000, "upd", ROMREGION_ERASE00 )
ROM_END

ROM_START( sc1hipta )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "high_point_70_6.bin"   , 0x0000, 0x8000, CRC(752b4c6e) SHA1(30503128ccca5c88e66174bd3e54b115eded1db6) )
	ROM_LOAD( "high_point_69_6.bin"   , 0x8000, 0x8000, CRC(82564d75) SHA1(436b75e6617a6c2bb89ea0994696928b8452317d) )
...
ROM_START( sc1chainp )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "95717174.bin", 0x0000, 0x8000, CRC(6cdc8d15) SHA1(582e5e7bcefe0085917d3499b7c83e27c19662d2) )
	ROM_LOAD( "95716173_proto.bin" , 0x8000, 0x8000, CRC(4f806f1d) SHA1(cfa8bcc2afbb47e549836d968c3390bef04c6c30) )
...
ROM_START( sc1potp )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "potp_95715159_2x1.bin"  , 0x6000, 0x2000, CRC(b47cd8f3) SHA1(bf26fdc440a111dc1326b200281c2dff5c517c67) )
	ROM_LOAD( "potp_95717908_2x1.bin"  , 0x8000, 0x8000, CRC(953c3e78) SHA1(f14ab2c4337e93605be4baac51b8ad3b9bf0e155) )
...
ROM_START( sc1potpa )
	ROM_REGION( 0x10000, "maincpu", 0 )
	ROM_LOAD( "potp_95715146.bin" , 0x6000, 0x2000, CRC(9557ebc4) SHA1(a9d3b2d901875b9d53ac9500acdb9b725b4edcb5) )
	ROM_LOAD( "potp_95350166.bin" , 0x8000, 0x8000, CRC(45f0effa) SHA1(afd7aabac7da04b5960c2cc55863b917a2692c4f) )
