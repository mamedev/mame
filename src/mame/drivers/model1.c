...
static WRITE16_HANDLER( bank_w )
{
	if(ACCESSING_BITS_0_7) {
		...
		case 0x1: // 100000-1fffff data roms banking
			memory_set_bankptr(1, memory_region(machine, RGNCLASS_CPU, "main") + 0x1000000 + 0x100000*((data >> 4) & 0xf));
...
{
	memory_set_bankptr(1, memory_region(machine, RGNCLASS_CPU, "main") + 0x1000000);
	irq_init(machine);
...
#define MODEL1_CPU_BOARD \
	ROM_REGION( 0xe0000, RGNCLASS_USER, "user5", 0 ) \
...
ROM_START( vf )
	...
	ROM_REGION( 0x1400000, RGNCLASS_CPU, "main", 0 ) /* v60 code */
	...
	ROM_REGION( 0xc0000, RGNCLASS_CPU, "audio", 0 )  /* 68K code */
	...
	ROM_REGION32_LE( 0x1000000, RGNCLASS_USER, "user1", 0 ) /* TGP model roms */
...
ROM_START( vr )
	...
	ROM_REGION32_LE( 0x200000, RGNCLASS_USER, "user2", 0 ) /* TGP data roms */
	...
	ROM_REGION( 0x2000, RGNCLASS_CPU, "tgp", 0 ) /* TGP program rom */
...
ROM_START( vformula )
	...
	ROM_REGION( 0x20000, RGNCLASS_USER, "user3", 0 ) /* Comms Board */
...
ROM_START( swa )
	ROM_REGION( 0x1000000, RGNCLASS_CPU, "main", 0 ) /* v60 code */
	...
	ROM_REGION( 0x20000, RGNCLASS_CPU, "cpu2", 0 ) /* Z80 DSB code */
        ROM_LOAD( "epr16471.bin", 0x000000, 0x020000, CRC(f4ee84a4) SHA1(f12b214e6f195b0e5f49ba9f41d8e54bfcea9acc) )

	ROM_REGION( 0x400000, RGNCLASS_SOUND, "mpeg", 0 ) /* DSB MPEG data */
	...
	ROM_REGION32_LE( 0xc00000, RGNCLASS_USER, "user1", 0 ) /* TGP model roms */
...
ROM_START( wingwar )
	ROM_REGION( 0x1300000, RGNCLASS_CPU, "main", 0 ) /* v60 code */
