...
NOTES : Shadow Fighters appears to have been dumped from an earlier
        ...
        The data stored in RGNCLASS_SOUND, "samples" is simply a series of
            Creative Media VOC files concatenated to eachother.
        The sound program (RGNCLASS_CPU, "sound") is about 640 bytes long.
...
ROM_START( vcombat )
	...
	ROM_REGION( 0x180000, RGNCLASS_SOUND, "samples", 0 )
	...
	ROM_REGION( 0x800, RGNCLASS_USER, "user1", 0 )	/* The SRAM module */
	...
	ROM_REGION( 0x400, RGNCLASS_PLDS, "plds", 0 )
...
ROM_START( shadfgtr )
	...
	ROM_REGION( 0x100000, RGNCLASS_SOUND, "samples", 0 )
