...
ROM_START( pass )
	ROM_REGION( 0x40000, RGNCLASS_CPU, "main", 0 ) /* 68k */
	...
	ROM_REGION( 0x10000, RGNCLASS_CPU, "audio", 0 ) /* z80 clone? */
	...
	ROM_REGION( 0x40000, RGNCLASS_GFX, "gfx1", 0 ) /* fg layer 'sprites' */
	...
	ROM_REGION( 0x80000, RGNCLASS_GFX, "gfx2", 0 ) /* bg tiles */
