...
ROM_START( finalap3 ) // this set displays MOTION (Ver. 3) in the test mode menu
	...
	ROM_REGION( 0x200000, "tiles", 0 ) /* Tiles */
	ROM_LOAD( "flt2_chr-0.11n", 0x000000, 0x040000, CRC(5954f270) SHA1(6f26365d89f38d4ab477908f32823e06f1a84e09) )
	ROM_LOAD( "fltchr-1.11p",   0x040000, 0x040000, CRC(2e68d13c) SHA1(46bb0628da1f97e0f6865f37e53a01d2e8391255) )
	ROM_LOAD( "flt2_chr-2.11r", 0x080000, 0x040000, CRC(98f3b190) SHA1(4858dab070c0c46d37148312664c6a616765c240) )
...
GAMEL(1992, finalap3,   0,        finallap, finalap3, namcos2_state, finalap3, ROT0,   "Namco", "Final Lap 3 (World, Rev C)", MACHINE_IMPERFECT_GRAPHICS | MACHINE_IMPERFECT_SOUND | MACHINE_NODEVICE_LAN, layout_finallap )
