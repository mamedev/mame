...
NEC D8035LC used as processor
needs inputs, prom decode, sound, artwork (lamps), probably some irq masking and the like

This hardware could be enhanced with a 6845 to run video AWPs, and is the original Deal 'Em
...
ROM_START( sm_ngacc )
	...
	ROM_LOAD( "na10.bin", 0x0000, 0x0800, CRC(720c747c) SHA1(f371de01d7066ffc9c10e0088dc7c73aa3f7c0be) )
	ROM_LOAD( "na11.bin", 0x0800, 0x0800, CRC(993b64b9) SHA1(39c2bdef52a21f91772b06a07a73631ba3f82edc) )
ROM_END
