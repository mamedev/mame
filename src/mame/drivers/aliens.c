...
ROM_START( aliens )
	ROM_REGION( 0x38000, RGNCLASS_CPU, "main", 0 ) /* code + banked roms */
	...
	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx1", 0 ) /* graphics */
	...
	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx2", 0 ) /* graphics */
