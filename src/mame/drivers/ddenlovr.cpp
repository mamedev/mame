...
public:
	...
	void quizchq_irq(device_t &device);
	void mmpanic_irq(device_t &device);
	void quizchq_rtc_irq(int state);
	void mmpanic_rtc_irq(int state);
	void hanakanz_irq(device_t &device);
	void mjchuuka_irq(device_t &device);
	void hginga_irq(device_t &device);
	void mjflove_irq(device_t &device);
	void hparadis_irq(device_t &device);
	void hanakanz_rtc_irq(int state);
	void mjchuuka_rtc_irq(int state);
	void hginga_rtc_irq(int state);
...
static ADDRESS_MAP_START( mjchuuka_portmap, AS_IO, 8, ddenlovr_state )     // 16 bit I/O
	...
	AM_RANGE(0x20, 0x20) AM_SELECT(0xff00) AM_WRITE(mjchuuka_blitter_w)
	AM_RANGE(0x21, 0x21) AM_SELECT(0xff00) AM_WRITE(mjchuuka_palette_w)
 ...
 */
void ddenlovr_state::quizchq_irq(device_t &device)
{
//  int scanline = param;
...
void ddenlovr_state::quizchq_rtc_irq(int state)
{
...
void ddenlovr_state::mmpanic_irq(device_t &device)
{
	//int scanline = param;
...
void ddenlovr_state::mmpanic_rtc_irq(int state)
{
...
void ddenlovr_state::hanakanz_irq(device_t &device)
{
	/* I haven't found a irq ack register, so I need this kludge to
	   make sure I don't lose any interrupt generated by the blitter,
	   otherwise quizchq would lock up. */
...
void ddenlovr_state::hanakanz_rtc_irq(int state)
{
	/* I haven't found a irq ack register, so I need this kludge to
	   make sure I don't lose any interrupt generated by the blitter,
	   otherwise quizchq would lock up. */
 ...
 */
void ddenlovr_state::mjchuuka_irq(device_t &device)
{
	/* I haven't found a irq ack register, so I need this kludge to
	   make sure I don't lose any interrupt generated by the blitter,
	   otherwise quizchq would lock up. */
...
void ddenlovr_state::mjchuuka_rtc_irq(int state)
{
	/* I haven't found a irq ack register, so I need this kludge to
	   make sure I don't lose any interrupt generated by the blitter,
	   otherwise quizchq would lock up. */
...
void ddenlovr_state::mjmyster_irq(timer_device &timer, void *ptr, int32_t param)
{
	int scanline = param;
...
void ddenlovr_state::mjmyster_rtc_irq(int state)
{
	/* I haven't found a irq ack register, so I need this kludge to
	   make sure I don't lose any interrupt generated by the blitter,
	   otherwise quizchq would lock up. */
 ...
 */
void ddenlovr_state::hginga_irq(device_t &device)
{
//  int scanline = param;
...
void ddenlovr_state::hginga_rtc_irq(int state)
{
	/* I haven't found a irq ack register, so I need this kludge to
	   make sure I don't lose any interrupt generated by the blitter,
	   otherwise quizchq would lock up. */
...
void ddenlovr_state::mjflove_irq(device_t &device)
{
...
/*  It runs in IM 2, thus needs a vector on the data bus:
    0xee is vblank  */
void ddenlovr_state::hparadis_irq(device_t &device)
{
