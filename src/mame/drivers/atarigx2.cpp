...
ROM_START( rrreveng )
	...
	ROM_LOAD( "136094-0009a.7n",  0x0000, 0x0117, BAD_DUMP ) /* GAL16V8A */
	ROM_LOAD( "136094-0012a.7r",  0x0000, 0x0117, BAD_DUMP ) /* GAL16V8A */
	...
	ROM_LOAD( "136094-0016a.23r", 0x0000, 0x0117, BAD_DUMP ) /* GAL16V8A */
