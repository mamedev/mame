...
static INPUT_PORTS_START( spclords )
	...
	PORT_BIT( 0x00000100, IP_ACTIVE_LOW, IPT_START1 ) PORT_NAME("P1 Start / Hyperspace")                   /* Pilot RED button */
	PORT_BIT( 0x00000200, IP_ACTIVE_LOW, IPT_BUTTON2 ) PORT_NAME("P2 Nuke") PORT_PLAYER(2)                 /* Co-Pilot Right Thumb */
	PORT_BIT( 0x00000400, IP_ACTIVE_LOW, IPT_BUTTON1 ) PORT_NAME("P2 Laser") PORT_PLAYER(2)                /* Co-Pilot Right Trigger */
	PORT_BIT( 0x00000800, IP_ACTIVE_LOW, IPT_BUTTON4 ) PORT_NAME("P1 Reverse") PORT_PLAYER(1)              /* Pilot Throttle reverse */
	PORT_BIT( 0x00001000, IP_ACTIVE_LOW, IPT_OTHER ) PORT_NAME("RIGHT of DOUBLE") PORT_CODE(KEYCODE_C)     /* RIGHT of DOUBLE */
	PORT_BIT( 0x00002000, IP_ACTIVE_LOW, IPT_OTHER ) PORT_NAME("DOUBLE SYSTEM") PORT_CODE(KEYCODE_V)       /* DOUBLE SYSTEM */
	PORT_BIT( 0x00004000, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT( 0x00008000, IP_ACTIVE_LOW, IPT_OTHER ) PORT_NAME("4 COIN COUNTERS") PORT_CODE(KEYCODE_B)     /* 4 COIN COUNTERS */
	PORT_BIT( 0x00ff0000, IP_ACTIVE_LOW, IPT_UNUSED )                                                      /* Freeze / Unfreeze */
	PORT_BIT( 0x01000000, IP_ACTIVE_LOW, IPT_START2 ) PORT_NAME("P2 Start / Cloak")                        /* Co-Pilot BLUE button */
	PORT_BIT( 0x02000000, IP_ACTIVE_LOW, IPT_BUTTON2 ) PORT_NAME("P1 Nuke") PORT_PLAYER(1)                 /* Pilot Left Thumb */
	PORT_BIT( 0x04000000, IP_ACTIVE_LOW, IPT_BUTTON1 ) PORT_NAME("P1 Laser") PORT_PLAYER(1)                /* Pilot Left Trigger */
	PORT_BIT( 0x08000000, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_NAME("P1 Forward") PORT_PLAYER(1)              /* Pilot Throttle forward */
	PORT_BIT( 0x10000000, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT( 0x20000000, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT( 0x40000000, IP_ACTIVE_LOW, IPT_BUTTON5 ) PORT_NAME("P1 Rearview") PORT_PLAYER(1)             /* Pilot Rearview */
