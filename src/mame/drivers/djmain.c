...
{
	sndram = memory_region(machine, RGNCLASS_SOUND, "shared") + 0x80000 * sndram_bank;
}
...
{
	UINT8 *mem8 = memory_region(machine, RGNCLASS_GFX, "gfx2");
...
static MACHINE_START( djmain )
{
	...
	UINT8 *region = memory_region(machine, RGNCLASS_SOUND, "shared");
...
ROM_START( bm1stmix )
	ROM_REGION( 0x100000, RGNCLASS_CPU, "main", 0 )		/* MC68EC020FG25 MPU */
	...
	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx1", 0)		/* SPRITE */
	...
	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx2", 0 )		/* TILEMAP */
...
{
	memory_region_alloc(machine, RGNCLASS_SOUND, "shared", 0x80000 * 32, 0);
