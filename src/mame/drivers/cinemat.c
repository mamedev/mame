...
static ADDRESS_MAP_START( program_map_8k, ADDRESS_SPACE_PROGRAM, 8 )
	...
	AM_RANGE(0x2000, 0x2fff) AM_MIRROR(0x1000) AM_ROM AM_REGION(RGNCLASS_CPU, "main", 0x1000)
ADDRESS_MAP_END
...
#define CCPU_PROMS \
	ROM_REGION( 0x1a0, RGNCLASS_PROMS, "proms", ROMREGION_DISPOSE ) \
...
ROM_START( spacewar )
	ROM_REGION( 0x1000, RGNCLASS_CPU, "main", 0 )
