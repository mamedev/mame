...
GAME( 1980?,sirio2,      mooncrst, mooncrst,   mooncptc,   galaxian_state, init_mooncrsu,   ROT90,  "bootleg (Calfesa)",            "Sirio II (Calfesa Spanish Moon Cresta bootleg)",         MACHINE_SUPPORTS_SAVE )
