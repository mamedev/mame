...
static MACHINE_CONFIG_START( s11b, s11b_state )
	...
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(s11_state, sol2_w))
	MCFG_PIA6821_CA2_HANDLER(WRITELINE(s11_state, pia21_ca2_w))
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(s11_state, pia21_cb2_w))
	MCFG_PIA6821_IRQA_HANDLER(WRITELINE(s11_state, pia_irq))
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(s11_state, pia_irq))

	MCFG_DEVICE_ADD("pia24", PIA6821, 0)
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(s11_state, lamp0_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(s11_state, lamp1_w))
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(s11_state, pia24_cb2_w))
	MCFG_PIA6821_IRQA_HANDLER(WRITELINE(s11_state, pia_irq))
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(s11_state, pia_irq))

	MCFG_DEVICE_ADD("pia28", PIA6821, 0)
	MCFG_PIA6821_READPA_HANDLER(READ8(s11_state, pia28_w7_r))
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(s11a_state, dig0_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(s11b_state, dig1_w))
	MCFG_PIA6821_CA2_HANDLER(WRITELINE(s11_state, pia28_ca2_w))
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(s11_state, pia28_cb2_w))
	MCFG_PIA6821_IRQA_HANDLER(WRITELINE(s11_state, pia_irq))
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(s11_state, pia_irq))

	MCFG_DEVICE_ADD("pia2c", PIA6821, 0)
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(s11b_state, pia2c_pa_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(s11b_state, pia2c_pb_w))
	MCFG_PIA6821_IRQA_HANDLER(WRITELINE(s11_state, pia_irq))
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(s11_state, pia_irq))

	MCFG_DEVICE_ADD("pia30", PIA6821, 0)
	MCFG_PIA6821_READPA_HANDLER(READ8(s11_state, switch_r))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(s11_state, switch_w))
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(s11_state, pia30_cb2_w))
	MCFG_PIA6821_IRQA_HANDLER(WRITELINE(s11_state, pia_irq))
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(s11_state, pia_irq))

	MCFG_DEVICE_ADD("pia34", PIA6821, 0)
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(s11b_state, pia34_pa_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(s11_state, pia34_pb_w))
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(s11_state, pia34_cb2_w))
	MCFG_PIA6821_IRQA_HANDLER(WRITELINE(s11_state, pia_irq))
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(s11_state, pia_irq))
	...
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(s11_state, pias_cb2_w))
