...
GAME( 1994, m4andycp10c,  m4andycp,  mod4oki_chr, mpu4, mpu4_state, init_m4_andycp10c, ROT0, "Bwb", "Andy Capp (Bwb / Barcrest) (MPU4) (AC10C)",GAME_FLAGS )
...
void mpu4_state::mod4oki_cashmn(machine_config &config)
{
	mod4oki(config);
	MPU4_CHARACTERISER_PAL(config, m_characteriser, 0);
//	m_characteriser->set_cpu_tag("maincpu");
...
#define GAME_CUSTOM(year, setname,parent,name,offset,length,hash,company,title) \
	ROM_START( setname ) \
		...
		M4CASHMN_EXTRA_ROMS \
	ROM_END \
	GAME(year, setname, parent, mod4oki_cashmn, mpu4jackpot8tkn, mpu4_state, init_m4_showstring_big, ROT0, company, title, GAME_FLAGS )
...
#define M4RFYM_EXTRA_ROMS \
	ROM_REGION( 0x10, "characteriser:fakechr", 0 ) \
...
// none of these boot with du91.chr?
