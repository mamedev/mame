...
ROM_START( flower ) /* Komax version */
	...
	ROM_REGION( 0x2000, RGNCLASS_GFX, "gfx1", ROMREGION_INVERT | ROMREGION_DISPOSE ) /* tx layer */
	ROM_LOAD( "10.13e", 0x0000, 0x2000, CRC(62f9b28c) SHA1(d57d06b99e72a4f68f197a5b6c042c926cc70ca0) ) // FIRST AND SECOND HALF IDENTICAL

	ROM_REGION( 0x8000, RGNCLASS_GFX, "gfx2", ROMREGION_INVERT | ROMREGION_DISPOSE ) /* sprites */
	...
	ROM_REGION( 0x8000, RGNCLASS_GFX, "gfx3", ROMREGION_INVERT | ROMREGION_DISPOSE ) /* bg layers */
	...
	ROM_REGION( 0x0520, RGNCLASS_USER, "user1", 0 ) /* Other proms, (zoom table?) */
