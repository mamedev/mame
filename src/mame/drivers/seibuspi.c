...
{
	UINT8 *sound = (UINT8*)memory_region(machine, RGNCLASS_USER, "user2");
	UINT16 *sound16 = (UINT16*)memory_region(machine, RGNCLASS_USER, "user2");
...
static ADDRESS_MAP_START( spi_map, ADDRESS_SPACE_PROGRAM, 32 )
	...
	AM_RANGE(0xffe00000, 0xffffffff) AM_ROM AM_REGION(RGNCLASS_USER, "user1", 0) AM_SHARE(2)		/* ROM location in real-mode */
ADDRESS_MAP_END
...
{
	int i;
	UINT8 *sound = memory_region(machine, RGNCLASS_SOUND, "ymf");

	UINT8 *rombase = memory_region(machine, RGNCLASS_USER, "user1");
...
static void init_spi(running_machine *machine)
{
	...
	seibuspi_text_decrypt(memory_region(machine, RGNCLASS_GFX, "gfx1"));
	seibuspi_bg_decrypt(memory_region(machine, RGNCLASS_GFX, "gfx2"), memory_region_length(machine, RGNCLASS_GFX, "gfx2"));
	seibuspi_sprite_decrypt(memory_region(machine, RGNCLASS_GFX, "gfx3"), 0x400000);
}
...
static void init_rf2(running_machine *machine)
{
	...
	seibuspi_rise10_text_decrypt(memory_region(machine, RGNCLASS_GFX, "gfx1"));
	seibuspi_rise10_bg_decrypt(memory_region(machine, RGNCLASS_GFX, "gfx2"), memory_region_length(machine, RGNCLASS_GFX, "gfx2"));
	seibuspi_rise10_sprite_decrypt(memory_region(machine, RGNCLASS_GFX, "gfx3"), 0x600000);
...
static DRIVER_INIT( rfjet )
{
	...
	seibuspi_rise11_text_decrypt(memory_region(machine, RGNCLASS_GFX, "gfx1"));
	seibuspi_rise11_bg_decrypt(memory_region(machine, RGNCLASS_GFX, "gfx2"), memory_region_length(machine, RGNCLASS_GFX, "gfx2"));
	seibuspi_rise11_sprite_decrypt(memory_region(machine, RGNCLASS_GFX, "gfx3"), 0x800000);
...
ROM_START(senkyu)
	ROM_REGION32_LE(0x200000, RGNCLASS_USER, "user1", 0)	/* i386 program */
	...
	ROM_REGION( 0x300000, RGNCLASS_GFX, "gfx2", 0)	/* background layer roms */
	...
	ROM_REGION( 0xc00000, RGNCLASS_GFX, "gfx3", 0)	/* sprites */
	...
	ROM_REGION(0x200000, RGNCLASS_SOUND, "ymf", ROMREGION_ERASE00)

	ROM_REGION(0x280000, RGNCLASS_USER, "user2", ROMREGION_ERASE00)	/* sound roms */
...
ROM_START(ejanhs)
	...
	ROM_REGION( 0x600000, RGNCLASS_GFX, "gfx2", 0)	/* background layer roms */
...
ROM_START(rdft)
	...
	ROM_REGION( 0x30000, RGNCLASS_GFX, "gfx1", 0)	/* text layer roms */
...
ROM_START(rdft2us)	/* Single board version SXX2F */
	...
	ROM_REGION( 0xc00000, RGNCLASS_GFX, "gfx2", 0)	/* background layer roms */
	...
	ROM_REGION( 0x1200000, RGNCLASS_GFX, "gfx3", 0)	/* sprites */
	...
	ROM_REGION(0x40000, RGNCLASS_CPU, "sound", 0)		/* 256k for the Z80 */
	ROM_LOAD("zprg.u091", 0x000000, 0x20000, CRC(cc543c4f) SHA1(6e5c93fd3d21c594571b071d4a830211e1f162b2) )

	ROM_REGION(0x280000, RGNCLASS_SOUND, "ymf", ROMREGION_ERASE00)	/* sound roms */
...
ROM_START(rfjet) /* SPI Cart, Europe */
	...
	ROM_REGION( 0x30000, RGNCLASS_GFX, "gfx1", ROMREGION_ERASEFF)
	...
	ROM_REGION( 0x900000, RGNCLASS_GFX, "gfx2", 0)	/* background layer roms */
	...
	ROM_REGION( 0x1800000, RGNCLASS_GFX, "gfx3", 0)	/* sprites */
...
ROM_START(rdft22kc)
	...
	ROM_REGION( 0x80000, RGNCLASS_SOUND, "oki1", 0)	/* sound data for MSM6295 */
	ROM_LOAD("pcm0.1022", 0x000000, 0x80000, CRC(fd599b35) SHA1(00c0307d1b503bd5ce02d7960ce5e1ad600a7290) )

	ROM_REGION( 0x80000, RGNCLASS_SOUND, "oki2", 0)	/* sound data for MSM6295 */
