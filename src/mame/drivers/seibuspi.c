...
READ8_MEMBER(seibuspi_state::spi_int_r)
{
	m_maincpu->set_input_line(0, CLEAR_LINE);
	return 0xff;
}

READ32_MEMBER(seibuspi_state::spi_nop_r)
{
	// use this if return val must be high
	return 0xffffffff;
}
...
//  AM_RANGE(0x00000108, 0x0000010b) AM_WRITENOP // ?
	...
	AM_RANGE(0x00000498, 0x0000049b) AM_WRITENOP // ?
	...
	AM_RANGE(0x00000600, 0x00000603) AM_READ8(spi_int_r, 0x000000ff)
	...
	AM_RANGE(0x00000688, 0x0000068b) AM_READNOP // ?
...
static ADDRESS_MAP_START( sxx2e_map, AS_PROGRAM, 32, seibuspi_state )
	...
	AM_RANGE(0x00000680, 0x00000683) AM_DEVWRITE8("soundfifo1", fifo7200_device, data_byte_w, 0x000000ff)
	AM_RANGE(0x00000684, 0x00000687) AM_READ(spi_nop_r) // ?
...
static ADDRESS_MAP_START( sys386f_map, AS_PROGRAM, 32, seibuspi_state )
	AM_RANGE(0x00000010, 0x00000013) AM_READ8(spi_int_r, 0x000000ff)
...
/* SXX2E */
GAME( 1996, rdfts,      rdft,     sxx2e,   sxx2e,       seibuspi_state, rdft,     ROT270, "Seibu Kaihatsu (Explorer System Corp. license)", "Raiden Fighters (Taiwan, single board)", GAME_IMPERFECT_GRAPHICS | GAME_IMPERFECT_SOUND )
...
GAME( 2000, rfjet2kc,   rfjet,    sys386i, sys386i,     seibuspi_state, rfjet,    ROT270, "Seibu Kaihatsu", "Raiden Fighters Jet 2000 (China, SYS386I)", GAME_IMPERFECT_GRAPHICS )

/* SYS386F */
GAME( 1999, ejsakura,   0,        sys386f, sys386f,     seibuspi_state, sys386f,  ROT0,   "Seibu Kaihatsu", "E-Jan Sakurasou (Japan, SYS386F V2.0)", GAME_IMPERFECT_GRAPHICS | GAME_IMPERFECT_SOUND )
GAME( 1999, ejsakura12, ejsakura, sys386f, sys386f,     seibuspi_state, sys386f,  ROT0,   "Seibu Kaihatsu", "E-Jan Sakurasou (Japan, SYS386F V1.2)", GAME_IMPERFECT_GRAPHICS | GAME_IMPERFECT_SOUND )
