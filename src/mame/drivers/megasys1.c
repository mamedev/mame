...
ROM_START( 64street )
	ROM_REGION( 0x80000, RGNCLASS_CPU, "main", 0 )		/* Main CPU Code */
	...
	ROM_REGION( 0x20000, RGNCLASS_CPU, "sound", 0 )		/* Sound CPU Code */
	...
	ROM_REGION( 0x40000, RGNCLASS_SOUND, "oki2", 0 )		/* Samples */
	ROM_LOAD( "64th_10.rom", 0x000000, 0x040000, CRC(a3390561) SHA1(f86d5c61e3e80d30408535c2203940ca1e95ac18) )

	ROM_REGION( 0x0200, RGNCLASS_PROMS, "proms", 0 )		/* Priority PROM */
...
ROM_START( astyanax )
	ROM_REGION( 0x60000, RGNCLASS_CPU, "main", 0 )		/* Main CPU Code */
	...
	ROM_REGION( 0x80000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE ) /* Sprites */
...
ROM_START( avspirit )
	ROM_REGION( 0xc0000, RGNCLASS_CPU, "main", 0 )		/* Main CPU Code: 00000-3ffff & 80000-bffff */
	...
	ROM_REGION( 0x40000, RGNCLASS_CPU, "sound", 0 )		/* Sound CPU Code */
...
ROM_START( chimerab )
	...
	ROM_REGION( 0x080000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) /* Scroll 0 */
	ROM_LOAD( "s1.bin",   0x000000, 0x080000, CRC(e4c2ac77) SHA1(db4bff3c02f22cc59a67b103fd176f4d88531f93) )

	ROM_REGION( 0x080000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE ) /* Scroll 1 */
	ROM_LOAD( "s2.bin",   0x000000, 0x080000, CRC(fafb37a5) SHA1(e36c4d18209add696982e36e84397ec51b9a9e7e) )

	ROM_REGION( 0x020000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE ) /* Scroll 2 */
...
//  fire    sword
	...
	PORT_DIPNAME( 0x04, 0x04, "Disable Instruction Screen" ) /* Manual states this dip is "Unused" */
	PORT_DIPSETTING(    0x04, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x18, 0x018, DEF_STR( Allow_Continue ) )
	PORT_DIPSETTING(    0x00, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x10, "Up to Mission 4" )
	PORT_DIPSETTING(    0x08, "Not on Final Mission" )
	PORT_DIPSETTING(    0x18, DEF_STR( On ) )
	PORT_DIPNAME( 0x20, 0x20, "Intro Music" )
	PORT_DIPSETTING(    0x00, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x20, DEF_STR( On ) )
	PORT_DIPNAME( 0x40, 0x00, DEF_STR( Demo_Sounds ) )
	PORT_DIPSETTING(    0x40, DEF_STR( Off ) )
...
ROM_START( edf )
	...
	ROM_REGION( 0x40000, RGNCLASS_CPU, "cpu2", 0 ) /* MCU Internal Code, 64 pin DIP surface scratched */
	...
	ROM_REGION( 0x080000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE ) /* Sprites */
	...
	ROM_REGION( 0x0200, RGNCLASS_PROMS, "proms", 0 )		/* Priority PROM  (N82S131N compatible type PROM) */
...
ROM_START( hayaosi1 )
	...
	ROM_REGION( 0x80000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE | ROMREGION_ERASEFF) /* Scroll 0 */
	ROM_LOAD( "7", 0x000000, 0x80000, CRC(3629c455) SHA1(c216b600750861b073062c165f36e6949db10d78) )

	ROM_REGION( 0x80000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE | ROMREGION_ERASEFF ) /* Scroll 1 */
	ROM_LOAD( "8", 0x000000, 0x80000, CRC(15f0b2a3) SHA1(48080de7818bd1c4ac6a7cd81aa86b69bdda2668) )

	ROM_REGION( 0x20000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE | ROMREGION_ERASEFF ) /* Scroll 2 */
	ROM_LOAD( "9",  0x000000, 0x20000, CRC(64d5b95e) SHA1(793714b2b049afd1cb66c888545cb8379c702010) )

	ROM_REGION( 0x80000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE | ROMREGION_ERASEFF ) /* Sprites */
	...
	ROM_REGION( 0x0200, RGNCLASS_PROMS, "proms", 0 )		/* Priority PROM  (N82S131N compatible type BPROM) */
...
static INPUT_PORTS_START( jitsupro )
	...
	PORT_DIPNAME( 0x02, 0x02, "Difficulty for Catching Ball" )
	PORT_DIPSETTING(    0x02, DEF_STR( Normal ) )	// $200-140
	PORT_DIPSETTING(    0x00, DEF_STR( Hard ) )	// $400-140
	PORT_DIPNAME( 0x3c, 0x3c, "Franchise (Increase Batting Power)" )
	PORT_DIPSETTING(    0x3c, DEF_STR( Normal )  )
	PORT_DIPSETTING(    0x38, "G"  )
	PORT_DIPSETTING(    0x34, "D"  )
	PORT_DIPSETTING(    0x30, "C"  ) /* I hope the Japanese Baseball crowd knows what these leagues are ;-) */
	PORT_DIPSETTING(    0x2c, "S"  )
	PORT_DIPSETTING(    0x28, "W (B)"  )
	PORT_DIPSETTING(    0x24, "T"  )
	PORT_DIPSETTING(    0x20, "L"  )
	PORT_DIPSETTING(    0x1c, "Br (Bw)"  )
	PORT_DIPSETTING(    0x18, "F"  )
...
//  shoot   pass
	...
	PORT_DIPNAME( 0x04, 0x04, DEF_STR( Unused ) ) /* Manual states dips 3 & 4 are "Unused" */
	PORT_DIPSETTING(    0x04, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x08, 0x08, DEF_STR( Unused ) )
	PORT_DIPSETTING(    0x08, DEF_STR( Off ) )
	...
	PORT_DIPSETTING(    0x40, DEF_STR( Trackball ) )
...
//  fire    bomb
	...
	PORT_DIPNAME( 0x40, 0x40, DEF_STR( Unused ) ) /* Manual states this dip is "Unused" */
	PORT_DIPSETTING(    0x40, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x80, 0x80, DEF_STR( Flip_Screen ) )
	PORT_DIPSETTING(    0x80, DEF_STR( Off ) )
...
ROM_START( peekaboo )
	ROM_REGION( 0x40000, RGNCLASS_CPU, "main", 0 )		/* 68000 CPU Code */
	...
	ROM_REGION( 0x40000, RGNCLASS_CPU, "cpu1", 0 ) /* MCU Internal Code */
	...
	ROM_REGION( 0x120000, RGNCLASS_SOUND, "oki1", 0 )		/* Samples */
...
//  fire    bomb
	...
	PORT_DIPSETTING(    0x01, "5" )
	PORT_DIPSETTING(    0x00, "Infinite (Cheat)" )
	PORT_DIPNAME( 0x04, 0x04, "Hyper Laser Beams" )
	PORT_DIPSETTING(    0x00, "2" )
	PORT_DIPSETTING(    0x04, "3" )
	PORT_DIPNAME( 0x08, 0x08, DEF_STR( Bonus_Life ) )
	PORT_DIPSETTING(    0x08, "70k and every 200k")		/* As stated in manual, but was 70K & Every 130K */
	PORT_DIPSETTING(    0x00, "100k and 300k Only")		/* As stated in manual, but was 100K & Every 200K */
	PORT_DIPNAME( 0x30, 0x30, DEF_STR( Difficulty ) )
	PORT_DIPSETTING(    0x00, DEF_STR( Easy ) )
	PORT_DIPSETTING(    0x30, DEF_STR( Normal ) )
	PORT_DIPSETTING(    0x10, DEF_STR( Hard ) )
...
//  fire    ladder
	...
	PORT_DIPSETTING(    0x20, DEF_STR( Hard ) )
	PORT_DIPSETTING(    0x40, DEF_STR( Hardest ) )
	PORT_DIPNAME( 0x80, 0x80, DEF_STR( Flip_Screen ) )
	PORT_DIPSETTING(    0x80, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
...
//  fire    fire
	...
	PORT_DIPSETTING(    0x00, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x40, DEF_STR( On ) )
	PORT_DIPNAME( 0x80, 0x80, DEF_STR( Unused ) )	// used?
	PORT_DIPSETTING(    0x80, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
...
{
	UINT16	*RAM	=	(UINT16 *) memory_region(Machine, RGNCLASS_CPU, "main"+cpu);
	int i,		size	=	memory_region_length(Machine, RGNCLASS_CPU, "main"+cpu);
...
{
	UINT8 *rom = memory_region(Machine, RGNCLASS_GFX, "gfx1"+region);
	int size = memory_region_length(Machine, RGNCLASS_GFX, "gfx1"+region);
	UINT8 *buffer;
	int i;
...
static DRIVER_INIT( astyanax )
{
	...
	RAM = (UINT16 *) memory_region(machine, RGNCLASS_CPU, "main");
