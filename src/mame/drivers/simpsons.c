...
ROM_START( simpsons ) /* World 4 Player */
	ROM_REGION( 0x8b000, RGNCLASS_CPU, "main", 0 ) /* code + banked roms + banked ram */
	...
	ROM_REGION( 0x28000, RGNCLASS_CPU, "audio", 0 ) /* Z80 code + banks */
	ROM_LOAD( "072-e03.6g", 0x00000, 0x08000, CRC(866b7a35) SHA1(98905764eb4c7d968ccc17618a1f24ee12e33c0e) )
	ROM_CONTINUE(		0x10000, 0x18000 )

	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx1", 0 ) /* graphics ( dont dispose as the program can read them, 0 ) */
	...
	ROM_REGION( 0x400000, RGNCLASS_GFX, "gfx2", 0 ) /* graphics ( dont dispose as the program can read them, 0 ) */
	...
	ROM_REGION( 0x140000, RGNCLASS_SOUND, "konami", 0 ) /* samples for the 053260 */
