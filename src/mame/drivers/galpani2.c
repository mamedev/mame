...
static READ16_HANDLER( galpani2_bankedrom_r )
{
	...
	size_t    len = memory_region_length( machine, RGNCLASS_USER, "user1" ) / 2;
...
ROM_START( galpani2 )
 	ROM_REGION( 0x100000, RGNCLASS_CPU, "main", 0 )			/* CPU#1 Code */
	...
	ROM_LOAD16_BYTE( "g001a2.u164-1", 0x000001, 0x080000, CRC(b3a5951f) SHA1(78cf2d85a8b3cd46c5e30fd13b474af2ed2ee09b) )
 	...
 	ROM_REGION( 0x1000000, RGNCLASS_CPU, "sub", 0 )			/* CPU#2 Code */
	...
	ROM_REGION16_BE( 0x1500000, RGNCLASS_USER, "user1", 0 )	/* Backgrounds (CPU2) */
	...
	ROM_REGION( 0x140000, RGNCLASS_SOUND, "oki1", 0 )	/* Samples */
	ROM_LOAD( "gp2-100.043", 0x040000, 0x100000, CRC(4235ac5b) SHA1(7e35831523fbb2d0587b9ab93c13b2b43dc481a8) )	// $10 x $10000
	ROM_COPY( RGNCLASS_SOUND, "oki1", 0x0c0000, 0, 0x40000 )

	ROM_REGION( 0x400000, RGNCLASS_SOUND, "oki2", 0 )	/* Samples */
...
ROM_START( galpan2j )
	...
	ROM_REGION16_BE( 0x800000, RGNCLASS_USER, "user1", 0 )	/* Backgrounds (CPU2) */
	...
	ROM_CONTINUE(            0x100000, 0x080000 )
	ROM_COPY( RGNCLASS_SOUND, "oki2", 0x100000, 0x300000, 0x100000 )
ROM_END
...
ROM_START( gp2se )
	...
	ROM_REGION16_BE( 0xa00000, RGNCLASS_USER, "user1", 0 )	/* Backgrounds (CPU2) */
	...
	ROM_REGION( 0x500000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )	/* Sprites */
...
ROM_START( gp2quiz )
	...
	ROM_REGION( 0x240000, RGNCLASS_SOUND, "oki1", 0 )	/* Samples */
