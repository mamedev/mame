...
// 00 a0 a8 18 f4 2c 70 60 e4 e8 58 d4 00 00  unusual sequence, lots of 00
GAME(199?, m4rsg,     0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Ready Steady Go (Barcrest) (MPU4, Mod 2 type, V1.2)",GAME_FLAGS )
GAME(199?, m4rsga,    m4rsg,      mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Ready Steady Go (Barcrest) (MPU4, Mod 2 type, V1.0)",GAME_FLAGS )

// 00 e0 8c 58 b0 68 30 64 e4 cc 58 f0 00 00  unusual seuqence, lots of 00
GAME(199?, m4crkpot,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Crackpot 100 Club (Barcrest) (MPU4) (set 1, C1P 1.2)",GAME_FLAGS )
GAME(199?, m4crkpota, m4crkpot,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Crackpot 100 Club (Barcrest) (MPU4) (set 2, CP 3.8)",GAME_FLAGS )
GAME(199?, m4crkpotb, m4crkpot,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Crackpot 100 Club (Barcrest) (MPU4) (set 3, CP 3.1)",GAME_FLAGS )

// 00 60 68 bc d0 2c 94 20 e4 e8 bc f0 00 00  unusual sequence, lots of 00
GAME(199?, m4multcl,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Multiplay Club (Barcrest) (MPU4, MP 2.8)",GAME_FLAGS )

// 00 30 20 14 64 30 44 30 64 34 00 74 20 10 64
GAME(199?, m4clbclm,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Club Climber (Barcrest) (MPU4, C1C 3.3)",GAME_FLAGS )
GAME(199?, m4clbclma, m4clbclm,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Club Climber (Barcrest) (MPU4, CC 4.5)",GAME_FLAGS )

// 00 bc b8 fc bc dc fc fc fc f8 d8 b8 00 00 00 unusual sequence, lots of 00
GAME(199?, m4grbbnk,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Grab The Bank (Barcrest) (MPU4) (G4B 2.0)",GAME_FLAGS )
GAME(199?, m4grbbnka, m4grbbnk,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Grab The Bank (Barcrest) (MPU4) (G4B 2.1)",GAME_FLAGS )
// doesn't run valid code, bad?
...
// 00 e0 8c 58 b0 68 30 64 e4 cc 58 f0 00 00  unusual equence, lots of 00
GAME(199?, m4hiroll,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","High Roller (Barcrest) (MPU4)",GAME_FLAGS )

// 00 c4 e8 58 b4 4c 30 40 e4 a8 18 94 00 00 unusual sequence, lots of 00
GAME(199?, m4potlck,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Pot Luck 100 Club (Barcrest) (MPU4) (P1L 2.2)",GAME_FLAGS )
GAME(199?, m4potlcka, m4potlck,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Pot Luck 100 Club (Barcrest) (MPU4) (PL 2.7)",GAME_FLAGS )

// 00 bc b8 fc bc dc fc fc fc f8 d8 b8 00 00 unusual sequence, lots of 00
GAME(199?, m4sgrab,   0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Smash 'n' Grab (Barcrest) (MPU4) (SAG 1.0, set 1)",GAME_FLAGS )
GAME(199?, m4sgraba,  m4sgrab,    mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Smash 'n' Grab (Barcrest) (MPU4) (set 1.0, set 2)",GAME_FLAGS )
GAME(199?, m4sgrabb,  m4sgrab,    mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Smash 'n' Grab (Barcrest) (MPU4) (SAG 3.4)",GAME_FLAGS )

// 00 60 68 bc d0 2c 94 20 e4 e8 bc f0 00 00
GAME(199?, m4stakeu,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Stake Up Club (Barcrest) (MPU4) (SU 4.4)",GAME_FLAGS )
GAME(199?, m4stakeua, m4stakeu,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Stake Up Club (Barcrest) (MPU4) (SU 4.8)",GAME_FLAGS )

// crashes MAME - check init
// 00 44 44 54 34 04 54 14 34 14 20 74 04 60 44 50 34
GAMEL(199?, m4actpak, 0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4actpak,      ROT0,   "Barcrest","Action Pack (Barcrest) (MPU4) (AP 0.4)",GAME_FLAGS, layout_m4actpak )
GAMEL(199?, m4actpaka,m4actpak,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4actpak,      ROT0,   "Barcrest","Action Pack (Barcrest) (MPU4) (AP 0.5)",GAME_FLAGS, layout_m4actpak )

// 00 50 40 14 64 50 24 50 64 54 20 74 40 30 60 10 64
GAMEL(199?, m4alladv, 0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4alladv,      ROT0,   "Barcrest","All Cash Advance (Barcrest) (MPU4) (C2B 6.0)",GAME_FLAGS, layout_m4alladv )

// 00 14 04 94 a8 6c c4 30 8c e8 e0 bc d4 28 4c c0 38
GAME(199?, m4clbdbl,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Club Double (Barcrest) (MPU4) (CD 1.6)",GAME_FLAGS ) // reel issues
...
// 00 a0 a8 18 f4 2c 70 60 e4 e8 58 d4 00 00
GAME(199?, m4stopcl,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Stop the Clock (Barcrest) (MPU4) (SC2.5)",GAME_FLAGS )

// 00 50 40 14 c4 b0 a4 30 c4 74 00 d4 e0 30 c0 34 c4
GAME(199?, m4toptena, m4topten,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Top Tenner (Barcrest) (MPU4, Mod 2 type, TP 2.7)",GAME_FLAGS )

// 00 90 88 2c e0 d8 74 84 dc 74 00 d4 c8 6c a0 58
GAME(199?, m4toplot,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Top The Lot (Barcrest) (MPU4, T4L 1.0)",GAME_FLAGS )
...
// 00 14 04 94 c8 68 a0 18 f4 8c e8 ec ac a8 6c 20 54
GAME(199?, m4bj,      0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Black Jack (Barcrest) [Dutch] (MPU4)",GAME_FLAGS ) // reel issues

// 00 44 44 64 4c 80 70 24 6c a8 b0 38 e4 50 24 48 8c bc
GAME(199?, m4flash,   0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Flash Cash (Barcrest) (MPU4, FC 1.0)",GAME_FLAGS )

// 00 60 60 24 e0 e8 1c 74 c4 6c 14 84 e8 1c f4 08 d0 cc dc b0
GAME(199?, m4swpnot,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Swap-A-Note (Barcrest) (v3.3) (MPU4)",GAME_FLAGS )
GAME(199?, m4swpnota, m4swpnot,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Swap-A-Note (Barcrest) (v3.2D) (MPU4)",GAME_FLAGS)

// 00 84 94 3c ec 5c ec 50 2c 68 60 ac 74 00 ac 58 ec 7c
GAME(199?, m4actnot,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Action Note (Barcrest) (MPU4) (AN 1.2)",GAME_FLAGS )

// 00 84 94 3c ec 5c ec 50 2c 68 60 ac 74 00 ac 58 ec 7c
GAME(199?, m4cardcs,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Card Cash (Barcrest) (MPU4) (CCS 1.9)",GAME_FLAGS )

// this and Cash Counter might be swapped around
// 00 c0 e0 b0 38 c4 f0 30 58 9c 9c 9c dc 9c dc 94 38 dc dc 8c
GAME(199?, m4cashcn,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Cash Connect (Barcrest) (MPU4) (CCO 3.2)",GAME_FLAGS )

// 00 84 c4 e4 4c 10 28 90 e8 78 34 28 b0 40 a4 4c 98 bc
GAME(199?, m4cashco,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Cash Counter (Barcrest) (MPU4) (C3 2.4)",GAME_FLAGS )
GAME(199?, m4cashcoa, m4cashco,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Cash Counter (Barcrest) (MPU4) (C3 1.8)",GAME_FLAGS )
GAME(199?, m4cashcob, m4cashco,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Cash Counter (Barcrest) (MPU4) (CO 0.5)",GAME_FLAGS )
GAME(199?, m4cashcoc, m4cashco,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Cash Counter (Barcrest) (MPU4) (C3 3.1)",GAME_FLAGS )
GAME(199?, m4cashcod, m4cashco,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Cash Connect (Barcrest) (MPU4) (C3 2.0)",GAME_FLAGS )

// unusual input mapping
// 00 14 10 C0 8C A8 68 30 D0 58 E4 DC F4
GAME(199?, m4cashmx,  0,          mod2_cheatchr_cashmx, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Cash Matrix (Barcrest) (MPU4) (CM 1.7, set 1)",GAME_FLAGS ) // hangs during play
GAME(199?, m4cashmxa, m4cashmx,   mod2_cheatchr_cashmx, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Cash Matrix (Barcrest) (MPU4) (CM 1.7, set 2)",GAME_FLAGS ) // hangs during play

// 00 84 8c d8 74 80 4c 90 e8 78 54 60 84 2c b0 28
GAME(199?, m4cashzn,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Cash Zone (Barcrest) (MPU4) (CAZ 1.2)",GAME_FLAGS )
GAME(199?, m4cashzna, m4cashzn,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Cash Zone (Barcrest) (MPU4) (CAZ 1.5)",GAME_FLAGS )
...
// 00 60 60 44 e0 e8 1c 74 a4 6c 14 84 e8 1c f4 08 b0 ac
GAME(199?, m4dblup,   0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Double Up (Barcrest) (MPU4) (DU 1.5)",GAME_FLAGS ) // token alarm

// 00 50 40 90 a8 6c c4 30 c8 ac a4 f8 d4 28 4c 84 38 dc
GAME(199?, m4eighth,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Eighth Wonder (Barcrest) (MPU4) (WON 2.2)",GAME_FLAGS )
...
// 00 14 04 94 c8 68 a0 50 8c e8 e0 dc bc b0 4c a0 58 bc bc 38
GAME(199?, m4frtprs,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Fruit Preserve (Barcrest) (MPU4) (F4P 1.1, set 1)",GAME_FLAGS )
GAME(199?, m4frtprsa, m4frtprs,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Fruit Preserve (Barcrest) (MPU4) (F4P 1.1, set 2)",GAME_FLAGS )

// 00 90 a0 34 8c 68 44 90 ac 6c 44 9c dc 5c d4 24 98 dc
GAME(199?, m4gldstr,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Gold Strike (Barcrest) (MPU4) (G4S 2.0)",GAME_FLAGS )
...
// 00 bc b8 fc bc dc fc fc fc f8 d8 b8 f8 d8 fc bc fc 98
GAME(199?, m4intcep,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Interceptor (Barcrest) (MPU4) (INT 3.0)",GAME_FLAGS ) // set % key
GAME(199?, m4intcepa, m4intcep,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Interceptor (Barcrest) (MPU4) (INT 3.0X)",GAME_FLAGS ) // set % key
// non-standard protection? hack?
GAME(199?, m4intcepb, m4intcep,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "hack?","Interceptor (Barcrest) (MPU4) (INT 1.1)",GAME_FLAGS ) // set % key

// 00 c0 c8 1c f4 68 14 50 70 50 20 f0 48 34 60 80 a8 7c f4
GAME(199?, m4megbks,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Mega Bucks (Barcrest) (MPU4) (BUC 4.1X)",GAME_FLAGS )
GAME(199?, m4megbksa, m4megbks,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Mega Bucks (Barcrest) (MPU4) (BUC 4.1CX)",GAME_FLAGS )
GAME(199?, m4megbksb, m4megbks,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Mega Bucks (Barcrest) (MPU4) (BUC 4.1XD)",GAME_FLAGS )
GAME(199?, m4megbksc, m4megbks,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Mega Bucks (Barcrest) (MPU4) (BUC 3.1)",GAME_FLAGS )

// 00 50 40 90 a8 6c c4 30 c8 ac a4 f8 d4 28 4c 84
GAME(199?, m4mirage,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Mirage (Barcrest) (MPU4) (RAG 4.1)",GAME_FLAGS ) // reel issue during play
...
// 00 30 20 14 64 30 44 30 64 34 00 74 20 10 64 10
GAME(199?, m4r2r,     0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Reel 2 Reel (Barcrest) (MPU4)",GAME_FLAGS )

// 00 a0 88 38 94 2c 30 00 e4 c8 18 b4 00 00
GAME(199?, m4reelpk,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Reel Poker (Barcrest) (MPU4)",GAME_FLAGS )

// 00 30 20 14 2c a0 54 24 3c 9c 9c 9c bc 94 6c
GAME(199?, m4runawy,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Runaway Trail (Barcrest) (MPU4)",GAME_FLAGS )
GAME(199?, m4runawyb, m4runawy,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Runaway Trail (Barcrest) (v1.2?) (MPU4)",GAME_FLAGS )

// 00 90 18 e4 a8 3c f4 48 74 50 20 f0 18 e4 98 e4
GAME(199?, m4silshd,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Silver Shadow (Barcrest) (MPU4)",GAME_FLAGS )
// these don't boot
GAME(199?, m4silshda, m4silshd,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Silver Shadow (Barcrest) (MPU4) (SH 2.0, set 1)",GAME_FLAGS  )// bad dump
GAME(199?, m4silshdb, m4silshd,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Silver Shadow (Barcrest) (MPU4) (SH 2.0, set 2)",GAME_FLAGS ) // bad dump

// 00 14 04 54 c4 98 f0 48 e4 5c f0 c8 ec 68 24
GAME(199?, m4solsil,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Solid Silver Club (Barcrest) (MPU4) (SOS 2.2)",GAME_FLAGS )
GAME(199?, m4solsila, m4solsil,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Solid Silver Club (Barcrest) (MPU4) (SOS 2.1)",GAME_FLAGS )
...
// 00 60 60 c0 58 44 e0 50 a8 9c cc bc e4 50 a0 58 ec bc
GAME(199?, m4sunsetd, m4sunset,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4_showstring, ROT0,   "Barcrest","Sunset Boulevard (Barcrest) (MPU4) (SBU 2.0)",GAME_FLAGS )
...
// 00 90 c0 54 8c 68 24 90 cc 6c 24 9c bc 34 88 6c
GAME(199?, m4supslt,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Supa Slot (Barcrest) (MPU4)",GAME_FLAGS )

// 00 50 40 90 a8 6c c4 30 c8 ac a4 f8 d4 28 4c 84 38
GAME(199?, m4suptub,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Super Tubes (Barcrest) (MPU4) (S4T 1.0, set 1))",GAME_FLAGS )
GAME(199?, m4suptuba, m4suptub,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Super Tubes (Barcrest) (MPU4) (S4T 1.0, set 2)",GAME_FLAGS )

// 00 60 60 24 e0 e8 1c 74 c4 6c 14 84 e8 1c f4
GAME(199?, m4suptwo,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Super Two (Barcrest) (MPU4)",GAME_FLAGS ) // set % key

// 00 18 70 44 58 30 44 18 7c 74 00 5c 7c 34 48 24 58
GAME(199?, m4tiktak,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Tic Tak Cash (Barcrest) (MPU4)",GAME_FLAGS )
...
// 00 30 20 14 2c a0 54 24 3c 9c 9c 9c bc 94 6c 80 58
GAME(199?, m4topacta, m4topact,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Top Action (Barcrest) (Dutch) (MPU4) (set 2)",GAME_FLAGS )

// 00 24 24 a4 4c 10 88 50 a8 d8 9c 9c bc 94 e8 50 a8
GAME(199?, m4topst,   0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Top Stop (Barcrest) (MPU4)",GAME_FLAGS )
...
GAME(199?, m421,      0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Twenty One (Barcrest) (MPU4)",GAME_FLAGS ) // reel issues

// 00 50 40 14 4c 80 34 44 5c 9c 9c 9c dc 9c
GAMEL(199?, m4alpha,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4alpha,       ROT0,   "Barcrest","Alphabet (Barcrest) [A4B 1.0] (MPU4)",GAME_FLAGS, layout_m4alpha )

// 00 84 94 3c ec 5c ec 50 2c 68 60 ac 74 00 ac
GAME(199?, m4bnknot,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Bank A Note (Barcrest) [BN 1.0] (MPU4)",GAME_FLAGS )

// 00 14 10 c0 4c 20 84 0c f0 98 e4 dc f4 08 f0 08 70 d0
GAME(199?, m4bjack,   0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Black Jack (Barcrest) (MPU4) (set 1)",GAME_FLAGS )
GAME(199?, m4bjacka,  m4bjack,    mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Black Jack (Barcrest) (MPU4) (set 2)",GAME_FLAGS )

// 00 60 60 c0 58 44 e0 50 a8 9c cc bc e4 50 a0 58
GAME(199?, m4bjsm,    0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Blackjack Super Multi (Barcrest) (MPU4) (SM H)",GAME_FLAGS ) // reel issues
...
// non-standard protection, hack?
GAME(199?, m4wayina,  m4wayin,    mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "hack?","Way In (Barcrest) (MPU4) (set 2)",GAME_FLAGS ) // bad chr


/* Bwb */

// 00 c4 e8 58 b4 4c 30 40 e4 a8 18 94 48 34 64 c4 c8 7c f4
GAME(199?, m4flshlt,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4_showstring, ROT0,   "Bwb","Flashlite (Bwb) (MPU4) (set 1)",GAME_FLAGS )
GAME(199?, m4flshltb, m4flshlt,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4_showstring, ROT0,   "Bwb","Flashlite (Bwb) (MPU4) (set 3)",GAME_FLAGS )
GAME(199?, m4flshltc, m4flshlt,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4_showstring, ROT0,   "Bwb","Flashlite (Bwb) (MPU4) (set 4)",GAME_FLAGS )
GAME(199?, m4flshltd, m4flshlt,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4_showstring, ROT0,   "Bwb","Flashlite (Bwb) (MPU4) (set 5)",GAME_FLAGS )
GAME(199?, m4flshlte, m4flshlt,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4_showstring, ROT0,   "Bwb","Flashlite (Bwb) (MPU4) (set 6)",GAME_FLAGS )
GAME(199?, m4flshltf, m4flshlt,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4_showstring, ROT0,   "Bwb","Flashlite (Bwb) (MPU4) (set 7)",GAME_FLAGS )
GAME(199?, m4flshltg, m4flshlt,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4_showstring, ROT0,   "Bwb","Flashlite (Bwb) (MPU4) (set 8)",GAME_FLAGS )
...
// 00 44 44 54 34 04 54 14 34 14 20 74 04 60 44 50 34 34 34 04 50 10 20
GAME(199?, m4ttak,    0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "<unknown>","Tic Tac Take (unknown) (MPU4)",GAME_FLAGS )

// 00 c0 c8 1c f4 68 14 50 70 50 20 f0 48 34 60 80 a8 7c
GAME(199?, m4actbnka, m4actbnk,   mod2_cheatchr, mpu4jackpot8tkn, mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Action Bank (Barcrest) (Mod 2 type, AC3.0) (MPU4)",GAME_FLAGS ) // set jackpot key to 8GBP TOKEN & stake key
GAME(199?, m4actbnkb, m4actbnk,   mod2_cheatchr, mpu4jackpot8tkn, mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Action Bank (Barcrest) (Mod 2 type, ACT2.0) (MPU4)",GAME_FLAGS )
...
// 00 24 24 64 2c 14 4c 14 4c 58 78 78 74 00 6c
GAMEL(199?, m4actclba,m4actclb,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4actclb,      ROT0,   "Barcrest","Action Club (Barcrest) (MPU4) (1.1)",GAME_FLAGS, layout_m4actclb ) //  ^^

// 00 14 04 94 c8 68 a0 50 8c e8 e0 dc bc b0 4c a0 58 bc bc
GAME(199?, m4bluemn,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Blue Moon (Barcrest) (MPU4) (BLU 2.3)",GAME_FLAGS )
GAME(199?, m4bluemna, m4bluemn,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Blue Moon (Barcrest) (MPU4) (BLU 2.1)",GAME_FLAGS )
...
// 00 50 40 14 c4 b0 a4 30 c4 74 00 d4 e0 30 c0 34 c4
GAME(199?, m4take2,   0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Take Two (Barcrest) (MPU4) (TTO 1.2)",GAME_FLAGS )
// not using standard protection, hack?
...
GAME(199?, m4loadmna, m4loadmn,   mod2_cheatchr_andybt, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Loads A Money (Barcrest) (MPU4) (set 2)",GAME_FLAGS )
GAME(199?, m4loadmnb, m4loadmn,   mod2_cheatchr_andybt, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Loads A Money (Barcrest) (MPU4) (set 3)",GAME_FLAGS )
...
// 00 60 60 24 e0 e8 1c 74 c4 6c 14 84 e8 1c f4 08 d0 cc dc b0 cc
...
// 00 14 10 a0 8c c8 68 50 b0 38 64 b4 18 e4 1c e4 8c f8
GAME(199?, m4clbcls,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Club Classic (Barcrest) (MPU4)",GAME_FLAGS ) // set stake (still moans tho)
...
// 00 84 c4 e4 4c 10 28 90 e8 78 34 28 b0 40 a4
GAME(199?, m4bjc,     0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default_alt, ROT0,   "Barcrest","Black Jack Club (Barcrest) (Dutch) (MPU4)",GAME_FLAGS )
// 00 30 10 44 70 10 44 30 54 14 40 74 10 40 34
GAME(199?, m4exprs,   0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Express (Barcrest) (DXP, Dutch) (MPU4)",GAME_FLAGS )
// 00 14 10 c0 4c 20 84 0c f0 98 e4 dc f4 08 f0
GAME(199?, m4brdway,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Broadway (Barcrest) (DBR, Dutch) (MPU4)",GAME_FLAGS )
// 00 14 04 94 c8 68 a0 50 8c e8 e0 dc bc b0 4c
GAME(199?, m4bigbn,   0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Big Ben (Barcrest) (DBB, Dutch) (MPU4)",GAME_FLAGS )
// 00 44 44 64 4c 10 28 50 68 38 34 28 70 00 6c 10 68
GAME(199?, m4cheryo,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Cherryo (Barcrest) (DCH, Dutch) (MPU4)",GAME_FLAGS )
...
// 00 30 20 14 2c a0 54 24 3c 9c 9c 9c bc 94 6c 80 58 bc bc 98
GAME(199?, m4holdon,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Hold On (Barcrest) (Dutch) (MPU4)",GAME_FLAGS )
// 00 e0 8c 58 b0 68 30 64 e4 cc 58 f0 2c 50 64 c4 88 5c f4 0c
GAME(199?, m4libty,   0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Liberty (Barcrest) (Dutch) (MPU4)",GAME_FLAGS )
// 00 84 94 5c ec 3c ec 30 4c 68 60 cc 7c e0 94 58 ec 7c
GAME(199?, m4meglnk,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Megalink (Barcrest) (Dutch) (MPU4)",GAME_FLAGS )
// 00 84 8c 3c f4 4c 34 24 e4 ac 38 f0 0c 70 04 e0 c8
GAME(199?, m4multwy,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Multiway (Barcrest) (Dutch) (MPU4)",GAME_FLAGS )
// 00 44 44 64 4c 80 70 24 6c a8 b0 38 e4 50 24 48 8c bc
GAME(199?, m4num1,    0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Number One (Barcrest) (Dutch) (MPU4)",GAME_FLAGS )
// 00 44 44 54 34 04 54 14 34 14 20 74 04 60 44 50
GAME(199?, m4nudup,   0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Nudge Up (Barcrest) (Dutch) (MPU4)",GAME_FLAGS )
// 00 bc b8 fc bc dc fc fc fc f8 d8 b8 00 00 00 00  strange sequence with lots of repeating 00 values
GAME(199?, m4omega,   0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Omega (Barcrest) (Dutch) (MPU4)",GAME_FLAGS )
...
// 00 a0 a8 18 f4 2c 70 60 e4 e8 58 d4 2c 50 60 80 8c 5c f4 28 70 00
GAME(199?, m4samu,    0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Samurai (Barcrest) (Dutch) (MPU4)",GAME_FLAGS )
// 00 90 c0 54 8c 68 24 90 cc 6c 24 9c bc 34 88 6c a8 ec ec
GAME(199?, m4stards,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Stardust (Barcrest) (Dutch) (MPU4)",GAME_FLAGS )
// 00 84 8c 3c f4 4c 34 14 54 14 40 d4 4c 70 04 d0 58 f4
...
// 00 30 20 14 64 30 44 30 64 34 00 74 20 10 64 10 64 74 64 30
GAME(199?, m4tbrldx,  m4tbreel,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Turbo Reel (Barcrest) (Dutch) (MPU4) (set 3, Deluxe?)",GAME_FLAGS )
...
// 00 84 94 3c ec 5c ec 50 2c 68 60 ac 74 00 ac 58
GAME(199?, m4wildms,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Wild Mystery (Barcrest) (Dutch) (MPU4)",GAME_FLAGS )


// these all have reel issues, but test mode produces ay sounds

// REEL D ALARM
// 00 60 60 24 e0 e8 1c 74 c4 6c 14 84 e8 1c f4 08
GAME(199?, m4suptrn,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Supatron (Barcrest) (MPU4)",GAME_FLAGS )

// REEL A ALARM
// 00 60 60 a0 38 64 e0 30 c8 9c ac dc ec 94 d8 a4 38 ec
GAME(199?, m4bjac,    0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default_alt, ROT0,   "Barcrest","Blackjack Club (Barcrest) (MPU4) (set 1)",GAME_FLAGS )
GAME(199?, m4bjaca,   m4bjac,     mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default_alt, ROT0,   "Barcrest","Blackjack Club (Barcrest) (MPU4) (set 2)",GAME_FLAGS )
...
// REEL A ALARM
// 00 84 94 5c ec 3c ec 30 4c 68 60 cc 7c e0 94 58 ec 7c
GAME(199?, m4clbcnt,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Club Connect (Barcrest) (MPU4) (set 1)",GAME_FLAGS )
GAME(199?, m4clbcnta, m4clbcnt,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Club Connect (Barcrest) (MPU4) (set 2)",GAME_FLAGS )
GAME(199?, m4clbcntb, m4clbcnt,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Club Connect (Barcrest) (MPU4) (set 3)",GAME_FLAGS )
GAME(199?, m4clbcntc, m4clbcnt,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Club Connect (Barcrest) (MPU4) (set 4)",GAME_FLAGS )
GAME(199?, m4clbcntd, m4clbcnt,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Club Connect (Barcrest) (MPU4) (set 5)",GAME_FLAGS )

// REEL D ALARM
// 00 50 40 14 c4 b0 a4 30 c4 74 00 d4 e0 30 c0 34 c4
GAME(199?, m4class,   0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","First Class (Barcrest) [DFC, Dutch] (MPU4) (set 1)",GAME_FLAGS )
// INITIALIZE COMMS, before any prot sequence
GAME(199?, m4classa,  m4class,    mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","First Class (Barcrest) [DFC, Dutch] (MPU4) (set 2)",GAME_FLAGS )

// REEL A ALARM
// 00 44 44 c4 58 60 c0 50 8c b8 e0 dc ec b0 1c e8 38
GAME(199?, m4frtfl,   0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Fruit Full (Barcrest) (MPU4) (set 1)",GAME_FLAGS )
GAME(199?, m4frtfla,  m4frtfl,    mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Fruit Full (Barcrest) (MPU4) (set 2)",GAME_FLAGS )
// 00 44 44 c4 58 60 c0 50 8c b8 e0 dc ec b0 1c e8 38
GAME(199?, m4frtflc,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Fruit Full Club (Barcrest) (MPU4)",GAME_FLAGS )
...
// REEL A ALARM
// 00 84 c4 e4 4c 10 28 90 e8 78 34 28 b0 40 a4 4c
GAME(199?, m4jpjmp,   0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Jackpot Jump (Barcrest) (MPU4) (set 1)",GAME_FLAGS )
GAME(199?, m4jpjmpa,  m4jpjmp,    mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Jackpot Jump (Barcrest) (MPU4) (set 2)",GAME_FLAGS )

// REEL A ALARM
// 00 84 a4 e4 b0 34 54 44 d4 64 80 f4 24 80 f4 20
GAME(199?, m4milclb,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Millionaire's Club (Barcrest) (MPU4) (set 1)",GAME_FLAGS )
GAME(199?, m4milclba, m4milclb,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Millionaire's Club (Barcrest) (MPU4) (set 2)",GAME_FLAGS )
GAME(199?, m4milclbb, m4milclb,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Millionaire's Club (Barcrest) (MPU4) (set 3)",GAME_FLAGS )
GAME(199?, m4milclbc, m4milclb,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Millionaire's Club (Barcrest) (MPU4) (set 4)",GAME_FLAGS )
GAME(199?, m4milclbd, m4milclb,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Millionaire's Club (Barcrest) (MPU4) (set 5)",GAME_FLAGS )

// boots but no coins?
// 00 44 44 54 34 04 54 14 34 14 20 74 04 60 44 50 34 34
GAME(199?, m4bigchd,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Big Chief (Barcrest) [BCH, Dutch] (MPU4)",GAME_FLAGS ) // why code BCH on a dutch?

// boots with percent key
// 00 24 24 a4 4c 10 88 50 a8 d8 9c 9c bc 94 e8 50 a8
GAME(199?, m4dbl9,    0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Double 9's (Barcrest) (MPU4) (set 1)",GAME_FLAGS )
...
GAME(199?, m4nick,    0,          mod2_cheatchr_viz, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Nickelodeon (Barcrest) (MPU4) (set 1)",GAME_FLAGS )
GAME(199?, m4nicka,   m4nick,     mod2_cheatchr_viz, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Nickelodeon (Barcrest) (MPU4) (set 2)",GAME_FLAGS )
GAME(199?, m4nickb,   m4nick,     mod2_cheatchr_viz, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Nickelodeon (Barcrest) (MPU4) (set 3)",GAME_FLAGS )
GAME(199?, m4nickc,   m4nick,     mod2_cheatchr_viz, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Nickelodeon (Barcrest) (MPU4) (set 4)",GAME_FLAGS )
GAME(199?, m4nickd,   m4nick,     mod2_cheatchr_viz, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Nickelodeon (Barcrest) (MPU4) (set 5)",GAME_FLAGS )
// non-standard protection, hack?
GAME(199?, m4nicke,   m4nick,     mod2_cheatchr_viz, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "hack?","Nickelodeon (Barcrest) (MPU4) (set 6)",GAME_FLAGS )

// 00 14 04 94 a8 6c c4 30 8c e8 e0 bc d4 28 4c c0 38
GAME(199?, m4joljok,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Jolly Joker (Barcrest) (MPU4)",GAME_FLAGS )

// 00 14 04 94 a8 6c c4 30 8c e8 e0 bc d4 28 4c
GAME(199?, m4joltav,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Jolly Taverner (Barcrest) (MPU4) (set 1)",GAME_FLAGS )
// 00 a0 a8 18 f4 2c 70 60 e4 e8 58 d4 2c 50 60
GAME(199?, m4joltava, m4joltav,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Jolly Taverner (Barcrest) (MPU4) (set 2)",GAME_FLAGS )
GAME(199?, m4joltavb, m4joltav,   mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Jolly Taverner (Barcrest) (MPU4) (set 3)",GAME_FLAGS )

// Bad CHR Alarm
// non-standard protection? hack? (has a fakechr rom in set though, might just be failing the cheat method)
GAME(199?, m4btclok,  0,          mod2_cheatchr, mpu4,            mpu4mod2_machines_state, init_m4default,     ROT0,   "Barcrest","Beat The Clock (Barcrest) (MPU4)",GAME_FLAGS )
...
#define GAME_CUSTOM(year, setname,parent,name,offset,length,hash,company,title) \
	ROM_START( setname ) \
		...
		ROM_LOAD( name, offset, length, hash ) \
	ROM_END \
	GAME(year, setname, parent, mod2_cheatchr_cashmx, mpu4, mpu4mod2_machines_state, init_m4_showstring, ROT0, company, title, GAME_FLAGS )
