...
{
	static UINT8 dial[8];
	static const char *dialnames[] = { "DIAL1", "DIAL2", "DIAL3", "DIAL4", "DIAL5", "DIAL6", "DIAL7", "DIAL8" };
...
{
	static const char *portnames[] = { "P1", "P2", "P3", "P4", "P5", "P6", "P7", "P8" };
...
ROM_START( sprint8 )
	...
	ROM_REGION( 0x0200, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) /* tiles */
	ROM_LOAD( "7315-01.n6", 0x0000, 0x0200, CRC(e2f603d0) SHA1(8d82b72d2f4039afa3341774000105a745caf85f) )

	ROM_REGION( 0x0100, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE ) /* cars */
