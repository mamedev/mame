...
ROM_START( 1944 )
	...
	ROM_REGION( 0x1400000, RGNCLASS_GFX, "gfx1", 0 )
	...
	ROM_REGION( QSOUND_SIZE, RGNCLASS_CPU, "audio", 0 ) /* 64k for the audio CPU (+banks) */
	ROM_LOAD( "nff.01",   0x00000, 0x08000, CRC(d2e44318) SHA1(33e45f6fe9fed098a4c072b8c39406aef1a949b2) )
	ROM_CONTINUE(         0x10000, 0x18000 )

	ROM_REGION( 0x800000, RGNCLASS_SOUND, "qsound", 0 ) /* QSound samples */
...
ROM_START( choko )
	ROM_REGION( CODE_SIZE, RGNCLASS_CPU, "main", ROMREGION_ERASEFF )      /* 68000 code */
...
ROM_START( ddtod )
	...
	ROM_REGION( 0xc00000, RGNCLASS_GFX, "gfx1", 0 )
