...
ROM_START( tubep )
	ROM_REGION( 0x10000,RGNCLASS_CPU, "main", 0 ) /* Z80 (master) cpu code */
	...
	ROM_REGION( 0x10000,RGNCLASS_CPU, "slave", 0 ) /* Z80 (slave) cpu code */
	...
	ROM_REGION( 0x10000,RGNCLASS_CPU, "sound", 0 ) /* Z80 (sound) cpu code */
	...
	ROM_REGION( 0x10000,RGNCLASS_CPU, "nsc", 0 ) /* 64k for the custom CPU */
	...
	ROM_REGION( 0xc000, RGNCLASS_USER, "user1", 0 ) /* background data */
	...
	ROM_REGION( 0x18000,RGNCLASS_USER, "user2", 0 )
	...
	ROM_REGION( 0x40,   RGNCLASS_PROMS, "proms", 0 ) /* color proms */
...
ROM_START( tubepb )
	...
	ROM_REGION( 0x10000,RGNCLASS_CPU, "mcu", 0 ) /* 64k for the custom CPU */
...
ROM_START( rjammer )
	...
	ROM_REGION( 0x7000, RGNCLASS_USER, "user1", 0 ) /* background data */
