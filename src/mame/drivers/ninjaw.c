...
ROM_START( ninjaw )
	ROM_REGION( 0xc0000, RGNCLASS_CPU, "main", 0 )	/* 256K for 68000 CPUA code */
	...
	ROM_REGION( 0x60000, RGNCLASS_CPU, "sub", 0 )	/* 384K for 68000 CPUB code */
	...
	ROM_COPY( RGNCLASS_GFX, "gfx1", 0x000000, 0x000000, 0x100000 )	/* SCR (screens 2+) */
