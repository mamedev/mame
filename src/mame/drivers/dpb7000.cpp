...
static INPUT_PORTS_START( dpb7000 )
	...
	PORT_BIT(0x10, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_CODE(KEYCODE_4_PAD) // 0x7f
...
{
	uint8_t data = machine().input().code_pressed(KEYCODE_5_PAD) ? machine().rand() : 0;
