...
GAME (19??, modelr,   0,        modelr,   invadrmr, 0, ROT0,   "Model Racing", "Model Racing Shooting Game", GAME_NOT_WORKING | GAME_SUPPORTS_SAVE ) // unknown title
