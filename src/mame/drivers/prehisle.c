...
ROM_START( prehisle )
	...
	ROM_REGION( 0x0a0000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE )
	...
	ROM_REGION( 0x10000, RGNCLASS_GFX, "gfx5", 0 )	/* background tilemaps */
	ROM_LOAD( "gt.11",  0x000000, 0x10000, CRC(b4f0fcf0) SHA1(b81cc0b6e3e6f5616789bb3e77807dc0ef718a38) )

	ROM_REGION( 0x20000, RGNCLASS_SOUND, "upd", 0 )	/* ADPCM samples */
