...
ROM_START( pkgnsh )
	ROM_REGION( 0x100000, RGNCLASS_CPU, "main", 0 )		/* TMP68301 Code */
	...
	ROM_REGION( 0x400000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )	/* Backgrounds */
	...
	ROM_REGION( 0x40000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE )	/* Text Layer */
	...
	ROM_REGION( 0xc00000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE )	/* Sprites (256 colors) */
	...
	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE )	/* Sprites (16 colors) Not Used */
...
ROM_START( realbrk )
	...
	ROM_REGION( 0x800000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )	/* Backgrounds */
	...
	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE )	/* Sprites (16 colors) */
...
ROM_START( dai2kaku )
	...
	ROM_REGION( 0x800000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE )	/* Sprites (256 colors) */
