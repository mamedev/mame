...
static INPUT_PORTS_START( area51 )
	...
	PORT_BIT( 0xfff, 0x80, IPT_LIGHTGUN_X ) PORT_CROSSHAIR(X, 320.0/(320.0 - 7 -7), 0, 0) PORT_MINMAX(0x00,268) PORT_SENSITIVITY(50) PORT_KEYDELTA(10)
	...
	PORT_BIT( 0xfff, 0x80, IPT_LIGHTGUN_X ) PORT_CROSSHAIR(X, 320.0/(320.0 - 7 -7), 0.0, 0) PORT_MINMAX(0x00,268) PORT_SENSITIVITY(50) PORT_KEYDELTA(10) PORT_PLAYER(2)
