...
{
	memory_set_bankptr( STATIC_BANK1, memory_region(machine, RGNCLASS_CPU, "audio") + (banknum * 0x8000) + 0x10000 );
//  memory_set_bankptr( 1, memory_region(machine, RGNCLASS_CPU, "audio") + (banknum * 0x8000) + 0x10000 );
...
ROM_START( darius )
	...
	ROM_LOAD16_BYTE( "a96_30.154",  0x40001, 0x10000, CRC(9eb5e127) SHA1(50e2fe5ec7f79ecf1fb5107298da13ef5ab37162) )
   	...
   	ROM_REGION( 0x30000, RGNCLASS_CPU, "audio", 0 )	/* Z80 sound cpu */
	ROM_LOAD( "a96_57.33",  0x00000, 0x10000, CRC(33ceb730) SHA1(05070ea503ac57ff8445145d6f97115f7aad90a5) )

	ROM_REGION( 0x80000, RGNCLASS_CPU, "cpub", 0 )	/* 68000 code */
	...
	ROM_REGION( 0x10000, RGNCLASS_CPU, "adpcm", 0 )	/* second Z80 driving the ADPCM chip */
	...
	ROM_REGION( 0xc0000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE )
	...
	ROM_LOAD32_BYTE( "da-65.bin",    0x80003, 0x10000, CRC(14eee326) SHA1(41760fada2a5e34ee6c9250af927baf650d9cfc4) )
 	...
 	ROM_REGION( 0x8000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE )			/* 8x8 SCR tiles */
