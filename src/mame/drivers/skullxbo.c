...
ROM_START( skullxbo )
	...
	ROM_REGION( 0x190000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )
	...
	ROM_REGION( 0x0a0000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE | ROMREGION_INVERT )
	...
	ROM_REGION( 0x008000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE )
	ROM_LOAD( "136072-2141.250k", 0x000000, 0x008000, CRC(60d6d6df) SHA1(a8d56092f014a0a93742c701effaec86c75772e1) )

	ROM_REGION( 0x40000, RGNCLASS_SOUND, "adpcm", 0 )	/* 256k for ADPCM samples */
...
static DRIVER_INIT( skullxbo )
{
	...
	memset(memory_region(machine, RGNCLASS_GFX, "gfx1") + 0x170000, 0, 0x20000);
}
