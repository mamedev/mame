...
public:
	...
	void scanrow_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void led_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t scan_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void potmux_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t comparitor_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void mask_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void cv_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void gate_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
...
void prophet600_state::dac_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	if (offset)
	{
		m_dac &= 0xff;
...
void prophet600_state::scanrow_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_scanrow = data;
}

// scanrow 0x10 = LEDs, 0x20 = 7-segment #1, 0x40 = 7-segment #2
void prophet600_state::led_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	if (m_scanrow & 0x10)
	{
...
uint8_t prophet600_state::scan_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return 0;
}

void prophet600_state::mask_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void prophet600_state::cv_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	int cvnum = data & 7;
...
void prophet600_state::gate_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_ASaw = (data & 0x01);
	m_ATri = (data & 0x02);
	m_Sync = (data & 0x04);
...
*/
void prophet600_state::potmux_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
}

uint8_t prophet600_state::comparitor_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
//  m_comparitor ^= 0x04;
	return m_comparitor;
}
