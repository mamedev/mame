...
{
	UINT8 *ROM = memory_region(machine, RGNCLASS_SOUND, "ymf");
...
{
	UINT8 *ymf_pcmbank = memory_region(machine, RGNCLASS_SOUND, "ymf") + 0x200000;
	UINT8 *pcm_rom = memory_region(machine, RGNCLASS_SOUND, "ymfsource");
...
ROM_START( hotgmck )
	...
	ROM_REGION( 0x2000000, RGNCLASS_GFX, "gfx1", ROMTEST_GFX )
	...
	ROM_REGION( 0x400000, RGNCLASS_SOUND, "ymf", ROMREGION_ERASE00 )

	ROM_REGION( 0x800000, RGNCLASS_SOUND, "ymfsource", 0 )
...
ROM_START( hgkairak )
	...
	ROM_REGION( 0x3000000, RGNCLASS_GFX, "gfx1", ROMTEST_GFX )	/* Sprites */
...
ROM_START( hotgmck3 )
	...
	ROM_REGION( 0x4000000, RGNCLASS_GFX, "gfx1", ROMTEST_GFX )	/* Sprites */
...
ROM_START( hotgm4ev )
	/* main program */
	ROM_REGION( 0x500000, RGNCLASS_CPU, "main", 0)
	...
	ROM_REGION( 0x8000000, RGNCLASS_GFX, "gfx1", ROMTEST_GFX )	/* Sprites */
...
ROM_START( hotgmcki )
	...
	ROM_REGION( 0x4000000, RGNCLASS_GFX, "gfx1", ROMREGION_ERASEFF | ROMTEST_GFX )	/* Sprites */
...
ROM_START( loderndf )
	...
	ROM_REGION( 0x800000, RGNCLASS_SOUND, "ymf", ROMREGION_ERASE00 )
...
ROM_START( hotdebut )
	...
	ROM_REGION( 0x1800000, RGNCLASS_GFX, "gfx1", ROMTEST_GFX )	/* Sprites */
...
{
	UINT8 *ymf_pcm = memory_region(machine, RGNCLASS_SOUND, "ymf");
	UINT8 *pcm_rom = memory_region(machine, RGNCLASS_SOUND, "ymfsource");
