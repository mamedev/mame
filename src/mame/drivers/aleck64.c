...
static ADDRESS_MAP_START( n64_map, ADDRESS_SPACE_PROGRAM, 32 )
	...
	AM_RANGE(0x10000000, 0x13ffffff) AM_ROM AM_REGION(RGNCLASS_USER, "user2", 0)	// Cartridge
	AM_RANGE(0x1fc00000, 0x1fc007bf) AM_ROM AM_REGION(RGNCLASS_USER, "user1", 0)	// PIF ROM
...
ROM_START( aleck64 )
	ROM_REGION32_BE( 0x800, RGNCLASS_USER, "user1", 0 )
	ROM_LOAD( "pifdata.bin", 0x0000, 0x0800, CRC(5ec82be9) SHA1(9174eadc0f0ea2654c95fd941406ab46b9dc9bdd) )

	ROM_REGION32_BE( 0x4000000, RGNCLASS_USER, "user2", ROMREGION_ERASE00 )
	ROM_REGION32_BE( 0x100000, RGNCLASS_USER, "user3", ROMREGION_ERASE00 )
	ROM_REGION32_BE( 0x80, RGNCLASS_USER, "user4", ROMREGION_ERASE00 )
ROM_END

ROM_START( 11beat )
	ROM_REGION32_BE( 0x800, RGNCLASS_USER, "user1", ROMREGION_ERASE00 )
	PIF_BOOTROM

	ROM_REGION32_BE( 0x4000000, RGNCLASS_USER, "user2", 0 )
...
ROM_START( twrshaft )
	...
	ROM_REGION32_BE( 0x800000, RGNCLASS_USER, "user3", 0 )
