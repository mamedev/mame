...
static INPUT_PORTS_START( aleck64 )
	...
	PORT_START
		...
		PORT_BIT( 0x00200000, IP_ACTIVE_LOW, IPT_SERVICE ) PORT_NAME( DEF_STR( Service_Mode )) PORT_CODE(KEYCODE_F2)
...
ROM_START( aleck64 )
	...
	ROM_REGION32_BE( 0x4000000, REGION_USER2, ROMREGION_ERASE00 )
	ROM_REGION32_BE( 0x100000, REGION_USER3, ROMREGION_ERASE00 )
	ROM_REGION32_BE( 0x80, REGION_USER4, ROMREGION_ERASE00 )
ROM_END
...
ROM_START( twrshaft )
	...
	ROM_REGION32_BE( 0x800000, REGION_USER3, 0 )
