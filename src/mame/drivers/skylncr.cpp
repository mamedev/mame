...
GAME( 199?, ypovrixi,  0,       skylncr,  skylncr,  skylncr_state,  ypovrixi, ROT0, "bootleg?",             "Missing In Action / Ypovrixio (set 1)",          MACHINE_WRONG_COLORS | MACHINE_NOT_WORKING )
GAME( 199?, ypovrixia, 0,       skylncr,  skylncr,  skylncr_state,  ypovrixi, ROT0, "bootleg?",             "Missing In Action / Ypovrixio (set 2)",          MACHINE_WRONG_COLORS | MACHINE_NOT_WORKING )
