...
ROM_START( tokims )
	...
	ROM_LOAD32_BYTE( "5_tk_514.ic25",        0x040000, 0x010000, BAD_DUMP CRC(1a8f517e) SHA1(500f1c11fc4b1fb703d037c241637557f76a126f) )
	...
	ROM_REGION( 0x080000, "gfx3", 0 ) // same ROMs as some of the other bootlegs
	...
	ROM_REGION( 0x080000, "gfx4", 0 ) // same ROMs as some of the other bootlegs
	...
	ROM_LOAD( "51_502_82s129an.ic10", 0x0000, 0x100, CRC(15085e44) SHA1(646e7100fcb112594023cf02be036bd3d42cc13c) ) // same as Euro League modular bootleg	
