...
ROM_START( boogwing )
	ROM_REGION( 0x100000, RGNCLASS_CPU, "main", 0 ) /* DE102 code (encrypted) */
	...
	ROM_REGION( 0x20000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) /* Tiles 1 */
	...
	ROM_REGION( 0x300000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE ) /* Tiles 2 */
	...
	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE ) /* Tiles 3 */
	...
	ROM_REGION( 0x400000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE ) /* Sprites 1 */
	...
	ROM_REGION( 0x400000, RGNCLASS_GFX, "gfx5", ROMREGION_DISPOSE ) /* Sprites 2 */
...
{
	const UINT8* src=memory_region(machine, RGNCLASS_GFX, "gfx6");
	UINT8* dst=memory_region(machine, RGNCLASS_GFX, "gfx2") + 0x200000;
