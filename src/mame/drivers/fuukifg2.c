...
{
	if (data <= 2)
		memory_set_bankptr(1, memory_region(machine, RGNCLASS_CPU, "audio") + 0x8000 * data + 0x10000);
	else
...
ROM_START( gogomile )
	...
	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )	/* 16x16x4 Sprites */
	ROM_LOAD( "lh537k2r.20", 0x000000, 0x200000, CRC(525dbf51) SHA1(f21876676cc60ed65bc86884da894b24830826bb) )

	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE )	/* 16x16x4 Tiles */
	...
	ROM_REGION( 0x800000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE )	/* 16x16x8 Tiles */
	...
	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE )	/* 16x16x4 Tiles */
...
ROM_START( pbancho )
	...
	ROM_REGION( 0x400000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE )	/* 16x16x8 Tiles */
