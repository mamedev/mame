...
{
	memory_set_bankptr(1, &memory_region(machine, RGNCLASS_CPU, "sound")[0x10000 + data * 0x4000]);
}
...
static ADDRESS_MAP_START( timekill_map, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0x100000, 0x17ffff) AM_ROM AM_REGION(RGNCLASS_USER, "user1", 0) AM_BASE(&main_rom)
ADDRESS_MAP_END
...
static ADDRESS_MAP_START( bloodstm_map, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0x800000, 0x87ffff) AM_MIRROR(0x780000) AM_ROM AM_REGION(RGNCLASS_USER, "user1", 0) AM_BASE(&main_rom)
ADDRESS_MAP_END
...
//  AM_RANGE(0x086000, 0x08623f) AM_RAM -- networking -- first 0x40 bytes = our data, next 0x40*8 bytes = their data, r/w on IRQ2
	...
	AM_RANGE(0x600000, 0x607fff) AM_ROM AM_REGION(RGNCLASS_USER, "user1", 0) AM_BASE((UINT32 **)&main_rom)
ADDRESS_MAP_END
...
/* ! */	AM_RANGE(0x680800, 0x68083f) AM_RAM_WRITE(SMH_NOP) /* Serial DUART Channel A/B & Top LED sign - To Do! */
	...
	AM_RANGE(0x800000, 0xbfffff) AM_ROM AM_REGION(RGNCLASS_USER, "user1", 0) AM_BASE((UINT32 **)&main_rom)
ADDRESS_MAP_END
...
ROM_START( timekill )
	...
	ROM_REGION16_BE( 0x400000, RGNCLASS_SOUND, "ensoniq.2", ROMREGION_ERASE00 )
...
ROM_START( bloodstm )
	...
	ROM_REGION16_BE( 0x400000, RGNCLASS_SOUND, "ensoniq.0", ROMREGION_ERASE00 )
...
ROM_START( wcbowldx )	/* Deluxe version 2.00 (PCB P/N 1082 Rev 2), This version is derived from the Tournament version, but tournament features have be removed/disabled */
	ROM_REGION32_BE( CODE_SIZE, RGNCLASS_USER, "user1", 0 )
	...
	ROM_REGION16_BE( 0x400000, RGNCLASS_SOUND, "ensoniq.1", ROMREGION_ERASE00 )
...
ROM_START( drivedge )
	ROM_REGION32_BE( 0x8000, RGNCLASS_USER, "user1", 0 )
...
ROM_START( sftm )	/* Version 1.12 */
	...
	ROM_REGION16_BE( 0x400000, RGNCLASS_SOUND, "ensoniq.3", ROMREGION_ERASE00 )
...
ROM_START( gt3d )	/* Version 1.93N for the single large type PCB P/N 1082 Rev 2 */
	...
	ROM_REGION( 0x600000, RGNCLASS_GFX, "gfx1", 0 )
