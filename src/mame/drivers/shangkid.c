...
static DRIVER_INIT( shangkid )
{
	...
	/* set up banking */
	memory_configure_bank(1, 0, 2, memory_region(machine, RGNCLASS_CPU, "main") + 0x8000, 0x8000);
	memory_configure_bank(2, 0, 2, memory_region(machine, RGNCLASS_CPU, "audio") + 0x0000, 0x10000);
}
...
ROM_START( chinhero )
	ROM_REGION( 0x10000, RGNCLASS_CPU, "main", 0 ) /* Z80 code (main) */
	...
	ROM_REGION( 0x10000, RGNCLASS_CPU, "bbx", 0 ) /* Z80 code (coprocessor) */
	...
	ROM_REGION( 0x4000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE|ROMREGION_INVERT ) /* tiles */
	...
	ROM_REGION( 0x6000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE|ROMREGION_INVERT ) /* sprites */
	...
	ROM_REGION( 0x6000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE|ROMREGION_INVERT ) /* sprites */
	...
	ROM_REGION( 0xa80, RGNCLASS_PROMS, "proms", 0 )
...
ROM_START( shangkid )
	...
	ROM_REGION( 0x12000, RGNCLASS_CPU, "main", 0 ) /* Z80 (NEC D780C-1) code */
    ...
    */
	ROM_REGION( 0x10000, RGNCLASS_CPU, "bbx", 0 ) /* Z80: bbx module */
	...
	ROM_REGION( 0x1e000, RGNCLASS_CPU, "audio", 0 ) /* Z80 (NEC D780C-1) */
	...
	ROM_REGION( 0x4000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE|ROMREGION_INVERT ) /* 8x8 tiles */
	...
	ROM_REGION( 0x18000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE|ROMREGION_INVERT ) /* 16x16 sprites */
...
ROM_START( dynamski )
	ROM_REGION( 0x12000, RGNCLASS_CPU, "main", 0 ) /* Z80 code */
	...
	ROM_REGION( 0x6000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE|ROMREGION_INVERT ) /* 16x16 sprites */
