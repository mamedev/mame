...
static ADDRESS_MAP_START( zr107_map, ADDRESS_SPACE_PROGRAM, 32 )
	...
	AM_RANGE(0x7fe00000, 0x7fffffff) AM_ROM AM_REGION(RGNCLASS_USER, "user1", 0) AM_SHARE(2)	/* Program ROM */
ADDRESS_MAP_END
...
static ADDRESS_MAP_START( jetwave_map, ADDRESS_SPACE_PROGRAM, 32 )
	...
	AM_RANGE(0x7f000000, 0x7f3fffff) AM_MIRROR(0x80000000) AM_ROM AM_REGION(RGNCLASS_USER, "user2", 0)
	AM_RANGE(0x7f800000, 0x7f9fffff) AM_MIRROR(0x80000000) AM_ROM AM_SHARE(2)
	AM_RANGE(0x7fe00000, 0x7fffffff) AM_MIRROR(0x80000000) AM_ROM AM_REGION(RGNCLASS_USER, "user1", 0) AM_SHARE(2)	/* Program ROM */
ADDRESS_MAP_END
...
static void init_zr107(running_machine *machine)
{
	...
	K001005_preprocess_texture_data(memory_region(machine, RGNCLASS_GFX, "gfx1"), memory_region_length(machine, RGNCLASS_GFX, "gfx1"), 0);
...
ROM_START(midnrun)
	...
	ROM_REGION(0x100000, RGNCLASS_GFX, "gfx2", 0)	/* Tilemap */
	...
	ROM_REGION(0x800000, RGNCLASS_GFX, "gfx1", 0)	/* Texture data */
	...
	ROM_REGION(0x600000, RGNCLASS_SOUND, "shared", 0)	/* Sound data */
...
ROM_START(jetwave)
	...
	ROM_REGION32_BE(0x400000, RGNCLASS_USER, "user2", 0)	/* data roms */
