...
static MACHINE_CONFIG_START( by133, by133_state )
	...
	MCFG_PIA6821_READPB_HANDLER(READ8(by133_state, by133_portb_r))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(by133_state, by133_portb_w))
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(by133_state, by133_cb2))
	MCFG_PIA6821_IRQA_HANDLER(WRITELINE(by133_state, by133_firq))
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(by133_state, by133_firq))
