...
ROM_START( fromanc2 )
	...
	ROM_REGION( 0x0480000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE )	// LAYER3 DATA
...
ROM_START( fromancr )
	...
	ROM_REGION( 0x0800000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )	// BG DATA
	...
	ROM_REGION( 0x2400000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE )	// FG DATA
	...
	ROM_REGION( 0x0200000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE )	// TEXT DATA
...
ROM_START( fromanc4 )
	ROM_REGION( 0x0800000, RGNCLASS_CPU, "main", 0 )	// MAIN CPU + DATA
	...
	ROM_REGION( 0x0020000, RGNCLASS_CPU, "audio", 0 )	// SOUND CPU
	ROM_LOAD( "ic79.bin", 0x0000000, 0x020000, CRC(c9587c09) SHA1(e04ee8c3f8519c2b2d3c2bdade1e142974b7fcb1) )

	ROM_REGION( 0x1000000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )	// BG DATA
	...
	ROM_REGION( 0x3000000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE )	// FG DATA
	...
	ROM_REGION( 0x0400000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE )	// TEXT DATA
	ROM_LOAD16_WORD_SWAP( "em33-a00.37", 0x0000000, 0x400000, CRC(a3bd4a34) SHA1(78bd5298e83f89c738c18105c8bc809fa6a35206) )

	ROM_REGION( 0x0800000, RGNCLASS_SOUND, "ym", 0 )	// SOUND DATA
