...
ROM_START( fromanc2 )
	...
	ROM_REGION( 0x0480000, "gfx1", ROMREGION_DISPOSE )	// LAYER4 DATA
	...
	ROM_REGION( 0x0480000, "gfx2", ROMREGION_DISPOSE )	// LAYER3 DATA
	...
	ROM_REGION( 0x0200000, "gfx3", ROMREGION_DISPOSE )	// LAYER2 DATA
	ROM_LOAD( "36-48.bin",   0x000000, 0x200000, CRC(c8ee7f40) SHA1(3f043e4d93dd20f0bfb56b6345d8d60c884547db) )

	ROM_REGION( 0x0100000, "gfx4", ROMREGION_DISPOSE )	// LAYER1 DATA
...
ROM_START( fromancr )
	...
	ROM_REGION( 0x0800000, "gfx1", ROMREGION_DISPOSE )	// BG DATA
	...
	ROM_REGION( 0x2400000, "gfx2", ROMREGION_DISPOSE )	// FG DATA
	...
	ROM_REGION( 0x0200000, "gfx3", ROMREGION_DISPOSE )	// TEXT DATA
...
ROM_START( fromanc4 )
	...
	ROM_REGION( 0x3000000, "gfx2", ROMREGION_DISPOSE )	// FG DATA
	...
	ROM_REGION( 0x0400000, "gfx3", ROMREGION_DISPOSE )	// TEXT DATA
