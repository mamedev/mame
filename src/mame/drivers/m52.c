...
ROM_START( mpatrol )
	...
	ROM_REGION( 0x8000, RGNCLASS_CPU, "iremsound", 0 )
	...
	ROM_REGION( 0x1000, RGNCLASS_GFX, "gfx5", ROMREGION_DISPOSE )
...
ROM_START( alpha1v )
	...
	ROM_REGION( 0x3000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE ) // 3bpp? (mpatrol is 2bpp..)
