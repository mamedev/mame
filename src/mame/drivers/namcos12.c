...
static void namcos12_rom_read( UINT32 n_address, INT32 n_size )
{
	...
	p_n_src = (UINT32 *)( memory_region( Machine, RGNCLASS_USER, n_region ) + n_offset );
	n_romleft = ( memory_region_length( Machine, RGNCLASS_USER, n_region ) - n_offset ) / 4;
	if( n_size > n_romleft )
	{
...
{
	memory_set_bankptr( 2, memory_region( machine, RGNCLASS_USER, "user1" ) + 0x20280 );
}
...
static DRIVER_INIT( namcos12 )
{
	...
	memory_configure_bank( 1, 0, memory_region_length( machine, RGNCLASS_USER, "user2" ) / 0x200000, memory_region( machine, RGNCLASS_USER, "user2" ), 0x200000 );
	m_n_bankoffset = 0;
	memory_set_bank( 1, 0 );
...
static DRIVER_INIT( ptblank2 )
{
	...
	*( (UINT32 *)( memory_region( machine, RGNCLASS_USER, "user1" ) + 0x331c4 ) ) = 0;
...
ROM_START( aquarush )
	ROM_REGION32_LE( 0x00400000, RGNCLASS_USER, "user1", 0 ) /* main prg */
	...
	ROM_REGION32_LE( 0x1000000, RGNCLASS_USER, "user2", 0 ) /* main data */
...
ROM_START( ehrgeiz )
	...
	ROM_REGION32_LE( 0x1c00000, RGNCLASS_USER, "user2", 0 ) /* main data */
...
ROM_START( fgtlayer )
	...
	ROM_REGION32_LE( 0x2000000, RGNCLASS_USER, "user2", 0 ) /* main data */
	...
	ROM_REGION( 0x1000000, RGNCLASS_SOUND, "c352", 0 ) /* samples */
...
ROM_START( golgo13 )
	...
	ROM_REGION32_LE( 0x3c00000, RGNCLASS_USER, "user2", 0 ) /* main data */
...
ROM_START( ghlpanic )
	...
	ROM_REGION32_LE( 0x00800000, RGNCLASS_USER, "user2", 0 ) /* main data */
...
ROM_START( kaiunqz )
	...
	ROM_REGION32_LE( 0x3000000, RGNCLASS_USER, "user2", 0 ) /* main data */
...
ROM_START( mrdrillr )
	...
	ROM_REGION32_LE( 0x0800000, RGNCLASS_USER, "user2", 0 ) /* main data */
...
ROM_START( pacapp )
	...
	ROM_REGION32_LE( 0x1800000, RGNCLASS_USER, "user2", 0 ) /* main data */
...
ROM_START( sws2001 )
	...
	ROM_REGION32_LE( 0x2800000, RGNCLASS_USER, "user2", 0 ) /* main data */
        ROM_LOAD( "ss01rom0.9",   0x0000000, 0x800000, CRC(c08cc59c) SHA1(f2d8064491c98acbb40260d7f13d0f9b394c1383) )
        ROM_LOAD( "ss01rom1.10",  0x0800000, 0x800000, CRC(d4aa1dc6) SHA1(68fcb60aadf35668d7d746da1e29d5d985e40aec) )
        ROM_LOAD( "ss01rom2.11",  0x1000000, 0x800000, CRC(3371904a) SHA1(58bbf98a44560bc021bac4bc513fe89deea85b50) )
...
ROM_START( tektagt )
	...
	ROM_REGION32_LE( 0x3800000, RGNCLASS_USER, "user2", 0 ) /* main data */
