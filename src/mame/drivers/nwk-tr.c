...
ROM_START(racingj)
	...
	ROM_LOAD( "m48t58y-70pc1(__racingj)", 0x000000, 0x002000, CRC(47e1628c) SHA1(7c42d06ae2f2cd24d083890f333552cbf4f1d3c9) )
ROM_END
...
ROM_START(racingj2j)
	...
	ROM_REGION(0x2000, "m48t58",0)
	ROM_LOAD( "m48t58y-70pc1(__racingj2j)", 0x000000, 0x002000, CRC(f691f5ab) SHA1(e81f652c5caa2caa8bd1c6d6db488d849bda058e) )
ROM_END
...
ROM_START(racingj2)
	...
	ROM_REGION(0x2000, "m48t58",0)
	ROM_LOAD( "m48t58y-70pc1(__racingj2).35d", 0x000000, 0x002000, CRC(1aa43a1f) SHA1(814b691b8a358bf1545a13d595d17070e612e9a4) )
ROM_END
...
ROM_START(thrilld)
	...
	ROM_REGION(0x2000, "m48t58",0)
	ROM_LOAD( "m48t58y-70pc1(__thrilld)", 0x000000, 0x002000, CRC(5d8fbcb2) SHA1(74ad91544d2a200cf599a565005476623075e7d6) )
ROM_END
...
ROM_START(thrilldb)
	...
	ROM_REGION(0x2000, "m48t58",0)
	ROM_LOAD( "m48t58y-70pc1(__thrilldb)", 0x000000, 0x002000, CRC(5d8fbcb2) SHA1(74ad91544d2a200cf599a565005476623075e7d6) )
ROM_END
...
ROM_START(thrilldae)
	...
	ROM_REGION(0x2000, "m48t58",0)
	ROM_LOAD( "m48t58y-70pc1(__thrilldae)", 0x000000, 0x002000, CRC(056ea8fa) SHA1(23574e0c1d011dab8644f3d98763d4a2d11a05b3)  )
ROM_END
