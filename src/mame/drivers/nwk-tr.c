...
ROM_START(racingj)
	ROM_REGION32_BE(0x200000, RGNCLASS_USER, "user1", 0)	/* PowerPC program roms */
	...
	ROM_REGION32_BE(0x800000, RGNCLASS_USER, "user5", 0)	/* CG Board texture roms */
	...
	ROM_REGION(0x80000, RGNCLASS_CPU, "audio", 0)		/* 68k program roms */
        ROM_LOAD16_WORD_SWAP( "676gna08.7s", 0x000000, 0x080000, CRC(8973f6f2) SHA1(f5648a7e0205f7e979ccacbb52936809ce14a184) )

	ROM_REGION(0x1000000, RGNCLASS_SOUND, "rf", 0) 		/* other roms (textures?) */
