...
ROM_START( topgunnr )
	ROM_REGION( 0xf00000, RGNCLASS_CPU, "main", 0 )
	...
	ROM_COPY( RGNCLASS_CPU, "main", 0x000000, 0x800000,0x004000)
	...
	ROM_REGION16_BE( 0x10000, RGNCLASS_USER, "user1", 0 )
	...
	ROM_REGION64_BE( 0x1000, RGNCLASS_PROMS, "proms", 0 )
	...
	ROM_REGION( 0x800, RGNCLASS_CPU, "cpu2", 0 )
