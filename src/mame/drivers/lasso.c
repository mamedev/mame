...
static ADDRESS_MAP_START( lasso_audio_map, ADDRESS_SPACE_PROGRAM, 8 )
	...
	AM_RANGE(0xf000, 0xffff) AM_ROM AM_REGION(RGNCLASS_CPU, "audio", 0x7000)
ADDRESS_MAP_END
...
static ADDRESS_MAP_START( chameleo_main_map, ADDRESS_SPACE_PROGRAM, 8 )
	...
	AM_RANGE(0xe000, 0xffff) AM_ROM AM_REGION(RGNCLASS_CPU, "main", 0xa000)
ADDRESS_MAP_END
...
static ADDRESS_MAP_START( wwjgtin_main_map, ADDRESS_SPACE_PROGRAM, 8 )
	...
	AM_RANGE(0x4000, 0xbfff) AM_ROM
	AM_RANGE(0xc000, 0xffff) AM_ROM AM_REGION(RGNCLASS_CPU, "main", 0x8000)
ADDRESS_MAP_END
...
ROM_START( lasso )
	...
	ROM_REGION( 0x10000, RGNCLASS_CPU, "blitter", 0 )
...
ROM_START( chameleo )
	...
	ROM_REGION( 0x40, RGNCLASS_PROMS, "proms", ROMREGION_DISPOSE )
...
ROM_START( wwjgtin )
	...
	ROM_REGION( 0x4000, RGNCLASS_USER, "user1", 0 )				/* tilemap */
...
ROM_START( pinbo )
	...
	ROM_REGION( 0x00300, RGNCLASS_PROMS, "proms", 0 )
