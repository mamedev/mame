...
/* 95681-2 */
/* FIXME - Current MASK ROMs don't match the ones mounted on the original pcb that uses the following:
   TS2-01M.3B, TS2-05M.3H, TS2-06M.4H, TS2-07M.5H, TS2-08M.2K, TS2-09M.3K, TS2-10M.4K
   Two of them are missing (TS2-07M.5H, TS2-09M.3K), moreover sizes of the other ones could not be correct. */
ROM_START( ts2 )
	CPZN1_BIOS
	...
	ROM_LOAD( "ts2-05",  0x0000000, 0x400000, BAD_DUMP CRC(7f4228e2) SHA1(3690a76d19d97e55bc7b05a8456328697cfd7a77) )
	ROM_LOAD( "ts2-06m", 0x0400000, 0x400000, BAD_DUMP CRC(cd7e0a27) SHA1(325b5f2e653cdea07cddc9d20d12b5ab50dca949) )
	ROM_LOAD( "ts2-08m", 0x0800000, 0x400000, BAD_DUMP CRC(b1f7f115) SHA1(3f416d2aac07aa73a99593b5a21b047da60cea6a) )
	ROM_LOAD( "ts2-10",  0x0c00000, 0x200000, BAD_DUMP CRC(ad90679a) SHA1(19dd30764f892ee7f89c78ccbccdaf4d6b0e6e09) )
	...
	ROM_LOAD16_WORD_SWAP( "ts2-01",  0x0000000, 0x400000, BAD_DUMP CRC(d7a505e0) SHA1(f1b0cdea712101f695bd326eccd753eb79a07490) )
ROM_END
...
ROM_START( sfexp )
	...
	ROM_REGION( 0x400000, "qsound", 0 ) /* Q Sound Samples */
	ROM_LOAD16_WORD_SWAP( "sfe-01m.3b", 0x0000000, 0x400000, CRC(f5afff0d) SHA1(7f9ac32ba0a3d9c6fef367e36a92d47c9ac1feb3) )	// label verification required
ROM_END
