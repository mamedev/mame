...
void s6_state::sol0_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	if (BIT(data, 4))
		m_samples->start(2, 5); // outhole
}

void s6_state::sol1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void s6_state::lamp0_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
}

void s6_state::lamp1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
}

uint8_t s6_state::dips_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void s6_state::dig0_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_strobe = data & 15;
	m_data_ok = true;
...
void s6_state::dig1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t s6_state::switch_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	char kbdrow[8];
...
void s6_state::switch_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_kbdrow = data;
}

uint8_t s6_state::sound_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_sound_data;
}
