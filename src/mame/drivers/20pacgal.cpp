...
//  map(0x08000, 0x09fff).bankr("mainbank").w(this, FUNC(_20pacgal_state::ram_48000_w));
...
void _20pacgal_state::_20pacgal_map(address_map &map)
{
	...
	map(0x48000, 0x49fff).bankr("mainbank").w(this, FUNC(_20pacgal_state::ram_48000_w));  /* this should be a mirror of 08000-09fff */
