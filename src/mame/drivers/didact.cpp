...
/*	Bits read on PIA1 A when issueing line number on PIA1 B bits 0-3 through a 74145 demultiplexer */
	...
	PORT_START("LINE3")
	PORT_BIT(0x01, IP_ACTIVE_LOW,	IPT_KEYBOARD) PORT_CODE(KEYCODE_COLON) PORT_CHAR('Ö') PORT_CHAR('ö')
	PORT_BIT(0x02, IP_ACTIVE_LOW,	IPT_UNUSED)
	...
	PORT_START("LINE4")
	PORT_BIT(0x01, IP_ACTIVE_LOW,	IPT_KEYBOARD) PORT_CODE(KEYCODE_QUOTE) PORT_CHAR('Ä') PORT_CHAR('ä')
	...
	PORT_BIT(0x40, IP_ACTIVE_LOW,	IPT_KEYBOARD) PORT_CODE(KEYCODE_OPENBRACE) PORT_CHAR('Å') PORT_CHAR('å')
