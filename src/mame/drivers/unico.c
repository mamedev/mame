...
static WRITE16_HANDLER( zeropnt_sound_bank_w )
{
	if (ACCESSING_BITS_8_15)
	{
		...
		int bank = (data >> 8 ) & 1;
		UINT8 *dst	= memory_region(machine, RGNCLASS_SOUND, "oki");
...
static WRITE32_HANDLER( zeropnt2_sound_bank_w )
{
	if (ACCESSING_BITS_24_31)
	{
		...
		UINT8 *dst	= memory_region(machine, RGNCLASS_SOUND, "oki1");
		UINT8 *src	= dst + 0x80000 + 0x20000 + 0x20000 * bank;
		memcpy(dst + 0x20000, src, 0x20000);
	}
}
...
ROM_START( burglarx )
	...
	ROM_REGION( 0x400000, RGNCLASS_GFX, "gfx1", ROMREGION_INVERT | ROMREGION_DISPOSE )	/* 16x16x8 Sprites */
	...
	ROM_REGION( 0x400000, RGNCLASS_GFX, "gfx2", ROMREGION_INVERT | ROMREGION_DISPOSE )	/* 16x16x8 Layers */
...
ROM_START( zeropnt )
	...
	ROM_REGION( 0x800000, RGNCLASS_GFX, "gfx1", ROMREGION_INVERT | ROMREGION_DISPOSE )	/* 16x16x8 Sprites */
	...
	ROM_REGION( 0x800000, RGNCLASS_GFX, "gfx2", ROMREGION_INVERT | ROMREGION_DISPOSE )	/* 16x16x8 Layers */
	...
	ROM_REGION( 0x80000 * 2, RGNCLASS_SOUND, "oki", 0 )	/* Samples */
...
ROM_START( zeropnt2 )
	...
	ROM_REGION( 0x1000000, RGNCLASS_GFX, "gfx1", ROMREGION_INVERT | ROMREGION_DISPOSE )	/* 16x16x8 Sprites */
	...
	ROM_REGION( 0x1000000, RGNCLASS_GFX, "gfx2", ROMREGION_INVERT | ROMREGION_DISPOSE )	/* 16x16x8 Layers */
	...
	ROM_REGION( 0x80000 * 2, RGNCLASS_SOUND, "oki1", 0 )	/* Samples */
