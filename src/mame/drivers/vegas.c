...
ROM_START( gauntdl )
	ROM_REGION32_LE( 0x80000, RGNCLASS_USER, "user1", 0 )	/* EPROM 1.7 12/14/1999 */
	ROM_LOAD( "gauntdl.bin", 0x000000, 0x80000, CRC(3d631518) SHA1(d7f5a3bc109a19c9c7a711d607ff87e11868b536) )

	DISK_REGION( RGNCLASS_DISKS, "disks" )	/* Guts: 1.9 3/17/2000 Game 5/9/2000 */
...
ROM_START( gauntd24 )
	...
	DISK_REGION( RGNCLASS_DISKS, "disks" )	/* Guts: 1.9 3/17/2000 Game 3/19/2000 */
...
ROM_START( warfa )
	ROM_REGION32_LE( 0x80000, RGNCLASS_USER, "user1", 0 )	/* EPROM 1.9 3/25/1999 */
	ROM_LOAD( "warboot.v19", 0x000000, 0x80000, CRC(b0c095cd) SHA1(d3b8cccdca83f0ecb49aa7993864cfdaa4e5c6f0) )

	DISK_REGION( RGNCLASS_DISKS, "disks" )	/* Guts 1.3 4/20/1999 Game 4/20/1999 */
...
ROM_START( tenthdeg )
	...
	DISK_REGION( RGNCLASS_DISKS, "disks" )	/* Guts 5/26/1998 Main 8/25/1998 */
...
ROM_START( roadburn )
	ROM_REGION32_LE( 0x80000, RGNCLASS_USER, "user1", 0 )	/* EPROM 2.6 4/22/1999 */
	ROM_LOAD( "rbmain.bin", 0x000000, 0x80000, CRC(060e1aa8) SHA1(2a1027d209f87249fe143500e721dfde7fb5f3bc) )

	DISK_REGION( RGNCLASS_DISKS, "disks" )	/* Guts 4/22/1999 Game 4/22/1999 */
...
ROM_START( cartfury )
	...
	ROM_REGION16_LE( 0x10000, RGNCLASS_SOUND, "dcs", 0 )	/* ADSP-2105 data */
	ROM_LOAD16_BYTE( "vegassio.bin", 0x000000, 0x8000, CRC(d1470e23) SHA1(f6e8405cfa604528c0224401bc374a6df9caccef) )
ROM_END


ROM_START( sf2049 )
	ROM_REGION32_LE( 0x80000, RGNCLASS_USER, "user1", 0 )	/* EPROM 1.02 7/9/1999 */
	ROM_LOAD( "sf2049.u27", 0x000000, 0x80000, CRC(174ba8fe) SHA1(baba83b811eca659f00514a008a86ef0ac9680ee) )

	DISK_REGION( RGNCLASS_DISKS, "disks" )	/* Guts 1.03 9/3/1999 Game 9/8/1999 */
