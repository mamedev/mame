...
ROM_START( solarfox )
	...
	ROM_REGION( 0x10000, RGNCLASS_CPU, "ssio", 0 )
...
ROM_START( dotrone )
	...
	ROM_REGION( 0x10000, RGNCLASS_CPU, "snt", 0 )
...
ROM_START( nflfoot )
	...
	ROM_REGION( 0x10000, RGNCLASS_CPU, "ipu", 0 )	/* 64k for the IPU CPU */
...
ROM_START( demoderb )
	...
	ROM_REGION( 0x10000, RGNCLASS_CPU, "ssio", ROMREGION_ERASE00 )	/* 64k for the audio CPU, not populated */

	ROM_REGION( 0x10000, RGNCLASS_CPU, "tcs", 0 )	/* 64k for the Turbo Cheap Squeak */
