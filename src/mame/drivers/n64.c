...
static INPUT_PORTS_START( n64 )
	...
	PORT_BIT( 0x0020, IP_ACTIVE_HIGH, IPT_SHOULDER_BUTTON_L1 )        PORT_PLAYER(1) PORT_NAME("P1 Button L")
	PORT_BIT( 0x0010, IP_ACTIVE_HIGH, IPT_SHOULDER_BUTTON_R1 )        PORT_PLAYER(1) PORT_NAME("P1 Button R")
	PORT_BIT( 0x0008, IP_ACTIVE_HIGH, IPT_HAT_UP )        PORT_PLAYER(1) PORT_NAME("P1 Button C \xE2\x86\x91") /* Up */
	PORT_BIT( 0x0004, IP_ACTIVE_HIGH, IPT_HAT_DOWN )        PORT_PLAYER(1) PORT_NAME("P1 Button C \xE2\x86\x93") /* Down */
	PORT_BIT( 0x0002, IP_ACTIVE_HIGH, IPT_HAT_LEFT )        PORT_PLAYER(1) PORT_NAME("P1 Button C \xE2\x86\x90") /* Left */
	PORT_BIT( 0x0001, IP_ACTIVE_HIGH, IPT_HAT_RIGHT )        PORT_PLAYER(1) PORT_NAME("P1 Button C \xE2\x86\x92") /* Right */
	...
	PORT_BIT( 0x00c0, IP_ACTIVE_HIGH, IPT_UNUSED )
	PORT_BIT( 0x0020, IP_ACTIVE_HIGH, IPT_SHOULDER_BUTTON_L1 )        PORT_PLAYER(2) PORT_NAME("P2 Button L")
	PORT_BIT( 0x0010, IP_ACTIVE_HIGH, IPT_SHOULDER_BUTTON_R1 )        PORT_PLAYER(2) PORT_NAME("P2 Button R")
