...
{
	blit_buffer = auto_alloc_array(machine, UINT8, 512*256);
	blit.addr_factor = 2;
}
...
static VIDEO_UPDATE(blitz68k)
{
	int x,y;

	UINT8 *src = blit_buffer;
...
static VIDEO_UPDATE(blitz68k_noblit)
{
	int x,y;

	UINT16 *src = frame_buffer;
...
static ADDRESS_MAP_START( maxidbl_map, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0x400000, 0x40ffff) AM_RAM AM_BASE(&frame_buffer)
...
static MACHINE_CONFIG_START( ilpag, blitz68k_state )
	...
	MDRV_VIDEO_START(blitz68k)
	MDRV_VIDEO_UPDATE(blitz68k)
...
static MACHINE_CONFIG_START( cjffruit, blitz68k_state )
	...
	MDRV_MC6845_ADD("crtc", R6545_1, XTAL_22_1184MHz/8, mc6845_intf_irq1)
...
static MACHINE_CONFIG_START( bankrob, driver_device )
	MDRV_CPU_ADD("maincpu", M68000, XTAL_11_0592MHz)
	MDRV_CPU_PROGRAM_MAP(bankrob_map)
	MDRV_CPU_VBLANK_INT("screen", irq3_line_hold)	// protection prevents correct irq frequency by crtc
...
//	MDRV_NVRAM_ADD_0FILL("nvram")
	...
	MDRV_SCREEN_FORMAT(BITMAP_FORMAT_RGB32)
	MDRV_SCREEN_SIZE(512, 256)
	MDRV_SCREEN_VISIBLE_AREA(0, 512-1, 0+4, 256-1-4)
	MDRV_MC6845_ADD("crtc", H46505, XTAL_11_0592MHz/4, mc6845_intf_irq3)
...
static MACHINE_CONFIG_START( bankroba, driver_device )
	MDRV_CPU_ADD("maincpu", M68000, XTAL_11_0592MHz )
	MDRV_CPU_PROGRAM_MAP(bankroba_map)
	MDRV_CPU_VBLANK_INT("screen", irq5_line_hold)	// protection prevents correct irq frequency by crtc
...
//	MDRV_NVRAM_ADD_0FILL("nvram")
	...
	MDRV_SCREEN_FORMAT(BITMAP_FORMAT_RGB32)
	MDRV_SCREEN_SIZE(512, 256)
	MDRV_SCREEN_VISIBLE_AREA(0, 512-1, 0+7, 256-1)
	MDRV_MC6845_ADD("crtc", H46505, XTAL_11_0592MHz/4, mc6845_intf_irq5)

	MDRV_PALETTE_LENGTH(0x100)

	MDRV_VIDEO_START(blitz68k_addr_factor1)
	MDRV_VIDEO_UPDATE(blitz68k)
...
static MACHINE_CONFIG_START( deucesw2, driver_device )
	MDRV_CPU_ADD("maincpu", M68000, XTAL_22_1184MHz / 2)
	MDRV_CPU_PROGRAM_MAP(deucesw2_map)
	// irq 2 reads from MCUs
...
//	MDRV_NVRAM_ADD_0FILL("nvram")
	...
	MDRV_SCREEN_SIZE(512, 256)
	MDRV_SCREEN_VISIBLE_AREA(0, 512-1, 0, 256-1)
	MDRV_MC6845_ADD("crtc", R6545_1, XTAL_22_1184MHz/8, mc6845_intf_irq3)
...
static MACHINE_CONFIG_START( dualgame, driver_device )
	MDRV_CPU_ADD("maincpu", M68000, XTAL_11_0592MHz )
	MDRV_CPU_PROGRAM_MAP(dualgame_map)
	MDRV_CPU_VBLANK_INT("screen", irq2_line_hold) // lev 2 = MCUs, lev 3 = vblank
...
static MACHINE_CONFIG_START( hermit, driver_device )
	MDRV_CPU_ADD("maincpu", M68000, XTAL_22_1184MHz/2 )
	MDRV_CPU_PROGRAM_MAP(hermit_map)
	MDRV_CPU_VBLANK_INT("screen", irq1_line_hold)	// protection prevents correct irq frequency by crtc
...
//	MDRV_NVRAM_ADD_0FILL("nvram")
	...
	MDRV_SCREEN_SIZE(512, 256)
	MDRV_SCREEN_VISIBLE_AREA(0, 512-1, 0+4, 256-1-4)
	MDRV_MC6845_ADD("crtc", H46505, XTAL_22_1184MHz/8, mc6845_intf_irq1)
...
static MACHINE_CONFIG_START( maxidbl, driver_device )
	MDRV_CPU_ADD("maincpu", M68000, XTAL_11_0592MHz)
	MDRV_CPU_PROGRAM_MAP(maxidbl_map)
	MDRV_CPU_VBLANK_INT("screen", irq3_line_hold)	// protection prevents correct irq frequency by crtc
	// irq 2 reads from MCUs
...
//	MDRV_NVRAM_ADD_0FILL("nvram")
	...
	MDRV_VIDEO_UPDATE(blitz68k_noblit)

	MDRV_SPEAKER_STANDARD_MONO("mono")
	MDRV_SOUND_ADD("saa", SAA1099, XTAL_8MHz/2)
