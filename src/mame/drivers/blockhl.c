...
ROM_START( blockhl )
	ROM_REGION( 0x18800, RGNCLASS_CPU, "main", 0 ) /* code + banked roms + space for banked RAM */
	...
	ROM_REGION( 0x20000, RGNCLASS_GFX, "gfx2", 0 ) /* graphics (addressable by the main CPU) */
	...
	ROM_REGION( 0x0100, RGNCLASS_PROMS, "proms", 0 )	/* PROMs */
