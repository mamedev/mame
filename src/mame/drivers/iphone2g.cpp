...
void iphone2g_spi_device::device_timer(emu_timer const &timer, device_timer_id id, int param, void *ptr)
{
	m_out_irq_func(1);
}
...
void iphone2g_timer_device::device_timer(emu_timer const &timer, device_timer_id id, int param, void *ptr)
{
	m_out_irq_func(1);
}
