...
void hng64_state::set_irq(uint32_t irq_vector)
{
	/*
		...
		SamSho code is more complex, irqs point to functions that get a jump address from a fixed ram location for each IRQ, most are invalid tho?
		80000400: 800C03E0 irq00 80005dd0 (800cfcc8) 
		80000404: 800C041C irq01 80005dd4 (800c0000)
		80000408: 800C0458 irq02 80005dd8 (800c0000)
		8000040C: 800C0494 irq03 80005ddc (800cfd58)
		80000410: 800C04D0 irq04 80005de0 (800cfdf8) - interesting because this level is invalid on other games
