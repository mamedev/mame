...
{
	audiobuffer_region = memory_region(machine, RGNCLASS_USER, "user1");
}
...
static ADDRESS_MAP_START( gottlieb_map, ADDRESS_SPACE_PROGRAM, 8 )
	...
	AM_RANGE(0x1000, 0x1fff) AM_RAM AM_REGION(RGNCLASS_CPU, "main", 0x1000)	/* or ROM */
	AM_RANGE(0x2000, 0x2fff) AM_RAM AM_REGION(RGNCLASS_CPU, "main", 0x2000) 	/* or ROM */
...
static GFXDECODE_START( gfxdecode )
	...
	GFXDECODE_ENTRY( "gfx1", 0x0000, bg_rom_layout, 0, 1 )
	GFXDECODE_ENTRY( "gfx2", 0x0000, fg_layout,     0, 1 )
GFXDECODE_END
...
static MACHINE_DRIVER_START( gottlieb_core )
	...
	MDRV_CPU_ADD("main", I8088, CPU_CLOCK/3)
...
ROM_START( screwloo )
	...
	ROM_REGION( 0x10000, RGNCLASS_CPU, "audio2", 0 )
...
ROM_START( mach3 )
	...
	ROM_REGION( 1024*1024, RGNCLASS_USER, "user1", 0)	/* about 30 min of target data from laserdisc */
...
ROM_START( cobram3 )
	...
	ROM_REGION( 0x10000, RGNCLASS_CPU, "audio", ROMREGION_ERASE00 )
	ROM_REGION( 0x10000, RGNCLASS_CPU, "audio2", ROMREGION_ERASE00 )
...
ROM_START( vidvince )
	...
	ROM_REGION( 0x2000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )
	ROM_LOAD( "gv132_bg0_2732.e11e12",          0x0000, 0x1000, CRC(1521bb4a) SHA1(a3a1209c74f1ca18f0be2d2c7b1fa2af625dfa5f) )	/* chars */
...
static DRIVER_INIT( laserdsc )
{
	...
	memory_install_read8_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x05805, 0x05807, 0, 0x007f8, gottlieb_laserdisc_status_r);
