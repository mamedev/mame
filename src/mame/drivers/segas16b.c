...
{
	int size = memory_region_length(machine, RGNCLASS_CPU, "sound") - 0x10000;
	if (size > 0)
	{
		int bankoffs = 0;
		...
		memory_set_bankptr(1, memory_region(machine, RGNCLASS_CPU, "sound") + 0x10000 + (bankoffs % size));
	}
}
...
ROM_START( aceattac )
	...
	ROM_REGION16_BE( 0x040000, RGNCLASS_USER, "user2", ROMREGION_ERASE00 ) /* working overlay */
...
ROM_START( altbeast )
	...
	ROM_REGION( 0x60000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) /* tiles */
...
ROM_START( altbeas4 )
	...
	ROM_REGION( 0x2000, RGNCLASS_USER, "user2", 0 ) /* MC8123 key */
...
ROM_START( bullet )
	...
	ROM_REGION( 0x2000, RGNCLASS_USER, "user1", 0 ) /* decryption key -- still WIP */
...
ROM_START( eswat )
	...
	ROM_REGION16_BE( 0x1c0000, RGNCLASS_GFX, "gfx2", 0 ) /* sprites */
	...
	ROM_REGION( 0x90000, RGNCLASS_CPU, "sound", 0 ) /* sound CPU */
...
ROM_START( fpoint )
	...
	ROM_REGION16_BE( 0x20000, RGNCLASS_GFX, "gfx2", 0 ) /* sprites */
...
ROM_START( passsht )
	...
	ROM_REGION16_BE( 0x60000, RGNCLASS_GFX, "gfx2", 0 ) /* sprites */
...
*/
ROM_START( suprleag )
	ROM_REGION( 0x060000, RGNCLASS_CPU, "main", 0 ) /* 68000 code */
...
ROM_START( tetris2 )
	...
	ROM_REGION16_BE( 0x020000, RGNCLASS_GFX, "gfx2", 0 ) /* sprites */
...
ROM_START( wrestwar )
	...
	ROM_REGION16_BE( 0x180000, RGNCLASS_GFX, "gfx2", 0 ) /* sprites */
