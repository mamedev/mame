...
ROM_START( pr_batls )
	...
	ROM_LOAD( "080snd2.bin", 0x0000, 0x020000, CRC(9189793b) SHA1(b47a3c214eb01595581f1e9d18c154560ee02ca1) )
...
ROM_START( pr_bigdp )
	...
	ROM_LOAD( "962snd1.050", 0x0000, 0x020000, CRC(618003a0) SHA1(01d5ab57dbe481729ef5dccca53c458eadaf042e) )
	ROM_LOAD( "962snd2.050", 0x0000, 0x020000, CRC(510dd26d) SHA1(02f1c9b10d08da838120457cac02f552e162c056) )
...
ROM_START( pr_flshc )
	ROM_REGION( 0x80000, "maincpu", 0 )
	ROM_LOAD( "163a25pn.930", 0x0000, 0x010000, CRC(36c6f14c) SHA1(7608bc179a5505f73782eb87a389bff691f56ad4) )
	ROM_LOAD( "163snd1", 0x0000, 0x020000, CRC(b80f6395) SHA1(48ea3714fb456df8cf20afe29363a4d4c2108079) )
	ROM_LOAD( "163snd2", 0x0000, 0x020000, CRC(c8486cd2) SHA1(39f90e2fb5fcd84d6455d65fbc305432e55c0e5b) )
...
ROM_START( pr_ftwhl )
	...
	ROM_LOAD( "943snd1.000", 0x0000, 0x020000, CRC(6b4223a7) SHA1(7af5779ef0309fef40b930f522e962708bd25930) )
	ROM_LOAD( "943snd2.000", 0x0000, 0x020000, CRC(4e4488a7) SHA1(d29e02d430b0afffea39b6c23afc292551151001) )
...
ROM_START( pr_funrn )
	...
	ROM_LOAD( "012snd1.000", 0x0000, 0x020000, CRC(d7424290) SHA1(5eb908a8903405868064fc9f898260a1a7db3e0f) )
	ROM_LOAD( "012snd2.000", 0x0000, 0x020000, CRC(5f9355f2) SHA1(75d8452106b17ad9c4bce75b07246e10f6e06f55) )
...
ROM_START( pr_gogld )
	...
	ROM_LOAD( "079snd1.000", 0x0000, 0x020000, CRC(d4b07715) SHA1(65b04cbc797a6878eb807d8e602724d6824dbaa7) )
	ROM_LOAD( "079snd2.000", 0x0000, 0x020000, CRC(a4c73a67) SHA1(961ae3b24a5201abf4e427c753eb23dcea13780f) )
...
ROM_START( pr_happy )
	...
	ROM_LOAD( "058snd1.000", 0x0000, 0x020000, CRC(87d78979) SHA1(1aa0d8dc6b8defa34fca09765128aeb993337859) )
	ROM_LOAD( "058snd2.000", 0x0000, 0x020000, CRC(f8ef3014) SHA1(d1d49b39054721615f2f9ebc1cfb4318ce31440c) )
ROM_END

ROM_START( pr_heato )
	ROM_REGION( 0x80000, "maincpu", 0 )
	ROM_LOAD( "032a20pn.500", 0x0000, 0x010000, CRC(87e1d114) SHA1(0f863d9c21be2907b70f6490f8272a75e92c4a44) )
	ROM_LOAD( "032snd1.000", 0x0000, 0x020000, CRC(2424dadf) SHA1(f98e6972c63c8211948810312c6fba94e7fc64af) )
	ROM_LOAD( "032snd2.000", 0x0000, 0x020000, CRC(f91e13c5) SHA1(595b1807d4d33f7fa40bb0021848275f014d6ddc) )
...
ROM_START( pr_hotcs )
	...
	ROM_LOAD( "hotcash2.bin", 0x0000, 0x008000, CRC(ee7c082c) SHA1(2f75e20755b24e5e86bfc4d5bf2b064149224d28) )
...
ROM_START( pr_rags )
	...
	ROM_LOAD( "937snd1.000", 0x0000, 0x020000, CRC(7dce6c5b) SHA1(2c52296a0fec3275dfa9b86014a23d7427f78fb8) )
	ROM_LOAD( "937snd2.000", 0x0000, 0x020000, CRC(17019d23) SHA1(a8b307a550ff0cd49cc7a04fc834c6b259cc56da) )
ROM_END
...
ROM_START( pr_roll )
	...
	ROM_LOAD( "rollsnd1.bin", 0x0000, 0x020000, CRC(53dea2e5) SHA1(cbc275f4cd6f415b090298772188bca4ba4c2b32) )
	ROM_LOAD( "rollsnd2.bin", 0x0000, 0x020000, CRC(f6722f64) SHA1(df40547deb7bb307724345db8d4dbe14e33f5dad) )
ROM_END
...
ROM_START( pr_sevml )
	...
	ROM_LOAD( "sevenmelonsprocon5p(27256)", 0x0000, 0x008000, CRC(ebee9be6) SHA1(efd713852213a8dcf2bc302195acffee3f60da10) )
