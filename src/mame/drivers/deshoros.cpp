...
public:
	...
	uint8_t printer_status_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t display_ready_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
...
void destiny_state::firq_ack_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_maincpu->set_input_line(M6809_FIRQ_LINE, CLEAR_LINE);
}

void destiny_state::nmi_ack_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_maincpu->set_input_line(INPUT_LINE_NMI, CLEAR_LINE);
}

uint8_t destiny_state::printer_status_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	// d2: mark sensor
	// d3: motor stop
	// d4: status
...
uint8_t destiny_state::display_ready_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	// d7: /display ready
	// other bits: N/C
	return 0;
...
void destiny_state::display_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void destiny_state::out_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	// d0: coin blocker
...
void destiny_state::bank_select_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void destiny_state::sound_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	// a0: sound on/off
