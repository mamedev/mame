...
ROM_START( spclords )
	...
	ROM_REGION( 0x100000, RGNCLASS_SOUND, "adpcml", 0 )	/* 1MB for ADPCM samples */
	ROM_LOAD( "136095.81a",  0x80000, 0x80000, CRC(212560dd) SHA1(9d90bca5b478050d640b2393c9d3d59a4bd493dd) )

	ROM_REGION( 0x100000, RGNCLASS_SOUND, "adpcmr", 0 )	/* 1MB for ADPCM samples */
	ROM_LOAD( "136095.81a",  0x80000, 0x80000, CRC(212560dd) SHA1(9d90bca5b478050d640b2393c9d3d59a4bd493dd) )
ROM_END
...
ROM_START( motofren )
	...
	ROM_REGION16_BE( 0x700000, RGNCLASS_GFX, "gfx3", 0 )
...
ROM_START( rrreveng )
	...
	ROM_REGION16_BE( 0x500000, RGNCLASS_GFX, "gfx3", 0 )
