...
{
	UINT8 *BANKROM = memory_region(machine, RGNCLASS_USER, "user1");
...
ROM_START( ojankohs )
	ROM_REGION( 0x98000, RGNCLASS_CPU, "main", 0 )
...
ROM_START( ojankoy )
	ROM_REGION( 0x70000, RGNCLASS_CPU, "main", 0 )
...
ROM_START( ccasino )
	ROM_REGION( 0x68000, RGNCLASS_CPU, "main", 0 )
