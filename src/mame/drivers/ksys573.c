...
static DRIVER_INIT( ge765pwbba )
{
	...
	memory_install_readwrite32_handler( machine->device("maincpu")->memory().space(ADDRESS_SPACE_PROGRAM), 0x1f640000, 0x1f6400ff, 0, 0, ge765pwbba_r, ge765pwbba_w );
}
...
static void gx700pwfbf_init( running_machine *machine, void (*output_callback_func)( running_machine *machine, int offset, int data ) )
{
	...
	memory_install_readwrite32_handler( machine->device("maincpu")->memory().space(ADDRESS_SPACE_PROGRAM), 0x1f640000, 0x1f6400ff, 0, 0, gx700pwbf_io_r, gx700pwbf_io_w );
...
static DRIVER_INIT( gtrfrks )
{
	...
	memory_install_readwrite32_handler( machine->device("maincpu")->memory().space(ADDRESS_SPACE_PROGRAM), 0x1f600000, 0x1f6000ff, 0, 0, gtrfrks_io_r, gtrfrks_io_w );
}
...
static void gx894pwbba_init( running_machine *machine, void (*output_callback_func)( running_machine *machine, int offset, int data ) )
{
	...
	memory_install_readwrite32_handler( machine->device("maincpu")->memory().space(ADDRESS_SPACE_PROGRAM), 0x1f640000, 0x1f6400ff, 0, 0, gx894pwbba_r, gx894pwbba_w );
...
static DRIVER_INIT( dmx )
{
	...
	memory_install_write32_handler(machine->device("maincpu")->memory().space(ADDRESS_SPACE_PROGRAM), 0x1f600000, 0x1f6000ff, 0, 0, dmx_io_w );
}
...
static DRIVER_INIT( mamboagg )
{
	...
	memory_install_write32_handler(machine->device("maincpu")->memory().space(ADDRESS_SPACE_PROGRAM), 0x1f600000, 0x1f6000ff, 0, 0, mamboagg_io_w );
}
...
{
	DRIVER_INIT_CALL(konami573);
	memory_install_readwrite32_handler( machine->device("maincpu")->memory().space(ADDRESS_SPACE_PROGRAM), 0x1f640000, 0x1f6400ff, 0, 0, gunmania_r, gunmania_w );
}
