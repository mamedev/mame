...
static const gfx_layout tiles16x16x8_layout =
{
	...
	RGN_FRAC(1,1),
	8,
//	{ 1, 33, 65, 97, 0, 32, 64, 96  }, // no
//	{ 33, 1, 97, 65, 32, 0, 96, 64  }, // no
//	{ 0, 1, 32, 33, 64, 65, 96, 97  }, // no
//	{ 1, 0, 33, 32, 65, 64, 97, 96  }, // no

//	{ 0, 1, 64, 65, 32, 33, 96, 97  }, // no
//	{ 1, 0, 65, 64, 33, 32, 97, 96  }, // no

	{ 97, 96, 65, 64, 33, 32, 1, 0  }, // no
