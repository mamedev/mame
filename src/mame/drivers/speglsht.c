...
static ADDRESS_MAP_START( speglsht_mem, ADDRESS_SPACE_PROGRAM, 32 )
	...
	AM_RANGE(0x01c00000, 0x01dfffff) AM_READ(SMH_ROM) AM_WRITE(SMH_ROM) AM_REGION(RGNCLASS_USER, "user2", 0)
	...
	AM_RANGE(0x1fc00000, 0x1fdfffff) AM_ROM AM_REGION(RGNCLASS_USER, "user1", 0)
	AM_RANGE(0x2fc00000, 0x2fdfffff) AM_ROM AM_REGION(RGNCLASS_USER, "user1", 0) // mirror for interrupts
ADDRESS_MAP_END
