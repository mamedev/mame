...
static ADDRESS_MAP_START( ppmast93_cpu1_map, ADDRESS_SPACE_PROGRAM, 8 )
	AM_RANGE(0x0000, 0x7fff) AM_READ(SMH_ROM) AM_WRITENOP AM_REGION(RGNCLASS_CPU, "main", 0x10000)
...
static ADDRESS_MAP_START( ppmast93_cpu2_map, ADDRESS_SPACE_PROGRAM, 8 )
	AM_RANGE(0x0000, 0xfbff) AM_ROM AM_REGION(RGNCLASS_CPU, "sub", 0x10000)
...
static ADDRESS_MAP_START( ppmast93_cpu2_io, ADDRESS_SPACE_IO, 8 )
	  AM_RANGE(0x0000, 0xffff) AM_READ(SMH_ROM) AM_WRITE(ppmast_sound_w) AM_REGION(RGNCLASS_CPU, "sub", 0x20000)
ADDRESS_MAP_END
...
ROM_START( ppmast93 )
	...
	ROM_REGION( 0x30000, RGNCLASS_CPU, "sub", 0 )
