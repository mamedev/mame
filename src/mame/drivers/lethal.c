...
{
	UINT8 *prgrom = (UINT8 *)memory_region(machine, RGNCLASS_CPU, "main")+0x10000;
...
{
	UINT8 *prgrom = (UINT8 *)memory_region(machine, RGNCLASS_CPU, "main");
...
ROM_START( lethalen )	// US version UAE
	...
	ROM_REGION( 0x020000, RGNCLASS_CPU, "sound", 0 )
	/* Z80 sound program */
	...
	ROM_REGION( 0x400000, RGNCLASS_GFX, "gfx1", 0 )
	/* tilemaps */
	...
	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx3", ROMREGION_ERASE00 )
	ROM_COPY(RGNCLASS_GFX, "gfx2",0,0, 0x200000)

	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx4", ROMREGION_ERASE00 )
	ROM_COPY(RGNCLASS_GFX, "gfx2",0x200000,0, 0x200000)
