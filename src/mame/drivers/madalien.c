...
static ADDRESS_MAP_START( main_map, ADDRESS_SPACE_PROGRAM, 8 )
	...
	AM_RANGE(0x8008, 0x8008) AM_MIRROR(0x07f0) AM_READWRITE(shift_r, MWA8_RAM) AM_BASE(&shift_hi)
	AM_RANGE(0x8009, 0x8009) AM_MIRROR(0x07f0) AM_READWRITE(shift_rev_r, MWA8_RAM) AM_BASE(&shift_lo)
	AM_RANGE(0x800b, 0x800b) AM_MIRROR(0x07f0) AM_WRITE(MWA8_RAM) AM_BASE(&madalien_video_flags)
	AM_RANGE(0x800c, 0x800c) AM_MIRROR(0x07f0) AM_WRITE(MWA8_RAM) AM_BASE(&madalien_headlight_pos)
	AM_RANGE(0x800d, 0x800d) AM_MIRROR(0x07f0) AM_WRITE(MWA8_RAM) AM_BASE(&madalien_edge1_pos)
	AM_RANGE(0x800e, 0x800e) AM_MIRROR(0x07f0) AM_WRITE(MWA8_RAM) AM_BASE(&madalien_edge2_pos)
	AM_RANGE(0x800f, 0x800f) AM_MIRROR(0x07f0) AM_WRITE(MWA8_RAM) AM_BASE(&madalien_scroll)
...
static MACHINE_DRIVER_START( madalien )
	...
	MDRV_CPU_VBLANK_INT("main", madalien_interrupt)
