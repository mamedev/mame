...
ROM_START( groundfx )
	ROM_REGION( 0x200000, RGNCLASS_CPU, "main", 0 )	/* 2048K for 68020 code (CPU A) */
	...
	ROM_REGION( 0x180000, RGNCLASS_CPU, "audio", 0 )
	...
	ROM_REGION( 0x1000000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE )
	...
	ROM_REGION16_LE( 0x80000, RGNCLASS_USER, "user1", 0 )
	ROM_LOAD16_WORD( "d51-13.7", 0x00000,  0x80000,  CRC(36921b8b) SHA1(2130120f78a3b984618a53054fc937cf727177b9) )	/* STY, spritemap */

	ROM_REGION16_BE( 0x1000000, RGNCLASS_SOUND, "ensoniq.0", ROMREGION_ERASE00 )
...
static DRIVER_INIT( groundfx )
{
	...
	int size=memory_region_length(machine, RGNCLASS_GFX, "gfx3");
	int data;
