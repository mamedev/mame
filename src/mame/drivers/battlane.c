...
ROM_START( battlane )
	...
	ROM_COPY( RGNCLASS_USER, "user1", 0x0000, 0x4000, 0x4000 )
	ROM_LOAD( "da01-5",     0x8000, 0x8000, CRC(7a6c3f02) SHA1(bee1ee858f81453a53afc2d016f549924801b090) )

	ROM_REGION( 0x10000, RGNCLASS_CPU, "sub", 0 )     /* 64K for slave CPU */
	/* second half of da00-5 will be copied at 0x4000-0x7fff */
	ROM_COPY( RGNCLASS_USER, "user1", 0x4000, 0x4000, 0x4000 )
