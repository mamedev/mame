...
ROM_START( dbz )
	...
	ROM_REGION( 0x400000, RGNCLASS_USER, "user1", 0)
	ROM_LOAD16_BYTE( "222a11.9e", 0x000000, 0x80000, CRC(60c7d9b2) SHA1(718ef89e89b3943845e91bedfc5c1d26229f9fe5) )
	ROM_LOAD16_BYTE( "222a12.9f", 0x000001, 0x80000, CRC(6ebc6853) SHA1(e9b2068246228968cc6b8554215563cacaa5ba9f) )
	...
	/* K053536 PSAC-2 #2 */
	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx4", 0)
...
ROM_START( dbz2 )
	...
	/* K053536 PSAC-2 #1 */
	ROM_REGION( 0x400000, RGNCLASS_GFX, "gfx3", 0)
	...
	/* K053536 PSAC-2 #2 */
	ROM_REGION( 0x400000, RGNCLASS_GFX, "gfx4", 0)
