...
ROM_START( srmp1 )
	...
	ROM_REGION( 0x020000, RGNCLASS_SOUND, "adpcm", 0 )				/* Samples */
	ROM_LOAD( "ub0-1.19", 0x000000, 0x20000, CRC(5f21b48c) SHA1(1838632609c176dbaab1d88f9368c03259a5e954) )

	ROM_REGION( 0x800, RGNCLASS_PROMS, "proms", 0 )					/* Color PROMs */
...
ROM_START( srmp2 )
	...
	ROM_REGION( 0x000800, RGNCLASS_PROMS, "proms", 0 )					/* Color PROMs */
...
ROM_START( srmp3 )
	ROM_REGION( 0x028000, RGNCLASS_CPU, "main", 0 )					/* 68000 Code */
	...
	ROM_REGION( 0x080000, RGNCLASS_SOUND, "adpcm", 0 )				/* Samples */
	ROM_LOAD( "za0-11.bin", 0x000000, 0x080000, CRC(2248c23f) SHA1(35591b51bb23dfd7fa81a05026e9ec0789bb0dde) )

	ROM_REGION( 0x000400, RGNCLASS_PROMS, "proms", 0 )					/* Color PROMs */
...
ROM_START( mjyuugi )
	...
	ROM_REGION( 0x100000, RGNCLASS_SOUND, "adpcm", 0 )				/* Samples */
