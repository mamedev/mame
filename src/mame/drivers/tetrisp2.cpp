...
//  AM_RANGE(0xac0000, 0xac0001) AM_WRITENOP // cleared at boot
	...
	AM_RANGE(0xb00000, 0xb00001) AM_DEVREAD("soundlatch", generic_latch_16_device, read) AM_DEVWRITE("soundlatch", generic_latch_16_device, write)
...
static MACHINE_CONFIG_START( vjdash )	// 4 Screens
	MCFG_CPU_ADD("maincpu", M68000, 12000000 )
