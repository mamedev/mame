...
//  discrete_sound_w(devtag_get_device(machine, "discrete"), SUPERBUG_ASR_EN, 0);
...
ROM_START( superbug )
	...
	ROM_REGION( 0x1000, "gfx2", ROMREGION_DISPOSE ) /* tiles */
	...
	ROM_REGION( 0x0400, "gfx3", ROMREGION_DISPOSE ) /* car */
...
ROM_START( montecar )
	...
	ROM_REGION( 0x0400, "gfx1", ROMREGION_DISPOSE ) /* text */
