...
static MACHINE_CONFIG_START( truco, truco_state )
	...
	MCFG_PIA6821_READPB_HANDLER(IOPORT("JMPRS"))
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(truco_state,porta_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(truco_state,portb_w))
	MCFG_PIA6821_CA2_HANDLER(WRITELINE(truco_state,pia_ca2_w))
	MCFG_PIA6821_IRQA_HANDLER(WRITELINE(truco_state,pia_irqa_w))
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(truco_state,pia_irqb_w))
