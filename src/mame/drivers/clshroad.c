...
ROM_START( firebatl )
	...
	ROM_REGION( 0x08000, "gfx2", ROMREGION_DISPOSE | ROMREGION_INVERT )	/* Layer 0 */
	...
	ROM_REGION( 0x01000, "gfx3", ROMREGION_DISPOSE )	/* Layer 1 */
...
ROM_START( clshroad )
	...
	ROM_REGION( 0x04000, "gfx3", ROMREGION_DISPOSE | ROMREGION_INVERT)	/* Layer 1 */
