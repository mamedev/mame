...
ROM_START( firebatl )
	ROM_REGION( 0x10000, RGNCLASS_CPU, "main", 0 )		/* Main Z80 Code */
	...
	ROM_REGION( 0x08000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE | ROMREGION_INVERT )	/* Sprites */
	...
	ROM_REGION( 0x08000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE | ROMREGION_INVERT )	/* Layer 0 */
	...
	ROM_REGION( 0x01000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE )	/* Layer 1 */
	ROM_LOAD( "rom15",       0x0000, 0x1000, CRC(8b5464d6) SHA1(e65acd280c0d9776cb80073241cf260b76ff0ca6) )

	ROM_REGION( 0x0a20, RGNCLASS_PROMS, "proms", 0 )
	...
	ROM_REGION( 0x2000, RGNCLASS_SOUND, "samples", 0 )	/* samples */
...
ROM_START( clshroad )
	...
	ROM_REGION( 0x04000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE | ROMREGION_INVERT)	/* Layer 1 */
	...
	ROM_REGION( 0x0b40, RGNCLASS_PROMS, "proms", 0 )
