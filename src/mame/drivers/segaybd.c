...
*/
ROM_START( gforce2 )
	ROM_REGION( 0x080000, RGNCLASS_CPU, "main", 0 ) // M
	...
	ROM_REGION( 0x040000, RGNCLASS_CPU, "subx", 0 ) // X
	...
	ROM_REGION( 0x040000, RGNCLASS_CPU, "suby", 0 ) // Y
	...
	ROM_REGION16_BE( 0x080000, RGNCLASS_GFX, "gfx2", 0 )
	...
	ROM_REGION64_BE( 0x400000, RGNCLASS_GFX, "gfx1", 0)
	...
	ROM_REGION( 0x10000, RGNCLASS_CPU, "sound", 0 )		/* Z80 sound CPU */
	ROM_LOAD( "epr-11693.bin",	0x000000, 0x10000, CRC(0497785c) SHA1(f077e71efdc96d6eb3f1a1f989650466554fb13a) ) // 11516A

	ROM_REGION( 0x200000, RGNCLASS_SOUND, "pcm", ROMREGION_ERASEFF )	/* SegaPCM samples */
...
ROM_START( gloc )
	...
	ROM_REGION16_BE( 0x200000, RGNCLASS_GFX, "gfx2", 0)
	...
	ROM_REGION64_BE( 0x1000000, RGNCLASS_GFX, "gfx1", 0 )
...
ROM_START( rchase )
	...
	ROM_REGION64_BE( 0xc00000, RGNCLASS_GFX, "gfx1", 0)
