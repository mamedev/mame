...
MACHINE_CONFIG_START(dooyong_z80_ym2203_state::sound_2203)
	...
	MCFG_YM2203_IRQ_HANDLER(DEVWRITELINE("soundirq", input_merger_any_high_device, in_w<0>))
	MCFG_AY8910_PORT_A_READ_CB(READ8(dooyong_z80_ym2203_state, unk_r))
	MCFG_SOUND_ROUTE(ALL_OUTPUTS, "mono", 0.40)

	MCFG_SOUND_ADD("ym2", YM2203, 1500000)
	MCFG_YM2203_IRQ_HANDLER(DEVWRITELINE("soundirq", input_merger_any_high_device, in_w<1>))
	MCFG_AY8910_PORT_A_READ_CB(READ8(dooyong_z80_ym2203_state, unk_r))
	MCFG_SOUND_ROUTE(ALL_OUTPUTS, "mono", 0.40)
MACHINE_CONFIG_END
