...
{
public:
	hvyunit_state(running_machine &machine, const driver_device_config_base &config)
...
GAME( 1988, hvyunito, hvyunit, hvyunit, hvyunitj, 0, ROT0, "Kaneko / Taito", "Heavy Unit (Japan, Older)", GAME_NO_COCKTAIL )
