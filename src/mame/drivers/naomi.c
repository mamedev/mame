...
static MACHINE_CONFIG_DERIVED( naomim1, naomi_base )
	MCFG_NAOMI_M1_BOARD_ADD("rom_board", "naomibd_eeprom", "maincpu", naomi_g1_irq)
MACHINE_CONFIG_END
...
static MACHINE_CONFIG_DERIVED( naomim2, naomi_base )
	MCFG_NAOMI_M2_BOARD_ADD("rom_board", "naomibd_eeprom", "maincpu", naomi_g1_irq)
MACHINE_CONFIG_END
...
static MACHINE_CONFIG_DERIVED( naomim4, naomi_base )
	MCFG_NAOMI_M4_BOARD_ADD("rom_board", "naomibd_eeprom", "maincpu", naomi_g1_irq)
MACHINE_CONFIG_END
...
// SHOOTOUT POOL (the original, the above game is a sequel)
ROM_START( shootopl )
	NAOMI_BIOS
	NAOMI_DEFAULT_EEPROM
