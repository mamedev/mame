...
static ADDRESS_MAP_START( naomi_map, ADDRESS_SPACE_PROGRAM, 64 )
	...
	AM_RANGE(0xa0000000, 0xa01fffff) AM_ROM AM_REGION(RGNCLASS_CPU, "main", 0)
ADDRESS_MAP_END
...
ROM_START( naomi )
	...
	ROM_REGION( 0x8400000, RGNCLASS_USER, "user1", ROMREGION_ERASE)
ROM_END
...
ROM_START( cspike )
	...
	ROM_REGION( 0x8000000, RGNCLASS_USER, "user2", 0)
...
ROM_START( csmash )
	...
	ROM_REGION( 0x4800000, RGNCLASS_USER, "user1", ROMREGION_ERASE00)
...
ROM_START( dybb99 )
	...
	ROM_REGION( 0x9800000, RGNCLASS_USER, "user2", 0)
	ROM_LOAD("ic1", 0x0000000, 0x0800000, NO_DUMP )
	ROM_LOAD("ic2", 0x0800000, 0x0800000, NO_DUMP )
	ROM_LOAD("ic3", 0x1000000, 0x0800000, NO_DUMP )
	ROM_LOAD("ic4", 0x1800000, 0x0800000, NO_DUMP )
...
ROM_START( gram2000 )
	...
	ROM_REGION( 0xa800000, RGNCLASS_USER, "user2", 0)
	ROM_LOAD("ic1", 0x0000000, 0x0800000, NO_DUMP )
	ROM_LOAD("ic2", 0x0800000, 0x0800000, NO_DUMP )
	ROM_LOAD("ic3", 0x1000000, 0x0800000, NO_DUMP )
	ROM_LOAD("ic4", 0x1800000, 0x0800000, NO_DUMP )
...
ROM_START( ggram2 )
	...
	ROM_REGION( 0x0800000, RGNCLASS_USER, "user2", 0)
	ROM_LOAD("ic1", 0x0000000, 0x0800000, NO_DUMP )
ROM_END
...
ROM_START( hmgeo )
	...
	ROM_REGION( 0x5800000, RGNCLASS_USER, "user2", 0)
	ROM_LOAD("ic1", 0x0000000, 0x0800000, NO_DUMP )
	ROM_LOAD("ic2", 0x0800000, 0x0800000, NO_DUMP )
	ROM_LOAD("ic3", 0x1000000, 0x0800000, NO_DUMP )
	ROM_LOAD("ic4", 0x1800000, 0x0800000, NO_DUMP )
...
ROM_START( suchie3 )
	...
	ROM_REGION( 0x8000000, RGNCLASS_USER, "user1", 0)
...
ROM_START( pstone )
	...
	ROM_REGION( 0x4000000, RGNCLASS_USER, "user2", 0)
	ROM_LOAD("ic1", 0x0000000, 0x0800000, NO_DUMP )
	ROM_LOAD("ic2", 0x0800000, 0x0800000, NO_DUMP )
	ROM_LOAD("ic3", 0x1000000, 0x0800000, NO_DUMP )
	ROM_LOAD("ic4", 0x1800000, 0x0800000, NO_DUMP )
...
ROM_START( pstone2 )
	...
	ROM_REGION( 0x4800000, RGNCLASS_USER, "user2", 0)
	ROM_LOAD("ic1", 0x0000000, 0x0800000, NO_DUMP )
	ROM_LOAD("ic2", 0x0800000, 0x0800000, NO_DUMP )
	ROM_LOAD("ic3", 0x1000000, 0x0800000, NO_DUMP )
	ROM_LOAD("ic4", 0x1800000, 0x0800000, NO_DUMP )
...
ROM_START( slasho )
	...
	ROM_REGION( 0x8800000, RGNCLASS_USER, "user2", 0)
	ROM_LOAD("ic1", 0x0000000, 0x0800000, NO_DUMP )
	ROM_LOAD("ic2", 0x0800000, 0x0800000, NO_DUMP )
	ROM_LOAD("ic3", 0x1000000, 0x0800000, NO_DUMP )
	ROM_LOAD("ic4", 0x1800000, 0x0800000, NO_DUMP )
...
ROM_START( spawn )
	...
	ROM_REGION( 0x5000000, RGNCLASS_USER, "user2", 0)
	ROM_LOAD("ic1", 0x0000000, 0x0800000, NO_DUMP )
	ROM_LOAD("ic2", 0x0800000, 0x0800000, NO_DUMP )
	ROM_LOAD("ic3", 0x1000000, 0x0800000, NO_DUMP )
	ROM_LOAD("ic4", 0x1800000, 0x0800000, NO_DUMP )
...
ROM_START( sfz3ugd )
	...
	ROM_REGION( 0xac00000, RGNCLASS_USER, "user1", ROMREGION_ERASE) // this is the 'rom' file from the GDROM DISC, once the GDROM is emulated this won't be loaded
	...
	ROM_REGION( 0x3d8ab000, RGNCLASS_USER, "user3", ROMREGION_ERASE)
...
DRIVER_INIT( cvs2gd )
{
	...
	naomi_game_decrypt( 0x2f3226165b9e407cULL, memory_region(machine,RGNCLASS_USER, "user1"), memory_region_length(machine,RGNCLASS_USER, "user1"));
}
...
ROM_START( cvs2gd )
	...
	ROM_REGION( 0x9800000, RGNCLASS_USER, "user1", ROMREGION_ERASE) // this is the 'rom' file from the GDROM DISC, once the GDROM is emulated this won't be loaded
	ROM_LOAD("snkgd_sl.bin", 0x0000000, 0x9800000,  CRC(f153421d) SHA1(0c2b935ae3cfb6c85410a209fec4eab497066d84) )

	/* GD-ROM dump, this will be replaced once an appropriate CHD format has been decided upon for the GD images*/
	ROM_REGION( 0x26ad4620, RGNCLASS_USER, "user3", ROMREGION_ERASE)
