...
static MACHINE_CONFIG_START( mpu3base, mpu3_state )
	...
	MCFG_PIA6821_READPA_HANDLER(READ8(mpu3_state, pia_ic3_porta_r))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(mpu3_state, pia_ic3_portb_w))
	MCFG_PIA6821_CA2_HANDLER(WRITELINE(mpu3_state, pia_ic3_ca2_w))
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(mpu3_state, cpu0_irq))

	MCFG_DEVICE_ADD("pia_ic4", PIA6821, 0)
	MCFG_PIA6821_READPA_HANDLER(READ8(mpu3_state, pia_ic4_porta_r))
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(mpu3_state, pia_ic4_porta_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(mpu3_state, pia_ic4_portb_w))
	MCFG_PIA6821_CA2_HANDLER(WRITELINE(mpu3_state, pia_ic4_ca2_w))
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(mpu3_state, pia_ic4_cb2_w))
	MCFG_PIA6821_IRQA_HANDLER(WRITELINE(mpu3_state, cpu0_irq))

	MCFG_DEVICE_ADD("pia_ic5", PIA6821, 0)
	MCFG_PIA6821_READPB_HANDLER(READ8(mpu3_state, pia_ic5_portb_r))
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(mpu3_state, pia_ic5_porta_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(mpu3_state, pia_ic5_portb_w))
	MCFG_PIA6821_CA2_HANDLER(WRITELINE(mpu3_state, pia_ic5_ca2_w))
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(mpu3_state, pia_ic5_cb2_w))

	MCFG_DEVICE_ADD("pia_ic6", PIA6821, 0)
	MCFG_PIA6821_READPA_HANDLER(READ8(mpu3_state, pia_ic6_porta_r))
	MCFG_PIA6821_READPB_HANDLER(READ8(mpu3_state, pia_ic6_portb_r))
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(mpu3_state, pia_ic6_porta_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(mpu3_state, pia_ic6_portb_w))
	MCFG_PIA6821_IRQA_HANDLER(WRITELINE(mpu3_state, cpu0_irq))
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(mpu3_state, cpu0_irq))
