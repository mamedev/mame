...
{
public:
	williams_s6a_state(running_machine &machine, const driver_device_config_base &config)
		: driver_device(machine, config) { }
};


static ADDRESS_MAP_START( williams_s6a_map, ADDRESS_SPACE_PROGRAM, 8 )
...
ROM_START(alpok_b6)
	ROM_REGION(0x10000, "maincpu", 0)
	ROM_LOAD("al32ic14.732", 0x6000, 0x1000, CRC(7e950f6e) SHA1(5f9b7c6bc2b9e6ee7b6d6dc66f0d3608f7b467f3))
	ROM_RELOAD( 0xe000, 0x1000)
	ROM_LOAD("al32ic17.716", 0x7800, 0x0800, CRC(29ee23d8) SHA1(9d5a143c4567a44bdbba00f16c4713dbb88d2e93))
	ROM_RELOAD( 0xf800, 0x0800)
	ROM_LOAD("al32ic20.716", 0x7000, 0x0800, CRC(0058551c) SHA1(6b4bd2bd329ecac18d7a848ff4614cd61f5b37ad))
	ROM_RELOAD( 0xf000, 0x0800)
	ROM_REGION(0x10000, "cpu2", 0)
	ROM_LOAD("sound3.716", 0x7800, 0x0800, CRC(55a10d13) SHA1(521d4cdfb0ed8178b3594cedceae93b772a951a4))
	ROM_RELOAD( 0xf800, 0x0800)
...
GAME(2006,	alpok_b6,		alpok_l6,	williams_s6a,	williams_s6a,	williams_s6a,	ROT0,	"Williams / Oliver",	"Alien Poker (L-6, Multiball conversion)",	GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
