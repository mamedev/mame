...
ROM_START(at586x3)
	...
	ROMX_LOAD("M55-04ns.rom", 0x20000, 0x20000, CRC(0116B2B0), ROM_BIOS(4))

	ROM_SYSTEM_BIOS(4, "m55s04", "m55n04") // with sound
	ROMX_LOAD("M55-04s.rom", 0x20000, 0x20000, CRC(34A7422E), ROM_BIOS(5))

	ROM_SYSTEM_BIOS(5, "m55ns03", "m55ns03") // Micronics M55HI-Plus with no sound
	ROMX_LOAD("M55NS03.ROM", 0x20000, 0x20000, CRC(6a3deb49), ROM_BIOS(6))

	ROM_SYSTEM_BIOS(6, "m55hi03", "m55hi03") // with sound
	ROMX_LOAD("M55HI03.ROM", 0x20000, 0x20000, CRC(bd476200), ROM_BIOS(7))

	ROM_SYSTEM_BIOS(7, "M7SHI03", "M7SHI03") // Micronics M7S-Hi
	ROMX_LOAD("M7SHI03.SND", 0x00000, 0x40000, CRC(3a35a939), ROM_BIOS(8))
ROM_END
