...
ROM_START( mightguy )
	ROM_REGION( 0x60000, RGNCLASS_CPU, "main", 0 ) /* Z80 code (main cpu) */
	...
	ROM_REGION( 0x8000, RGNCLASS_USER, "user1", 0 ) /* 1412M2 protection data */
	ROM_LOAD( "10.ic2",     0x0000, 0x8000, CRC(1a5d2bb1) SHA1(0fd4636133a980ba9ffa076f9010474586d37635) )

	ROM_REGION( 0x02000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) /* alpha */
	ROM_LOAD( "10.15g",     0x0000, 0x2000, CRC(17874300) SHA1(f97bee0ab491b04fe4950ebe9587031db6c815a3) )

	ROM_REGION( 0x08000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE ) /* tiles */
	...
	ROM_REGION( 0x14000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE ) /* sprites */
...
static DRIVER_INIT( mightguy )
{
	...
	UINT8 *RAM = (UINT8 *)memory_region(machine, RGNCLASS_CPU, "main");
