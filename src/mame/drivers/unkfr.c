...
//	ROM_LOAD( "hbrk_hot.txt", 0x0000, 0x0000ff, CRC(c95eecc8) SHA1(fd3e5658028ab39622e761445d72ed110da3e091) )
	...
	ROM_LOAD( "papa.p1", 0x0000, 0x020000, CRC(cb57a63c) SHA1(3472df9e375c820f1f8016528736bbfc37f6def3) ) //Paparazzi (Empire) - alt set of j6papa?
	...
	ROM_LOAD( "screw.p1", 0x0000, 0x080000, CRC(a0f62e42) SHA1(d6114a963f8dbda272529a4a06d5117977d0712a) )// four identical copies of screw0_5.p1, overdump? Keep anyway, 0.5 doesn't seem to work
	...
	ROM_LOAD( "zigzag.p1", 0x0000, 0x080000, CRC(68f4e9ab) SHA1(b22063976cf971dbbff9adb0d14c4eda5f6a9e23) )// Red Gaming Zig Zag - MPU5?
