...
GAME( 200?, hb_gpal		,0,			pluto5, pluto5, hb, ROT0, "Qps","G' Palace (Qps)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 200?, hb_gldpl	,0,			pluto5, pluto5, hb, ROT0, "Mazooma","Golden Palace (Mazooma)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
