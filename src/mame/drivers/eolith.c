...
static ADDRESS_MAP_START( eolith_map, ADDRESS_SPACE_PROGRAM, 32 )
	...
	AM_RANGE(0xfd000000, 0xfeffffff) AM_ROM AM_REGION(RGNCLASS_USER, "user1", 0)
	AM_RANGE(0xfff80000, 0xffffffff) AM_ROM AM_REGION(RGNCLASS_CPU, "cpu", 0)
ADDRESS_MAP_END
...
ROM_START( hidnctch )
	ROM_REGION( 0x80000, RGNCLASS_CPU, "cpu", 0 ) /* Hyperstone CPU Code */
	ROM_LOAD( "hc_u43.bin", 0x00000, 0x80000, CRC(635b4478) SHA1(31ea4a9725e0c329447c7d221c22494c905f6940) )

	ROM_REGION32_BE( 0x2000000, RGNCLASS_USER, "user1", ROMREGION_ERASE00 ) /* Game Data - banked ROM, swapping necessary */
...
ROM_START( hidctch2 )
	...
	ROM_REGION( 0x000800, RGNCLASS_CPU, "cpu2", 0 ) /* AT89c52 */
...
ROM_START( raccoon )
	...
	ROM_REGION( 0x08000, RGNCLASS_CPU, "cpu1", 0 ) /* QDSP ('51) Code */
	ROM_LOAD( "racoon-u.107", 0x0000, 0x8000, CRC(89450a2f) SHA1(d58efa805f497bec179fdbfb8c5860ac5438b4ec) )

	ROM_REGION( 0x08000, RGNCLASS_CPU, "cpu2", 0 ) /* Sound (80c301) CPU Code */
...
ROM_START( hidctch3 )
	...
	ROM_REGION( 0x008000, RGNCLASS_CPU, "cpu2", 0 ) /* GMS90C32 */
	ROM_LOAD( "u111",        0x0000, 0x8000, CRC(79012474) SHA1(09a2d5705d7bc52cc2d1644c87c1e31ee44813ef) )
...
static DRIVER_INIT( landbrka )
{
	...
	UINT32 *rombase = (UINT32*)memory_region(machine, RGNCLASS_CPU, "cpu");
