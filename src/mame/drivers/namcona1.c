...
static ADDRESS_MAP_START( namcona1_main_map, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0x400000, 0xbfffff) AM_ROM AM_REGION(RGNCLASS_CPU, "main", 0x280000)	/* data */
	AM_RANGE(0xc00000, 0xdfffff) AM_ROM AM_REGION(RGNCLASS_CPU, "main", 0x080000)	/* code */
...
static ADDRESS_MAP_START( namcona1_mcu_map, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0x00c000, 0x00ffff) AM_ROM AM_REGION(RGNCLASS_CPU, "mcu", 0)			// internal ROM BIOS
...
{
	UINT16 *pMem = (UINT16 *)memory_region( machine, RGNCLASS_CPU, "main" );
...
ROM_START( bkrtmaq )
	ROM_REGION( 0xa80000, RGNCLASS_CPU, "main", 0 )
	...
	ROM_REGION16_LE( 0x4000, RGNCLASS_CPU, "mcu", 0 )
...
ROM_START( emeralda ) /* NA-2 Game PCB, clones are NA-1 based; see games listed above */
	...
	ROM_REGION16_LE( 0x4000, RGNCLASS_CPU, "cpu1", 0 )
