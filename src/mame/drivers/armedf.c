...
static ADDRESS_MAP_START( legiono_map, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0x040000, 0x04003f) AM_WRITEONLY AM_BASE(&legion_cmd)
...
ROM_START( legion )
	ROM_REGION( 0x60000, RGNCLASS_CPU, "main", 0 )	/* 64K*8 for 68000 code */
	...
	ROM_REGION( 0x10000, RGNCLASS_CPU, "audio", 0 )	/* Z80 code (sound) */
	...
	ROM_REGION( 0x20000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE )
...
ROM_START( terraf )
	ROM_REGION( 0x50000, RGNCLASS_CPU, "main", 0 )	/* 64K*8 for 68000 code */
	...
	ROM_REGION( 0x0100, RGNCLASS_PROMS, "proms", 0 )	/* Unknown use */
...
ROM_START( terrafb )
	...
	ROM_REGION( 0x4000, RGNCLASS_CPU, "extra", 0 )	/* z80 program (replacement mcu/blitter) */
