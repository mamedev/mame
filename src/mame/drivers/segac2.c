...
static MACHINE_RESET( segac2 )
{
	...
	sound_banks = 0;
	if (memory_region(machine, RGNCLASS_SOUND, "upd"))
		sound_banks = memory_region_length(machine, RGNCLASS_SOUND, "upd") / 0x20000;
...
ROM_START( borench ) /* Borench  (c)1990 Sega */
	...
	ROM_REGION( 0x020000, RGNCLASS_SOUND, "upd", 0 )
...
ROM_START( tfrceac ) /* ThunderForce AC  (c)1990 Technosoft / Sega */
	...
	ROM_REGION( 0x040000, RGNCLASS_SOUND, "upd", 0 )
...
ROM_START( ribbit ) /* Ribbit  (c)1991 Sega */
	...
	ROM_COPY( RGNCLASS_CPU, "main", 0x000000, 0x080000, 0x080000 )
	...
	ROM_REGION( 0x080000, RGNCLASS_SOUND, "upd", 0 )
