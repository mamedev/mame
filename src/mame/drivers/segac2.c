...
static INPUT_PORTS_START( sonicpop )
	...
	PORT_MODIFY("P1")
	PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_BUTTON3 ) PORT_NAME("Relay")  // relay (must be ON by default or machine will instantly give an 'assistance' error)
	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_BUTTON4 ) PORT_NAME("Coinblock") // coinblock (inverted)
	...
	PORT_DIPNAME( 0x10, 0x00, "Sensor Advertise" ) PORT_DIPLOCATION("SW2:5")
...
ROM_START( sonicpop ) /* Sega Sonic Popcorn Shop (EMP5032 labeled 317-0140) */
	ROM_REGION( 0x200000, "maincpu", 0 )
