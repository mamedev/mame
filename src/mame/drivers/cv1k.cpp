...
static ADDRESS_MAP_START( cv1k_map, AS_PROGRAM, 64, cv1k_state )
	...
	AM_RANGE(0x0c000000, 0x0c7fffff) AM_RAM AM_MIRROR(0xa0800000) AM_SHARE("mainram")// work RAM
	AM_RANGE(0x10000000, 0x10000007) AM_MIRROR(0xa0000000) AM_READWRITE8(flash_io_r, flash_io_w, 0xffffffffffffffffU)
	AM_RANGE(0x10400000, 0x10400007) AM_MIRROR(0xa0000000) AM_DEVWRITE8("ymz770", ymz770_device, write, 0xffffffffffffffffU)
	AM_RANGE(0x10C00000, 0x10C00007) AM_MIRROR(0xa0000000) AM_READWRITE8(serial_rtc_eeprom_r, serial_rtc_eeprom_w, 0xffffffffffffffffU)
...
static ADDRESS_MAP_START( cv1k_d_map, AS_PROGRAM, 64, cv1k_state )
	AM_RANGE(0x00000000, 0x003fffff) AM_ROM AM_MIRROR(0xa0000000) AM_REGION("maincpu", 0) AM_WRITENOP AM_SHARE("rombase") // mmmbanc writes here on startup for some reason..
	AM_RANGE(0x0c000000, 0x0cffffff) AM_RAM AM_MIRROR(0xa0000000) AM_SHARE("mainram") // work RAM
	AM_RANGE(0x10000000, 0x10000007) AM_MIRROR(0xa0000000) AM_READWRITE8(flash_io_r, flash_io_w, 0xffffffffffffffffU)
	AM_RANGE(0x10400000, 0x10400007) AM_MIRROR(0xa0000000) AM_DEVWRITE8("ymz770", ymz770_device, write, 0xffffffffffffffffU)
	AM_RANGE(0x10C00000, 0x10C00007) AM_MIRROR(0xa0000000) AM_READWRITE8(serial_rtc_eeprom_r, serial_rtc_eeprom_w, 0xffffffffffffffffU)
//  AM_RANGE(0x18000000, 0x18000057) // blitter, installed on reset
