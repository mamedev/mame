...
ROM_START( ddpsdojbl )
	ROM_REGION( 0x400000, "maincpu", ROMREGION_ERASEFF)
	ROM_LOAD16_WORD_SWAP( "u4", 0x000000, 0x400000, CRC(a878ff4c) SHA1(cf5f2f987a775099992009c376466c44170e0e3f) )

	ROM_REGION( 0x8400000, "game", ROMREGION_ERASEFF)
	ROM_LOAD( "u2", 0x000000, 0x8400000, CRC(54353425) SHA1(5c749cd2e93a1b51bfdf1a0d4fd436b4d17acf9f) )

	ROM_REGION( 0x800000, "ymz770", ROMREGION_ERASEFF)
	ROM_LOAD16_WORD_SWAP( "u23", 0x000000, 0x400000, CRC(32b91544) SHA1(49e914bfdf33a328fbfa7efb42c5b89915e37643) )
	ROM_LOAD16_WORD_SWAP( "u24", 0x400000, 0x400000, CRC(7b9e749f) SHA1(374085a60098cc62501abae4d148bfd88c88149f) )
ROM_END

ROM_START( ddpsdojbla )
	ROM_REGION( 0x400000, "maincpu", ROMREGION_ERASEFF)
	ROM_LOAD16_WORD_SWAP( "u4", 0x000000, 0x400000, CRC(5a3b94e8) SHA1(a546f2baa366ca02dbd462b8ee7808c2643927cb) )

	ROM_REGION( 0x8400000, "game", ROMREGION_ERASEFF)
	ROM_LOAD( "u2", 0x000000, 0x8400000, CRC(7e19adc7) SHA1(6a6e2220096c80471d391d93979e0c883f733c1b) )
...
// These bootleg sets have been seen on converted PCBs.  The former set is an obvious defacement of the original game, while the 'dehack' set is a 'scam' set designed to
// make that defacement less obvious and the game appear original by removing some hacked elements entirely and restoring other assets using resources from the Xbox 360 port.
GAME( 2021, ddpsdojbl,  ddpsdoj,  cv1k_d, cv1k, cv1k_state, init_ddpdfk,   ROT270, "bootleg",            "DoDonPachi SaiDaiOuJou ('& Knuckles' bootleg)",                   MACHINE_IMPERFECT_TIMING )
GAME( 2021, ddpsdojbla, ddpsdoj,  cv1k_d, cv1k, cv1k_state, init_ddpdfk,   ROT270, "bootleg",            "DoDonPachi SaiDaiOuJou ('& Knuckles' bootleg, 'dehack' hack)",    MACHINE_IMPERFECT_TIMING )
