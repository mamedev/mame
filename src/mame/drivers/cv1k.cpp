...
// original ROM patcher is can be downloadable in http://suicideclub.gameordie.com/
// This set is dumped from bootleg PCB with pre-patched Suicide Club hack, These CRC32 checksums are matches compares to homepage's one.
...
GAME( 2017, pinkswtssc, pinkswts, cv1k,   cv1ks,cv1k_state, init_pinkswts, ROT270, "bootleg / hack (Four Horsemen)", "Pink Sweets: Suicide Club (2017/10/31 SUICIDECLUB VER., bootleg)",              MACHINE_IMPERFECT_TIMING ) // bootlegged with pre-patched Suicide Club hack
