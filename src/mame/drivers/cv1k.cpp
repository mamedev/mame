...
// the original set is not currently supported, these bootlegs are being used on converted PCBs.
GAME( 2021, sdojbl,     0,        cv1k_d, cv1k, cv1k_state, init_ddpdfk,   ROT270, "bootleg",            "DoDonPachi SaiDaiOuJou ('& Knuckles' bootleg)",                   MACHINE_IMPERFECT_TIMING )
GAME( 2021, sdojbla,    sdojbl,   cv1k_d, cv1k, cv1k_state, init_ddpdfk,   ROT270, "bootleg",            "DoDonPachi SaiDaiOuJou ('& Knuckles' bootleg, 'dehack' hack)",    MACHINE_IMPERFECT_TIMING )
