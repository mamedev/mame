...
public:
	...
	void keyb_put(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t keyboard_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);

	void floppy_control_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t floppy_ack_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void floppy_reserve_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void floppy_release_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	...
	uint8_t centronics_control_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void centronics_control_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);

	I82730_UPDATE_ROW(txt_update_row);
	void txt_ca_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	void txt_irst_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
...
void rc759_state::keyb_put(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_keyboard_key = data;
	m_pic->ir1_w(1);
}

uint8_t rc759_state::keyboard_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	logerror("keyboard_r\n");
...
uint8_t rc759_state::ppi_porta_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	uint8_t data = 0;
...
uint8_t rc759_state::ppi_portb_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	uint8_t data = 0;
...
void rc759_state::ppi_portc_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t rc759_state::centronics_data_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_centronics_data;
}

void rc759_state::centronics_data_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t rc759_state::centronics_control_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	uint8_t data = 0;
...
void rc759_state::centronics_control_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void rc759_state::floppy_control_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t rc759_state::floppy_ack_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	logerror("floppy_ack_r\n");
	return 0xff;
}

void rc759_state::floppy_reserve_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	logerror("floppy_reserve_w: %02x\n", data);
}

void rc759_state::floppy_release_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void rc759_state::txt_ca_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	m_txt->ca_w(1);
	m_txt->ca_w(0);
}

void rc759_state::txt_irst_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	m_txt->irst_w(1);
	m_txt->irst_w(0);
}

uint8_t rc759_state::palette_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	logerror("palette_r(%02x)\n", offset);
	return 0xff;
}

void rc759_state::palette_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t rc759_state::rtc_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	logerror("rtc_r(%02x)\n", offset);
	return 0xff;
}

void rc759_state::rtc_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t rc759_state::nvram_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void rc759_state::nvram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	offs_t addr = (m_nvram_bank << 6) | offset;
...
uint8_t rc759_state::irq_callback(address_space &space, offs_t offset, uint8_t mem_mask)
{
