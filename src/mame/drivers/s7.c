...
ROM_START(hypbl_l5)
	ROM_REGION(0x10000, "maincpu", 0)
	ROM_LOAD("ic20_fix.532", 0xd000, 0x1000, CRC(48958d77) SHA1(ddfec991ef99606b866ced08b59e205a0b2cadd1))
	ROM_RELOAD( 0x5000, 0x1000)
	ROM_LOAD("ic14.532", 0xe000, 0x1000, CRC(8090fe71) SHA1(0f1f40c0ee8da5b2fd51efeb8be7c20d6465239e))
	ROM_RELOAD( 0x6000, 0x1000)
	ROM_LOAD("ic17.532", 0xf000, 0x1000, CRC(6f4c0c4c) SHA1(1036067e2c85da867983e6e51ee2a7b5135000df))
...
ROM_START(hypbl_l6)
	ROM_REGION(0x10000, "maincpu", 0)
	ROM_LOAD("ic20_l6.532", 0xd000, 0x1000, CRC(e40c27cd) SHA1(337bd8450be305796e52c1b7d3ae3cc8cc972525))
	ROM_RELOAD( 0x5000, 0x1000)
	ROM_LOAD("ic14.532", 0xe000, 0x1000, CRC(8090fe71) SHA1(0f1f40c0ee8da5b2fd51efeb8be7c20d6465239e))
	ROM_RELOAD( 0x6000, 0x1000)
	ROM_LOAD("ic17.532", 0xf000, 0x1000, CRC(6f4c0c4c) SHA1(1036067e2c85da867983e6e51ee2a7b5135000df))
...
ROM_START(frpwr_b7)
	ROM_REGION(0x10000, "maincpu", 0)
	ROM_LOAD("f7ic14pr.716", 0xe000, 0x0800, CRC(c7a60d8a) SHA1(1921f2ddec96963d7f990cd6b1cdd6b4a6e42810) )
	ROM_RELOAD( 0x6000, 0x0800)
	ROM_LOAD("f7ic17gr.532", 0xf000, 0x1000, CRC(a042201a) SHA1(1421e1dbbcb322d83838d68ac0909f4804249815) )
	ROM_RELOAD( 0x7000, 0x1000)
	ROM_LOAD("f7ic20ga.716", 0xe800, 0x0800, CRC(584d7b45) SHA1(9ea01eda36dab77dec78c2d1207983c505e406b2) )
	ROM_RELOAD( 0x6800, 0x0800)
	ROM_REGION(0x10000, "cpu2", 0)
	ROM_LOAD("sound3.716", 0x7800, 0x0800, CRC(55a10d13) SHA1(521d4cdfb0ed8178b3594cedceae93b772a951a4))
	ROM_RELOAD( 0xf800, 0x0800)
...
ROM_START(frpwr_c7)
	ROM_REGION(0x10000, "maincpu", 0)
	ROM_LOAD("f7ic14pr.716", 0xe000, 0x0800, CRC(4cd22956) SHA1(86380754b9cbb0a81b4fa4d26cff71b9a70d2a96) )
	ROM_RELOAD( 0x6000, 0x0800)
	ROM_LOAD("f7ic17gr.532", 0xf000, 0x1000, CRC(3a1b7cc7) SHA1(1f32ef6d66040a53b04a0cddb1ffbf197a29c940) )
	ROM_RELOAD( 0x7000, 0x1000)
	ROM_LOAD("f7ic20ga.716", 0xe800, 0x0800, CRC(5ed61e41) SHA1(b73a05b336f7bb8ee528205612bd0744e86498f5) )
	ROM_RELOAD( 0x6800, 0x0800)
	ROM_LOAD("f7ic26.716", 0xd800, 0x0800, CRC(aaf82d89) SHA1(c481a49c7e7d4734c0eeab31b9970ca62a3995f0) )
	ROM_RELOAD( 0x5800, 0x0800)
	ROM_REGION(0x10000, "cpu2", 0)
	ROM_LOAD("sound3.716", 0x7800, 0x0800, CRC(55a10d13) SHA1(521d4cdfb0ed8178b3594cedceae93b772a951a4))
	ROM_RELOAD( 0xf800, 0x0800)
	...
	ROM_LOAD("v_ic5.532", 0x4000, 0x1000, CRC(1737fdd2) SHA1(6307e0ae715e97294ee8aaaeb2e2bebb0cb590c2))
	ROM_RELOAD( 0xc000, 0x1000)
	ROM_LOAD("v_ic6.532", 0x5000, 0x1000, CRC(35db11d2) SHA1(001df0d5245230b960ff69c30ee2b305b3a5e4b4))
	ROM_RELOAD( 0xd000, 0x1000)
	ROM_LOAD("v_ic4.532", 0x6000, 0x1000, CRC(8d4ff909) SHA1(b82666fe96bdf174bc4f347d7139da9ab7dadee1))
	ROM_RELOAD( 0xe000, 0x1000)
ROM_END
...
GAME(1998,	hypbl_l5,	hypbl_l4,	williams_s7,	williams_s7,	williams_s7,	ROT0,	"Jess M. Askey",		"HyperBall (L-5) (High score bootleg)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(2006,	hypbl_l6,	hypbl_l4,	williams_s7,	williams_s7,	williams_s7,	ROT0,	"Jess M. Askey",		"HyperBall (L-6) (High score bootleg)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
...
GAME(2003,	frpwr_b7,	frpwr_l6,	williams_s7,	williams_s7,	williams_s7,	ROT0,	"Williams / Oliver",	"Firepower (Sys.7 7-digit conversion)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(2005,	frpwr_c7,	frpwr_l6,	williams_s7,	williams_s7,	williams_s7,	ROT0,	"Williams / Oliver",	"Firepower (Sys.7 7-digit conversion, new version)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
