...
GAME( 1994, revx,     0,    midxunit, revx, midxunit_state, revx, ROT0, "Midway",   "Revolution X - Music is the Weapon (rev 1.0 6/16/94)", MACHINE_SUPPORTS_SAVE )
GAME( 1994, revxp5,   revx, midxunit, revx, midxunit_state, revx, ROT0, "Midway",   "Revolution X - Music is the Weapon (prototype, rev 5.0 5/23/94)", MACHINE_SUPPORTS_SAVE )
