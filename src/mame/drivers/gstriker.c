...
ROM_START( gstriker )
	...
	ROM_REGION( 0x1000000, RGNCLASS_GFX, "gfx3", 0 )
	...
	ROM_REGION( 0x40000, RGNCLASS_SOUND, "ym.deltat", 0 )
	...
	ROM_REGION( 0x1000, RGNCLASS_PLDS, "plds", 0 )
...
ROM_START( vgoalsoc )
	...
	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx2", 0 ) // screen tilemap
...
ROM_START( vgoalsca )
	...
	ROM_REGION( 0x20000, RGNCLASS_GFX, "gfx1", 0 ) // fixed tile
	ROM_LOAD( "c16_u48.u48",  0x000000, 0x020000, CRC(ca059e7f) SHA1(2fa48b0fec1210575f3a1ecee7d2aec0af3fa9c4) )

	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx2", 0 ) // scroll tile
...
ROM_START( twrldc94 )
	...
	ROM_REGION( 0x800000, RGNCLASS_GFX, "gfx3", 0 )
