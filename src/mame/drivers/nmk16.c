...
{
	memory_install_read_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x08000e, 0x08000f, 0, 0, vandykeb_r );
	memory_install_write_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x08001e, 0x08001f, 0, 0, SMH_NOP );
}
...
ROM_START( tdragon )
	ROM_REGION( 0x80000, "main", 0 )		/* 68000 code -bitswapped- */
...
ROM_START( ssmissin )
	...
	ROM_REGION( 0x010000, "audio", 0 )		/* Code for Sound CPU */
...
ROM_START( raphero )
	...
	ROM_REGION( 0x30000, "audio", 0 )		/* tmp90c841 */
	...
	ROM_REGION( 0x600000, "gfx3", ROMREGION_DISPOSE ) /* sprites */
...
ROM_START( manybloc )
	...
	ROM_REGION( 0x10000, "audio", 0 )		/* Z80? CPU */
	...
	ROM_REGION( 0x080000, "gfx3", ROMREGION_DISPOSE ) /* 16x16 sprite tiles */
...
ROM_START( stagger1 ) /* Japan only, with later (c) year of 1998 */
	...
	ROM_REGION( 0x080000, "gfx2", ROMREGION_DISPOSE )	/* Layer 0, 16x16x4 */
...
ROM_START( redhawkb )
	...
	ROM_REGION( 0x080000, "gfx3", ROMREGION_DISPOSE | ROMREGION_ERASEFF )	/* Layer 1, 8x8x4 */
...
ROM_START( grdnstrm )
	...
	ROM_REGION( 0x200000, "gfx1", ROMREGION_DISPOSE )	/* Sprites, 16x16x4 */
	ROM_LOAD( "gst-06.c13", 0x000000, 0x200000, CRC(7d4d4985) SHA1(15c6c1aecd3f12050c1db2376f929f1a26a1d1cf) )

	ROM_REGION( 0x400000, "gfx2", ROMREGION_DISPOSE )	/* Layer 0, 16x16x8 */
	...
	ROM_REGION( 0x10000, "gfx3", ROMREGION_DISPOSE )	/* Layer 1, 8x8x4 */
...
ROM_START( popspops )
	...
	ROM_REGION( 0x400000, "gfx1", ROMREGION_ERASEFF | ROMREGION_DISPOSE )	/* Sprites, 16x16x4 */
	/* no sprite roms? */
...
ROM_START( mangchi )
	...
	ROM_REGION( 0x080000, "gfx1", ROMREGION_DISPOSE )	/* Sprites, 16x16x4 */
	...
	ROM_REGION( 0x100000, "gfx2", ROMREGION_DISPOSE )	/* Layer 0, 16x16x8 */
	...
	ROM_REGION( 0x100000, "gfx3", ROMREGION_DISPOSE | ROMREGION_ERASEFF )	/* Layer 1, 8x8x4 */
...
ROM_START( bubl2000 )
	...
	ROM_REGION( 0x300000, "gfx2", ROMREGION_DISPOSE )	/* Layer 0, 16x16x8 */
...
ROM_START( firehawk )
	...
	ROM_REGION( 0x20000, "audio", 0 )	/* Z80 Code */
...
ROM_START( twinactn )
	...
	ROM_REGION( 0x80000, "gfx2", ROMREGION_DISPOSE )	/* Layer 0, 16x16x8 */
	ROM_LOAD( "afega.ui20", 0x00000, 0x80000, CRC(237c8f92) SHA1(bb3131b450bd78d03b789626a465fb9e7a4604a7) )

	ROM_REGION( 0x20000, "gfx1", ROMREGION_DISPOSE )	/* Layer 1, 8x8x4 */
