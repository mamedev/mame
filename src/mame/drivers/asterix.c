...
ROM_START( asterix )
	...
	ROM_REGION( 0x200000, RGNCLASS_SOUND, "konami", 0 )
...
#if 0
	*(UINT16 *)(memory_region(machine, RGNCLASS_CPU, "main") + 0x07f34) = 0x602a;
	*(UINT16 *)(memory_region(machine, RGNCLASS_CPU, "main") + 0x00008) = 0x0400;
#endif
}
