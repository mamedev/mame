...
void s8_state::sol3_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	if (BIT(data, 1))
		m_samples->start(0, 6); // knocker
}

void s8_state::sound_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_sound_data = data;
}

int s8_state::pia21_ca1_r()
{
// sound busy
	return 1;
}
...
void s8_state::lamp0_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
}

void s8_state::dig0_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void s8_state::dig1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t s8_state::switch_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	char kbdrow[8];
...
void s8_state::switch_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_kbdrow = data;
}

uint8_t s8_state::sound_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_sound_data;
}
