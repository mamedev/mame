...
ROM_START( cyberbal )
	...
	ROM_REGION( 0x40000, RGNCLASS_CPU, "extra", 0 )	/* 4*64k for 68000 code */
	...
	ROM_REGION16_BE( 0x40000, RGNCLASS_CPU, "dac", 0 )	/* 256k for 68000 sound code */
	...
	ROM_REGION( 0x140000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )
...
ROM_START( cyberbt )
	...
	ROM_REGION( 0x40000, RGNCLASS_CPU, "extra", 0 )
