...
ROM_START( vamphalf )
	ROM_REGION16_BE( 0x100000, RGNCLASS_USER, "user1", ROMREGION_ERASE00 ) /* Hyperstone CPU Code */
	/* 0 - 0x80000 empty */
	ROM_LOAD( "prom1", 0x80000, 0x80000, CRC(f05e8e96) SHA1(c860e65c811cbda2dc70300437430fb4239d3e2d) )

	ROM_REGION( 0x800000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) /* 16x16x8 Sprites */
...
ROM_START( misncrft )
	...
	ROM_REGION( 0x400000, RGNCLASS_CPU, "audio", 0 )	/* i8052 code */
...
ROM_START( coolmini )
	...
	ROM_REGION( 0x1000000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )  /* 16x16x8 Sprites */
...
ROM_START( wyvernwg )
	ROM_REGION32_BE( 0x100000, RGNCLASS_USER, "user1", 0 ) /* Hyperstone CPU Code */
	...
	ROM_REGION( 0x020000, RGNCLASS_CPU, "audio", 0 ) /* QDSP ('51) Code */
	ROM_LOAD( "u7", 0x0000, 0x20000, CRC(00a3f705) SHA1(f0a6bafd16bea53d4c05c8cc108983cbd41e5757) )

	ROM_REGION( 0x1000000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )  /* gfx data */
	...
	ROM_REGION( 0x200000, RGNCLASS_SOUND, "sfx", 0 ) /* Music data / QDSP samples (SFX) */
...
ROM_START( finalgdr ) /* version 2.20.5915, Korea only */
	...
	ROM_REGION( 0x800000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )  /* gfx data */
	...
	ROM_REGION( 0x080000, RGNCLASS_USER, "user2", 0 ) /* Oki Samples */
...
ROM_START( dquizgo2 )
	...
	ROM_REGION( 0xc00000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) /* 16x16x8 Sprites */
