...
{
	memory_set_bankptr(2, memory_region(machine, RGNCLASS_CPU, "audio") + 0x10000 + cur_sound_region*0x4000);
}
...
ROM_START( xexex ) /* Europe, Version AA */
	ROM_REGION( 0x180000, RGNCLASS_CPU, "main", 0 )
	...
	ROM_REGION( 0x030000, RGNCLASS_CPU, "audio", 0 )
	...
	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx3", 0 ) // NOTE: region must be 2xROM size for unpacking
	ROM_LOAD( "067_b08.rom", 0x000000, 0x080000, CRC(ca816b7b) SHA1(769ce3700e41200c34adec98598c0fe371fe1e6d) )

	ROM_REGION( 0x300000, RGNCLASS_SOUND, "konami", 0 )
...
static DRIVER_INIT( xexex )
{
	...
	{
		// Invulnerability
//      *(UINT16 *)(memory_region(machine, RGNCLASS_CPU, "main") + 0x648d4) = 0x4a79;
//      *(UINT16 *)(memory_region(machine, RGNCLASS_CPU, "main") + 0x00008) = 0x5500;
		xexex_strip0x1a = 1;
	}
