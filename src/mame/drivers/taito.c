...
static ADDRESS_MAP_START( taito_map, AS_PROGRAM, 8, taito_state )
	...
	AM_RANGE(0x2800, 0x2800) AM_MIRROR(0x00f0) AM_READ_PORT("X0")
	AM_RANGE(0x2801, 0x2801) AM_MIRROR(0x00f0) AM_READ_PORT("X1")
	AM_RANGE(0x2802, 0x2802) AM_MIRROR(0x00f0) AM_READ_PORT("X2")
	AM_RANGE(0x2803, 0x2803) AM_MIRROR(0x00f0) AM_READ_PORT("X3")
	AM_RANGE(0x2804, 0x2804) AM_MIRROR(0x00f0) AM_READ_PORT("X4")
	AM_RANGE(0x2805, 0x2805) AM_MIRROR(0x00f0) AM_READ_PORT("X5")
	AM_RANGE(0x2806, 0x2806) AM_MIRROR(0x00f0) AM_READ_PORT("X6")
	AM_RANGE(0x2807, 0x2807) AM_MIRROR(0x00f0) AM_READ_PORT("X7")
	AM_RANGE(0x2808, 0x2808) AM_MIRROR(0x00f0) AM_READ_PORT("X8")
