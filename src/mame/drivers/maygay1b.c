...
ROM_START( m1eeb )
	...
	ROM_LOAD( "eastenders_special_4_8_-_2_bars_pays_4.bin"       , 0x0000, 0x010000, CRC(ffab9325) SHA1(be04106cd049ede8af28f77bd2d88e0545d98e48) )
...
ROM_START( m1guvnor )
	...
	ROM_REGION( 0x20000, "altrevs", ROMREGION_ERASE00  )
	ROM_LOAD( "guvnor_20p_10.bin"  , 0x0000, 0x010000, CRC(63405fd0) SHA1(0e4fddb86bd0978e4d0facc954f1e67d7b4c0690) )
	...
	ROM_REGION( 0x100000, "msm6376", ROMREGION_ERASE00  )
	ROM_LOAD( "dig1-036_snd_u2.bin"  , 0x000000, 0x080000, CRC(ba0cec08) SHA1(03c009f0157000785931139107745df7df005227) )
	ROM_LOAD( "dig1-036_snd_u3.bin"  , 0x080000, 0x080000, CRC(2213e2e9) SHA1(b442f1af81326946df2bf4c7ea12c805d221f4f6) )
ROM_END_M1A_MCU
...
ROM_START( m1mono )
	ROM_REGION( 0x20000, "maincpu", ROMREGION_ERASE00  )
	ROM_LOAD( "maygaymonopoly_delx_5p-10p_6.bin"   , 0x0000, 0x010000, CRC(ed3c5997) SHA1(5a1e82894bd71073e08136a9071528833b529f5e) )

	ROM_REGION( 0x20000, "altrevs", ROMREGION_ERASE00  )
	ROM_LOAD( "mon_deluxe_old_6_5_10.bin"    , 0x0000, 0x010000, CRC(f6ff2c55) SHA1(dec0be9c5584285b47943dd7d8751acd5e244daf) )
	...
	ROM_LOAD( "monopoly_5p.bin" , 0x0000, 0x010000, CRC(75125a1d) SHA1(20a16835b39d3eaa38c88ed885aef04bdb08bb65) )
	...
	ROM_REGION( 0x100000, "msm6376", ROMREGION_ERASE00  ) // the sound roms for the SWP video version were in here too...
...
ROM_START( m1pp )
	...
	ROM_LOAD( "ppanthersa3-026_nd.bin" , 0x0000, 0x010000, CRC(189bc301) SHA1(2b9a190e3b5e008b291d0f4b14fa5874c6f867c4) )
...
ROM_START( m1przee )
	ROM_REGION( 0x10000, "maincpu", ROMREGION_ERASE00  )
	ROM_LOAD( "prize_eastenders_6.bin"  , 0x0000, 0x010000, CRC(3cc35697) SHA1(adaaafd6ae59497630660ec179212f0dd8dd3741) )
	...
	ROM_REGION( 0x100000, "msm6376", ROMREGION_ERASE00  )
	ROM_LOAD( "dig1-033_snd_u2.bin"  , 0x000000, 0x080000, CRC(3eaa138c) SHA1(ad7d6e3ffc8fe19ea8cb9188998c75c90a77e09e) )
	ROM_LOAD( "dig1-033_snd_u3.bin"  , 0x080000, 0x080000, CRC(89fde428) SHA1(f0942a2f1d3890ad18b01e8433333e5412c57644) )
ROM_END_M1A_MCU
...
ROM_START( m1mb )
	...
	ROM_LOAD( "monkey_business_v0-4.bin"  , 0x0000, 0x020000, CRC(ead89920) SHA1(de7da735429956e8fdb0593937d3cf3dd2e4e7d8) )
...
ROM_START( m1trtrcl )
	ROM_REGION( 0x20000, "maincpu", ROMREGION_ERASE00  )
	ROM_LOAD( "trick_or_treat_club_v0-2.bin"    , 0x0000, 0x020000, CRC(af72431c) SHA1(a6060445527372606bcfab9eb9f0a40882d00520) )
	ROM_REGION( 0x20000, "altrevs", ROMREGION_ERASE00  )
	ROM_LOAD( "ttcb0-2n.p0", 0x0000, 0x020000, CRC(af72431c) SHA1(a6060445527372606bcfab9eb9f0a40882d00520) )
	ROM_REGION( 0x100000, "msm6376", ROMREGION_ERASE00  )
	ROM_LOAD( "trick_or_treat_sound_0.bin"    , 0x000000, 0x080000, CRC(4900e4d3) SHA1(ce3342d076caadb793572411be8394e02a37cd11) )
	ROM_LOAD( "trick_or_treat_sound_1.bin"    , 0x080000, 0x080000, CRC(42ae9bc3) SHA1(c82f3d8ac6004b827913e1940b0d06ed7c1584d0) )
ROM_END
