...
ROM_START( coolridr )
	ROM_REGION( 0x200000, RGNCLASS_CPU, "main", 0 ) /* SH2 code */
	...
	ROM_REGION( 0x100000, RGNCLASS_CPU, "sound", 0 )	/* 68000 */
	...
	ROM_REGION( 0x0400000, RGNCLASS_GFX, "gfx2", 0 ) /* Tiles. . at least 1 format */
	...
	ROM_REGION( 0x0400000, RGNCLASS_GFX, "gfx3", 0 ) /*Tiles. . at least 1 format + sprites (non-tile data)? */
	...
	ROM_REGION( 0x0400000, RGNCLASS_GFX, "gfx4", 0 ) /* sprites (non-tile data?) */
	...
	ROM_REGION( 0x1600000, RGNCLASS_GFX, "gfx5", ROMREGION_ERASEFF ) /* Other Roms */
