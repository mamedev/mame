...
ROM_START( lsasquad )
	...
	ROM_REGION( 0x20000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE | ROMREGION_INVERT )
	...
	ROM_REGION( 0x20000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE | ROMREGION_INVERT )
...
ROM_START( daikaiju )
	...
	ROM_REGION( 0x0800, RGNCLASS_CPU, "cpu2", 0 )
