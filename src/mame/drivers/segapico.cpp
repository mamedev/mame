...
public:
	...
	uint16_t pico_68k_io_read(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void pico_68k_io_write(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
...
uint16_t pico_base_state::pico_68k_io_read(address_space &space, offs_t offset, uint16_t mem_mask)
{
	uint8_t retdata = 0;
...
void pico_base_state::pico_68k_io_write(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
