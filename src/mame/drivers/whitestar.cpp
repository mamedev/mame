...
GAME(2000,  strikext,     0,          whitestar,  whitestar, whitestar_state, 0,  ROT0,   "Stern",    "Striker Xtreme (1.02)",                                    MACHINE_IS_PINBALL)
...
GAME(2000,  strxt_uk,     strikext,   whitestar,  whitestar, whitestar_state, 0,  ROT0,   "Stern",    "Striker Xtreme (1.01 UK)",                                 MACHINE_IS_PINBALL)
GAME(2000,  strxt_gr,     strikext,   whitestar,  whitestar, whitestar_state, 0,  ROT0,   "Stern",    "Striker Xtreme (1.03 Germany)",                            MACHINE_IS_PINBALL)
GAME(2000,  strxt_fr,     strikext,   whitestar,  whitestar, whitestar_state, 0,  ROT0,   "Stern",    "Striker Xtreme (1.02 France)",                             MACHINE_IS_PINBALL)
GAME(2000,  strxt_it,     strikext,   whitestar,  whitestar, whitestar_state, 0,  ROT0,   "Stern",    "Striker Xtreme (1.02 Italy)",                              MACHINE_IS_PINBALL)
GAME(2000,  strxt_it_101, strikext,   whitestar,  whitestar, whitestar_state, 0,  ROT0,   "Stern",    "Striker Xtreme (1.01 Italy)",                              MACHINE_IS_PINBALL)
GAME(2000,  strxt_sp,     strikext,   whitestar,  whitestar, whitestar_state, 0,  ROT0,   "Stern",    "Striker Xtreme (1.02 Spain)",                              MACHINE_IS_PINBALL)
