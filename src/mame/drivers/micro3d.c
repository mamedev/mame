...
static ADDRESS_MAP_START( vgbmem, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0x03800000, 0x03dfffff) AM_ROM AM_REGION(RGNCLASS_GFX, "gfx1", 0)		/* 2D Graphics ROMs */
	AM_RANGE(0x03e00000, 0x03ffffff) AM_ROM AM_REGION(RGNCLASS_USER, "user1", 0)		/* 128kB Program ROM */
	AM_RANGE(0xc0000000, 0xc00001ff) AM_READWRITE(tms34010_io_register_r, tms34010_io_register_w)
	AM_RANGE(0xffe00000, 0xffffffff) AM_ROM AM_REGION(RGNCLASS_USER, "user1", 0)		/* 128kB Program ROM (Mirror - for interrupt vectors) */
ADDRESS_MAP_END
...
ROM_START( botss )
	...
	ROM_REGION( 0x140000, RGNCLASS_CPU, "main", 0 ) /* 68000 Code */
	...
	ROM_REGION( 0x40000, RGNCLASS_USER, "user2", 0 )
	...
	ROM_REGION16_LE( 0x40000, RGNCLASS_USER, "user1", 0 )
	...
	ROM_REGION16_LE( 0xc0000, RGNCLASS_GFX, "gfx1", 0 )
	...
	ROM_REGION( 0x40000, RGNCLASS_SOUND, "upd", 0 )
...
//  ROM_LOAD16_BYTE( "host.u92",  0x040000, 0x20000, CRC(220e5a39) SHA1(d9de87bc56182c8412c11bff9616164159ced9fb) ) // alt (bad?) rom
	...
	ROM_REGION( 0x08000, RGNCLASS_CPU, "audio", 0 )
...
//  ROM_REGION( 0x40000, RGNCLASS_CPU, "vgb", 0 )         /* TMS34010 dummy region */
	...
	ROM_REGION32_BE( 0x80000, RGNCLASS_USER, "user2", 0 )
