...
{
	UINT32 data;
	const UINT8 *usr = memory_region(machine, RGNCLASS_USER, "user2");
...
static ADDRESS_MAP_START( srmp5_mem, ADDRESS_SPACE_PROGRAM, 32 )
	...
	AM_RANGE(0x1fc00000, 0x1fdfffff) AM_READ(SMH_ROM) AM_WRITE(SMH_ROM) AM_REGION(RGNCLASS_USER, "user1", 0)
	AM_RANGE(0x2fc00000, 0x2fdfffff) AM_READ(SMH_ROM) AM_WRITE(SMH_ROM) AM_REGION(RGNCLASS_USER, "user1", 0)
ADDRESS_MAP_END
...
ROM_START( srmp5 )
	ROM_REGION( 0x410000, RGNCLASS_CPU, "main", 0 )
	...
	ROM_COPY( RGNCLASS_CPU, "main",  0x10000, 0x00000, 0x08000 )

	ROM_REGION32_BE( 0x200000, RGNCLASS_USER, "user1", 0 )
	...
	ROM_REGION( 0xf00000, RGNCLASS_USER, "user2",0) /* gfx ? */
