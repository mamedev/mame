...
Cho-Zetsurin-Jin Beraboh Man       (c) 1988 Namco
...
12/87 Galaga '88 (Japanese version)         153  V
 ...
 5/88 Cho-Zetsurin-Jin Beraboh Man          B    H
??/88 Cho-Zetsurin-Jin Beraboh Man          NONE H
...
void namcos1_state::ns1(machine_config &config)
{
	/* basic machine hardware */
	MC6809E(config, m_maincpu, XTAL(49'152'000)/32);
	m_maincpu->set_addrmap(AS_PROGRAM, &namcos1_state::main_map);

	MC6809E(config, m_subcpu, XTAL(49'152'000)/32);
	m_subcpu->set_addrmap(AS_PROGRAM, &namcos1_state::sub_map);
...
/* Cho-Zetsurin-Jin Beraboh Man (revision C) */
ROM_START( berabohm )
	ROM_REGION( 0x20000, "audiocpu", 0 )
...
/* Cho-Zetsurin-Jin Beraboh Man (revision B) */
ROM_START( berabohmb )
	ROM_REGION( 0x20000, "audiocpu", 0 )
	ROM_LOAD( "bm1_s0.bin",         0x00000, 0x10000, CRC(d5d53cb1) SHA1(af5db529550382dab61197eb46e02110efc4c21b) )
...
ROM_START( puzlclub )
	...
	ROM_REGION( 0x100000, "sprite", ROMREGION_ERASEFF ) /* sprites */
	/* no sprites */
ROM_END
...
GAME( 1988, berabohm,  0,        ns1,     berabohm, namcos1_state, init_berabohm, ROT180, "Namco", "Cho-Zetsurin-Jin Beraboh Man (Japan, Rev C)", MACHINE_SUPPORTS_SAVE )
GAME( 1988, berabohmb, berabohm, ns1,     berabohm, namcos1_state, init_berabohm, ROT180, "Namco", "Cho-Zetsurin-Jin Beraboh Man (Japan, Rev B)", MACHINE_SUPPORTS_SAVE )
