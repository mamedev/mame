...
{
	UINT8 *SNDROM = memory_region(machine, RGNCLASS_SOUND, "ymz");
	int bank;
...
static WRITE16_HANDLER( nndmseal_sound_bank_w )
{
	...
	if (ACCESSING_BITS_0_7)
	{
		UINT8 *rom = memory_region(machine, RGNCLASS_SOUND, "okisource");

		if (data & 0x04)
		{
			bank_lo = data & 0x03;

			memcpy(memory_region(machine, RGNCLASS_SOUND, "oki"), rom + (bank_lo * 0x80000), 0x20000);
...
//          logerror("PC:%06X sound bank_lo = %02X\n",activecpu_get_pc(),bank_lo);
		...
		else
		{
			...
			memcpy(memory_region(machine, RGNCLASS_SOUND, "oki") + 0x20000, rom + (bank_lo * 0x80000) + (bank_hi * 0x20000), 0x20000);
...
ROM_START( tetrisp2 ) /* Unknown version */
	...
	ROM_REGION( 0x800000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )	/* 8x8x8 (Sprites) */
	...
	ROM_REGION( 0x800000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE )	/* 16x16x8 (Background) */
	...
	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE )	/* 16x16x8 (Rotation) */
	ROM_LOAD( "96019-04.6",  0x000000, 0x100000, CRC(b849dec9) SHA1(fa7ac00fbe587a74c3fb8c74a0f91f7afeb8682f) )

	ROM_REGION( 0x080000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE )	/* 8x8x8 (Foreground) */
...
ROM_START( teplus2j ) /* Version 2.2 */
	...
	ROM_REGION( 0x400000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE )	/* 16x16x8 (Background) */
	ROM_LOAD( "96019-06.13", 0x000000, 0x400000, CRC(16f7093c) SHA1(2be77c6a692c5d762f5553ae24e8c415ab194cc6) )
...
ROM_START( nndmseal )
	...
	ROM_REGION( 0x100, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE | ROMREGION_ERASE )	/* 8x8x8 (Sprites) */
	// unused
	...
	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE )	// 16x16x8 (Rotation)
	ROM_LOAD( "mr97006-01.2", 0x000000, 0x200000, CRC(32283485) SHA1(14ccd25389b97825d9a727809c3a1de803687c16) )

	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE )	// 8x8x8 (Foreground)
	ROM_LOAD( "mr97006-04.8", 0x000000, 0x100000, CRC(6726a25b) SHA1(4ea49c014477229eaf9de4a0b9bf83021b82c095) )

	ROM_REGION( 0x40000, RGNCLASS_SOUND, "oki", ROMREGION_ERASE )	// Samples
	// filled in from "okisource"

	ROM_REGION( 0x200000, RGNCLASS_SOUND, "okisource", 0 )	// Samples
...
ROM_START( rockn )
	...
	ROM_REGION( 0x400000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )	/* 8x8x8 (Sprites) */
	...
	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE )	/* 16x16x8 (Background) */
	...
	ROM_REGION( 0x7000000, RGNCLASS_SOUND, "ymz", 0 )	/* Samples */
...
ROM_START( rockn3 )
	...
	ROM_REGION( 0x7000000, RGNCLASS_SOUND, "ymz", 0 )	/* Samples - On seperate ROM board with YMZ280B-F sound chip */
...
ROM_START( rocknms )
	...
	ROM_REGION( 0x0800000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )	/* 8x8x8 (Sprites) */
	...
	ROM_REGION( 0x800000, RGNCLASS_GFX, "gfx5", ROMREGION_DISPOSE )	/* 8x8x8 (Sprites) */
	...
	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx6", ROMREGION_DISPOSE )	/* 16x16x8 (Background) */
	ROM_LOAD16_WORD( "slav_back", 0x000000, 0x200000, CRC(f0a28e32) SHA1(517b98dee6ec201bab02a3c81b0937ed462a626e) )

	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx7", ROMREGION_DISPOSE )	/* 16x16x8 (Rotation) */
	ROM_LOAD( "slav_rot", 0x000000, 0x200000, CRC(0bab21f4) SHA1(afd3f32d7bb99b3f566b302fce11059ae8788715) )

	ROM_REGION( 0x080000, RGNCLASS_GFX, "gfx8", ROMREGION_DISPOSE )	/* 8x8x8 (Foreground) */
