...
static ADDRESS_MAP_START( gtmr_readmem, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0x200000, 0x20ffff) AM_READ(SMH_RAM					)	// Shared With MCU
	AM_RANGE(0x300000, 0x30ffff) AM_READ(SMH_RAM					)	// Palette
	AM_RANGE(0x310000, 0x327fff) AM_READ(SMH_RAM					)	//
	AM_RANGE(0x400000, 0x401fff) AM_READ(SMH_RAM					)	// Sprites
	AM_RANGE(0x500000, 0x503fff) AM_READ(SMH_RAM					)	// Layers 0
	AM_RANGE(0x580000, 0x583fff) AM_READ(SMH_RAM					)	// Layers 1
...
static ADDRESS_MAP_START( gtmr_writemem, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0x100000, 0x10ffff) AM_WRITE(SMH_RAM					)	// Work RAM
	AM_RANGE(0x200000, 0x20ffff) AM_WRITE(SMH_RAM) AM_BASE(&kaneko16_mcu_ram	)	// Shared With MCU
	AM_RANGE(0x2a0000, 0x2a0001) AM_WRITE(toybox_mcu_com0_w			)	// To MCU ?
	AM_RANGE(0x2b0000, 0x2b0001) AM_WRITE(toybox_mcu_com1_w			)
	AM_RANGE(0x2c0000, 0x2c0001) AM_WRITE(toybox_mcu_com2_w			)
	AM_RANGE(0x2d0000, 0x2d0001) AM_WRITE(toybox_mcu_com3_w			)
	AM_RANGE(0x300000, 0x30ffff) AM_WRITE(paletteram16_xGGGGGRRRRRBBBBB_word_w) AM_BASE(&paletteram16	)	// Palette
	AM_RANGE(0x310000, 0x327fff) AM_WRITE(SMH_RAM												)	//
	AM_RANGE(0x400000, 0x401fff) AM_WRITE(SMH_RAM) AM_BASE(&spriteram16) AM_SIZE(&spriteram_size			)	// Sprites
	...
	AM_RANGE(0x502000, 0x502fff) AM_WRITE(SMH_RAM) AM_BASE(&kaneko16_vscroll_1					)	//
	AM_RANGE(0x503000, 0x503fff) AM_WRITE(SMH_RAM) AM_BASE(&kaneko16_vscroll_0					)	//
	...
	AM_RANGE(0x582000, 0x582fff) AM_WRITE(SMH_RAM) AM_BASE(&kaneko16_vscroll_3					)	//
	AM_RANGE(0x583000, 0x583fff) AM_WRITE(SMH_RAM) AM_BASE(&kaneko16_vscroll_2					)	//
...
{
	UINT8 *RAM	=	memory_region(machine, RGNCLASS_GFX, region);
	int size			=	memory_region_length(machine, RGNCLASS_GFX, region);
	int i;
...
static void kaneko16_expand_sample_banks(running_machine *machine, const char *region)
{
    ...
    */
	...
	if (memory_region_length(machine, RGNCLASS_SOUND, region) < 0x40000 * 16)
		fatalerror("gtmr SOUND1 region too small");

	/* bank 0 maps to itself, so we just leave it alone */
	src0 = memory_region(machine, RGNCLASS_SOUND, region);
...
ROM_START( explbrkr )
	...
	ROM_REGION( 0x240000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )	/* Sprites */
	...
	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE )	/* Tiles */
	ROM_LOAD( "ts010.u4",  0x000000, 0x100000, CRC(df935324) SHA1(73b7aff8800a4e88a47ad426190b73dabdfbf142) )

	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE )	/* Tiles */
	ROM_LOAD( "ts020.u33",  0x000000, 0x100000, CRC(eb58c35d) SHA1(762c5219de6f729a0fc1df90fce09cdf711c2a1e) )

	ROM_REGION( 0x100000, RGNCLASS_USER, "user1", ROMREGION_DISPOSE )	/* OKI Sample ROM */
	ROM_LOAD( "ts030.u5",    0x000000, 0x100000, CRC(1d68e9d1) SHA1(aaa64a8e8d7cd7f91d2be346fafb9d1f29b40eda) )

	/* $00000-$20000 stays the same in all sound banks, */
	/* the second half of the bank is what gets switched */
	ROM_REGION( 0x200000, RGNCLASS_SOUND, "oki", 0 )	/* Samples */
	ROM_COPY( RGNCLASS_USER, "user1", 0x000000, 0x000000, 0x020000)
	ROM_COPY( RGNCLASS_USER, "user1", 0x020000, 0x020000, 0x020000)
	ROM_COPY( RGNCLASS_USER, "user1", 0x000000, 0x040000, 0x020000)
	ROM_COPY( RGNCLASS_USER, "user1", 0x040000, 0x060000, 0x020000)
	ROM_COPY( RGNCLASS_USER, "user1", 0x000000, 0x080000, 0x020000)
	ROM_COPY( RGNCLASS_USER, "user1", 0x060000, 0x0a0000, 0x020000)
	ROM_COPY( RGNCLASS_USER, "user1", 0x000000, 0x0c0000, 0x020000)
	ROM_COPY( RGNCLASS_USER, "user1", 0x080000, 0x0e0000, 0x020000)
	ROM_COPY( RGNCLASS_USER, "user1", 0x000000, 0x100000, 0x020000)
	ROM_COPY( RGNCLASS_USER, "user1", 0x0a0000, 0x120000, 0x020000)
	ROM_COPY( RGNCLASS_USER, "user1", 0x000000, 0x140000, 0x020000)
	ROM_COPY( RGNCLASS_USER, "user1", 0x0c0000, 0x160000, 0x020000)
	ROM_COPY( RGNCLASS_USER, "user1", 0x000000, 0x180000, 0x020000)
	ROM_COPY( RGNCLASS_USER, "user1", 0x0e0000, 0x1a0000, 0x020000)
...
ROM_START( berlwall )
	...
	ROM_REGION( 0x120000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )	/* Sprites */
	...
	ROM_REGION( 0x080000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE )	/* Tiles (Scrambled) */
	ROM_LOAD( "bw003",  0x000000, 0x080000, CRC(fbb4b72d) SHA1(07a0590f18b3bba1843ef6a89a5c214e8e605cc3) )

	ROM_REGION( 0x400000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE )	/* High Color Background */
...
ROM_START( blazeon )
	...
	ROM_LOAD16_BYTE( "bz_prg2.u81", 0x000001, 0x040000, CRC(b8a0a08b) SHA1(5f275b98d3e49a834850b45179d26e8c2f9fd604) )
 	...
 	ROM_REGION( 0x020000, RGNCLASS_CPU, "audio", 0 )			/* Z80 Code */
	...
	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE )	/* Tiles (Scrambled) */
...
ROM_START( bloodwar )
 	ROM_REGION( 0x100000, RGNCLASS_CPU, "gtmr", 0 )			/* 68000 Code */
	...
	ROM_LOAD16_BYTE( "p1f3.513", 0x000001, 0x080000, CRC(894ecbe5) SHA1(bf403d19e6315266114ac742a08cac903e7b54b5) )
 	...
 	ROM_REGION( 0x020000, RGNCLASS_CPU, "cpu1", 0 )			/* MCU Code */
	ROM_LOAD( "dox3.124",  0x000000, 0x020000, CRC(399f2005) SHA1(ff0370724770c35963953fd9596d9f808ba87d8f) )

	ROM_REGION( 0x1e00000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )	/* Sprites */
...
ROM_START( gtmr )
	...
	ROM_REGION( 0x840000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )	/* Sprites */
	...
	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE )	/* Tiles (scrambled) */
	ROM_LOAD( "mm-300-406-a0.bin",  0x000000, 0x200000, CRC(b15f6b7f) SHA1(5e84919d788add53fc87f4d85f437df413b1dbc5) )

	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE )	/* Tiles (scrambled) */
	ROM_COPY(RGNCLASS_GFX, "gfx2",0,0,0x200000) // it isn't on the board twice.

	ROM_REGION( 0x400000, RGNCLASS_SOUND, "oki1", 0 )	/* Samples, plus room for expansion */
	ROM_LOAD( "mm-100-401-e0.bin",  0x000000, 0x100000, CRC(b9cbfbee) SHA1(051d48a68477ef9c29bd5cc0bb7955d513a0ab94) )	// 16 x $10000

	ROM_REGION( 0x100000, RGNCLASS_SOUND, "oki2", ROMREGION_ERASE00 )	/* Samples */
...
ROM_START( gtmr2 )
	...
	ROM_REGION( 0x440000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE )	/* Tiles (scrambled) */
	...
	ROM_REGION( 0x440000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE )	/* Tiles (scrambled) */
	ROM_COPY(RGNCLASS_GFX, "gfx2",0,0,0x440000) // it isn't on the board twice.
...
ROM_START( mgcrystl ) /* Master Up: 92/01/10 14:21:30 */
 	ROM_REGION( 0x040000*2, RGNCLASS_CPU, "main", ROMREGION_ERASE )			/* 68000 Code */
	...
	ROM_REGION( 0x280000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )	/* Sprites */
...
ROM_START( shogwarr )
	...
	ROM_REGION( 0x400000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE )	/* Tiles (scrambled) */
...
ROM_START( brapboys ) /* Single PCB, fully populated, no rom sub board */
	...
	ROM_REGION( 0x400000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )	/* Sprites */
...
ROM_START( bonkadv )
	...
	ROM_REGION( 0x300000, RGNCLASS_SOUND, "oki2", 0 )	/* Samples */
