...
static GFXDECODE_START( psikyo )
	GFXDECODE_ENTRY( REGION_GFX1, 0, layout_16x16x4, 0x000, 0x20 ) // [0] Sprites
	GFXDECODE_ENTRY( REGION_GFX2, 0, layout_16x16x4, 0x800, 0x48 ) // [1] Layer 0 + 1
GFXDECODE_END
...
{
	{
		...
		int len				=	memory_region_length(machine, REGION_SOUND1);
		int i;
