...
{
	int bank = data;
	int bank_n = memory_region_length(machine, RGNCLASS_CPU, "main")/0x4000 - 1;
	if (bank >= bank_n)
	{
	...
	if (bank >= 3)	bank+=1;
	memory_set_bankptr(1, memory_region(machine, RGNCLASS_CPU, "main") + bank * 0x4000);
}
...
ROM_START( paradise )
	ROM_REGION( 0x44000, RGNCLASS_CPU, "main", 0 )		/* Z80 Code */
	ROM_LOAD( "u128", 0x00000, 0x0c000, CRC(8e5b5a24) SHA1(a4e559d9329f8a7a9d12cd90d98d0525958085d8) )
	ROM_CONTINUE(     0x10000, 0x34000    )

	ROM_REGION( 0x80000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE | ROMREGION_INVERT)	/* 16x16x8 Sprites */
	...
	ROM_REGION( 0x20000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE | ROMREGION_INVERT)	/* 8x8x4 Background */
	ROM_LOAD( "u94", 0x00000, 0x20000, CRC(e3a99209) SHA1(5db79dc1a38d93b458b043499a58516285c65aa8) )

	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE | ROMREGION_INVERT)	/* 8x8x8 Foreground */
	...
	ROM_REGION( 0x40000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE | ROMREGION_INVERT)	/* 8x8x8 Midground */
	...
	ROM_REGION( 0x80000, RGNCLASS_SOUND, "oki2", 0 )	/* Samples (banked) */
...
ROM_START( paradlx )
	...
	ROM_REGION( 0x40000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE | ROMREGION_INVERT)	/* 8x8x4 Background */
...
ROM_START( tgtball )
	...
	ROM_REGION( 0x20000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE | ROMREGION_ERASEFF)	/* 8x8x4 Background */
	/* not for this game? */
	...
	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE | ROMREGION_INVERT)	/* 8x8x8 Midground */
...
ROM_START( torus ) /* Board looks identical to the YS-0402 but has no number printed on the PCB */
	ROM_REGION( 0x14000, RGNCLASS_CPU, "main", 0 )		/* Z80 Code */
...
ROM_START( madball ) /* Models in swimsuits only, no nudity */
	ROM_REGION( 0x24000, RGNCLASS_CPU, "main", 0 )		/* Z80 Code */
	...
	ROM_REGION( 0x80000, RGNCLASS_SOUND, "oki1", 0 )	/* Samples */
