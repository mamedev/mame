...
ROM_START( m5aceclb )
	ROM_REGION( 0x400000, "maincpu", 0 ) /* Code */
...
ROM_START( m5clbtro )
	...
	ROM_LOAD16_BYTE( "trop2_5d.p1", 0x000000, 0x080000, CRC(a5eac7a4) SHA1(77fa99ae3a2ee7d4856a3d9918086a471e161a91) )
ROM_END
...
ROM_START( m5loot )
	...
	ROM_REGION( 0x100000, "altrevs", 0 ) /* Alternate revision Prg ROMs, to be sorted into clones */
	ROM_LOAD16_BYTE( "lkhsjbd1.7_1", 0x000000, 0x080000, CRC(81ba5ccc) SHA1(26375e6f81b926a5033c71f1b53f5b489644525e) )
	ROM_LOAD16_BYTE( "lkhsjbd1.7_2", 0x000000, 0x080000, CRC(d7b40df8) SHA1(4704cbe1c34239b7060135208ed550870ba69483) )
ROM_END
...
ROM_START( m5openbx )
	...
	ROM_LOAD16_BYTE( "obtr01.p5", 0x000000, 0x07ca32, BAD_DUMP CRC(257ae97e) SHA1(dc7ce7cfa73b095751d557ebabf28569476a839b) )
...
GAME( 199?, m5dmnstr	,0,			mpu5, mpu5, 0, ROT0, "Barcrest / Red Gaming","Demon Streak (Barcrest - Red Gaming) (MPU5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 199?, m5fusir		,0,			mpu5, mpu5, 0, ROT0, "Barcrest / Red Gaming","Fruits U Sir (Barcrest - Red Gaming) (MPU5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
...
GAME( 199?, m5lock		,0,			mpu5, mpu5, 0, ROT0, "Barcrest / Red Gaming","Lock 'n' Load (Barcrest - Red Gaming) (MPU5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 199?, m5lockcl	,0,			mpu5, mpu5, 0, ROT0, "Barcrest / Red Gaming","Lock 'n' Load Club (Barcrest - Red Gaming) (MPU5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
...
GAME( 199?, m5rainrn	,0,			mpu5, mpu5, 0, ROT0, "Barcrest / Red Gaming","Rainbow Runner (Barcrest - Red Gaming) (MPU5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
...
GAME( 199?, m5all41		,0,			mpu5, mpu5, 0, ROT0, "Vivid","All 4 One (Vivid) (MPU5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
...
GAME( 199?, m5loot		,0,			mpu5, mpu5, 0, ROT0, "Vivid","Loot 'n' Khamun (Vivid) (MPU5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
...
GAME( 199?, m5clown		,0,			mpu5, mpu5, 0, ROT0, "Bwb","Clown In Around (Bwb) (MPU5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
...
GAME( 199?, m5donna		,0,			mpu5, mpu5, 0, ROT0, "Bwb","Donna Kebab (Bwb) (MPU5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
GAME( 199?, m5dblqts	,0,			mpu5, mpu5, 0, ROT0, "Bwb","Double Or Quits (Bwb) (MPU5)", GAME_NOT_WORKING|GAME_NO_SOUND|GAME_REQUIRES_ARTWORK|GAME_MECHANICAL )
