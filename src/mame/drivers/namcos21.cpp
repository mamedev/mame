...
#define NAMCOS21_SNDROM_LOAD_256K(romname,start,chksum)\
...
ROM_START( aircomb )
	...
	ROM_REGION( 0x400000, "c140", 0 ) /* sound samples */
	NAMCOS21_SNDROM_LOAD_512K("ac1-voi0.12b", 0x000000, CRC(f427b119) SHA1(bd45bbe41c8be26d6c997fcdc226d080b416a2cf) )
	NAMCOS21_SNDROM_LOAD_512K("ac1-voi1.12c", 0x100000, CRC(c9490667) SHA1(4b6fbe635c32469870a8e6f82742be6a9d4918c9) )
	NAMCOS21_SNDROM_LOAD_512K("ac1-voi2.12d", 0x200000, CRC(1fcb51ba) SHA1(80fc815e5fad76d20c3795ab1d89b57d9abc3efd) )
	NAMCOS21_SNDROM_LOAD_512K("ac1-voi3.12e", 0x300000, CRC(cd202e06) SHA1(72a18f5ba402caefef14b8d1304f337eaaa3eb1d) )
...
ROM_START( cybsled )
	...
	ROM_REGION( 0x400000, "c140", 0 ) /* sound samples */
	NAMCOS21_SNDROM_LOAD_512K("cy1-voi0.12b", 0x000000, CRC(99d7ce46) SHA1(b75f4055c3ce847daabfacda22df14e3f80c4fb9) )
	NAMCOS21_SNDROM_LOAD_512K("cy1-voi1.12c", 0x100000, CRC(2b335f06) SHA1(2b2cd407c34388b56496f84a414daa153780b098) )
	NAMCOS21_SNDROM_LOAD_512K("cy1-voi2.12d", 0x200000, CRC(10cd15f0) SHA1(9b721654ed97a13287373c1b2854ac9aeddc271f) )
	NAMCOS21_SNDROM_LOAD_512K("cy1-voi3.12e", 0x300000, CRC(c902b4a4) SHA1(816357ec1a02a7ebf817ac1182e9c50ce5ca71f6) )
...
*/
	...
	ROM_REGION( 0x400000, "c140", 0 ) /* sound samples */
	NAMCOS21_SNDROM_LOAD_256K("de1-voi0.12b", 0x040000, CRC(fc44adbd) SHA1(4268bb1f025e47a94212351d1c1cfd0e5029221f) )
	NAMCOS21_SNDROM_LOAD_256K("de1-voi1.12c", 0x140000, CRC(a71dc55a) SHA1(5e746184db9144ab4e3a97b20195b92b0f56c8cc) )
	NAMCOS21_SNDROM_LOAD_256K("de1-voi2.12d", 0x240000, CRC(4d32879a) SHA1(eae65f4b98cee9efe4e5dad7298c3717cfb1e6bf) )
	NAMCOS21_SNDROM_LOAD_256K("de1-voi3.12e", 0x340000, CRC(e4832d18) SHA1(0460c79d3942aab89a765b0bd8bbddaf19a6d682) )
ROM_END
...
ROM_START( starblad )
	...
	ROM_REGION( 0x400000, "c140", 0 ) /* sound samples */
	NAMCOS21_SNDROM_LOAD_512K("st1-voi0.bin", 0x000000, CRC(5b3d43a9) SHA1(cdc04f19dc91dca9fa88ba0c2fca72aa195a3694) )
	NAMCOS21_SNDROM_LOAD_512K("st1-voi1.bin", 0x100000, CRC(413e6181) SHA1(e827ec11f5755606affd2635718512aeac9354da) )
	NAMCOS21_SNDROM_LOAD_512K("st1-voi2.bin", 0x200000, CRC(067d0720) SHA1(a853b2d43027a46c5e707fc677afdaae00f450c7) )
	NAMCOS21_SNDROM_LOAD_512K("st1-voi3.bin", 0x300000, CRC(8b5aa45f) SHA1(e1214e639200758ad2045bde0368a2d500c1b84a) )
...
ROM_START( solvalou )
	...
	ROM_REGION( 0x400000, "c140", 0 ) /* sound samples */
	NAMCOS21_SNDROM_LOAD_512K("sv1-voi0.bin", 0x000000, CRC(7f61bbcf) SHA1(b3b7e66e24d9cb16ebd139237c1e51f5d60c1585) )
	NAMCOS21_SNDROM_LOAD_512K("sv1-voi1.bin", 0x100000, CRC(c732e66c) SHA1(14e75dd9bea4055f85eb2bcbf69cf6695a3f7ec4) )
	NAMCOS21_SNDROM_LOAD_512K("sv1-voi2.bin", 0x200000, CRC(51076298) SHA1(ec52c9ae3029118f3ea3732948d6de28f5fba561) )
	NAMCOS21_SNDROM_LOAD_512K("sv1-voi3.bin", 0x300000, CRC(33085ff3) SHA1(0a30b91618c250a5e7bd896a8ceeb3d16da178a9) )
ROM_END
...
ROM_START( winrun )
	...
	ROM_REGION( 0x400000, "c140", 0 ) /* sound samples */
	NAMCOS21_SNDROM_LOAD_256K("wr-voi-0.11b", 0x040000, CRC(8040b645) SHA1(7ccafb3073fa79910e26cf9b8b6e8e9ae22e55fc) )
	NAMCOS21_SNDROM_LOAD_256K("wr-voi-1.11c", 0x140000, CRC(d347e904) SHA1(620cd07e6230322c306283e45a43fa1e217028d4) )
	NAMCOS21_SNDROM_LOAD_256K("wr-voi-2.11d", 0x240000, CRC(b34747af) SHA1(7e0b55631bffa0583bf4f7f5368db9f09e411ba1) )
	NAMCOS21_SNDROM_LOAD_256K("wr-voi-3.11e", 0x340000, CRC(43085303) SHA1(9f743055c20df3548879118194244e37a0b91f7e) )
...
ROM_START( winrungp )
	...
	ROM_REGION( 0x400000, "c140", 0 ) /* sound samples */
	NAMCOS21_SNDROM_LOAD_512K("sg-voi-1.11c", 0x100000, CRC(7dcccb31) SHA1(4441b37691434b13eae5dee2d04dc12a56b04d2a) )
	NAMCOS21_SNDROM_LOAD_512K("sg-voi-3.11e", 0x300000, CRC(a198141c) SHA1(b4ca352e6aedd9d7a7e5e39e840f1d3a7145900e) )
ROM_END
...
ROM_START( winrun91 )
	...
	ROM_REGION( 0x400000, "c140", 0 ) /* sound samples */
	NAMCOS21_SNDROM_LOAD_512K("r911-avo1.11c", 0x100000, CRC(9fb33af3) SHA1(666630a8e5766ca4c3275961963c3e713dfdda2d) )
	NAMCOS21_SNDROM_LOAD_512K("r911-avo3.11e", 0x300000, CRC(76e22f92) SHA1(0e1b8d35a5b9c20cc3192d935f0c9da1e69679d2) )
ROM_END
