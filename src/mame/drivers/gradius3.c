...
ROM_START( gradius3 )
	...
	ROM_REGION( 0x100000, RGNCLASS_CPU, "sub", 0 )
	...
	ROM_REGION( 0x20000, RGNCLASS_GFX, "gfx1", ROMREGION_ERASE00 )	/* fake */
	/* gfx data is dynamically generated in RAM */

	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx2", 0 )	/* graphics (addressable by the main CPU) */
	...
	ROM_REGION( 0x80000, RGNCLASS_SOUND, "konami", 0 )	/* 007232 samples */
