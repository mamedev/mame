...
ROM_START( sidearms )
	ROM_REGION( 0x20000, RGNCLASS_CPU, "main", 0 )     /* 64k for code + banked ROMs images */
	...
	ROM_REGION( 0x08000, RGNCLASS_USER, "user1", 0 )    /* starfield data */
	...
	ROM_REGION( 0x08000, RGNCLASS_GFX, "gfx4", 0 )	/* background tilemaps */
