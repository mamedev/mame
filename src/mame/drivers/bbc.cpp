...
static INPUT_PORTS_START(bbc_keypad)
	...
	PORT_BIT(0x10, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME("Keypad DELETE")
	...
	PORT_BIT(0x20, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME("Keypad ,")
...
COMP( 1986, bbcm512,  bbcm,   0,      bbcm512,  bbcm,   bbc_state,   init_bbc, "Acorn",           "BBC Master 512",                MACHINE_NOT_WORKING)
