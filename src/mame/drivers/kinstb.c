...
{
	INT32 i;
	UINT8 *rom = memory_region(machine, RGNCLASS_USER, "user3");
...
ROM_START( kinstb )
	ROM_REGION( 0x400000, RGNCLASS_USER, "user3", ROMREGION_DISPOSE )
	...
	ROM_REGION(0x100,           RGNCLASS_USER, "user5", 0)
	ROM_LOAD("spc700.rom", 0, 0x40, CRC(44bb3a40) SHA1(97e352553e94242ae823547cd853eecda55c20f0) )

	ROM_REGION(0x800,           RGNCLASS_USER, "user6", ROMREGION_ERASEFF)
