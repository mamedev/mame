...
{
	const UINT8* DECODE = memory_region(machine, RGNCLASS_USER, "user1");

	UINT8* p1 = memory_region(machine, RGNCLASS_CPU, "main") + 0x00000;
	UINT8* p2 = memory_region(machine, RGNCLASS_CPU, "main") + 0x10000;
