...
ROM_START(aust301)
	...
	ROM_REGION(0x1000000, "bsmt", 0 )
	ROM_LOAD("apsndu17.100", 0x000000, 0x080000, CRC(c1e33fee) SHA1(5a3581584cc1a841d884de4628f7b65d8670f96a))
	ROM_CONTINUE(0x200000, 0x080000)
	ROM_LOAD("apsndu21.100", 0x080000, 0x080000, CRC(07c3e077) SHA1(d48020f7da400c3682035d537289ce9a30732d74))
	ROM_CONTINUE(0x280000, 0x080000)
	ROM_LOAD("apsndu36.100", 0x100000, 0x080000, CRC(f70f2828) SHA1(9efbed4f68c22eb26e9100afaca5ebe85a97b605))
	ROM_CONTINUE(0x300000, 0x080000)
	ROM_LOAD("apsndu37.100", 0x180000, 0x080000, CRC(ddf0144b) SHA1(c2a56703a41ee31841993d63385491259d5a13f8))
