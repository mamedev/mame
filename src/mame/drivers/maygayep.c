...
ROM_START( ep_spirt )
	...
	ROM_REGION( 0x100000, "ymz", 0 )
	ROM_LOAD( "hispsnd.p1", 0x000001, 0x080000, CRC(3d4b265b) SHA1(6a5ca56395c4c57b302aa6f0a066ceb54deedacc) )
...
ROM_START( ep_snbev )
	...
	ROM_REGION( 0x200000, "altrevs2", 0 ) /* different hardware */
...
ROM_START( ep_grncld )
	ROM_REGION( 0x080000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "grid3-3n.p0", 0x000000, 0x020000, NO_DUMP ) // or does it pair with one of the above?
	ROM_LOAD16_BYTE( "grid3-3n.p1", 0x000001, 0x020000, CRC(26c8d7cb) SHA1(fadeea78abc0b90c7527acaff5f08f9f24e8b67a) )
	MISSING_SOUND
ROM_END

ROM_START( ep_grncle )
	ROM_REGION( 0x080000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "grid3-4p.p0", 0x000000, 0x020000, NO_DUMP ) // or does it pair with one of the above?
	ROM_LOAD16_BYTE( "grid3-4p.p1", 0x000001, 0x020000, CRC(410f5571) SHA1(38536c41f103ec94e866cad4d7d80d4b66028b2e) )
	MISSING_SOUND
ROM_END
...
ROM_START( ep_smoke )
	...
	ROM_LOAD( "h smoke.g0", 0x000000, 0x020000, CRC(dc3d37f5) SHA1(f9bf1ff7f97044f66ded4886ad8e81ee47376c7e) )
	ROM_LOAD( "h smoke.g1", 0x000001, 0x020000, CRC(c6eba9e8) SHA1(4c79b9e193d3d5f0ceaaad0ba28ae35ef671d033) )
	ROM_LOAD( "h smoke.g2", 0x040000, 0x020000, CRC(28faa741) SHA1(97009cd81086a910a0888cb7ed0e61c55f8d4571) )
	ROM_LOAD( "h smoke.g3", 0x040001, 0x020000, CRC(bf4d199a) SHA1(c43597ff62f0609ad9faf576cc75f0aa7b583de7) )
...
ROM_START( ep_kopcl )
	...
	ROM_LOAD( "ko_punch.g0", 0x000000, 0x020000, CRC(03e371c7) SHA1(d34091d27800fd3d681f74f85141bc313afe3186) )
	ROM_LOAD( "ko_punch.g1", 0x000001, 0x020000, CRC(e495b309) SHA1(5daed67ed107df904aa64bad8ff5d73b23a8d904) )
...
ROM_START( ep_ltt )
	...
	ROM_LOAD16_BYTE( "thrl1-2p.p2", 0x000001, 0x100000, CRC(a93c8b13) SHA1(a27aeac98295bb615cb3662a7a3cde84f107b6d6) )
	MISSING_SOUND
ROM_END
...
ROM_START( ep_mummy )
	...
	ROM_LOAD( "mummytal.g0", 0x000000, 0x080000, CRC(443c5607) SHA1(5c83124ebdde55608ffd94707692e005e12d5bde) )
	ROM_LOAD( "mummytal.g1", 0x000001, 0x080000, CRC(d5d9b807) SHA1(da931bc562a86d6957729d81cf49b4d651d91024) )
	ROM_LOAD( "mummytal.g2", 0x040000, 0x080000, CRC(7237b6f9) SHA1(f89e894868f3ac0c84c333b853bd0a8cf6f728f2) )
	ROM_LOAD( "mummytal.g3", 0x040001, 0x080000, CRC(8569eb03) SHA1(8e13ad5fda3c95a99e684ce931d05d5b1ad48d95) )
...
ROM_START( ep_wud )
	...
	ROM_REGION( 0x200000, "altrevs", 0 ) /* split into clones later */
	ROM_LOAD16_BYTE( "car2-9n.p1", 0x000001, 0x008000, CRC(be523840) SHA1(a6b5b36cf8ee495c2271a879b28e4f388b9deba1) )
	ROM_LOAD16_BYTE( "car2-9n.p2", 0x040000, 0x008000, CRC(865c23f3) SHA1(e4e874cc003cb62012cdc741e163becfb29caa12) )
...
ROM_START( ep_wside )
	...
	ROM_LOAD16_BYTE( "wildside.g0", 0x000000, 0x018000, BAD_DUMP CRC(040e5f1d) SHA1(e5bade050871841ad13c19ff39a84918549cd699) )
	MISSING_SOUND
ROM_END
...
GAME( 199?, ep_grncld,	ep_grncl,	maygayep,  maygayep, maygayep_state,  0,  ROT0, "Global",        "Grid Runner Club (Global) (EPOCH) (set 5)",GAME_IS_SKELETON_MECHANICAL )
GAME( 199?, ep_grncle,	ep_grncl,	maygayep,  maygayep, maygayep_state,  0,  ROT0, "Global",        "Grid Runner Club (Global) (EPOCH) (set 6)",GAME_IS_SKELETON_MECHANICAL )
