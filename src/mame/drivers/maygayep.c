...
ROM_START( ep_wipeo )
	...
	ROM_LOAD16_BYTE( "wipeoutgame3.bin", 0x040001, 0x020000, CRC(0c45a675) SHA1(155c458620aa2ea8aaf4ff18a09b62df3f50b508) )
	EP_WIPEO_SOUND
ROM_END
...
ROM_START( ep_bvruc )
	...
	ROM_LOAD( "b_uncove.g1", 0x000001, 0x020000, CRC(34635292) SHA1(edaa0b71a1a4d50e43e75638327e3422738d78ac) )
	ROM_LOAD( "b_uncove.g2", 0x040000, 0x020000, CRC(be9501f5) SHA1(939b7c4776061ed209846e59c3c7b25a590eb005) )
	ROM_LOAD( "b_uncove.g3", 0x040001, 0x020000, CRC(05250939) SHA1(f9a3056a4e7b9fcfc8d777166f6682dc703ae4aa) )
	ROM_LOAD( "b_uncovr.g0", 0x000000, 0x020000, CRC(902b741f) SHA1(1f55f45a46444cfb0f91aa4f47b99d091844a19f) )
	...
	ROM_LOAD( "uncoverd.g2", 0x040000, 0x020000, CRC(31cfd4b2) SHA1(f215899f9de58a1d7200acfdc92e6c65a5f88c71) )
...
ROM_START( ep_bjclb )
	...
	//ROM_REGION( 0x080000, "altrevs", 0 ) /* split into clones later */
	//ROM_LOAD16_BYTE( "blackjak.p1", 0x000001, 0x020000, BAD_DUMP CRC(31660bf5) SHA1(225c8ef7138b642cbf07a0cb8a575b1e768463ca) ) // FIXED BITS (xxxxxx1x)
...
ROM_START( ep_cbrun )
	...
	ROM_LOAD16_BYTE( "cann2-4n.p2", 0x040000, 0x100000, CRC(19a1a7c2) SHA1(dab5b084d8b1ba21c31d7fb1ff052c81797c66c6) )
	ROM_LOAD16_BYTE( "cann2-4n.p3", 0x040001, 0x100000, CRC(0fcc8bfc) SHA1(311fe6283df3520bbe1695357df6ed4a3e0f0bd7) )
	...
	ROM_LOAD16_BYTE( "cann2-4p.p3", 0x040001, 0x100000, CRC(0fcc8bfc) SHA1(311fe6283df3520bbe1695357df6ed4a3e0f0bd7) )
...
//  ROM_LOAD16_BYTE( "gridrunnergame1.bin", 0x000001, 0x020000, CRC(28a2ea37) SHA1(1c562c6b93f324752ade39aa40664ccc6c459bcd) )
//  ROM_LOAD16_BYTE( "gridrunnergame2.bin", 0x040000, 0x020000, CRC(0f2e2461) SHA1(51c8ee2bb352c7fe5af928017a2698debfe3aa26) )
//  ROM_LOAD16_BYTE( "gridrunnergame3.bin", 0x040001, 0x020000, CRC(78aa85ae) SHA1(65587da39d0d62d2dd34422df182dcad15fe734c) )
...
ROM_START( ep_bartkf )
	ROM_REGION( 0x080000, "maincpu", 0 )
	ROM_LOAD( "bar_trek.g0", 0x000000, 0x020000, CRC(661965f9) SHA1(f6fd83a9be14e4d2d5bbf1fbb33cc99f12d18ffa) )
	ROM_LOAD( "bar_trek.g1", 0x000001, 0x020000, CRC(24f86ffc) SHA1(bc839b08f5b6cc604710adb17497d5be3cd47d4c) )
	MISSING_SOUND
ROM_END
...
ROM_START( ep_cahoya )
	ROM_REGION( 0x080000, "maincpu", 0 )
	ROM_LOAD( "c_ahoy.g0", 0x000000, 0x020000, CRC(20be6dfc) SHA1(abda6674c7663f3136d270fbec5b214f3d7e33ee) )
	ROM_LOAD( "c_ahoy.g1", 0x000001, 0x020000, CRC(a363f246) SHA1(3c609d803e6f9b43717e38e7c9264d6a1a115837) )
	MISSING_SOUND
ROM_END

ROM_START( ep_cahoyb )
	ROM_REGION( 0x080000, "maincpu", 0 )
	ROM_LOAD( "c_ahoy 5pound.g0", 0x000000, 0x020000, CRC(dc7a5c0d) SHA1(d6068e72ab3025c601752f18f144917a6da1d5df) )
	ROM_LOAD( "c_ahoy 5pound.g1", 0x000001, 0x020000, CRC(fb92b892) SHA1(3cfe1486ee6b312259efda4a1eeb4d415b0c9dc1) )
	MISSING_SOUND
ROM_END
...
ROM_START( ep_chockb )
	ROM_REGION( 0x100000, "maincpu", 0 ) // why are these larger?
	ROM_LOAD( "chocs_aw.g0", 0x000000, 0x080000, CRC(f84d5d17) SHA1(39cc1fc0d6a3ca6b7a7040b19b5a7da157f384ec) )
	ROM_LOAD( "chocs_aw.g1", 0x000001, 0x080000, CRC(73c38daf) SHA1(79da1d3a4b3841ba53d61b4afa3ae254ad4d067a) )
	MISSING_SOUND
ROM_END
...
ROM_START( ep_commd )
	...
	ROM_LOAD( "comp_mad.g0", 0x000000, 0x020000, CRC(62635ff9) SHA1(6b3b8bbb2661e778b2f0b978dc36736576100ce7) )
	ROM_LOAD( "comp_mad.g1", 0x000001, 0x020000, CRC(7a4b3177) SHA1(c77ef01c9cfe9662f417d6ac7609c4864f2e8d43) )
...
ROM_START( ep_cycl )
	...
	ROM_LOAD16_BYTE( "cycl_upd.g0", 0x000000, 0x020000, CRC(3f98b4ad) SHA1(701865863e84aefade7de05f2fbf98c78db2cef7) )
	ROM_LOAD16_BYTE( "cycl_upd.g1", 0x000001, 0x020000, CRC(00b0e152) SHA1(9741b59b9756480f79e4ecdafbeb0a8d6e30ccba) )
...
ROM_START( ep_flash )
	...
	ROM_LOAD( "fl_back.g0", 0x000000, 0x020000, CRC(dcf838f0) SHA1(1151d7c3ab2379b1ef7998e159e2d31fad840966) )
	ROM_LOAD( "fl_back.g1", 0x000001, 0x020000, CRC(6ddf2a50) SHA1(4460cfc5ed3e0b5d5a1932d33e3f6ca03daa1469) )


	ROM_REGION( 0x100000, "ymz", 0 )
//  ROM_LOAD( "flashback sound 1 imp99fl01.bin", 0x000001, 0x080000, CRC(4ff8b006) SHA1(bfe7b83b1bcc81f5980263db26e0c3dd8074518b) )
...
ROM_START( ep_hhclb )
	...
	ROM_LOAD( "h_house.g0", 0x000000, 0x020000, CRC(71476052) SHA1(d97785b7e64c30d4bfdd12ffd68e3d1f1e9dd311) )
	ROM_LOAD( "h_house.g1", 0x000001, 0x020000, CRC(5b2d7fd7) SHA1(885221d0ec354dc6bb8813fddd8db1729ec07d3b) )
	ROM_LOAD( "h_house.g2", 0x040000, 0x020000, CRC(3277bba8) SHA1(b6b7005d3a056f9bcbc6960b50cb7acabe1781dd) )
	ROM_LOAD( "h_house.g3", 0x040001, 0x020000, CRC(9acfcbe8) SHA1(bada40fc9886aa59c6c9a793ef904d9d82a9efe5) )
...
ROM_START( ep_highv )
	...
	ROM_LOAD( "hi_volt.g0", 0x000000, 0x020000, CRC(863a7c78) SHA1(2de7fed4bd78508c1ae985ad97a4a265d5789c78) )
	ROM_LOAD( "hi_volt.g1", 0x000001, 0x020000, CRC(7c579950) SHA1(37e6edbfd0d969002fd98d2be824a9b85223d0ec) )
...
ROM_START( ep_hogmn )
	...
	ROM_LOAD16_BYTE( "i99phm17.g1", 0x000001, 0x020000, CRC(51022b50) SHA1(47cb0d9b4a6012f87e12f07e2adcdd841d1e336a) )
	MISSING_SOUND
ROM_END
...
ROM_START( ep_tits )
	...
	ROM_LOAD( "ttl_shot.g0", 0x000000, 0x020000, CRC(f2fcd2c7) SHA1(89fe906dae0a85ff548ed97c449a5f22df30c605) )
	ROM_LOAD( "ttl_shot.g1", 0x000001, 0x020000, CRC(3474b2be) SHA1(fa3173b45c967dd18712b0ea9bda264a47fa8e70) )
...
ROM_START( ep_tp )
	...
	ROM_LOAD( "triv_pur.g0", 0x000000, 0x020000, CRC(3197e48e) SHA1(ae4328df20f27e0edf35ed5d872ad452c23e0094) )
	ROM_LOAD( "triv_pur.g1", 0x000001, 0x020000, CRC(7d63c3bd) SHA1(6625361a549baed733e7d0d2b1eb87e417a73fc6) )
	ROM_LOAD( "triv_pur.g2", 0x040000, 0x020000, CRC(aca47c0c) SHA1(c23926b98439cac5d7982a9ca7767b9e79ba096e) )
	ROM_LOAD( "triv_pur.g3", 0x040001, 0x020000, CRC(e2a446cf) SHA1(9327f1fe39b8d012928892d1ebec9a6a1405df2a) )
...
ROM_START( ep_tutcl )
	...
	ROM_LOAD( "tut_karm.g1", 0x000001, 0x020000, CRC(799dca4f) SHA1(92093e336c53489029d5b78c025dd8c248a1cf2b) )
...
ROM_START( ep_fullm )
	...
	ROM_LOAD16_BYTE( "f_moon.g3", 0x040001, 0x080000, CRC(2ff659ab) SHA1(d7dd545abf6b3794b114690a5c53e488d8bb3f02) ) // paired with i00pff18.g0 i00nff18.g1 i00nff18.g2 (original names f_moon.gx) either i00nff18.g3 or this is probably a bad dump
...
GAME( 1999, ep_simpi,	ep_simp,	maygayep,  maygayep,  0,  ROT0, "Maygay",        "The Simpsons (Maygay) (EPOCH) (set 10)",        GAME_IS_SKELETON_MECHANICAL )
GAME( 1999, ep_simpj,	ep_simp,	maygayep,  maygayep,  0,  ROT0, "Maygay",        "The Simpsons (Maygay) (EPOCH) (set 11)",        GAME_IS_SKELETON_MECHANICAL )
GAME( 1999, ep_simpk,	ep_simp,	maygayep,  maygayep,  0,  ROT0, "Maygay",        "The Simpsons (Maygay) (EPOCH) (set 12)",        GAME_IS_SKELETON_MECHANICAL )
GAME( 1999, ep_simpl,	ep_simp,	maygayep,  maygayep,  0,  ROT0, "Maygay",        "The Simpsons (Maygay) (EPOCH) (set 13)",        GAME_IS_SKELETON_MECHANICAL )
GAME( 1999, ep_simpm,	ep_simp,	maygayep,  maygayep,  0,  ROT0, "Maygay",        "The Simpsons (Maygay) (EPOCH) (set 14)",        GAME_IS_SKELETON_MECHANICAL )
...
GAME( 199?, ep_wipeod,	ep_wipeo,	maygayep,  maygayep,  0,  ROT0, "Maygay",        "Wipeout (Maygay) (EPOCH) (set 5)",        GAME_IS_SKELETON_MECHANICAL )
GAME( 199?, ep_wipeoe,	ep_wipeo,	maygayep,  maygayep,  0,  ROT0, "Maygay",        "Wipeout (Maygay) (EPOCH) (set 6)",        GAME_IS_SKELETON_MECHANICAL )
...
GAME( 199?, ep_cflowb,	ep_cflow,	maygayep,  maygayep,  0,  ROT0, "Maygay",        "Cash Flow (Maygay) (EPOCH) (set 3)",        GAME_IS_SKELETON_MECHANICAL )
GAME( 199?, ep_cflowc,	ep_cflow,	maygayep,  maygayep,  0,  ROT0, "Maygay",        "Cash Flow (Maygay) (EPOCH) (set 4)",        GAME_IS_SKELETON_MECHANICAL )
GAME( 199?, ep_cflowd,	ep_cflow,	maygayep,  maygayep,  0,  ROT0, "Maygay",        "Cash Flow (Maygay) (EPOCH) (set 5)",        GAME_IS_SKELETON_MECHANICAL )
