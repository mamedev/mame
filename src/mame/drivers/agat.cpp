...
#include "bus/a2bus/agat7video.h"
...
static SLOT_INTERFACE_START(agat7_cards)
	...
	SLOT_INTERFACE("a7lang", A2BUS_AGAT7LANGCARD) // Agat-7 RAM Language Card -- 3.089.119 in LC mode
	SLOT_INTERFACE("a7ram", A2BUS_AGAT7RAM) // Agat-7 32K RAM Card -- 3.089.119-01 in RAM mode, KR565RU6D chips
	SLOT_INTERFACE("diskii", A2BUS_DISKII) // Disk II clone -- 3.089.105
	// 840K floppy controller -- 7.104.351
	// Serial-parallel card -- 3.089.106
	// Printer card (agat9) -- 3.089.174
...
//	MCFG_RAM_EXTRA_OPTIONS("64K,128K")
	...
	MCFG_A2BUS_SLOT_ADD(A7_BUS_TAG, "sl3", agat7_cards, "diskii")
	MCFG_SLOT_OPTION_DEFAULT_BIOS("diskii", "agat7")
	...
	MCFG_A2BUS_ONBOARD_ADD("a2bus", "sl7", A2BUS_AGAT7VIDEO, NOOP)
