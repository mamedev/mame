...
#define GAME_CUSTOM(year, setname,parent,name,offset,length,hash,company,title) \
	ROM_START( setname ) \
		...
		M4BIGMT_EXTRA_ROMS \
	ROM_END \
	GAME(year, setname, parent, bwboki, mpu4_impcoin, mpu4bwb_machines_state, init_m4default ,ROT0,company,title,GAME_FLAGS )

// string at 38e1, X is 372f
...
#define GAME_CUSTOM(year, setname,parent,name,offset,length,hash,company,title) \
	ROM_START( setname ) \
		...
		M4BLSBYS_EXTRA_ROMS \
	ROM_END \
	GAME(year, setname, parent, bwboki, mpu4_impcoin, mpu4bwb_machines_state, init_m_blsbys, ROT0, company, title, GAME_FLAGS )
...
#define GAME_CUSTOM(year, setname,parent,name,offset,length,hash,company,title) \
	ROM_START( setname ) \
		...
		M4BLUESN_EXTRA_ROMS \
	ROM_END \
	GAME(year, setname, parent, bwboki, mpu4_impcoin, mpu4bwb_machines_state, init_m4default_big ,ROT0,company,title,GAME_FLAGS )
