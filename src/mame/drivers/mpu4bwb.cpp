...
#define GAME_CUSTOM(year, setname,parent,name,offset,length,hash,company,title) \
	ROM_START( setname ) \
		...
		M4BIGMT_EXTRA_ROMS \
	ROM_END \
	GAME(year, setname, parent, mod4oki_cheatchr, mpu4, mpu4bwb_machines_state, init_m4default ,ROT0,company,title,GAME_FLAGS )
...
#define GAME_CUSTOM(year, setname,parent,name,offset,length,hash,company,title) \
	ROM_START( setname ) \
		...
		M4BINGBL_EXTRA_ROMS \
	ROM_END \
	GAME(year, setname, parent, mod4oki, mpu4, mpu4bwb_machines_state, init_m4default ,ROT0,company,title,GAME_FLAGS )
...
#define GAME_CUSTOM(year, setname,parent,name,offset,length,hash,company,title) \
	ROM_START( setname ) \
		...
		M4BLSBYS_EXTRA_ROMS \
	ROM_END \
	GAME(year, setname, parent, bwboki, mpu4, mpu4bwb_machines_state, init_m_blsbys, ROT0, company, title, GAME_FLAGS )
