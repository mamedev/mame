...
static const uint32_t m4bigmt_keys[2] = { 0xff, 0xffffffff };
...
static const uint32_t m4bingbl_keys[2] = { 0xff, 0xffffffff };
...
static const uint32_t m4bingbs_keys[2] = { 0xff, 0xffffffff };
...
static const uint32_t m4bingcl_keys[2] = { 0xff, 0xffffffff };
...
#define GAME_CUSTOM(year, setname,parent,name,offset,length,hash,company,title) \
	ROM_START( setname ) \
		...
		M4BLSBYS_EXTRA_ROMS \
	ROM_END \
	GAME(year, setname, parent, bwboki_chr_cheat<m4blsbys_keys>, mpu4_impcoin, mpu4bwb_machines_state, init_m_blsbys, ROT0, company, title, GAME_FLAGS )
...
#define GAME_CUSTOM(year, setname,parent,name,offset,length,hash,company,title) \
	ROM_START( setname ) \
		...
		M4BLSBYS_EXTRA_ROMS \
	ROM_END \
	GAME(year, setname, parent, bwboki_chr_cheat<m4blsbys_g_keys>, mpu4_impcoin, mpu4bwb_machines_state, init_m_blsbys, ROT0, company, title, GAME_FLAGS )
...
static const uint32_t m4csoc_keys[2] = { 0xff, 0xffffffff };
...
// common value 13 | keys 1f1e231e
static const uint32_t m4daytn_keys[2] = { 0xff, 0xffffffff };
...
static const uint32_t m4exotic_keys[2] = { 0xff, 0xffffffff };
// common value 34 | keys 3f0e260e
...
// common value 11 | keys 16241324
static const uint32_t m4firice_keys[2] = { 0xff, 0xffffffff };
...
// common value 11 | keys 3f0b260b
static const uint32_t m4hvhel_keys[2] = { 0xff, 0xffffffff };
...
// common value 13 | keys 10223322
static const uint32_t m4indycr_keys[2] = { 0xff, 0xffffffff };
...
static const uint32_t m4jakjok_keys[2] = { 0xff, 0xffffffff };
// common value 11 | keys 10321832
...
static const uint32_t m4madmon_keys[2] = { 0xff, 0xffffffff };
...
static const uint32_t m4madmnc_keys[2] = { 0xff, 0xffffffff };
...
static const uint32_t m4mmm_keys[2] = { 0xff, 0xffffffff };
...
static const uint32_t m4orland_keys[2] = { 0xff, 0xffffffff };
...
static const uint32_t m4pzbing_keys[2] = { 0xff, 0xffffffff };
