...
/*********************************************************
   Crazy Monkey
	...
	ROM_LOAD( "crazy_monkey.001", 0x000000, 0x80000, CRC(665ae6a1) SHA1(2ef2d657918d66d303d45d2d82430d13108f3fad) ) // This set appears on the official hash list, but after 070402 update?
	ROM_LOAD( "crazy_monkey.002", 0x100000, 0x80000, CRC(1a8e235a) SHA1(6d562cc5250283fc0c8ca7e103231a2e5bab4c69) )
	ROM_LOAD( "crazy_monkey.003", 0x200000, 0x80000, CRC(415133eb) SHA1(227f7c8858fd5b928fdde691017104d3bd69910a) )
	ROM_LOAD( "crazy_monkey.004", 0x300000, 0x80000, CRC(ec45fe14) SHA1(4a0fc87e2f19ea05c9a5746bb4ca7cafe5592d33) )

	ROM_LOAD( "5a", 0x080000, 0x80000, CRC(ef898756) SHA1(4753c9fce56487dd9ff5a257ac4e368f58eae799) ) // Bad Dump... 1 bit difference
...
ROM_START( crzmon ) // 030217
	...
	ROM_LOAD( "crazy_monkey.005", 0x080000, 0x80000, CRC(9d4d2a94) SHA1(c714e110de628b343dfc7fff23befaa1276056a9) )
	ROM_LOAD( "crazy_monkey.006", 0x180000, 0x80000, CRC(a15f0fee) SHA1(3f06d5a1a41e1335bcc7586a5ea95b9b734155c0) )
	ROM_LOAD( "crazy_monkey.007", 0x280000, 0x80000, CRC(715a2528) SHA1(6c4c72592568ecbaa9518fb7271d2714dd22dbbb) )
	ROM_LOAD( "crazy_monkey.008", 0x380000, 0x80000, CRC(6fdb6fd5) SHA1(f40916112365de258956ec033aff79aae1f58690) )
ROM_END
...
ROM_START( fcockt_8 ) // 060111
	...
	ROM_LOAD( "fruitcocktail.007", 0x280000, 0x80000, CRC(20f87a15) SHA1(cb60866a3543668f3592c270b445dee881d78128) )
...
/*********************************************************
   Lucky Haunter
	...
	ROM_LOAD( "lucky_haunter.001", 0x000000, 0x80000, CRC(c541ce0f) SHA1(5b5ad171168f204e1a4892a4be06a4983dcfc5e5) ) // This set appears on the official hash list, but after 070402 update?
	ROM_LOAD( "lucky_haunter.002", 0x100000, 0x80000, CRC(ea49e52f) SHA1(7c6b0da1c4ebca5439dda7d38882055b47d00169) )
	ROM_LOAD( "lucky_haunter.003", 0x200000, 0x80000, CRC(f601cd05) SHA1(b983d703ff5f5795ed60248cd4affc91f983072c) )
	ROM_LOAD( "lucky_haunter.004", 0x300000, 0x80000, CRC(10040104) SHA1(966abcccb67949b73f84ffc85ead70b10856fa5b) )
...
ROM_START( lhaunt ) // 030707
	...
	ROM_LOAD( "lucky_haunter.005", 0x080000, 0x80000, CRC(b50c90a3) SHA1(74749f4ffb5b0630631b511fc3230c6e7b50dc3b) )
	ROM_LOAD( "lucky_haunter.006", 0x180000, 0x80000, CRC(4eaaab64) SHA1(9fed16f8e0308200fd16c4b1e511e1bf6c22ae66) )
	ROM_LOAD( "lucky_haunter.007", 0x280000, 0x80000, CRC(64d16ba9) SHA1(3b897183d6e0f1256be7657441f234fc72077682) )
	ROM_LOAD( "lucky_haunter.008", 0x380000, 0x80000, CRC(1bdf6252) SHA1(7b5ae82a95a744b236e109024d47b526dccf9c14) )
ROM_END
...
/*********************************************************
   Garage
	...
	ROM_LOAD( "garage.001", 0x000000, 0x80000, CRC(15349b8c) SHA1(4f59e67114d7440dab82655787a6df9404bcb4b2) ) // This set appears on the official hash list, but after 070213 update?
...
ROM_START( garage ) // 040122.
	...
	ROM_LOAD( "garage.005", 0x080000, 0x80000, CRC(5bf85bc5) SHA1(ff9d2b9cbcd2af6f5fda972e387820d830c196a9) )
	ROM_LOAD( "garage.006", 0x180000, 0x80000, CRC(e5082b26) SHA1(6547409d39dd51498ce8e3f82ff813a8ac3c6522) )
	ROM_LOAD( "garage.007", 0x280000, 0x80000, CRC(dfa2ceb1) SHA1(ec7de8a8f6e7785a563df973841cc1f1603f79fc) )
	ROM_LOAD( "garage.008", 0x380000, 0x80000, CRC(90c5416b) SHA1(583bfb517bc2e30d7b7903aa19fc3b4b5188d7d2) )
ROM_END
...
/*********************************************************
   Rock Clibmer
	...
	ROM_LOAD( "rock_climber.001", 0x000000, 0x80000, CRC(2c6c10b6) SHA1(b2f96fb90a5f2150d84fe5012414c74fcbde81d1) ) // This set appears on the official hash list, but after 070322 update?
	ROM_LOAD( "rock_climber.002", 0x100000, 0x80000, CRC(7def062a) SHA1(d418f5e8b80680ecdc10159322c83d298c96cf4d) )
	ROM_LOAD( "rock_climber.003", 0x200000, 0x80000, CRC(313a6490) SHA1(96430117f45cc0a34a7dbc51c0df032595451390) )
	ROM_LOAD( "rock_climber.004", 0x300000, 0x80000, CRC(0cfaa33f) SHA1(df289b816fdb094228d518e823a3e660f5b8a0b6) )
...
ROM_START( rclimb ) // 040815
	...
	ROM_LOAD( "rock_climber.005", 0x080000, 0x80000, CRC(ea127c3d) SHA1(a6391eed69a4723b68d727f59b6baebe51633e66) )
	ROM_LOAD( "rock_climber.006", 0x180000, 0x80000, CRC(277fa273) SHA1(6320e6c5b5e48dc451cc48189054c42d85e8ccc1) )
	ROM_LOAD( "rock_climber.007", 0x280000, 0x80000, CRC(3ca7f69a) SHA1(878cca181d915dc3548d5285a4bbb51aef31a64e) )
	ROM_LOAD( "rock_climber.008", 0x380000, 0x80000, CRC(8cf6b4c2) SHA1(4c36c217b83c82acfdd615f5547bf597af7b8833) )
ROM_END
...
/*********************************************************
   Resident
	...
	ROM_LOAD( "resident.001", 0x000000, 0x80000, CRC(5a1a24f1) SHA1(da601ed84603b880d2ce4b98784067531d5294b2) ) // This set appears on the official hash list, but after 070222 update?
...
ROM_START( resdnt ) // 040415
	...
	ROM_LOAD( "resident.005", 0x080000, 0x80000, CRC(0cfe7d44) SHA1(9f0e4925e815ff9f79188f18e78c0a7b377daa3f) )
	ROM_LOAD( "resident.006", 0x180000, 0x80000, CRC(7437904f) SHA1(630c79cd6a990ce7658a1ffabba5a27efba985a1) )
	ROM_LOAD( "resident.007", 0x280000, 0x80000, CRC(6e94728a) SHA1(ab414879cb957d9bc8d653b5e3bb2bbf91139ec0) )
	ROM_LOAD( "resident.008", 0x380000, 0x80000, CRC(a9f55043) SHA1(4771df3d45bdc0a21b1c479f45e09ac5bab6c94f) )
ROM_END
#endif
...
ROM_START( keks ) // 060328
	...
	ROM_LOAD( "keks.008", 0x380000, 0x80000, CRC(f69b0831) SHA1(75392349ef02a39cf883206938e2c615445065fc) )
ROM_END
...
GAME( 2002, mfish_3a,    mfish_3,  multfish, multfish,  0, ROT0, "Igro", "Multi Fish (021124, hacked)",  0 )
GAME( 2002, mfish_12,    mfish_3,  multfish, multfish,  0, ROT0, "Igro", "Multi Fish (040308)",  0 )
GAME( 2002, mfish_12a,   mfish_3,  multfish, multfish,  0, ROT0, "Igro", "Multi Fish (040308, hacked)",  0 )
#if ALL_REVISIONS
...
GAME( 2003, crzmon_7a,   crzmon_7, multfish, multfish,  0, ROT0, "hack",     "Crazy Monkey (031110, hacked set 1)",  0 )
GAME( 2003, crzmon_7b,   crzmon_7, multfish, multfish,  0, ROT0, "hack",     "Crazy Monkey (031110, hacked set 2)",  0 )
GAME( 2003, crzmon_8,    crzmon_7, multfish, multfish,  0, ROT0, "Igrosoft", "Crazy Monkey (050120)",  0 )
GAME( 2003, crzmon_8a,   crzmon_7, multfish, multfish,  0, ROT0, "hack",     "Crazy Monkey (050120, hacked)",  0 )
#if ALL_REVISIONS
...
GAME( 2003, fcockt_6a,   fcockt_6, multfish, multfish,  0, ROT0, "hack",     "Fruit Cocktail (040216, hacked set 1)",  0 )
GAME( 2003, fcockt_6b,   fcockt_6, multfish, multfish,  0, ROT0, "hack",     "Fruit Cocktail (040216, hacked set 2)",  0 )
GAME( 2003, fcockt_7,    fcockt_6, multfish, multfish,  0, ROT0, "Igrosoft", "Fruit Cocktail (050118)",  0 )
GAME( 2003, fcockt_7a,   fcockt_6, multfish, multfish,  0, ROT0, "hack",     "Fruit Cocktail (050118, hacked)",  0 )
...
GAME( 2003, lhaunt_4a,   lhaunt_4, multfish, multfish,  0, ROT0, "hack",     "Lucky Haunter (031111, hacked)",  0 )
GAME( 2003, lhaunt_5,    lhaunt_4, multfish, multfish,  0, ROT0, "Igrosoft", "Lucky Haunter (040216)",  0 )
GAME( 2003, lhaunt_5a,   lhaunt_4, multfish, multfish,  0, ROT0, "hack",     "Lucky Haunter (040216, hacked)",  0 )
GAME( 2003, lhaunt_6,    lhaunt_4, multfish, multfish,  0, ROT0, "Igrosoft", "Lucky Haunter (040825)",  0 )
GAME( 2003, lhaunt_6a,   lhaunt_4, multfish, multfish,  0, ROT0, "hack",     "Lucky Haunter (040825, hacked)",  0 )
#if ALL_REVISIONS
...
GAME( 2004, garage_4a,   garage_4, multfish, multfish,  0, ROT0, "hack",     "Garage (040219, hacked)",  0 )
GAME( 2004, garage_5,    garage_4, multfish, multfish,  0, ROT0, "Igrosoft", "Garage (050311)",  0 )
GAME( 2004, garage_5a,   garage_4, multfish, multfish,  0, ROT0, "hack",     "Garage (050311, hacked)",  0 )
#if ALL_REVISIONS
...
GAME( 2004, rclimb_3a,   rclimb_3, multfish, multfish,  0, ROT0, "hack",     "Rock Climber (040827, hacked set 1)", 0 )
GAME( 2004, rclimb_3b,   rclimb_3, multfish, multfish,  0, ROT0, "hack",     "Rock Climber (040827, hacked set 2)", 0 ) // new service menu
#if ALL_REVISIONS
...
GAME( 2004, sweetla,     sweetl,   multfish, multfish,  0, ROT0, "hack",     "Sweet Life (041220, hacked)",  0 )
...
GAME( 2004, resdnt_2a,   resdnt_2, multfish, multfish,  0, ROT0, "hack",     "Resident (040513, hacked)",  0 )

GAME( 2005, island,      0,        multfish, multfish,  0, ROT0, "Igrosoft", "Island (050713)",  0 )
GAME( 2005, islanda,     island,   multfish, multfish,  0, ROT0, "hack",     "Island (050713, hacked)",  0 )
...
GAME( 2006, keksb,       keks,     multfish, multfish,  0, ROT0, "hack",     "Keks (060328, hacked set 2)",  0 )
GAME( 2006, keks_2,      keks,     multfish, multfish,  0, ROT0, "Igrosoft", "Keks (060403)",  0 )
GAME( 2006, keks_2a,     keks,     multfish, multfish,  0, ROT0, "hack",     "Keks (060403, hacked)",  0 )
