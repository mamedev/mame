...
static ADDRESS_MAP_START( c140_map, 0, 16, gal3_state )    //to be verified
	ADDRESS_MAP_GLOBAL_MASK(0x3fffff)
	AM_RANGE(0x000000, 0x07ffff) AM_ROM AM_REGION("samples", 0x000000) AM_MIRROR(0x80000)
	AM_RANGE(0x100000, 0x17ffff) AM_ROM AM_REGION("samples", 0x080000) AM_MIRROR(0x80000)
	AM_RANGE(0x200000, 0x27ffff) AM_ROM AM_REGION("samples", 0x100000) AM_MIRROR(0x80000)
	AM_RANGE(0x300000, 0x37ffff) AM_ROM AM_REGION("samples", 0x180000) AM_MIRROR(0x80000)
ADDRESS_MAP_END
