...
{
	UINT8 *rom = memory_region(machine, RGNCLASS_SOUND, "voice") + 0x20000;
	UINT8 *prot = memory_region(machine, RGNCLASS_USER, "user1");
	int i;
...
static DRIVER_INIT( kanatuen )
{
	...
	UINT8 *rom = memory_region(machine, RGNCLASS_SOUND, "voice") + 0x30000;
...
ROM_START( nightlov )
	...
	ROM_REGION( 0x060000, RGNCLASS_GFX, "gfx1", 0 ) /* gfx */
...
ROM_START( citylove )
	...
	ROM_REGION( 0xa0000, RGNCLASS_GFX, "gfx1", 0 ) /* gfx */
...
ROM_START( livegal )
	...
	ROM_REGION( 0x40000, RGNCLASS_SOUND, "voice", 0 ) /* voice */
...
ROM_START( iemotom )
	...
	ROM_REGION( 0x120000, RGNCLASS_GFX, "gfx1", 0 ) /* gfx */
...
ROM_START( ojousan )
	...
	ROM_REGION( 0x1c0000, RGNCLASS_GFX, "gfx1", 0 ) /* gfx */
	/* 000000-0fffff empty */
...
ROM_START( kaguya2 )
	...
	ROM_REGION( 0x40000, RGNCLASS_USER, "user1", 0 ) /* protection data */
...
ROM_START( kaguya2f )
	...
	ROM_REGION( 0x40000, RGNCLASS_USER, "user1", ROMREGION_ERASE00 ) /* protection data */
//  ROM_LOAD( "ic4m.bin", 0x00000, 0x40000, CRC(f85c5b07) SHA1(0fc55e9b60ccc630a0d77862eb5e64a3ba366947) )  // same as housemnq/3i.bin gfx data
ROM_END
