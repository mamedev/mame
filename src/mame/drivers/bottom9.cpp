...
uint8_t bottom9_state::k052109_051960_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void bottom9_state::k052109_051960_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	if (offset >= 0x3800 && offset < 0x3808)
...
uint8_t bottom9_state::bottom9_bankedram1_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void bottom9_state::bottom9_bankedram1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	if (m_k052109_selected)
...
uint8_t bottom9_state::bottom9_bankedram2_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	if (m_k052109_selected)
...
void bottom9_state::bottom9_bankedram2_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	if (m_k052109_selected)
...
void bottom9_state::bankswitch_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	int bank;
...
void bottom9_state::bottom9_1f90_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void bottom9_state::bottom9_sh_irqtrigger_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void bottom9_state::nmi_enable_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_nmienable = data;
}

void bottom9_state::sound_bank_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	int bank_A, bank_B;
...
void bottom9_state::volume_callback0(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_k007232_1->set_volume(0, (data >> 4) * 0x11, 0);
	m_k007232_1->set_volume(1, 0, (data & 0x0f) * 0x11);
}

void bottom9_state::volume_callback1(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
