...
static ADDRESS_MAP_START( common_map, ADDRESS_SPACE_PROGRAM, 32 )
	...
	AM_RANGE(0x80000000, 0x80ffffff) AM_ROM AM_REGION(RGNCLASS_USER, "user2",0)
...
ROM_START( mosaicf2 )
	ROM_REGION32_BE( 0x100000, RGNCLASS_USER, "user1", ROMREGION_ERASE00 ) /* Hyperstone CPU Code */
	/* 0 - 0x80000 empty */
	ROM_LOAD( "rom1.bin",            0x80000, 0x080000, CRC(fceb6f83) SHA1(b98afb477627c3b2d584c0f0fb26c4dd5b1a31e2) )

	ROM_REGION32_BE( 0x1000000, RGNCLASS_USER, "user2", 0 )  /* gfx data */
