...
static WRITE32_HANDLER( misc_control_w )
{
	...
	/* adjust banking */
	if (memory_region(machine, RGNCLASS_USER, "user2"))
	{
...
static ADDRESS_MAP_START( r3000_map, ADDRESS_SPACE_PROGRAM, 32 )
	...
	AM_RANGE(0x1fc00000, 0x1fdfffff) AM_ROM AM_REGION(RGNCLASS_USER, "user1", 0) AM_BASE(&rom_base)
ADDRESS_MAP_END
...
static ADDRESS_MAP_START( m68020_map, ADDRESS_SPACE_PROGRAM, 32 )
	...
	AM_RANGE(0x800000, 0x9fffff) AM_ROM AM_REGION(RGNCLASS_USER, "user1", 0) AM_BASE(&rom_base)
...
ROM_START( area51t ) /* 68020 based, Area51 Time Warner License  Date: Nov 15, 1995 */
	ROM_REGION32_BE( 0x200000, RGNCLASS_USER, "user1", 0 )	/* 2MB for 68020 code */
...
ROM_START( area51 ) /* R3000 based, labeled as "Area51 2-C"  Date: Nov 11 1996 */
	ROM_REGION32_BE( 0x200000, RGNCLASS_USER, "user1", 0 )	/* 2MB for IDT 79R3041 code */
...
ROM_START( maxf_ng ) /* R3000 based, stickers say 'NO GORE' */
	...
	ROM_REGION( 0x800, RGNCLASS_USER, "user2", 0 ) /* 28C16 style eeprom, currently loaded but not used */
...
ROM_START( vcircle )
	ROM_REGION32_BE( 0x200000, RGNCLASS_USER, "user1", 0 )	/* 2MB for R3000 code */
...
ROM_START( fishfren )
	...
	ROM_REGION32_BE( 0x1000000, RGNCLASS_USER, "user2", 0 )	/* 16MB for 64-bit ROM data */
	...
	ROM_COPY( RGNCLASS_USER, "user2", 0x800000, 0xc00000, 0x400000 )
ROM_END
