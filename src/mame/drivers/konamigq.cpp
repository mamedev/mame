...
static ADDRESS_MAP_START( k054539_map, AS_0, 8, konamigq_state )
...
ROM_START( cryptklr )
	...
	ROM_LOAD16_WORD_SWAP( "420a01.2g", 0x00000, 0x80000, CRC(84fc2613) SHA1(e06f4284614d33c76529eb43b168d095200a9eac) )

	ROM_REGION( 0x80000, "k054539", 0 )
	ROM_LOAD( "420a02.3m",    0x00000, 0x80000, CRC(2169c3c4) SHA1(6d525f10385791e19eb1897d18f0bab319640162) )

	ROM_REGION32_LE( 0x80000, "maincpu:rom", 0 ) /* bios */
	ROM_LOAD( "420b03.27p",   0x00000, 0x80000, CRC(aab391b1) SHA1(bf9dc7c0c8168c22a4be266fe6a66d3738df916b) )
