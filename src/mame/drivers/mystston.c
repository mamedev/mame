...
static ADDRESS_MAP_START( main_map, ADDRESS_SPACE_PROGRAM, 8 )
	...
	AM_RANGE(0x2020, 0x2020) AM_MIRROR(0x1f8f) AM_READ_PORT("DSW0") AM_WRITE(MWA8_RAM) AM_BASE_MEMBER(mystston_state, scroll)
	AM_RANGE(0x2030, 0x2030) AM_MIRROR(0x1f8f) AM_READ_PORT("DSW1") AM_WRITE(MWA8_RAM) AM_BASE_MEMBER(mystston_state, ay8910_data)
