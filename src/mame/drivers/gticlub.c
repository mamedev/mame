...
static ADDRESS_MAP_START( gticlub_map, ADDRESS_SPACE_PROGRAM, 32 )
	...
	AM_RANGE(0x7f000000, 0x7f3fffff) AM_ROM AM_REGION(RGNCLASS_USER, "user2", 0)	/* Data ROM */
...
ROM_START(gticlub)
	...
	ROM_REGION(0x800000, RGNCLASS_SOUND, "rf", 0)	/* sound roms */
    ...
    ROM_REGION(0x800000, RGNCLASS_GFX, "gfx1", 0)	/* texture roms */
...
ROM_START( thunderh )
	...
	ROM_REGION(0x20000, RGNCLASS_CPU, "dsp", 0)		/* 68k program for outboard sound? network? board */
...
ROM_START( hangplt )
	...
	ROM_REGION(0x1000000, RGNCLASS_SOUND, "rf", 0)	/* other roms */
    ...
    ROM_REGION(0x800000, RGNCLASS_USER, "user5", 0)	/* texture roms */
...
static DRIVER_INIT(gticlub)
{
	...
	K001005_preprocess_texture_data(memory_region(machine, RGNCLASS_GFX, "gfx1"), memory_region_length(machine, RGNCLASS_GFX, "gfx1"), 1);
