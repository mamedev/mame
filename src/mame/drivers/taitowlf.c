...
{
	palette.set_pen_color(0x70,MAKE_RGB(0xff,0xff,0xff));
	palette.set_pen_color(0x71,MAKE_RGB(0xff,0xff,0xff));
	palette.set_pen_color(0x01,MAKE_RGB(0x55,0x00,0x00));
	palette.set_pen_color(0x10,MAKE_RGB(0xaa,0x00,0x00));
	palette.set_pen_color(0x00,MAKE_RGB(0x00,0x00,0x00));
}
#endif
