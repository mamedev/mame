...
/* disp2 */GAME(2008,	blkhole7,	blckhole,	gts80_ss,	gts80,	gts80,	ROT0,	"Oliver",		"Black Hole  (7-digit conversion)",			GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
...
/* disp2 */GAME(2008,	blkhol7s,	blkholea,	gts80_s,	gts80,	gts80,	ROT0,	"Oliver",		"Black Hole (Sound Only, 7-digit conversion)",	GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
/* disp1 */GAME(1980,	circusp,	0,		gts80_s,	gts80,	gts80,	ROT0,	"Gottlieb",		"Circus",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
/* disp1 */GAME(2008,	circus7,	circusp,		gts80_s,	gts80,	gts80,	ROT0,	"Oliver",		"Circus (7-digit conversion)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
/* disp1 */GAME(1980,	cntforce,	0,		gts80_s,	gts80,	gts80,	ROT0,	"Gottlieb",		"Counterforce",			GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
/* disp1 */GAME(2008,	cntforc7,	cntforce,	gts80_s,	gts80,	gts80,	ROT0,	"Oliver",		"Counterforce (7-digit conversion)",			GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
/* disp2 */GAME(1981,	eclipse,	0,		gts80_s,	gts80,	gts80,	ROT0,	"Gottlieb",		"Eclipse",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
/* disp2 */GAME(2008,	eclipse7,	eclipse,gts80_s,	gts80,	gts80,	ROT0,	"Oliver",		"Eclipse (7-digit conversion)",			GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
/* disp1 */GAME(1981,	forceii,	0,		gts80_s,	gts80,	gts80,	ROT0,	"Gottlieb",		"Force II",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
/* disp1 */GAME(2008,	forceii7,	forceii,gts80_s,	gts80,	gts80,	ROT0,	"Oliver",		"Force II (7-digit conversion)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
...
/* disp2 */GAME(2008,	hh7,	hh,		gts80_ss,	gts80,	gts80,	ROT0,	"Oliver",		"Haunted House (Rev. 2, 7-digit conversion)",	GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
...
/* disp2 */GAME(2008,	jamesb7,	jamesb,		gts80_s,	gts80,	gts80,	ROT0,	"Oliver",		"James Bond (Timed Play, 7-digit conversion)",	GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
...
/* disp2 */GAME(2008,	jamesb7b,	jamesb,	gts80_s,	gts80,	gts80,	ROT0,	"Oliver",		"James Bond (3/5-Ball, 7-digit conversion)",	GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
...
/* disp1 */GAME(2008,	mars7,		marsp,	gts80_ss,	gts80,	gts80,	ROT0,	"Gottlieb / Oliver",		"Mars - God of War (7-digit conversion)",		GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
/* disp1 */GAME(1980,	panthera,	0,		gts80_s,	gts80,	gts80,	ROT0,	"Gottlieb",		"Panthera",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
/* disp1 */GAME(2008,	panther7,	panthera,gts80_s,	gts80,	gts80,	ROT0,	"Gottlieb / Oliver",		"Panthera (7-digit conversion)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
/* cust  */GAME(1981,	pnkpnthr,	0,		gts80_s,	gts80,	gts80,	ROT0,	"Gottlieb",		"Pink Panther",			GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
/* cust  */GAME(2008,	pnkpntr7,	pnkpnthr,gts80_s,	gts80,	gts80,	ROT0,	"Gottlieb / Oliver",		"Pink Panther (7-digit conversion",			GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
/* disp1 */GAME(1980,	starrace,	0,		gts80_s,	gts80,	gts80,	ROT0,	"Gottlieb",		"Star Race",			GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
/* disp1 */GAME(2008,	starrac7,	starrace,gts80_s,	gts80,	gts80,	ROT0,	"Gottlieb / Oliver",		"Star Race (7-digit conversion)",			GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
...
/* disp1 */GAME(2008,	spiderm7,	spidermn,gts80_s,	gts80,	gts80,	ROT0,	"Gottlieb / Oliver",		"The Amazing Spider-Man (7-digit conversion)",	GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
/* cust  */GAME(1980,	timeline,	0,		gts80_s,	gts80,	gts80,	ROT0,	"Gottlieb",		"Time Line",			GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
/* cust  */GAME(2008,	timelin7,	timeline,gts80_s,	gts80,	gts80,	ROT0,	"Gottlieb / Oliver",		"Time Line (7-digit conversion)",			GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
/* disp1 */GAME(1981,	vlcno_ax,	0,		gts80_ss,	gts80,	gts80,	ROT0,	"Gottlieb",		"Volcano",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
/* disp1 */GAME(2008,	vlcno_a7,	vlcno_ax,	gts80_ss,	gts80,	gts80,	ROT0,	"Gottlieb / Oliver",		"Volcano (7-digit conversion)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
...
/* disp1 */GAME(2008,	vlcno_b7,	vlcno_1b,	gts80_s,	gts80,	gts80,	ROT0,	"Gottlieb / Oliver",		"Volcano (Sound Only, 7-digit conversion)",	GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
