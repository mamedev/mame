...
static WRITE16_HANDLER(any_w)
{
	...
	//  if(offset == 0x700)
	//      cpu_setbank(2, memory_region(machine, RGNCLASS_USER, "user1")+0x20000*data);
...
static void r2_dt(UINT16 sc, UINT16 cc, UINT16 ent, UINT16 tm, UINT16 x, UINT16 y)
{
	...
	//  cpu_setbank(2, memory_region(machine, RGNCLASS_USER, "user1")+0x20000*bank);
}
...
ROM_START( raiden2 )
	ROM_REGION( 0x200000, RGNCLASS_USER, "user1", 0 ) /* v30 main cpu */
	...
	ROM_REGION( 0x020000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) /* chars */
	ROM_LOAD( "px0",	0x000000,	0x020000,	CRC(c9ec9469) SHA1(a29f480a1bee073be7a177096ef58e1887a5af24) )

	ROM_REGION( 0x400000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE ) /* background gfx */
	...
	ROM_REGION( 0x800000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE ) /* sprite gfx (encrypted) */
	...
	ROM_REGION( 0x080000, RGNCLASS_SOUND, "oki1", 0 )	/* ADPCM samples */
	ROM_LOAD( "voi1", 0x00000, 0x80000, CRC(f340457b) SHA1(8169acb24c82f68d223a31af38ee36eb6cb3adf4) )

	ROM_REGION( 0x080000, RGNCLASS_SOUND, "oki2", 0 )	/* ADPCM samples */
...
ROM_START( raiden2a )
	...
	ROM_REGION( 0x100000, RGNCLASS_SOUND, "oki1", 0 )	/* ADPCM samples */
	ROM_LOAD( "rom6", 0x00000, 0x40000, CRC(fb0fca23) SHA1(4b2217b121a66c5ab6015537609cf908ffedaf86) )

	ROM_REGION( 0x100000, RGNCLASS_SOUND, "oki2", ROMREGION_ERASEFF )	/* ADPCM samples */
ROM_END
...
ROM_START( raiden2c )
	...
	ROM_REGION( 0x100000, RGNCLASS_SOUND, "oki2", 0 )	/* ADPCM samples */
...
ROM_START( raidndx )
	...
	ROM_REGION( 0x40000, RGNCLASS_USER, "user2", 0 )	/* COPDX */
...
ROM_START( zeroteam )
	...
	ROM_REGION( 0x800000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE ) /* sprite gfx (encrypted) (diff encrypt to raiden2? ) */
...
ROM_START( r2dx_v33 )
	ROM_REGION( 0x400000, RGNCLASS_CPU, "main", 0 ) /* v33 main cpu */
	ROM_LOAD("prg.223",   0x000000, 0x400000, CRC(b3dbcf98) SHA1(30d6ec2090531c8c579dff74c4898889902d7d87) )

	ROM_REGION( 0x20000, RGNCLASS_CPU, "cpu1", ROMREGION_ERASE00 ) /* 64k code for sound Z80 */
	/* nothing?  no z80*/

	ROM_REGION( 0x040000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) /* chars */
