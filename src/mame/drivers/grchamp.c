...
ROM_START( grchamp )
	...
	ROM_REGION( 0x2000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) /* characters/sprites */
	...
	ROM_REGION( 0x2000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE ) /* left tiles */
	...
	ROM_REGION( 0x2000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE ) /* right tiles */
	...
	ROM_REGION( 0x2000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE ) /* center tiles */
