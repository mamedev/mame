...
public:
	...
	void print_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	...
	uint8_t print_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
...
void tim011_state::fdc_dma_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	printf("fdc_dma_w :%02x\n",data);
}

void tim011_state::print_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	//printf("print_w :%02x\n",data);
}

uint8_t tim011_state::print_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	//printf("print_r\n");
	return 0;
}

void tim011_state::scroll_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_scroll = data;
}

uint8_t tim011_state::scroll_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_scroll;
}
