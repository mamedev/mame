...
{
	palette.set_pen_color(0, MAKE_RGB(0x3F, 0x3F, 0x3F));  /* tiles, ball */
	palette.set_pen_color(1, MAKE_RGB(0xFF, 0xFF, 0xFF));
	palette.set_pen_color(2, MAKE_RGB(0xFF ,0xFF, 0xFF));  /* sprites */
...
static MACHINE_CONFIG_START( flyball, flyball_state )
	...
	MCFG_GFXDECODE_ADD("gfxdecode",flyball,"palette")
