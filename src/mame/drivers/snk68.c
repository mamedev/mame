...
ROM_START( pow )
	...
	ROM_REGION( 0x010000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )	/* characters */
	...
	ROM_REGION( 0x10000, RGNCLASS_SOUND, "upd", 0 )	/* UPD7759 samples */
...
ROM_START( streetsm )
	...
	ROM_REGION( 0x20000, RGNCLASS_SOUND, "upd", 0 )	/* UPD7759 samples */
...
ROM_START( ikari3 )
	...
	ROM_REGION16_BE( 0x40000, RGNCLASS_USER, "user1", 0 ) /* Extra code bank */
