...
ROM_START( sprint1 )
	...
	ROM_REGION( 0x0200, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE ) /* cars */
...
ROM_START( dominos )
	...
	ROM_REGION( 0x200, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) /* tiles */
	...
	ROM_REGION( 0x200, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE ) /* sprites, not used */
