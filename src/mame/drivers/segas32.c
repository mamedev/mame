...
static WRITE8_HANDLER( sound_bank_lo_w )
{
	...
	memory_set_bankptr(1, memory_region(machine, RGNCLASS_CPU, "sound") + 0x100000 + 0x2000 * sound_bank);
}
...
static ADDRESS_MAP_START( system32_map, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0xf00000, 0xffffff) AM_ROM AM_REGION(RGNCLASS_CPU, "main", 0)
ADDRESS_MAP_END
...
static ADDRESS_MAP_START( system32_sound_map, ADDRESS_SPACE_PROGRAM, 8 )
	AM_RANGE(0x0000, 0x9fff) AM_ROM AM_REGION(RGNCLASS_CPU, "sound", 0x100000)
...
static ADDRESS_MAP_START( ga2_v25_map, ADDRESS_SPACE_PROGRAM, 8 )
	...
	AM_RANGE(0xf0000, 0xfffff) AM_ROM AM_REGION(RGNCLASS_CPU, "mcu", 0)
ADDRESS_MAP_END
...
*/
ROM_START( arescue )
	ROM_REGION( 0x200000, RGNCLASS_CPU, "main", 0 ) /* v60 code + data */
	...
	ROM_REGION( 0x500000, RGNCLASS_CPU, "sound", 0 ) /* sound CPU */
	...
	ROM_REGION32_BE( 0x800000, RGNCLASS_GFX, "gfx2", 0 ) /* sprites */
	...
	ROM_REGION( 0x20000, RGNCLASS_USER, "user2", 0 ) /* NEC uPD77P25 DSP Internal ROM */
...
ROM_START( alien3 )
	...
	ROM_REGION( 0x400000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) /* tiles */
	...
	ROM_REGION32_BE( 0x1000000, RGNCLASS_GFX, "gfx2", 0 ) /* sprites */
...
ROM_START( arabfgt )
	...
	ROM_REGION( 0x500000, RGNCLASS_CPU, "sound", 0 ) /* sound CPU + banks */
	...
	ROM_REGION( 0x100000, RGNCLASS_CPU, "cpu2", 0 ) /* Protection CPU (simulated, not emulated) */
...
ROM_START( arabfgtj )
	...
	ROM_REGION( 0x100000, RGNCLASS_CPU, "cpu2", 0 ) /* Protection CPU */
	ROM_LOAD( "14468-01.3", 0x00000, 0x10000, CRC(c3c591e4) SHA1(53e48066e85b61d0c456618d14334a509b354cb3) )
	ROM_RELOAD(             0xf0000, 0x10000             )
...
ROM_START( f1lap )
	...
	ROM_REGION( 0x20000, RGNCLASS_USER, "user2", 0 ) /*  comms board  */
...
ROM_START( ga2 )
	...
	ROM_REGION( 0x100000, RGNCLASS_CPU, "mcu", 0 ) /* Protection CPU */
...
*/
ROM_START( harddunk )
	ROM_REGION( 0x200000, RGNCLASS_CPU, "main", 0 ) /* v60 code */
	...
	ROM_REGION( 0x180000, RGNCLASS_CPU, "sound", 0 ) /* sound CPU */
	...
	ROM_REGION( 0x400000, RGNCLASS_SOUND, "sega", 0 ) /* Sega PCM sound data */
...
ROM_START( holo )
	...
	ROM_REGION( 0x000100, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) /* tiles */
...
ROM_START( jpark )
	...
	ROM_REGION( 0x10000, RGNCLASS_CPU, "cpu2", 0 ) /* unused */
...
ROM_START( radm )
	...
	ROM_REGION( 0x8000, RGNCLASS_USER, "user2", 0 ) /* unused (cabinet motor?) */
...
ROM_START( radr )
	...
	ROM_REGION( 0x8000, RGNCLASS_USER, "user2", 0 ) /* unused */
...
ROM_START( slipstrm )
	...
	ROM_REGION32_BE( 0x400000, RGNCLASS_GFX, "gfx2", 0 ) /* sprites */
...
static DRIVER_INIT( jpark )
{
	...
	UINT16 *pROM = (UINT16 *)memory_region(machine, RGNCLASS_CPU, "main");
