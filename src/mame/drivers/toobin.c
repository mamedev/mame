...
static ADDRESS_MAP_START( main_map, AS_PROGRAM, 16, toobin_state )
	...
	AM_RANGE(0xc10000, 0xc107ff) AM_MIRROR(0x047800) AM_RAM_WRITE_LEGACY(toobin_paletteram_w) AM_BASE_GENERIC(paletteram)
	...
	AM_RANGE(0xff9000, 0xff9001) AM_MIRROR(0x4507fe) AM_READ_LEGACY(special_port1_r)
