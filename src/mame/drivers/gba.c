...
static INPUT_PORTS_START( gbadv )
	PORT_START("INPUTS")
	PORT_BIT( 0xfc00, IP_ACTIVE_HIGH, IPT_BUTTON3) PORT_UNUSED
	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_SHOULDER_BUTTON_L1 ) PORT_NAME("P1 L") PORT_PLAYER(1) // L
	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_SHOULDER_BUTTON_R1 ) PORT_NAME("P1 R") PORT_PLAYER(1) // R
