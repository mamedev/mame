...
ROM_START (ti73b)
	...
	ROMX_LOAD( "ti73v160.bin", 0x00000, 0x80000, CRC(453701d8) SHA1(371d1f74a5e26ed749e12baac104f0069f329f44), ROM_BIOS(1) )
  ROM_SYSTEM_BIOS( 1, "v140", "V 1.40" )
	ROMX_LOAD( "ti73v160.bin", 0x00000, 0x80000, CRC(057e85ae) SHA1(4c45c8b26190e887bb9cdc3b185fd7e703922cbc), ROM_BIOS(2) )
  ROM_SYSTEM_BIOS( 2, "v150", "V 1.50" )
	ROMX_LOAD( "ti73v160.bin", 0x00000, 0x80000, CRC(c0edfb53) SHA1(1049363587b6d7985356aa2467a0118e6cc6dc37), ROM_BIOS(3) )
  ...
  ROM_SYSTEM_BIOS( 4, "v180", "V 1.80" )
	ROMX_LOAD( "ti73v160.bin", 0x00000, 0x80000, CRC(7d3b9ee6) SHA1(93bfc8d951c526e1be7c0e1bebc43dd20cd4c3b1), ROM_BIOS(5) )
  ROM_SYSTEM_BIOS( 5, "v185", "V 1.85" )
	ROMX_LOAD( "ti73v160.bin", 0x00000, 0x80000, CRC(4e7d68e7) SHA1(52a8b71fee7cda11935d6e89825842b4aad046dd), ROM_BIOS(6) )
  ROM_SYSTEM_BIOS( 6, "v190", "V 1.90" )
	ROMX_LOAD( "ti73v160.bin", 0x00000, 0x80000, CRC(8726a8db) SHA1(636551d75fd0bccbbc89ea6749bb1153e9545e26), ROM_BIOS(7) )
  ROM_SYSTEM_BIOS( 7, "v191", "V 1.91" )
	ROMX_LOAD( "ti73v160.bin", 0x00000, 0x80000, CRC(f3785d57) SHA1(ad73d0c61ef6a51a04902a9b30a58992a2d860c4), ROM_BIOS(8) )
...
ROM_START (ti84pse)
	...
	ROMX_LOAD( "ti84psev241.bin", 0x00000, 0x200000, CRC(da8b3c8e) SHA1(736fae1929089167a3af6290e04e9278b0a3d1a6), ROM_BIOS(1) )
  ROM_SYSTEM_BIOS( 1, "v222", "V 2.22" )
	ROMX_LOAD( "ti84psev241.bin", 0x00000, 0x200000, CRC(dc2931db) SHA1(319f1ec6accdbe2309f9ffcd8d9970fa2a422c4d), ROM_BIOS(2) )
  ROM_SYSTEM_BIOS( 2, "v230", "V 2.30" )
	ROMX_LOAD( "ti84psev241.bin", 0x00000, 0x200000, CRC(8800c73a) SHA1(cb9ad540137ede275ff22e293ae0f7cc31b6663d), ROM_BIOS(3) )
  ROM_SYSTEM_BIOS( 3, "v240", "V 2.40" )
	ROMX_LOAD( "ti84psev241.bin", 0x00000, 0x200000, CRC(2aed41c4) SHA1(6886f4c07718f0dfa43b397ff492a6b4b06ded15), ROM_BIOS(4) )
  ...
  ROM_SYSTEM_BIOS( 5, "v243", "V 2.43" )
	ROMX_LOAD( "ti84psev241.bin", 0x00000, 0x200000, CRC(1e9707f8) SHA1(767a5238882d97fac550971adbfbe48f82f2772f), ROM_BIOS(6) )
  ROM_SYSTEM_BIOS( 6, "v253mp", "V 2.53MP" )
	ROMX_LOAD( "ti84psev241.bin", 0x00000, 0x200000, CRC(3e52683a) SHA1(80050ae2a8f128b291d3a8973ab32e879172f2b9), ROM_BIOS(7) )
  ROM_SYSTEM_BIOS( 7, "v255mp", "V 2.55MP" )
	ROMX_LOAD( "ti84psev241.bin", 0x00000, 0x200000, CRC(70439fdd) SHA1(201e585caa64836829ea57c1291c6136c778ef55), ROM_BIOS(8) )
