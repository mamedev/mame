...
m) 'smooncrs'
  ...
  - inputs : player 1 controls are used by players 1 and 2, even in a "cocktail"
    cabinet (player 2 inputs are never read due to code at 0x2b1c, 0x3306 and 0x3313)
  - 2 coins slots with different settings :
      * coin A : 1C_1C / 2C_1C / 3C_1C / 4C_1C
      * coin B : 1C_1C / 1C_2C / 1C_3C / "Free Play"
...
- jumpbug  : full Dip Switches and Inputs - missing discrete sounds
- jumpbugb : full Dip Switches and Inputs - missing discrete sounds
