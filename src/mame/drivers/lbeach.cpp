...
public:
	...
	void palette_init_lbeach(palette_device &palette);
...
void lbeach_state::palette_init_lbeach(palette_device &palette)
{
	// tiles
...
void lbeach_state::get_bg_tile_info(tilemap_t &tilemap, tile_data &tileinfo, tilemap_memory_index tile_index)
{
	// d0-d4: code
	// d5: unused?
	// d6,d7: color
...
void lbeach_state::get_fg_tile_info(tilemap_t &tilemap, tile_data &tileinfo, tilemap_memory_index tile_index)
{
