...
ROM_START( cabal )
	ROM_REGION( 0x50000, RGNCLASS_CPU, "main", 0 )	/* 64k for cpu code */
	...
	ROM_REGION( 0x10000, RGNCLASS_CPU, "audio", 0 )	/* 64k for sound cpu code */
	...
	ROM_REGION( 0x20000, RGNCLASS_SOUND, "adpcm", 0 )	/* Samples */
