...
GAME( 1988, cabal,   0,     cabal,   cabalj,   cabal,   ROT0, "Tad", "Cabal (World, Joystick version)", 0 )
GAME( 1989, cabala,  cabal, cabal,   cabalj,   cabal,   ROT0, "Tad (Alpha Trading license)", "Cabal (Alpha Trading)", 0 ) // korea?
