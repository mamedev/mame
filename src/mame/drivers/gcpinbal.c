...
ROM_START( gcpinbal )
	ROM_REGION( 0x200000, RGNCLASS_CPU, "main", 0 )     /* 512k for 68000 program */
	...
	ROM_REGION( 0x080000, RGNCLASS_SOUND, "oki", 0 )	/* M6295 acc to Raine */
	ROM_LOAD( "u55",   0x000000, 0x080000, CRC(b3063351) SHA1(825e63e8a824d67d235178897528e5b0b41e4485) )

	ROM_REGION( 0x200000, RGNCLASS_SOUND, "msm", 0 )	/* M6585 acc to Raine */
