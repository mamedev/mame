...
public:
	...
	void fg_vram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void bg_vram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	void vidreg_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t mux_port_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t mux_port2_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void mux_sel_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
...
void majorpkr_state::rom_bank_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void majorpkr_state::palette_bank_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void majorpkr_state::vram_bank_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void majorpkr_state::fg_vram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_fg_vram[offset] = data;
	m_fg_tilemap->mark_tile_dirty(offset >> 1);
}

void majorpkr_state::bg_vram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_bg_vram[offset] = data;
	m_bg_tilemap->mark_tile_dirty(offset >> 1);
}

void majorpkr_state::vidreg_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t majorpkr_state::mux_port_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
uint8_t majorpkr_state::mux_port2_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void majorpkr_state::mux_sel_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void majorpkr_state::lamps_a_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
/*  Lamps - Array A.
...
void majorpkr_state::lamps_b_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
/*  Lamps - Array B.
...
void majorpkr_state::pulses_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
/*  Pulses...
