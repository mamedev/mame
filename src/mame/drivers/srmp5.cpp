...
#endif
	void bank_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t tileram_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void tileram_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t spr_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void spr_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t chrrom_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void input_select_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t srmp5_inputs_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void cmd1_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	void cmd2_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t cmd_stat32_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	uint32_t srmp5_vidregs_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void srmp5_vidregs_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t irq_ack_clear(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	uint8_t cmd1_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t cmd2_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	uint8_t cmd_stat8_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
...
void srmp5_state::bank_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	m_chrbank = ((data & 0xf0) >> 4) * (0x100000 / sizeof(uint16_t));
}

uint32_t srmp5_state::tileram_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
	return m_tileram[offset];
}

void srmp5_state::tileram_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
...
uint32_t srmp5_state::spr_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
	return m_sprram[offset];
}

void srmp5_state::spr_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	m_sprram[offset] = data & 0xFFFF; //lower 16bit only
}

uint32_t srmp5_state::chrrom_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
	return m_chrrom[m_chrbank + offset]; // lower 16bit only
}

void srmp5_state::input_select_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	m_input_select = data & 0x0F;
}

uint32_t srmp5_state::srmp5_inputs_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
	uint32_t ret = 0;
...
void srmp5_state::cmd1_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	m_cmd1 = data & 0xFF;
	logerror("cmd1_w %08X\n", data);
}

void srmp5_state::cmd2_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	m_cmd2 = data & 0xFF;
	m_cmd_stat = 5;
	logerror("cmd2_w %08X\n", data);
...
uint32_t srmp5_state::cmd_stat32_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
	return m_cmd_stat;
}

uint32_t srmp5_state::srmp5_vidregs_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
	logerror("vidregs read  %08X %08X\n", offset << 2, m_vidregs[offset]);
	return m_vidregs[offset];
}

void srmp5_state::srmp5_vidregs_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
...
uint32_t srmp5_state::irq_ack_clear(address_space &space, offs_t offset, uint32_t mem_mask)
{
...
uint8_t srmp5_state::cmd1_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	m_cmd_stat = 0;
	return m_cmd1;
}

uint8_t srmp5_state::cmd2_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_cmd2;
}

uint8_t srmp5_state::cmd_stat8_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_cmd_stat;
}

// common rombank? should go in machine/st0016 with larger address space exposed?
void srmp5_state::st0016_rom_bank_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
