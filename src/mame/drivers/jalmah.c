...
ROM_START ( urashima )
	...
	ROM_REGION( 0x080000, "gfx2", ROMREGION_DISPOSE ) /* 16x16 Tiles */

	ROM_REGION( 0x080000, "gfx3", ROMREGION_DISPOSE )

	ROM_REGION( 0x100000, "gfx4", ROMREGION_DISPOSE ) /* BG3 */
...
ROM_START( daireika )
	...
	ROM_REGION( 0x40000, "gfx2", 0 ) /* BG1 */
	ROM_COPY( "gfx3", 0x00000, 0x00000, 0x20000 )/*mj10.bin*/
...
{
	memory_install_read_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x80004, 0x80005, 0, 0, urashima_mcu_r );
	memory_install_write_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x80012, 0x80013, 0, 0, urashima_mcu_w );
	memory_install_readwrite_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0xf0320, 0xf0321, 0, 0, SMH_BANK1, SMH_BANK1 );
	memory_set_bankptr(1, auto_malloc(0xf0322 - 0xf0320));
	memory_install_readwrite_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0xf03c0, 0xf03c5, 0, 0, SMH_BANK2, SMH_BANK2 );
	memory_set_bankptr(2, auto_malloc(0xf03c6 - 0xf03c0));
	memory_install_readwrite_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0xf03c6, 0xf03e5, 0, 0, SMH_BANK3, SMH_BANK3 );
...
{
	memory_install_read_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x80004, 0x80005, 0, 0, daireika_mcu_r );
	memory_install_write_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x80012, 0x80013, 0, 0, daireika_mcu_w );
	memory_install_readwrite_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0xf0140, 0xf0141, 0, 0, SMH_BANK1, SMH_BANK1 );
	memory_set_bankptr(1, auto_malloc(0xf0142 - 0xf0140));
	memory_install_readwrite_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0xf0020, 0xf0025, 0, 0, SMH_BANK2, SMH_BANK2 );
	memory_set_bankptr(2, auto_malloc(0xf0026 - 0xf0020));
	memory_install_readwrite_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0xf00c0, 0xf00d5, 0, 0, SMH_BANK3, SMH_BANK3 );
	memory_set_bankptr(3, auto_malloc(0xf00d6 - 0xf00c0));
	memory_install_readwrite_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0xf0100, 0xf0131, 0, 0, SMH_BANK4, SMH_BANK4 );
...
{
	memory_install_read_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x80004, 0x80005, 0, 0, mjzoomin_mcu_r );
	memory_install_write_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x80012, 0x80013, 0, 0, mjzoomin_mcu_w );
	memory_install_readwrite_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0xf00c0, 0xf00c5, 0, 0, SMH_BANK1, SMH_BANK1 );
	memory_set_bankptr(1, auto_malloc(0xf00c6 - 0xf00c0));
	memory_install_readwrite_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0xf00c6, 0xf00d1, 0, 0, SMH_BANK2, SMH_BANK2 );
	memory_set_bankptr(2, auto_malloc(0xf00d2 - 0xf00c6));
	memory_install_readwrite_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0xf0020, 0xf002f, 0, 0, SMH_BANK3, SMH_BANK3 );
...
{
	memory_install_read_handler(machine, 0,  ADDRESS_SPACE_PROGRAM, 0x80004, 0x80005, 0, 0, kakumei_mcu_r );
	mcu_prg = 0x21;
}
...
{
	memory_install_read_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x80004, 0x80005, 0, 0, suchipi_mcu_r );
	mcu_prg = 0x23;
}
