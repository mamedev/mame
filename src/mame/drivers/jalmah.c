...
ROM_START ( urashima )
	...
	ROM_REGION( 0x140000, RGNCLASS_SOUND, "oki", ROMREGION_ERASEFF ) /* Samples */
	...
	ROM_REGION( 0x080000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE ) /* 16x16 Tiles */

	ROM_REGION( 0x080000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE )

	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE ) /* BG3 */
	...
	ROM_REGION( 0x0240, RGNCLASS_USER, "user1", 0 )
...
ROM_START( daireika )
	...
	ROM_REGION( 0x80000, RGNCLASS_GFX, "gfx4", 0 ) /* BG3 */
	ROM_LOAD( "mj10.bin", 0x00000, 0x80000, CRC(1f5509a5) SHA1(4dcdee0e159956cf73f5f85ce278479be2a9ca9f) )

	ROM_REGION( 0x40000, RGNCLASS_GFX, "gfx3", 0 ) /* BG2 */
	ROM_LOAD( "mj11.bin",  0x00000, 0x20000, CRC(14867c51) SHA1(b282b5048a55c9ad72ceb0d23f010a0fee78704f) )
	ROM_COPY( RGNCLASS_GFX, "gfx4", 0x20000, 0x20000, 0x20000 )/*mj10.bin*/

	ROM_REGION( 0x40000, RGNCLASS_GFX, "gfx2", 0 ) /* BG1 */
	ROM_COPY( RGNCLASS_GFX, "gfx3", 0x00000, 0x00000, 0x20000 )/*mj10.bin*/
	ROM_LOAD( "mj12.bin", 0x20000, 0x20000, CRC(236f809f) SHA1(9e15dd8a810a9d4f7f75f084d6bd277ea7d0e40a) )

	ROM_REGION( 0x220, RGNCLASS_USER, "user1", 0 ) /* Proms */
...
ROM_START( mjzoomin )
	...
	ROM_REGION( 0x20000, RGNCLASS_GFX, "gfx2", 0 ) /* BG1 */
...
ROM_START( suchipi )
	...
	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx4", 0 ) /* BG3 */
