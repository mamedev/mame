...
ROM_START( dcheese )
	...
	ROM_REGION( 0x10000, RGNCLASS_CPU, "audio", 0 ) /* M6809 */
	...
	ROM_REGION( 0x400000, RGNCLASS_SOUND, "bsmt", 0 )
	...
	ROM_REGION16_LE( 0x20000, RGNCLASS_USER, "user1", 0 )
...
ROM_START( fredmem )
	...
	ROM_REGION( 0x100, RGNCLASS_USER, "user2", 0 )
...
ROM_START( cecmatch )
	...
	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx1", ROMREGION_ERASEFF )
