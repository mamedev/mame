...
public:
	...
	uint32_t hornet_k037122_sram_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void hornet_k037122_sram_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t hornet_k037122_char_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void hornet_k037122_char_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t hornet_k037122_reg_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void hornet_k037122_reg_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	...
	void comm1_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	void comm_rombank_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint32_t comm0_unk_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	uint32_t gun_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void gun_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	void gn680_sysctrl(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint16_t gn680_latch_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void gn680_latch_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	...
	void jamma_jvs_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t comm_eeprom_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void comm_eeprom_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
...
uint32_t hornet_state::hornet_k037122_sram_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
	k037122_device *k037122 = m_konppc->get_cgboard_id() ? m_k037122_2 : m_k037122_1;
	return k037122->sram_r(space, offset, mem_mask);
}

void hornet_state::hornet_k037122_sram_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	k037122_device *k037122 = m_konppc->get_cgboard_id() ? m_k037122_2 : m_k037122_1;
...
uint32_t hornet_state::hornet_k037122_char_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
	k037122_device *k037122 = m_konppc->get_cgboard_id() ? m_k037122_2 : m_k037122_1;
	return k037122->char_r(space, offset, mem_mask);
}

void hornet_state::hornet_k037122_char_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	k037122_device *k037122 = m_konppc->get_cgboard_id() ? m_k037122_2 : m_k037122_1;
	k037122->char_w(space, offset, data, mem_mask);
}

uint32_t hornet_state::hornet_k037122_reg_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
	k037122_device *k037122 = m_konppc->get_cgboard_id() ? m_k037122_2 : m_k037122_1;
	return k037122->reg_r(space, offset, mem_mask);
}

void hornet_state::hornet_k037122_reg_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	k037122_device *k037122 = m_konppc->get_cgboard_id() ? m_k037122_2 : m_k037122_1;
...
uint8_t hornet_state::sysreg_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	uint8_t r = 0;
...
void hornet_state::sysreg_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	switch (offset)
	{
...
uint8_t hornet_state::comm_eeprom_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	uint8_t r = 0;
...
void hornet_state::comm_eeprom_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_eepromout->write(data, 0xff);
	m_lan_ds2401->write((data >> 4) & 1);
}

void hornet_state::comm1_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	printf("comm1_w: %08X, %08X, %08X\n", offset, data, mem_mask);
}

void hornet_state::comm_rombank_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	int bank = data >> 24;
...
uint32_t hornet_state::comm0_unk_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
...
uint32_t hornet_state::gun_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
	return m_gn680_ret0<<16 | m_gn680_ret1;
}

void hornet_state::gun_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
...
void hornet_state::soundtimer_en_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	if (data & 1)
	{
...
void hornet_state::soundtimer_count_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	// Reset the count
	m_sound_irq_timer->adjust(attotime::from_usec(m_sound_timer_usec));
...
void hornet_state::gn680_sysctrl(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	// bit 15 = watchdog toggle
	// lower 4 bits = LEDs?
}

uint16_t hornet_state::gn680_latch_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
void hornet_state::gn680_latch_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	if (offset)
	{
		m_gn680_ret1 = data;
...
uint32_t hornet_state::dsp_dataram0_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
	return m_sharc_dataram0[offset] & 0xffff;
}

void hornet_state::dsp_dataram0_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	m_sharc_dataram0[offset] = data;
}

uint32_t hornet_state::dsp_dataram1_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
	return m_sharc_dataram1[offset] & 0xffff;
}

void hornet_state::dsp_dataram1_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
...
void hornet_state::jamma_jvs_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
