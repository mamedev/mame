...
static INPUT_PORTS_START(terabrst) //Button 3 is used to speed the gun cursor during gameplay while held when using jamma inputs. This was most likely used for testing purposes as evidence in the game's attract mode.
	...
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_NAME("P1 Temp Cursor Speed")
	...
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON3) PORT_PLAYER(2) PORT_NAME("P2 Temp Cursor Speed")
INPUT_PORTS_END
...
static INPUT_PORTS_START( sscope )
	...
	PORT_BIT( 0x7ff, 0x400, IPT_AD_STICK_X ) PORT_MINMAX(0x000, 0x7ff) PORT_SENSITIVITY(25) PORT_KEYDELTA(20)

	PORT_START("ANALOG2") // Gun Pitch
	PORT_BIT( 0x7ff, 0x3ff, IPT_AD_STICK_Y ) PORT_MINMAX(0x000, 0x7ff) PORT_SENSITIVITY(25) PORT_KEYDELTA(20) PORT_INVERT
INPUT_PORTS_END
