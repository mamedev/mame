...
ROM_START( legionna )
	...
	ROM_REGION( 0x020000, RGNCLASS_USER, "user1", ROMREGION_DISPOSE ) /* load the tiles here so we can split them up into the required regions by hand */
	...
	ROM_REGION( 0x010000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )  /* FG Tiles */
	ROM_COPY( RGNCLASS_USER, "user1", 0x010000, 0x000000, 0x010000 )

	ROM_REGION( 0x010000, RGNCLASS_GFX, "gfx5", ROMREGION_DISPOSE )  /* BK3 */
	ROM_COPY( RGNCLASS_USER, "user1", 0x000000, 0x000000, 0x010000 ) /* decrambled in INIT */
	...
	ROM_REGION( 0x100000, RGNCLASS_USER, "user2", ROMREGION_DISPOSE ) /* load the tiles here so we can split them up into the required regions by hand */
	ROM_LOAD( "back",     0x000000, 0x100000, CRC(58280989) SHA1(e3eef1f52829a91b8f87cfe27776a1f12679b3ca) )	/* 3 sets of tiles ('MBK','LBK','BK3') */

	ROM_REGION( 0x80000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE )  /* MBK */
	ROM_COPY( RGNCLASS_USER, "user2", 0x000000, 0x000000, 0x80000 )

	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE )
	/* Not Used */

	ROM_REGION( 0x80000, RGNCLASS_GFX, "gfx6", ROMREGION_DISPOSE )	/* LBK */
	ROM_COPY( RGNCLASS_USER, "user2", 0x080000, 0x000000, 0x78000 )

	ROM_REGION( 0x020000, RGNCLASS_SOUND, "oki", 0 )	/* ADPCM samples */
...
ROM_START( heatbrl )
	...
	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE )	/* MBK tiles */
	ROM_LOAD( "bg-1",     0x000000, 0x100000, CRC(2f5d8baa) SHA1(0bf687c46c603150eadb304adcd78d53a338e615) )

	ROM_REGION( 0x020000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE )	/* not used? */
	ROM_COPY( RGNCLASS_GFX, "gfx1", 0x010000, 0x000000, 0x010000 ) // this is just corrupt tiles if we decode it

	ROM_REGION( 0x080000, RGNCLASS_GFX, "gfx5", ROMREGION_DISPOSE )	/* BK3 tiles */
	ROM_LOAD( "bg-3",     0x000000, 0x080000, CRC(83850e2d) SHA1(cdc2df8e3bc58319c50768ea2a05b9c7ddc2a652) )

	ROM_REGION( 0x080000, RGNCLASS_GFX, "gfx6", ROMREGION_DISPOSE )	/* LBK tiles */
...
ROM_START( godzilla )
	...
	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx5", ROMREGION_DISPOSE )	/* BK3 tiles */
	ROM_LOAD( "bg2.619",      0x000000, 0x100000, CRC(8ac192a5) SHA1(54b557e81a704c70a651e6b8da70207a2a70530f) )

	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx6", ROMREGION_DISPOSE )	/* LBK tiles */
	ROM_COPY( RGNCLASS_GFX, "gfx3", 0x00000, 0x00000, 0x100000 )
...
ROM_START( denjinmk )
	...
	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE )	/* BK2 used */
	...
	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx6", ROMREGION_DISPOSE )	/* LBK tiles */
	ROM_COPY( RGNCLASS_GFX, "gfx4", 0x00000, 0x00000, 0x100000 )
...
ROM_START( sdgndmrb )
	...
	ROM_REGION( 0x040000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE )	/* not used */
...
//#define ROM_COPY(rgn,srcoffset,offset,length)
	ROM_COPY( RGNCLASS_GFX, "gfx3", 0x80000, 0x00000, 0x80000 )
...
ROM_START( cupsoc )
	...
	ROM_REGION( 0x080000, RGNCLASS_GFX, "gfx6", ROMREGION_DISPOSE )	/* LBK tiles */
	ROM_COPY( RGNCLASS_GFX, "gfx5", 0x00000, 0x00000, 0x080000 )
...
ROM_START( cupsocsb )
	...
	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE )	/* not used */
	ROM_COPY(RGNCLASS_GFX, "gfx3",0x00000,0x00000,0x100000)
	...
	ROM_REGION( 0x500000, RGNCLASS_USER, "user2", 0 )
	...
	ROM_REGION( 0x020000, RGNCLASS_SOUND, "oki2", 0 )	/* ADPCM samples */
	ROM_LOAD( "sc_02.bin",    0x000000, 0x20000, CRC(a70d4f03) SHA1(c2482e624c8a828a94206a36d10c1021ad8ca1d0) )

	ROM_REGION( 0x080000, RGNCLASS_SOUND, "oki1", 0 ) // sound related ?
...
{
	descramble_legionnaire_gfx( memory_region(machine, RGNCLASS_GFX, "gfx5") );
}
