...
void legionna_state::legionna(machine_config &config)
{
	...
	Z80(config, m_audiocpu, 14.31818_MHz_XTAL / 4);
	...
	ym3812_device &ymsnd(YM3812(config, "ymsnd", 14.31818_MHz_XTAL / 4));
...
//  screen.set_visarea(0*8, 40*8-1, 0*8, 28*8-1);
	...
	ym2151_device &ymsnd(YM2151(config, "ymsnd", 14.31818_MHz_XTAL / 4));
