...
GAME( 1978, topaz_l1, 0,        s4,  s4, shuffle_state, empty_init, ROT0, "Williams", "Topaz (Shuffle) (L-1)",                  MACHINE_MECHANICAL | MACHINE_SUPPORTS_SAVE )
GAME( 1978, pomp_l1,  0,        s4,  s4, shuffle_state, empty_init, ROT0, "Williams/United", "Pompeii (Shuffle) (L-1)",         MACHINE_MECHANICAL | MACHINE_SUPPORTS_SAVE )
GAME( 1978, arist_l1, 0,        s4,  s4, shuffle_state, empty_init, ROT0, "Williams/United", "Aristocrat (Shuffle) (L-1)",      MACHINE_MECHANICAL | MACHINE_SUPPORTS_SAVE )
