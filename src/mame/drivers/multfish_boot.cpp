...
GAME( 2002, mfish_3a,   mfish_13,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Multi Fish (bootleg, 021124, banking address hack)", MACHINE_SUPPORTS_SAVE ) // bank F9
GAME( 2002, mfish_12a,  mfish_13,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Multi Fish (bootleg, 040308, banking address hack)", MACHINE_SUPPORTS_SAVE ) // bank F9

GAME( 2003, czmon_7a,   czmon_13,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Crazy Monkey (bootleg, 031110, backdoor set 1)",         MACHINE_SUPPORTS_SAVE ) // backdoor 1,1 1,3 1,5 1,7  3,3  3,4
GAME( 2003, czmon_7b,   czmon_13,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Crazy Monkey (bootleg, 031110, backdoor set 2)",         MACHINE_SUPPORTS_SAVE ) // backdoor 1,5 5,5 1,7 3,2  3,3  3,4
GAME( 2003, czmon_8a,   czmon_13,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Crazy Monkey (bootleg, 050120, backdoor)",               MACHINE_SUPPORTS_SAVE ) // backdoor 1,1 1,3 1,5 1,7  3,3  3,4
GAME( 2003, czmon_8b,   czmon_13,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Crazy Monkey (bootleg, 050120, changed version text)",   MACHINE_SUPPORTS_SAVE ) // changed version text to 070315
GAME( 2003, czmon_8c,   czmon_13,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, init_customl, ROT0,  "bootleg", "Crazy Monkey (bootleg, 050120, VIDEO GAME-1 CM01)",      MACHINE_SUPPORTS_SAVE ) // custom alteras, modified graphics, changed version text to "VIDEO GAME-1 CM01"
...
GAME( 2003, fcockt_6a,  fcockt_8,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Fruit Cocktail (bootleg, 040216, banking address hack)",   MACHINE_SUPPORTS_SAVE ) // bank F8
GAME( 2003, fcockt_6b,  fcockt_8,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Fruit Cocktail (bootleg, 040216, backdoor)",               MACHINE_SUPPORTS_SAVE ) // backdoor 1,1 1,3 1,5 1,7  3,3  3,4
GAME( 2003, fcockt_6c,  fcockt_8,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Fruit Cocktail (bootleg, 040216, LotoRossy+)",             MACHINE_SUPPORTS_SAVE ) // modified graphics, some code changes, description says "for Lat-02 terminals", older set
GAME( 2003, fcockt_6d,  fcockt_8,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Fruit Cocktail (bootleg, 040216, VIDEO GAME-1 FR01)",      MACHINE_SUPPORTS_SAVE ) // modified graphics, some code changes, changed version text to "VIDEO GAME-1 FR01", description says "for Lat-02 terminals", newer set
GAME( 2003, fcockt_7a,  fcockt_8,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Fruit Cocktail (bootleg, 050118, backdoor)",               MACHINE_SUPPORTS_SAVE ) // backdoor 1,1 1,3 1,5 1,7  3,3  3,4
GAME( 2003, fcockt_7b,  fcockt_8,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, init_customl, ROT0,  "bootleg", "Fruit Cocktail (bootleg, 050118, VIDEO GAME-1 FR01)",      MACHINE_SUPPORTS_SAVE ) // custom alteras, modified graphics, many texts changed, changed version text to "VIDEO GAME-1 FR01"
GAME( 2003, fcockt_7c,  fcockt_8,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Fruit Cocktail (bootleg, 050118, payout percentage 40)",   MACHINE_SUPPORTS_SAVE ) // payout percentage 40%
GAME( 2003, fcockt_7d,  fcockt_8,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Fruit Cocktail (bootleg, 050118, payout percentage 60)",   MACHINE_SUPPORTS_SAVE ) // payout percentage 60%
GAME( 2003, fcockt_7e,  fcockt_8,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Fruit Cocktail (bootleg, 050118, payout percentage 70)",   MACHINE_SUPPORTS_SAVE ) // payout percentage 70%
GAME( 2003, fcockt_7f,  fcockt_8,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Fruit Cocktail (bootleg, 050118, changed version text)",   MACHINE_SUPPORTS_SAVE ) // changed version text to 070305
GAME( 2003, fcockt_7g,  fcockt_8,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Fruit Cocktail (bootleg, 050118, LOTO PROGRAM V-FC2)",     MACHINE_SUPPORTS_SAVE ) // modified graphics, many texts changed, changed version text to "LOTO PROGRAM V-FC2"
GAME( 2003, fcockt_7h,  fcockt_8,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Fruit Cocktail (bootleg, 050118, LOTOS FR01)",             MACHINE_SUPPORTS_SAVE ) // modified graphics, many texts changed, changed version text to "LOTOS FR01"
GAME( 2003, fcockt_8a,  fcockt_8,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Fruit Cocktail (bootleg, 060111, LOTO COCKTAIL V01-0001)", MACHINE_SUPPORTS_SAVE ) // modified graphics, many texts changed, changed version text to "LOTO COCKTAIL V01-0001"
GAME( 2003, fcockt_8b,  fcockt_8,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Fruit Cocktail (bootleg, 060111, LOTTOGAME (I))",          MACHINE_SUPPORTS_SAVE ) // modified graphics, changed version text to "MDS_is_the_best_ LOTTOGAME (I)"

GAME( 2003, lhaunt_4a,  lhaunt_6,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Lucky Haunter (bootleg, 031111, backdoor)",             MACHINE_SUPPORTS_SAVE ) // backdoor 1,1 1,3 1,5 1,7  3,3  3,4
GAME( 2003, lhaunt_5a,  lhaunt_6,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Lucky Haunter (bootleg, 040216, backdoor)",             MACHINE_SUPPORTS_SAVE ) // backdoor 1,1 1,3 1,5 1,7  3,3  3,4
GAME( 2003, lhaunt_6a,  lhaunt_6,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Lucky Haunter (bootleg, 040825, backdoor)",             MACHINE_SUPPORTS_SAVE ) // backdoor 1,5 9,1 5,1 1,5  3,3  3,4
GAME( 2003, lhaunt_6b,  lhaunt_6,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, init_customl, ROT0,  "bootleg", "Lucky Haunter (bootleg, 040825, VIDEO GAME-1 PB01)",    MACHINE_SUPPORTS_SAVE ) // custom alteras, modified graphics, many texts changed, changed version text to "VIDEO GAME-1 PB01"
GAME( 2003, lhaunt_6c,  lhaunt_6,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Lucky Haunter (bootleg, 040825, changed version text)", MACHINE_SUPPORTS_SAVE ) // changed version text to 070604
GAME( 2003, lhaunt_6d,  lhaunt_6,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Lucky Haunter (bootleg, 040825, LOTTOGAME (I))",        MACHINE_SUPPORTS_SAVE ) // modified graphics, changed version text to "MDS_is_the_best_ LOTTOGAME (I)"
GAME( 2003, lhaunt_6e,  lhaunt_6,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Lucky Haunter (bootleg, 040825, LOTO PROGRAM V-LH2)",   MACHINE_SUPPORTS_SAVE ) // modified graphics, many texts changed, changed version text to "LOTO PROGRAM V-LH2"
GAME( 2003, lhaunt_6f,  lhaunt_6,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, init_customl, ROT0,  "bootleg", "Lucky Haunter (bootleg, 040825, LOTOS PB01)",           MACHINE_SUPPORTS_SAVE ) // custom alteras, modified graphics, many texts changed, changed version text to "LOTOS PB01"

GAME( 2004, garage_4a,  garage_5,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Garage (bootleg, 040219, backdoor)", MACHINE_SUPPORTS_SAVE ) // backdoor 1,1 1,3 1,5 1,7  3,3  3,4
GAME( 2004, garage_4b,  garage_5,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Garage (bootleg, 040219, changed version text)", MACHINE_SUPPORTS_SAVE ) // changed version text to 070329
GAME( 2004, garage_4c,  garage_5,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Garage (bootleg, 040219, LOTO PROGRAM V-GG2)", MACHINE_SUPPORTS_SAVE ) // modified graphics, many texts changed, changed version text to "LOTO PROGRAM V-GG2"
GAME( 2004, garage_5a,  garage_5,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Garage (bootleg, 050311, backdoor)", MACHINE_SUPPORTS_SAVE ) // backdoor 1,1 1,3 1,5 1,7  3,3  3,4
GAME( 2004, garage_5b,  garage_5,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, init_customl, ROT0,  "bootleg", "Garage (bootleg, 050311, VIDEO GAME-1 GA01)", MACHINE_SUPPORTS_SAVE ) // custom alteras, modified graphics, changed version text to "VIDEO GAME-1 GA01"
GAME( 2004, garage_5c,  garage_5,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Garage (bootleg, 050311, payout percentage 70)", MACHINE_SUPPORTS_SAVE ) // payout percentage 70%
GAME( 2004, garage_5d,  garage_5,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Garage (bootleg, 050311, LOTTOGAME (I))", MACHINE_SUPPORTS_SAVE ) // modified graphics, changed version text to "MDS_is_the_best_ LOTTOGAME (I)"
GAME( 2004, garage_5e,  garage_5,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, init_customl, ROT0,  "bootleg", "Garage (bootleg, 050311, LOTOS GA01)", MACHINE_SUPPORTS_SAVE ) // custom alteras, modified graphics, many texts changed, changed version text to "LOTOS GA01"

GAME( 2004, rclimb_3a,  rclimb_3,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Rock Climber (bootleg, 040827, backdoor)",          MACHINE_SUPPORTS_SAVE ) // backdoor 1,5 9,1 5,1 1,5  3,3  3,4
GAME( 2004, rclimb_3b,  rclimb_3,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Rock Climber (bootleg, 040827, new service menu)",  MACHINE_SUPPORTS_SAVE ) // new service menu
GAME( 2004, rclimb_3c,  rclimb_3,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, init_customl, ROT0,  "bootleg", "Rock Climber (bootleg, 040827, VIDEO GAME-1 SK01)", MACHINE_SUPPORTS_SAVE ) // custom alteras, modified graphics, many texts changed, changed version text to "VIDEO GAME-1 SK01"
GAME( 2004, rclimb_3d,  rclimb_3,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Rock Climber (bootleg, 040827, LOTTOGAME (I))",     MACHINE_SUPPORTS_SAVE ) // modified graphics, changed version text to "MDS_is_the_best_ LOTTOGAME (I)"
GAME( 2004, rclimb_3e,  rclimb_3,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, init_customl, ROT0,  "bootleg", "Rock Climber (bootleg, 040827, LOTOS SK01)",        MACHINE_SUPPORTS_SAVE ) // custom alteras, modified graphics, many texts changed, changed version text to "LOTOS SK01"

GAME( 2004, sweetla,    sweetl,    igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Sweet Life (bootleg, 041220, backdoor)",                                   MACHINE_SUPPORTS_SAVE ) // backdoor 1,5 9,1 5,3 1,5  3,3  3,4
GAME( 2004, sweetlb,    sweetl,    igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Sweet Life (bootleg, 041220, banking address hack, changed version text)", MACHINE_SUPPORTS_SAVE ) // bank F9, changed version text to 070412

GAME( 2004, resdnt_2a,  resdnt_6,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Resident (bootleg, 040513, backdoor)",                MACHINE_SUPPORTS_SAVE ) // backdoor 1,5 9,1 5,1 1,5  3,3  3,4
GAME( 2004, resdnt_2b,  resdnt_6,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, init_customl, ROT0,  "bootleg", "Resident (bootleg, 040513, VIDEO GAME-1 SE01 set 1)", MACHINE_SUPPORTS_SAVE ) // custom alteras, modified graphics, changed version text to "VIDEO GAME-1 SE01"
GAME( 2004, resdnt_2c,  resdnt_6,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, init_customl, ROT0,  "bootleg", "Resident (bootleg, 040513, VIDEO GAME-1 SE01 set 2)", MACHINE_SUPPORTS_SAVE ) // custom alteras, modified graphics, changed version text to "VIDEO GAME-1 SE01"
GAME( 2004, resdnt_2d,  resdnt_6,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, init_customl, ROT0,  "bootleg", "Resident (bootleg, 040513, VIDEO GAME-1 SE01 set 3)", MACHINE_SUPPORTS_SAVE ) // custom alteras, modified graphics, many texts changed, changed version text to "VIDEO GAME-1 SE01"
GAME( 2004, resdnt_2e,  resdnt_6,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Resident (bootleg, 040513, LOTTOGAME (I))",           MACHINE_SUPPORTS_SAVE ) // modified graphics, changed version text to "MDS_is_the_best_ LOTTOGAME (I)"
GAME( 2004, resdnt_2f,  resdnt_6,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Resident (bootleg, 040513, LOTO PROGRAM V-RS2)",      MACHINE_SUPPORTS_SAVE ) // modified graphics, many texts changed, changed version text to "LOTO PROGRAM V-RS2"
GAME( 2004, resdnt_2g,  resdnt_6,  igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, init_customl, ROT0,  "bootleg", "Resident (bootleg, 040513, LOTOS SE01)",              MACHINE_SUPPORTS_SAVE ) // custom alteras, modified graphics, many texts changed, changed version text to "LOTOS SE01"

GAME( 2005, islanda,    island,    igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Island (bootleg, 050713, backdoor)",          MACHINE_SUPPORTS_SAVE ) // backdoor 1,1 1,3 1,5 1,7  3,3  3,4
GAME( 2005, islandb,    island,    igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, init_customl, ROT0,  "bootleg", "Island (bootleg, 050713, VIDEO GAME-1 OS01)", MACHINE_SUPPORTS_SAVE ) // custom alteras, modified graphics, many texts changed, changed version text to "VIDEO GAME-1 OS01"
GAME( 2005, islandc,    island,    igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, init_customl, ROT0,  "bootleg", "Island (bootleg, 050713, LOTOS OS01)",        MACHINE_SUPPORTS_SAVE ) // custom alteras, modified graphics, many texts changed, changed version text to "LOTOS OS01"

GAME( 2006, island2a,   island2,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Island 2 (bootleg, 060529, banking address hack)",                       MACHINE_SUPPORTS_SAVE ) // bank F9 (not standard, requires default value in timekeeper to boot)
GAME( 2006, island2b,   island2,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Island 2 (bootleg, 060529, banking address hack, changed version text)", MACHINE_SUPPORTS_SAVE ) // bank F9, changed version text to 070205, skip some start tests
GAME( 2006, island2c,   island2,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Island 2 (bootleg, 060529, LOTTOGAME (I))",                              MACHINE_SUPPORTS_SAVE ) // bank F9, modified graphics, changed version text to "MDS_is_the_best_ LOTTOGAME (I)"
GAME( 2006, island2_3a, island2,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Island 2 (bootleg, 061218, VIDEO GAME-1 OS2-01)",                        MACHINE_SUPPORTS_SAVE ) // bank F9, modified graphics, changed version text to "VIDEO GAME-1 OS2-01"
GAME( 2006, island2_4a, island2,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Island 2 (bootleg, 070205, banking address hack)",                       MACHINE_SUPPORTS_SAVE ) // bank F9

GAME( 2006, pirate2a,   pirate2,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Pirate 2 (bootleg, 061005, banking address hack set 1)",                       MACHINE_SUPPORTS_SAVE ) // bank F9
GAME( 2006, pirate2b,   pirate2,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Pirate 2 (bootleg, 061005, banking address hack set 2)",                       MACHINE_SUPPORTS_SAVE ) // bank F9, skip raster beam position check
GAME( 2006, pirate2c,   pirate2,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Pirate 2 (bootleg, 061005, banking address hack, changed version text set 1)", MACHINE_SUPPORTS_SAVE ) // bank F9, changed version text to 070126
GAME( 2006, pirate2d,   pirate2,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Pirate 2 (bootleg, 061005, banking address hack, changed version text set 2)", MACHINE_SUPPORTS_SAVE ) // bank F9, changed version text to 070126
GAME( 2006, pirate2e,   pirate2,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Pirate 2 (bootleg, 061005, banking address hack, changed version text set 3)", MACHINE_SUPPORTS_SAVE ) // bank F9, changed version text to 070126, skip some start tests
GAME( 2006, pirate2f,   pirate2,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, init_customl, ROT0,  "bootleg", "Pirate 2 (bootleg, 061005, VIDEO GAME-1 PR01)",                                MACHINE_SUPPORTS_SAVE ) // custom alteras, modified graphics, many texts changed, changed version text to "VIDEO GAME-1 PR01"
GAME( 2006, pirate2g,   pirate2,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Pirate 2 (bootleg, 061005, LOTTOGAME (I))",                                    MACHINE_SUPPORTS_SAVE ) // bank F9, modified graphics, changed version text to "MDS_is_the_best_ LOTTOGAME (I)"
...
GAME( 2007, gnomec,     gnome_9,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Gnome (bootleg, 070906, banking address hack set 3)",                 MACHINE_SUPPORTS_SAVE ) // bank F9
GAME( 2007, gnomed,     gnome_9,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, init_customl, ROT0,  "bootleg", "Gnome (bootleg, 070906, VIDEO GAME-1 GN01)",                          MACHINE_SUPPORTS_SAVE ) // custom alteras, modified graphics, many texts changed, changed version text to "VIDEO GAME-1 GN01"
GAME( 2007, gnomee,     gnome_9,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, init_customl, ROT0,  "bootleg", "Gnome (bootleg, 070906, LOTOS GN01)",                                 MACHINE_SUPPORTS_SAVE ) // custom alteras, modified graphics, bank F9, many texts changed, changed version text to "LOTOS GN01"
GAME( 2007, gnome_2a,   gnome_9,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Gnome (bootleg, 071115, banking address hack)",                       MACHINE_SUPPORTS_SAVE ) // bank F9
GAME( 2007, gnome_3a,   gnome_9,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Gnome (bootleg, 080303, banking address hack)",                       MACHINE_SUPPORTS_SAVE ) // bank F9
GAME( 2007, gnome_3b,   gnome_9,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Gnome (bootleg, 080303, banking address hack, payout percentage 45)", MACHINE_SUPPORTS_SAVE ) // bank F9 payout percentage 45%
GAME( 2007, gnome_3c,   gnome_9,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Gnome (bootleg, 080303, banking address hack, payout percentage 60)", MACHINE_SUPPORTS_SAVE ) // bank F9 payout percentage 60%
GAME( 2007, gnome_5a,   gnome_9,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Gnome (bootleg, 090406, banking address hack, payout percentage 70)", MACHINE_SUPPORTS_SAVE ) // bank F9, payout percentage 70%
GAME( 2007, gnome_5b,   gnome_9,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Gnome (bootleg, 090406, LOTTOGAME (I))",                              MACHINE_SUPPORTS_SAVE ) // bank F9, modified graphics, changed version text to "MDS_is_the_best_ LOTTOGAME (I)"

GAME( 2007, sweetl2_2a, sweetl2,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Sweet Life 2 (bootleg, 080320, banking address hack set 1)", MACHINE_SUPPORTS_SAVE ) // bank F9
GAME( 2007, sweetl2_2b, sweetl2,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Sweet Life 2 (bootleg, 080320, banking address hack set 2)", MACHINE_SUPPORTS_SAVE ) // bank F9, some fixes
GAME( 2007, sweetl2_2c, sweetl2,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Sweet Life 2 (bootleg, 080320, VIDEO GAME-1 MD01)",          MACHINE_SUPPORTS_SAVE ) // modified graphics, bank F9, changed version text to "VIDEO GAME-1 MD01"
GAME( 2007, sweetl2_2d, sweetl2,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Sweet Life 2 (bootleg, 080320, LOTTOGAME (I))",              MACHINE_SUPPORTS_SAVE ) // bank F9, modified graphics, changed version text to "MDS_is_the_best_ LOTTOGAME (I)"

GAME( 2008, fcockt2a,   fcockt2,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Fruit Cocktail 2 (bootleg, 080707, banking address hack)",                       MACHINE_SUPPORTS_SAVE ) // bank F9
GAME( 2008, fcockt2_4a, fcockt2,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Fruit Cocktail 2 (bootleg, 081105, banking address hack)",                       MACHINE_SUPPORTS_SAVE ) // bank F9
GAME( 2008, fcockt2_4b, fcockt2,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Fruit Cocktail 2 (bootleg, 081105, banking address hack, no credit limit)",      MACHINE_SUPPORTS_SAVE ) // bank F9, no credit limit, "MaxVin" signature
GAME( 2008, fcockt2_4c, fcockt2,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, init_customl, ROT0,  "bootleg", "Fruit Cocktail 2 (bootleg, 081105, VIDEO GAME-1 FR02)",                          MACHINE_SUPPORTS_SAVE ) // custom alteras, modified graphics, bank F9, many texts changed, changed version text to "VIDEO GAME-1 FR02"
GAME( 2008, fcockt2_4d, fcockt2,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Fruit Cocktail 2 (bootleg, 081105, banking address hack, payout percentage 70)", MACHINE_SUPPORTS_SAVE ) // bank F9, no credit limit, "MaxVin" signature, payout percentage 70%
GAME( 2008, fcockt2_4e, fcockt2,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init,   ROT0,  "bootleg", "Fruit Cocktail 2 (bootleg, 081105, LOTTOGAME (I))",                              MACHINE_SUPPORTS_SAVE ) // bank F9, modified graphics, changed version text to "MDS_is_the_best_ LOTTOGAME (I)"
GAME( 2008, fcockt2_4f, fcockt2,   igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, init_customl, ROT0,  "bootleg", "Fruit Cocktail 2 (bootleg, 081105, LOTOS FR02)",                                 MACHINE_SUPPORTS_SAVE ) // custom alteras, modified graphics, bank F9, many texts changed, changed version text to "LOTOS FR02"
...
GAME( 2003, igromult,   0,        igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init, ROT0,  "bootleg", "Igrosoft Multigame Bootleg (10 Games)", MACHINE_NOT_WORKING ) // no GFX roms
GAME( 2003, igromula,   igromult, igrosoft_gamble, igrosoft_gamble, igrosoft_gamble_state, empty_init, ROT0,  "bootleg", "Igrosoft Multigame Bootleg (15 Games)", MACHINE_NOT_WORKING ) // no GFX roms
