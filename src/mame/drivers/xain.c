...
ROM_START( xsleena )
	...
	ROM_LOAD( "p1-0.ic29",    0x08000, 0x8000, CRC(a1a860e2) SHA1(fb2b152bfafc44608039774436ddf3b17eed979c) ) /* Need to verify proper rom label */
	ROM_LOAD( "p0-0.ic133",   0x04000, 0x4000, CRC(948b9757) SHA1(3ea840cc47ae6a66f3e5f6a2f3e88475dcfe1840) ) /* Need to verify proper rom label */
	ROM_CONTINUE(             0x10000, 0x4000 )
	...
	ROM_LOAD( "pn-0.ic133",   0x18000, 0x8000, CRC(d37939e0) SHA1(301d9f6720857c64a4e070444a07a38138ddd4ef) ) /* Need to verify proper rom label */
	...
	ROM_LOAD( "pf-0.ic111",   0x38000, 0x8000, CRC(e59a2f27) SHA1(4643cea85f8613c36b416f46f9d1753fa9839237) ) /* Need to verify proper rom label */
