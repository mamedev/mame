...
ROM_START( spbactn )
	...
	ROM_REGION( 0x080000, RGNCLASS_GFX, "gfx1", 0 ) /* 16x8 FG Tiles */
	...
	ROM_REGION( 0x080000, RGNCLASS_GFX, "gfx2", 0 ) /* 16x8 BG Tiles */
	...
	ROM_REGION( 0x080000, RGNCLASS_GFX, "gfx3", 0 ) /* 8x8 Sprite Tiles */
