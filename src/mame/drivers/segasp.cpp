...
uint64_t segasp_state::sp_bank_r(address_space &space, offs_t offset, uint64_t mem_mask)
{
...
void segasp_state::sp_bank_w(address_space &space, offs_t offset, uint64_t data, uint64_t mem_mask)
{
	if (ACCESSING_BITS_32_63)
		return;
...
uint64_t segasp_state::sn_93c46a_r(address_space &space, offs_t offset, uint64_t mem_mask)
{
	int res;
...
void segasp_state::sn_93c46a_w(address_space &space, offs_t offset, uint64_t data, uint64_t mem_mask)
{
	/* bit 4 is data */
	/* bit 2 is clock */
	/* bit 5 is cs */
...
uint64_t segasp_state::sp_eeprom_r(address_space &space, offs_t offset, uint64_t mem_mask)
{
	if (ACCESSING_BITS_32_63)
		return -1;
...
void segasp_state::sp_eeprom_w(address_space &space, offs_t offset, uint64_t data, uint64_t mem_mask)
{
	if (ACCESSING_BITS_32_63)
		return;
...
uint64_t segasp_state::sp_rombdflg_r(address_space &space, offs_t offset, uint64_t mem_mask)
{
...
uint64_t segasp_state::sp_io_r(address_space &space, offs_t offset, uint64_t mem_mask)
{
	uint64_t retval;
