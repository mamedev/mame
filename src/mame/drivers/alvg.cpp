...
ROM_START(wrldtour)
	ROM_REGION(0x10000, "maincpu", 0)
	ROM_LOAD("cpu", 0x0000, EPROM_27C512, CRC(c9572fb5) SHA1(47a3e8943ef4207011a33f4a03a6e722c937cc48))
	ROM_REGION(0x10000, "cpu2", 0)
	...
	ROM_LOAD("dot", 0x100000, EPROM_27C512, CRC(c8bd48e7) SHA1(e2dc513dd42c05c2018e6d8c0b6f0b2c56e6e059))
