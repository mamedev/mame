...
void mpu4mod4yam_machines_state::mod4yam_m4addr(machine_config &config)
{
	...
	m_characteriser->set_lamp_table(m4addr_lamp_scramble);
}
...
// 00 84 8C D8 74 80 4C 90 E8 78 54 60 84
...
// 00 14 04 94 c8 68 a0 50 8c e8 e0 dc
// different CHR - boots
