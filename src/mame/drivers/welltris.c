...
ROM_START( welltris )
	...
	ROM_REGION( 0x0a0000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) /* CHAR Tiles */
	ROM_LOAD( "lh534j12.77", 0x000000, 0x80000, CRC(b61a8b74) SHA1(e17f7355375bdc166ef8131f7de9dbda5453f570) )

	ROM_REGION( 0x80000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE ) /* SPRITE Tiles */
...
ROM_START( quiz18k )
	...
	ROM_REGION( 0x180000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) /* CHAR Tiles */
	...
	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE ) /* SPRITE Tiles */
	...
	ROM_REGION( 0x040000, RGNCLASS_SOUND, "ym.deltat", 0 ) /* sound samples */
	ROM_LOAD( "ic126.bin", 0x00000, 0x40000, CRC(7a92fbc9) SHA1(c13be1e84fc8e74c85d25d3357e078bc9e264682) )

	ROM_REGION( 0x140000, RGNCLASS_SOUND, "ym", 0 ) /* sound samples */
