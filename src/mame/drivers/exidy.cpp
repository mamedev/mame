...
ROM_START( mtrap )
	...
	ROM_REGION( 0x140, "proms", 0 ) // PROMs located at 6c and 3d were dumped from a bootleg, very probably they are the same, but marked as bad dump for precaution. They also match the teetert ones.
