...
ROM_START( nekkyoku )
	ROM_REGION( 0x010000, RGNCLASS_CPU, "main", 0 )
	...
	ROM_REGION( 0x210000, RGNCLASS_CPU, "sub", 0 )
...
ROM_START( idolmj )
	...
	ROM_REGION( 0x410000, RGNCLASS_CPU, "sub", 0 )
...
ROM_START( daiyogen )
	...
	ROM_REGION( 0x130000, RGNCLASS_CPU, "sub", 0 )
	...
	ROM_REGION( 0x0c0000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )
