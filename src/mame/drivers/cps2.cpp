...
/*************************************
 *
 *  Network Passthrough Polling
 *
 *************************************/

TIMER_DEVICE_CALLBACK_MEMBER(cps2_state::cps2_net_check_data) {
	checkDataAvailable();
}
...
void cps2_state::cps2_map(address_map &map)
{
	...
	map(0x620000, 0x6200ff).rw(FUNC(cps2_state::cps2_network_r), FUNC(cps2_state::cps2_network_w)); /* Network adapter related, accessed in SSF2TB */
...
void cps2_state::cps2(machine_config &config)
{
	...
	TIMER(config, "nettimer").configure_periodic(FUNC(cps2_state::cps2_net_check_data), attotime::from_hz(7200));
...
ROM_START( ffightae_cps2 )
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
	ROM_LOAD16_WORD_SWAP( "ff-23m.8h", 0x000000, 0x80000, CRC(0EA32B07) SHA1(A28F5DAAD833E02A0E16BC66E37EA0D8B55F7AED) )
	ROM_LOAD16_WORD_SWAP( "ff-22m.7h", 0x080000, 0x80000, CRC(7B71482F) SHA1(DFCA01C8CE6A91B50C548EBCE876FDA1198E0D4C) )

	ROM_REGION16_BE( CODE_SIZE, "user1", 0 )
	ROM_FILL( 0x000000, 0x100000, 0x00 )

	ROM_REGION( 0x2000000, "gfx", 0 )
	ROM_LOAD64_WORD( "ff-5m.7a",   0x0000000, 0x400000, CRC(D169D922) SHA1(F2B224985B3E1B57B93D832882F61C820AEE6A9E) )
	ROM_LOAD64_WORD( "ff-7m.9a",   0x0000002, 0x400000, CRC(3FF368AC) SHA1(9A13343DDB202A31AE8712D09144D991CE0E31CF) )
	ROM_LOAD64_WORD( "ff-1m.3a",   0x0000004, 0x400000, CRC(034BD2F3) SHA1(955EE25F3C954F5672EFC3F043673304B87A3668) )
	ROM_LOAD64_WORD( "ff-3m.5a",   0x0000006, 0x400000, CRC(579063F5) SHA1(C1CC6A025255BA6223762A69731E80B458FFBEE0) )

	ROM_REGION( QSOUND_SIZE, "audiocpu", 0 ) /* 64k for the audio CPU (+banks) */
	ROM_LOAD( "sz3.01",   0x00000, 0x08000, CRC(D6E5E934) SHA1(51DB605BBE395AA26A4506BB5EB0034C6FC392AD) )
	ROM_CONTINUE(         0x10000, 0x18000 )
	ROM_LOAD( "sz3.02",   0x28000, 0x20000, CRC(72445dc4) SHA1(14fca7596ac45ba655016eef5b6120f9f9671c23) )
...
ROM_START( ssf2xjtb )
	ROM_REGION( CODE_SIZE, "maincpu", 0 )      /* 68000 code */
	ROM_LOAD16_WORD_SWAP( "sfxjd.03c", 0x000000, 0x80000, CRC(d1432cf1) SHA1(665536bfd072e9fcc591742f5c654554ce53786e) )
	ROM_LOAD16_WORD_SWAP( "sfxjd.04a", 0x080000, 0x80000, CRC(57110cd3) SHA1(b1b2cb28d80fef79787235423ad93c78e9e80ab9) )
	...
	ROM_LOAD16_WORD_SWAP( "sfxd.09",   0x300000, 0x80000, CRC(642fae3f) SHA1(746df99b826b9837bba267104132161153c1daff) )
	ROM_LOAD16_WORD_SWAP( "sfxjtb.10", 0x380000, 0x80000, CRC(2602dd2c) SHA1(4524e8a06156cfd11aafb631650c2bb37ef38ccf) )
...
GAME( 1994, ssf2xjtb,   ssf2t,    dead_cps2, cps2_2p6b, cps2_state, init_ssf2tb,   ROT0,   "bootleg", "Super Street Fighter II X: Tournament Battle (Japan 940223)", MACHINE_SUPPORTS_SAVE )
...
GAME( 1998, ffightae_cps2,  0,    dead_cps2, cps2_3p3b, cps2_state, init_cps2,     ROT0,   "bootleg", "Final Fight Anniversary Edition CPS2", MACHINE_SUPPORTS_SAVE )
