...
DRIVER_INIT_MEMBER(cps_state,mmatrix)
{
	DRIVER_INIT_CALL(cps2);
...
GAME( 1995, mshbr1,     msh,      cps2, cps2_2p6b, cps_state, cps2,     ROT0,   "Capcom", "Marvel Super Heroes (Brazil 951024)", MACHINE_SUPPORTS_SAVE )
