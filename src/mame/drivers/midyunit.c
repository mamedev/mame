...
ROM_START( narc )
	ROM_REGION( 0x90000, RGNCLASS_CPU, "narc1", 0 )	/* sound CPU */
	...
	ROM_REGION( 0x90000, RGNCLASS_CPU, "narc2", 0 )	/* slave sound CPU */
...
ROM_START( trog )
	ROM_REGION( 0x90000, RGNCLASS_CPU, "cvsd", 0 )	/* sound CPU */
...
ROM_START( hiimpact )
	...
	ROM_REGION( 0x1100, RGNCLASS_PLDS, "plds", ROMREGION_DISPOSE )
...
ROM_START( mkprot9 )
	ROM_REGION( 0x50000, RGNCLASS_CPU, "adpcm", 0 )	/* sound CPU */
	ROM_LOAD (  "mks-u3.rom", 0x10000, 0x40000, CRC(c615844c) SHA1(5732f9053a5f73b0cc3b0166d7dc4430829d5bc7) )

	ROM_REGION( 0x200000, RGNCLASS_SOUND, "adpcm", 0 )	/* ADPCM */
...
ROM_START( mkyawdim )
	...
	ROM_REGION( 0x100000, RGNCLASS_SOUND, "adpcm", 0 )	/* ADPCM */
