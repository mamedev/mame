...
/*    */ GAME( 1983, cgraplop2, cgraplop, cgraplop2,cgraplop2,decocass_type3_state, decocass, ROT270, "Data East Corporation", "Cluster Buster (DECO Cassette) (US) (Prototype?)", 0 ) /* button 1 does nothing, infinite shield despite the attract mode claiming otherwise, title screen corrupt, repetitive level design, most likely a proto unless the encryption is still an issue (unlikely) */
