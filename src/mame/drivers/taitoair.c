...
ROM_START( topland )
	ROM_REGION( 0xc0000, RGNCLASS_CPU, "main", 0 )	/* 68000 */
	...
	ROM_REGION( 0x1c000, RGNCLASS_CPU, "audio", 0 )	/* Z80 */
	...
	ROM_REGION( 0x20000, RGNCLASS_CPU, "dsp", 0 )	/* TMS320C25 */
	...
	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )	/* 16x16 tiles */
	...
	ROM_REGION( 0xa0000, RGNCLASS_SOUND, "ym", 0 )	/* ADPCM samples */
	...
	ROM_REGION( 0x20000, RGNCLASS_SOUND, "ym.deltat", 0 )	/* Delta-T samples */
	ROM_LOAD( "b62-18.31", 0x00000, 0x20000, CRC(3a4e687a) SHA1(43f07fe19dec351e851defdf9c7810fb9df04736) )

	ROM_REGION( 0x02000, RGNCLASS_USER, "user1", 0 )	/* unknown */
...
ROM_START( ainferno )
	...
	ROM_REGION( 0x02000, RGNCLASS_USER, "user1", 0 )
	ROM_LOAD( "c45-xx.22", 0x00000, 0x02000, NO_DUMP )	// video board

	ROM_REGION( 0x1c00, RGNCLASS_PLDS, "plds", ROMREGION_DISPOSE )
