...
uint16_t galpani2_state::galpani2_eeprom_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	return (m_eeprom_word & ~1) | (m_eeprom->do_read() & 1);
}

void galpani2_state::galpani2_eeprom_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void galpani2_state::galpani2_mcu_init_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void galpani2_state::galpani2_mcu_nmi1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)//driven by CPU1's int5 ISR
{
//for galpan2t:
...
void galpani2_state::galpani2_mcu_nmi2_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)//driven by CPU2's int5 ISR
{
...
void galpani2_state::galpani2_coin_lockout_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void galpani2_state::galpani2_oki1_bank_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void galpani2_state::galpani2_oki2_bank_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void galpani2_state::subdatabank_select_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	data &= mem_mask;
