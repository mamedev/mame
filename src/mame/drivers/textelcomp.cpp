...
static INPUT_PORTS_START(textelcomp)
	...
	PORT_BIT(0x20, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME("\xc3\x96") PORT_CHAR(0xf6) PORT_CHAR(0xd6) PORT_CHAR(0x1c) PORT_CODE(KEYCODE_COLON) // Ö
	...
	PORT_BIT(0x20, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME("\xc3\x84") PORT_CHAR(0xe4) PORT_CHAR(0xc4) PORT_CHAR(0x1b) PORT_CODE(KEYCODE_QUOTE) // Ä
	...
	PORT_BIT(0x10, IP_ACTIVE_LOW, IPT_KEYBOARD) PORT_NAME("\xc3\x9c") PORT_CHAR(0xfc) PORT_CHAR(0xdc) PORT_CHAR(0x1d) PORT_CODE(KEYCODE_OPENBRACE) // Ü
