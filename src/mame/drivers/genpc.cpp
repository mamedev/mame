...
ROM_START(pc)
	...
	ROM_SYSTEM_BIOS(27, "excel31", "Excel-Turbo Computer Version 3.1")
	ROMX_LOAD( "excel-turbo_computer_3.1_2764.bin", 0x00000, 0x2000, CRC(d319fea7) SHA1(5b4b0eb35889602aa7f18de82800599528690e15),ROM_BIOS(27))
	ROM_SYSTEM_BIOS(28, "s10b1", "Super 10-B1") // another Phoenix 2.51 variant
	ROMX_LOAD( "super_10-b1_27c64.bin", 0x00000, 0x2000, CRC(ba7797db) SHA1(2ee8863640b860a1807cc41e1ac9d94f73a087aa),ROM_BIOS(28))
	ROM_SYSTEM_BIOS(29, "td386", "TD 3.86")
	ROMX_LOAD( "td3.86_id_75102637.bin", 0x00000, 0x2000, CRC(aec96e13) SHA1(6e3143418f439a0373fba626cf69df34e41815e5),ROM_BIOS(29))
	ROM_SYSTEM_BIOS(30, "td391", "TD 3.91")
	ROMX_LOAD( "tbios-ii.rom", 0x00000, 0x2000, CRC(508b1bad) SHA1(ee9f51423f4cccfdc160c565ecd95fabbcb8a4d4),ROM_BIOS(30))
	ROM_SYSTEM_BIOS(31, "td393", "TD 3.93")
	ROMX_LOAD( "td3.93.bin", 0x00000, 0x2000, CRC(807620d9) SHA1(3f0ca24e33feb32051de9e819b962df1528a0403),ROM_BIOS(31))
	ROM_SYSTEM_BIOS(32, "yangp227", "YANGTECH.INC Phoenix 2.27")
	ROMX_LOAD( "000p001.bin", 0x00000, 0x2000, CRC(16f4fdc8) SHA1(8e73e9d1456aadd65bb89cc813d1aa1354c90d68),ROM_BIOS(32))
	ROM_SYSTEM_BIOS(33, "ethom11f", "ETHOM Associates Version 1.1f") // 8 MHz
	ROMX_LOAD( "ethom_associates_version_1.1f.bin", 0x00000, 0x02000, CRC(bbe7dc12) SHA1(195989a43e6701ff247329524622f1d6f41db7b4),ROM_BIOS(33))
	ROM_SYSTEM_BIOS(34, "arc20", "ARC BIOS 2.0") // ABC Turbo Board - X Turbo System
	ROMX_LOAD( "ibm-artb.rom", 0x00000, 0x2000, CRC(0ae5bf8e) SHA1(79b043070c92f9b2f6f9ca25fe61b4c1fcdf1bc8),ROM_BIOS(34))
	ROM_SYSTEM_BIOS(35, "pho252", "XT Phoenix Bios 2.52")
	ROMX_LOAD( "ibm-phxt.rom", 0x00000, 0x2000, CRC(c0bc9482) SHA1(a527403c92b6bf4fd876f516c18ca499cb7d4b13),ROM_BIOS(35))
	ROM_SYSTEM_BIOS(36, "com33", "IBM Compatible BIOS v3.3")
	ROMX_LOAD( "ibm3-3.rom", 0x00000, 0x02000, CRC(bf6dde1a) SHA1(e63456a888b887b8c0f77f35261ff067f0e2020d),ROM_BIOS(36))
	ROM_SYSTEM_BIOS(37, "xt16", "Turbo BIOS for PC XT-16")
	ROMX_LOAD( "ibmturb.rom", 0x00000, 0x2000, CRC(ba4a711e) SHA1(82fe2f76fd6668d2b38f8e6552a605d70c822792),ROM_BIOS(37))
	ROM_SYSTEM_BIOS(38, "znix", "Z-NIX PC-1600")
	ROMX_LOAD( "ibmzen.rom", 0x00000, 0x2000, CRC(c5468172) SHA1(499a7813f870b04003e246cc90d4a591d043c6bb),ROM_BIOS(038))
	ROM_SYSTEM_BIOS(39, "pcpi", "PC/88 BIOS Ver1.92") // use pcega
