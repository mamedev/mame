...
#define SEGAPCM_RELOAD_32K(offset)\
ROM_RELOAD( offset,         0x8000)\
ROM_RELOAD( offset+0x10000, 0x8000)
...
ROM_START( outrun )
	...
	ROM_REGION( 0x100000, "pcm", ROMREGION_ERASEFF ) // sound PCM data
	SEGAPCM_LOAD_32K( "opr-10193.66", 0x00000, CRC(bcd10dde) SHA1(417ce1d7242884640c5b14f4db8ee57cde7d085d) )
	SEGAPCM_RELOAD_32K(               0x08000 )
	SEGAPCM_LOAD_32K( "opr-10192.67", 0x20000, CRC(770f1270) SHA1(686bdf44d45c1d6002622f6658f037735382f3e0) )
	SEGAPCM_RELOAD_32K(               0x28000 )
	SEGAPCM_LOAD_32K( "opr-10191.68", 0x40000, CRC(20a284ab) SHA1(7c9027416d4122791ba53782fe2230cf02b7d506) )
	SEGAPCM_RELOAD_32K(               0x48000 )
	SEGAPCM_LOAD_32K( "opr-10190.69", 0x60000, CRC(7cab70e2) SHA1(a3c581d2b438630d0d4c39481dcfd85681c9f889) )
	SEGAPCM_RELOAD_32K(               0x68000 )
	SEGAPCM_LOAD_32K( "opr-10189.70", 0x80000, CRC(01366b54) SHA1(f467a6b807694d5832a985f5381c170d24aaee4e) )
	SEGAPCM_RELOAD_32K(               0x88000 )
	SEGAPCM_LOAD_32K( "opr-10188.71", 0xa0000, CRC(bad30ad9) SHA1(f70dd3a6362c314adef313b064102f7a250401c8) )
	SEGAPCM_RELOAD_32K(               0xa8000 )
ROM_END
...
ROM_START( outruneh )
	...
	SEGAPCM_LOAD_32K( "opr-10189.70", 0x80000, CRC(01366b54) SHA1(f467a6b807694d5832a985f5381c170d24aaee4e) )
	SEGAPCM_RELOAD_32K(               0x88000 )
	SEGAPCM_LOAD_32K( "enhanced_103_opr-10188.71", 0xa0000, CRC(37598616) SHA1(e7c8ae6c59742e1de7ec5a95c5aebfab5716d959) ) // unofficial replacement for factory defective opr-10188
	SEGAPCM_RELOAD_32K(               0xa8000 )
ROM_END
...
ROM_START( outrunb )
	...
	ROM_LOAD( "a-5.bin", 0x40000, 0x08000, CRC(374466d0) SHA1(c648bcb17ed0501bb3e94994716b4a7b81ec75e4) )
	ROM_CONTINUE(        0x50000, 0x08000 )
	ROM_LOAD( "a-4.bin", 0x80000, 0x08000, CRC(2a27d0b0) SHA1(018db0e80af37c22c4eb57747093ac3b9faf8931) )
	ROM_CONTINUE(        0x90000, 0x08000 )
	ROM_COPY( "pcm",     0x00000, 0x20000, 0x20000)
	ROM_COPY( "pcm",     0x40000, 0x60000, 0x20000)
	ROM_COPY( "pcm",     0x80000, 0xa0000, 0x20000)
ROM_END
...
ROM_START( shangon )
	...
	SEGAPCM_LOAD_32K( "epr-10643.66", 0x00000, CRC(06f55364) SHA1(fd685795e12541e3d0059d383fab293b3980d247) )
	SEGAPCM_RELOAD_32K(               0x08000 )
	SEGAPCM_LOAD_32K( "epr-10644.67", 0x20000, CRC(b41d541d) SHA1(28bbfa5edaa4a5901c74074354ba6f14d8f42ff6) )
	SEGAPCM_RELOAD_32K(               0x28000 )
	SEGAPCM_LOAD_32K( "epr-10645.68", 0x40000, CRC(a60dabff) SHA1(bbef0fb0d7837cc7efc866226bfa2bd7fab06459) )
	SEGAPCM_RELOAD_32K(               0x48000 )
	SEGAPCM_LOAD_32K( "epr-10646.69", 0x60000, CRC(473cc411) SHA1(04ca2d047eb59581cd5d76e0ac6eca8b19eef497) )
	SEGAPCM_RELOAD_32K(               0x68000 )
ROM_END
...
ROM_START( toutrun )
	...
	ROM_REGION( 0x100000, "pcm", ROMREGION_ERASEFF ) // sound PCM data
	SEGAPCM_LOAD_64K( "opr-12301.66", 0x00000, CRC(6e78ad15) SHA1(c31ddf434b459cd1a381d2a028beabddd4ed10d2) )
	SEGAPCM_LOAD_64K( "opr-12302.67", 0x20000, CRC(e72928af) SHA1(40e0b178958cfe97c097fe9d82b5de54bc27a29f) )
	SEGAPCM_LOAD_64K( "opr-12303.68", 0x40000, CRC(8384205c) SHA1(c1f9d52bc587eab5a97867198e9aa7c19e973429) )
	SEGAPCM_LOAD_64K( "opr-12304.69", 0x60000, CRC(e1762ac3) SHA1(855f06c082a17d90857e6efa3cf95b0eda0e634d) )
	SEGAPCM_LOAD_64K( "opr-12305.70", 0x80000, CRC(ba9ce677) SHA1(056781f92450c902e1d279a02bda28337815cba9) )
	SEGAPCM_LOAD_64K( "opr-12306.71", 0xa0000, CRC(e49249fd) SHA1(ff36e4dba4e9d3d354e3dd528edeb50ad9c18ee4) )
ROM_END
