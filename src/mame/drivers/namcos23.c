...
static MACHINE_DRIVER_START( ss23e2 )
	...
	MDRV_CPU_REPLACE("maincpu", R4650BE, S23_BUSCLOCK*6)
...
ROM_START( downhill )
	...
	ROM_REGION( 0x4000000, "textile", 0 )	/* texture tiles */
        ROM_LOAD( "dh1cguu.5f",   0x000000, 0x800000, CRC(66cb0dd7) SHA1(1f67320f150f1b55c97eae4b9fe4890fabc8dc7e) ) 
        ROM_LOAD( "dh1cgum.4j",   0x000000, 0x800000, CRC(1044d0a0) SHA1(e0bf843616e166495fcdc76f076eb53a28287d30) ) 
        ROM_LOAD( "dh1cgll.4m",   0x000000, 0x800000, CRC(c0d5ad87) SHA1(bc1992516c63aebdae0322def77f082d799a327a) ) 
        ROM_LOAD( "dh1cglm.4k",   0x000000, 0x800000, CRC(5d9a5e35) SHA1(d746abb45f04aa4eb9d43d9c79051e71bf024e38) ) 
	...
	ROM_REGION32_LE( 0x2000000, "pointrom", 0 )	/* 3D model data */
        ROM_LOAD32_WORD( "dh1pt0l.7c", 0x0000000, 0x400000, CRC(d120eee5) SHA1(fa1269d891f4e0510491aa70c4abd5f36852e691) ) 
        ROM_LOAD32_WORD( "dh1pt0h.7a", 0x0000002, 0x400000, CRC(0e84a5d8) SHA1(28559f978b86d88bb18c3e58e28a97ecfb5f7fa9) ) 
        ROM_LOAD32_WORD( "dh1pt1l.5c", 0x0800000, 0x400000, CRC(dee2f2bf) SHA1(258f9a6e324502550d27b8feaf36244766fa19da) ) 
        ROM_LOAD32_WORD( "dh1pt1h.5a", 0x0800002, 0x400000, CRC(88cd4c90) SHA1(94016c72a9da983e55c74cbdd3691b596ea50c31) ) 
        ROM_LOAD32_WORD( "dh1pt2l.4c", 0x1000000, 0x400000, CRC(714e3090) SHA1(39827f645dacbb57c7c40193f3f58e879899a4f3) ) 
        ROM_LOAD32_WORD( "dh1pt2h.4a", 0x1000002, 0x400000, CRC(7e167c65) SHA1(018bf6aea4c1640ef728cf7b8e491f11742ede0d) ) 
...
ROM_START( crszone )
	...
	ROM_REGION( 0x4000000, "textile", 0 )	/* texture tiles */
        ROM_LOAD( "csz1cguu.5f",  0x000000, 0x800000, CRC(e1d1bf24) SHA1(daf2c68e2d9a8f313d262d221cc990c93dfdf22f) ) 
        ROM_LOAD( "csz1cgum.4j",  0x000000, 0x800000, CRC(913c98b5) SHA1(b952dbc19053796077d4f33e8da836893e933b12) ) 
        ROM_LOAD( "csz1cgll.4m",  0x000000, 0x800000, CRC(0bcd41f2) SHA1(80b74f9398e8bd074f79a14490d06cfeb875c874) ) 
        ROM_LOAD( "csz1cglm.4k",  0x000000, 0x800000, CRC(d4af93d1) SHA1(0df37b793ce8da02d14f714722382786ae5d3ce2) ) 
	...
	ROM_REGION32_LE( 0x2000000, "pointrom", 0 )	/* 3D model data */
        ROM_LOAD32_WORD( "csz1pt0l.7c",  0x0000000, 0x400000, CRC(b0d66afe) SHA1(7cda4eebf1bb1191d17e4b5e616be2fbe4ae9328) ) 
        ROM_LOAD32_WORD( "csz1pt0h.7a",  0x0000002, 0x400000, CRC(e82f1abb) SHA1(b1c57152cc27835e06e429fd1659fe0973638142) ) 
        ROM_LOAD32_WORD( "csz1pt1l.5c",  0x0800000, 0x400000, CRC(527171c8) SHA1(0b2ce3858f40bdedf1543309a6bc28d780415250) ) 
        ROM_LOAD32_WORD( "csz1pt1h.5a",  0x0800002, 0x400000, CRC(e54f80ad) SHA1(3b3fbb3001e630d800b02ec8e653d74878ac5116) ) 
        ROM_LOAD32_WORD( "csz1pt2l.4c",  0x1000000, 0x400000, CRC(c87d6dbd) SHA1(686f39073c521d6b21ef8bc1161b41b680697c63) ) 
        ROM_LOAD32_WORD( "csz1pt2h.4a",  0x1000002, 0x400000, CRC(e295137a) SHA1(37b18af1b3d9f0e69b45135f89b49a1ceec79127) ) 
        ROM_LOAD32_WORD( "csz1pt3l.3c",  0x1800000, 0x400000, CRC(5d077c0f) SHA1(a4fd0167d89bf9417766405726e0334e7c7eaec3) ) 
        ROM_LOAD32_WORD( "csz1pt3h.3a",  0x1800002, 0x400000, CRC(05f65bdf) SHA1(0c349fe5381fe7aeb81f9365a2b44a212f6bd33e) ) 
