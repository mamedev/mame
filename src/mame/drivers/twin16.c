...
{
	return ((UINT16 *)memory_region(machine, RGNCLASS_GFX, "gfx3"))[offset];
}
...
ROM_START( devilw )
	...
	ROM_REGION( 0x40000, RGNCLASS_CPU, "sub", 0 )	// 68000 code (CPU B)
	...
	ROM_REGION( 0x40000, RGNCLASS_CPU, "main", 0 )	// 68000 code (CPU A)
	...
	ROM_REGION16_LE( 0x200000, RGNCLASS_GFX, "gfx2", 0 )	// gfx data used at runtime
	...
	ROM_REGION16_BE( 0x20000, RGNCLASS_GFX, "gfx3", 0 )	// tile data; mapped at 0x80000 on CPUB
	...
	ROM_REGION( 0x20000, RGNCLASS_SOUND, "konami", 0 ) // samples
	ROM_LOAD( "687_i01.5a",			0x00000, 0x20000, CRC(d4992dfb) SHA1(c65bef07b6adb9ab6328d679595450945dbf6a88) )

	ROM_REGION( 0x20000, RGNCLASS_SOUND, "upd", 0 ) // samples
...
ROM_START( vulcan )
	...
	ROM_REGION16_BE( 0x200000, RGNCLASS_GFX, "gfx2", 0 )	// gfx data used at runtime
	...
	ROM_REGION( 0x20000, RGNCLASS_GFX, "gfx3", ROMREGION_ERASE00 )	// tile data; mapped at 0x80000 on CPUB
...
ROM_START( miaj )
	...
	ROM_REGION( 0x20000, RGNCLASS_SOUND, "upd", ROMREGION_ERASE00 ) // samples
ROM_END
...
ROM_START( cuebrckj )
	...
	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx2", ROMREGION_ERASE00 )	// gfx data used at runtime
	// unpopulated
	...
	ROM_REGION( 0x20000, RGNCLASS_SOUND, "konami", ROMREGION_ERASE00 ) // samples
	// unpopulated
...
static void gfx_untangle( running_machine *machine )
{
	...
	UINT16 *temp = malloc_or_die(0x200000);
		...
		twin16_gfx_rom = (UINT16 *)memory_region(machine, RGNCLASS_GFX, "gfx2");
