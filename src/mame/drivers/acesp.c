...
ROM_START( sp_timem )
	...
	ROM_LOAD( "002pa-0a.bin", 0x0000, 0x8000, CRC(4e86fbdb) SHA1(951c2f4bda7bf0c54de89f57d96d8f6d378fae91) )
...
ROM_START( sp_tz )
	...
	//  ROM_LOAD( "ace_twilight_zone_p42.bin", 0x0000, 0x8000, CRC(271ddb7c) SHA1(8aee4b662e642ee4ea64ea10800a2d1269650160) )
	//  ROM_LOAD( "ace_twilight_zone_p41.bin", 0x8000, 0x8000, CRC(89247bc3) SHA1(3da13069111169367fc734729ba45eb097e2bd03) )

	ROM_REGION( 0x80000, "altrevs", 0 )
	ROM_LOAD( "576 tzsk p4.2.bin", 0x0000, 0x8000, CRC(78b33965) SHA1(7e865126113b81af7013a8e0a8a6ed72fd6ae743) )
	ROM_LOAD( "576 tz p4.1.bin", 0x8000, 0x8000, CRC(89247bc3) SHA1(3da13069111169367fc734729ba45eb097e2bd03) )
...
//  ROM_LOAD( "feotz2.bin", 0x0000, 0x8000, CRC(b5f66994) SHA1(869a6a4c784a320b17d6552032e45d170af0e95f) )
//  ROM_LOAD( "feotz1.bin", 0x8000, 0x8000, CRC(3486b0d1) SHA1(9950168f6aaaecffeaa621d22a570ba1a3d82f59) )

	ROM_REGION( 0x80000, "altrevs", 0 )
	ROM_LOAD( "011p5-0a.bin", 0x0000, 0x8000, CRC(9887117d) SHA1(124622e2508fdf7dec5b0c747e4245f4fea3ddc9) )
	...
	ROM_LOAD( "tz689p1a", 0x0000, 0x8000, CRC(da39c4cd) SHA1(05ba35ac6a19121884ce11baf65d8892a64f7b18) )
	...
	ROM_LOAD( "tz715p1a", 0x0000, 0x8000, CRC(b8ace271) SHA1(769d36155b9c090a5fcb04732dbb117d8d764597) )
...
ROM_START( sp_beau )
	...
	ROM_REGION( 0x80000, "altrevs", 0 )
	ROM_LOAD( "619 bp all cash d3.1.bin", 0x0000, 0x8000, CRC(6ccd693a) SHA1(97d281509883623615b1d634e736d16814963cb8) )
...
ROM_START( sp_brkbk )
	...
	ROM_REGION( 0x80000, "altrevs", 0 )
	ROM_LOAD( "btb80.1", 0x0000, 0x8000, CRC(9a828e00) SHA1(06784d0b3586930bbbbb880f088ba4b417d71587) )
...
ROM_START( sp_camel )
	...
	ROM_LOAD( "ca562p5a", 0x0000, 0x8000, CRC(61ccd154) SHA1(07345e0d8d90ef36737b30a00a7f8d252aaaf596) )
...
ROM_START( sp_ghost )
	...
	ROM_REGION( 0x80000, "altrevs", 0 )
	ROM_LOAD( "gt635p2a", 0x0000, 0x8000, CRC(8dfc342e) SHA1(528f0a6efa77bff359c14fce6bcf566c0475087b) )
	...
	ROM_LOAD( "gt670p1a", 0x0000, 0x8000, CRC(4916a2b1) SHA1(da58289e1f46468e42822f2fa4a9f3af9223d278) )
...
ROM_START( sp_golds )
	...
	ROM_REGION( 0x80000, "altrevs", 0 )
	ROM_LOAD( "021p3-0a.bin", 0x0000, 0x8000, CRC(dc792e10) SHA1(ecbd66fe481785b0b6125c4b8d379f8710ed4320) )
	...
	ROM_LOAD( "gs20.1", 0x0000, 0x8000, CRC(5b2911d3) SHA1(9bac67b8da16c241e5960cda21751049eb293362) )
...
ROM_START( sp_nudex )
	...
	ROM_LOAD( "033p3-2a.bin", 0x0000, 0x8000, CRC(a2eaf15e) SHA1(e6ce57675c7f0219394cee3653584351121f370f) )
...
ROM_START( sp_onbox )
	...
	ROM_LOAD( "709p5-0a.bin", 0x0000, 0x8000, CRC(a9204087) SHA1(99e2e6ba716369f69526b82ad88b22698ed6e2cc) )
	...
	ROM_LOAD( "prom1.bin", 0x0000, 0x8000, CRC(a9204087) SHA1(99e2e6ba716369f69526b82ad88b22698ed6e2cc) )
...
ROM_START( sp_piste )
	...
	ROM_LOAD( "op710p1a", 0x0000, 0x8000, CRC(64add8c6) SHA1(46cfa6f9e06a1c74f0230d4b9cc6c3f9d5167cfe) )
	...
	ROM_LOAD( "op722p1a", 0x0000, 0x8000, CRC(26cfaaa8) SHA1(6e5c3a4c22bccab0e84737f4e0c8d4fef9a189aa) )
