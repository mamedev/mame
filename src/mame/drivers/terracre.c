...
ROM_START( terracra )
	...
	ROM_REGION( 0x10000, RGNCLASS_CPU, "audio", 0 )	/* 64k to sound cpu */
...
ROM_START( amazon )
	ROM_REGION( 0x20000, RGNCLASS_CPU, "main", 0 ) /* 68000 code (main CPU) */
	...
	ROM_REGION( 0x2000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) /* alphanumerics */
	...
	ROM_REGION( 0x10000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE ) /* sprites */
	...
	ROM_REGION( 0x2000, RGNCLASS_USER, "user2", 0 ) /* unknown, mostly text */
...
ROM_START( horekid )
	...
	ROM_REGION( 0x20000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE ) /* sprites */
