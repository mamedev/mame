...
ROM_START( dogstdx )
	...
	DISK_REGION( "ide:0:hdd:image" )
	DISK_IMAGE_READONLY( "dogstdx", 0, BAD_DUMP SHA1(A229B8AC8FB2B155E6EF7366D4D47EC8C372DFAD) ) //No picture of media available; used romset name
ROM_END
...
GAME(2003, dogstdx,    kpython,   kpython,   kpython, kpython_state, empty_init, ROT0, "Konami", "dogstation Deluxe", MACHINE_IS_SKELETON)
