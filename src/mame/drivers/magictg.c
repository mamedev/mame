...
ROM_START( magictg )
	...
	ROM_LOAD( "magic.snd0.u8", 0x000000, 0x100000, CRC(ef3384ed) SHA1(0b2fa03e3da691590c705ff9d4e26ffbe374cd0f) )
	ROM_LOAD( "magic.snd1.u14",0x100000, 0x100000, CRC(d591dc93) SHA1(6a7627659de8b9e4cde7c314504f0ee087ecab4d) )
	ROM_LOAD( "magic.snd2.u13",0x200000, 0x100000, CRC(d81cb2e1) SHA1(f62f85ce094cfe48373d0929bfdb76522315da81) )
	ROM_LOAD( "magic.snd3.u7", 0x300000, 0x100000, CRC(6c8e0475) SHA1(9cafbc85d20390e9cd5d55e3c48a049e40a833ca) ) // basically empty

	ROM_REGION( 0x400000, "user4", 0 ) /* ? */
	ROM_LOAD( "magic.s0.u9",  0x000000, 0x100000, CRC(b1d9e54e) SHA1(c4964fcab4aa3d37cbfaeac0c35be31597fdd0aa) )
	ROM_LOAD( "magic.s1.u10", 0x100000, 0x100000, CRC(ccce2af7) SHA1(23d6e1bcf1ae9787f20b9bb14c2553b9a6d6b12c) )
	ROM_LOAD( "magic.s2.u12", 0x200000, 0x100000, CRC(eb8d1607) SHA1(353410b20d121b0bbecef4735a692f0c1d09ce9b) )
	ROM_LOAD( "magic.s3.u11", 0x300000, 0x100000, CRC(58c33f8e) SHA1(af09105b17b95882f7ff90ec64081e8b1d429e0b) )

	ROM_REGION( 0x100000, "user5", 0 ) /* ? */
	ROM_LOAD( "magic.k0.u20", 0x000000, 0x100000, CRC(aeb617fa) SHA1(4853c1c3631b798312d9146a90158490f2252119) )
ROM_END
