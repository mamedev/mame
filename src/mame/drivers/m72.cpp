...
void m72_state::m72(machine_config &config)
{
	...
	m_soundcpu->set_periodic_int(FUNC(m72_state::fake_nmi), attotime::from_ticks(8 * 512, 32000000));
...
void m72_state::m72_xmultipl(machine_config &config)
{
	...
	/* Sample rate verified (Gallop : https://youtu.be/aozd0dbPzOw) */
	m_soundcpu->set_periodic_int(FUNC(m72_state::nmi_line_pulse), attotime::from_ticks(8 * 512, 32000000));
	/* IRQs are generated by main Z80 and YM2151 */
}
...
void m72_state::rtype2(machine_config &config)
{
	...
	m_soundcpu->set_addrmap(AS_PROGRAM, &m72_state::sound_rom_map);
	m_soundcpu->set_addrmap(AS_IO, &m72_state::rtype2_sound_portmap);
	m_soundcpu->set_periodic_int(FUNC(m72_state::nmi_line_pulse), attotime::from_ticks(8 * 512, 32000000)); /* verified (https://youtu.be/lUszf9Ong7U) */
								/* IRQs are generated by main Z80 and YM2151 */
...
void m72_state::cosmccop(machine_config &config)
{
	...
	m_soundcpu->set_addrmap(AS_PROGRAM, &m72_state::sound_rom_map);
	m_soundcpu->set_addrmap(AS_IO, &m72_state::rtype2_sound_portmap);
	m_soundcpu->set_periodic_int(FUNC(m72_state::nmi_line_pulse), attotime::from_ticks(8 * 512, 32000000)); /* verified (https://youtu.be/Sol2Yq2S5hQ) */
								/* IRQs are generated by main Z80 and YM2151 */
...
void m72_state::m82(machine_config &config)
{
	...
	m_soundcpu->set_addrmap(AS_PROGRAM, &m72_state::sound_rom_map);
	m_soundcpu->set_addrmap(AS_IO, &m72_state::rtype2_sound_portmap);
	m_soundcpu->set_periodic_int(FUNC(m72_state::nmi_line_pulse), attotime::from_ticks(8 * 512, 32000000)); /* verified (https://youtu.be/lLQDPe-8Ha0) */
								/* IRQs are generated by main Z80 and YM2151 */
...
void m72_state::poundfor(machine_config &config)
{
	...
	m_soundcpu->set_periodic_int(FUNC(m72_state::fake_nmi), attotime::from_ticks(8 * 512, 32000000));   /* clocked by V1? (Vigilante) */
								/* IRQs are generated by main Z80 and YM2151 */
