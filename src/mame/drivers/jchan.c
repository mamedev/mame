...
ROM_START( jchan )
	...
	ROM_REGION( 0x100000, RGNCLASS_CPU, "sub", 0 ) /* 68000 Code */
	...
	ROM_REGION( 0x2000000, RGNCLASS_GFX, "gfx1", 0 ) /* SPA GFX */
	...
	ROM_REGION( 0x1000000, RGNCLASS_GFX, "gfx2", 0 ) /* SPB GFX (we haven't used yet, not sure where they map, 2nd sprite layer maybe?) */
	...
	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE ) /* BG GFX */
	ROM_LOAD( "jc-200.00", 0x000000, 0x100000, CRC(1f30c24e) SHA1(0c413fc67c3ec020e6786e7157d82aa242c8d2ad) )

	ROM_REGION( 0x300000, RGNCLASS_SOUND, "ymz", 0 ) /* Audio 1? */
	...
	ROM_REGION( 0x040000, RGNCLASS_SOUND, "unknown", 0 ) /* Audio 2? */
	ROM_LOAD( "jcw0x0.u56", 0x000000, 0x040000, CRC(bcf25c2a) SHA1(b57a563ab5c05b05d133eed3d099c4de997f37e4) )

	ROM_REGION( 0x020000, RGNCLASS_USER, "user1", 0 ) /* MCU Code? */
