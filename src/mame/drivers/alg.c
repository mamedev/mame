...
static ADDRESS_MAP_START( main_map_r1, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0xf00000, 0xf1ffff) AM_ROM AM_REGION(RGNCLASS_USER, "user2", 0)			/* Custom ROM */
...
static ADDRESS_MAP_START( main_map_r2, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0xf00000, 0xf3ffff) AM_ROM AM_REGION(RGNCLASS_USER, "user2", 0)			/* Custom ROM */
...
ROM_START( alg_bios )
	...
	ROM_REGION( 0x20000, RGNCLASS_USER, "user2", ROMREGION_ERASEFF )
ROM_END
...
ROM_START( maddog )
	...
	ROM_REGION( 0x40000, RGNCLASS_USER, "user2", ROMREGION_ERASEFF )
...
{
	UINT32 length = memory_region_length(machine, RGNCLASS_USER, "user2");
