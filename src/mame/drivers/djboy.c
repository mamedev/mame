...
{
	unsigned char *RAM = memory_region(machine, RGNCLASS_CPU, "main");
	data ^= bankxor;
...
{
	UINT8 *RAM = memory_region(machine, RGNCLASS_CPU, "cpu1");
...
{
	UINT8 *RAM = memory_region(machine, RGNCLASS_CPU, "cpu2");
...
ROM_START( djboy )
	...
	ROM_REGION( 0x38000, RGNCLASS_CPU, "cpu1", 0 )
	...
	ROM_REGION( 0x24000, RGNCLASS_CPU, "cpu2", 0 ) /* sound */
	...
	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx2", 0 ) /* background */
	...
	ROM_REGION( 0x40000, RGNCLASS_SOUND, "oki1", 0 ) /* OKI-M6295 samples */
	ROM_LOAD( "bs203.5j", 0x000000, 0x40000, CRC(805341fb) SHA1(fb94e400e2283aaa806814d5a39d6196457dc822) )

	ROM_REGION( 0x40000, RGNCLASS_SOUND, "oki2", 0 ) /* OKI-M6295 samples */
	ROM_LOAD( "bs203.5j", 0x000000, 0x40000, CRC(805341fb) SHA1(fb94e400e2283aaa806814d5a39d6196457dc822) )
ROM_END
