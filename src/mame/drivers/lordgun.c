...
ROM_START( lordgun )
	ROM_REGION( 0x100000, RGNCLASS_CPU, "main", 0 ) // 68000
	...
	ROM_REGION( 0x300000, RGNCLASS_GFX, "gfx2", 0 )	// Tilemaps 0 & 3
	...
	ROM_REGION( 0x600000, RGNCLASS_GFX, "gfx3", 0 )	// Tilemaps 1 & 2
