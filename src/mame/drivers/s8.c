...
static MACHINE_CONFIG_START( s8, s8_state )
	...
	MCFG_PIA6821_READCA1_HANDLER(READLINE(s8_state, pia21_ca1_r))
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(s8_state, sound_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(s8_state, sol2_w))
	MCFG_PIA6821_CA2_HANDLER(WRITELINE(s8_state, pia21_ca2_w))
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(s8_state, pia21_cb2_w))
	MCFG_PIA6821_IRQA_HANDLER(DEVWRITELINE("maincpu", m6802_cpu_device, irq_line))
	MCFG_PIA6821_IRQB_HANDLER(DEVWRITELINE("maincpu", m6802_cpu_device, irq_line))

	MCFG_DEVICE_ADD("pia24", PIA6821, 0)
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(s8_state, lamp0_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(s8_state, lamp1_w))
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(s8_state, pia24_cb2_w))
	MCFG_PIA6821_IRQA_HANDLER(DEVWRITELINE("maincpu", m6802_cpu_device, irq_line))
	MCFG_PIA6821_IRQB_HANDLER(DEVWRITELINE("maincpu", m6802_cpu_device, irq_line))

	MCFG_DEVICE_ADD("pia28", PIA6821, 0)
	MCFG_PIA6821_READCA1_HANDLER(READLINE(s8_state, pia28_ca1_r))
	MCFG_PIA6821_READCB1_HANDLER(READLINE(s8_state, pia28_cb1_r))
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(s8_state, dig0_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(s8_state, dig1_w))
	MCFG_PIA6821_CA2_HANDLER(WRITELINE(s8_state, pia28_ca2_w))
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(s8_state, pia28_cb2_w))
	MCFG_PIA6821_IRQA_HANDLER(DEVWRITELINE("maincpu", m6802_cpu_device, irq_line))
	MCFG_PIA6821_IRQB_HANDLER(DEVWRITELINE("maincpu", m6802_cpu_device, irq_line))

	MCFG_DEVICE_ADD("pia30", PIA6821, 0)
	MCFG_PIA6821_READPA_HANDLER(READ8(s8_state, switch_r))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(s8_state, switch_w))
	MCFG_PIA6821_IRQA_HANDLER(DEVWRITELINE("maincpu", m6802_cpu_device, irq_line))
	MCFG_PIA6821_IRQB_HANDLER(DEVWRITELINE("maincpu", m6802_cpu_device, irq_line))
	...
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(s8_state, pias_cb2_w))
	MCFG_PIA6821_IRQA_HANDLER(DEVWRITELINE("audiocpu", m6808_cpu_device, irq_line))
