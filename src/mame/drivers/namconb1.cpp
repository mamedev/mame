...
static GFXDECODE_START( namconb1 )
	GFXDECODE_ENTRY( NAMCONB1_TILEGFXREGION,   0, layout8x8x8,   0x1000, 0x10 )
	GFXDECODE_ENTRY( NAMCONB1_SPRITEGFXREGION, 0, layout16x16x8, 0x0000, 0x10 )
GFXDECODE_END /* gfxdecodeinfo */

static GFXDECODE_START( namconb2 )
	GFXDECODE_ENTRY( NAMCONB1_TILEGFXREGION,   0, layout8x8x8,   0x1000, 0x08 )
	GFXDECODE_ENTRY( NAMCONB1_SPRITEGFXREGION, 0, layout16x16x8, 0x0000, 0x10 )
	GFXDECODE_ENTRY( NAMCONB1_ROTGFXREGION,    0, layout16x16x8, 0x1800, 0x08 )
...
MACHINE_CONFIG_START(namconb1_state::namconb2)
	...
	MCFG_GFXDECODE_ADD("gfxdecode", "palette", namconb2)
	MCFG_PALETTE_ADD("palette", 0x2000)
	MCFG_PALETTE_ENABLE_SHADOWS()
