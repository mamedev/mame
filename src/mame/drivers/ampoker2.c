...
ROM_START( ampoker2 )
	...
	ROM_COPY( RGNCLASS_CPU, "main", 0x8000, 0x0000, 0x4000 ) /* poker9.003 contains the 16K halves swapped around */
...
ROM_START( pkrdewin )
	...
	ROM_COPY( RGNCLASS_CPU, "main",	0x8000, 0x0000, 0x4000 ) /* poker7.001 contains the 1st and 2nd 16K quarters swapped */
	ROM_COPY( RGNCLASS_CPU, "main", 0x10000, 0x8000, 0x4000 ) /* poker7.001 contains the 1st and 2nd 16K quarters swapped */
