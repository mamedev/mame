...
ROM_START( contcirc )
	ROM_REGION( 0x40000, RGNCLASS_CPU, "main", 0 )	/* 256K for 68000 code (CPU A) */
...
//  ROM_LOAD16_BYTE( "cc_26.bin", 0x00001, 0x20000, CRC(1345ebe6) SHA1(88b9cc8ba2f7061beb8f6b763583cd45b03bcea1) )
	...
	ROM_REGION( 0x40000, RGNCLASS_CPU, "sub", 0 )	/* 256K for 68000 code (CPU B) */
	...
	ROM_REGION( 0x80000, RGNCLASS_GFX, "gfx3", 0 )	/* don't dispose */
	...
	ROM_REGION( 0x10000, RGNCLASS_USER, "user2", 0 )	/* unused ROMs */
...
ROM_START( chasehq )
	ROM_REGION( 0x80000, RGNCLASS_CPU, "main", 0 )	/* 512K for 68000 code (CPU A) */
	...
	ROM_REGION( 0x180000, RGNCLASS_SOUND, "ym", 0 )	/* ADPCM samples */
	...
	ROM_REGION( 0x02a00, RGNCLASS_PLDS, "plds", ROMREGION_DISPOSE )
...
ROM_START( bshark )
	...
	ROM_REGION( 0x80000, RGNCLASS_CPU, "sub", 0 )	/* 512K for 68000 code (CPU B) */
...
ROM_START( sci )
	...
	ROM_REGION( 0x2c000, RGNCLASS_CPU, "audio", 0 )	/* Z80 sound cpu */
...
ROM_START( aquajack )
	...
	ROM_REGION( 0x00200, RGNCLASS_USER, "user2", 0 )	/* unused PROMs */
