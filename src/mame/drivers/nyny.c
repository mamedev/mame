...
static MACHINE_CONFIG_START( nyny, nyny_state )
	...
	MCFG_PIA6821_IRQA_HANDLER(WRITELINE(nyny_state, main_cpu_irq))
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(nyny_state, main_cpu_irq))

	MCFG_DEVICE_ADD("pia2", PIA6821, 0)
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(nyny_state,pia_2_port_a_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(nyny_state,pia_2_port_b_w))
	MCFG_PIA6821_CA2_HANDLER(WRITELINE(nyny_state,flipscreen_w))
	MCFG_PIA6821_IRQA_HANDLER(WRITELINE(nyny_state,main_cpu_firq))
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(nyny_state,main_cpu_irq))
