...
void powerins_state::powerins_map(address_map &map)
{
	...
	map(0x140000, 0x143fff).ram().w(this, FUNC(powerins_state::vram_w<0>)).share("vram_0");
	map(0x170000, 0x170fff).mirror(0x1000).ram().w(this, FUNC(powerins_state::vram_w<1>)).share("vram_1");
