...
ROM_START( powerins )
	...
	ROM_REGION( 0x20000, RGNCLASS_CPU, "sound", 0 )		/* Z80 Code */
	ROM_LOAD( "93095-2.u90",  0x00000, 0x20000, CRC(4b123cc6) SHA1(ed61d3a2ab20c86b91fd7bafa717be3ce26159be) )

	ROM_REGION( 0x280000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )	/* Layer 0 */
	...
	ROM_REGION( 0x240000, RGNCLASS_SOUND, "oki1", 0 )	/* 8 bit adpcm (banked) */
	...
	ROM_REGION( 0x240000, RGNCLASS_SOUND, "oki2", 0 )	/* 8 bit adpcm (banked) */
	...
	ROM_REGION( 0x0220, RGNCLASS_PROMS, "proms", 0 )		/* unknown */
...
ROM_START( powerina )
	...
	ROM_REGION( 0x090000, RGNCLASS_SOUND, "oki1", 0 )	/* 8 bit adpcm (banked) */
