...
ROM_START( suprmrio)
	ROM_REGION( 0x10000,RGNCLASS_CPU, "main", 0 ) /* 6502 memory */
	...
	ROM_REGION( 0x4000,RGNCLASS_GFX, "gfx1", 0  ) /* PPU memory */
...
ROM_START( vsgshoe )
	ROM_REGION( 0x14000,RGNCLASS_CPU, "main", 0 ) /* 6502 memory */
...
ROM_START( vsfdf )
	ROM_REGION( 0x30000,RGNCLASS_CPU, "main", 0 ) /* 6502 memory */
	...
	ROM_REGION( 0x10000,RGNCLASS_GFX, "gfx1", 0 ) /* PPU memory */
	ROM_LOAD( "cha2.1",  0x00000, 0x10000, CRC(a2f88df0) SHA1(10ef432d3132b01a1fcb38d8f521edd2a029ac5e) )
ROM_END

ROM_START( goonies )
	ROM_REGION( 0x20000,RGNCLASS_CPU, "main", 0 ) /* 6502 memory */
...
ROM_START( vsslalom )
	...
	ROM_REGION( 0x2000,RGNCLASS_GFX, "gfx1", 0 ) /* PPU memory */
...
ROM_START( drmario )
	...
	ROM_REGION( 0x8000,RGNCLASS_GFX, "gfx1", 0 ) /* PPU memory */
...
ROM_START( vsskykid )
	ROM_REGION( 0x18000,RGNCLASS_CPU, "main",0 ) /* 6502 memory */
...
ROM_START( platoon )
	...
	ROM_REGION( 0x20000,RGNCLASS_GFX, "gfx1", 0 ) /* PPU memory */
...
ROM_START( bnglngby )
	...
	ROM_REGION( 0x2000, RGNCLASS_USER, "user1", 0 ) /* unknown */
...
ROM_START( balonfgt )
	...
	ROM_REGION( 0x10000,RGNCLASS_CPU, "sub",0 ) /* 6502 memory */
	...
	ROM_REGION( 0x4000,RGNCLASS_GFX, "gfx2", 0 ) /* PPU memory */
