...
static ADDRESS_MAP_START( main_map, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0x0d000, 0x0dfff) AM_WRITE(MWA16_RAM)
	AM_RANGE(0x0e000, 0x0e0ff) AM_WRITE(MWA16_RAM) AM_BASE(&deadang_scroll_ram)
	AM_RANGE(0x0e100, 0x0ffff) AM_WRITE(MWA16_RAM)
	AM_RANGE(0xc0000, 0xfffff) AM_ROM
ADDRESS_MAP_END

static ADDRESS_MAP_START( sub_map, ADDRESS_SPACE_PROGRAM, 16 )
	AM_RANGE(0x00000, 0x037ff) AM_RAM
	AM_RANGE(0x03800, 0x03fff) AM_READWRITE(MRA16_RAM, deadang_foreground_w) AM_BASE(&deadang_video_data)
	AM_RANGE(0x04000, 0x04fff) AM_RAM AM_SHARE(1)
...
static GFXDECODE_START( deadang )
	GFXDECODE_ENTRY( REGION_GFX1, 0x000000, charlayout,    512, 16 )
	GFXDECODE_ENTRY( REGION_GFX2, 0x000000, spritelayout,  768, 16 )
	GFXDECODE_ENTRY( REGION_GFX3, 0x000000, spritelayout, 1024, 16 )
	GFXDECODE_ENTRY( REGION_GFX4, 0x000000, spritelayout,  256, 16 )
