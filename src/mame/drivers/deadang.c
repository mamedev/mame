...
ROM_START( leadang )
	ROM_REGION( 0x100000, "maincpu", 0 ) /* v20 main cpu */
	ROM_LOAD16_BYTE("la2.18h",   0x0c0000, 0x10000, CRC(611247e0) SHA1(1b9ad50f67ba3a3a9e5a0d6e33f4d4be2fc20446) )
	ROM_LOAD16_BYTE("la4.22h",   0x0c0001, 0x10000, CRC(348c1201) SHA1(277dd77dcbc950299de0fd56a4f66db8f90752ad) )
	ROM_LOAD16_BYTE("la1.18f",   0x0e0000, 0x10000, CRC(fb952d71) SHA1(c6578cddf019872e6005c3a9e8e3e024d17d8c6e) )
