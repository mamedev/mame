...
static INPUT_PORTS_START( deadang )
	...
	PORT_DIPNAME( 0x8000, 0x8000, "User Mode" )
...
static INPUT_PORTS_START( ghunter )
	...
	PORT_DIPSETTING(    0x0400, "50K 150K" )
	PORT_DIPSETTING(    0x0000, "100K 200K" )
	PORT_DIPNAME( 0x0800, 0x0800, DEF_STR( Controller ) )
...
ROM_START( deadang )
	ROM_REGION( 0x100000, RGNCLASS_CPU, "main", 0 ) /* v20 main cpu */
	...
	ROM_REGION( 0x100000, RGNCLASS_CPU, "sub", 0 ) /* v20 sub cpu */
	...
	ROM_REGION( 0x20000, RGNCLASS_CPU, "audio", 0 ) /* sound Z80 */
	...
	ROM_REGION( 0x08000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) /* Chars */
	...
	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE ) /* pf1 layer */
	...
	ROM_REGION16_BE( 0x10000, RGNCLASS_GFX, "gfx7", 0 )	/* background map data */
	...
	ROM_REGION( 0x20000, RGNCLASS_SOUND, "adpcm", 0 )
