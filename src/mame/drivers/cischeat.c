...
static void cischeat_untangle_sprites(running_machine *machine, const char *region)
{
	...
	const UINT8	*end = src + memory_region_length(machine, RGNCLASS_GFX, region);
...
ROM_START( bigrun )
	ROM_REGION( 0x80000, RGNCLASS_CPU, "cpu1", 0 )
	...
	ROM_REGION( 0x40000, RGNCLASS_CPU, "cpu2", 0 )
	...
	ROM_REGION( 0x40000, RGNCLASS_CPU, "cpu3", 0 )
	...
	ROM_REGION16_BE( 0x40000, RGNCLASS_USER, "user1", 0 )	/* second halves of program ROMs */
	...
	ROM_REGION( 0x040000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE ) // scroll 0
	...
	ROM_REGION( 0x040000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE ) // scroll 1
	...
	ROM_REGION( 0x280000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE )	/* sprites */
	...
	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx5", ROMREGION_DISPOSE ) // Road 0
	...
	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx6", ROMREGION_DISPOSE ) // Road 1
	ROM_LOAD( "mr88004g.t45",  0x000000, 0x080000, CRC(bb397bae) SHA1(c67d33bde6e8de2ea7581faadb96acd977adc13c) )
	ROM_LOAD( "mb88004h.t46",  0x080000, 0x080000, CRC(6b31a1ba) SHA1(71a956f0f51a63bddedfef0febdc95108ed42226) )
	...
	ROM_REGION( 0x80000, RGNCLASS_SOUND, "oki2", 0 )	/* samples */
	ROM_LOAD( "mb88004m.t51", 0x000000, 0x020000, CRC(ee52f04d) SHA1(fc45bd1d3a7552433e40846c358573c6988127c3) )
	ROM_CONTINUE(             0x040000, 0x020000             )
	ROM_CONTINUE(             0x020000, 0x020000             )
	ROM_CONTINUE(             0x060000, 0x020000             )

	ROM_REGION( 0x20000, RGNCLASS_USER, "user2", 0 )		/* ? Unused ROMs ? */
...
{
	/* Split ROMs */
	rom_1 = (UINT16 *) memory_region(machine, RGNCLASS_USER, "user1");
...
ROM_START( cischeat )
	ROM_REGION( 0x080000, RGNCLASS_CPU, "cpu1", 0 )
	...
	ROM_REGION( 0x80000, RGNCLASS_CPU, "cpu2", 0 )
	...
	ROM_REGION( 0x80000, RGNCLASS_CPU, "cpu3", 0 )
	...
	ROM_REGION16_BE( 0x100000, RGNCLASS_USER, "user1", 0 )	/* second halves of program ROMs */
	...
	ROM_REGION( 0x400000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE )	/* sprites */
	...
	ROM_REGION( 0x100000, RGNCLASS_GFX, "gfx6", ROMREGION_DISPOSE )
	ROM_LOAD( "ch9073.r21",  0x000000, 0x080000, CRC(2943d2f6) SHA1(ae8a25c1d76d3c36aa326d0171acb7dce93c4d87) ) // Road
	ROM_LOAD( "ch9073.r22",  0x080000, 0x080000, CRC(2dd44f85) SHA1(5f20f75e96e14389187d3471bc7f2ceb0758eec4) )
	...
	ROM_REGION( 0x40000, RGNCLASS_USER, "user2", 0 )		/* ? Unused ROMs ? */
...
{
	/* Split ROMs */
	rom_1 = (UINT16 *) (memory_region(machine, RGNCLASS_USER, "user1") + 0x00000);
	rom_2 = (UINT16 *) (memory_region(machine, RGNCLASS_CPU, "cpu2")  + 0x40000);
	rom_3 = (UINT16 *) (memory_region(machine, RGNCLASS_CPU, "cpu3")  + 0x40000);

	memcpy(memory_region(machine, RGNCLASS_USER, "user1") + 0x80000, rom_2, 0x40000);
	memset(rom_2, 0, 0x40000);
	rom_2 = (UINT16 *) (memory_region(machine, RGNCLASS_USER, "user1") + 0x80000);

	memcpy(memory_region(machine, RGNCLASS_USER, "user1") + 0xc0000, rom_3, 0x40000);
	memset(rom_3, 0, 0x40000);
	rom_3 = (UINT16 *) (memory_region(machine, RGNCLASS_USER, "user1") + 0xc0000);
...
ROM_START( f1gpstar )
	ROM_REGION( 0x100000, RGNCLASS_CPU, "cpu1", 0 )
	...
	ROM_REGION16_BE( 0x80000, RGNCLASS_USER, "user1", 0 )	/* second halves of program ROMs */
	...
	ROM_REGION( 0x020000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE )
	ROM_LOAD( "9188a-30.v10",  0x000000, 0x020000, CRC(0ef1fbf1) SHA1(28fa0b677e70833954a5fc2fdce233d0dec4f43c) ) // scroll 2

	ROM_REGION( 0x500000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE )	/* sprites */
	...
	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx5", ROMREGION_DISPOSE )
	...
	ROM_REGION( 0x80000, RGNCLASS_USER, "user2", 0 )		/* ? Unused ROMs ? */
...
ROM_START( wildplt )
	...
	ROM_REGION( 0x80000, RGNCLASS_CPU, "cpu5", 0 )
	...
	ROM_REGION( 0x200000, RGNCLASS_GFX, "gfx6", ROMREGION_DISPOSE )
...
ROM_START( f1gpstr2 )
	...
	ROM_REGION( 0x600000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE )	/* sprites */
...
ROM_START( scudhamm )
	ROM_REGION( 0x080000, RGNCLASS_CPU, "main", 0 )		/* Main CPU Code */
...
//  UNUSED
	...
	ROM_REGION( 0x100000, RGNCLASS_SOUND, "oki1", 0 )		/* Samples (4x40000) */
	...
	ROM_REGION( 0x100000, RGNCLASS_SOUND, "oki2", 0 )		/* Samples (4x40000) */
...
//  UNUSED
	...
	ROM_REGION( 0x300000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE ) /* Sprites */
