...
ROM_START( dassault )
	...
	ROM_REGION(0x120000, "gfx2", ROMREGION_DISPOSE )
	...
	ROM_REGION( 0x400000, "gfx4", ROMREGION_DISPOSE ) /* sprites chip 1 */
	...
	ROM_REGION( 0x80000, "gfx5", ROMREGION_DISPOSE ) /* sprites chip 2 */
