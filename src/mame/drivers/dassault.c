...
static GFXDECODE_START( dassault )
	/* RGNCLASS_GFX, "gfx1" is copied to RGNCLASS_GFX, "gfx2" at runtime */
...
ROM_START( dassault )
	...
	ROM_REGION(0x80000, RGNCLASS_CPU, "sub", 0 ) /* 68000 code (Sub cpu) */
	...
	ROM_REGION(0x020000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE )
	...
	ROM_REGION(0x120000, RGNCLASS_GFX, "gfx2", ROMREGION_DISPOSE )
	...
	ROM_REGION(0x200000, RGNCLASS_GFX, "gfx3", ROMREGION_DISPOSE )
	...
	ROM_REGION( 0x400000, RGNCLASS_GFX, "gfx4", ROMREGION_DISPOSE ) /* sprites chip 1 */
	...
	ROM_REGION( 0x80000, RGNCLASS_GFX, "gfx5", ROMREGION_DISPOSE ) /* sprites chip 2 */
	...
	ROM_REGION(0x20000, RGNCLASS_SOUND, "oki1", 0 ) /* Oki samples */
	ROM_LOAD( "gs07",  0x00000,  0x20000,  CRC(750b7e5d) SHA1(d33b17a1d8c9b05d5c1daf0c80fed6381e04b167) )

	ROM_REGION(0x80000, RGNCLASS_SOUND, "oki2", 0 ) /* Extra Oki samples */
	...
	ROM_REGION( 0x1000, RGNCLASS_PLDS, "plds", ROMREGION_DISPOSE )
...
{
	const UINT8 *src = memory_region(machine, RGNCLASS_GFX, "gfx1");
	UINT8 *dst = memory_region(machine, RGNCLASS_GFX, "gfx2");
