...
static WRITE8_HANDLER( qsound_banksw_w )
{
    ...
    */
	...
	if (bankaddress >= memory_region_length(machine, RGNCLASS_CPU, "sound"))
	{
...
ROM_START( forgottn )
	...
	ROM_COPY( RGNCLASS_GFX, "gfx1", 0x200000, 0x000000, 0x8000 )	/* stars */

	ROM_REGION( 0x18000, RGNCLASS_CPU, "sound", 0 )
...
ROM_START( ghouls )
	...
	ROM_REGION( 0x8000, RGNCLASS_GFX, "gfx2", 0 )
	ROM_COPY( RGNCLASS_GFX, "gfx1", 0x000000, 0x000000, 0x8000 )	/* stars */
...
/* B-Board 89624B */
ROM_START( strider )
	ROM_REGION( CODE_SIZE, RGNCLASS_CPU, "main", 0 )      /* 68000 code */
	...
	ROM_REGION( 0x18000, RGNCLASS_CPU, "sound", 0 ) /* 64k for the audio CPU (+banks) */
...
ROM_START( sf2mdt )
	...
	ROM_REGION( 0x600000, RGNCLASS_GFX, "gfx1", 0 ) /* rearranged in init */
	...
	ROM_REGION( 0x28000, RGNCLASS_CPU, "sound", 0 ) /* Sound program + samples  */
...
ROM_START( wof )
	...
	ROM_REGION( 0x28000, RGNCLASS_CPU, "sound", 0 ) /* QSound Z80 code */
	ROM_LOAD( "tk2_qa.rom",     0x00000, 0x08000, CRC(c9183a0d) SHA1(d8b1d41c572f08581f8ab9eb878de77d6ea8615d) )
	ROM_CONTINUE(               0x10000, 0x18000 )

	ROM_REGION( 0x200000, RGNCLASS_SOUND, "qsound", 0 ) /* QSound samples */
...
ROM_START( wofhfh )
	...
	ROM_REGION( 0x28000, RGNCLASS_CPU, "sound", 0 ) /* 128k for the audio CPU (+banks) */
...
ROM_START( dinopic )
	...
	ROM_REGION( 0x400000, RGNCLASS_GFX, "gfx1", 0 ) // same data, different format, except for 8 which is a 99% match (bad rom?)
	...
	ROM_REGION( 0x28000, RGNCLASS_CPU, "sound", 0 ) /* PIC16c57 - protected, dump isn't valid */
...
ROM_START( dinopic2 )
	...
	ROM_REGION( 0x80000, RGNCLASS_USER, "user1", 0 ) /* extra bits on this set */
...
ROM_START( punipic )
	...
	ROM_REGION( 0x28000, RGNCLASS_CPU, "sound", 0 ) /* PIC16c57 - protected */
	ROM_LOAD( "pic16c57", 0x00000, 0x4000, NO_DUMP )

	ROM_REGION( 0x200000, RGNCLASS_SOUND, "oki", 0 ) /* OKI6295 */
...
ROM_START( punipic3 )
	...
	ROM_REGION( 0x28000, RGNCLASS_CPU, "sound", ROMREGION_ERASE00 ) /* PIC16c57 (maybe, not listed in readme) */
	//ROM_LOAD( "pic16c57", 0x00000, 0x4000, NO_DUMP )

	ROM_REGION( 0x200000, RGNCLASS_SOUND, "oki", ROMREGION_ERASE00 ) /* OKI6295 */
	//ROM_LOAD( "sound.bin",      0x000000, 0x80000, CRC(aeec9dc6) SHA1(56fd62e8db8aa96cdd242d8c705849a413567780) )
ROM_END
...
ROM_START( slammast )
	...
	ROM_COPY( RGNCLASS_CPU, "sound", 0x00000, 0x00000, 0x8000 )

	ROM_REGION( 0x400000, RGNCLASS_SOUND, "qsound", 0 ) /* QSound samples */
...
ROM_START( megaman )
	...
	ROM_REGION( 0x28000, RGNCLASS_CPU, "sound", 0 ) /* 64k for the audio CPU (+banks) */
...
{
	int i;
	UINT32 gfx_size = memory_region_length( machine, RGNCLASS_GFX, "gfx1" );
