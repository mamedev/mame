...
static MACHINE_CONFIG_START( r2dtank, r2dtank_state )
	...
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(r2dtank_state, flipscreen_w))
	MCFG_PIA6821_IRQA_HANDLER(WRITELINE(r2dtank_state, main_cpu_irq))
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(r2dtank_state, main_cpu_irq))

	MCFG_DEVICE_ADD("pia_audio", PIA6821, 0)
	MCFG_PIA6821_READPA_HANDLER(READ8(r2dtank_state, AY8910_port_r))
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(r2dtank_state, AY8910_port_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(r2dtank_state, AY8910_select_w))
	MCFG_PIA6821_IRQA_HANDLER(WRITELINE(r2dtank_state, main_cpu_irq))
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(r2dtank_state, main_cpu_irq))
