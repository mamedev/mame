...
//This may be misidentified, it looks like Z80 code, and the ROM names suggest multiple boxes
	...
	ROM_LOAD( "smn3v2gh.bin", 0x0000, 0x010000, CRC(7cd53bbe) SHA1(1e21eec98c4af93636e13e1542e868e3fa8a14a3) )
	ROM_LOAD( "smn3v2gl.bin", 0x0000, 0x010000, CRC(99fdb5bb) SHA1(547f37a3df0477dfad2a47050946cd09c874fd98) )
