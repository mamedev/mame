...
ROM_START( rallybik )
	...
	ROM_REGION( 0x240, RGNCLASS_PROMS, "proms", 0 )		/* nibble bproms, lo/hi order to be determined */
...
ROM_START( truxton )
	...
	ROM_REGION( 0x40, RGNCLASS_PROMS, "proms", 0 )		/* nibble bproms, lo/hi order to be determined */
