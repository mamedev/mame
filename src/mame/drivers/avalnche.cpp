...
void avalnche_state::avalance_video_invert_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_avalance_video_inverted = data & 0x01;
}

void avalnche_state::catch_coin_counter_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	machine().bookkeeping().coin_counter_w(0, data & 1);
	machine().bookkeeping().coin_counter_w(1, data & 2);
}

void avalnche_state::avalance_credit_1_lamp_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	output().set_led_value(0, data & 1);
}

void avalnche_state::avalance_credit_2_lamp_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	output().set_led_value(1, data & 1);
}

void avalnche_state::avalance_start_lamp_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
