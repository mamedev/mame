...
static ADDRESS_MAP_START( main_map, ADDRESS_SPACE_PROGRAM, 16 )
	...
	AM_RANGE(0x038000, 0x03ffff) AM_READ(bankrom_r) AM_REGION(RGNCLASS_CPU, "main", 0x38000) AM_BASE(&bankrom_base)
...
ROM_START( offtwall )
	ROM_REGION( 0x40000, RGNCLASS_CPU, "main", 0 )	/* 4*64k for 68000 code */
	...
	ROM_REGION( 0x14000, RGNCLASS_CPU, "jsa", 0 )	/* 64k for 6502 code */
	ROM_LOAD( "otw1020.bin", 0x10000, 0x4000, CRC(488112a5) SHA1(55e84855daacfa303d1031de8c9adb992a846e21) )
	ROM_CONTINUE(            0x04000, 0xc000 )

	ROM_REGION( 0xc0000, RGNCLASS_GFX, "gfx1", ROMREGION_DISPOSE | ROMREGION_INVERT )
