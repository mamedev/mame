...
static ADDRESS_MAP_START( aw_map, AS_PROGRAM, 64, atomiswave_state )
	...
	/* Area 3 */
	AM_RANGE(0x0c000000, 0x0cffffff) AM_RAM AM_SHARE("dc_ram") AM_MIRROR(0xa0000000)
	AM_RANGE(0x0d000000, 0x0dffffff) AM_RAM AM_SHARE("dc_ram") AM_MIRROR(0xa0000000) // extra ram on Naomi (mirror on DC)
	AM_RANGE(0x0e000000, 0x0effffff) AM_RAM AM_SHARE("dc_ram") AM_MIRROR(0xa0000000) // mirror
	AM_RANGE(0x0f000000, 0x0fffffff) AM_RAM AM_SHARE("dc_ram") AM_MIRROR(0xa0000000) // mirror
