...
static INPUT_PORTS_START(keyfox10)
    ...
    PORT_BIT(0x04, IP_ACTIVE_HIGH, IPT_OTHER) PORT_NAME("PRES2")
    PORT_BIT(0x08, IP_ACTIVE_HIGH, IPT_OTHER) PORT_NAME("PRES1")
    ...
    PORT_BIT(0x02, IP_ACTIVE_HIGH, IPT_OTHER) PORT_NAME("ROCK&ROLL")  PORT_CODE(KEYCODE_3)
    PORT_BIT(0x04, IP_ACTIVE_HIGH, IPT_OTHER) PORT_NAME("BEAT 8")         PORT_CODE(KEYCODE_4)
