...
static INPUT_PORTS_START( getaway )
	...
	PORT_DIPNAME( 0x00c, 0x004, DEF_STR( Game_Time ) ) PORT_DIPLOCATION("SWB:1,SWA:5")
	...
	PORT_DIPSETTING(     0x000, DEF_STR( None ) )
	...
	PORT_DIPNAME( 0x400, 0x000, DEF_STR( Language ) ) PORT_DIPLOCATION("SWA:1")
	PORT_DIPSETTING(     0x000, DEF_STR( English ) )
	PORT_DIPSETTING(     0x400, DEF_STR( Japanese ) )
INPUT_PORTS_END
