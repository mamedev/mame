 ...
 *
 *************************************************************/
uint8_t at_mb_device::get_slave_ack(address_space &space, offs_t offset, uint8_t mem_mask)
{
	if (offset==2) // IRQ = 2
...
uint8_t at_mb_device::page8_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void at_mb_device::page8_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t at_mb_device::dma_read_byte(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void at_mb_device::dma_write_byte(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	address_space& prog_space = m_maincpu->space(AS_PROGRAM); // get the right address space
	if(m_dma_channel == -1)
		return;
...
uint8_t at_mb_device::dma_read_word(address_space &space, offs_t offset, uint8_t mem_mask)
{
	address_space& prog_space = m_maincpu->space(AS_PROGRAM); // get the right address space
	if(m_dma_channel == -1)
		return 0xff;
...
void at_mb_device::dma_write_word(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	address_space& prog_space = m_maincpu->space(AS_PROGRAM); // get the right address space
	if(m_dma_channel == -1)
		return;
...
uint8_t at_mb_device::dma8237_0_dack_r(address_space &space, offs_t offset, uint8_t mem_mask) { return m_isabus->dack_r(0); }
uint8_t at_mb_device::dma8237_1_dack_r(address_space &space, offs_t offset, uint8_t mem_mask) { return m_isabus->dack_r(1); }
uint8_t at_mb_device::dma8237_2_dack_r(address_space &space, offs_t offset, uint8_t mem_mask) { return m_isabus->dack_r(2); }
uint8_t at_mb_device::dma8237_3_dack_r(address_space &space, offs_t offset, uint8_t mem_mask) { return m_isabus->dack_r(3); }
uint8_t at_mb_device::dma8237_5_dack_r(address_space &space, offs_t offset, uint8_t mem_mask) { uint16_t ret = m_isabus->dack16_r(5); m_dma_high_byte = ret & 0xff00; return ret; }
uint8_t at_mb_device::dma8237_6_dack_r(address_space &space, offs_t offset, uint8_t mem_mask) { uint16_t ret = m_isabus->dack16_r(6); m_dma_high_byte = ret & 0xff00; return ret; }
uint8_t at_mb_device::dma8237_7_dack_r(address_space &space, offs_t offset, uint8_t mem_mask) { uint16_t ret = m_isabus->dack16_r(7); m_dma_high_byte = ret & 0xff00; return ret; }


void at_mb_device::dma8237_0_dack_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask){ m_isabus->dack_w(0, data); }
void at_mb_device::dma8237_1_dack_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask){ m_isabus->dack_w(1, data); }
void at_mb_device::dma8237_2_dack_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask){ m_isabus->dack_w(2, data); }
void at_mb_device::dma8237_3_dack_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask){ m_isabus->dack_w(3, data); }
void at_mb_device::dma8237_5_dack_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask){ m_isabus->dack16_w(5, m_dma_high_byte | data); }
...
void at_mb_device::write_rtc(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	if (offset==0) {
...
void at_mb_device::portb_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_at_speaker = data;
