...
uint8_t ac1_state::ac1_port_b_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	uint8_t data = 0x7f;
...
uint8_t ac1_state::ac1_port_a_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void ac1_state::ac1_port_a_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
}

void ac1_state::ac1_port_b_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	/*
