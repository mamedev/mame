...
uint32_t n64_periphs::mi_reg_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
	uint32_t ret = 0;
	switch (offset)
	{
...
void n64_periphs::mi_reg_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	switch (offset)
	{
...
uint32_t n64_periphs::is64_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
	switch(offset)
	{
		case 0x0000/4:
...
void n64_periphs::is64_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	int i = 0;
...
uint32_t n64_periphs::open_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
...
void n64_periphs::open_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	// Do nothing
}
...
uint32_t n64_periphs::rdram_reg_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
	if(offset > 0x24/4)
	{
...
void n64_periphs::rdram_reg_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	if(offset > 0x24/4)
	{
...
void n64_periphs::sp_set_status(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	if (data & 0x1)
	{
		m_rsp->set_input_line(INPUT_LINE_HALT, ASSERT_LINE);
...
uint32_t n64_periphs::sp_reg_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
	switch (offset)
	{
...
void n64_periphs::sp_reg_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	if ((offset & 0x10000) == 0)
	{
...
uint32_t n64_periphs::dp_reg_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
	switch (offset)
	{
...
void n64_periphs::dp_reg_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
...
uint32_t n64_periphs::vi_reg_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
	uint32_t ret = 0;
	switch (offset)
	{
...
void n64_periphs::vi_reg_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
...
uint32_t n64_periphs::ai_reg_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
	uint32_t ret = 0;
	switch (offset)
	{
...
void n64_periphs::ai_reg_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	switch (offset)
	{
...
uint32_t n64_periphs::pi_reg_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
	uint32_t ret = 0;
	switch (offset)
	{
...
void n64_periphs::pi_reg_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	switch (offset)
	{
		case 0x00/4:        // PI_DRAM_ADDR_REG
...
uint32_t n64_periphs::ri_reg_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
...
void n64_periphs::ri_reg_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	if(offset > 0x1c/4)
	{
...
uint32_t n64_periphs::si_reg_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
	uint32_t ret = 0;
	switch (offset)
	{
...
void n64_periphs::si_reg_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	switch (offset)
	{
		case 0x00/4:        // SI_DRAM_ADDR_REG
...
uint32_t n64_periphs::dd_reg_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
	if(offset < 0x400/4)
	{
...
void n64_periphs::dd_reg_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
...
uint32_t n64_periphs::pif_ram_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
...
void n64_periphs::pif_ram_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
