...
image_init_result nc_state::device_image_load_nc_pcmcia_card(device_image_interface &image)
{
...
void nc_state::device_image_unload_nc_pcmcia_card(device_image_interface &image)
{
