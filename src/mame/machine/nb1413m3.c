...
MACHINE_RESET( nb1413m3 )
{
	...
	nb1413m3_counter = 0;
	nb1413m3_sndromrgnclass = RGNCLASS_SOUND;
...
READ8_HANDLER( nb1413m3_sndrom_r )
{
	...
	if (offset < memory_region_length(machine, nb1413m3_sndromrgnclass, nb1413m3_sndromrgntag))
		return memory_region(machine, nb1413m3_sndromrgnclass, nb1413m3_sndromrgntag)[offset];
	else
	{
