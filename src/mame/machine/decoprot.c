...
//  case 0x04c: return eepromdev_read_bit(devtag_get_device(space->machine, "eeprom"));
...
READ32_HANDLER( deco16_146_fghthist_prot_r )
{
	...
	case 0x04c: return (eepromdev_read_bit(devtag_get_device(space->machine, "eeprom"))<<16) | 0xffff;
	}
