...
INPUT_PORTS_START( ms7004 )
	PORT_START("KEY.12") // vertical row 1
	...
	PORT_START("KEY.13") // vertical row 2
	...
	PORT_START("KEY.14") // vertical row 3
	...
	PORT_START("KEY.15") // vertical row 4
	...
	PORT_START("KEY.11") // vertical row 5
	...
	PORT_START("KEY.10") // vertical row 6
	...
	PORT_START("KEY.9")  // vertical row 7
	...
	PORT_START("KEY.8")  // vertical row 8
	...
	PORT_START("KEY.7")  // vertical row 9
	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_UNUSED )
	...
	PORT_START("KEY.6")  // vertical row 10
	...
	PORT_START("KEY.5")  // vertical row 11
	...
	PORT_START("KEY.3")  // vertical row 12
	...
	PORT_START("KEY.2")  // vertical row 13
	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_UNUSED )
	...
	PORT_START("KEY.1")  // vertical row 14
	...
	PORT_START("KEY.0")  // vertical row 15
	...
	PORT_START("KEY.4")  // vertical row 16
