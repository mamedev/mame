...
NETLIST_START(pong_fast)
	...
	PARAM(clk.USE_DEACTIVATE, 0)
	PARAM(ic_e1d.USE_DEACTIVATE, 0)
	PARAM(ic_e1c.USE_DEACTIVATE, 0)
	PARAM(ic_f1.A.USE_DEACTIVATE, 0)
	PARAM(ic_f1.D.USE_DEACTIVATE, 0)
	PARAM(ic_g1d.USE_DEACTIVATE, 0)
	PARAM(ic_h1a.USE_DEACTIVATE, 0)
	PARAM(ic_h1d.USE_DEACTIVATE, 0)
	PARAM(ic_h3b.sub.USE_DEACTIVATE, 0)
	PARAM(ic_g6b.sub.USE_DEACTIVATE, 0)
	PARAM(ic_c2a.sub.USE_DEACTIVATE, 0)
	PARAM(hit_sound.USE_DEACTIVATE, 0)
	PARAM(topbothitsound.USE_DEACTIVATE, 0)
	PARAM(ic_c9b.USE_DEACTIVATE, 0)
	PARAM(ic_b8.D.USE_DEACTIVATE, 0)
	PARAM(ic_b7a.USE_DEACTIVATE, 0)
	PARAM(ic_a7b.USE_DEACTIVATE, 0)
	PARAM(ic_c9a.USE_DEACTIVATE, 0)
	PARAM(ic_a8.D.USE_DEACTIVATE, 0)
	PARAM(ic_b7d.USE_DEACTIVATE, 0)
	PARAM(ic_a7a.USE_DEACTIVATE, 0)
	PARAM(ic_g1a.USE_DEACTIVATE, 0)
	PARAM(ic_c8a.sub.USE_DEACTIVATE, 0)
	PARAM(ic_c8b.sub.USE_DEACTIVATE, 0)
	PARAM(ic_d8b.USE_DEACTIVATE, 0)
	PARAM(ic_d6a.sub.USE_DEACTIVATE, 0)
	PARAM(ic_d6b.sub.USE_DEACTIVATE, 0)
	PARAM(ic_c6a.sub.USE_DEACTIVATE, 0)
	PARAM(ic_c6b.sub.USE_DEACTIVATE, 0)
	PARAM(ic_e5b.USE_DEACTIVATE, 0)
	PARAM(ic_e4c.USE_DEACTIVATE, 0)
	PARAM(ic_d4b.USE_DEACTIVATE, 0)
	PARAM(ic_g1b.USE_DEACTIVATE, 0)
