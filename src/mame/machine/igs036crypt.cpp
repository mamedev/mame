...
by a certain combination of one or two of the highest address bits. Every one of 
the one-bit XORs affects a different bit of the word. The game key is comprised of 
256 8-bits values provided by the internal ARM, and acts by masking on/off those XORs; 
every 8-bit value in the key affect those words whose address match the index modulus 256; 
every bit in a given key byte, affects two positions of the correponding 16-bits
...
const uint16_t igs036_decryptor::triggers[16][2] = {
	...
	{0x1001, 0x0001}, {0x2002, 0x2000}, {0x4004, 0x4000}, {0x8008, 0x0000},
...
const uint16_t kof98umh_key[0x100] = {
	0x9202, 0x8f03, 0x0200, 0x3f01, 0x2404, 0x8901, 0x2000, 0x0d05, 
	0x870a, 0xae0a, 0x8608, 0xaa08, 0x8606, 0x2606, 0x850c, 0x8808, 
	0x9212, 0x9810, 0x8400, 0x0701, 0x0000, 0x0a02, 0x0714, 0x0505, 
	0x060a, 0x1313, 0x8600, 0x1511, 0x021a, 0x0101, 0x8018, 0x8111, 
	0x8420, 0x9020, 0xb100, 0xbd01, 0x8726, 0x8c24, 0xa404, 0xa101, 
	0x922a, 0x1929, 0x1620, 0x9020, 0x0128, 0x2c0c, 0x250c, 0xae0c, 
	0x0202, 0x9b13, 0x9730, 0x1b31, 0x8404, 0x8c04, 0x8310, 0x8111, 
	0x8120, 0x9939, 0x9038, 0x9030, 0x072e, 0x0c1c, 0x8624, 0x8d3d,
	
	0xe342, 0xa901, 0x0100, 0x7b41, 0xa000, 0x8901, 0xa604, 0x4141, 
	0x130a, 0x7242, 0x8300, 0xdf49, 0x050c, 0x4545, 0x444c, 0xcc4c, 
	0x0602, 0x1410, 0x4740, 0x1911, 0x0414, 0x0b13, 0xc454, 0x8a10, 
	0x474a, 0xc040, 0x4348, 0x5250, 0xc050, 0x0414, 0xc444, 0xc755, 
	0x7242, 0xec40, 0x9020, 0xcf61, 0x8120, 0xe040, 0x2404, 0x0921, 
	0x4468, 0x3000, 0x6048, 0x9a28, 0xc76e, 0x0222, 0xe644, 0x2c0c, 
	0x0722, 0x1b13, 0x8220, 0x9810, 0xc040, 0x4b73, 0x4664, 0x4870, 
