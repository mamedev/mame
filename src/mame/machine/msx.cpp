...
static const uint8_t cc_xy[0x100] = {
	...
	15+1,15+1,15+1,15+1,15+1,15+1, 4+1,15+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1,15+1, 4+1,
	 ...
	 4+1, 4+1, 4+1, 4+1, 4+1, 4+1,15+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1,15+1, 4+1,
	 4+1, 4+1, 4+1, 4+1, 4+1, 4+1,15+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1,15+1, 4+1,
	 5+1,10+1,10+1,10+1,10+1,11+1, 7+1,11+1, 5+1,10+1,10+1,16+1,10+1,17+1, 7+1,11+1,
	 5+1,10+1,10+1,11+1,10+1,11+1, 7+1,11+1, 5+1, 4+1,10+1,11+1,10+1, 4+1, 7+1,11+1,
	 5+1,10+1,10+1,19+1,10+1,11+1, 7+1,11+1, 5+1, 4+1,10+1, 4+1,10+1, 4+1, 7+1,11+1,
	 5+1,10+1,10+1, 4+1,10+1,11+1, 7+1,11+1, 5+1, 6+1,10+1, 4+1,10+1, 4+1, 7+1,11+1
};

// This is arg() no opcode fetch, no adjustment needed
...
static const u8 cc_rop[0x100] = {
	4+1, 4+1, 4+1, 6+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 6+1, 4+1, 4+1, 4+1, 4+1,
	5+1, 4+1, 4+1, 6+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 6+1, 4+1, 4+1, 4+1, 4+1,
	4+1, 4+1, 4+1, 6+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 6+1, 4+1, 4+1, 4+1, 4+1,
	4+1, 4+1, 4+1, 6+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 6+1, 4+1, 4+1, 4+1, 4+1,
	4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1,
	4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1,
	...
	4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1,
	4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1,
	5+1, 4+1, 4+1, 4+1, 4+1, 5+1, 4+1, 5+1, 5+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1,
	5+1, 4+1, 4+1, 4+1, 4+1, 5+1, 4+1, 5+1, 5+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1,
	5+1, 4+1, 4+1, 4+1, 4+1, 5+1, 4+1, 5+1, 5+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1,
	5+1, 4+1, 4+1, 4+1, 4+1, 5+1, 4+1, 5+1, 5+1, 6+1, 4+1, 4+1, 4+1, 4+1, 4+1, 4+1
};
...
void msx_state::driver_start()
{
	...
	m_maincpu->z80_set_cycle_tables(cc_op, cc_cb, cc_ed, cc_xy, nullptr, cc_ex, cc_rop);
