...
*/
uint8_t docastle_state::docastle_shared0_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	if (offset == 8 && LOG)
...
uint8_t docastle_state::docastle_shared1_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	if (offset == 8 && LOG)
...
void docastle_state::docastle_shared0_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	if (offset == 8 && LOG)
...
void docastle_state::docastle_shared1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void docastle_state::docastle_nmitrigger_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
