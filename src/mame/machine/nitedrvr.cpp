...
uint8_t nitedrvr_state::nitedrvr_steering_reset_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	m_steering_val = 0;
	return 0;
}

void nitedrvr_state::nitedrvr_steering_reset_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_steering_val = 0;
}
...
uint8_t nitedrvr_state::nitedrvr_in0_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
uint8_t nitedrvr_state::nitedrvr_in1_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void nitedrvr_state::nitedrvr_out0_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void nitedrvr_state::nitedrvr_out1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
