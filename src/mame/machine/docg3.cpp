...
uint16_t diskonchip_g3_device::sec_1_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	uint16_t data;
...
void diskonchip_g3_device::sec_1_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	verboselog(*this, 9, "(DOC) %08X <- %04X\n", 0x0800 + (offset << 1), data);
	if (m_sec_2[0x1B] & 0x40)
	{
...
uint16_t diskonchip_g3_device::sec_2_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	if (mem_mask == 0xffff)
	{
...
void diskonchip_g3_device::sec_2_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	if (mem_mask == 0xffff)
	{
...
uint16_t diskonchip_g3_device::sec_3_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	uint16_t data = 0;
...
void diskonchip_g3_device::sec_3_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	verboselog(*this, 9, "(DOC) %08X <- %02X\n", 0x1800 + (offset << 1), data);
}
