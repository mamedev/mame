...
uint8_t btime_state::mmonkey_protection_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void btime_state::mmonkey_protection_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	uint8_t *RAM = memregion("maincpu")->base();
