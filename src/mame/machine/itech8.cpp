...
uint8_t itech8_state::slikz80_port_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	int result = 0;
...
void itech8_state::slikz80_port_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_z80_port_val = data;
...
uint8_t itech8_state::slikshot_z80_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
uint8_t itech8_state::slikshot_z80_control_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_z80_ctrl;
}
...
void itech8_state::slikshot_z80_control_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
