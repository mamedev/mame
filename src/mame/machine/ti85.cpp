...
offs_t ti85_state::ti83p_direct_update_handler(direct_read_data &direct, offs_t address)
{
	if (m_booting)
	{
...
uint8_t ti85_state::ti85_port_0000_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return 0xff;
}

uint8_t ti85_state::ti8x_keypad_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	int data = 0xff;
	int port;
	int bit;
	...
	uint8_t ti85_state::ti85_port_0002_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return 0xff;
}

	uint8_t ti85_state::ti85_port_0003_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	int data = 0;
	...
	uint8_t ti85_state::ti85_port_0004_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return 0xff;
}

	uint8_t ti85_state::ti85_port_0005_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_ti8x_memory_page_1;
}

uint8_t ti85_state::ti85_port_0006_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_power_mode;
}

uint8_t ti85_state::ti8x_serial_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
uint8_t ti85_state::ti82_port_0002_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_ti8x_port2;
}

uint8_t ti85_state::ti86_port_0005_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_ti8x_memory_page_1;
}

uint8_t ti85_state::ti86_port_0006_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_ti8x_memory_page_2;
}

uint8_t ti85_state::ti83pse_port_0005_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_ti8x_memory_page_3;
}

uint8_t ti85_state::ti83_port_0000_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return ((m_ti8x_memory_page_1 & 0x08) << 1) | 0x0C;
}

uint8_t ti85_state::ti83_port_0002_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_ti8x_port2;
}

uint8_t ti85_state::ti83_port_0003_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	int data = 0;
...
uint8_t ti85_state::ti8x_plus_serial_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	//ti85_update_serial(m_serial);
	return (m_white_out<<3)
		| (m_red_out<<2)
...
uint8_t ti85_state::ti83p_port_0002_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_ti8x_port2|3;
}

uint8_t ti85_state::ti83p_port_0004_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	int data = 0;
...
uint8_t ti85_state::ti83pse_port_0002_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return 0xC3 | (m_flash_unlocked << 2);
}

uint8_t ti85_state::ti83pse_port_0009_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return 0;
}

uint8_t ti85_state::ti83pse_port_0015_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return 0x33;
}


void ti85_state::ti81_port_0007_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_ti81_port_7_data = data;
}

void ti85_state::ti85_port_0000_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_LCD_memory_base = data;
}

void ti85_state::ti8x_keypad_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_keypad_mask = data&0x7f;
}

void ti85_state::ti85_port_0002_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_LCD_contrast = data&0x1f;
}

void ti85_state::ti85_port_0003_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void ti85_state::ti85_port_0004_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void ti85_state::ti85_port_0005_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_ti8x_memory_page_1 = data;
	update_ti85_memory();
}

void ti85_state::ti85_port_0006_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_power_mode = data;
}

void ti85_state::ti8x_serial_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void ti85_state::ti86_port_0005_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_ti8x_memory_page_1 = data&((data&0x40)?0x47:0x4f);
	update_ti86_memory();
}

void ti85_state::ti86_port_0006_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_ti8x_memory_page_2 = data&((data&0x40)?0x47:0x4f);
	update_ti86_memory();
}

void ti85_state::ti82_port_0002_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void ti85_state::ti83_port_0000_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_ti8x_memory_page_1 = (m_ti8x_memory_page_1 & 7) | ((data & 16) >> 1);
	update_ti85_memory();
}

void ti85_state::ti83_port_0002_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void ti85_state::ti83_port_0003_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
		if (m_LCD_status && !(data&0x08))   m_timer_interrupt_mask = 0;
		m_ON_interrupt_mask = data&0x01;
		//m_timer_interrupt_mask = data&0x04;
...
void ti85_state::ti8x_plus_serial_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void ti85_state::ti83pse_int_ack_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void ti85_state::ti83p_int_mask_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void ti85_state::ti83p_port_0004_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_ti83p_port4 = data | 0xe0;
	update_ti83p_memory();
}

void ti85_state::ti83p_port_0006_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_ti8x_memory_page_1 = data & ((data&0x40) ? 0x41 : 0x5f);
	update_ti83p_memory();
}

void ti85_state::ti83p_port_0007_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_ti8x_memory_page_2 = data & ((data&0x40) ? 0x41 : 0x5f);
	update_ti83p_memory();
}

void ti85_state::ti83pse_port_0004_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_ti83p_port4 = data;
	update_ti83pse_memory();
}

void ti85_state::ti83pse_port_0005_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_ti8x_memory_page_3 = data & 0x07;
	update_ti83pse_memory();
}

void ti85_state::ti83pse_port_0006_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void ti85_state::ti83pse_port_0007_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	if ((m_model == TI84P) && (data < 0x80))
	{
...
void ti85_state::ti83p_port_0014_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_flash_unlocked = data;
	update_ti83pse_memory();
}

void ti85_state::ti83pse_port_0020_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_cpu_speed = data;
	if(data)
	{
...
uint8_t ti85_state::ti83pse_port_0020_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_cpu_speed;
}

void ti85_state::ti83pse_port_0021_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_ti83pse_port21 = data & 0x0f;
}

uint8_t ti85_state::ti83pse_port_0021_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_ti83pse_port21;
}

uint8_t ti85_state::ti84pse_port_0055_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return 0x1f;
}

uint8_t ti85_state::ti84pse_port_0056_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return 0;
}
...
uint8_t ti85_state::ti83pse_ctimer1_setup_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_ctimer[CRYSTAL_TIMER1].setup;
}

void ti85_state::ti83pse_ctimer1_setup_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_crystal_timer1->enable(false);
	m_ctimer[CRYSTAL_TIMER1].setup = data;
}

uint8_t ti85_state::ti83pse_ctimer1_loop_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_ctimer[CRYSTAL_TIMER1].loop;
}

void ti85_state::ti83pse_ctimer1_loop_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_ctimer[CRYSTAL_TIMER1].loop = data & 0x03;
	m_ctimer_interrupt_status = 0;
}

uint8_t ti85_state::ti83pse_ctimer1_count_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_ctimer[CRYSTAL_TIMER1].count;
}

void ti85_state::ti83pse_ctimer1_count_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t ti85_state::ti83pse_ctimer2_setup_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_ctimer[CRYSTAL_TIMER2].setup;
}

void ti85_state::ti83pse_ctimer2_setup_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_crystal_timer2->enable(false);
	m_ctimer[CRYSTAL_TIMER2].setup = data;
}

uint8_t ti85_state::ti83pse_ctimer2_loop_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_ctimer[CRYSTAL_TIMER2].loop;
}

void ti85_state::ti83pse_ctimer2_loop_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_ctimer[CRYSTAL_TIMER2].loop = data & 0x03;
	m_ctimer_interrupt_status = 0;
}

uint8_t ti85_state::ti83pse_ctimer2_count_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_ctimer[CRYSTAL_TIMER2].count;
}

void ti85_state::ti83pse_ctimer2_count_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t ti85_state::ti83pse_ctimer3_setup_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_ctimer[CRYSTAL_TIMER3].setup;
}

void ti85_state::ti83pse_ctimer3_setup_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_crystal_timer3->enable(false);
	m_ctimer[CRYSTAL_TIMER3].setup = data;
}

uint8_t ti85_state::ti83pse_ctimer3_loop_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_ctimer[CRYSTAL_TIMER3].loop;
}

void ti85_state::ti83pse_ctimer3_loop_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_ctimer[CRYSTAL_TIMER3].loop = data & 0x03;
	m_ctimer_interrupt_status = 0;
}

uint8_t ti85_state::ti83pse_ctimer3_count_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_ctimer[CRYSTAL_TIMER3].count;
}

void ti85_state::ti83pse_ctimer3_count_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
