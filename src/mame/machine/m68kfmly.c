...
{
	LOG(("PC %08X: TMP68301_address_decoder_r (%08X)\n", cpu_get_pc(machine->activecpu), (0xfffc00 + (offset * 2))));
...
{
	LOG(("PC %08X: TMP68301_address_decoder_w (%08X = %04X)\n", cpu_get_pc(machine->activecpu), (0xfffc00 + (offset * 2)), data));
...
{
	LOG(("PC %08X: TMP68301_interrupt_controller_r (%08X)\n", cpu_get_pc(machine->activecpu), (0xfffc80 + (offset * 2))));
...
{
	LOG(("PC %08X: TMP68301_interrupt_controller_w (%08X = %04X)\n", cpu_get_pc(machine->activecpu), (0xfffc80 + (offset * 2)), data));
...
{
	LOG(("PC %08X: TMP68301_parallel_interface_r (%08X)\n", cpu_get_pc(machine->activecpu), (0xfffd00 + (offset * 2))));
...
{
	LOG(("PC %08X: TMP68301_parallel_interface_w (%08X = %04X)\n", cpu_get_pc(machine->activecpu), (0xfffd00 + (offset * 2)), data));
...
{
	LOG(("PC %08X: TMP68301_serial_interface_r (%08X)\n", cpu_get_pc(machine->activecpu), (0xfffd80 + (offset * 2))));
...
{
	LOG(("PC %08X: TMP68301_serial_interface_w (%08X = %04X)\n", cpu_get_pc(machine->activecpu), (0xfffd80 + (offset * 2)), data));
...
{
	LOG(("PC %08X: TMP68301_timer_r (%08X)\n", cpu_get_pc(machine->activecpu), (0xfffe00 + (offset * 2))));
...
{
	LOG(("PC %08X: TMP68301_timer_w (%08X = %04X)\n", cpu_get_pc(machine->activecpu), (0xfffe00 + (offset * 2)), data));
