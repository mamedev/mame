...
void raiden2cop_device::cop_pgm_data_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void raiden2cop_device::cop_pgm_addr_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	assert(ACCESSING_BITS_0_7 && ACCESSING_BITS_8_15);
	assert(data < 0x100);
	cop_latch_addr = data;
...
void raiden2cop_device::cop_pgm_value_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	assert(ACCESSING_BITS_0_7 && ACCESSING_BITS_8_15);
	cop_latch_value = data;
}

void raiden2cop_device::cop_pgm_mask_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	assert(ACCESSING_BITS_0_7 && ACCESSING_BITS_8_15);
	cop_latch_mask = data;
}

void raiden2cop_device::cop_pgm_trigger_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	assert(ACCESSING_BITS_0_7 && ACCESSING_BITS_8_15);
...
void raiden2cop_device::cop_dma_adr_rel_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	COMBINE_DATA(&cop_dma_adr_rel);
}

void raiden2cop_device::cop_dma_v1_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	COMBINE_DATA(&cop_dma_v1);
}

void raiden2cop_device::cop_dma_v2_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	COMBINE_DATA(&cop_dma_v2);
}

void raiden2cop_device::cop_dma_dst_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	COMBINE_DATA(&cop_dma_dst[cop_dma_mode]);
}

uint16_t raiden2cop_device::cop_dma_mode_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	return cop_dma_mode;
}

void raiden2cop_device::cop_dma_mode_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	COMBINE_DATA(&cop_dma_mode);
}

void raiden2cop_device::cop_dma_src_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	COMBINE_DATA(&cop_dma_src[cop_dma_mode]);
}

void raiden2cop_device::cop_dma_size_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	COMBINE_DATA(&cop_dma_size[cop_dma_mode]);
}

void raiden2cop_device::cop_pal_brightness_val_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	COMBINE_DATA(&pal_brightness_val);
}

void raiden2cop_device::cop_pal_brightness_mode_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void raiden2cop_device::cop_dma_trigger_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
#if 0
...
void raiden2cop_device::cop_itoa_low_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void raiden2cop_device::cop_itoa_high_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void raiden2cop_device::cop_itoa_mode_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
uint16_t raiden2cop_device::cop_itoa_digits_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	return cop_itoa_digits[offset*2] | (cop_itoa_digits[offset*2+1] << 8);
}

uint16_t raiden2cop_device::cop_status_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	return cop_status;
}

uint16_t raiden2cop_device::cop_angle_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	return cop_angle;
}

uint16_t raiden2cop_device::cop_dist_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	return cop_dist;
}

void raiden2cop_device::cop_scale_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	COMBINE_DATA(&cop_scale);
	cop_scale &= 3;
}

void raiden2cop_device::cop_angle_target_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	COMBINE_DATA(&cop_angle_target);
}

void raiden2cop_device::cop_angle_step_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	COMBINE_DATA(&cop_angle_step);
}

uint16_t raiden2cop_device::cop_reg_high_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	return cop_regs[offset] >> 16;
}

void raiden2cop_device::cop_reg_high_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	cop_regs[offset] = (cop_regs[offset] & ~(mem_mask << 16)) | ((data & mem_mask) << 16);
}

uint16_t raiden2cop_device::cop_reg_low_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	return cop_regs[offset];
}

void raiden2cop_device::cop_reg_low_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	cop_regs[offset] = (cop_regs[offset] & ~uint32_t(mem_mask)) | (data & mem_mask);
}

void raiden2cop_device::cop_hitbox_baseadr_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void raiden2cop_device::cop_cmd_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
uint16_t raiden2cop_device::cop_collision_status_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	return cop_hit_status;
}


uint16_t raiden2cop_device::cop_collision_status_val_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	return cop_hit_val[offset];
}

uint16_t raiden2cop_device::cop_collision_status_stat_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	return cop_hit_val_stat;
}

void raiden2cop_device::cop_sort_lookup_hi_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	cop_sort_lookup = (cop_sort_lookup&0x0000ffff)|(data<<16);
}

void raiden2cop_device::cop_sort_lookup_lo_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	cop_sort_lookup = (cop_sort_lookup&0xffff0000)|(data&0xffff);
}

void raiden2cop_device::cop_sort_ram_addr_hi_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	cop_sort_ram_addr = (cop_sort_ram_addr&0x0000ffff)|(data<<16);
}

void raiden2cop_device::cop_sort_ram_addr_lo_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	cop_sort_ram_addr = (cop_sort_ram_addr&0xffff0000)|(data&0xffff);
}

void raiden2cop_device::cop_sort_param_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	cop_sort_param = data;
}

// TODO: trampoline
void raiden2cop_device::cop_sort_dma_trig_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	dma_zsorting(data);
}
...
uint16_t raiden2cop_device::cop_prng_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	return m_host_cpu->total_cycles() % (m_cop_rng_max_value + 1);
}

/* max possible value returned by the RNG at 0x5a*, trusted */
void raiden2cop_device::cop_prng_maxvalue_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	COMBINE_DATA(&m_cop_rng_max_value);
}

uint16_t raiden2cop_device::cop_prng_maxvalue_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
void raiden2cop_device::cop_sprite_dma_param_hi_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	m_cop_sprite_dma_param = (m_cop_sprite_dma_param&0x0000ffff)|(data<<16);
}

void raiden2cop_device::cop_sprite_dma_param_lo_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	m_cop_sprite_dma_param = (m_cop_sprite_dma_param&0xffff0000)|(data&0xffff);
}

void raiden2cop_device::cop_sprite_dma_size_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	m_cop_sprite_dma_size = data;
}


void raiden2cop_device::cop_sprite_dma_src_hi_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	m_cop_sprite_dma_src = (m_cop_sprite_dma_src&0x0000ffff)|(data<<16);
}

void raiden2cop_device::cop_sprite_dma_src_lo_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	m_cop_sprite_dma_src = (m_cop_sprite_dma_src&0xffff0000)|(data&0xffff);
}

// guess
void raiden2cop_device::cop_sprite_dma_inc_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	if (data)
...
void raiden2cop_device::cop_unk_param_a_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	COMBINE_DATA(&m_cop_unk_param_a);
}

// Involved with 0x9100/0x9180 and 0x9900/0x9980
void raiden2cop_device::cop_unk_param_b_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void raiden2cop_device::cop_precmd_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	COMBINE_DATA(&m_cop_precmd);
}

// cupsoc writes a longword before 0x5105 or 0xF105 (always 0xC000 for the latter)
void raiden2cop_device::cop_rom_addr_lo_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	COMBINE_DATA(&m_cop_rom_addr_lo);
}

void raiden2cop_device::cop_rom_addr_hi_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	COMBINE_DATA(&m_cop_rom_addr_hi);
}

void raiden2cop_device::cop_sprite_dma_abs_y_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	m_cop_sprite_dma_abs_y = data;
}

void raiden2cop_device::cop_sprite_dma_abs_x_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void raiden2cop_device::LEGACY_cop_cmd_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	int command;
