...
void m2_bda_device::device_timer(emu_timer const &timer, device_timer_id id, int param, void *ptr)
{
	switch (id)
	{
		case 0:
...
void m2_vdu_device::device_timer(emu_timer const &timer, device_timer_id id, int param, void *ptr)
{
	switch (id)
	{
		case TIMER_ID_VINT0:
...
void m2_cde_device::device_timer(emu_timer const &timer, device_timer_id id, int param, void *ptr)
{
	switch (id)
	{
		case TIMER_ID_READY:
