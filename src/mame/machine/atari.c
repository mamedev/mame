...
void a600xl_mmu(running_machine *machine, UINT8 new_mmu)
{
	...
	memory_install_readwrite_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x5000, 0x57ff, 0, 0, rbank2, wbank2);
	if (rbank2 == SMH_BANK2)
...
void a800xl_mmu(running_machine *machine, UINT8 new_mmu)
{
	...
	memory_install_readwrite_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0xc000, 0xcfff, 0, 0, rbank3, wbank3);
	memory_install_readwrite_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0xd800, 0xffff, 0, 0, rbank4, wbank4);
	...
	memory_install_readwrite_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0xa000, 0xbfff, 0, 0, rbank1, wbank1);
...
DRIVER_INIT( atari )
{
	...
	memory_install_read_handler(machine, 0, ADDRESS_SPACE_PROGRAM,
		0x0000, ram_top, 0, 0, SMH_BANK2);
	memory_install_write_handler(machine, 0, ADDRESS_SPACE_PROGRAM,
		0x0000, ram_top, 0, 0, SMH_BANK2);
...
static void a800_setbank(running_machine *machine, int n)
{
	...
	memory_install_read_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x8000, 0xbfff, 0, 0,
		read_addr ? SMH_BANK1 : SMH_NOP);
	memory_install_write_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x8000, 0xbfff, 0, 0,
