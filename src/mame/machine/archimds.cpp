...
void archimedes_state::archimedes_request_fiq(int mask)
{
	...
	{
		m_maincpu->pulse_input_line(ARM_FIRQ_LINE, m_maincpu->minimum_quantum());
...
void archimedes_state::device_timer(timer_instance const &timer, device_timer_id id, int param, void *ptr)
{
	switch (id)
	{
