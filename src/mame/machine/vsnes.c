...
DRIVER_INIT( vsnormal )
{
	...
	memory_install_write_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x4016, 0x4016, 0, 0, vsnormal_vrom_banking );
}
...
DRIVER_INIT( suprmrio )
{
	...
	memory_install_readwrite_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x6000, 0x7fff, 0, 0, SMH_BANK1, SMH_BANK1 );
...
{
	/* vrom switching is enabled with bit 2 of $4016 */
	memory_install_readwrite_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x4016, 0x4016, 0, 0, gun_in0_r, gun_in0_w );
...
DRIVER_INIT( goonies )
{
	...
	memory_install_write_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x8000, 0xffff, 0, 0, goonies_rom_banking );
...
DRIVER_INIT( vsgshoe )
{
	...
	/* Protection */
	memory_install_read_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x2002, 0x2002, 0, 0, vsgshoe_security_r );
	memory_install_write_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x2000, 0x2001, 0, 0, ppuRC2C05_protection );

	/* vrom switching is enabled with bit 2 of $4016 */
	memory_install_readwrite_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x4016, 0x4016, 0, 0, gun_in0_r, vsgshoe_gun_in0_w );
...
DRIVER_INIT( drmario )
{
	...
	memory_install_write_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x8000, 0xffff, 0, 0, drmario_rom_banking );
...
DRIVER_INIT( cstlevna )
{
	...
	memcpy( &prg[0x08000], &prg[0x28000], 0x8000 );
   	...
   	/* banking is done with writes to the $8000-$ffff area */
	memory_install_write_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x8000, 0xffff, 0, 0, castlevania_rom_banking );
...
DRIVER_INIT( topgun )
{
	...
	memory_install_read_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x2002, 0x2002, 0, 0, topgun_security_r );
	memory_install_write_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x2000, 0x2001, 0, 0, ppuRC2C05_protection );
...
DRIVER_INIT( MMC3 )
{
	...
	memory_install_write_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x8000, 0xffff, 0, 0, mapper4_w );
...
DRIVER_INIT( rbibb )
{
	...
	/* RBI Base ball hack */
	memory_install_read_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x5e00, 0x5e01, 0, 0, rbi_hack_r) ;
...
DRIVER_INIT( supxevs )
{
	...
	memory_install_read_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x54ff, 0x54ff, 0, 0, supxevs_read_prot_1_r );
	memory_install_read_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x5678, 0x5678, 0, 0, supxevs_read_prot_2_r );
	memory_install_read_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x578f, 0x578f, 0, 0, supxevs_read_prot_3_r );
	memory_install_read_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x5567, 0x5567, 0, 0, supxevs_read_prot_4_r );
...
DRIVER_INIT( tkoboxng )
{
	...
	memory_install_read_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x5e00, 0x5e01, 0, 0, tko_security_r );
...
DRIVER_INIT( platoon )
{
	...
	memory_install_write_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x8000, 0xffff, 0, 0, mapper68_rom_banking );
...
{
	memory_install_readwrite_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x0231, 0x0231, 0, 0, set_bnglngby_irq_r, set_bnglngby_irq_w );
...
DRIVER_INIT( jajamaru )
{
	...
	/* Protection */
	memory_install_read_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x2002, 0x2002, 0, 0, jajamaru_security_r );
	memory_install_write_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x2000, 0x2001, 0, 0, ppuRC2C05_protection );
...
{
	/* Protection */
	memory_install_read_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x2002, 0x2002, 0, 0, mightybj_security_r );
	memory_install_write_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x2000, 0x2001, 0, 0, ppuRC2C05_protection );
...
DRIVER_INIT( vstennis )
{
	...
	/* vrom switching is enabled with bit 2 of $4016 */
	memory_install_write_handler(machine, 0, ADDRESS_SPACE_PROGRAM, 0x4016, 0x4016, 0, 0, vstennis_vrom_banking );
	memory_install_write_handler(machine, 1, ADDRESS_SPACE_PROGRAM, 0x4016, 0x4016, 0, 0, vstennis_vrom_banking );
