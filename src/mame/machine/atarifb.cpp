...
void atarifb_state::atarifb_out1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_CTRLD = data;
...
void atarifb_state::atarifb4_out1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_CTRLD = data;
...
void atarifb_state::abaseb_out1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_CTRLD = data;
...
void atarifb_state::soccer_out1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_CTRLD = data;
...
void atarifb_state::atarifb_out2_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void atarifb_state::soccer_out2_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_discrete->write(space, ATARIFB_CROWD_DATA, data & 0x0f); // Crowd
...
void atarifb_state::atarifb_out3_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t atarifb_state::atarifb_in0_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
uint8_t atarifb_state::atarifb_in2_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	if ((m_CTRLD & 0x20) == 0x00)
	{
...
uint8_t atarifb_state::atarifb4_in0_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
uint8_t atarifb_state::atarifb4_in2_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
