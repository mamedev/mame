...
#ifndef MAME_MACHINE_WAFADRIVE_H
#define MAME_MACHINE_WAFADRIVE_H
...
public:
	...
	wafadrive_image_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock);
...
#endif // MAME_MACHINE_WAFADRIVE_H
