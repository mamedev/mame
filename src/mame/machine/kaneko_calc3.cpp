...
void kaneko_calc3_device::mcu_com0_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask){ mcu_com_w(offset, data, mem_mask, 0); }
void kaneko_calc3_device::mcu_com1_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask){ mcu_com_w(offset, data, mem_mask, 1); }
void kaneko_calc3_device::mcu_com2_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask){ mcu_com_w(offset, data, mem_mask, 2); }
void kaneko_calc3_device::mcu_com3_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask){ mcu_com_w(offset, data, mem_mask, 3); }
...
static const int16_t keydata[0x40*0x100] = {
...
int kaneko_calc3_device::decompress_table(int tabnum, uint8_t* dstram, int dstoffset)
{
	...
	// we're at the start of the block, get the info about it
	{
		...
		//if (dstram)
		{
			...
			{
				const int16_t* key = keydata+(m_decryption_key_byte*0x40);
