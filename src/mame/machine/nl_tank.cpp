...
NETLIST_START(tank)
	...
	NET_C(IC_B6.11, IC_B6.12)
	NET_C(IC_B6.13, IC_B6.10)
	NET_C(IC_B6.5, IC_B6.2)
	NET_C(IC_B6.1, IC_B6.6)
	ALIAS(COIN1_NO, IC_B6.11)
	ALIAS(COIN1_NC, IC_B6.13)
	ALIAS(COIN2_NO, IC_B6.5)
	ALIAS(COIN2_NC, IC_B6.1)

	NET_C(IC_B6.6, IC_D6.8)
	NET_C(IC_B6.10, IC_D6.9)
	NET_C(IC_B6.12, IC_N6.5)
	NET_C(IC_B6.2, IC_N6.6)

	NET_C(IC_D6.10, IC_D6.11)
	NET_C(ATTRACT, IC_D6.12)
	...
	NET_C(IC_N6.1, COINAGE1.2)

	NET_C(GND, COINAGE1.1, R48A.1)
	NET_C(R48A.2, COINAGE1.Q, IC_D6.3)
	NET_C(COINQ, IC_D6.2)
	ALIAS(START, IC_D6.1)

	// Game Timer / Attract
	NET_C(V5, PLAYTIME.2, PLAYTIME.3)
	NET_C(COINAGE2.1, PLAYTIME.1, R54A.1)
	NET_C(COINAGE2.Q, R53A.1)
	NET_C(R54A.2, IC_H6.6, IC_H6.7, R53A.2, R60A.1, C25.1)
	NET_C(R60A.2, Q2.B)
	NET_C(GND, COINAGE2.2, C25.2, Q3.E, Q4.E, C24.2)
	NET_C(IC_H6.5, C24.1, R59A.1)
	NET_C(R59A.2, Q2.E, R56A.2, R63A.1, Q3.C, Q4.B)
	...
	NET_C(GND, IC_M10.7,  IC_N13.7, R19.2, R20.2, R21.2, R22.2, R23.2, R24.2, R25.2, R26.2)
