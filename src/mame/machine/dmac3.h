...
protected:
    ...
    template<DMAC3_Controller controller> uint32_t cstat_r() { return m_controllers[controller].cstat; }
    template<DMAC3_Controller controller> uint32_t ictl_r() { return m_controllers[controller].ictl; }
    template<DMAC3_Controller controller> uint32_t trc_r() { return m_controllers[controller].trc; }
    template<DMAC3_Controller controller> uint32_t tra_r() { return m_controllers[controller].tra; }
    template<DMAC3_Controller controller> uint32_t cnf_r() { return m_controllers[controller].cnf; }

    template<DMAC3_Controller controller> void cstat_w(uint32_t data) { m_controllers[controller].cstat = data; }
    template<DMAC3_Controller controller> void ictl_w(uint32_t data) { m_controllers[controller].ictl = data; }
    template<DMAC3_Controller controller> void trc_w(uint32_t data) { m_controllers[controller].trc = data; }
    template<DMAC3_Controller controller> void tra_w(uint32_t data) { m_controllers[controller].tra = data; }
    template<DMAC3_Controller controller> void cnf_w(uint32_t data) { m_controllers[controller].cnf = data; }
