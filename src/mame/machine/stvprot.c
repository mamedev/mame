...
{
	memory_install_readwrite32_handler(machine->device("maincpu")->memory().space(AS_PROGRAM), 0x4fffff0, 0x4ffffff, 0, 0, twcup98_prot_r, twcup98_prot_w);
}
...
{
	memory_install_readwrite32_handler(machine->device("maincpu")->memory().space(AS_PROGRAM), 0x4fffff0, 0x4ffffff, 0, 0, sss_prot_r, sss_prot_w);
}
...
{
	memory_install_readwrite32_handler(machine->device("maincpu")->memory().space(AS_PROGRAM), 0x4fffff0, 0x4ffffff, 0, 0, rsgun_prot_r, rsgun_prot_w);
}
...
{
	memory_install_readwrite32_handler(machine->device("maincpu")->memory().space(AS_PROGRAM), 0x4fffff0, 0x4ffffff, 0, 0, elandore_prot_r, elandore_prot_w);
}
...
{
	memory_install_readwrite32_handler(machine->device("maincpu")->memory().space(AS_PROGRAM), 0x4fffff0, 0x4ffffff, 0, 0, ffreveng_prot_r, ffreveng_prot_w);
}
...
{
	ctrl_index = -1;
	memory_install_readwrite32_handler(machine->device("maincpu")->memory().space(AS_PROGRAM), 0x4fffff0, 0x4ffffff, 0, 0, astrass_prot_r, astrass_prot_w);
}
...
void install_decathlt_protection(running_machine *machine)
{
	...
	decathlt_prot_uploadoffset = 0;
	decathlt_part = 1;
	memory_install_readwrite32_handler(machine->device("maincpu")->memory().space(AS_PROGRAM), 0x37FFFF0, 0x37FFFFF, 0, 0, decathlt_prot_r, decathlt_prot_w);
	/* It uploads 2 tables here too, but nothing else, mirror? unused? */
//  memory_install_readwrite32_handler(machine->device("maincpu")->memory().space(AS_PROGRAM), 0x27FFFF0, 0x27FFFFF, 0, 0, decathlt_prot_r, decathlt_prot_w);
}
