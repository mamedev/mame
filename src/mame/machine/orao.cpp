...
uint8_t orao_state::orao_io_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	double level;
...
void orao_state::orao_io_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	if (offset == 0x0800)
	{
