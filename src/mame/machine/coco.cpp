...
offs_t coco_state::os9_dasm_override(device_t &device, std::ostream &stream, offs_t pc, const device_disasm_interface::data_buffer &opcodes, const device_disasm_interface::data_buffer &params, int options)
{
	unsigned call;
	offs_t result = 0;
...
offs_t coco_state::dasm_override(device_t &device, std::ostream &stream, offs_t pc, const device_disasm_interface::data_buffer &opcodes, const device_disasm_interface::data_buffer &params, int options)
{
	return os9_dasm_override(device, stream, pc, opcodes, params, options);
}
