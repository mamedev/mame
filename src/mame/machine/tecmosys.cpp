...
uint16_t tecmosys_state::prot_status_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
void tecmosys_state::prot_status_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	// deroon clears the status in one place.
}


uint16_t tecmosys_state::prot_data_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
void tecmosys_state::prot_data_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	// Only LSB
	data >>= 8;
