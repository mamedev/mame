...
public:
	...
	uint32_t pgm_arm7_type1_protlatch_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void pgm_arm7_type1_protlatch_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	uint16_t pgm_arm7_type1_68k_protlatch_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void pgm_arm7_type1_68k_protlatch_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint16_t pgm_arm7_type1_ram_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void pgm_arm7_type1_ram_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint32_t pgm_arm7_type1_unk_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	uint32_t pgm_arm7_type1_exrom_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	uint32_t pgm_arm7_type1_shareram_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
	void pgm_arm7_type1_shareram_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
	void pgm_arm7_type1_latch_init();
	uint16_t kovsh_fake_region_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	void kovshp_asic27a_write_word(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	...
	uint16_t pgm_arm7_type1_sim_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	...
	void pgm_arm7_type1_sim_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);
	uint16_t pgm_arm7_type1_sim_protram_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	uint16_t pstars_arm7_type1_sim_protram_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);
	int m_simregion;
