...
NETLIST_START(dpatrol)
	...
	TTL_7404_INVERT(H9_4, main_clk)

	TTL_74107(H8_1a, H9_4.Q, VCC, VCC, VCC)// FIXME: H8_1 already used below
	ALIAS(IMAGE_CLOCK, H8_1a.Q)

	TTL_74161_FIXME(E9, VCC, GND, GND, VCC, VCC, D9_3.Q, H9_4.Q, VCC, VCC)
	TTL_7404_INVERT(D9_3, E9.RC)

	TTL_74107(H8_2a, H8_1.QQ, VCC, VCC, VCC) // FIXME: H8_2 already used below

	TTL_7492(A6a, VCC, H9_4.Q, GND, GND) // FIXME: A6 already used below

	ALIAS(HORZ_CLOCK, A6a.QB)
	ALIAS(ADDR_BIT_START, GND)
	TTL_7400_NAND(C5_1a, ADDR_BIT_START, A6a.QC) // FIXME: C5_1 already used below

	ALIAS(VERT_DRIVE, VCC)
	ALIAS(VERT_DRIVE_Q, GND)
	...
	ALIAS(BIT_15, GND)
	ALIAS(BIT_16, GND)
	ALIAS(BIT_COMPARE, GND)
	ALIAS(BIT_COMPARE_Q, VCC)
	ALIAS(STROBE_A, GND)

	TTL_7474(J6_2, BIT_COMPARE_Q, BIT_10, VCC, VCC)
	TTL_7474(B7_2, BIT_COMPARE_Q, BIT_9, VCC, VCC)
	TTL_7474(J6_1, BIT_COMPARE_Q, BIT_14, VERT_DRIVE_Q, VCC)
	TTL_7400_NAND(C5_2a, STROBE_A, B7_2.Q) // FIXME: C5_2 already used below
	TTL_7400_NAND(C5_3, C5_2a.Q, J6_1.Q)

	TTL_7400_NAND(J5_4a, BIT_16, BIT_COMPARE) // FIXME: J5_4 already used below
	TTL_7400_NAND(J5_1a, BIT_15, BIT_COMPARE) // FIXME: J5_1 already used below
	TTL_7474(H5_1a, J5_4a.Q, H5_1a.QQ, J5_1a.Q, VCC) // FIXME: H5_1 already used below
	TTL_7474(H5_2a, H5_1a.QQ, H5_2a.QQ, J5_1a.Q, VCC) // FIXME: H5_2 already used below
	...
	TTL_7420_NAND(J6_1a, 8H, 64H, 128H, 256H) // FIXME: J6_1 already used above
	ALIAS(HRESET_Q, J6_1a.Q)
	...
	NET_C(VCC, PROBECLK.VCC, SPEED_PULSES.VCC)
	NET_C(GND, PROBECLK.GND, SPEED_PULSES.GND)
