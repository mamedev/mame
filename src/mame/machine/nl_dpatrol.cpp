...
NETLIST_START(dpatrol)
	...
	TTL_74107(H8_1, H9_4.Q, VCC, VCC, VCC)
	ALIAS(IMAGE_CLOCK, H8_1.Q)

	TTL_74161(E9, VCC, GND, GND, VCC, VCC, D9_3.Q, H9_4.Q, VCC, VCC)
	TTL_7404_INVERT(D9_3, E9.RCO)

	TTL_74107(H8_2, H8_1.QQ, VCC, VCC, VCC)

	TTL_7492(A6, VCC, H9_4.Q, GND, GND)

	ALIAS(HORZ_CLOCK, A6.QB)
	ALIAS(ADDR_BIT_START, GND)
	TTL_7400_NAND(C5_1, ADDR_BIT_START, A6.QC)
	...
	TTL_7400_NAND(C5_2, STROBE_A, B7_2.Q)
	TTL_7400_NAND(C5_3, C5_2.Q, J6_1.Q)

	TTL_7400_NAND(J5_4, BIT_16, BIT_COMPARE)
	TTL_7400_NAND(J5_1, BIT_15, BIT_COMPARE)
	TTL_7474(H5_1, J5_4.Q, H5_1.QQ, J5_1.Q, VCC)
	TTL_7474(H5_2, H5_1.QQ, H5_2.QQ, J5_1.Q, VCC)
