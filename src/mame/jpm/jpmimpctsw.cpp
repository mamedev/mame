...
INPUT_PORTS_START( jpmimpct_non_video_inputs ) // these are standard inputs for the first party games
	...
	PORT_MODIFY("J10_2")
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_DOOR ) PORT_NAME("Back Door") PORT_CODE(KEYCODE_Q) PORT_TOGGLE
	...
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_DOOR ) PORT_NAME("Cashbox Door") PORT_CODE(KEYCODE_W) PORT_TOGGLE
INPUT_PORTS_END
...
INPUT_PORTS_START( j6amdrm ) // MDM game - might use % key, errors when changed from previous boot, but doesn't seem to require one
	...
	PORT_MODIFY("J10_2")
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_DOOR ) PORT_NAME("Cashbox Door") PORT_CODE(KEYCODE_W) PORT_TOGGLE
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_DOOR ) PORT_NAME("Back Door") PORT_CODE(KEYCODE_Q) PORT_TOGGLE
...
#define GAME_FLAGS_SOUND MACHINE_NOT_WORKING|MACHINE_REQUIRES_ARTWORK|MACHINE_MECHANICAL

#define GAME_FLAGS_WORKING MACHINE_MECHANICAL
