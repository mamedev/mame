...
static INPUT_PORTS_START( revlatns )
	...
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_DOOR) PORT_NAME("Cashbox Door") PORT_CODE(KEYCODE_Q) PORT_TOGGLE
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_CUSTOM )  // 20p level
	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNUSED )
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON5 ) PORT_NAME("*")
	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_DOOR) PORT_NAME("Back Door") PORT_CODE(KEYCODE_W) PORT_TOGGLE
