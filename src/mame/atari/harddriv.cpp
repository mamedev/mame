...
static INPUT_PORTS_START( racedrivc )
	...
	PORT_BIT( 0xff, 0x00, IPT_PEDAL2 ) PORT_MINMAX(0x20, 0xf0) PORT_SENSITIVITY(25) PORT_KEYDELTA(40) PORT_REVERSE PORT_NAME("Force Brake") /* Added port_minmax to keep brake calibration within range in test menu */
