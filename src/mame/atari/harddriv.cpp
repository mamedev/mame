...
static INPUT_PORTS_START( strtdriv )
	...
	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_COIN3 )    /* aux coin */
	PORT_BIT( 0x00f8, IP_ACTIVE_LOW, IPT_BUTTON7 ) PORT_NAME("CPU Halt/Start")
	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_BUTTON5 ) PORT_NAME("Neutral")
	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_BUTTON4 )  /* ??? */
