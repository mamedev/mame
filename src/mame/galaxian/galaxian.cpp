...
ROM_START( mandingag2 )
	...
	ROM_REGION( 0x1000, "gfx1", 0 )
	ROM_LOAD( "2716.5f",   0x0000, 0x0800, CRC(fc53a676) SHA1(14cb45a50687edef4a2c08011a80f9f0ece69dbd) )
	ROM_LOAD( "2716.5h",   0x0800, 0x0800, CRC(79cad750) SHA1(5d1b0b42d1461809242c13a135656fe921a3ed35) )
...
GAME( 1982, mandingag1,  amidar,   scramble,   amidars,    galaxian_state, init_mandingaeg, ROT90,  "bootleg",                            "Mandinga (bootleg of Amidar, set 1)",                                    MACHINE_SUPPORTS_SAVE )
GAME( 1982, mandingag2,  amidar,   scramble,   amidars,    galaxian_state, init_mandingaeg, ROT90,  "bootleg",                            "Mandinga (bootleg of Amidar, set 2)",                                    MACHINE_SUPPORTS_SAVE )
