...
void clcd_state::clcd(machine_config &config)
{
	...
	M65C02(config, m_maincpu, XTAL::u(1000000));
	...
	via6522_device &via0(R65C22(config, "via0", XTAL::u(1000000)));
	...
	via6522_device &via1(R65C22(config, "via1", XTAL::u(1000000)));
	...
	MOS6551(config, m_acia, XTAL::u(1000000));
