...
GAME( 1986, ninjemat, ninjemak, youmab,   ninjemak, galivan_state, empty_init,  ROT270, "Nichibutsu (Tecfri license)", "Ninja Emaki (Tecfri license)",                        MACHINE_SUPPORTS_SAVE|MACHINE_UNEMULATED_PROTECTION )
