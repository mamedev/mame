...
ROM_START( ninjemat )
	...
	ROM_REGION( 0x08000, "gfx1", 0 )
	ROM_LOAD( "7.c7",         0x00000, 0x8000, CRC(d13c22db) SHA1(38e992f2c5f425b20d20fec64d6ab979e72e0e3c) ) // chars

	ROM_REGION( 0x20000, "gfx2", 0 )
	ROM_LOAD( "4.a6",         0x00000, 0x8000, CRC(655f0a58) SHA1(8ffe73cec68d52c7b09651b546289613d6d4dde4) ) // tiles
	...
	ROM_REGION( 0x20000, "gfx3", 0 )
	ROM_LOAD( "12.a4",        0x00000, 0x8000, CRC(3cb41a2d) SHA1(7535bd5fa6b6ee71617e06ee690da29ccce7560e) ) // sprites
...
ROM_START( youma2 )
	...
	ROM_REGION( 0x4000, "nb1414m4", 0 )    // data for MCU/blitter?
	ROM_LOAD( "5.15d",        0x00000, 0x4000, CRC(1b4f64aa) SHA1(2cb2db946bf93e0928d6aa2e2dd29acb92981567) ) // text layer data x

	ROM_REGION( 0x0400, "proms", 0 )    // Region 3 - color data
	ROM_LOAD( "bpr.6e",       0x00000, 0x0100, CRC(8a62d4e4) SHA1(99ca4da01ea1b5585f6e3ebf162c3f988ab317e5) ) // red x
	ROM_LOAD( "bpr.7e",       0x00100, 0x0100, CRC(2ccf976f) SHA1(b804ee761793697087fbe3372352f301a22feeab) ) // green x
	ROM_LOAD( "bpr.8e",       0x00200, 0x0100, CRC(16b2a7a4) SHA1(53c410b439c8a835447f15f2ab250b363b3f7888) ) // blue x
...
GAME( 1986, ninjemat, ninjemak, galivan,  galivan,  galivan_state, empty_init,  ROT270, "Nichibutsu (Tecfri license)", "Ninja Emaki (Tecfri license)",                        MACHINE_SUPPORTS_SAVE|MACHINE_UNEMULATED_PROTECTION )
