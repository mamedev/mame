...
GAME(2003, term3_205,    term3,    whitestar,  whitestar, whitestar_state, empty_init, ROT0, "Stern", "Terminator 3: Rise of the Machines (CPU 2.05, display F2.01, France)",           MACHINE_IS_SKELETON_MECHANICAL | MACHINE_SUPPORTS_SAVE )
