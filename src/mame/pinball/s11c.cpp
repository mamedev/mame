...
GAME(1990,  dd_lu1,     dd_l2,      s11c,   s11c, s11c_state, init_s11c,  ROT0,   "Bally",                "Dr. Dude (LU-1) Europe",                       MACHINE_MECHANICAL | MACHINE_SUPPORTS_SAVE )
GAME(1990,  dd_p6,      dd_l2,      s11c,   s11c, s11c_state, init_s11c,  ROT0,   "Bally",                "Dr. Dude (PA-6)",                              MACHINE_MECHANICAL | MACHINE_SUPPORTS_SAVE )
GAME(1990,  pool_l7,    0,          s11c,   s11c, s11c_state, init_s11c,  ROT0,   "Bally",                "Pool Sharks (LA-7)",                           MACHINE_MECHANICAL | MACHINE_SUPPORTS_SAVE )
GAME(1990,  pool_l6,    pool_l7,    s11c,   s11c, s11c_state, init_s11c,  ROT0,   "Bally",                "Pool Sharks (LA-6)",                           MACHINE_MECHANICAL | MACHINE_SUPPORTS_SAVE )
GAME(1990,  pool_l5,    pool_l7,    s11c,   s11c, s11c_state, init_s11c,  ROT0,   "Bally",                "Pool Sharks (LA-5)",                           MACHINE_MECHANICAL | MACHINE_SUPPORTS_SAVE )
GAME(1990,  pool_le2,   pool_l7,    s11c,   s11c, s11c_state, init_s11c,  ROT0,   "Bally",                "Pool Sharks (LE-2)",                           MACHINE_MECHANICAL | MACHINE_SUPPORTS_SAVE )
GAME(1989,  pool_p7,    pool_l7,    s11c,   s11c, s11c_state, init_s11c,  ROT0,   "Bally",                "Pool Sharks (PA-7)",                           MACHINE_MECHANICAL | MACHINE_SUPPORTS_SAVE )
GAME(1990,  radcl_l1,   0,          s11c,   s11c, s11c_state, init_s11c,  ROT0,   "Bally",                "Radical! (L-1)",                               MACHINE_MECHANICAL | MACHINE_SUPPORTS_SAVE )
GAME(1990,  radcl_g1,   radcl_l1,   s11c,   s11c, s11c_state, init_s11c,  ROT0,   "Bally",                "Radical! (G-1)",                               MACHINE_MECHANICAL | MACHINE_SUPPORTS_SAVE )
...
GAME(1990,  rollr_l3,   rollr_l2,   s11c,   s11c, s11c_state, init_s11c,  ROT0,   "Williams",             "Rollergames (LU-3) Europe",                    MACHINE_MECHANICAL | MACHINE_SUPPORTS_SAVE )
GAME(1990,  rollr_g3,   rollr_l2,   s11c,   s11c, s11c_state, init_s11c,  ROT0,   "Williams",             "Rollergames (LG-3) Germany",                   MACHINE_MECHANICAL | MACHINE_SUPPORTS_SAVE )
