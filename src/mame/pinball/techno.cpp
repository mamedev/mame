...
void techno_state::techno(machine_config &config)
{
	...
	DAC_8BIT_R2R(config, m_dac).add_route(ALL_OUTPUTS, "rspeaker", 0.5); // DAC0808
	Y8950(config, "ym1", XTAL::u(3580000)).add_route(ALL_OUTPUTS, "lspeaker", 0.5); // TKY2016 - no crystal, just a random oscillator, sch says 3.58MHz
}
