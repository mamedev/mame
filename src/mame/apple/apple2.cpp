...
II Plus: RAM options reduced to 16/32/48 KB.
    ...
    CONTROL and SHIFT pressed togther as a shift lock and other CONTROL
    ...
    the F8 ROM also mask off any lowercase characters generated by the
    keyboard, which Apple's own keyboards did not do.  The a2lca2, a2plca2
    and apple2pe sets feature third-party lowercase character generator ROMs,
    and their BIOS options include miscellaneous homebrew modifications to
    the F8 ROMs that facilitate the input of lowercase characters (and
