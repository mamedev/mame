...
// complete(?) dump
GAME( 1997, mg_gbr,   0     ,  maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Guinness Book Of Records (Maygay M2, SW7-235 SW7-240)", MACHINE_IS_SKELETON )
GAME( 1998, mg_gbra,  mg_gbr,  maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Guinness Book Of Records (Maygay M2, SW8-146 SW7-360)", MACHINE_IS_SKELETON )
GAME( 1998, mg_gbrb,  mg_gbr,  maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Guinness Book Of Records (Maygay M2, SW8-147 SW7-361)", MACHINE_IS_SKELETON )
GAME( 1997, mg_risk,  0,       maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Risk (Maygay M2, SW7-614 SW7-461)", MACHINE_IS_SKELETON )
GAME( 1999, mg_riska, mg_risk, maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Risk (Maygay M2, SW9-025 SW9-023)", MACHINE_IS_SKELETON )
GAME( 1999, mg_riskb, mg_risk, maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Risk (Maygay M2, SW9-024 SW9-026)", MACHINE_IS_SKELETON )
GAME( 1996, mg_bb,    0,       maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Big Break (Maygay M2, SW6-618 SW6-601)", MACHINE_IS_SKELETON )
GAME( 1996, mg_bba,   mg_bb,   maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Big Break (Maygay M2, SW6-656 SW6-635)", MACHINE_IS_SKELETON )
GAME( 1996, mg_bbb,   mg_bb,   maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Big Break (Maygay M2, SW6-657 SW6-636)", MACHINE_IS_SKELETON )
GAME( 1998, mg_lug,   0,       maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "London Underground (Maygay M2, SW8-232 SW8-154)", MACHINE_IS_SKELETON )
GAME( 1998, mg_luga,  mg_lug,  maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "London Underground (Maygay M2, SW8-233 SW8-155)", MACHINE_IS_SKELETON )
GAME( 1997, mg_alad,  0,       maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Aladdin's Cave (Maygay M2, SW7-536 SW7-465)", MACHINE_IS_SKELETON )
GAME( 1998, mg_alada, mg_alad, maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Aladdin's Cave (Maygay M2, SW8-323 SW8-299)", MACHINE_IS_SKELETON )
GAME( 1998, mg_aladb, mg_alad, maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Aladdin's Cave (Maygay M2, SW8-322 SW8-298)", MACHINE_IS_SKELETON )
GAME( 1998, mg_aladc, mg_alad, maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Aladdin's Cave (Maygay M2, SW8-298 SW8-144)", MACHINE_IS_SKELETON )

// incomplete dumps
GAME( 1996, mg_ewg,   0,       maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Each Way Gambler (Maygay M2, SA6_127 SA6_113)", MACHINE_IS_SKELETON )
GAME( 1996, mg_ewga,  mg_ewg,  maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Each Way Gambler (Maygay M2, SA6_128 SA6_114)", MACHINE_IS_SKELETON )
GAME( 1996, mg_ewgb,  mg_ewg,  maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Each Way Gambler (Maygay M2, SA6_129 SA6_115)", MACHINE_IS_SKELETON )
GAME( 1996, mg_ewgc,  mg_ewg,  maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Each Way Gambler (Maygay M2, SA6_130 SA6_115)", MACHINE_IS_SKELETON )
GAME( 1996, mg_ewgd,  mg_ewg,  maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Each Way Gambler (Maygay M2, SA6_281 NONE)", MACHINE_IS_SKELETON )
GAME( 1996, mg_ewge,  mg_ewg,  maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Each Way Gambler (Maygay M2, SA6_282 NONE)", MACHINE_IS_SKELETON )
GAME( 1996, mg_ewgf,  mg_ewg,  maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Each Way Gambler (Maygay M2, SA6_283 NONE)", MACHINE_IS_SKELETON )
GAME( 1996, mg_ewgg,  mg_ewg,  maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Each Way Gambler (Maygay M2, SA6_284 NONE)", MACHINE_IS_SKELETON )
GAME( 199?, mg_jv,    0,       maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Jack & Vera (Maygay M2, set 1)", MACHINE_IS_SKELETON )
GAME( 199?, mg_jva,   mg_jv,   maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Jack & Vera (Maygay M2, set 2)", MACHINE_IS_SKELETON )
GAME( 199?, mg_jvb,   mg_jv,   maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Jack & Vera (Maygay M2, set 3)", MACHINE_IS_SKELETON )
GAME( 199?, mg_jvc,   mg_jv,   maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Jack & Vera (Maygay M2, set 4)", MACHINE_IS_SKELETON )
GAME( 1998, mg_pbw,   0,       maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Pinball Wizard (Maygay M2, SW8-098 SW8148)", MACHINE_IS_SKELETON )
GAME( 1998, mg_pbwa,  mg_pbw,  maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Pinball Wizard (Maygay M2, SW8-099 SW8149)", MACHINE_IS_SKELETON )
GAME( 1998, mg_pbwb,  mg_pbw,  maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Pinball Wizard (Maygay M2, SW8-098 SW8-096)", MACHINE_IS_SKELETON )
GAME( 1998, mg_scl,   0,       maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Super Clue (Maygay M2, SW8-152 SW8-130)", MACHINE_IS_SKELETON )
GAME( 1998, mg_scla,  mg_scl,  maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Super Clue (Maygay M2, SW8-153 SW8-131)", MACHINE_IS_SKELETON )
GAME( 199?, mg_kf,    0,       maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Krypton Factor (Maygay M2, set 1)", MACHINE_IS_SKELETON )
GAME( 199?, mg_kfa,   mg_kf,   maygayew, maygayew, maygayew_state, empty_init, ROT0, "Maygay", "Krypton Factor (Maygay M2, set 2)", MACHINE_IS_SKELETON )
