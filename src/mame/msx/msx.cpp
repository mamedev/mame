...
/* MSX1 */
COMP(1986, perfect1,   0,        0,     perfect1,   msx,      msx_state, empty_init, "Bawareth", "Perfect MSX1 (MSX1, Middle East)", 0)
COMP(1985, canonv8,    0,        0,     canonv8,    msxjp,    msx_state, empty_init, "Canon", "V-8 (MSX1, Japan)", 0)
COMP(1984, canonv10,   canonv20, 0,     canonv10,   msxjp,    msx_state, empty_init, "Canon", "V-10 (MSX1, Japan)", 0)
COMP(1984, canonv20,   0,        0,     canonv20,   msxjp,    msx_state, empty_init, "Canon", "V-20 (MSX1, Japan)", 0)
COMP(1985, canonv20e,  canonv20, 0,     canonv20e,  msxuk,    msx_state, empty_init, "Canon", "V-20E (MSX1, UK)", 0)
COMP(1985, canonv20f,  canonv20, 0,     canonv20e,  msxfr,    msx_state, empty_init, "Canon", "V-20F (MSX1, France)", 0)
COMP(198?, canonv20g,  canonv20, 0,     canonv20e,  msxde,    msx_state, empty_init, "Canon", "V-20G (MSX1, Germany)", 0)
COMP(198?, canonv20s,  canonv20, 0,     canonv20e,  msxsp,    msx_state, empty_init, "Canon", "V-20S (MSX1, Spain)", 0)
COMP(1985, mx10,       mx15,     0,     mx10,       msxjp,    msx_state, empty_init, "Casio", "MX-10 (MSX1, Japan)", 0)
COMP(1987, mx101,      mx15,     0,     mx101,      msxjp,    msx_state, empty_init, "Casio", "MX-101 (MSX1, Japan)", 0)
COMP(1986, mx15,       0,        0,     mx15,       msx,      msx_state, empty_init, "Casio", "MX-15 (MSX1, International)", 0)
COMP(1984, pv7,        pv16,     0,     pv7,        msxjp,    msx_state, empty_init, "Casio", "PV-7 (MSX1, Japan)", 0)
COMP(1985, pv16,       0,        0,     pv16,       msxjp,    msx_state, empty_init, "Casio", "PV-16 (MSX1, Japan)", 0)
COMP(1984, cpc88,      0,        0,     cpc88,      msxkr,    msx_state, empty_init, "Daewoo", "CPC-88 (MSX1, Korea)", 0)
COMP(1984, dpc100,     dpc200,   0,     dpc100,     msxkr,    msx_state, empty_init, "Daewoo", "IQ-1000 DPC-100 (MSX1, Korea)", 0)
COMP(1984, dpc180,     dpc200,   0,     dpc180,     msxkr,    msx_state, empty_init, "Daewoo", "IQ-1000 DPC-180 (MSX1, Korea)", 0)
COMP(1984, dpc200,     0,        0,     dpc200,     msxkr,    msx_state, empty_init, "Daewoo", "IQ-1000 DPC-200 (MSX1, Korea)", 0)
COMP(1985, dpc200e,    0,        0,     dpc200e,    msxfr,    msx_state, empty_init, "Daewoo", "DPC-200E (MSX1, French)", 0)
COMP(1986, cpc50a,     cpc51,    0,     cpc50a,     msxkr,    msx_state, empty_init, "Daewoo", "Zemmix CPC-50A (MSX1, Korea)", 0)
COMP(1987, cpc50b,     cpc51,    0,     cpc50b,     msxkr,    msx_state, empty_init, "Daewoo", "Zemmix CPC-50B (MSX1, Korea)", 0)
COMP(1988, cpc51,      0,        0,     cpc51,      msxkr,    msx_state, empty_init, "Daewoo", "Zemmix CPC-51 (MSX1, Korea)", 0)
COMP(1985, dgnmsx,     0,        0,     dgnmsx,     msxuk,    msx_state, empty_init, "Eurohard S.A.", "Dragon MSX-64 (MSX1, Spain)", 0)
COMP(1985, fdpc200,    0,        0,     fdpc200,    msx,      msx_state, empty_init, "Fenner", "DPC-200 (MSX1, Italy)", 0)
COMP(1985, fpc500,     0,        0,     fpc500,     msx,      msx_state, empty_init, "Fenner", "FPC-500 (MSX1, Italy)", 0)
COMP(1984, fspc800,    0,        0,     fspc800,    msxuk,    msx_state, empty_init, "Fenner", "SPC-800 (MSX1, Italy)", 0)
...
COMP(1983, fmx,        0,        0,     fmx,        msxjp,    msx_state, empty_init, "Fujitsu", "FM-X (MSX1, Japan)", 0)
COMP(1984, gsfc80u,    0,        0,     gsfc80u,    msxkr,    msx_state, empty_init, "Goldstar", "FC-80U (MSX1, Korea)", 0)
COMP(1984, gsfc200,    0,        0,     gsfc200,    msx,      msx_state, empty_init, "Goldstar", "FC-200 (MSX1, Europe)", 0)
COMP(1985, gfc1080,    0,        0,     gfc1080,    msxkr,    msx_state, empty_init, "Goldstar", "GFC-1080 (MSX1, Korea)", 0)
COMP(1985, gfc1080a,   0,        0,     gfc1080a,   msxkr,    msx_state, empty_init, "Goldstar", "GFC-1080A (MSX1, Korea)", 0)
COMP(1985, expert10,   expert13, 0,     expert10,   expert10, msx_state, empty_init, "Gradiente", "Expert XP-800 (1.0) (MSX1, Brazil)", 0)
COMP(198?, expert11,   expert13, 0,     expert11,   expert11, msx_state, empty_init, "Gradiente", "Expert XP-800 (1.1) / Expert GPC-1 (MSX1, Brazil)", 0)
COMP(198?, expert13,   0,        0,     expert13,   expert11, msx_state, empty_init, "Gradiente", "Expert 1.3 (MSX1, Brazil)", 0)
COMP(1989, expertdp,   0,        0,     expertdp,   expert11, msx_state, empty_init, "Gradiente", "Expert DDPlus (MSX1, Brazil)", 0)
COMP(1989, expertpl,   0,        0,     expertpl,   expert11, msx_state, empty_init, "Gradiente", "Expert Plus (MSX1, Brazil)", 0)
COMP(1983, mbh1,       0,        0,     mbh1,       msxjp,    msx_state, empty_init, "Hitachi", "MB-H1 (MSX1, Japan)", 0)
COMP(1984, mbh1e,      mbh1,     0,     mbh1e,      msxjp,    msx_state, empty_init, "Hitachi", "MB-H1E (MSX1, Japan)", 0)
COMP(1984, mbh2,       0,        0,     mbh2,       msxjp,    msx_state, empty_init, "Hitachi", "MB-H2 (MSX1, Japan)", 0)
COMP(1988, mbh25,      0,        0,     mbh25,      msxjp,    msx_state, empty_init, "Hitachi", "MB-H25 (MSX1, Japan)", 0)
COMP(1986, mbh50,      0,        0,     mbh50,      msxjp,    msx_state, empty_init, "Hitachi", "MB-H50 (MSX1, Japan)", 0)
COMP(1985, jvchc7gb,   0,        0,     jvchc7gb,   msxuk,    msx_state, empty_init, "JVC", "HC-7E / HC-7GB (MSX1, Europe)", 0)
COMP(1983, ml8000,     0,        0,     ml8000,     msxjp,    msx_state, empty_init, "Mitsubishi", "ML-8000 (MSX1, Japan)", 0)
COMP(1984, mlf48,      0,        0,     mlf48,      msxuk,    msx_state, empty_init, "Mitsubishi", "ML-F48 (MSX1, UK)", 0)
COMP(1984, mlf80,      0,        0,     mlf80,      msxuk,    msx_state, empty_init, "Mitsubishi", "ML-F80 (MSX1, UK)", 0)
COMP(1984, mlf110,     0,        0,     mlf110,     msxjp,    msx_state, empty_init, "Mitsubishi", "ML-F110 (MSX1, Japan)", 0)
COMP(1984, mlf120,     0,        0,     mlf120,     msxjp,    msx_state, empty_init, "Mitsubishi", "ML-F120 (MSX1, Japan)", 0)
COMP(1986, mlfx1,      0,        0,     mlfx1,      mlfx1,    msx_state, empty_init, "Mitsubishi", "ML-FX1 (MSX1, Spain)", 0)
COMP(1985, cf1200,     0,        0,     cf1200,     msxjp,    msx_state, empty_init, "National", "CF-1200 (MSX1, Japan)", 0)
COMP(1983, cf2000,     0,        0,     cf2000,     msxjp,    msx_state, empty_init, "National", "CF-2000 (MSX1, Japan)", 0)
COMP(1984, cf2700,     0,        0,     cf2700,     msxjp,    msx_state, empty_init, "National", "CF-2700 (MSX1, Japan)", 0)
COMP(1984, cf3000,     0,        0,     cf3000,     cf3000,   msx_state, empty_init, "National", "CF-3000 (MSX1, Japan)", 0)
COMP(1985, cf3300,     0,        0,     cf3300,     cf3000,   msx_state, empty_init, "National", "CF-3300 (MSX1, Japan)", 0)
COMP(1985, fs1300,     0,        0,     fs1300,     msxjp,    msx_state, empty_init, "National", "FS-1300 (MSX1, Japan)", 0)
COMP(1985, fs4000,     0,        0,     fs4000,     fs4000,   msx_state, empty_init, "National", "FS-4000 (MSX1, Japan)", 0)
COMP(1985, fs4000a,    fs4000,   0,     fs4000a,    fs4000,   msx_state, empty_init, "National", "FS-4000 (alt) (MSX1, Japan)", 0)
COMP(1985, phc2,       0,        0,     phc2,       msxfr,    msx_state, empty_init, "Olympia", "PHC-2 (MSX1, France)" , 0)
COMP(1984, phc28,      0,        0,     phc28,      msxfr,    msx_state, empty_init, "Olympia", "PHC-28 (MSX1, France)", 0)
COMP(1985, cf2700g,    cf2700uk, 0,     cf2700g,    msxde,    msx_state, empty_init, "Panasonic", "CF-2700 (MSX1, Germany)", 0)
COMP(1985, cf2700uk,   0,        0,     cf2700uk,   msxuk,    msx_state, empty_init, "Panasonic", "CF-2700 (MSX1, UK)", 0)
COMP(1989, nms801,     0,        0,     nms801,     msx,      msx_state, empty_init, "Philips", "NMS-801 (MSX1, Italy)", 0)
COMP(1984, vg8000,     vg8010,   0,     vg8000,     vg8010,   msx_state, empty_init, "Philips", "VG-8000 (MSX1, Europe)", 0)
COMP(1985, vg8010,     0,        0,     vg8010,     vg8010,   msx_state, empty_init, "Philips", "VG-8010 / VG-8010/00 (MSX1, Europe)", 0)
COMP(1985, vg8010f,    vg8010,   0,     vg8010f,    vg8010f,  msx_state, empty_init, "Philips", "VG-8010F / VG-8010/19 (MSX1, French)" , 0)
COMP(1985, vg802000,   vg802020, 0,     vg802000,   msx,      msx_state, empty_init, "Philips", "VG-8020/00 (MSX1, Europe)", 0)
COMP(1985, vg8020f,    vg802020, 0,     vg8020f,    msxfr,    msx_state, empty_init, "Philips", "VG-8020/19 / VG-8020F (MSX1, French)", 0)
COMP(1985, vg802020,   0,        0,     vg802020,   msx,      msx_state, empty_init, "Philips", "VG-8020/20 (MSX1, Europe)", 0)
COMP(1984, piopx7,     0,        0,     piopx7,     msxjp,    msx_state, empty_init, "Pioneer", "PX-07 Palcom (MSX1, Japan)", 0)
COMP(1985, piopx7uk,   piopx7,   0,     piopx7uk,   msxuk,    msx_state, empty_init, "Pioneer", "PX-07UK Palcom (MSX1, UK)", 0)
...
COMP(1985, mpc64,      0,        0,     mpc64,      msxde,    msx_state, empty_init, "Sanyo", "MPC-64 (MSX1, Germany)", 0)
COMP(1985, mpc100,     0,        0,     mpc100,     msxuk,    msx_state, empty_init, "Sanyo", "MPC-100 (MSX1, UK)", 0)
COMP(1985, mpc200,     0,        0,     mpc200,     msxuk,    msx_state, empty_init, "Sanyo", "MPC-200 (MSX1, UK)", 0) // Is this the same as MPC-200SP, is it even real ?
COMP(1985, mpc200sp,   mpc200,   0,     mpc200sp,   msxsp,    msx_state, empty_init, "Sanyo", "MPC-200SP (MSX1, Spain)", 0)
COMP(1985, phc28l,     0,        0,     phc28l,     msxfr,    msx_state, empty_init, "Sanyo", "PHC-28L (MSX1, France)", 0)
COMP(1984, phc28s,     0,        0,     phc28s,     msxuk,    msx_state, empty_init, "Sanyo", "PHC-28S (MSX1, France)", 0)
COMP(1985, hb8000,     0,        0,     hb8000,     hotbit,   msx_state, empty_init, "Sharp / Epcom", "HB-8000 Hotbit (MSX1, Brazil)", 0)
COMP(198?, hotbi13b,   hotbi13p, 0,     hotbi13b,   hotbit,   msx_state, empty_init, "Sharp / Epcom", "HB-8000 Hotbit 1.3b (MSX1, Brazil)", 0)
COMP(198?, hotbi13p,   0,        0,     hotbi13p,   hotbit,   msx_state, empty_init, "Sharp / Epcom", "HB-8000 Hotbit 1.3p (MSX1, Brazil)", 0)
COMP(1985, hb10,       hb10p,    0,     hb10,       msxjp,    msx_state, empty_init, "Sony", "HB-10 (MSX1, Japan)", 0)
COMP(1986, hb10p,      0,        0,     hb10p,      msxuk,    msx_state, empty_init, "Sony", "HB-10P (MSX1, Netherlands)", 0)
COMP(1984, hb101,      hb101p,   0,     hb101,      msxjp,    msx_state, empty_init, "Sony", "HB-101 (MSX1, Japan)", 0)
COMP(1984, hb101p,     0,        0,     hb101p,     msxuk,    msx_state, empty_init, "Sony", "HB-101P (MSX1, Europe)", 0)
COMP(1986, hb20p,      0,        0,     hb20p,      msxsp,    msx_state, empty_init, "Sony", "HB-20P (MSX1, Spain)", 0)
COMP(1985, hb201,      hb201p,   0,     hb201,      msxjp,    msx_state, empty_init, "Sony", "HB-201 (MSX1, Japan)", 0)
COMP(1985, hb201p,     0,        0,     hb201p,     msxuk,    msx_state, empty_init, "Sony", "HB-201P (MSX1, Europe)", 0)
COMP(1984, hb501p,     0,        0,     hb501p,     msxuk,    msx_state, empty_init, "Sony", "HB-501P (MSX1, Europe)", 0)
COMP(1983, hb55,       hb55p,    0,     hb55,       msxjp,    msx_state, empty_init, "Sony", "HB-55 (MSX1, Japan)", 0)
COMP(1984, hb55d,      hb55p,    0,     hb55d,      msxde,    msx_state, empty_init, "Sony", "HB-55D (MSX1, Germany)", 0)
COMP(1984, hb55p,      0,        0,     hb55p,      msxuk,    msx_state, empty_init, "Sony", "HB-55P (MSX1, Europe)", 0)
COMP(1984, hb701fd,    0,        0,     hb701fd,    msxjp,    msx_state, empty_init, "Sony", "HB-701FD (MSX1, Japan)", 0)
COMP(1984, hb75,       hb75p,    0,     hb75,       msxjp,    msx_state, empty_init, "Sony", "HB-75 (MSX1, Japan)", 0)
COMP(1984, hb75d,      hb75p,    0,     hb75d,      msxde,    msx_state, empty_init, "Sony", "HB-75D (MSX1, Germany)", 0)
...
COMP(1984, hx10e,      hx10,     0,     hx10e,      msx,      msx_state, empty_init, "Toshiba", "HX-10E (MSX1, Spain)", 0)
COMP(1984, hx10f,      hx10,     0,     hx10f,      msx,      msx_state, empty_init, "Toshiba", "HX-10F (MSX1, France)", 0)
COMP(1983, hx10s,      hx10,     0,     hx10s,      msxjp,    msx_state, empty_init, "Toshiba", "HX-10S (MSX1, Japan)", 0)
COMP(1984, hx10sa,     hx10,     0,     hx10sa,     msxjp,    msx_state, empty_init, "Toshiba", "HX-10SA (MSX1, Japan)", 0)
COMP(1984, hx20,       0,        0,     hx20,       msxjp,    msx_state, empty_init, "Toshiba", "HX-20 (MSX1, Japan)", 0)
COMP(1985, hx20e,      hx20,     0,     hx20e,      msx,      msx_state, empty_init, "Toshiba", "HX-20E (MSX1, Spain)", 0)
COMP(1985, hx20i,      hx20,     0,     hx20i,      msx,      msx_state, empty_init, "Toshiba", "HX-20I (MSX1, Italy)", 0)
COMP(1984, hx21,       0,        0,     hx21,       msxjp,    msx_state, empty_init, "Toshiba", "HX-21 (MSX1, Japan)", 0)
COMP(1985, hx21f,      hx21,     0,     hx21f,      msx,      msx_state, empty_init, "Toshiba", "HX-21F (MSX1, France)", 0)
COMP(1984, hx22,       0,        0,     hx22,       msxjp,    msx_state, empty_init, "Toshiba", "HX-22 (MSX1, Japan)", 0)
COMP(1985, hx22i,      hx22,     0,     hx22i,      msx,      msx_state, empty_init, "Toshiba", "HX-22I (MSX1, Italy)", 0)
COMP(1985, hx32,       0,        0,     hx32,       msxjp,    msx_state, empty_init, "Toshiba", "HX-32 (MSX1, Japan)", 0)
COMP(1985, hx51i,      0,        0,     hx51i,      msx,      msx_state, empty_init, "Toshiba", "HX-51I (MSX1, Italy, Spain)", 0)
COMP(1983, hc5,        hc7,      0,     hc5,        msxjp,    msx_state, empty_init, "Victor", "HC-5 (MSX1, Japan)", 0)
COMP(1984, hc6,        hc7,      0,     hc6,        msxjp,    msx_state, empty_init, "Victor", "HC-6 (MSX1, Japan)", 0)
COMP(1985, hc7,        0,        0,     hc7,        msxjp,    msx_state, empty_init, "Victor", "HC-7 (MSX1, Japan)", 0)
