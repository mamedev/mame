...
protected:
	void msx1_v9938(ay8910_type ay8910_type, machine_config &config, region_type region, const internal_layout &layout);
	void msx1_v9938_pal(ay8910_type ay8910_type, machine_config &config, region_type region, const internal_layout &layout);
	void svi738_base(machine_config &config, region_type region, const internal_layout &layout);
...
void msx1_v9938_state::msx1_v9938(ay8910_type ay8910_type, machine_config &config, region_type region, const internal_layout &layout)
{
...
void msx1_v9938_state::msx1_v9938_pal(ay8910_type ay8910_type, machine_config &config, region_type region, const internal_layout &layout)
{
	msx1_v9938(ay8910_type, config, region, layout);
...
void msx1_v9938_state::ax200(machine_config &config)
{
	...
	msx1_v9938_pal(SND_YM2149, config, REGION_ARAB, layout_msx_ar);
}
...
void msx1_v9938_state::svi738_base(machine_config &config, region_type region, const internal_layout &layout)
{
	...
	msx1_v9938_pal(SND_AY8910, config, region, layout);
}
...
void msx1_v9938_state::svi738(machine_config &config)
{
	...
	svi738_base(config, REGION_INTERNATIONAL, layout_msx_nocode);
}
...
{
	svi738_base(config, REGION_ARAB, layout_msx_ar);
...
void msx1_v9938_state::tadpc200a(machine_config &config)
{
	...
	msx1_v9938_pal(SND_YM2149, config, REGION_INTERNATIONAL, layout_msx_nocode);
}
...
void msx1_v9938_state::yis503ii(machine_config &config)
{
	...
	msx1_v9938(SND_YM2149, config, REGION_INTERNATIONAL, layout_msx_nocode);
}
...
void msx1_v9938_state::y503iir(machine_config &config)
{
	...
	msx1_v9938_pal(SND_YM2149, config, REGION_RUSSIA, layout_msx_ru);
	SOFTWARE_LIST(config, "minicart_list").set_original("msx_yamaha_minicart");
}
