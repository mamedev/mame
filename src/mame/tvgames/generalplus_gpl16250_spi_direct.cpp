...
CONS( 201?, dsgnpal, 0, 0, generalplus_gpspi_direct, bfmpac, generalplus_gpspi_direct_game_state, empty_init,  "Tomy", "Kiratto Puri Chan Pretty Chan Design Palette (Japan)", MACHINE_NO_SOUND | MACHINE_NOT_WORKING)
