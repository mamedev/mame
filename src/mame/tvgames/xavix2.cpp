...
CONS( 2006, ban_naru,  0, 0, config, naruto, naruto_state, empty_init, "Bandai / SSD Company Limited",    "Let's! TV Play Naruto Ninja Taikan: Dattebayo! (Japan)", MACHINE_NOT_WORKING | MACHINE_IMPERFECT_GRAPHICS | MACHINE_IMPERFECT_SOUND )

// Let's!TVプレイ 影発動体感! ブルードラゴン -極めろ!ファイヤークライシス!-
CONS( 2006, ban_bldj,  0, 0, config, naruto, naruto_state, empty_init, "Bandai / SSD Company Limited",    "Let's! TV Play Kage Hatsudou Taikan! Blue Dragon: Kiwamero! Fire Crisis! (Japan)", MACHINE_NOT_WORKING | MACHINE_IMPERFECT_GRAPHICS | MACHINE_IMPERFECT_SOUND )

// Let's!TVプレイ　ドラゴンボールＺ　バトル体感かめはめ波
CONS( 2005, ban_dbz,   0, 0, config, naruto, naruto_state, empty_init, "Bandai / SSD Company Limited",    "Let's! TV Play Dragon Ball Z: Battle Taikan Kamehameha (Japan)", MACHINE_NOT_WORKING | MACHINE_IMPERFECT_GRAPHICS | MACHINE_IMPERFECT_SOUND )
...
CONS( 2006, epo_dtcj,  0, 0, config, dabj,   xavix2_state, empty_init, "Epoch / SSD Company Limited",     "Doraemon Taikan Take-copter! Sora Tobu Daibouken (Japan)", MACHINE_NOT_WORKING | MACHINE_IMPERFECT_GRAPHICS | MACHINE_IMPERFECT_SOUND )

// SASUKE サスケ＆筋肉バトル!!スポーツマンNO.1決定戦
CONS( 2006, epo_sskj,  0, 0, config, dabj,   xavix2_state, empty_init, "Epoch / SSD Company Limited",     "Sasuke & Kinniku Battle!! Sportsman No. 1 Ketteisen (Japan)", MACHINE_NOT_WORKING | MACHINE_IMPERFECT_GRAPHICS | MACHINE_IMPERFECT_SOUND )

// 究極! 筋肉(マッスル)スタジアム! サスケ完全制覇
CONS( 2008, epo_ssk2,  0, 0, config, dabj,   xavix2_state, empty_init, "Epoch / SSD Company Limited",     "Kyuukyoku! Muscle Stadium! Sasuke Kanzen Seiha (Japan)", MACHINE_NOT_WORKING | MACHINE_IMPERFECT_GRAPHICS | MACHINE_IMPERFECT_SOUND )

CONS( 2007, epo_pabj,  0, 0, config, dabj,   xavix2_state, empty_init, "Epoch / SSD Company Limited",     "TV de Asobou! Manabou! Pooh-san to Issho: ABC AIUEO Zukan (Japan)", MACHINE_NOT_WORKING | MACHINE_IMPERFECT_GRAPHICS | MACHINE_IMPERFECT_SOUND )
...
CONS( 2008, domfitad,  0, 0, config, domyos, domyos_state, empty_init, "Decathlon / SSD Company Limited", "Domyos Fitness Adventure (Domyos Interactive System)", MACHINE_NOT_WORKING | MACHINE_IMPERFECT_GRAPHICS | MACHINE_IMPERFECT_SOUND )
CONS( 2008, dombikec,  0, 0, config, domyos, domyos_state, empty_init, "Decathlon / SSD Company Limited", "Domyos Bike Concept (Domyos Interactive System)", MACHINE_NOT_WORKING | MACHINE_IMPERFECT_GRAPHICS | MACHINE_IMPERFECT_SOUND )
