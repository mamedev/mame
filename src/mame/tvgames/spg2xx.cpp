...
ROM_START( anpannou )
	ROM_REGION( 0x800000, "maincpu", ROMREGION_ERASE00 )
	ROM_LOAD16_WORD_SWAP( "k8d6316utm-pi07.u4", 0x000000, 0x800000, CRC(e8059e91) SHA1(f6da1401a098709516af0d2e86c2f1da2f677f09) )
ROM_END
...
// Radica TV games
CONS( 2006, rad_skat,  0,         0,      rad_skat,   rad_skat,   spg2xx_game_state,               init_crc,      "Radica / FarSight Studios", "Play TV Skateboarder (NTSC)", MACHINE_IMPERFECT_SOUND | MACHINE_IMPERFECT_GRAPHICS )
CONS( 2006, rad_skatp, rad_skat,  0,      rad_skatp,  rad_skatp,  spg2xx_game_state,               init_crc,      "Radica / FarSight Studios", "Connectv Skateboarder (PAL)", MACHINE_IMPERFECT_SOUND | MACHINE_IMPERFECT_GRAPHICS )

CONS( 2006, rad_crik,  0,         0,      rad_crik,   rad_crik,   spg2xx_game_state,               init_crc,      "Radica / Hi-Score Entertainment Software Engineering", "Connectv Cricket (PAL)", MACHINE_IMPERFECT_SOUND | MACHINE_NOT_WORKING ) // Version 3.00 20/03/06 is listed in INTERNAL TEST

CONS( 2007, rad_fb2,   0,         0,      rad_skat,   rad_fb2,    spg2xx_game_state,               init_crc,      "Radica / FarSight Studios", "Play TV Football 2", MACHINE_IMPERFECT_SOUND | MACHINE_NOT_WORKING ) // offers a 2 player option in menus, but seems to have only been programmed for, and released as, a single player unit, P2 controls appear unfinished.
