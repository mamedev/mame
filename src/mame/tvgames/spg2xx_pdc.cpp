...
ROM_START( vjpp3 )
	ROM_REGION( 0x800000, "maincpu", ROMREGION_ERASE00 )
	ROM_LOAD16_WORD_SWAP( "plugplaytvgames3.u2", 0x000000, 0x400000, CRC(f664d3f4) SHA1(59279e54e5d9ac2f956241e78dffe526b5de14fd) )
ROM_END

ROM_START( vjpp4 )
	ROM_REGION( 0x800000, "maincpu", ROMREGION_ERASE00 )
	ROM_LOAD16_WORD_SWAP( "plugplaytvgames4.u2", 0x000000, 0x200000, CRC(2272f1f4) SHA1(0ffb606d4ac93da27a671b369800ea71e68452f3) )
ROM_END
