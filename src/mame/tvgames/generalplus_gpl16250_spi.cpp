...
CONS(201?, vmastspi, 0, 0, generalplus_gpspispi,         gcm394, generalplus_gpspispi_game_state,         init_spi, "Takara Tomy", "Virtual Masters Spirits (Japan)", MACHINE_NOT_WORKING | MACHINE_IMPERFECT_SOUND)
