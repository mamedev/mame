...
static INPUT_PORTS_START( att6300p )
	...
	PORT_DIPNAME( 0x01, 0x01, "Drive B Type")
	PORT_DIPSETTING(    0x01, "96 TPI" )
	PORT_DIPSETTING(    0x00, "48 TPI" )
	PORT_DIPNAME( 0x02, 0x02, "Drive A Type")
	PORT_DIPSETTING(    0x02, "96 TPI" )
	PORT_DIPSETTING(    0x00, "48 TPI" )
	PORT_DIPNAME( 0x04, 0x04, "Hard Disk 1 Type")
	PORT_DIPSETTING(    0x00, "0" )
	PORT_DIPSETTING(    0x04, "1" )
	PORT_DIPNAME( 0x08, 0x08, "Hard Disk 0 Type")
	PORT_DIPSETTING(    0x00, "0" )
	PORT_DIPSETTING(    0x08, "1" )
	PORT_DIPNAME( 0x30, 0x20, "Display Type")
