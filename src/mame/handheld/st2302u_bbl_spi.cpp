...
void bbl380_state::bbl380_map(address_map &map)
{
	...
	map(0x1800000, 0x1800000).w(m_lcdc, FUNC(st7735s_lcdc_device::lcdc_command_w));
	map(0x1804000, 0x1804000).rw(m_lcdc, FUNC(st7735s_lcdc_device::lcdc_data_r), FUNC(st7735s_lcdc_device::lcdc_data_w));
}
