...
void genpc_state::pcmda(machine_config &config)
{
	...
	I8088(config, m_maincpu, 4'772'720);
	...
	ISA8_SLOT(config, "isa1", 4'772'720, "mb:isa", pc_isa8_cards, "mda", false);
	ISA8_SLOT(config, "isa2", 4'772'720, "mb:isa", pc_isa8_cards, "com", false);
	ISA8_SLOT(config, "isa3", 4'772'720, "mb:isa", pc_isa8_cards, "fdc_xt", false);
	ISA8_SLOT(config, "isa4", 4'772'720, "mb:isa", pc_isa8_cards, "hdc", false);
	ISA8_SLOT(config, "isa5", 4'772'720, "mb:isa", pc_isa8_cards, "adlib", false);
	ISA8_SLOT(config, "isa6", 4'772'720, "mb:isa", pc_isa8_cards, nullptr, false);
