...
void iskr103x_state::iskr1030m(machine_config &config)
{
	...
	I8086(config, m_maincpu, 4'772'720);
	...
	ISA8_SLOT(config, "isa1", 4'772'720, "mb:isa", iskr103x_isa8_cards, "cga_iskr1030m", false);
	ISA8_SLOT(config, "isa2", 4'772'720, "mb:isa", iskr103x_isa8_cards, "fdc_xt", false);
	ISA8_SLOT(config, "isa3", 4'772'720, "mb:isa", iskr103x_isa8_cards, nullptr, false);
	ISA8_SLOT(config, "isa4", 4'772'720, "mb:isa", iskr103x_isa8_cards, nullptr, false);
	ISA8_SLOT(config, "isa5", 4'772'720, "mb:isa", iskr103x_isa8_cards, nullptr, false);
	ISA8_SLOT(config, "isa6", 4'772'720, "mb:isa", iskr103x_isa8_cards, nullptr, false);
