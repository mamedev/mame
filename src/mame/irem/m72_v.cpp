...
void m82_state::video_start()
{
	...
	// The layout remains 256x64, the right half is just not displayed.
	...
	m_bg_tilemap_large->set_transmask(3,0x0001,0xfffe);
...
void m82_state::majtitle_draw_sprites(screen_device &screen, bitmap_ind16 &bitmap, const rectangle &cliprect)
{
...
u32 m82_state::screen_update_m82(screen_device &screen, bitmap_ind16 &bitmap, const rectangle &cliprect)
{
	...
	tilemap_t *tm = (m_m82_tmcontrol & 0x40) ? m_bg_tilemap_large : m_bg_tilemap;
	...
	majtitle_draw_sprites(screen, bitmap, cliprect);
	draw_sprites(screen, bitmap, cliprect);
