...
//  config.set_maximum_quantum(attotime::from_hz(6000));
	...
	AY8910(config, "ay1", XTAL::u(1500000)).add_route(ALL_OUTPUTS, "lspeaker", 0.25).add_route(ALL_OUTPUTS, "rspeaker", 0.25);

	AY8910(config, "ay2", XTAL::u(1500000)).add_route(ALL_OUTPUTS, "lspeaker", 0.25).add_route(ALL_OUTPUTS, "rspeaker", 0.25);
}
