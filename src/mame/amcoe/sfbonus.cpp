...
Notes:
- Some games require an operator password to prevent players from changing the settings
...
public:
	sfbonus_state(const machine_config &mconfig, device_type type, const char *tag) :
		...
		m_tilemap_ram(*this, "tilemap_ram", 0x4000U, ENDIANNESS_LITTLE),
		m_reel_ram(*this, "reel_ram%u", 0U, 0x800U, ENDIANNESS_LITTLE),
		m_videoram(*this, "videoram", 0x10000U, ENDIANNESS_LITTLE),
		m_mainbank(*this, "mainbank"),
		m_lamps(*this, "lamp%u", 0U)
	{ }

	void sfbonus(machine_config &config) ATTR_COLD;

	void init_hldspin2d() ATTR_COLD;
	void init_fb5v() ATTR_COLD;
	void init_suprball() ATTR_COLD;
	void init_ch2000v2() ATTR_COLD;
	void init_classiced3() ATTR_COLD;
	void init_fb6v3() ATTR_COLD;
	void init_fb4d() ATTR_COLD;
	void init_dblchal() ATTR_COLD;
	void init_tighookv2() ATTR_COLD;
	void init_funriverv() ATTR_COLD;
	void init_pir2002() ATTR_COLD;
	void init_moneymacd() ATTR_COLD;
	void init_classice() ATTR_COLD;
	void init_fb6() ATTR_COLD;
	void init_classicev3() ATTR_COLD;
	void init_fb4() ATTR_COLD;
	void init_pir2001() ATTR_COLD;
	void init_version4() ATTR_COLD;
	void init_pir2002v() ATTR_COLD;
	void init_act2000v2() ATTR_COLD;
	void init_fb6s() ATTR_COLD;
	void init_abnudge() ATTR_COLD;
	void init_fb2genv3() ATTR_COLD;
	void init_robadv2d() ATTR_COLD;
	void init_pir2002d() ATTR_COLD;
	void init_bugfeverv() ATTR_COLD;
	void init_anithunt() ATTR_COLD;
	void init_fb2genv() ATTR_COLD;
	void init_bugfeverv2() ATTR_COLD;
	void init_tighookd() ATTR_COLD;
	void init_fb6v() ATTR_COLD;
	void init_pir2002v2() ATTR_COLD;
	void init_sfruitbv() ATTR_COLD;
	void init_sfbonus() ATTR_COLD;
	void init_pirpok2v2() ATTR_COLD;
	void init_parrot3v2() ATTR_COLD;
	void init_fb4v3() ATTR_COLD;
	void init_common() ATTR_COLD;
	void init_seawld() ATTR_COLD;
	void init_moneymacv() ATTR_COLD;
	void init_fb3g() ATTR_COLD;
	void init_act2000() ATTR_COLD;
	void init_robadv2v1() ATTR_COLD;
	void init_moneymac() ATTR_COLD;
	void init_pickwinv() ATTR_COLD;
	void init_version4v() ATTR_COLD;
	void init_pir2001v2() ATTR_COLD;
	void init_spooky() ATTR_COLD;
	void init_pickwinv2() ATTR_COLD;
	void init_pickwin() ATTR_COLD;
	void init_act2000v() ATTR_COLD;
	void init_fb6d() ATTR_COLD;
	void init_fb5d() ATTR_COLD;
	void init_seawldv() ATTR_COLD;
	void init_anibonusv() ATTR_COLD;
	void init_getrich() ATTR_COLD;
	void init_anibonus() ATTR_COLD;
	void init_atworld() ATTR_COLD;
	void init_anibonusd() ATTR_COLD;
	void init_fb2gen() ATTR_COLD;
	void init_atworldd() ATTR_COLD;
	void init_fb2gend() ATTR_COLD;
	void init_sfruitbd() ATTR_COLD;
	void init_anithuntv() ATTR_COLD;
	void init_version4d2() ATTR_COLD;
	void init_classiced() ATTR_COLD;
	void init_fb5() ATTR_COLD;
	void init_fruitcar2() ATTR_COLD;
	void init_fruitcar3() ATTR_COLD;
	void init_sfbonusd() ATTR_COLD;
	void init_dblchald() ATTR_COLD;
	void init_pirpok2() ATTR_COLD;
	void init_anithuntd() ATTR_COLD;
	void init_fb2ndv() ATTR_COLD;
	void init_ch2000v() ATTR_COLD;
	void init_funriver() ATTR_COLD;
	void init_pickwind() ATTR_COLD;
	void init_fruitcar() ATTR_COLD;
	void init_hldspin1() ATTR_COLD;
	void init_sfruitb() ATTR_COLD;
	void init_hldspin1v() ATTR_COLD;
	void init_sfbonusv() ATTR_COLD;
	void init_dblchalv() ATTR_COLD;
	void init_act2000d() ATTR_COLD;
	void init_sfruitbv2() ATTR_COLD;
	void init_robadv2v4() ATTR_COLD;
	void init_anibonus3() ATTR_COLD;
	void init_fb2ndd() ATTR_COLD;
	void init_classicev() ATTR_COLD;
	void init_hldspin1d() ATTR_COLD;
	void init_fb4v() ATTR_COLD;
	void init_abnudgev() ATTR_COLD;
	void init_bugfeverd() ATTR_COLD;
	void init_dvisland() ATTR_COLD;
	void init_fb2nd() ATTR_COLD;
	void init_version4v2() ATTR_COLD;
	void init_ch2000() ATTR_COLD;
	void init_ch2000d() ATTR_COLD;
	void init_abnudged() ATTR_COLD;
	void init_anibonusv3() ATTR_COLD;
	void init_fbdeluxe() ATTR_COLD;
	void init_bugfever() ATTR_COLD;
	void init_parrot3v() ATTR_COLD;
	void init_pir2001v() ATTR_COLD;
	void init_tighook() ATTR_COLD;
	void init_hldspin2() ATTR_COLD;
	void init_hldspin2v() ATTR_COLD;
	void init_pirpok2v() ATTR_COLD;
	void init_parrot3d() ATTR_COLD;
	void init_pir2001d() ATTR_COLD;
	void init_tighookv() ATTR_COLD;
	void init_robadv() ATTR_COLD;
	void init_pirpok2d() ATTR_COLD;
	void init_mcircus() ATTR_COLD;
...
private:
	...
	memory_share_creator<uint8_t> m_tilemap_ram;
	memory_share_array_creator<uint8_t, 4> m_reel_ram;
...
static INPUT_PORTS_START( newer1_reels3 )
	...
	PORT_DIPSETTING(    0x00, "Master Reset" )  // Resets setting and ALL data
...
{
	int const code = m_tilemap_ram[(tile_index * 2) + 0] | (m_tilemap_ram[(tile_index * 2) + 1] << 8);
	int const flipx = (m_tilemap_ram[(tile_index * 2) + 1] & 0x80) >> 7;
	int const flipy = (m_tilemap_ram[(tile_index * 2) + 1] & 0x40) >> 5;

	tileinfo.set(0, code, 0, TILE_FLIPYX(flipx | flipy));
}

template<uint8_t Reel>
TILE_GET_INFO_MEMBER(sfbonus_state::get_reel_tile_info)
{
	int const code = m_reel_ram[Reel][(tile_index * 2) + 0] | (m_reel_ram[Reel][(tile_index * 2) + 1] << 8);
	int const flipx = (m_reel_ram[Reel][(tile_index * 2) + 1] & 0x80) >> 7;
	int const flipy = 0; //(m_reel_ram[Reel][(tile_index * 2) + 1] & 0x40) >> 5;

	int const priority = (m_reel_ram[Reel][(tile_index * 2) + 1] & 0x40) >> 6;

	tileinfo.set(1, code, priority, TILE_FLIPYX(flipx | flipy)); // colour abused as priority
}
...
void sfbonus_state::draw_reel_layer(screen_device &screen, bitmap_ind16 &bitmap, const rectangle &cliprect, int category)
{
	...
	uint8_t const *const selectbase = &m_videoram[0x600];
	uint8_t const *const bg_scroll = &m_videoram[0x000];
	uint8_t const *const reels_rowscroll = &m_videoram[0x400];
	...
	{
		int scroll = bg_scroll[(i * 2) + 0x000] | (bg_scroll[(i * 2) + 0x001] << 8);
...
//  printf("------------\n");
	for (int zz = 0; zz < 288; zz++)
	{
		...
		int const rowenable2 = (selectbase[line] & 0xc) >> 2;
		int xxxscroll;
		int rowscroll;
...
uint32_t sfbonus_state::screen_update(screen_device &screen, bitmap_ind16 &bitmap, const rectangle &cliprect)
{
	...
	uint8_t const *const front_rowscroll = &m_videoram[0x200];
	...
	for (int i = 0; i < 64; i++)
	{
		int const scroll = front_rowscroll[(i * 2) + 0x000] | (front_rowscroll[(i * 2) + 0x001] << 8);
...
void sfbonus_state::sfbonus_io(address_map &map)
{
	...
	map(0x1800, 0x1807).w(FUNC(sfbonus_state::_1800_w)).share(m_1800_regs); // lamps and coin counters

	map(0x2400, 0x241f).ram().share(m_vregs);

	map(0x2800, 0x2800).r(FUNC(sfbonus_state::_2800_r));
	map(0x2801, 0x2801).r(FUNC(sfbonus_state::_2801_r)).w(FUNC(sfbonus_state::_2801_w)).share(m_2801_regs);

	map(0x2c00, 0x2c00).r(FUNC(sfbonus_state::_2c00_r));
	map(0x2c01, 0x2c01).r(FUNC(sfbonus_state::_2c01_r)).w(FUNC(sfbonus_state::_2c01_w)).share(m_2c01_regs);

	map(0x3000, 0x3000).w(FUNC(sfbonus_state::_3000_w)).share(m_3000_regs);
	map(0x3400, 0x3400).w(FUNC(sfbonus_state::bank_w));
	map(0x3800, 0x3800).r(FUNC(sfbonus_state::_3800_r));

	map(0x3800, 0x3807).w(FUNC(sfbonus_state::_3800_w)).share(m_3800_regs);
}
...
static GFXDECODE_START( gfx_sfbonus )
	...
	GFXDECODE_ENTRY( "gfx2", 0, gfx_8x32x8_raw, 0x0, 2 )
GFXDECODE_END
...
{
	Z80(config, m_maincpu, 6'000'000); // custom packaged z80 CPU ?? Mhz
	...
	OKIM6295(config, "oki", 1'000'000, okim6295_device::PIN7_HIGH).add_route(ALL_OUTPUTS, "mono", 1.00); // clock frequency & pin 7 not verified
}
...
ROM_START( fb2gencq ) // PCB VCG-1
	...
	ROM_REGION( 0x1000, "nvram", ROMREGION_ERASE00 ) // default settings
	ROM_LOAD( "fb2g18q.id", 0x00, 0x20, CRC(f7755da4) SHA1(98a490e0801d0dde65ae06771f07da1f24e8f8d5) )
ROM_END
...
// shows 1.6 in bookkeeping but saves 1.6R in NVRAM
ROM_START( fb2ndo1 )
	ROM_REGION( 0x80000, "maincpu", 0 ) // Z80 code
	ROM_LOAD( "fb2e16r.bin", 0x00000, 0x40000, CRC(00c79759) SHA1(fb2978e4ba8ed1dfa2c9edeb1b5b23a04078e18e) )
	...
	ROM_REGION( 0x1000, "nvram", ROMREGION_ERASE00 ) // default settings
	ROM_LOAD( "fb2e16r.id", 0x00, 0x20, CRC(e4eaab6e) SHA1(fb010d7492b10ebd568fff4a715c98aee63fe136) )
ROM_END
...
ROM_START( ch2000o4 )  // PCB S2000-B
	...
	ROM_REGION( 0x040000, "oki", ROMREGION_ERASE00 ) // Samples
	ROM_LOAD( "fbrom2.u18", 0x00000, 0x40000, CRC(3b0f5374) SHA1(7e7b185b62d1a321e2853b4b08e8ee2aa54933f5) )

	ROM_REGION( 0x100000, "gfx1", 0 )
	ROM_LOAD16_BYTE( "fbrom3.u25", 0x00000, 0x40000, CRC(fba18126) SHA1(d4b8ce0cf2a73696828c3d649ceb6b73a80825e5) )
	ROM_LOAD16_BYTE( "fbrom4.u24", 0x00001, 0x40000, CRC(3e8926ca) SHA1(0486b1390f9e5dadd4ba946a10e8a47bfd9041e6) )

	ROM_REGION( 0x100000, "gfx2", 0 )
	ROM_LOAD16_BYTE( "fbrom5.u23", 0x00000, 0x40000, CRC(d21d171a) SHA1(7c7a3c46879220a174a038f634518d60f3959047) )
	ROM_LOAD16_BYTE( "fbrom6.u22", 0x00001, 0x40000, CRC(a9efbd48) SHA1(008d6628c1a1af3b50cb69c8800f8f35ed310dd3) )
ROM_END

ROM_START( ch2000o5 )
	ROM_REGION( 0x80000, "maincpu", 0 ) // Z80 code
	ROM_LOAD( "fc2k31.bin", 0x00000, 0x40000, CRC(3944aabe) SHA1(5d31ab50ea6ffc83e6aa13140a23cb5bc2f04ba4) )
...
ROM_START( ch2000o6 )
	ROM_REGION( 0x80000, "maincpu", 0 ) // Z80 code
	ROM_LOAD( "fc2k33.bin", 0x00000, 0x40000, CRC(b07877fe) SHA1(c520c67ed5f10c22feb8c73e2ae12e1645a9490d) )
...
ROM_START( ch2000o7 )
	ROM_REGION( 0x80000, "maincpu", 0 ) // Z80 code
	ROM_LOAD( "fc2k36.bin", 0x00000, 0x40000, CRC(4247b2f9) SHA1(fc4c568c5be6a05445b0809d4ade0903b7ca57dc) )
...
ROM_START( ch2000o9 )
	ROM_REGION( 0x80000, "maincpu", 0 ) // Z80 code
	ROM_LOAD( "fc2k23b.bin", 0x00000, 0x20000, CRC(9c4b44b7) SHA1(6ed0b9983517fa67091731827d4c9713439dd083) )

	ROM_REGION( 0x040000, "oki", ROMREGION_ERASE00 ) // Samples
	ROM_LOAD( "fbrom2.bin", 0x00000, 0x40000, CRC(3b0f5374) SHA1(7e7b185b62d1a321e2853b4b08e8ee2aa54933f5) )

	ROM_REGION( 0x100000, "gfx1", 0 )
	ROM_LOAD16_BYTE( "fbrom3.bin", 0x00000, 0x80000, CRC(4045640f) SHA1(5ac5da23c434cefbae46dfd25ee74c1baac27926) )
	ROM_LOAD16_BYTE( "fbrom4.bin", 0x00001, 0x80000, CRC(1147b772) SHA1(cd57119d0dca7d1a1d4e7e49e279abe6c6073a37) )
...
ROM_START( ch2000o10 )
	ROM_REGION( 0x80000, "maincpu", 0 ) // Z80 code
	ROM_LOAD( "fc2k23xt.bin", 0x00000, 0x20000, CRC(4067463b) SHA1(2c16fbe6f064b0bcf133e14988fc5795fd54110a) )
...
ROM_START( classice )
	...
	ROM_LOAD( "fcsrom2.bin", 0x00000, 0x80000, CRC(fd5fb152) SHA1(3cb15d6439ade7d6e8ae73895b40e5dc1abea8d0) ) // A29040BV, 1xxxxxxxxxxxxxxxxxx = 0xFF
...
ROM_START( classiceo )
	ROM_REGION( 0x80000, "maincpu", 0 ) // Z80 code
	ROM_LOAD( "fcsd14r.bin", 0x00000, 0x80000, CRC(f017f389) SHA1(66b1988f21de4faa1dde9dd8fcef96d333497708) )
	...
	ROM_REGION( 0x1000, "nvram", ROMREGION_ERASE00 ) // default settings
	ROM_LOAD( "fcs14r.id", 0x00, 0x20,  CRC(9da3fcbf) SHA1(541d63dbe539718727eb8cb637bc02f824f0c264) )
ROM_END
...
ROM_START( moneymaco )
	ROM_REGION( 0x80000, "maincpu", 0 ) // Z80 code
	ROM_LOAD( "mmd13r.bin", 0x00000, 0x40000, CRC(e1d12d5b) SHA1(b11ee6f8e58a8b20b2e3fabf9524921a9298fb0e) )
	...
	ROM_REGION( 0x1000, "nvram", ROMREGION_ERASE00 ) // default settings
	ROM_LOAD( "mmd13r.id", 0x00, 0x20,  CRC(e986acfe) SHA1(916914db025a258eccc8e47468e6c70abe071625) )
ROM_END
...
{
	memset(m_tilemap_ram.target(), 0xff, m_tilemap_ram.bytes());

	for (uint8_t i = 0; i < 4; i++)
		memset(m_reel_ram[i].target(), 0xff, m_reel_ram[i].bytes());

	memset(m_videoram.target(), 0xff, m_videoram.bytes());
}
...
void sfbonus_state::init_anibonus()         { sfbonus_bitswap( 0x33, 0,3,7,6,5,2,1,4, 0xe7, 2,7,6,5,3,4,1,0, 0x3a, 4,2,3,7,6,5,1,0, 0xa8, 3,4,2,0,1,7,6,5, 0x3d, 2,3,7,6,5,1,0,4, 0xff, 3,7,6,5,1,0,2,4, 0x3a, 4,2,3,7,6,5,1,0, 0xbe, 3,4,1,0,2,7,6,5); }
void sfbonus_state::init_anibonus3()        { sfbonus_bitswap( 0x33, 0,3,7,6,5,2,1,4, 0xff, 3,7,6,5,1,0,4,2, 0x36, 4,2,3,7,6,5,1,0, 0xa8, 3,2,4,0,1,7,6,5, 0x2c, 0,1,7,6,5,2,4,3, 0xff, 3,7,6,5,1,0,4,2, 0x26, 2,4,3,7,6,5,1,0, 0xbe, 4,1,3,0,2,7,6,5); }
void sfbonus_state::init_anibonusd()        { sfbonus_bitswap( 0x3b, 0,1,7,6,5,4,3,2, 0xef, 0,7,6,5,4,3,2,1, 0x21, 0,2,1,7,6,5,4,3, 0xa8, 4,3,0,1,2,7,6,5, 0x3d, 2,1,7,6,5,4,3,0, 0xed, 2,7,6,5,4,3,1,0, 0x21, 0,2,1,7,6,5,4,3, 0xaa, 4,3,1,2,0,7,6,5); }
void sfbonus_state::init_anibonusv()        { sfbonus_bitswap( 0x39, 1,2,7,6,5,4,3,0, 0xef, 2,7,6,5,4,3,0,1, 0
7,6,5,4,3, 0xac, 4,3,0,1,2,7,6,5); }
void sfbonus_state::init_pirpok2()          { sfbonus_bitswap( 0x26, 1,2,7,6,5,4,3,0, 0xf6, 1,7,6,5,4,3,0,2, 0x29, 4,0,1,7,6,5,2,3, 0xad, 0,3,1,2,4,7,6,5, 0x2e, 1,3,7,6,5,2,0,4, 0xe0, 3,7,6,5,2,0,4,1, 0x39, 4,1,2,7,6,5,0,3, 0xb2, 2,0,4,1,3,7,6,5); }
void sfbonus_state::init_pirpok2d()         { sfbonus_bitswap( 0x3c, 0,1,7,6,5,4,3,2, 0xed, 0,7,6,5,4,3,2,1, 0x21, 1,0,2,7,6,5,4,3, 0xa9, 4,3,0,1,2,7,6,5, 0x38, 0,2,7,6,5,4,3,1, 0xed, 1,7,6,5,4,3,0,2, 0x21, 1,0,2,7,6,5,4,3, 0xae, 4,3,1,2,0,7,6,5); }
void sfbonus_state::init_pirpok2v()         { sfbonus_bitswap( 0x3c, 1,0,7,6,5,4,3,2, 0xef, 0,7,6,5,4,3,2,1, 0x23, 2,0,1,7,6,5,4,3, 0xa8, 4,3,1,2,0,7,6,5, 0x3e, 2,1,7,6,5,4,3,0, 0xea, 2,7,6,5,4,3,1,0, 0x22, 0,1,2,7,6,5,4,3, 0xa9, 4,3,2,1,0,7,6,5); }
void sfbonus_state::init_pirpok2v2()        { sfbonus_bitswap( 0x3c, 1,0,7,6,5,4,3,2, 0xef, 0,7,6,5,4,3,2,1, 0x22, 2,0,1,7,6,5,4,3, 0xa8, 4,3,1,2,0,7,6,5, 0x3a, 2,1,7,6,5,4,3,0, 0xea, 2,7,6,5,4,3,1,0, 0x22, 0,1,2,7,6,5,4,3, 0xa9, 4,3,2,1,0,7,6,5); }
void sfbonus_state::init_robadv()           { sfbonus_bitswap( 0x31, 0,3,7,6,5,2,1,4, 0xe0, 1,7,6,5,3,2,4,0, 0x2f, 4,0,2,7,6,5,3,1, 0xa7, 1,0,3,4,2,7,6,5, 0x33, 1,3,7,6,5,2,0,4, 0xed, 2,7,6,5,1,4,3,0, 0x34, 4,1,3,7,6,5,2,0, 0xaf, 2,0,4,1,3,7,6,5); }
void sfbonus_state::init_robadv2d()         { sfbonus_bitswap( 0x3c, 0,1,7,6,5,4,3,2, 0xe8, 0,7,6,5,4,3,1,2, 0x24, 2,1,0,7,6,5,4,3, 0xae, 4,3,1,0,2,7,6,5, 0x3e, 1,0,7,6,5,4,3,2, 0xed, 1,7,6,5,4,3,0,2, 0x24, 2,1,0,7,6,5,4,3, 0xa9, 4,3,0,1,2,7,6,5); }
void sfbonus_state::init_robadv2v1()        { sfbonus_bitswap( 0x39, 1,2,7,6,5,4,3,0, 0xef, 2,7,6,5,4,3,0,1, 0x21, 2,1,0,7,6,5,4,3, 0xa8, 4,3,1,2,0,7,6,5, 0x3a, 0,1,7,6,5,4,3,2, 0xe9, 1,7,6,5,4,3,0,2, 0x21, 1,0,2,7,6,5,4,3, 0xac, 4,3,0,1,2,7,6,5); }
void sfbonus_state::init_robadv2v4()        { sfbonus_bitswap( 0x39, 1,2,7,6,5,4,3,0, 0xef, 2,7,6,5,4,3,0,1, 0x23, 2,1,0,7,6,5,4,3, 0xa8, 4,3,1,2,0,7,6,5, 0x3b, 0,1,7,6,5,4,3,2, 0xe9, 1,7,6,5,4,3,0,2, 0x21, 1,0,2,7,6,5,4,3, 0xac, 4,3,0,1,2,7,6,5); }
void sfbonus_state::init_seawld()           { sfbonus_bitswap( 0x3c, 1,2,7,6,5,4,3,0, 0xea, 2,7,6,5,4,3,0,1, 0x24, 0,2,1,7,6,5,4,3, 0xa8, 4,3,1,2,0,7,6,5, 0x3b, 1,0,7,6,5,4,3,2, 0xec, 1,7,6,5,4,3,2,0, 0x23, 1,0,2,7,6,5,4,3, 0xa9, 4,3,0,1,2,7,6,5); }
void sfbonus_state::init_seawldv()          { sfbonus_bitswap( 0x39, 1,2,7,6,5,4,3,0, 0xef, 2,7,6,5,4,3,0,1, 0x22, 0,2,1,7,6,5,4,3, 0xa8, 4,3,1,2,0,7,6,5, 0x3a, 0,1,7,6,5,4,3,2, 0xea, 2,7,6,5,4,3,1,0, 0x22, 2,1,0,7,6,5,4,3, 0xac, 4,3,0,1,2,7,6,5); }
void sfbonus_state::init_sfbonus()          { sfbonus_bitswap( 0x2a, 1,3,7,6,5,2,0,4, 0xe4, 3,7,6,5,2,0,4,1, 0x2d, 4,1,3,7,6,5,2,0, 0xba, 4,3,0,2,1,7,6,5, 0x30, 2,1,7,6,5,0,3,4, 0xf1, 2,7,6,5,1,3,4,0, 0x3d, 2,1,4,7,6,5,3,0, 0xba, 4,3,0,1,2,7,6,5); }
void sfbonus_state::init_sfbonusd()         { sfbonus_bitswap( 0x3b, 0,1,7,6,5,4,3,2, 0xef, 1,7,6,5,4,3,0,2, 0x24, 2,1,0,7,6,5,4,3, 0xad, 4,3,0,1,2,7,6,5, 0x3e, 1,0,7,6,5,4,3,2, 0xeb, 2,7,6,5,4,3,1,0, 0x24, 2,1,0,7,6,5,4,3, 0xaa, 4,3,1,2,0,7,6,5); }
void sfbonus_state::init_sfbonusv()         { sfbonus_bitswap( 0x3c, 1,2,7,6,5,4,3,0, 0xea, 2,7,6,5,4,3,0,1, 0x25, 2,1,0,7,6,5,4,3, 0xa8, 4,3,1,2,0,7,6,5, 0x3b, 0,1,7,6,5,4,3,2, 0xee, 1,7,6,5,4,3,0,2, 0x23, 1,0,2,7,6,5,4,3, 0xa9, 4,3,0,1,2,7,6,5); }
void sfbonus_state::init_sfruitb()          { sfbonus_bitswap( 0x3e, 2,1,7,6,5,4,3,0, 0xfd, 1,7,6,5,0,3,2,4, 0x37, 4,1,3,7,6,5,2,0, 0xac, 2,0,4,1,3,7,6,5, 0x35, 2,3,7,6,5,1,0,4, 0xf6, 3,7,6,5,2,0,1,4, 0x37, 4,1,3,7,6,5,2,0, 0xb9, 0,3,4,1,2,7,6,5); }
void sfbonus_state::init_sfruitbd()         { sfbonus_bitswap( 0x3e, 1,0,7,6,5,4,3,2, 0xed, 1,7,6,5,4,3,0,2, 0x25, 2,0,1,7,6,5,4,3, 0xa9, 4,3,0,1,2,7,6,5, 0x3c, 0,1,7,6,5,4,3,2, 0xed, 2,7,6,5,4,3,1,0, 0x25, 2,0,1,7,6,5,4,3, 0xae, 4,3,1,2,0,7,6,5); }
void sfbonus_state::init_sfruitbv()         { sfbonus_bitswap( 0x39, 1,2,7,6,5,4,3,0, 0xef, 2,7,6,5,4,3,0,1, 0x25, 2,1,0,7,6,5,4,3, 0xa8, 4,3,1,2,0,7,6,5, 0x3b, 0,1,7,6,5,4,3,2, 0xec, 1,7,6,5,4,3,0,2, 0x21, 1,0,2,7,6,5,4,3, 0xac, 4,3,0,1,2,7,6,5); }
void sfbonus_state::init_sfruitbv2()        { sfbonus_bitswap( 0x39, 1,2,7,6,5,4,3,0, 0xef, 2,7,6,5,4,3,0,1, 0x25, 2,1,0,7,6,5,4,3, 0xa8, 4,3,1,2,0,7,6,5, 0x3b, 0,1,7,6,5,4,3,2, 0xee, 1,7,6,5,4,3,0,2, 0x25, 1,0,2,7,6,5,4,3, 0xac, 4,3,0,1,2,7,6,5); }
void sfbonus_state::init_suprball()         { sfbonus_bitswap( 0x39, 1,2,7,6,5,4,3,0, 0xe7, 4,7,6,5,0,3,1,2, 0x33, 0,2,1,7,6,5,4,3, 0xb3, 0,3,4,2,1,7,6,5, 0x2a, 1,3,7,6,5,2,0,4, 0xe4, 3,7,6,5,2,0,4,1, 0x2d, 4,1,3,7,6,5,2,0, 0xb6, 0,3,2,1,4,7,6,5); }
void sfbonus_state::init_tighook()          { sfbonus_bitswap( 0x33, 0,1,7,6,5,2,3,4, 0xf3, 3,7,6,5,1,0,4,2, 0x2e, 4,0,2,7,6,5,3,1, 0xa7, 1,0,4,2,3,7,6,5, 0x2d, 1,2,7,6,5,3,4,0, 0xff, 2,7,6,5,1,0,3,4, 0x27, 1,0,2,7,6,5,3,4, 0xa7, 1,0,4,2,3,7,6,5); }
void sfbonus_state::init_tighookd()         { sfbonus_bitswap( 0x3d, 0,1,7,6,5,4,3,2, 0xed, 1,7,6,5,4,3,0,2, 0x26, 2,1,0,7,6,5,4,3, 0xa9, 4,3,0,1,2,7,6,5, 0x3c, 1,0,7,6,5,4,3,2, 0xed, 2,7,6,5,4,3,1,0, 0x26, 2,1,0,7,6,5,4,3, 0xae, 4,3,1,2,0,7,6,5); }
void sfbonus_state::init_tighookv()         { sfbonus_bitswap( 0x39, 1,2,7,6,5,4,3,0, 0xef, 2,7,6,5,4,3,0,1, 0x26, 0,2,1,7,6,5,4,3, 0xa8, 4,3,1,2,0,7,6,5, 0x3b, 0,1,7,6,5,4,3,2, 0xec, 0,7,6,5,4,3,2,1, 0x21, 1,0,2,7,6,5,4,3, 0xac, 4,3,0,1,2,7,6,5); }
void sfbonus_state::init_tighookv2()        { sfbonus_bitswap( 0x39, 1,2,7,6,5,4,3,0, 0xef, 2,7,6,5,4,3,0,1, 0x23, 0,2,1,7,6,5,4,3, 0xa8, 4,3,1,2,0,7,6,5, 0x3b, 0,1,7,6,5,4,3,2, 0xea, 0,7,6,5,4,3,2,1, 0x21, 1,0,2,7,6,5,4,3, 0xac, 4,3,0,1,2,7,6,5); }
void sfbonus_state::init_bugfever()         { sfbonus_bitswap( 0x3c, 1,2,7,6,5,4,3,0, 0xea, 2,7,6,5,4,3,0,1, 0x22, 2,1,0,7,6,5,4,3, 0xa8, 4,3,1,2,0,7,6,5, 0x3b, 0,1,7,6,5,4,3,2, 0xe9, 1,7,6,5,4,3,0,2, 0x23, 1,0,2,7,6,5,4,3, 0xa9, 4,3,0,1,2,7,6,5); }
void sfbonus_state::init_bugfeverd()        { sfbonus_bitswap( 0x39, 1,2,7,6,5,4,3,0, 0xef, 2,7,6,5,4,3,0,1, 0x26, 1,0,2,7,6,5,4,3, 0xa8, 4,3,1,2,0,7,6,5, 0x3a, 0,1,7,6,5,4,3,2, 0xe8, 1,7,6,5,4,3,0,2, 0x22, 2,1,0,7,6,5,4,3, 0xac, 4,3,0,1,2,7,6,5); }
void sfbonus_state::init_bugfeverv()        { sfbonus_bitswap( 0x3c, 1,0,7,6,5,4,3,2, 0xef, 0,7,6,5,4,3,2,1, 0x22, 0,2,1,7,6,5,4,3, 0xa8, 4,3,1,2,0,7,6,5, 0x3a, 0,1,7,6,5,4,3,2, 0xea, 2,7,6,5,4,3,1,0, 0x22, 0,1,2,7,6,5,4,3, 0xa9, 4,3,2,1,0,7,6,5); }
void sfbonus_state::init_bugfeverv2()       { sfbonus_bitswap( 0x3c, 1,2,7,6,5,4,3,0, 0xea, 2,7,6,5,4,3,0,1, 0x23, 0,2,1,7,6,5,4,3, 0xa8, 4,3,1,2,0,7,6,5, 0x3b, 0,1,7,6,5,4,3,2, 0xed, 2,7,6,5,4,3,1,0, 0x26, 2,1,0,7,6,5,4,3, 0xa9, 4,3,0,1,2,7,6,5); }
void sfbonus_state::init_version4()         { sfbonus_bitswap( 0x39, 1,2,7,6,5,4,3,0, 0xef, 2,7,6,5,4,3,0,1, 0x26, 1,0,2,7,6,5,4,3, 0xa8, 4,3,1,2,0,7,6,5, 0x3b, 0,1,7,6,5,4,3,2, 0xec, 1,7,6,5,4,3,0,2, 0x22, 2,1,0,7,6,5,4,3, 0xac, 4,3,0,1,2,7,6,5); }
void sfbonus_state::init_version4v2()       { sfbonus_bitswap( 0x3c, 1,0,7,6,5,4,3,2, 0xef, 0,7,6,5,4,3,2,1, 0x26, 0,2,1,7,6,5,4,3, 0xa8, 4,3,1,2,0,7,6,5, 0x3b, 0,1,7,6,5,4,3,2, 0xea, 2,7,6,5,4,3,1,0, 0x22, 0,1,2,7,6,5,4,3, 0xa9, 4,3,2,1,0,7,6,5); }
void sfbonus_state::init_version4d2()       { sfbonus_bitswap( 0x39, 1,2,7,6,5,4,3,0, 0xef, 2,7,6,5,4,3,0,1, 0x25, 1,0,2,7,6,5,4,3, 0xa8, 4,3,1,2,0,7,6,5, 0x3b, 0,1,7,6,5,4,3,2, 0xe9, 1,7,6,5,4,3,0,2, 0x22, 2,1,0,7,6,5,4,3, 0xac, 4,3,0,1,2,7,6,5); }
void sfbonus_state::init_version4v()        { sfbonus_bitswap( 0x3c, 1,2,7,6,5,4,3,0, 0xea, 2,7,6,5,4,3,0,1, 0x26, 2,0,1,7,6,5,4,3, 0xa8, 4,3,1,2,0,7,6,5, 0x3b, 1,0,7,6,5,4,3,2, 0xee, 1,7,6,5,4,3,0,2, 0x23, 1,0,2,7,6,5,4,3, 0xa9, 4,3,0,1,2,7,6,5); }
void sfbonus_state::init_dvisland()         { sfbonus_bitswap( 0x39, 1,2,7,6,5,4,3,0, 0xef, 2,7,6,5,4,3,0,1, 0x21, 1,0,2,7,6,5,4,3, 0xa8, 4,3,1,2,0,7,6,5, 0x3b, 0,1,7,6,5,4,3,2, 0xe9, 1,7,6,5,4,3,0,2, 0x23, 2,1,0,7,6,5,4,3, 0xac, 4,3,0,1,2,7,6,5); }
void sfbonus_state::init_funriver()         { sfbonus_bitswap( 0x3c, 1,2,7,6,5,4,3,0, 0xea, 2,7,6,5,4,3,0,1, 0x24, 0,2,1,7,6,5,4,3, 0xa8, 4,3,1,2,0,7,6,5, 0x3b, 0,1,7,6,5,4,3,2, 0xec, 0,7,6,5,4,3,2,1, 0x23, 1,0,2,7,6,5,4,3, 0xa9, 4,3,0,1,2,7,6,5); }
void sfbonus_state::init_funriverv()        { sfbonus_bitswap( 0x39, 1,2,7,6,5,4,3,0, 0xef, 2,7,6,5,4,3,0,1, 0x26, 0,2,1,7,6,5,4,3, 0xa8, 4,3,1,2,0,7,6,5, 0x3b, 0,1,7,6,5,4,3,2, 0xea, 2,7,6,5,4,3,1,0, 0x22, 2,1,0,7,6,5,4,3, 0xac, 4,3,0,1,2,7,6,5); }
void sfbonus_state::init_spooky()           { sfbonus_bitswap( 0x39, 1,2,7,6,5,4,3,0, 0xef, 2,7,6,5,4,3,0,1, 0x21, 1,0,2,7,6,5,4,3, 0xa8, 4,3,1,2,0,7,6,5, 0x39, 1,0,7,6,5,4,3,2, 0xe8, 1,7,6,5,4,3,2,0, 0x23, 0,2,1,7,6,5,4,3, 0xac, 4,3,0,1,2,7,6,5); }
...
GAME( 2004, fb2gencq,    fb2gen,   sfbonus, amcoe1_reels3, sfbonus_state, init_fb2gend,         ROT0,  "Amcoe", "Fruit Bonus 2nd Generation (Version 1.8Q)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2004, fb2ndo1,     fb2nd,    sfbonus, amcoe1_reels3, sfbonus_state, init_fb2ndd,          ROT0,  "Amcoe", "Fruit Bonus 2nd Edition (Version 1.6R)", MACHINE_SUPPORTS_SAVE )
...
GAME( 1999, act2000vx,   act2000,  sfbonus, amcoe1_reels3, sfbonus_state, init_act2000v,        ROT0,  "Amcoe", "Action 2000 (Version 3.30XT Dual)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2000, ch2000c1,    ch2000,   sfbonus, amcoe1_reels3, sfbonus_state, init_ch2000,          ROT0,  "Amcoe", "Fruit Bonus 2000 / New Cherry 2000 (Version 4.4R, set 2)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2000, ch2000c2,    ch2000,   sfbonus, amcoe1_reels3, sfbonus_state, init_ch2000,          ROT0,  "Amcoe", "Fruit Bonus 2000 / New Cherry 2000 (Version 4.1LT, set 2)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2000, ch2000v2,    ch2000,   sfbonus, amcoe1_reels3, sfbonus_state, init_ch2000v,         ROT0,  "Amcoe", "Fruit Bonus 2000 / New Cherry 2000 (Version 4.1LT Dual)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2000, ch2000o4,    ch2000,   sfbonus, amcoe2_reels3, sfbonus_state, init_ch2000,          ROT0,  "Amcoe", "Fruit Bonus 2000 / New Cherry 2000 (Version 2.6 Special)", MACHINE_SUPPORTS_SAVE )
GAME( 2000, ch2000o5,    ch2000,   sfbonus, amcoe2_reels3, sfbonus_state, init_ch2000,          ROT0,  "Amcoe", "Fruit Bonus 2000 / New Cherry 2000 (Version 3.1 Special)", MACHINE_SUPPORTS_SAVE )
GAME( 2000, ch2000o6,    ch2000,   sfbonus, amcoe2_reels3, sfbonus_state, init_ch2000,          ROT0,  "Amcoe", "Fruit Bonus 2000 / New Cherry 2000 (Version 3.3 Special)", MACHINE_SUPPORTS_SAVE )
GAME( 2000, ch2000o7,    ch2000,   sfbonus, amcoe2_reels3, sfbonus_state, init_ch2000,          ROT0,  "Amcoe", "Fruit Bonus 2000 / New Cherry 2000 (Version 3.4 Special, set 1)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2004, classiceo,   classice, sfbonus, amcoe1_reels3, sfbonus_state, init_classice,        ROT0,  "Amcoe", "Classic Edition (Version 1.4R)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2005, moneymaco,   moneymac, sfbonus, amcoe1_reels3, sfbonus_state, init_moneymacd,       ROT0,  "Amcoe", "Money Machine (Version 1.3R)", MACHINE_SUPPORTS_SAVE )
