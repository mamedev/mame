...
GAME( 2003?, csesame2, 0, sesame2, sesame2, sesame2_state, empty_init, ROT270, "Taito", "Capriccio Sesame 2", MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_NO_SOUND ) // between F19 (hkuranai) and F34 (invqix)
