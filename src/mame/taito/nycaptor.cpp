...
void nycaptor_state::nycaptor(machine_config &config)
{
	...
	Z80(config, m_maincpu, XTAL(10'733'000)/2); /* assuming same as in FLSTORY */
	...
	Z80(config, m_subcpu, XTAL(10'733'000)/2); /* assuming same as in unpopulated sub CPU on FLSTORY PCB */
	...
	m_audiocpu->set_periodic_int(FUNC(nycaptor_state::irq0_line_hold), attotime::from_hz(122));  /* IRQ generated by discrete logic */
