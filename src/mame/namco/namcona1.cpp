...
ROM_START( emeraldajb ) // NA-1 Game PCB, parent is NA-2 version listed below
	ROM_REGION( 0x200000, "maincpu", 0 )
...
ROM_START( emeralda ) // NA-2 Game PCB
	ROM_REGION( 0x200000, "maincpu", 0 )
...
ROM_START( emeraldajd ) // NA-2 Game PCB, other Japanese clones are NA-1 based; see above
	ROM_REGION( 0x200000, "maincpu", 0 )
	ROM_LOAD16_BYTE( "em1-ep0ld.6c", 0x000001, 0x080000, CRC(988eb1cb) SHA1(08f92c8c47e48cded5dd28792575d52e2323ddb4) ) // 0xc00000
	ROM_LOAD16_BYTE( "em1-ep0ud.6f", 0x000000, 0x080000, CRC(6a169b8c) SHA1(f418fa51d8580173c223fdc320f11670ad918ee2) )
	ROM_LOAD16_BYTE( "em1-ep1l.7c",  0x100001, 0x080000, CRC(373c1c59) SHA1(385cb3bc056b798878de890dbff97a8bdd48fe4e) ) // same data as NA-1 sets
	ROM_LOAD16_BYTE( "em1-ep1u.7f",  0x100000, 0x080000, CRC(4e969152) SHA1(2c89ae5d43585f479f16cf8278f8fc001e077e45) ) // same data as NA-1 sets
...
GAME( 1993, emeraldajb, emeralda, namcona1, namcona1_joy,  namcona1_state, init_emeraldj, ROT0, "Namco", "Emeraldia (Japan Version B)", MACHINE_SUPPORTS_SAVE | MACHINE_NO_COCKTAIL ) // Parent is below on NA-2 Hardware
GAME( 1993, emeraldaj,  emeralda, namcona1, namcona1_joy,  namcona1_state, init_emeraldj, ROT0, "Namco", "Emeraldia (Japan)", MACHINE_SUPPORTS_SAVE | MACHINE_NO_COCKTAIL ) // Parent is below on NA-2 Hardware
...
GAME( 1993, emeraldajd, emeralda, namcona2, namcona1_joy,  namcona2_state,       init_emeralda, ROT0, "Namco", "Emeraldia (Japan Version D)", MACHINE_SUPPORTS_SAVE | MACHINE_NO_COCKTAIL )
