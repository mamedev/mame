...
namco_c116_device::namco_c116_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock)
...
uint8_t namco_c116_device::read(offs_t offset)
{
	uint8_t *RAM;
...
void namco_c116_device::write(offs_t offset, uint8_t data)
{
	uint8_t *RAM;
