...
{
public:
	namco_c69_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock);
protected:
...
{
public:
	namco_c70_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock);
protected:
	virtual const tiny_rom_entry *device_rom_region() const override;
};
...
{
public:
	namco_c74_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock);
protected:
	virtual const tiny_rom_entry *device_rom_region() const override;
};
...
{
public:
	namco_c75_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock);
protected:
	virtual const tiny_rom_entry *device_rom_region() const override;
};
...
{
public:
	namco_c76_device(const machine_config &mconfig, const char *tag, device_t *owner, const XTAL &clock);
protected:
	virtual const tiny_rom_entry *device_rom_region() const override;
};
