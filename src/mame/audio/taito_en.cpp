...
MACHINE_CONFIG_START(taito_en_device::device_add_mconfig)
	...
	MCFG_SOUND_ROUTE_EX(0, "pump", 0.08, 0)
	MCFG_SOUND_ROUTE_EX(1, "pump", 0.08, 1)
	MCFG_SOUND_ROUTE_EX(2, "pump", 0.08, 2)
	MCFG_SOUND_ROUTE_EX(3, "pump", 0.08, 3)
	MCFG_SOUND_ROUTE_EX(4, "pump", 0.08, 4)
	MCFG_SOUND_ROUTE_EX(5, "pump", 0.08, 5)
	MCFG_SOUND_ROUTE_EX(6, "pump", 0.08, 6)
	MCFG_SOUND_ROUTE_EX(7, "pump", 0.08, 7)
MACHINE_CONFIG_END
