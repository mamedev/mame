...
NETLIST_START(segausb)
	...
	ANALOG_INPUT(I_U41_HP0, 0.1)
	ANALOG_INPUT(I_U41_HP1, 0.1)
	ANALOG_INPUT(I_U41_HP2_ON, 0.1)
	ANALOG_INPUT(I_U41_HP2_OFF, 0.1)

	ANALOG_INPUT(I_U42_HP0, 0.1)
	ANALOG_INPUT(I_U42_HP1, 0.1)
	ANALOG_INPUT(I_U42_HP2_ON, 0.1)
	ANALOG_INPUT(I_U42_HP2_OFF, 0.1)

	ANALOG_INPUT(I_U43_HP0, 0.1)
	ANALOG_INPUT(I_U43_HP1, 0.1)
	ANALOG_INPUT(I_U43_HP2_ON, 0.1)
	ANALOG_INPUT(I_U43_HP2_OFF, 0.1)
#else
...
#if (SEGAUSB_FAKE_8253)
	VARCLOCK(U42_OUT0, 1, "max(0.000001,min(0.1,A0))")
	NET_C(U42_OUT0.GND, GND)
	NET_C(U42_OUT0.VCC, I_V5)
	NET_C(U42_OUT0.A0, I_U42_HP0)
	NET_C(U42_OUT0.Q, C14.1)
#else
...
#if (SEGAUSB_FAKE_8253)
	VARCLOCK(U42_OUT1, 1, "max(0.000001,min(0.1,A0))")
	NET_C(U42_OUT1.GND, GND)
	NET_C(U42_OUT1.VCC, I_V5)
	NET_C(U42_OUT1.A0, I_U42_HP1)
	NET_C(U42_OUT1.Q, C15.1)
#else
...
#if (SEGAUSB_FAKE_8253)
	VARCLOCK(U42_OUT2, 2, "max(0.000001,min(0.1,if(Q>0.5,A1,A0)))")
	NET_C(U42_OUT2.GND, GND)
	NET_C(U42_OUT2.VCC, I_V5)
	NET_C(U42_OUT2.A0, I_U42_HP2_ON)
	NET_C(U42_OUT2.A1, I_U42_HP2_OFF)
	NET_C(U42_OUT2.Q, U15.10, U15.9)
#else
...
#if (SEGAUSB_FAKE_8253)
	VARCLOCK(U41_OUT0, 1, "max(0.000001,min(0.1,A0))")
	NET_C(U41_OUT0.GND, GND)
	NET_C(U41_OUT0.VCC, I_V5)
	NET_C(U41_OUT0.A0, I_U41_HP0)
	NET_C(U41_OUT0.Q, C34.1)
#else
...
#if (SEGAUSB_FAKE_8253)
	VARCLOCK(U41_OUT1, 1, "max(0.000001,min(0.1,A0))")
	NET_C(U41_OUT1.GND, GND)
	NET_C(U41_OUT1.VCC, I_V5)
	NET_C(U41_OUT1.A0, I_U41_HP1)
	NET_C(U41_OUT1.Q, C33.1)
#else
...
#if (SEGAUSB_FAKE_8253)
	VARCLOCK(U41_OUT2, 2, "max(0.000001,min(0.1,if(Q>0.5,A1,A0)))")
	NET_C(U41_OUT2.GND, GND)
	NET_C(U41_OUT2.VCC, I_V5)
	NET_C(U41_OUT2.A0, I_U41_HP2_ON)
	NET_C(U41_OUT2.A1, I_U41_HP2_OFF)
	NET_C(U41_OUT2.Q, U8.10, U8.9)
#else
...
#if (SEGAUSB_FAKE_8253)
	VARCLOCK(U43_OUT0, 1, "max(0.000001,min(0.1,A0))")
	NET_C(U43_OUT0.GND, GND)
	NET_C(U43_OUT0.VCC, I_V5)
	NET_C(U43_OUT0.A0, I_U43_HP0)
	NET_C(U43_OUT0.Q, C35.1)
#else
...
#if (SEGAUSB_FAKE_8253)
	VARCLOCK(U43_OUT1, 1, "max(0.000001,min(0.1,A0))")
	NET_C(U43_OUT1.GND, GND)
	NET_C(U43_OUT1.VCC, I_V5)
	NET_C(U43_OUT1.A0, I_U43_HP1)
	NET_C(U43_OUT1.Q, C36.1)
#else
...
#if (SEGAUSB_FAKE_8253)
	VARCLOCK(U43_OUT2, 2, "max(0.000001,min(0.1,if(Q>0.5,A1,A0)))")
	NET_C(U43_OUT2.GND, GND)
	NET_C(U43_OUT2.VCC, I_V5)
	NET_C(U43_OUT2.A0, I_U43_HP2_ON)
	NET_C(U43_OUT2.A1, I_U43_HP2_OFF)
	NET_C(U43_OUT2.Q, U30.10, U30.9)
#else
