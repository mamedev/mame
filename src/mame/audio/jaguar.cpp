...
uint16_t jaguar_state::jerry_regs_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
void jaguar_state::jerry_regs_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
uint32_t jaguar_state::serial_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
...
void jaguar_state::serial_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	switch (offset)
	{
		/* right DAC */
