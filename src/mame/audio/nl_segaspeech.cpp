...
#if 0
	// use a 7407 as a buffer
	TTL_7407_DIP(SPEECHBUF)
	NET_C(SPEECHBUF.1, I_SP0250)
	ALIAS(I_SPEECH, SPEECHBUF.2)
	NET_C(SPEECHBUF.7, SPEECHBUF.3, SPEECHBUF.5, SPEECHBUF.9, SPEECHBUF.11, SPEECHBUF.13, GND)
	NET_C(SPEECHBUF.14, I_V5)
#endif
#endif
