...
//	TTL_7815_DIP(IC24)		// +15V Regulator -- not emulated
	...
	//
	//    R2 = 0.89845: HP = (-0.0200062*A0) + 0.0204003
	//    R2 = 0.90151: HP = (-0.00106970*A0*A0) - (0.0240156*A0) + 0.0186820
	//    R2 = 0.91086: HP = (-0.00171453*A0*A0*A0) - (0.0114284*A0*A0) - (0.0394674*A0) + 0.0152328
	//    R2 = 0.91094: HP = (-0.000160296*A0*A0*A0*A0) - (0.00304620*A0*A0*A0) - (0.0148767*A0*A0) - (0.0423484*A0) + 0.0148084
	//    R2 = 0.91401: HP = (-0.00108821*A0*A0*A0*A0*A0) - (0.0117727*A0*A0*A0*A0) - (0.0467536*A0*A0*A0) - (0.083301*A0*A0) - (0.081814*A0) + 0.0101518
	//
	VARCLOCK(BGCLK1, 1, "max(0.000001,min(0.1,(-0.00171453*A0*A0*A0) - (0.0114284*A0*A0) - (0.0394674*A0) + 0.0152328))")
	...
	//    R2 = 0.99821: HP = (-0.000307729*A0) + 0.000259516
	//    R2 = 0.99835: HP = (.00000331128*A0*A0) - (0.000295475*A0) + 0.000264916
	//    R2 = 0.99836: HP = (-0.000000805228*A0*A0*A0) - (0.00000150987*A0*A0) - (0.000302576*A0) + 0.000263318
	//    R2 = 0.99836: HP = (0.000000302855*A0*A0*A0*A0) + (0.00000170234*A0*A0*A0) + (0.00000496904*A0*A0) - (0.000297143*A0) + 0.000264127
	//    R2 = 0.99837: HP = (-0.000000114396*A0*A0*A0*A0*A0) - (0.000000907284*A0*A0*A0*A0) - (0.00000280583*A0*A0*A0) - (0.00000201193*A0*A0) - (0.000301139*A0) + 0.000263656
	//
	VARCLOCK(BGCLK2, 1, "max(0.000001,min(0.1,(-0.000000805228*A0*A0*A0) - (0.00000150987*A0*A0) - (0.000302576*A0) + 0.000263318))")
