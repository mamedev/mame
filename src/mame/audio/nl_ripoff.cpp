...
//	NET_C(IC6.6, IC7.3) -- temporarily disable the beep sound
	...
	//    R2 = 0.99913: HP = (0-0.102004*A0*A0*A0) + (0.0406935*A0*A0) - (0.00277839*A0) - 0.00000140594
	...
	//
	VARCLOCK(LASERCLK, 1, "max(0.000001, (0-0.102004*A0*A0*A0) + (0.0406935*A0*A0) - (0.00277839*A0) - 0.00000140594)")
	...
	//    R2 = 0.96482: HP = (0-0.000459844*A0*A0) + (0.00110697*A0) - 0.000085961
	//    R2 = 0.99210: HP = (0.000512521*A0*A0*A0) - (0.00183716*A0*A0) + (0.00202778*A0) - 0.000165571
	//    R2 = 0.99614: HP = (0-0.000450996*A0*A0*A0*A0) + (0.00218565*A0*A0*A0) - (0.00381123*A0*A0) + (0.00280823*A0) - 0.000225737
	//    R2 = 0.99625: HP = (0-0.000161974*A0*A0*A0*A0*A0) + (0.000309626*A0*A0*A0*A0) + (0.000915096*A0*A0*A0) - (0.00291505*A0*A0) + (0.00256587*A0) - 0.000209241
	//
	VARCLOCK(TORPEDOCLK, 1, "max(0.000001, (0.000512521*A0*A0*A0) - (0.00183716*A0*A0) + (0.00202778*A0) - 0.000165571)")
