...
static MACHINE_CONFIG_FRAGMENT(midway_chip_squeak_deluxe)
	...
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(midway_chip_squeak_deluxe_device, porta_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(midway_chip_squeak_deluxe_device, portb_w))
	MCFG_PIA6821_IRQA_HANDLER(WRITELINE(midway_chip_squeak_deluxe_device, irq_w))
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(midway_chip_squeak_deluxe_device, irq_w))
...
static MACHINE_CONFIG_FRAGMENT(midway_sounds_good)
	...
	MCFG_DEVICE_ADD("pia", PIA6821, 0)
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(midway_sounds_good_device, porta_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(midway_sounds_good_device, portb_w))
	MCFG_PIA6821_IRQA_HANDLER(WRITELINE(midway_sounds_good_device, irq_w))
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(midway_sounds_good_device, irq_w))
...
static MACHINE_CONFIG_FRAGMENT(midway_turbo_chip_squeak)
	...
	MCFG_DEVICE_ADD("pia", PIA6821, 0)
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(midway_turbo_chip_squeak_device, porta_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(midway_turbo_chip_squeak_device, portb_w))
	MCFG_PIA6821_IRQA_HANDLER(WRITELINE(midway_turbo_chip_squeak_device, irq_w))
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(midway_turbo_chip_squeak_device, irq_w))
...
static MACHINE_CONFIG_FRAGMENT(midway_squawk_n_talk)
	...
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(midway_squawk_n_talk_device, porta1_w))
	MCFG_PIA6821_IRQA_HANDLER(WRITELINE(midway_squawk_n_talk_device, irq_w))
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(midway_squawk_n_talk_device, irq_w))

	MCFG_DEVICE_ADD("pia1", PIA6821, 0)
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(midway_squawk_n_talk_device, porta2_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(midway_squawk_n_talk_device, portb2_w))
	MCFG_PIA6821_IRQA_HANDLER(WRITELINE(midway_squawk_n_talk_device, irq_w))
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(midway_squawk_n_talk_device, irq_w))
