...
void midway_ssio_device::device_timer(timer_instance const &timer, device_timer_id id, int param, void *ptr)
{
...
void midway_sounds_good_device::device_timer(timer_instance const &timer, device_timer_id id, int param, void *ptr)
{
...
void midway_turbo_cheap_squeak_device::device_timer(timer_instance const &timer, device_timer_id id, int param, void *ptr)
{
	m_pia->portb_w((param >> 1) & 0x0f);
	m_pia->ca1_w(~param & 0x01);
