...
void suna8_state::suna8_samples_number_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_sample = data;
...
void suna8_state::suna8_play_samples_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void suna8_state::rranger_play_samples_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	logerror("%s: play sample = %02X\n", machine().describe_context(), data);
