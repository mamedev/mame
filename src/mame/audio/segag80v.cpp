...
void segag80v_state::elim1_sh_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	data ^= 0xff;
...
void segag80v_state::elim2_sh_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	data ^= 0xff;
...
void segag80v_state::zektor1_sh_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	data ^= 0xff;
...
void segag80v_state::zektor2_sh_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	data ^= 0xff;
...
void segag80v_state::spacfury1_sh_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	data ^= 0xff;
...
void segag80v_state::spacfury2_sh_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	data ^= 0xff;
