...
void tiamc1_sound_device::tiamc1_timer0_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	timer8253_wr(&m_timer0, offset, data);
}

void tiamc1_sound_device::tiamc1_timer1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	timer8253_wr(&m_timer1, offset, data);
}

void tiamc1_sound_device::tiamc1_timer1_gate_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
