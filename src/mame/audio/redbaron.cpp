...
void redbaron_sound_device::sounds_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void redbaron_sound_device::pokey_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	if( m_latch & 0x20 )
