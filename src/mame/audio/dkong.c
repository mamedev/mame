...
static DISCRETE_SOUND_START(dkong2b)
    ...
    DISCRETE_RCINTEGRATE(NODE_22,1,NODE_20,DK_R5, RES_2_PARALLEL(DK_R4+DK_R3,DK_R6),0,DK_C19,DK_SUP_V,DISC_RC_INTEGRATE_TYPE1)
...
/*  tt */
    ...
    DISCRETE_RCINTEGRATE(NODE_39,1,NODE_38,DK_R27, RES_2_PARALLEL(DK_R28,DK_R26+DK_R25),0,DK_C16,DK_SUP_V,DISC_RC_INTEGRATE_TYPE1)
	...
	DISCRETE_TRANSFORM3(NODE_52,1,DS_SOUND0,DK_R46,R_SERIES(DK_R44,DK_R45),"01*2+")
...
static DISCRETE_SOUND_START(radarscp)
    ...
    DISCRETE_RCINTEGRATE(NODE_22,1,NODE_20,RS_R5, RES_2_PARALLEL(RS_R4+RS_R3,RS_R6),0,RS_C18,DK_SUP_V,DISC_RC_INTEGRATE_TYPE1)
    ...
    DISCRETE_RCINTEGRATE(NODE_31,1,NODE_30,RS_R28, RES_2_PARALLEL(RS_R27+RS_R26,RS_R29),0,RS_C29,DK_SUP_V,DISC_RC_INTEGRATE_TYPE1)
