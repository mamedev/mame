...
uint8_t t5182_device::sharedram_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_sharedram[offset];
}

void t5182_device::sharedram_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void t5182_device::sound_irq_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	synchronize(SETIRQ_CB, CPU_ASSERT);
}

void t5182_device::ym2151_irq_ack_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	synchronize(SETIRQ_CB, YM2151_ACK);
}

void t5182_device::cpu_irq_ack_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t t5182_device::sharedram_semaphore_snd_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_semaphore_snd;
}

void t5182_device::sharedram_semaphore_main_acquire_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_semaphore_main = 1;
}

void t5182_device::sharedram_semaphore_main_release_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_semaphore_main = 0;
}

void t5182_device::sharedram_semaphore_snd_acquire_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_semaphore_snd = 1;
}

void t5182_device::sharedram_semaphore_snd_release_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_semaphore_snd = 0;
}

uint8_t t5182_device::sharedram_semaphore_main_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
