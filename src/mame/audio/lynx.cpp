...
uint8_t lynx_sound_device::read(address_space &space, offs_t offset, uint8_t mem_mask)
{
	uint8_t value = 0;
...
void lynx_sound_device::write(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
