...
static MACHINE_CONFIG_FRAGMENT( williams_cvsd_sound )
	...
	MCFG_PIA6821_WRITEPA_HANDLER(DEVWRITE8("dac", dac_device, write_unsigned8))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(williams_cvsd_sound_device, talkback_w))
	MCFG_PIA6821_IRQA_HANDLER(WRITELINE(williams_cvsd_sound_device, pia_irqa))
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(williams_cvsd_sound_device, pia_irqb))
