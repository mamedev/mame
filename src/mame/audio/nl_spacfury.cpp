...
//	NET_C(U35.14, I_V5)
	...
	// #6: R139=150K, C72=0.047uF,  Freq=102.05Hz
	...
	NET_C(GND, R139.1, R139.2, C72.1, C72.2, U19.13, U19.11)
	...
	NET_C(D15.A, U21.3, R102.1, D13.K)
	NET_C(U21.2, C66.2, R103.1)
	NET_C(R103.2, U21.1, R102.2, R84.1)
	NET_C(R84.2, U11.1)
	NET_C(U11.12, R81.1)
	NET_C(U11.11, R82.1)
	NET_C(U11.9, R83.1)
	...
	OPTIMIZE_FRONTIER(R25.1, RES_M(1), 50)
	OPTIMIZE_FRONTIER(R21.1, RES_M(1), 50)
	OPTIMIZE_FRONTIER(R23.1, RES_M(1), 50)
	OPTIMIZE_FRONTIER(R19.1, RES_M(1), 50)
	OPTIMIZE_FRONTIER(R26.1, RES_M(1), 50)
	OPTIMIZE_FRONTIER(R22.1, RES_M(1), 50)
	OPTIMIZE_FRONTIER(R27.1, RES_M(1), 50)
	OPTIMIZE_FRONTIER(R24.1, RES_M(1), 50)
	OPTIMIZE_FRONTIER(R20.1, RES_M(1), 50)
#endif
