...
void efo_zsu_device::device_start()
{
	...
	m_fifo_shift_timer = timer_alloc(*this, FUNC(efo_zsu_device::fifo_shift));
	m_adpcm_clock_timer = timer_alloc(*this, FUNC(efo_zsu_device::adpcm_clock));
	m_ctc0_ck0_restart_timer = timer_alloc(*this, FUNC(efo_zsu_device::ctc0_ck0_restart));
