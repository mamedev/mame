...
//	TTL_74121_DIP(IC14)		// Monostable multivibrators with Schmitt-trigger inputs
	...
	NET_C(C18.2, GND)
	NET_C(C19.2, C20.2, R21.2, R41.2, IC13.2)
	NET_C(R35.2, C20.1)
	NET_C(C21.1, R40.2)
	NET_C(IC13.3, R42.2)
	NET_C(R42.1, GND)
	...
	NET_C(C31.2, IC14.10)
	NET_C(IC14.14, IC14.5, IC14.3, I_V5)
	NET_C(IC14.6, IC15.1)
	NET_C(IC15.2, R44.1)
	NET_C(R44.2, R45.1, D4.K, C33.1)
	NET_C(C33.2, GND)
	NET_C(D4.A, R46.1)
