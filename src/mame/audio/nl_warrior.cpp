...
/*
At 1x D4.K vs 1000x IC8.9
R2 = 0.62778: HP = (0.0000606342*A0) + 0.000263089
R2 = 0.62920: HP = (0-0.00000225317*A0*A0) + (0.000064424*A0) + 0.000265633
R2 = 0.67971: HP = (0.0000120833*A0*A0*A0) - (0.0000263292*A0*A0) + (0.0000372788*A0) + 0.000284751
R2 = 0.73131: HP = (0.0000106263*A0*A0*A0*A0) - (0.0000177951*A0*A0*A0) - (0.0000459790*A0*A0) + (0.000095722*A0) + 0.000285793
R2 = 0.73156: HP = (0-0.000000589837*A0*A0*A0*A0*A0) + (0.0000125708*A0*A0*A0*A0) - (0.0000167293*A0*A0*A0) - (0.0000513049*A0*A0) + (0.000095487*A0) + 0.000287054

At 1.5x D4.K vs 1000x IC8.9
R2 = 0.96846: HP = (0.0000445815*A0) + 0.000218522
R2 = 0.96985: HP = (0.000000668657*A0*A0) + (0.0000414177*A0) + 0.000218697
R2 = 0.96987: HP = (0-0.0000000320690*A0*A0*A0) + (0.000000910640*A0*A0) + (0.0000411879*A0) + 0.000218305
R2 = 0.96988: HP = (0.00000000645411*A0*A0*A0*A0) - (0.000000098065*A0*A0*A0) + (0.00000104649*A0*A0) + (0.0000413364*A0) + 0.000218083
R2 = 0.96990: HP = (0-0.00000000544781*A0*A0*A0*A0*A0) + (0.000000077991*A0*A0*A0*A0) - (0.000000343337*A0*A0*A0) + (0.00000101841*A0*A0) + (0.0000421121*A0) + 0.000217921

At 2x D4.K vs 1000x IC8.9
R2 = 0.98155: HP = (0.0000368135*A0) + 0.000194735
R2 = 0.98669: HP = (0.000000934077*A0*A0) + (0.0000305738*A0) + 0.000197857
R2 = 0.98746: HP = (0.000000124920*A0*A0*A0) - (0.000000368837*A0*A0) + (0.0000331039*A0) + 0.000199436
R2 = 0.98752: HP = (0.0000000129574*A0*A0*A0*A0) - (0.0000000587655*A0*A0*A0) + (0.000000292201*A0*A0) + (0.0000330038*A0) + 0.000198462
R2 = 0.98756: HP = (0-0.00000000402813*A0*A0*A0*A0*A0) + (0.000000084523*A0*A0*A0*A0) - (0.000000439531*A0*A0*A0) + (0.000000750795*A0*A0) + (0.0000337974*A0) + 0.000197752

At 10x D4.K vs 1000x IC8.9
R2 = 0.98229: HP = (0.0000378336*A0) + 0.000191002
R2 = 0.99048: HP = (0.00000123586*A0*A0) + (0.0000297363*A0) + 0.000195151
R2 = 0.99110: HP = (0.000000121270*A0*A0*A0) - (0.00000000380150*A0*A0) + (0.0000321120*A0) + 0.000196603
R2 = 0.99112: HP = (0.0000000074831*A0*A0*A0*A0) + (0.0000000175791*A0*A0*A0) + (0.000000361781*A0*A0) + (0.0000320555*A0) + 0.000196080
R2 = 0.99114: HP = (0-0.00000000291523*A0*A0*A0*A0*A0) + (0.0000000581051*A0*A0*A0*A0) - (0.000000246079*A0*A0*A0) + (0.000000674139*A0*A0) + (0.0000325834*A0) + 0.000195609

At 100x D4.K vs 1000x IC8.9
R2 = 0.98153: HP = (0.0000419458*A0) + 0.000194120
R2 = 0.98995: HP = (0.00000149863*A0*A0) + (0.0000333314*A0) + 0.000197518
R2 = 0.99008: HP = (0.000000070813*A0*A0*A0) + (0.000000860602*A0*A0) + (0.0000343435*A0) + 0.000198295
R2 = 0.99008: HP = (0.0000000078640*A0*A0*A0*A0) - (0.0000000249918*A0*A0*A0) + (0.00000114639*A0*A0) + (0.0000343685*A0) + 0.000197905
R2 = 0.99009: HP = (0.00000000172821*A0*A0*A0*A0*A0) - (0.0000000185697*A0*A0*A0*A0) + (0.000000093120*A0*A0*A0) + (0.00000104859*A0*A0) + (0.0000341194*A0) + 0.000198059
*/
#if (HLE_PITFALL_VCO)
//
// mapping of time-since-trigger to voltage on R46.2:
//    V = 0.00477914*T + 3.99525139

// maximum line, with 555 timer modulation removed:
//    V = -2.243396*T*T + 8.652998*T + 4.048478
//
// modulated +/- 0.5V by 555 timer (using C32.1 as input):
//    +if(A0<0,(-15-A0)/30,(15-A0)/30)
