...
//	NET_C(IC19.7, I_V15)
	...
	//    R2 = 0.99808: HP = (0-0.000000000510037*A0*A0*A0*A0*A0) + (0.000000103515*A0*A0*A0*A0) - (0.00000243946*A0*A0*A0) + (0.0000246047*A0*A0) - (0.000066382*A0) + 0.000198653
	//
	...
	//    R2 = 0.99774: HP = (0-0.00117988*A0*A0) + (0.00409590*A0) - 0.000196405
	//    R2 = 0.99774: HP = (0.00262450*A0*A0*A0) - (0.00252128*A0*A0) + (0.00431521*A0) - 0.000207837
	//    R2 = 0.99774: HP = (0-0.00269118*A0*A0*A0*A0) + (0.00447056*A0*A0*A0) - (0.00298272*A0*A0) + (0.00436492*A0) - 0.000209783
	...
	VARCLOCK(PITFALLCLK, 1, "max(0.0000001,(0.00262450*A0*A0*A0) - (0.00252128*A0*A0) + (0.00431521*A0) - 0.000207837)")
