...
static INPUT_PORTS_START( disc )
	...
	PORT_START("TZ0") //TASTEN
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_SERVICE ) //TS Door switch
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_SERVICE ) //SK Read data button
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN ) //ZE2
	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN ) //Ru
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_SLOT_STOP2 ) //STR
	...
	PORT_START("TZ3") //ZUSATZ-EINGAENGE
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_GAMBLE_HIGH ) // Left
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_SLOT_STOP1 )
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_GAMBLE_LOW ) // Right
