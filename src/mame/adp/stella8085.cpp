...
GAMEL( 1991, treffasm,          0, board4382, servicem, stella8085_state, empty_init, ROT0, "Merkur", "Treff As (Medaille)", MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK, layout_adpservice )
