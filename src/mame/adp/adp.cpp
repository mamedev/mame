...
ROM_START( fstation7 )
    ROM_REGION(0x100000, "maincpu", 0)
    ROM_LOAD16_BYTE("m27c4001_spielekoffer_7._sp._f1_i.u2", 0x00000, 0x80000, CRC(bbf4bbd9) SHA1(80e785cb04213f8cc2f580b523e20b4825ba45e5))
    ROM_LOAD16_BYTE("m27c4001_spielekoffer_7._sp._f1_ii.u6", 0x00001, 0x80000, CRC(cd8ab9e3) SHA1(cb9206d0367f00bec278cee0a4115594ba715fcd))

    ROM_REGION(0x100000, "gfx1", 0)
    ROM_LOAD16_BYTE("m27c4001_spielekoffer_7._sp._f1_i.u2", 0x00000, 0x80000, CRC(dcddb25a) SHA1(7c54bd7a368fd57e3eb995a26462b3d2d589b0db))
    ROM_LOAD16_BYTE("m27c4001_spielekoffer_7._sp._f1_ii.u5", 0x00001, 0x80000, CRC(400f9b8f) SHA1(4c4a9f46016eee805653b5fae65680225ac71436))
ROM_END

ROM_START( fstation8 )
    ROM_REGION(0x100000, "maincpu", 0)
    ROM_LOAD16_BYTE("m27c4001_spielekoffer_8_sp._f1_i.u2", 0x00000, 0x80000, CRC(f9c792ab) SHA1(30ab7352cce22340be87ddae80e4b3c2f69ea778))
    ROM_LOAD16_BYTE("m27c4001_spielekoffer_8_sp._f1_ii.u5", 0x00001, 0x80000, CRC(0cb7b719) SHA1(e87bc67da903d9514dd97a6abf2d4e2171e15dbd))

	ROM_REGION16_BE( 0x100000, "gfx1", 0 ) // no dump available, using fstation9 roms
	ROM_LOAD16_BYTE( "spielekoffer_video_9_sp_f1_i.u2", 0x00000, 0x80000, BAD_DUMP CRC(b6eb971e) SHA1(14e3272c66a82db0f77123974eea28f308209b1b) )
	ROM_LOAD16_BYTE( "spielekoffer_video_9_sp_f1_ii.u5", 0x00001, 0x80000, BAD_DUMP CRC(64138dcb) SHA1(1b629915cba32f8f6164ae5075c175b522b4a323) )
ROM_END
