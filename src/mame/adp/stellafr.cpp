...
GAMEL(1997, jokerpoker,           0, stellafr, stellafr, stellafr_state, empty_init, ROT0, "ADP",    "Joker Poker",           MACHINE_NOT_WORKING | MACHINE_MECHANICAL | MACHINE_REQUIRES_ARTWORK, layout_stellafr )
