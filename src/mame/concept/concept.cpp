...
ROM_START( concept )
	...
	// concept boot ROM
	ROM_SYSTEM_BIOS(0, "v17", "Version 1 Level 7" )
	ROMX_LOAD("ccb17h.bin", 0x010000, 0x1000, CRC(6dd9718f) SHA1(7427d218dc13b1b319866d5a1e59e152fab082b3), ROM_BIOS(0) | ROM_SKIP(1))
	ROMX_LOAD("ccb17l.bin", 0x010001, 0x1000, CRC(107a3830) SHA1(0ea12ef13b0d11fcd83b306b3a1bb8014ba910c0), ROM_BIOS(0) | ROM_SKIP(1))

	ROM_SYSTEM_BIOS(1, "lvl8", "Level 8" )  // v0?
	...
	ROM_SYSTEM_BIOS(2, "lvl7", "Level 7" )  // v0? v1?
	...
	ROM_SYSTEM_BIOS(3, "lvl6", "Level 6" )  // v0?
