...
static INPUT_PORTS_START( mj4simai )
	...
	PORT_DIPSETTING(      0x0040, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
	PORT_DIPNAME( 0x0080, 0x0080, DEF_STR( Test_Mode ) ) PORT_DIPLOCATION("SW1:8")
	PORT_DIPSETTING(      0x0080, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
	...
	PORT_DIPSETTING(      0x0020, DEF_STR( Off ) )
	PORT_DIPSETTING(      0x0000, DEF_STR( On ) )
	PORT_DIPUNUSED_DIPLOC( 0x0002, 0x0040, "SW2:7" ) // Listed as "Unused"
	PORT_DIPUNUSED_DIPLOC( 0x0004, 0x0080, "SW2:8" ) // Listed as "Unused"
	PORT_BIT(             0xff00, IP_ACTIVE_LOW, IPT_UNUSED )
