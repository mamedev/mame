...
GAME( 1994, magerror,  0,        magerror, magerror, hyprduel_state, empty_init,    ROT0, "Technosoft / Jaleco", "Magical Error wo Sagase (Japan)", MACHINE_IMPERFECT_GRAPHICS | MACHINE_SUPPORTS_SAVE )
