...
ROM_START( triviaes4 )
	...
	ROM_LOAD( "pal16l8a.ic31", 0x000, 0x117, BAD_DUMP CRC(e58c2762) SHA1(c26d092a3aa736ed47bfda01ce9b85b681a96fd0) ) // PAL16L8. Bruteforced and untested
	ROM_LOAD( "pal16l8a.ic61", 0x000, 0x117, BAD_DUMP CRC(99512880) SHA1(7a0e80a0db40253c1fedd082e3d08d0cc2d55fbc) ) // PAL16L8. Bruteforced and untested
ROM_END
