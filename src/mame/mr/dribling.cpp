...
GAME( 1983, driblingam, dribling, dribling, dribling, dribling_state, empty_init, ROT0, "bootleg (Automave)",             "Dribbling (Automave bootleg, Spain)",  MACHINE_IMPERFECT_SOUND | MACHINE_SUPPORTS_SAVE )
