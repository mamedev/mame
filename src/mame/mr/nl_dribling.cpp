...
// The output goes through a TDA2003 amplifier which seems to be a band-pass filter as well cutting the frequency
...
// MOSFET EMULATION doesn't work. So using the same circuit with different
// values to emulate the sound.
