...
static INPUT_PORTS_START( koftball )
	...
	PORT_DIPSETTING(         0x0000, DEF_STR( On ) )
	PORT_DIPNAME(    0x0080, 0x0080, DEF_STR( AutoPlay ) ) PORT_DIPLOCATION("SW1:!1")
...
static INPUT_PORTS_START( jxzh )
	...
	PORT_DIPSETTING(         0x0020, DEF_STR( Off ) )
	PORT_DIPSETTING(         0x0000, DEF_STR( On ) )
	PORT_DIPNAME(    0x0040, 0x0040, DEF_STR( AutoPlay ) ) PORT_DIPLOCATION("SW1:!2")
	PORT_DIPSETTING(         0x0040, DEF_STR( Off ) )
	PORT_DIPSETTING(         0x0000, DEF_STR( On ) )
	...
	PORT_DIPSETTING(         0x2000, DEF_STR( Off ) )
	PORT_DIPSETTING(         0x0000, DEF_STR( On ) )
	PORT_DIPNAME(    0x4000, 0x4000, DEF_STR( In-Game Music ) ) PORT_DIPLOCATION("SW2:!2")
	PORT_DIPSETTING(         0x4000, DEF_STR( Off ) )
	PORT_DIPSETTING(         0x0000, DEF_STR( On ) )
	PORT_DIPNAME(    0x8000, 0x0000, DEF_STR( Demo_Sounds ) ) PORT_DIPLOCATION("SW2:!1")
	PORT_DIPSETTING(         0x8000, DEF_STR( Off ) )
