...
static INPUT_PORTS_START( qiwang )
	...
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_OTHER ) PORT_NAME("Key In (Player 2)") PORT_CODE(KEYCODE_3)
	PORT_SERVICE_NO_TOGGLE( 0x20, IP_ACTIVE_LOW )// only works with not coin inserted
	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_START2 )
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_START1 )
	...
	PORT_DIPSETTING(    0x01, DEF_STR( Off ) )
	PORT_DIPSETTING(    0x00, DEF_STR( On ) )
	PORT_DIPNAME( 0x02, 0x02, "Payout Mode" ) PORT_DIPLOCATION("SW1:2")
	PORT_DIPSETTING(    0x02, "Returns Coins" )
	...
	PORT_DIPNAME( 0x60, 0x60, "Key-In / Key-Out Rate" ) PORT_DIPLOCATION("SW1:6,7")
	PORT_DIPSETTING(    0x40, DEF_STR( 1C_1C ) )
	PORT_DIPSETTING(    0x20, DEF_STR( 1C_10C ) )
	PORT_DIPSETTING(    0x60, DEF_STR( 1C_100C ) )
	PORT_DIPSETTING(    0x00, "1 Coin/500 Credits" )
	PORT_DIPNAME( 0x80, 0x80, "Credit Limit" ) PORT_DIPLOCATION("SW1:8")
	PORT_DIPSETTING(    0x80, "2000" )
	PORT_DIPSETTING(    0x00, "10000" )

	PORT_START("DSW2") // read in DIP test, definitions from test mode
	PORT_DIPNAME( 0x03, 0x03, "Jackpot Limit" ) PORT_DIPLOCATION("SW2:1,2")
	PORT_DIPSETTING(    0x03, "3000" )
	PORT_DIPSETTING(    0x02, "5000" )
	PORT_DIPSETTING(    0x01, "10000" )
	PORT_DIPSETTING(    0x00, "50000" )
	PORT_DIPNAME( 0x0c, 0x0c, "Maximum Bet" ) PORT_DIPLOCATION("SW2:3,4")
	PORT_DIPSETTING(    0x04, "20" )
	PORT_DIPSETTING(    0x0c, "50" )
	PORT_DIPSETTING(    0x00, "100" )
	PORT_DIPSETTING(    0x08, "200" )
	PORT_DIPNAME( 0x30, 0x30, "Payout Rate" ) PORT_DIPLOCATION("SW2:5,6")
	...
	PORT_DIPNAME( 0x80, 0x80, "Countdown Seconds" ) PORT_DIPLOCATION("SW2:8")
	PORT_DIPSETTING(    0x00, DEF_STR( Off ) )
