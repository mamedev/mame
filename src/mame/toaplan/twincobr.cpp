...
GAME( 1987, fshark,    0,        fshark,    fshark,    twincobr_state, empty_init,    ROT270, "Toaplan / Taito",                           "Flying Shark (World)",                         0 )
GAME( 1987, skyshark,  fshark,   fshark,    skyshark,  twincobr_state, empty_init,    ROT270, "Toaplan / Taito America (Romstar license)", "Sky Shark (US, set 1)",                        0 )
GAME( 1987, skysharka, fshark,   fshark,    skyshark,  twincobr_state, empty_init,    ROT270, "Toaplan / Taito America (Romstar license)", "Sky Shark (US, set 2)",                        0 )
GAME( 1987, hishouza,  fshark,   fshark,    hishouza,  twincobr_state, empty_init,    ROT270, "Toaplan / Taito",                           "Hishou Zame (Japan)",                          0 )
...
GAME( 1987, twincobr,  0,        twincobrw, twincobr,  twincobr_state, empty_init,    ROT270, "Toaplan / Taito",                           "Twin Cobra (World)",                           0 )
GAME( 1987, twincobru, twincobr, twincobrw, twincobru, twincobr_state, empty_init,    ROT270, "Toaplan / Taito America (Romstar license)", "Twin Cobra (US)",                              0 )
GAME( 1989, ktiger,    twincobr, twincobr,  ktiger,    twincobr_state, empty_init,    ROT270, "Toaplan / Taito",                           "Kyukyoku Tiger (Japan, 2 player cooperative)", 0 )
GAME( 1987, ktigera,   twincobr, twincobr,  ktigera,   twincobr_state, empty_init,    ROT270, "Toaplan / Taito",                           "Kyukyoku Tiger (Japan, 2 player alternate)",   0 )
