...
static INPUT_PORTS_START(keyboard)
	...
	PORT_BIT(0x40, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("R.CONTROL") PORT_CODE(KEYCODE_RCONTROL) // f2 02 2c
	...
	PORT_BIT(0x20, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("L.META") PORT_CODE(KEYCODE_LALT) // f2 02 4a
	...
	PORT_BIT(0x20, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("R.SUPER") PORT_CODE(KEYCODE_RWIN) // f2 02 6a
	...
	PORT_BIT(0x20, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("R.META") PORT_CODE(KEYCODE_RALT) // f2 02 ea
	...
	PORT_BIT(0x02, IP_ACTIVE_HIGH, IPT_BUTTON2) PORT_NAME("Middle mouse button")
	PORT_BIT(0x04, IP_ACTIVE_HIGH, IPT_BUTTON3) PORT_NAME("Right mouse button")
