...
static INPUT_PORTS_START( nwktr_gq )
	...
	PORT_START("ANALOG4")
	PORT_BIT( 0xfff, 0x000, IPT_CUSTOM )
...
static INPUT_PORTS_START( nwktr_gn )
	...
	PORT_MODIFY("ANALOG4")
	PORT_BIT( 0xfff, 0x000, IPT_LEVER ) PORT_NAME("Handbrake Lever") PORT_MINMAX(0x000, 0xfff) PORT_SENSITIVITY(100) PORT_KEYDELTA(60)
INPUT_PORTS_END
...
// JCx, ACx --> up/down gear shift, no clutch, hand brake lever
// EDx, UDx --> prompts you to select if you have a hand brake lever installed, a clutch pedal installed,
// gear shifter type (up/down, 4 pos, or 5+R), and gear shifter's display position.
GAME( 1998, thrilld,    0,       nwktr_lan_b, nwktr_gn, nwktr_state, init_thrilld, ROT0, "Konami", "Thrill Drive (UDE)",             GAME_FLAGS )
...
GAME( 1998, thrillde,   thrilld, nwktr_lan_b, nwktr_gn, nwktr_state, init_thrilld, ROT0, "Konami", "Thrill Drive (EDE)",             GAME_FLAGS )
...
GAME( 1998, thrilldb,   thrilld, nwktr_lan_b, nwktr_gn, nwktr_state, init_thrilld, ROT0, "Konami", "Thrill Drive (UDB)",             GAME_FLAGS )
...
GAME( 1998, thrilldbe,  thrilld, nwktr_lan_b, nwktr_gn, nwktr_state, init_thrilld, ROT0, "Konami", "Thrill Drive (EDB)",             GAME_FLAGS )
