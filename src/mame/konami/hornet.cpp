...
ROM_START(gradius4a)
	...
	ROM_REGION(0x2000, "m48t58",0)
	ROM_LOAD( "m48t58y-70pc1_aac", 0x000000, 0x002000, BAD_DUMP CRC(3aba3bbe) SHA1(a36a6718f54524d846894fb04b5b885b4e43e63b) ) // hand built

	ROM_REGION( 0x0000224, "security_eeprom", 0 )
	ROM_LOAD( "security_eeprom_aa", 0x000000, 0x000224, BAD_DUMP CRC(b669474d) SHA1(e9c5d7db93a1c17d45c5820daf458224bfa7a725) ) // hand built
ROM_END
