...
ROM_START(gticlub2) //*
	...
	ROM_REGION(0x2000, "m48t58", ROMREGION_ERASE00)     /* M48T58 Timekeeper NVRAM */
	ROM_LOAD("gk941ebb_m48t58.u39", 0x00000, 0x2000, CRC(70c450e0) SHA1(797777e0a7e1b382fc46b53ae9ae1324b4fdb9ac))

	DISK_REGION( "ata:0:hdd" )
	DISK_IMAGE( "941b02", 0,  SHA1(943bc9b1ea7273a8382b94c8a75010dfe296df14) )
ROM_END

ROM_START(gticlub2eab) //*
	VIPER_BIOS
	...
	ROM_REGION(0x2000, "m48t58", ROMREGION_ERASE00)     /* M48T58 Timekeeper NVRAM */
	ROM_LOAD("gk941eab_m48t58.u39", 0x00000, 0x2000, CRC(0b1270a2) SHA1(f74dadbdcb9c334b938e63b618f7b437219c7e71))
...
ROM_START(gticlub2u) //*
	...
	ROM_REGION(0x2000, "m48t58", ROMREGION_ERASE00)     /* M48T58 Timekeeper NVRAM */
	ROM_LOAD("gk941uab_m48t58.u39", 0x00000, 0x2000, CRC(fb39517d) SHA1(6025324397bc87950d5f87ad9de61c496831a79a))
...
ROM_START(gticlub2j) //*
	...
	ROM_REGION(0x2000, "m48t58", ROMREGION_ERASE00)     /* M48T58 Timekeeper NVRAM */
	ROM_LOAD("ge941jab_m48t58.u39", 0x00000, 0x2000, CRC(8c8aa4a8) SHA1(07d0f0ace645e2418ff6f74df0cd65525ee2519d))

	DISK_REGION( "ata:0:hdd" )
	DISK_IMAGE( "941b02", 0,  SHA1(943bc9b1ea7273a8382b94c8a75010dfe296df14) )
ROM_END

ROM_START(gticlub2mj) //*
	VIPER_BIOS
	...
	ROM_REGION(0x2000, "m48t58", ROMREGION_ERASE00)     /* M48T58 Timekeeper NVRAM */
	ROM_LOAD("gm941jab_m48t58.u39", 0x00000, 0x2000, CRC(a4f49c8f) SHA1(e5c00fa81adde5982e864a7e906530a9c1512fbc))
...
ROM_START(gticlub2a) //*
	...
	ROM_REGION(0x2000, "m48t58", ROMREGION_ERASE00)     /* M48T58 Timekeeper NVRAM */
	ROM_LOAD("ge941aab_m48t58.u39", 0x00000, 0x2000, CRC(3c76a3a6) SHA1(e263ca5f1ad8c1fd3a7621ace650450a01a7a8f3))

	DISK_REGION( "ata:0:hdd" )
	DISK_IMAGE( "941b02", 0,  SHA1(943bc9b1ea7273a8382b94c8a75010dfe296df14) )
ROM_END

ROM_START(gticlub2ma) //*
	VIPER_BIOS
	...
	ROM_REGION(0x2000, "m48t58", ROMREGION_ERASE00)     /* M48T58 Timekeeper NVRAM */
	ROM_LOAD("gm941aab_m48t58.u39", 0x00000, 0x2000, CRC(669c61a8) SHA1(307f960ae2b45d84f600467024bbf28d1b883add))

	DISK_REGION( "ata:0:hdd" ) // 32 MB Memory Card labeled 941 EA A02
	DISK_IMAGE( "941b02", 0,  SHA1(943bc9b1ea7273a8382b94c8a75010dfe296df14) )
ROM_END

ROM_START(gticlub2eba) //*
	VIPER_BIOS
	...
	ROM_REGION(0x2000, "m48t58", ROMREGION_ERASE00)     /* M48T58 Timekeeper NVRAM */
	ROM_LOAD("gk941eba_m48t58.u39", 0x00000, 0x2000, CRC(dddc36ec) SHA1(b2570547053c8f5d6b99144866c142782f231874))

	DISK_REGION( "ata:0:hdd" )
	DISK_IMAGE( "941a02", 0,  SHA1(dd180ad92dd344b38f160e31833077e342cee38d) ) // with ATA id included
ROM_END

ROM_START(gticlub2eaa) //*
	VIPER_BIOS
	...
	ROM_REGION(0x2000, "m48t58", ROMREGION_ERASE00)     /* M48T58 Timekeeper NVRAM */
	ROM_LOAD("gk941eaa_m48t58.u39", 0x00000, 0x2000, CRC(0a99a7cd) SHA1(54c4b6dfb4895f000ebabd27dcbbba08cf157fd3))

	DISK_REGION( "ata:0:hdd" ) // 32 MB Memory Card labeled 941 EA A02
	DISK_IMAGE( "941a02", 0,  SHA1(dd180ad92dd344b38f160e31833077e342cee38d) ) // with ATA id included
ROM_END

ROM_START(gticlub2ua) //*
	VIPER_BIOS
	...
	ROM_REGION(0x2000, "m48t58", ROMREGION_ERASE00)     /* M48T58 Timekeeper NVRAM */
	ROM_LOAD("gk941uaa_m48t58.u39", 0x00000, 0x2000, CRC(251db659) SHA1(cc43cb572e562910cf48c4436e90492dc951a787))

	DISK_REGION( "ata:0:hdd" ) // 32 MB Memory Card labeled 941 EA A02
	DISK_IMAGE( "941a02", 0,  SHA1(dd180ad92dd344b38f160e31833077e342cee38d) ) // with ATA id included
ROM_END

ROM_START(gticlub2ja) //*
	VIPER_BIOS
	...
	ROM_REGION(0x2000, "m48t58", ROMREGION_ERASE00)     /* M48T58 Timekeeper NVRAM */
	ROM_LOAD("ge941jaa_m48t58.u39", 0x00000, 0x2000, CRC(2c04e488) SHA1(8e16b57d195e33059f40fd65164fac2897cfcfef))

	DISK_REGION( "ata:0:hdd" )
	DISK_IMAGE( "941a02", 0,  SHA1(dd180ad92dd344b38f160e31833077e342cee38d) ) // with ATA id included
ROM_END

ROM_START(gticlub2mja) //*
	VIPER_BIOS
	...
	ROM_REGION(0x2000, "m48t58", ROMREGION_ERASE00)     /* M48T58 Timekeeper NVRAM */
	ROM_LOAD("gm941jaa_m48t58.u39", 0x00000, 0x2000, CRC(bb77b308) SHA1(8c4dcedf8dc92bbb72fa3b02159bc9e78ab4a409))

	DISK_REGION( "ata:0:hdd" ) // 32 MB Memory Card labeled 941 EA A02
	DISK_IMAGE( "941a02", 0,  SHA1(dd180ad92dd344b38f160e31833077e342cee38d) ) // with ATA id included
ROM_END

ROM_START(gticlub2aa) //*
	VIPER_BIOS
	...
	ROM_REGION(0x2000, "m48t58", ROMREGION_ERASE00)     /* M48T58 Timekeeper NVRAM */
	ROM_LOAD("ge941aaa_m48t58.u39", 0x00000, 0x2000, CRC(273ded57) SHA1(222170962430abc5b859128a503baa7672508c73))

	DISK_REGION( "ata:0:hdd" )
	DISK_IMAGE( "941a02", 0,  SHA1(dd180ad92dd344b38f160e31833077e342cee38d) ) // with ATA id included
ROM_END

ROM_START(gticlub2maa) //*
	VIPER_BIOS
	...
	ROM_REGION(0x2000, "m48t58", ROMREGION_ERASE00)     /* M48T58 Timekeeper NVRAM */
	ROM_LOAD("gm941aaa_m48t58.u39", 0x00000, 0x2000, CRC(ff36fb80) SHA1(f2c4ccbc420a5105867f551b3e5a9029aa827ea8))
...
ROM_START(jpark3) //*
	...
	ROM_REGION(0x2000, "m48t58", ROMREGION_ERASE00)     /* M48T58 Timekeeper NVRAM */
	ROM_LOAD("gkb41ebc_m48t58.u39", 0x00000, 0x2000, CRC(c5191bc5) SHA1(27704785d1c5433e5af13edf13a4b48972cfed9c))
...
ROM_START(jpark3u) //*
	...
	ROM_REGION(0x2000, "m48t58", ROMREGION_ERASE00)     /* M48T58 Timekeeper NVRAM */
	ROM_LOAD("gkb41ubc_m48t58.u39", 0x00000, 0x2000, CRC(850ef140) SHA1(b20991e56e43f58ec4b49e96efdb7751dbe1083d))
...
ROM_START(jpark3j) //*
	...
	ROM_REGION(0x2000, "m48t58", ROMREGION_ERASE00)     /* M48T58 Timekeeper NVRAM */
	ROM_LOAD("gqb41jbc_m48t58.u39", 0x00000, 0x2000, CRC(b491991c) SHA1(55b359d6628126849609873a014e61fd23a9c402))
...
ROM_START(jpark3k) //*
	...
	ROM_REGION(0x2000, "m48t58", ROMREGION_ERASE00)     /* M48T58 Timekeeper NVRAM */
	ROM_LOAD("gkb41kbc_m48t58.u39", 0x00000, 0x2000, CRC(9a3749b5) SHA1(433536c2749b5b693a352b3eeedb945930a0bdbe))
...
ROM_START(jpark3x) //*
	...
	ROM_REGION(0x2000, "m48t58", ROMREGION_ERASE00)     /* M48T58 Timekeeper NVRAM */
	ROM_LOAD("gqb41xbc_m48t58.u39", 0x00000, 0x2000, CRC(af1f3fed) SHA1(c34c339e574aa364a400ca1bd9c1a8ea2b0e98b7))
...
ROM_START(jpark3ja) //*
	...
	ROM_REGION(0x2000, "m48t58", ROMREGION_ERASE00)     /* M48T58 Timekeeper NVRAM */
	ROM_LOAD("gnb41jaa_m48t58.u39", 0x00000, 0x2000, CRC(87850631) SHA1(c2edeb2a06f1c9a632d926b7fbafb76985b0e7e9))
...
ROM_START(jpark3jr) //*
	...
	ROM_REGION(0x2000, "m48t58", ROMREGION_ERASE00)     /* M48T58 Timekeeper NVRAM */
	ROM_LOAD("gnb41jra_m48t58.u39", 0x00000, 0x2000, CRC(38fb05db) SHA1(4aa7adae2fc5aa07209c9973b8ce72385e70ff12))
...
ROM_START(jpark3a) //*
	...
	ROM_REGION(0x2000, "m48t58", ROMREGION_ERASE00)     /* M48T58 Timekeeper NVRAM */
	ROM_LOAD("gnb41aaa_m48t58.u39", 0x00000, 0x2000, CRC(783df547) SHA1(07147360aed7b6761b5042857d5a63e6cb83a046))
...
ROM_START(jpark3xa) //*
	...
	ROM_REGION(0x2000, "m48t58", ROMREGION_ERASE00)     /* M48T58 Timekeeper NVRAM */
	ROM_LOAD("gnb41xaa_m48t58.u39", 0x00000, 0x2000, CRC(d0b574ce) SHA1(8e7679a5736aebc3679a7c3f6029ce3d381ffb74))
...
GAME(2000, gticlub2j,   gticlub2,  viper,           gticlub2,   viper_state,           init_vipercf,  ROT0,  "Konami", "GTI Club: Corso Italiano (ver GE941JAB)",          MACHINE_NOT_WORKING)
...
GAME(2001, jpark3,      kviper,    viper,           jpark3,     viper_state,           init_vipercf,  ROT0,  "Konami", "Jurassic Park III (ver GKB41EBC)",                 MACHINE_NOT_WORKING)
GAME(2001, jpark3u,     jpark3,    viper,           jpark3,     viper_state,           init_vipercf,  ROT0,  "Konami", "Jurassic Park III (ver GKB41UBC)",                 MACHINE_NOT_WORKING)
GAME(2001, jpark3j,     jpark3,    viper,           jpark3,     viper_state,           init_vipercf,  ROT0,  "Konami", "Jurassic Park III (ver GQB41JBC)",                 MACHINE_NOT_WORKING)
GAME(2001, jpark3k,     jpark3,    viper,           jpark3,     viper_state,           init_vipercf,  ROT0,  "Konami", "Jurassic Park III (ver GKB41KBC)",                 MACHINE_NOT_WORKING)
GAME(2001, jpark3x,     jpark3,    viper,           jpark3,     viper_state,           init_vipercf,  ROT0,  "Konami", "Jurassic Park III (ver GQB41XBC)",                 MACHINE_NOT_WORKING)
GAME(2001, jpark3ja,    jpark3,    viper,           jpark3,     viper_state,           init_vipercf,  ROT0,  "Konami", "Jurassic Park III (ver GNB41JAC)",                 MACHINE_NOT_WORKING)
GAME(2001, jpark3jr,    jpark3,    viper,           jpark3,     viper_state,           init_vipercf,  ROT0,  "Konami", "Jurassic Park III (ver GNB41JRC)",                 MACHINE_NOT_WORKING)
GAME(2001, jpark3a,     jpark3,    viper,           jpark3,     viper_state,           init_vipercf,  ROT0,  "Konami", "Jurassic Park III (ver GNB41AAC)",                 MACHINE_NOT_WORKING)
GAME(2001, jpark3xa,    jpark3,    viper,           jpark3,     viper_state,           init_vipercf,  ROT0,  "Konami", "Jurassic Park III (ver GNB41XAC)",                 MACHINE_NOT_WORKING)
...
GAME(2002, wcombatk,    wcombat,   viper,           wcombat4p,  viper_state,           init_vipercf,  ROT0,  "Konami", "Warzaid (ver KBC:B)",                              MACHINE_NOT_WORKING)
GAME(2002, wcombatu,    wcombat,   viper,           wcombat2p,  viper_state,           init_vipercf,  ROT0,  "Konami", "Warzaid (ver UCD:B)",                              MACHINE_NOT_WORKING)
