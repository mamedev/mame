...
void v9938_init (running_machine *machine, int which, const device_config *screen, bitmap_t *bitmap, int model, int vram_size, void (*callback)(running_machine *, int) )
{
	...
	state_save_register_item("v9938", NULL, which, vdp->offset_x);
	state_save_register_item("v9938", NULL, which, vdp->offset_y);
	state_save_register_item("v9938", NULL, which, vdp->visible_y);
	state_save_register_item("v9938", NULL, which, vdp->mode);
	state_save_register_item("v9938", NULL, which, vdp->pal_write_first);
	state_save_register_item("v9938", NULL, which, vdp->cmd_write_first);
	state_save_register_item("v9938", NULL, which, vdp->pal_write);
	state_save_register_item("v9938", NULL, which, vdp->cmd_write);
	state_save_register_item_array("v9938", NULL, which, vdp->palReg);
	state_save_register_item_array("v9938", NULL, which, vdp->statReg);
	state_save_register_item_array("v9938", NULL, which, vdp->contReg);
	state_save_register_item("v9938", NULL, which, vdp->read_ahead);
	state_save_register_item_pointer("v9938", NULL, which, vdp->vram, 0x20000);
	if ( vdp->vram_exp != NULL )
		state_save_register_item_pointer("v9938", NULL, which, vdp->vram_exp, 0x10000);
	state_save_register_item("v9938", NULL, which, vdp->INT);
	state_save_register_item("v9938", NULL, which, vdp->scanline);
	state_save_register_item("v9938", NULL, which, vdp->blink);
	state_save_register_item("v9938", NULL, which, vdp->blink_count);
	state_save_register_item("v9938", NULL, which, vdp->size);
	state_save_register_item("v9938", NULL, which, vdp->size_old);
	state_save_register_item("v9938", NULL, which, vdp->size_auto);
	state_save_register_item("v9938", NULL, which, vdp->size_now);
	state_save_register_item("v9938", NULL, which, vdp->mx_delta);
	state_save_register_item("v9938", NULL, which, vdp->my_delta);
	state_save_register_item("v9938", NULL, which, vdp->button_state);
	state_save_register_item_array("v9938", NULL, which, vdp->pal_ind16);
	state_save_register_item_array("v9938", NULL, which, vdp->pal_ind256);
	state_save_register_item("v9938", NULL, which, vdp->MMC.SX);
	state_save_register_item("v9938", NULL, which, vdp->MMC.SY);
	state_save_register_item("v9938", NULL, which, vdp->MMC.DX);
	state_save_register_item("v9938", NULL, which, vdp->MMC.DY);
	state_save_register_item("v9938", NULL, which, vdp->MMC.TX);
	state_save_register_item("v9938", NULL, which, vdp->MMC.TY);
	state_save_register_item("v9938", NULL, which, vdp->MMC.NX);
	state_save_register_item("v9938", NULL, which, vdp->MMC.NY);
	state_save_register_item("v9938", NULL, which, vdp->MMC.MX);
	state_save_register_item("v9938", NULL, which, vdp->MMC.ASX);
	state_save_register_item("v9938", NULL, which, vdp->MMC.ADX);
	state_save_register_item("v9938", NULL, which, vdp->MMC.ANX);
	state_save_register_item("v9938", NULL, which, vdp->MMC.CL);
	state_save_register_item("v9938", NULL, which, vdp->MMC.LO);
	state_save_register_item("v9938", NULL, which, vdp->MMC.CM);
	state_save_register_item("v9938", NULL, which, vdp->MMC.MXS);
	state_save_register_item("v9938", NULL, which, vdp->MMC.MXD);
	state_save_register_item("v9938", NULL, which, vdp->VdpOpsCnt);
}
