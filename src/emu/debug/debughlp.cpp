...
const help_item f_static_help_list[] =
{
	...
	},
	{
		...
		"  dump <filename>,<address>[:<space>],<length>[,<group>[,<ascii>[,<rowsize>]]] -- dump program memory as text\n"
		...
		"  strdump <filename>,<address>[:<space>],<length>[,<term>] -- dump ASCII strings from program memory\n"
		...
		"  save <filename>,<address>[:<space>],<length> -- save binary program memory to the given file\n"
		...
		"  load <filename>,<address>[:<space>][,<length>] -- load binary program memory from the given file\n"
		...
		"  map <address>[:<space>] -- map logical program address to physical address and bank\n"
	...
	},
	{
		...
		"Type help <command> for further details on each command\n"
		"\n"
		"  wp[set] <address>[:<space>],<length>,<type>[,<condition>[,<action>]] -- sets program space watchpoint\n"
