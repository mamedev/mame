...
void construct_core_types_P1(simple_list<input_type_entry> &typelist)
{
	...
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, HAT_UP,              "P1 Hat Up",              input_seq(KEYCODE_I) )
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, HAT_DOWN,            "P1 Hat Down",            input_seq(KEYCODE_K) )
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, HAT_LEFT,            "P1 Hat Left",            input_seq(KEYCODE_J) )
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, HAT_RIGHT,           "P1 Hat Right",           input_seq(KEYCODE_L) )
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, SHOULDER_BUTTON_L1,  "P1 Button L1",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, SHOULDER_BUTTON_L2,  "P1 Button L2",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, SHOULDER_BUTTON_R1,  "P1 Button R1",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, SHOULDER_BUTTON_R2,  "P1 Button R2",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, JOYSTICK_BUTTON1,    "P1 Joystick Down L",     input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 1, PLAYER1, JOYSTICK_BUTTON2,    "P1 Joystick Down R",     input_seq() )
...
void construct_core_types_P2(simple_list<input_type_entry> &typelist)
{
	...
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, HAT_UP,              "P2 Hat Up",              input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, HAT_DOWN,            "P2 Hat Down",            input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, HAT_LEFT,            "P2 Hat Left",            input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, HAT_RIGHT,           "P2 Hat Right",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, SHOULDER_BUTTON_L1,  "P2 Button L1",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, SHOULDER_BUTTON_L2,  "P2 Button L2",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, SHOULDER_BUTTON_R1,  "P2 Button R1",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, SHOULDER_BUTTON_R2,  "P2 Button R2",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, JOYSTICK_BUTTON1,    "P2 Joystick Down L",     input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 2, PLAYER2, JOYSTICK_BUTTON2,    "P2 Joystick Down R",     input_seq() )
...
void construct_core_types_P3(simple_list<input_type_entry> &typelist)
{
	...
	INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, HAT_UP,              "P3 Hat Up",              input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, HAT_DOWN,            "P3 Hat Down",            input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, HAT_LEFT,            "P3 Hat Left",            input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, HAT_RIGHT,           "P3 Hat Right",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, SHOULDER_BUTTON_L1,  "P3 Button L1",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, SHOULDER_BUTTON_L2,  "P3 Button L2",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, SHOULDER_BUTTON_R1,  "P3 Button R1",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, SHOULDER_BUTTON_R2,  "P3 Button R2",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, JOYSTICK_BUTTON1,    "P3 Joystick Down L",     input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 3, PLAYER3, JOYSTICK_BUTTON2,    "P3 Joystick Down R",     input_seq() )
...
void construct_core_types_P4(simple_list<input_type_entry> &typelist)
{
	...
	INPUT_PORT_DIGITAL_TYPE( 4, PLAYER4, HAT_UP,              "P4 Hat Up",              input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 4, PLAYER4, HAT_DOWN,            "P4 Hat Down",            input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 4, PLAYER4, HAT_LEFT,            "P4 Hat Left",            input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 4, PLAYER4, HAT_RIGHT,           "P4 Hat Right",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 4, PLAYER4, SHOULDER_BUTTON_L1,  "P4 Button L1",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 4, PLAYER4, SHOULDER_BUTTON_L2,  "P4 Button L2",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 4, PLAYER4, SHOULDER_BUTTON_R1,  "P4 Button R1",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 4, PLAYER4, SHOULDER_BUTTON_R2,  "P4 Button R2",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 4, PLAYER4, JOYSTICK_BUTTON1,    "P4 Joystick Down L",     input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 4, PLAYER4, JOYSTICK_BUTTON2,    "P4 Joystick Down R",     input_seq() )
...
void construct_core_types_P5(simple_list<input_type_entry> &typelist)
{
	...
	INPUT_PORT_DIGITAL_TYPE( 5, PLAYER5, HAT_UP,              "P5 Hat Up",              input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 5, PLAYER5, HAT_DOWN,            "P5 Hat Down",            input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 5, PLAYER5, HAT_LEFT,            "P5 Hat Left",            input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 5, PLAYER5, HAT_RIGHT,           "P5 Hat Right",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 5, PLAYER5, SHOULDER_BUTTON_L1,  "P5 Button L1",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 5, PLAYER5, SHOULDER_BUTTON_L2,  "P5 Button L2",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 5, PLAYER5, SHOULDER_BUTTON_R1,  "P5 Button R1",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 5, PLAYER5, SHOULDER_BUTTON_R2,  "P5 Button R2",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 5, PLAYER5, JOYSTICK_BUTTON1,    "P5 Joystick Down L",     input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 5, PLAYER5, JOYSTICK_BUTTON2,    "P5 Joystick Down R",     input_seq() )
...
void construct_core_types_P6(simple_list<input_type_entry> &typelist)
{
	...
	INPUT_PORT_DIGITAL_TYPE( 6, PLAYER6, HAT_UP,              "P6 Hat Up",              input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 6, PLAYER6, HAT_DOWN,            "P6 Hat Down",            input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 6, PLAYER6, HAT_LEFT,            "P6 Hat Left",            input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 6, PLAYER6, HAT_RIGHT,           "P6 Hat Right",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 6, PLAYER6, SHOULDER_BUTTON_L1,  "P6 Button L1",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 6, PLAYER6, SHOULDER_BUTTON_L2,  "P6 Button L2",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 6, PLAYER6, SHOULDER_BUTTON_R1,  "P6 Button R1",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 6, PLAYER6, SHOULDER_BUTTON_R2,  "P6 Button R2",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 6, PLAYER6, JOYSTICK_BUTTON1,    "P6 Joystick Down L",     input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 6, PLAYER6, JOYSTICK_BUTTON2,    "P6 Joystick Down R",     input_seq() )
...
void construct_core_types_P7(simple_list<input_type_entry> &typelist)
{
	...
	INPUT_PORT_DIGITAL_TYPE( 7, PLAYER7, HAT_UP,              "P1 Hat Up",              input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 7, PLAYER7, HAT_DOWN,            "P1 Hat Down",            input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 7, PLAYER7, HAT_LEFT,            "P1 Hat Left",            input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 7, PLAYER7, HAT_RIGHT,           "P1 Hat Right",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 7, PLAYER7, SHOULDER_BUTTON_L1,  "P7 Button L1",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 7, PLAYER7, SHOULDER_BUTTON_L2,  "P7 Button L2",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 7, PLAYER7, SHOULDER_BUTTON_R1,  "P7 Button R1",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 7, PLAYER7, SHOULDER_BUTTON_R2,  "P7 Button R2",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 7, PLAYER7, JOYSTICK_BUTTON1,    "P7 Joystick Down L",     input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 7, PLAYER7, JOYSTICK_BUTTON2,    "P7 Joystick Down R",     input_seq() )
...
void construct_core_types_P8(simple_list<input_type_entry> &typelist)
{
	...
	INPUT_PORT_DIGITAL_TYPE( 8, PLAYER8, HAT_UP,              "P8 Hat Up",              input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 8, PLAYER8, HAT_DOWN,            "P8 Hat Down",            input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 8, PLAYER8, HAT_LEFT,            "P8 Hat Left",            input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 8, PLAYER8, HAT_RIGHT,           "P8 Hat Right",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 8, PLAYER8, SHOULDER_BUTTON_L1,  "P8 Button L1",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 8, PLAYER8, SHOULDER_BUTTON_L2,  "P8 Button L2",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 8, PLAYER8, SHOULDER_BUTTON_R1,  "P8 Button R1",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 8, PLAYER8, SHOULDER_BUTTON_R2,  "P8 Button R2",           input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 8, PLAYER8, JOYSTICK_BUTTON1,    "P8 Joystick Down L",     input_seq() )
	INPUT_PORT_DIGITAL_TYPE( 8, PLAYER8, JOYSTICK_BUTTON2,    "P8 Joystick Down R",     input_seq() )
