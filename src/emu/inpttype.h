...
inline void construct_core_types_UI(simple_list<input_type_entry> &typelist)
{
	...
	INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_QUIT,             "UI Quit",                input_seq(KEYCODE_ESC, input_seq::not_code, KEYCODE_LSHIFT) )
	INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_FORCE_QUIT,       "UI Force Quit",          input_seq(KEYCODE_ESC, KEYCODE_LSHIFT) )
