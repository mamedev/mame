...
public:
	...
	// endianness override setting
	address_map_entry &endian(int _endian) { m_endian = _endian + 1; return *this; }
	...
	int                     m_endian;               // endianness override
...
public:
	...
	address_map(const address_space &space, offs_t start, offs_t end, u64 unitmask, int cswidth, int endian, device_t &device, address_map_constructor submap_delegate);
	~address_map();
