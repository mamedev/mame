...
static MACHINE_CONFIG_FRAGMENT( dmac_hdc )
	...
	MCFG_SCSIDEV_ADD("scsi:harddisk", SCSIHD, SCSI_ID_1)
...
ROM_START( dmac_hdc )
	...
	// ROM_COPY("bootrom", 0x0000, 0x4000, 0x4000)
	ROM_SYSTEM_BIOS(1, "v66", "Version 6.6")
	...
	// ROM_COPY("bootrom", 0x0000, 0x4000, 0x4000)
	ROM_SYSTEM_BIOS(2, "v70", "Version 7.0")
	ROMX_LOAD("390721-03.u13", 0x0000, 0x2000, CRC(2942747a) SHA1(dbd7648e79c753337ff3e4f491de224bf05e6bb6), ROM_SKIP(1) | ROM_BIOS(3))
	ROMX_LOAD("390722-03.u12", 0x0001, 0x2000, CRC(a9ccffed) SHA1(149f5bd52e2d29904e3de483b9ad772448e9278e), ROM_SKIP(1) | ROM_BIOS(3))
	ROMX_LOAD("390721-03.u13", 0x4000, 0x2000, CRC(2942747a) SHA1(dbd7648e79c753337ff3e4f491de224bf05e6bb6), ROM_SKIP(1) | ROM_BIOS(3))
	ROMX_LOAD("390722-03.u12", 0x4001, 0x2000, CRC(a9ccffed) SHA1(149f5bd52e2d29904e3de483b9ad772448e9278e), ROM_SKIP(1) | ROM_BIOS(3))
	// ROM_COPY("bootrom", 0x0000, 0x4000, 0x4000)
	ROM_SYSTEM_BIOS(3, "g614", "Guru-ROM 6.14")
...
{
	return m_wdc->read(space, offset);
}

WRITE8_MEMBER( dmac_hdc_device::dmac_scsi_w )
{
	m_wdc->write(space, offset, data);
}
