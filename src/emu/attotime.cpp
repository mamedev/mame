...
const attotime newtime::attotime::zero(0);
const attotime newtime::attotime::never(0x7fffffffffffffffll, 0xfffffffd);
...
char const *attotime::generate_string(char *buffer, int precision, bool dividers) const
{
	// special case: never
	if (is_never())
	...
	if (precision > 0)
	{
		*dest++ = '.';
		...
		{ 
			...
			subseconds::PER_SECOND / 10000ll,
			subseconds::PER_SECOND / 100000ll,
			subseconds::PER_SECOND / 1000000ll,
			subseconds::PER_SECOND / 10000000ll,
			subseconds::PER_SECOND / 100000000ll,
			subseconds::PER_SECOND / 1000000000ll,
			subseconds::PER_SECOND / 10000000000ll,
			subseconds::PER_SECOND / 100000000000ll,
			subseconds::PER_SECOND / 1000000000000ll,
			subseconds::PER_SECOND / 10000000000000ll,
			subseconds::PER_SECOND / 100000000000000ll,
...
const char *attotime::as_string(int precision, bool dividers) const
{
