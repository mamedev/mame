...
*/
uint16_t tap_990_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
	if (offset < 8)
		return m_w[offset];
	else
...
*/
void tap_990_device::write(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	if (offset < 8)
	{
