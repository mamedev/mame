...
*/
uint8_t fd800_legacy_device::cru_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	int reply = 0;
...
/*
    ...
    28-31: command code
*/
void fd800_legacy_device::cru_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	switch (offset)
	{
	case 0:
