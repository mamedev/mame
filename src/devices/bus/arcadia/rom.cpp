...
uint8_t arcadia_rom_device::read_rom(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
uint8_t arcadia_rom_device::extra_rom(address_space &space, offs_t offset, uint8_t mem_mask)
{
