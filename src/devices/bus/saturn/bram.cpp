...
uint32_t saturn_bram_device::read_ext_bram(address_space &space, offs_t offset, uint32_t mem_mask)
{
...
void saturn_bram_device::write_ext_bram(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	if (offset < m_ext_bram.size()/2)
	{
