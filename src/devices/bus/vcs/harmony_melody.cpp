...
uint8_t a26_rom_harmony_device::read8_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
uint8_t a26_rom_harmony_device::read_rom(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void a26_rom_harmony_device::write_bank(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	check_bankswitch(offset);
