...
{
	LOGMASKED(LOG_GENERAL, "nina-001 write_m, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "nina-006 write_l, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "Maxi 15 read_h, offset: %04x\n", offset);
