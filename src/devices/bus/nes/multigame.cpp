...
{
	LOGMASKED(LOG_GENERAL, "ae_act52_w, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "caltron6in1 write_m, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "caltron6in1 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "caltron9in1 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "rumblestation write_m, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "rumblestation write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "svision16 write_m, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "svision16 write_h, offset: %04x, data: %02x\n", offset, data);
	m_latch2 = data;
	update_prg();
}
...
{
	LOGMASKED(LOG_GENERAL, "svision16 read_m, offset: %04x\n", offset);
...
{
	LOGMASKED(LOG_GENERAL, "farid_unrom write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "kn42 write_h, offset: %04x, data: %02x\n", offset, data);
...
void nes_a65as_device::write_h(offs_t offset, uint8_t data)
{
	...
	LOGMASKED(LOG_GENERAL, "a65as write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "t262 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "studyngame write_h, offset: %04x, data: %02x\n", offset, data);
	prg32(data);
}
...
{
	LOGMASKED(LOG_GENERAL, "supergun20in1 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "vt5201 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_vt5201 read_h, offset: %04x\n", offset);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_80013b write_h, offset: %04x, data: %02x\n", offset, data);
	if (offset & 0x6000)
	{
		m_reg[1] = data & 0x7f;
...
{
	LOGMASKED(LOG_GENERAL, "bmc_810544c write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_830425c write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_830928c write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_850437c write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_970630c write_h, offset: %04x, data: %02x\n", offset, data);
...
{
//  LOGMASKED(LOG_GENERAL, "bmc_970630c read_h, offset: %04x\n", offset);
...
{
	LOGMASKED(LOG_GENERAL, "ntd03 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_ctc09 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
// LOGMASKED(LOG_GENERAL, "bmc_ds927 read_h, offset: %04x\n", offset);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_ds927 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_gka read_m, offset: %04x\n", offset);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_gka write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_gkb write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_gkcxin1 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_gn91b write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_hp898f read_l, offset: %04x\n", offset);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_hp898f write_m, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_k3036 write_h, offset: %04x, data: %02x\n", offset, data);
	u8 bank = offset & 0x1f;
	prg16_89ab(bank);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_k3046 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_k3071 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_s009 write_m, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_s009 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_sa005a write_h, offset: %04x, data: %02x\n", offset, data);
	u8 bank = offset & 0x0f;
	prg16_89ab(bank);
	prg16_cdef(bank);
	chr8(bank, CHRROM);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_tf2740 write_m, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_tf2740 write_h, offset: %04x, data: %02x\n", offset, data);
	m_reg[0] = data;
	update_chr();
}
...
{
	LOGMASKED(LOG_GENERAL, "bmc_tf2740 read_m, offset: %04x\n", offset);
	return (get_open_bus() & ~0x03) | m_jumper;    // TODO: add jumper settings, m_jumper is 0 for now
}
...
{
	LOGMASKED(LOG_GENERAL, "bmc_th2348 write_l, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_th2348 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_tj03 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_ws write_m, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_11160 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_g146 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_2751 write_h, offset: %04x, data: %02x\n", offset, data);
	u8 bank = BIT(offset, 4, 3);
	u8 mode = BIT(offset, 7);
	prg16_89ab(bank & ~mode);
	prg16_cdef(bank | mode);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_8157 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_8157 read_h, offset: %04x\n", offset);
	if (m_latch)
...
{
	LOGMASKED(LOG_GENERAL, "bmc_hik300 read_m, offset: %04x, data: %02x\n", offset);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_hik300 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_s700 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_ball11 read_m, offset: %04x, data: %02x\n", offset);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_ball11 write_m, offset: %04x, data: %02x\n", offset, data);
	set_nt_mirroring(BIT(data, 4) ? PPU_MIRROR_HORZ : PPU_MIRROR_VERT);
	m_reg[0] = data & 0x02;
	update_prg();
}
...
{
	LOGMASKED(LOG_GENERAL, "bmc_ball11 write_h, offset: %04x, data: %02x\n", offset, data);
	m_reg[1] = data & 0x1f;
	update_prg();
}
...
{
	LOGMASKED(LOG_GENERAL, "bmc_22games write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_64y2k write_l, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_64y2k write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_420y2k write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_420y2k read_h, offset: %04x\n", offset);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_12in1 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_20in1 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_21in1 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_31in1 write_h, offset: %04x, data: %02x\n", offset, data);
	set_nt_mirroring(BIT(offset, 5) ? PPU_MIRROR_HORZ : PPU_MIRROR_VERT);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_35in1 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_36in1 write_h, offset: %04x, data: %02x\n", offset, data);
...
void nes_bmc_64in1_device::write_h(offs_t offset, uint8_t data)
{
	...
	LOGMASKED(LOG_GENERAL, "bmc_64in1 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc70in1 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc70in1 read_h, offset: %04x\n", offset);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_72in1 read_l, offset: %04x\n", offset);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_72in1 write_l, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_72in1 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_76in1 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_150in1 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc500in1 write_h, offset: %04x, data: %02x\n", offset, data);
...
void nes_bmc_1200in1_device::write_h(offs_t offset, uint8_t data)
{
	...
	LOGMASKED(LOG_GENERAL, "bmc_1200in1 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_gold260 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_42in1reset write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_lc160 write_h, offset: %04x, data: %02x\n", offset, data);
	if (offset >= 0x4000)
	{
...
{
	LOGMASKED(LOG_GENERAL, "bmc_60311c write_m, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_60311c write_h, offset: %04x, data: %02x\n", offset, data);
	m_reg[2] = data & 0x07;
	update_banks();
}
...
{
	LOGMASKED(LOG_GENERAL, "bmc_ctc12in1 read_m, offset: %04x, data: %02x\n", offset);
	return m_prg[0x01 * 0x2000 + offset];    // fixed to bank 1
}

void nes_bmc_ctc12in1_device::write_h(offs_t offset, u8 data)
{
	LOGMASKED(LOG_GENERAL, "bmc_ctc12in1 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_891227 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
// LOGMASKED(LOG_GENERAL, "fam250 read_m, offset: %04x\n", offset);
...
{
	LOGMASKED(LOG_GENERAL, "fam250 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_k1029 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "n625092 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_th22913 write_h, offset: %04x, data: %02x\n", offset, data);
