...
{
	LOGMASKED(LOG_GENERAL, "Sunsoft 1 write_m, offset: %04x, data: %02x\n", offset, data);
...
void nes_sunsoft_2_device::write_h(offs_t offset, uint8_t data)
{
	...
	LOGMASKED(LOG_GENERAL, "Sunsoft 2 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "Sunsoft 3 write_h, offset %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "Sunsoft 4 write_h, offset %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "Sunsoft 4 write_m, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "Sunsoft 4 read_m, offset: %04x\n", offset);
...
{
	LOGMASKED(LOG_GENERAL, "fme7_write, offset %04x, data: %02x\n", offset, data);
	...
	switch (offset & 0x6000)
	{
		...
		default:
			LOGMASKED(LOG_GENERAL, "Sunsoft FME7 write_h uncaught %04x value: %02x\n", offset + 0x8000, data);
			break;
	}
}
...
void nes_sunsoft_fme7_device::write_m(offs_t offset, uint8_t data)
{
	...
	LOGMASKED(LOG_GENERAL, "Sunsoft FME7 write_m, offset: %04x, data: %02x\n", offset, data);
...
{
	uint8_t bank = m_wram_bank & 0x3f;
	LOGMASKED(LOG_GENERAL, "Sunsoft FME7 read_m, offset: %04x\n", offset);
...
{
	LOGMASKED(LOG_GENERAL, "sunsoft 5 write_h, offset %04x, data: %02x\n", offset, data);
