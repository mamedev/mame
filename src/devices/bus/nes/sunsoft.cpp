...
void nes_sunsoft_1_device::write_m(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void nes_sunsoft_2_device::write_h(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void nes_sunsoft_3_device::write_h(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void nes_sunsoft_4_device::sun4_write(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void nes_sunsoft_4_device::write_m(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t nes_sunsoft_4_device::read_m(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void nes_sunsoft_fme7_device::fme7_write(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void nes_sunsoft_fme7_device::write_m(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t nes_sunsoft_fme7_device::read_m(address_space &space, offs_t offset, uint8_t mem_mask)
{
	uint8_t bank = m_wram_bank & 0x3f;
...
void nes_sunsoft_5_device::write_h(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
