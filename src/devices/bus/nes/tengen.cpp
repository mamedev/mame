...
void nes_tengen008_device::write_h(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void nes_tengen032_device::tengen032_write(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	uint8_t helper, cmd;
...
void nes_tengen037_device::write_h(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
