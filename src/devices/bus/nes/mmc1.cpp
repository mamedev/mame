...
void nes_sxrom_device::write_h(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void nes_sxrom_device::write_m(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t nes_sxrom_device::read_m(address_space &space, offs_t offset, uint8_t mem_mask)
{
	uint8_t bank = (m_reg[1] >> 2) & 3;
...
void nes_sorom_device::write_m(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t nes_sorom_device::read_m(address_space &space, offs_t offset, uint8_t mem_mask)
{
	uint8_t type = BIT(m_reg[0], 4) ? BIT(m_reg[1], 4) : BIT(m_reg[1], 3);
...
void nes_sxrom_a_device::write_m(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	uint8_t bank = (m_reg[1] >> 2) & 3;
...
uint8_t nes_sxrom_a_device::read_m(address_space &space, offs_t offset, uint8_t mem_mask)
{
	uint8_t bank = (m_reg[1] >> 2) & 3;
...
void nes_sorom_a_device::write_m(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	uint8_t type = BIT(m_reg[0], 4) ? BIT(m_reg[1], 4) : BIT(m_reg[1], 3);
...
uint8_t nes_sorom_a_device::read_m(address_space &space, offs_t offset, uint8_t mem_mask)
{
	uint8_t type = BIT(m_reg[0], 4) ? BIT(m_reg[1], 4) : BIT(m_reg[1], 3);
