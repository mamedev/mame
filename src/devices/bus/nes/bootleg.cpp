...
void nes_ax5705_device::write_h(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	uint8_t bank;
...
void nes_sc127_device::write_h(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void nes_mbaby_device::write_h(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t nes_mbaby_device::read_m(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void nes_asn_device::write_h(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t nes_asn_device::read_m(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void nes_smb3p_device::write_h(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void nes_btl_dn_device::write_h(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	uint8_t bank;
...
void nes_whirl2706_device::write_h(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	LOG_MMC(("whirl2706 write_h, offset: %04x, data: %02x\n", offset, data));
	m_latch = data;
}

uint8_t nes_whirl2706_device::read_m(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void nes_smb2j_device::write_l(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void nes_smb2j_device::write_h(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void nes_smb2j_device::write_ex(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t nes_smb2j_device::read_l(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
uint8_t nes_smb2j_device::read_m(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void nes_smb2ja_device::write_h(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t nes_smb2ja_device::read_m(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void nes_smb2jb_device::write_l(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	uint8_t prg;
...
uint8_t nes_smb2jb_device::read_m(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void nes_smb2jb_device::write_ex(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	uint8_t prg;
...
void nes_09034a_device::write_ex(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t nes_09034a_device::read_m(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void nes_tobidase_device::write_l(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t nes_tobidase_device::read_m(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
uint8_t nes_lh32_device::read_m(address_space &space, offs_t offset, uint8_t mem_mask)
{
	LOG_MMC(("lh32 read_m, offset: %04x\n", offset));
	return m_prg[(m_latch * 0x2000) + (offset & 0x1fff)];
}

uint8_t nes_lh32_device::read_h(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void nes_lh32_device::write_m(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void nes_lh32_device::write_h(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t nes_lh10_device::read_m(address_space &space, offs_t offset, uint8_t mem_mask)
{
	LOG_MMC(("lh10 read_m, offset: %04x\n", offset));
	return m_prg[(0x0e * 0x2000) + (offset & 0x1fff)];
}

uint8_t nes_lh10_device::read_h(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void nes_lh10_device::write_h(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t nes_lh53_device::read_m(address_space &space, offs_t offset, uint8_t mem_mask)
{
	LOG_MMC(("lh53 read_m, offset: %04x\n", offset));
	return m_prg[(m_reg * 0x2000) + (offset & 0x1fff)];
}

uint8_t nes_lh53_device::read_h(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void nes_lh53_device::write_h(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t nes_2708_device::read_m(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void nes_2708_device::write_m(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t nes_2708_device::read_h(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void nes_2708_device::write_h(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void nes_ac08_device::write_ex(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t nes_ac08_device::read_m(address_space &space, offs_t offset, uint8_t mem_mask)
{
	LOG_MMC(("AC-08 read_m, offset: %04x\n", offset));
	return m_prg[(m_latch * 0x2000) + (offset & 0x1fff)];
}

void nes_ac08_device::write_h(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t nes_unl_bb_device::read_m(address_space &space, offs_t offset, uint8_t mem_mask)
{
	LOG_MMC(("unl-bb read_m, offset: %04x\n", offset));
	return m_prg[(((m_reg[0] & 3 & m_prg_mask) * 0x2000) + (offset & 0x1fff))];
}

void nes_unl_bb_device::write_h(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t nes_mmalee_device::read_m(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void nes_mmalee_device::write_m(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void nes_shuiguan_device::write_h(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	int bank;
...
uint8_t nes_shuiguan_device::read_m(address_space &space, offs_t offset, uint8_t mem_mask)
{
	// always first bank??
...
uint8_t nes_rt01_device::read_h(address_space &space, offs_t offset, uint8_t mem_mask)
{
