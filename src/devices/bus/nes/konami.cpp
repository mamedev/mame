...
{
	LOGMASKED(LOG_GENERAL, "VRC-1 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "VRC-2 read_m, offset: %04x\n", offset);
...
{
	LOGMASKED(LOG_GENERAL, "VRC-2 write_m, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "VRC-2 write_h, offset: %04x, data: %02x\n", offset, data);
	...
	switch (offset & 0x7000)
	{
		...
		default:
			LOGMASKED(LOG_GENERAL, "VRC-2 write_h uncaught write, addr: %04x value: %02x\n", offset + 0x8000, data);
			break;
	}
}
...
{
	LOGMASKED(LOG_GENERAL, "VRC-3 write_h, offset: %04x, data: %02x\n", offset, data);
	...
	switch (offset & 0x7000)
	{
		...
		case 0x7000:
			...
			break;
		default:
			LOGMASKED(LOG_GENERAL, "VRC-3 write_h uncaught write, offset %04x, data: %02x\n", offset, data);
			break;
	}
}
...
{
	LOGMASKED(LOG_GENERAL, "VRC-4 read_m, offset: %04x\n", offset);
...
{
	LOGMASKED(LOG_GENERAL, "VRC-4 write_m, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "VRC-4 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "VRC-6 write_h, offset: %04x, data: %02x\n", offset, data);
		...
		case 0x7000:
			switch (addr_lines)
			{
				...
				case 2:
					...
					break;
				default:
					LOGMASKED(LOG_GENERAL, "VRC-6 write_h uncaught write, addr: %04x value: %02x\n", ((offset & 0x7000) | addr_lines) + 0x8000, data);
					break;
			}
			break;
	}
...
{
	LOGMASKED(LOG_GENERAL, "VRC-7 write_h, offset: %04x, data: %02x\n", offset, data);
