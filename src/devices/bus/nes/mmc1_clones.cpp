...
{
	LOGMASKED(LOG_GENERAL, "unl_ninjaryu write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_jy012005 write_m, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_jy820845c write_m, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "bmc_jy820845c write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "farid_slrom write_m, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "srpg5in1 write_l, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "srpg5in1 write_m, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "srpg5in1 read_m, offset: %04x\n", offset);
...
{
	LOGMASKED(LOG_GENERAL, "TXC 22110 write_l, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "TXC 22110 write_h, offset: %04x, data: %02x\n", offset, data);
