...
void nes_action53_device::write_l(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void nes_action53_device::write_h(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
