...
void nes_txc_22211_device::write_l(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t nes_txc_22211_device::read_l(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void nes_txc_22211_device::write_h(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void nes_txc_dumarc_device::write_h(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t nes_txc_mjblock_device::read_l(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void nes_txc_strikew_device::write_h(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t nes_txc_commandos_device::read_l(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return 0x50;
}

void nes_txc_commandos_device::write_h(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
