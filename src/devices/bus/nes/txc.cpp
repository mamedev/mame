...
{
	LOGMASKED(LOG_GENERAL, "TXC 22111 write_l, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "TXC 22111 read_l, offset: %04x\n", offset);
...
{
	LOGMASKED(LOG_GENERAL, "TXC 22111 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "TXC Du Ma Racing write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "TXC mjblock read_l, offset: %04x\n", offset);
...
{
	LOGMASKED(LOG_GENERAL, "TXC 01-22000-400 read_l, offset: %04x\n", offset);
...
{
	LOGMASKED(LOG_GENERAL, "TXC 01-22000-400 write_l, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "TXC 01-22000-400 write_h, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "TXC Commandos write_h, offset: %04x, data: %02x\n", offset, data);
