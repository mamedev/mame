...
void nes_ntdec_asder_device::write_h(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void nes_ntdec_fh_device::write_m(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
