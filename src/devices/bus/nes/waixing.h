...
public:
	...
	virtual void waixing_write(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	virtual void write_h(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff) override { waixing_write(space, offset, data, mem_mask); }
