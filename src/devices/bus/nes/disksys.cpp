...
{
	LOGMASKED(LOG_GENERAL, "Famicom Disk System write_h, offset %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "Famicom Disk System read_h, offset: %04x\n", offset);
...
{
	LOGMASKED(LOG_GENERAL, "Famicom Disk System write_m, offset: %04x, data: %02x\n", offset, data);
	m_prgram[offset] = data;
}

uint8_t nes_disksys_device::read_m(offs_t offset)
{
	LOGMASKED(LOG_GENERAL, "Famicom Disk System read_m, offset: %04x\n", offset);
...
{
	LOGMASKED(LOG_GENERAL, "Famicom Disk System write_ex, offset: %04x, data: %02x\n", offset, data);
...
{
	LOGMASKED(LOG_GENERAL, "Famicom Disk System read_ex, offset: %04x\n", offset);
	uint8_t ret = 0x00;
