...
protected:
		...
		uint32_t procolor816_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
		void procolor816_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
