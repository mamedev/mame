...
protected:
		...
		uint32_t wsportrait_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
		void wsportrait_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
