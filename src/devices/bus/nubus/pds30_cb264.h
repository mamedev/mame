...
protected:
		...
		uint32_t cb264se30_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
		void cb264se30_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
