...
protected:
		...
		uint32_t spec8s3_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
		void spec8s3_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
