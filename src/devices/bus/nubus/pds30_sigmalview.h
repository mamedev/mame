...
protected:
		...
		uint32_t lview_r(address_space &space, offs_t offset, uint32_t mem_mask = 0xffffffff);
		void lview_w(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask = 0xffffffff);
