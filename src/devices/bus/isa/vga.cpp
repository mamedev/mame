...
//-------------------------------------------------
uint8_t isa8_vga_device::input_port_0_r(address_space &space, offs_t offset, uint8_t mem_mask) { return 0xff; } //return space.machine().root_device().ioport("IN0")->read(); }
