...
public:
	uint8_t p1_HDC_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void p1_HDC_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
};
