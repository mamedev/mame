...
isa8_opus_pm100_device::isa8_opus_pm100_device(const machine_config &mconfig, device_type type, const char *tag, device_t *owner, uint32_t clock)
...
isa8_opus_pm110_device::isa8_opus_pm110_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock)
	: isa8_opus_pm100_device(mconfig, ISA8_OPUS_PM110, tag, owner, clock)
{
}
...
ioport_constructor isa8_opus_pm100_device::device_input_ports() const
{
...
void isa8_opus_pm100_device::cpu_map(address_map &map)
{
	...
	map(0x800000, 0x83ffff).rw(FUNC(isa8_opus_pm100_device::slave_reg_r), FUNC(isa8_opus_pm100_device::slave_reg_w));
...
void isa8_opus_pm100_device::device_reset()
{
...
void isa8_opus_pm100_device::reset_card()
{
	set_running(false);
...
void isa8_opus_pm100_device::remap(int space_id, offs_t start, offs_t end)
{
...
void isa8_opus_pm100_device::set_running(bool running)
{
...
TIMER_CALLBACK_MEMBER(isa8_opus_pm100_device::start_cpu)
{
	set_running(true);
}

void isa8_opus_pm100_device::update_host_irq()
{
...
void isa8_opus_pm100_device::irq_line_w(int line, int state)
{
	switch (line)
	{
...
void isa8_opus_pm100_device::set_host_irq(bool state)
{
	m_irq_latch = state;
	update_host_irq();
}
...
offs_t isa8_opus_pm100_device::window_phys(offs_t offset, bool write)
{
...
void isa8_opus_pm100_device::slave_reg_w(offs_t offset, uint8_t data)
{
