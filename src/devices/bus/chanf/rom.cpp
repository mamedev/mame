...
uint8_t chanf_rom_device::read_rom(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
uint8_t chanf_multi_old_device::read_rom(address_space &space, offs_t offset, uint8_t mem_mask)
{
	if (offset < 0x2000)
...
void chanf_multi_old_device::write_bank(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	//printf("0x%x\n", data);
	m_base_bank = data & 0x1f;
}

uint8_t chanf_multi_final_device::read_rom(address_space &space, offs_t offset, uint8_t mem_mask)
{
	if (offset < 0x2000)
...
void chanf_multi_final_device::write_bank(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	//printf("0x%x\n", data);
	m_base_bank = data & 0x1f;
