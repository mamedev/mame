...
public:
	...
	virtual uint16_t read_a13(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff) override;
	virtual void write_a13(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff) override;
