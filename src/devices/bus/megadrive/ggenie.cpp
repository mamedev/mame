...
uint16_t md_rom_ggenie_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
void md_rom_ggenie_device::write(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	if (offset >= 0x40/2)
		return;
