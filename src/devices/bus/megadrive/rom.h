...
public:
	...
	// reading and writing
	virtual uint16_t read(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff) override { if (offset < 0x400000/2) return m_rom[MD_ADDR(offset)]; else return 0xffff; };
