...
uint16_t md_eeprom_stm95_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
uint16_t md_eeprom_stm95_device::read_a13(address_space &space, offs_t offset, uint16_t mem_mask)
{
	if (offset == 0x0a/2)
	{
...
void md_eeprom_stm95_device::write_a13(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	if (offset == 0x00/2)
	{
