...
namespace bus::megadrive::slotoptions {
	...
	extern char const *const HB_EVERDRIVE;
	extern char const *const HB_PSOLAR;
	extern char const *const HB_SSF;
	extern char const *const HB_SSF_SRAM;
	extern char const *const HB_SSF_EX;
	...
	extern char const *const MD_3IN1_FWT;
	extern char const *const MD_BARKLEY2;
	extern char const *const MD_CM2IN1;
	extern char const *const MD_EEPROM;
	extern char const *const MD_EEPROM_BLARA95;
	extern char const *const MD_EEPROM_BLARA96;
	...
	extern char const *const UNL_AVARTISAN;
	...
	extern char const *const UNL_FUTBOL_ARG96;
