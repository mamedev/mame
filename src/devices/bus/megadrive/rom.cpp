...
uint16_t md_rom_sram_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
void md_rom_sram_device::write(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	// since a lot of generic carts ends up here if loaded from fullpath
	// we access nvram only if m_nvram_handlers_installed has been turned on
	if (m_nvram_handlers_installed)
...
void md_rom_sram_device::write_a13(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	if (offset == 0xf0/2)
	{
...
uint16_t md_rom_fram_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
	if (offset >= m_nvram_start/2 && offset <= m_nvram_end/2 && m_nvram_active)
		return m_nvram[offset - m_nvram_start/2];
	if (offset < 0x400000/2)
...
void md_rom_fram_device::write(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	if (offset >= m_nvram_start/2 && offset <= m_nvram_end/2 && m_nvram_active)
			m_nvram[offset - m_nvram_start/2] = data;
}

void md_rom_fram_device::write_a13(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	if (offset == 0xf0/2)
		m_nvram_active = BIT(data, 0);
}
...
uint16_t md_rom_fram_device::read_a13(address_space &space, offs_t offset, uint16_t mem_mask)
{
	if (offset == 0xf0/2)
...
uint16_t md_rom_ssf2_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
	if (offset < 0x400000/2)
		return m_rom[offset];
	else
...
void md_rom_ssf2_device::write_a13(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	if (offset >= 0xf0/2)
	{
		offset -= 0xf0/2;
...
uint16_t md_rom_cm2in1_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
	if (offset < 0x400000/2)
...
uint16_t md_rom_mcpirate_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
	if (offset < 0x400000/2)
...
void md_rom_mcpirate_device::write_a13(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	offset <<= 1;
	if (offset < 0x40)
		m_bank = offset;
...
uint16_t md_rom_bugslife_device::read_a13(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
uint16_t md_rom_chinf3_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
void md_rom_chinf3_device::write(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
uint16_t md_rom_16mj2_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
uint16_t md_rom_elfwor_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
uint16_t md_rom_smouse_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
	if (offset == 0x400000/2)   return 0x5500;
	if (offset == 0x400002/2)   return 0x0f00;
...
uint16_t md_rom_yasech_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
uint16_t md_rom_kof98_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
uint16_t md_rom_kof99_device::read_a13(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
uint16_t md_rom_lion2_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
void md_rom_lion2_device::write(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
uint16_t md_rom_lion3_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
	if (offset < 0x100000/2)
...
void md_rom_lion3_device::write(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	if (offset >= 0x600000/2 && offset < 0x700000/2)
	{
...
uint16_t md_rom_mjlov_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
uint16_t md_rom_cjmjclub_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
	if (offset == 0x400000/2)   return 0x9000;
...
uint16_t md_rom_sbubl_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
	if (offset == 0x400000/2)   return 0x5500;
	if (offset == 0x400002/2)   return 0x0f00;
...
uint16_t md_rom_soulb_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
	if (offset == 0x400002/2)   return 0x9800;
	if (offset == 0x400004/2)   return 0xc900;
	if (offset == 0x400006/2)   return 0xf000;
...
uint16_t md_rom_pokestad_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
	if (offset < 0x100000/2)
...
void md_rom_pokestad_device::write(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
uint16_t md_rom_pokea_device::read_a13(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
uint16_t md_rom_realtec_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
void md_rom_realtec_device::write(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	if (offset == 0x400000/2)
	{
...
uint16_t md_rom_redcl_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
uint16_t md_rom_rx3_device::read_a13(address_space &space, offs_t offset, uint16_t mem_mask)
{
	if (offset == 0)
		return 0x0c;
	else
...
uint16_t md_rom_squir_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
void md_rom_squir_device::write(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	if (offset >= 0x400000/2 && offset < 0x400008/2)
		m_latch = data;
}
...
uint16_t md_rom_smb_device::read_a13(address_space &space, offs_t offset, uint16_t mem_mask)
{
	if (offset == 0)
		return 0x0c;
	else
...
uint16_t md_rom_smb2_device::read_a13(address_space &space, offs_t offset, uint16_t mem_mask)
{
	if (offset == 0)
		return 0x0a;
	else
...
uint16_t md_rom_smw64_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
void md_rom_smw64_device::write(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	// 0x600000-0x6fffff: internal hardware (up to 0x67ffff) + mirror
	// Namely,
...
uint16_t md_rom_tekkensp_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
	if (offset < 0x400000/2)
		return m_rom[MD_ADDR(offset)];
...
void md_rom_tekkensp_device::write(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	if (offset < 0x400000/2)
		return;
...
uint16_t md_rom_topf_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
void md_rom_topf_device::write(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	if (offset >= 0x700000/2 && offset < 0x800000/2)
	{
		if (data == 0x002a)
...
uint16_t md_rom_radica_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
	return m_rom[(((m_bank * 0x10000) + (offset << 1)) & (m_rom_size - 1))/2];
}

uint16_t md_rom_radica_device::read_a13(address_space &space, offs_t offset, uint16_t mem_mask)
{
	if (offset < 0x80)
		m_bank = offset & 0x3f;
	return 0;
...
uint16_t md_rom_beggarp_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
	if (offset >= m_nvram_start/2 && offset <= m_nvram_end/2 && m_nvram_active)
...
void md_rom_beggarp_device::write(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
void md_rom_beggarp_device::write_a13(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	if (offset == 0xf0/2)
	{
		m_nvram_active = BIT(data, 0);
...
uint16_t md_rom_wukong_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
	if (offset >= m_nvram_start/2 && offset <= m_nvram_end/2 && m_nvram_active)
		return m_nvram[offset - m_nvram_start/2];
...
void md_rom_wukong_device::write(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
// this works the same as in standard SRAM carts
void md_rom_wukong_device::write_a13(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	if (offset == 0xf0/2)
	{
		m_nvram_active = BIT(data, 0);
...
uint16_t md_rom_starodys_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
void md_rom_starodys_device::write(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
uint16_t md_rom_starodys_device::read_a13(address_space &space, offs_t offset, uint16_t mem_mask)
{
	return m_base << 4;
}

// this works the same as in standard SRAM carts
void md_rom_starodys_device::write_a13(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	if (offset == 0xf0/2)
	{
		m_nvram_active = BIT(data, 0);
