...
INPUT_PORTS_START(nabu_hle_keyboard)
	...
	PORT_BIT(0x08, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CODE(KEYCODE_F12)         PORT_NAME("|||>")     PORT_CHAR(UCHAR_MAMEKEY(F12))
	PORT_START("ROW3")
	...
	PORT_BIT(0x04, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_CODE(KEYCODE_F11)        PORT_NAME("<|||")      PORT_CHAR(UCHAR_MAMEKEY(F11))
