...
//  m_tms9914->int_write_cb().set(DEVICE_SELF_OWNER, FUNC(a2bus_ieee488_device::irq_w));  // int line not hooked up
...
void a2bus_ieee488_device::device_start()
{
}

void a2bus_ieee488_device::device_reset()
{
}
...
ROM_START(a2ieee488)
	...
	ROM_LOAD( "apple_ieee488.bin", 0x0000, 0x0800, CRC(57a3ece1) SHA1(d5cd452bdb7f9ab5c1d77806ffea4b63da77f714) )
	//  According to Reactive Micro website, this is part number: 341-0059-A
ROM_END
