...
a2bus_agat840k_hle_device::a2bus_agat840k_hle_device(const machine_config &mconfig, device_type type, const char *tag, device_t *owner, uint32_t clock)
	...
	, m_rom(*this, AGAT840K_ROM_REGION)
...
DEFINE_DEVICE_TYPE_PRIVATE(A2BUS_AGAT840K_HLE, device_a2bus_card_interface, a2bus_agat840k_hle_device, "agat840k_hle", "Agat 840K floppy card")
