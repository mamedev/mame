...
uint8_t a2bus_themill_device::dma_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void a2bus_themill_device::dma_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	if (m_6809Mode)
	{
		if (offset <= 0x7fff)
