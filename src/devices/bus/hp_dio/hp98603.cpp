...
/***************************************************************************
  ...
  HP98603A/HP98603B BASIC ROM card
...
class dio16_98603a_device : public dio16_98603_device
{
public:
	// construction/destruction
...
class dio16_98603b_device : public dio16_98603_device
{
public:
	// construction/destruction
...
ROM_START(hp98603a)
	ROM_REGION(0x80000, HP98603_ROM_REGION, 0)
...
{
	dio16_98603_device::device_reset();
...
uint16_t dio16_98603_device::rom_r(offs_t offset)
{
	return get_u16le(&m_rom[offset * 2]);
}

void dio16_98603_device::rom_w(offs_t offset, uint16_t data)
{
}
