...
ROM_START(mface128)
	...
	ROM_SYSTEM_BIOS(1, "vxx0f", "87.2 Vxx 1D") // unknown PCB version
	ROMX_LOAD("mf128_xx_1d.rom", 0x0000, 0x2000, CRC(f473991e) SHA1(f03f4ecbcf4a654f4775d16bda0d4cc47f884379), ROM_BIOS(1))
	ROM_SYSTEM_BIOS(2, "v350d", "87.12 V35 0F")
	ROMX_LOAD("mf128_35_0f.rom", 0x0000, 0x2000, CRC(cfefd560) SHA1(6cd6fd2c0fbb40a989a568db9d08ba8eed49cbbd), ROM_BIOS(1))
	ROM_SYSTEM_BIOS(3, "v340d", "87.1 V34 0D")
	ROMX_LOAD("mf128_34_0d.rom", 0x0000, 0x2000, CRC(8d8cfd39) SHA1(2104962bb6097e58fcab63969bbaca424a872bb5), ROM_BIOS(3))
ROM_END
