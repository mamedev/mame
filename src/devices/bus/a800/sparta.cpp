...
uint8_t a800_rom_spartados_device::read_80xx(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void a800_rom_spartados_device::write_d5xx(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	if (offset & 0x08)
