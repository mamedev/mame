...
uint8_t a800_rom_device::read_80xx(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
uint8_t a800_rom_bbsb_device::read_80xx(address_space &space, offs_t offset, uint8_t mem_mask)
{
	if (offset < 0x1000)
...
void a800_rom_bbsb_device::write_80xx(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t xegs_rom_device::read_80xx(address_space &space, offs_t offset, uint8_t mem_mask)
{
	if (offset < 0x2000)
...
void xegs_rom_device::write_d5xx(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t a800_rom_williams_device::read_80xx(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_rom[(offset & 0x1fff) + (m_bank * 0x2000)];
}

void a800_rom_williams_device::write_d5xx(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_bank = (offset & 0x07);
}
...
uint8_t a800_rom_express_device::read_80xx(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_rom[(offset & 0x1fff) + (m_bank * 0x2000)];
}

void a800_rom_express_device::write_d5xx(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t a800_rom_turbo_device::read_80xx(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_rom[(offset & 0x1fff) + (m_bank * 0x2000)];
}

void a800_rom_turbo_device::write_d5xx(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t a800_rom_telelink2_device::read_80xx(address_space &space, offs_t offset, uint8_t mem_mask)
{
	if (offset >= 0x2000)
...
void a800_rom_telelink2_device::write_80xx(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_nvram[offset & 0xff] = data | 0xf0;   // low 4bits only
}

uint8_t a800_rom_telelink2_device::read_d5xx(address_space &space, offs_t offset, uint8_t mem_mask)
{
	// this should affect NVRAM enable / save
	return 0xff;
}

void a800_rom_telelink2_device::write_d5xx(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	// this should affect NVRAM enable / save
}
...
uint8_t a800_rom_microcalc_device::read_80xx(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_rom[(offset & 0x1fff) + (m_bank * 0x2000)];
}

void a800_rom_microcalc_device::write_d5xx(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_bank = data;
}
...
uint8_t a5200_rom_2chips_device::read_80xx(address_space &space, offs_t offset, uint8_t mem_mask)
{
	if (offset < 0x4000)
		return m_rom[offset & 0x1fff];
	else
...
uint8_t a5200_rom_bbsb_device::read_80xx(address_space &space, offs_t offset, uint8_t mem_mask)
{
	if (offset < 0x1000)
		return m_rom[(offset & 0xfff) + (m_banks[0] * 0x1000) + 0];
	else if (offset < 0x2000)
...
void a5200_rom_bbsb_device::write_80xx(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	uint16_t addr = offset & 0xfff;
	if (addr >= 0xff6 && addr <= 0xff9)
		m_banks[BIT(offset, 12)] = (addr - 0xff6);
