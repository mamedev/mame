...
INPUT_PORTS_START( pc6022 )
	PORT_START("PB") // TODO: verify button order / switch polarity
	...
	PORT_BIT( 0x60, IP_ACTIVE_HIGH, IPT_OUTPUT )  // TODO (set/cleared during timer irq)
...
{
	// TODO: motor control?
	// data is treated as two 4-bit values, only set/cleared during timer irq
