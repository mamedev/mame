...
uint16_t fatfury2_prot_device::protection_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
...
void fatfury2_prot_device::protection_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	switch (offset)
	{
