...
void neogeo_kf2k3bl_cart_device::device_add_mconfig(machine_config &config)
{
	...
	NG_KOF2K3BL_PROT(config, m_kof2k3bl_prot, 0);
}
...
neogeo_kf2k3bl_cart_device::neogeo_kf2k3bl_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, u32 clock) :
...
neogeo_kf2k3pl_cart_device::neogeo_kf2k3pl_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, u32 clock) :
...
neogeo_kf2k3upl_cart_device::neogeo_kf2k3upl_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, u32 clock) :
