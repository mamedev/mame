...
public:
	...
	neogeo_sma_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, u32 clock);
	...
	virtual u32 get_bank_base(u16 sel) override { return 0; }

	virtual void decrypt_all(DECRYPT_ALL_PARAMS) override {}
	virtual int get_fixed_bank_type() override { return 0; }

protected:
	neogeo_sma_cart_device(const machine_config &mconfig, device_type type, const char *tag, device_t *owner, u32 clock);
...
{
public:
	neogeo_sma_kof99_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, u32 clock);
	virtual void decrypt_all(DECRYPT_ALL_PARAMS) override;
	virtual int get_fixed_bank_type() override { return 1; }
	virtual u32 get_bank_base(u16 sel) override { return m_sma_prot->kof99_bank_base(sel); }
};
...
{
public:
	neogeo_sma_garou_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, u32 clock);
	virtual void decrypt_all(DECRYPT_ALL_PARAMS) override;
	virtual int get_fixed_bank_type() override { return 1; }
	virtual u32 get_bank_base(u16 sel) override { return m_sma_prot->garou_bank_base(sel); }
};
...
{
public:
	neogeo_sma_garouh_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, u32 clock);
	virtual void decrypt_all(DECRYPT_ALL_PARAMS) override;
	virtual int get_fixed_bank_type() override { return 1; }
	virtual u32 get_bank_base(u16 sel) override { return m_sma_prot->garouh_bank_base(sel); }
};
...
{
public:
	neogeo_sma_mslug3_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, u32 clock);
	virtual void decrypt_all(DECRYPT_ALL_PARAMS) override;
	virtual int get_fixed_bank_type() override { return 1; }
	virtual u32 get_bank_base(u16 sel) override { return m_sma_prot->mslug3_bank_base(sel); }
};
...
{
public:
	neogeo_sma_mslug3a_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, u32 clock);
	virtual void decrypt_all(DECRYPT_ALL_PARAMS) override;
	virtual int get_fixed_bank_type() override { return 1; }
	virtual u32 get_bank_base(u16 sel) override { return m_sma_prot->mslug3a_bank_base(sel); }
};
...
{
public:
	neogeo_sma_kof2000_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, u32 clock);
	virtual void decrypt_all(DECRYPT_ALL_PARAMS) override;
	virtual int get_fixed_bank_type() override { return 2; }
	virtual u32 get_bank_base(u16 sel) override { return m_sma_prot->kof2000_bank_base(sel); }
};
