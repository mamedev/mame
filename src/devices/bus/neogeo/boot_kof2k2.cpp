...
void neogeo_kof2002b_cart_device::device_add_mconfig(machine_config &config)
{
	...
	NG_KOF2002_PROT(config, m_kof2k2_prot, 0);
}
...
neogeo_kof2002b_cart_device::neogeo_kof2002b_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, u32 clock) :
...
neogeo_kf2k2mp_cart_device::neogeo_kf2k2mp_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, u32 clock) :
...
neogeo_kf2k2mp2_cart_device::neogeo_kf2k2mp2_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, u32 clock) :
