...
void mslugx_prot_device::protection_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	switch (offset)
	{
...
uint16_t mslugx_prot_device::protection_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	uint16_t res = 0;
