...
u32 sma_prot_device::kof99_bank_base(u16 sel)
{
	static const int bankoffset[64] =
	{
		0x000000, 0x100000, 0x200000, 0x300000,
...
u32 sma_prot_device::garou_bank_base(u16 sel)
{
	static const int bankoffset[64] =
	{
		0x000000, 0x100000, 0x200000, 0x300000, // 00
...
u32 sma_prot_device::garouh_bank_base(u16 sel)
{
	static const int bankoffset[64] =
	{
		0x000000, 0x100000, 0x200000, 0x300000, // 00
...
u32 sma_prot_device::mslug3_bank_base(u16 sel)
{
	static const int bankoffset[64] =
	{
		0x000000, 0x020000, 0x040000, 0x060000, // 00
...
u32 sma_prot_device::mslug3a_bank_base(u16 sel)
{
	static const int bankoffset[64] =
	{
...
u32 sma_prot_device::kof2000_bank_base(u16 sel)
{
	static const int bankoffset[64] =
	{
		0x000000, 0x100000, 0x200000, 0x300000, // 00
