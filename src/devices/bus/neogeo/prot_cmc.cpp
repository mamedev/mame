...
void cmc_prot_device::decrypt(u8 *r0, u8 *r1,
					u8 c0,  u8 c1,
					const u8 *table0hi,
					const u8 *table0lo,
					const u8 *table1,
...
void cmc_prot_device::gfx_decrypt(u8* rom, u32 rom_size, int extra_xor)
{
	int rpos;
...
void cmc_prot_device::cmc42_gfx_decrypt(u8* rom, u32 rom_size, int extra_xor)
{
...
// REMOVE ME!!!!
void cmc_prot_device::kof99_neogeo_gfx_decrypt(u8* rom, u32 rom_size, u8* fixed, u32 fixed_size, int extra_xor)
{
...
void cmc_prot_device::cmc50_gfx_decrypt(u8* rom, u32 rom_size, int extra_xor)
{
...
// REMOVE ME!!!!
void cmc_prot_device::kof2000_neogeo_gfx_decrypt(u8* rom, u32 rom_size, u8* fixed, u32 fixed_size, int extra_xor)
{
...
void cmc_prot_device::sfix_decrypt(u8* rom, u32 rom_size, u8* fixed, u32 fixed_size)
{
...
void cmc_prot_device::cmc50_m1_decrypt(u8* romcrypt, u32 romcrypt_size, u8* romaudio, u32 romaudio_size)
{
	u8* rom = romcrypt;
