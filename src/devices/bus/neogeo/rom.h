...
public:
	...
	neogeo_rom_device(const machine_config &mconfig, const char *tag, device_t *owner, u32 clock);
...
protected:
	neogeo_rom_device(const machine_config &mconfig, device_type type, const char *tag, device_t *owner, u32 clock);
...
{
public:
	neogeo_vliner_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, u32 clock);
