...
neogeo_svcboot_cart_device::neogeo_svcboot_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, u32 clock) :
...
void neogeo_svcboot_cart_device::device_add_mconfig(machine_config &config)
{
	...
	NG_PVC_PROT(config, m_pvc_prot, 0);
}
...
neogeo_svcplus_cart_device::neogeo_svcplus_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, u32 clock) :
...
neogeo_svcplusa_cart_device::neogeo_svcplusa_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, u32 clock) :
...
neogeo_svcsplus_cart_device::neogeo_svcsplus_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, u32 clock) :
