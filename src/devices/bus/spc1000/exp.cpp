...
uint8_t spc1000_exp_device::read(address_space &space, offs_t offset, uint8_t mem_mask)
{
	if (m_card)
...
void spc1000_exp_device::write(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	if (m_card)
