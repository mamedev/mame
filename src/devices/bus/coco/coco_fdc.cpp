...
void coco_fdc_device_base::device_add_mconfig(machine_config &config)
{
	...
	FLOPPY_CONNECTOR(config, m_floppies[0], coco_fdc_floppies, "525qd", coco_fdc_device_base::floppy_formats).enable_sound(true);
	FLOPPY_CONNECTOR(config, m_floppies[1], coco_fdc_floppies, "525qd", coco_fdc_device_base::floppy_formats).enable_sound(true);
