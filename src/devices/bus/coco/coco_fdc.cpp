...
ROM_START(coco_scii)
	...
	ROM_SYSTEM_BIOS(2, "eados3-102-drt", "Extended A-DOS 3 1.03 for the CoCo 3 with Disto real time board")
	ROMX_LOAD("e-ados3-102-40-drt.bin", 0x0000, 0x4000, CRC(682bbd9b) SHA1(da773c566368f6094d3c8901bfb29a445bc7e84e), ROM_BIOS(2))
	ROM_RELOAD(0x4000,0x4000)
ROM_END
