...
static MACHINE_CONFIG_FRAGMENT(coco_ssc)
	MCFG_CPU_ADD(PIC_TAG, TMS7040, XTAL_3_579545MHz / 2)	// perhaps should be DERIVED_CLOCK(1, 2)
	...
	MCFG_SOUND_ADD(AY_TAG, AY8913, XTAL_3_579545MHz / 4)	// perhaps should be DERIVED_CLOCK(1, 2)
