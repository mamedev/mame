...
uint8_t crvision_rom_device::read_rom80(address_space &space, offs_t offset, uint8_t mem_mask)
{
	offset &= 0x1fff;
	if (offset < 0x1000)
		return 0xff;
...
uint8_t crvision_rom6k_device::read_rom80(address_space &space, offs_t offset, uint8_t mem_mask)
{
	offset &= 0x1fff;
	if (offset < 0x1000)
...
uint8_t crvision_rom8k_device::read_rom80(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_rom[offset & 0x1fff];
}


uint8_t crvision_rom10k_device::read_rom80(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_rom[offset & 0x1fff];
}

uint8_t crvision_rom10k_device::read_rom40(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_rom[0x2000 + (offset & 0x7ff)];
}


uint8_t crvision_rom12k_device::read_rom80(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_rom[offset & 0x1fff];
}

uint8_t crvision_rom12k_device::read_rom40(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_rom[0x2000 + (offset & 0xfff)];
}


uint8_t crvision_rom16k_device::read_rom80(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
uint8_t crvision_rom18k_device::read_rom80(address_space &space, offs_t offset, uint8_t mem_mask)
{
	// lower 8K in 0xa000-0xbfff, higher 8K in 0x8000-0x9fff
	return m_rom[offset ^ 0x2000];
}

uint8_t crvision_rom18k_device::read_rom40(address_space &space, offs_t offset, uint8_t mem_mask)
{
