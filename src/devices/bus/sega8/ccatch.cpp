...
uint8_t sega8_cardcatch_device::read_cart(address_space &space, offs_t offset, uint8_t mem_mask)
{
	if (offset < 0x8000)
...
void sega8_cardcatch_device::write_cart(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
