...
static INPUT_PORTS_START( sk1100_keys )
	...
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_KEYBOARD ) PORT_NAME(u8"π") PORT_CODE(KEYCODE_EQUALS) PORT_CHAR(0x03c0)
	...
	PORT_START("PB5")
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_KEYBOARD ) PORT_NAME(u8"¥") PORT_CODE(KEYCODE_TILDE) PORT_CHAR(0x00a5)
