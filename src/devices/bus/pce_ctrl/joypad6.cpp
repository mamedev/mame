...
static INPUT_PORTS_START( pce_joypad6 )
	...
	// 2 button mode
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON2 ) PORT_NAME("Button I")   PORT_CONDITION("JOY_MODE",0x01,NOTEQUALS,0x01) // Rightmost in bottom row
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON1 ) PORT_NAME("Button II")  PORT_CONDITION("JOY_MODE",0x01,NOTEQUALS,0x01)
	// 6 button mode
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON3 ) PORT_NAME("Button I")   PORT_CONDITION("JOY_MODE",0x01,EQUALS,0x01)    // Rightmost in bottom row
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON2 ) PORT_NAME("Button II")  PORT_CONDITION("JOY_MODE",0x01,EQUALS,0x01)
	...
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON1 ) PORT_NAME("Button III") PORT_CONDITION("JOY_MODE",0x01,EQUALS,0x01) // Leftmost in bottom row
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON4 ) PORT_NAME("Button IV")  PORT_CONDITION("JOY_MODE",0x01,EQUALS,0x01)
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON5 ) PORT_NAME("Button V")   PORT_CONDITION("JOY_MODE",0x01,EQUALS,0x01)
	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_BUTTON6 ) PORT_NAME("Button VI")  PORT_CONDITION("JOY_MODE",0x01,EQUALS,0x01)
...
static INPUT_PORTS_START( pce_arcade_pad_6 )
	...
	// these are affected when 6 buttons mode only
	PORT_BIT(      0xf0, IP_ACTIVE_HIGH, IPT_UNUSED ) PORT_CONDITION("JOY_MODE",0x01,NOTEQUALS,0x01)
	PORT_CONFNAME( 0x10, 0x00, "Button III Turbo" )   PORT_CONDITION("JOY_MODE",0x01,EQUALS,0x01)
	PORT_CONFSETTING(    0x00, DEF_STR( Off ) )
	PORT_CONFSETTING(    0x10, DEF_STR( On ) )
	PORT_CONFNAME( 0x20, 0x00, "Button IV Turbo" )    PORT_CONDITION("JOY_MODE",0x01,EQUALS,0x01)
	PORT_CONFSETTING(    0x00, DEF_STR( Off ) )
	PORT_CONFSETTING(    0x20, DEF_STR( On ) )
	PORT_CONFNAME( 0x40, 0x00, "Button V Turbo" )     PORT_CONDITION("JOY_MODE",0x01,EQUALS,0x01)
	PORT_CONFSETTING(    0x00, DEF_STR( Off ) )
	PORT_CONFSETTING(    0x40, DEF_STR( On ) )
	PORT_CONFNAME( 0x80, 0x00, "Button VI Turbo" )    PORT_CONDITION("JOY_MODE",0x01,EQUALS,0x01)
	PORT_CONFSETTING(    0x00, DEF_STR( Off ) )
