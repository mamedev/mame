...
uint8_t msx_cart_rtype::read_cart(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void msx_cart_rtype::write_cart(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
