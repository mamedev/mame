...
uint8_t msx_cart_hfox::read_cart(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void msx_cart_hfox::write_cart(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	switch (offset)
	{
		case 0x6000:
