...
uint8_t msx_cart_halnote::read_cart(address_space &space, offs_t offset, uint8_t mem_mask)
{
	if (offset >= 0xc000)
	{
		return 0xFF;
...
void msx_cart_halnote::write_cart(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	if (offset < 0x4000)
	{
