...
static INPUT_PORTS_START( psx_analog_controller )
	PORT_START("PSXPAD0")
	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_HAT_LEFT )
	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_HAT_DOWN )
	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_HAT_RIGHT )
	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_HAT_UP )
	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_START )
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_BUTTON2 ) PORT_NAME("R3")
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_BUTTON1 ) PORT_NAME("L3")
	...
	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_SHOULDER_BUTTON_R1 ) PORT_NAME("R1")
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SHOULDER_BUTTON_L1 ) PORT_NAME("L1")
	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_SHOULDER_BUTTON_R2 ) PORT_NAME("R2")
	PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_SHOULDER_BUTTON_L2 ) PORT_NAME("L2")
