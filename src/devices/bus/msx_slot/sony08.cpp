...
uint8_t msx_slot_sony08_device::read(address_space &space, offs_t offset, uint8_t mem_mask)
{
	if (offset >= 0xc000)
	{
		return 0xFF;
...
void msx_slot_sony08_device::write(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	if (offset < 0x4000)
	{
