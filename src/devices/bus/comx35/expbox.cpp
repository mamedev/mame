...
{
	COMX_EXPANSION_SLOT(config, SLOT1_TAG, DERIVED_CLOCK(1, 1), comx_expansion_cards, "fd").irq_callback().set(FUNC(comx_eb_device::slot1_irq_w));
	COMX_EXPANSION_SLOT(config, SLOT2_TAG, DERIVED_CLOCK(1, 1), comx_expansion_cards, "clm").irq_callback().set(FUNC(comx_eb_device::slot2_irq_w));
	COMX_EXPANSION_SLOT(config, SLOT3_TAG, DERIVED_CLOCK(1, 1), comx_expansion_cards, "joy").irq_callback().set(FUNC(comx_eb_device::slot3_irq_w));
	COMX_EXPANSION_SLOT(config, SLOT4_TAG, DERIVED_CLOCK(1, 1), comx_expansion_cards, "ram").irq_callback().set(FUNC(comx_eb_device::slot4_irq_w));
}
