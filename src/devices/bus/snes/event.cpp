...
uint8_t sns_pfest94_device::read_l(address_space &space, offs_t offset, uint8_t mem_mask)
{
	// menu
...
uint8_t sns_pfest94_device::read_h(address_space &space, offs_t offset, uint8_t mem_mask)
{
	// menu
	if ((offset & 0x208000) == 0x208000)
	{
...
uint8_t sns_pfest94_device::chip_read(address_space &space, offs_t offset, uint8_t mem_mask)
{
	if (offset & 0x8000)
	{
		// menu access
...
void sns_pfest94_device::chip_write(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	if (offset & 0x8000)
	{
		// menu access
...
uint32_t sns_pfest94_device::necdsp_prg_r(address_space &space, offs_t offset, uint32_t mem_mask)
{
	return get_prg(&m_bios[0], offset);
}

uint16_t sns_pfest94_device::necdsp_data_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
