...
uint8_t generic_ram_plain_device::read_ram(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void generic_ram_plain_device::write_ram(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	if (offset < m_ram.size())
		m_ram[offset] = data;
}
...
uint8_t generic_ram_linear_device::read_ram(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_ram[offset % m_ram.size()];
}

void generic_ram_linear_device::write_ram(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
