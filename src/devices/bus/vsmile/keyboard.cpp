...
void vsmile_keyboard_device::device_start()
{
	...
	m_idle_timer = timer_alloc(*this, FUNC(vsmile_keyboard_device::handle_idle));
	m_hello_timer = timer_alloc(*this, FUNC(vsmile_keyboard_device::handle_hello));
	m_hello_timeout_timer = timer_alloc(*this, FUNC(vsmile_keyboard_device::handle_hello_timeout));
