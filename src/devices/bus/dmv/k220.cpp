...
void dmv_k220_device::porta_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
void dmv_k220_device::portc_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	/*
	    xxxx ---- not connected
	    ---- x--- PIT gate 2
