...
void pit68230_device::write(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t pit68230_device::read(address_space &space, offs_t offset, uint8_t mem_mask){
	uint8_t data;
