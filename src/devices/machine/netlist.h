...
protected:
	...
	ATTR_COLD virtual uint32_t opcode_alignment() const override { return 1; }
	ATTR_COLD virtual offs_t disassemble(std::ostream &stream, offs_t pc, const data_buffer &opcodes, const data_buffer &params, uint32_t options) override;
