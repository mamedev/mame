...
uint8_t mc2661_device::read(address_space &space, offs_t offset, uint8_t mem_mask)
{
	uint8_t data = 0;
...
void mc2661_device::write(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	switch (offset & 0x03)
	{
	case REGISTER_HOLDING:
