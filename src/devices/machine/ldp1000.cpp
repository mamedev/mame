...
uint8_t sony_ldp1000_device::status_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void sony_ldp1000_device::command_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	printf("CMD %02x\n",data);
