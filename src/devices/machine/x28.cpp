...
DEFINE_DEVICE_TYPE(X28HC256, x28hc256_device, "x28hc256", "X28HC64 32Kx8 EEPROM")
...
DEFINE_DEVICE_TYPE(X28F256, x28f256_device, "x28f256", "Fast X28C256 8Kx8 EEPROM (T_WC=0)")
