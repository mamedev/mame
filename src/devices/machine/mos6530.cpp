...
void mos6530_device::write(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t mos6530_device::read(address_space &space, offs_t offset, uint8_t mem_mask)
{
	uint8_t val;
