...
uint8_t z80sti_device::read(address_space &space, offs_t offset, uint8_t mem_mask)
{
	uint8_t data = 0;
...
void z80sti_device::write(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	switch (offset & 0x0f)
	{
	case REGISTER_IR:
