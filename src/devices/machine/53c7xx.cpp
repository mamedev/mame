...
uint32_t ncr53c7xx_device::read(address_space &space, offs_t offset, uint32_t mem_mask)
{
...
void ncr53c7xx_device::write(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
