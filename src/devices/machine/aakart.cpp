...
uint8_t aakart_device::read(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void aakart_device::write(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
