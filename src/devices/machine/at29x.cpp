...
*/
uint8_t at29x_device::read(address_space &space, offs_t offset, uint8_t mem_mask)
{
	int reply;
...
*/
void at29x_device::write(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	offset &= m_address_mask;
