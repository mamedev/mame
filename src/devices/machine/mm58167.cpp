...
uint8_t mm58167_device::read(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void mm58167_device::write(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
//  printf("%02x to reg %x\n", data, offset);
