...
void spg2xx_io_device::device_start()
{
	...
	m_tmb1 = timer_alloc(*this, FUNC(spg2xx_io_device::tmb_timer_tick<0>));
	m_tmb2 = timer_alloc(*this, FUNC(spg2xx_io_device::tmb_timer_tick<1>));

	m_uart_tx_timer = timer_alloc(*this, FUNC(spg2xx_io_device::uart_transmit_tick));
	m_uart_rx_timer = timer_alloc(*this, FUNC(spg2xx_io_device::uart_receive_tick));

	m_4khz_timer = timer_alloc(*this, FUNC(spg2xx_io_device::system_timer_tick));

	m_timer_src_ab = timer_alloc(*this, FUNC(spg2xx_io_device::timer_ab_tick));
	m_timer_src_c = timer_alloc(*this, FUNC(spg2xx_io_device::timer_c_tick));
	m_rng_timer = timer_alloc(*this, FUNC(spg2xx_io_device::rng_clock_tick));
	m_watchdog_timer = timer_alloc(*this, FUNC(spg2xx_io_device::watchdog_tick));
	m_spi_tx_timer = timer_alloc(*this, FUNC(spg2xx_io_device::spi_tx_tick));

	m_adc_timer[0] = timer_alloc(*this, FUNC(spg2xx_io_device::adc_convert_tick<0>));
	m_adc_timer[1] = timer_alloc(*this, FUNC(spg2xx_io_device::adc_convert_tick<1>));
	m_adc_timer[2] = timer_alloc(*this, FUNC(spg2xx_io_device::adc_convert_tick<2>));
	m_adc_timer[3] = timer_alloc(*this, FUNC(spg2xx_io_device::adc_convert_tick<3>));
