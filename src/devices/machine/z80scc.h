...
public:
	...
	uint8_t ba_cd_inv_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void ba_cd_inv_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	...
	uint8_t zbus_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
	void zbus_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
