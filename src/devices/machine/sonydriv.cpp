...
{
	switch(drive) {
		case 0 : return machine.root_device().subdevice<legacy_floppy_image_device>(FLOPPY_0);
		case 1 : return machine.root_device().subdevice<legacy_floppy_image_device>(FLOPPY_1);
		case 2 : return machine.root_device().subdevice<legacy_floppy_image_device>(FLOPPY_2);
		case 3 : return machine.root_device().subdevice<legacy_floppy_image_device>(FLOPPY_3);
	}
	return nullptr;
}
