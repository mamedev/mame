...
uint8_t nsc810_device::read(address_space &space, offs_t offset, uint8_t mem_mask)
{
	uint8_t res = 0xff;
...
void nsc810_device::write(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	uint32_t rate;
