...
uint8_t pioneer_pr8210_device::i8049_pia_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	uint8_t result = 0xff;
	switch (offset)
	{
...
void pioneer_pr8210_device::i8049_pia_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	uint8_t value;
	switch (offset)
	{
...
uint8_t pioneer_pr8210_device::i8049_bus_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	/*
	   $80 = n/c
...
void pioneer_pr8210_device::i8049_port1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	/*
	   $80 = (out) SCAN C (F/R)
	   $40 = (out) AUDIO SQ
...
void pioneer_pr8210_device::i8049_port2_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	/*
	   $80 = (out) /CS on PIA
...
uint8_t pioneer_pr8210_device::i8049_t0_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	// returns VSYNC state
	return !m_vsync;
}
...
uint8_t pioneer_pr8210_device::i8049_t1_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return 1;
}
...
uint8_t simutrek_special_device::i8748_port2_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void simutrek_special_device::i8748_port2_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	// update stat
...
uint8_t simutrek_special_device::i8748_data_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
uint8_t simutrek_special_device::i8748_t0_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
