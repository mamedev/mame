...
void ds1386_device::data_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t ds1386_device::data_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	if (offset >= m_ram_size)
		return 0;
