...
uint8_t mc6843_device::read(address_space &space, offs_t offset, uint8_t mem_mask)
{
	uint8_t data = 0;
...
void mc6843_device::write(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	switch ( offset ) {
