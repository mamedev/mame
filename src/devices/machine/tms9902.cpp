...
*/
uint8_t tms9902_device::cruread(address_space &space, offs_t offset, uint8_t mem_mask)
{
	uint8_t answer = 0;
...
/*
    TMS9902 CRU write
*/
void tms9902_device::cruwrite(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
