...
const uint16_t mm5740_device::mm5740AAC_Shift_mapping[9][10] = {
	{
		0b00101111111,  // X1 Y1
		0b00101011111,  // X1 Y2
		0b00101101111,  // X1 Y3
...
const uint16_t mm5740_device::mm5740AAC_Control_mapping[9][10] = {
	{
		0b00110111111,  // X1 Y1
		0b00110011111,  // X1 Y2
		0b00110101111,  // X1 Y3
...
const uint16_t mm5740_device::mm5740AAC_ShiftControl_mapping[9][10] = {
	{
		0b00100111111,  // X1 Y1
		0b00100011111,  // X1 Y2
		0b00100101111,  // X1 Y3
