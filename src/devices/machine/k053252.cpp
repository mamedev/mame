...
uint8_t k053252_device::read(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void k053252_device::write(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_regs[offset] = data;
