...
#ifndef MAME_MACHINE_SIS950_ACPI_H
#define MAME_MACHINE_SIS950_ACPI_H
...
DECLARE_DEVICE_TYPE(SIS950_ACPI, sis950_acpi_device)

#endif // MAME_MACHINE_SIS950_ACPI_H
