...
uint16_t aicartc_device::read(address_space &space, offs_t offset, uint16_t mem_mask)
{
	uint16_t res;
...
void aicartc_device::write(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	switch(offset)
	{
		case 0:
