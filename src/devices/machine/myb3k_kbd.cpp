...
/*	PORT_BIT( 0x0008U, IP_ACTIVE_HIGH, IPT_KEYBOARD ) PORT_CODE(KEYCODE_BACKSLASH) PORT_CONDITION("MYB3K_CFG", 0x03, EQUALS, 0x00) // Swedish Step/One
                                                                                       PORT_NAME("< >") PORT_CHAR('<') PORT_CHAR('>') // 28
	PORT_BIT( 0x0008U, IP_ACTIVE_HIGH, IPT_KEYBOARD ) PORT_CODE(KEYCODE_BACKSLASH) PORT_CONDITION("MYB3K_CFG", 0x03, EQUALS, 0x01) // Australian JB3000
                                                                                       PORT_NAME("\\ |") PORT_CHAR('\\') PORT_CHAR('|') // 28
*/
...
//                                                                                  PORT_NAME(", ;") PORT_CHAR(',')  PORT_CHAR(';') // 66
        PORT_BIT( 0x0040U, IP_ACTIVE_HIGH, IPT_KEYBOARD ) PORT_CODE(KEYCODE_COMMA) PORT_CONDITION("MYB3K_CFG", 0x03, EQUALS, 0x00) // Australian JB3000
                                                                                   PORT_NAME(", <") PORT_CHAR(',')  PORT_CHAR('<') // 66
...
//                                                                                   PORT_NAME(". :") PORT_CHAR('.')  PORT_CHAR(':') // 67
	PORT_BIT( 0x0080U, IP_ACTIVE_HIGH, IPT_KEYBOARD ) PORT_CODE(KEYCODE_STOP) PORT_CONDITION("MYB3K_CFG", 0x03, EQUALS, 0x00) // Australian JB3000
                                                                                   PORT_NAME(". >") PORT_CHAR('.')  PORT_CHAR('>') // 67
