...
uint8_t tms7000_device::tms7000_pf_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	switch (offset)
	{
		// i/o control
...
void tms7000_device::tms7000_pf_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	switch (offset)
	{
		// i/o control (IOCNT0)
...
uint8_t tms70c46_device::control_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_control;
}

void tms70c46_device::control_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t tms70c46_device::dockbus_status_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	// d0: slave _HSK
	// d1: slave _BAV
	// d2: unused?
...
void tms70c46_device::dockbus_status_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t tms70c46_device::dockbus_data_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return 0xff;
}

void tms70c46_device::dockbus_data_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
}
