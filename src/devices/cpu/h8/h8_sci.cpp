...
void h8_sci_device::smr_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	smr = data;
...
uint8_t h8_sci_device::smr_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	if(V>=2) logerror("smr_r %02x (%06x)\n", smr, cpu->pc());
	return smr;
}

void h8_sci_device::brr_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	brr = data;
...
uint8_t h8_sci_device::brr_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void h8_sci_device::scr_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t h8_sci_device::scr_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	if(V>=2) logerror("scr_r %02x (%06x)\n", scr, cpu->pc());
	return scr;
}

void h8_sci_device::tdr_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t h8_sci_device::tdr_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	if(V>=2) logerror("tdr_r %02x (%06x)\n", tdr, cpu->pc());
	return tdr;
}

void h8_sci_device::ssr_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	cpu->synchronize();
...
uint8_t h8_sci_device::ssr_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	if(V>=3) logerror("ssr_r %02x (%06x)\n", ssr, cpu->pc());
	return ssr;
}

uint8_t h8_sci_device::rdr_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
...
void h8_sci_device::scmr_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	if(V>=2) logerror("scmr_w %02x (%06x)\n", data, cpu->pc());
}

uint8_t h8_sci_device::scmr_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
