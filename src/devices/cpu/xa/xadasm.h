...
#define XA_CALL_PARAMS opcode, stream, pc, opcodes, params
...
public:
	...
	const char* m_branches[15] = { "BCC", "BCS", "BNE", "BEQ", "BNV", "BOV", "BPL", "BMI", "BG", "BL", "BGE", "BLT", "BGT", "BLE" };
	...
	int handle_alu_type1(XA_DASM_PARAMS, uint8_t opcode2);
