...
void hyperstone_device::execute_run()
{
	...
	do
	{
		...
		switch ((OP >> 8) & 0x00ff)
		{
			...
			case 0xdc: hyperstone_stwp_global(); break;
			case 0xdd: hyperstone_stwp_local(); break;
			case 0xde: hyperstone_stdp_global(); break;
			case 0xdf: hyperstone_stdp_local(); break;
