 ...
 ***************************************************************/
#define OP(prefix,opcode) inline void r800_device::prefix##_##opcode()
...
**********************************************************/
OP(xycb,00) { illegal_1();                           } /* DB   DD          */
OP(xycb,01) { illegal_1();                           } /* DB   DD          */
OP(xycb,02) { illegal_1();                           } /* DB   DD          */
OP(xycb,03) { illegal_1();                           } /* DB   DD          */
OP(xycb,04) { illegal_1();                           } /* DB   DD          */
OP(xycb,05) { illegal_1();                           } /* DB   DD          */
OP(xycb,06) { wm(m_ea, rlc(rm_reg(m_ea)));           } /* RLC  (XY+o)      */
OP(xycb,07) { illegal_1();                           } /* DB   DD          */

OP(xycb,08) { illegal_1();                           } /* DB   DD          */
OP(xycb,09) { illegal_1();                           } /* DB   DD          */
OP(xycb,0a) { illegal_1();                           } /* DB   DD          */
OP(xycb,0b) { illegal_1();                           } /* DB   DD          */
OP(xycb,0c) { illegal_1();                           } /* DB   DD          */
OP(xycb,0d) { illegal_1();                           } /* DB   DD          */
OP(xycb,0e) { wm(m_ea,rrc(rm_reg(m_ea)));            } /* RRC  (XY+o)      */
OP(xycb,0f) { illegal_1();                           } /* DB   DD          */

OP(xycb,10) { illegal_1();                           } /* DB   DD          */
OP(xycb,11) { illegal_1();                           } /* DB   DD          */
OP(xycb,12) { illegal_1();                           } /* DB   DD          */
OP(xycb,13) { illegal_1();                           } /* DB   DD          */
OP(xycb,14) { illegal_1();                           } /* DB   DD          */
OP(xycb,15) { illegal_1();                           } /* DB   DD          */
OP(xycb,16) { wm(m_ea,rl(rm_reg(m_ea)));             } /* RL   (XY+o)      */
OP(xycb,17) { illegal_1();                           } /* DB   DD          */

OP(xycb,18) { illegal_1();                           } /* DB   DD          */
OP(xycb,19) { illegal_1();                           } /* DB   DD          */
OP(xycb,1a) { illegal_1();                           } /* DB   DD          */
OP(xycb,1b) { illegal_1();                           } /* DB   DD          */
OP(xycb,1c) { illegal_1();                           } /* DB   DD          */
OP(xycb,1d) { illegal_1();                           } /* DB   DD          */
OP(xycb,1e) { wm(m_ea, rr(rm_reg(m_ea)));            } /* RR   (XY+o)      */
OP(xycb,1f) { illegal_1();                           } /* DB   DD          */

OP(xycb,20) { illegal_1();                           } /* DB   DD          */
OP(xycb,21) { illegal_1();                           } /* DB   DD          */
OP(xycb,22) { illegal_1();                           } /* DB   DD          */
OP(xycb,23) { illegal_1();                           } /* DB   DD          */
OP(xycb,24) { illegal_1();                           } /* DB   DD          */
OP(xycb,25) { illegal_1();                           } /* DB   DD          */
OP(xycb,26) { wm(m_ea, sla(rm_reg(m_ea)));           } /* SLA  (XY+o)      */
OP(xycb,27) { illegal_1();                           } /* DB   DD          */

OP(xycb,28) { illegal_1();                           } /* DB   DD          */
OP(xycb,29) { illegal_1();                           } /* DB   DD          */
OP(xycb,2a) { illegal_1();                           } /* DB   DD          */
OP(xycb,2b) { illegal_1();                           } /* DB   DD          */
OP(xycb,2c) { illegal_1();                           } /* DB   DD          */
OP(xycb,2d) { illegal_1();                           } /* DB   DD          */
OP(xycb,2e) { wm(m_ea, sra(rm_reg(m_ea)));           } /* SRA  (XY+o)      */
OP(xycb,2f) { illegal_1();                           } /* DB   DD          */

OP(xycb,30) { illegal_1();                           } /* DB   DD          */
OP(xycb,31) { illegal_1();                           } /* DB   DD          */
OP(xycb,32) { illegal_1();                           } /* DB   DD          */
OP(xycb,33) { illegal_1();                           } /* DB   DD          */
OP(xycb,34) { illegal_1();                           } /* DB   DD          */
OP(xycb,35) { illegal_1();                           } /* DB   DD          */
OP(xycb,36) { wm(m_ea, sll(rm_reg(m_ea)));           } /* SLL  (XY+o)      */
OP(xycb,37) { illegal_1();                           } /* DB   DD          */

OP(xycb,38) { illegal_1();                           } /* DB   DD          */
OP(xycb,39) { illegal_1();                           } /* DB   DD          */
OP(xycb,3a) { illegal_1();                           } /* DB   DD          */
OP(xycb,3b) { illegal_1();                           } /* DB   DD          */
OP(xycb,3c) { illegal_1();                           } /* DB   DD          */
OP(xycb,3d) { illegal_1();                           } /* DB   DD          */
OP(xycb,3e) { wm(m_ea, srl(rm_reg(m_ea)));           } /* SRL  (XY+o)      */
OP(xycb,3f) { illegal_1();                           } /* DB   DD          */

OP(xycb,40) { illegal_1();                           } /* DB   DD          */
OP(xycb,41) { illegal_1();                           } /* DB   DD          */
OP(xycb,42) { illegal_1();                           } /* DB   DD          */
OP(xycb,43) { illegal_1();                           } /* DB   DD          */
OP(xycb,44) { illegal_1();                           } /* DB   DD          */
OP(xycb,45) { illegal_1();                           } /* DB   DD          */
OP(xycb,46) { bit_xy(0, rm_reg(m_ea));               } /* BIT  0,(XY+o)    */
OP(xycb,47) { illegal_1();                           } /* DB   DD          */

OP(xycb,48) { illegal_1();                           } /* DB   DD          */
OP(xycb,49) { illegal_1();                           } /* DB   DD          */
OP(xycb,4a) { illegal_1();                           } /* DB   DD          */
OP(xycb,4b) { illegal_1();                           } /* DB   DD          */
OP(xycb,4c) { illegal_1();                           } /* DB   DD          */
OP(xycb,4d) { illegal_1();                           } /* DB   DD          */
OP(xycb,4e) { bit_xy(1, rm_reg(m_ea));               } /* BIT  1,(XY+o)    */
OP(xycb,4f) { illegal_1();                           } /* DB   DD          */

OP(xycb,50) { illegal_1();                           } /* DB   DD          */
OP(xycb,51) { illegal_1();                           } /* DB   DD          */
OP(xycb,52) { illegal_1();                           } /* DB   DD          */
OP(xycb,53) { illegal_1();                           } /* DB   DD          */
OP(xycb,54) { illegal_1();                           } /* DB   DD          */
OP(xycb,55) { illegal_1();                           } /* DB   DD          */
OP(xycb,56) { bit_xy(2, rm_reg(m_ea));               } /* BIT  2,(XY+o)    */
OP(xycb,57) { illegal_1();                           } /* DB   DD          */

OP(xycb,58) { illegal_1();                           } /* DB   DD          */
OP(xycb,59) { illegal_1();                           } /* DB   DD          */
OP(xycb,5a) { illegal_1();                           } /* DB   DD          */
OP(xycb,5b) { illegal_1();                           } /* DB   DD          */
OP(xycb,5c) { illegal_1();                           } /* DB   DD          */
OP(xycb,5d) { illegal_1();                           } /* DB   DD          */
OP(xycb,5e) { bit_xy(3, rm_reg(m_ea));               } /* BIT  3,(XY+o)    */
OP(xycb,5f) { illegal_1();                           } /* DB   DD          */

OP(xycb,60) { illegal_1();                           } /* DB   DD          */
OP(xycb,61) { illegal_1();                           } /* DB   DD          */
OP(xycb,62) { illegal_1();                           } /* DB   DD          */
OP(xycb,63) { illegal_1();                           } /* DB   DD          */
OP(xycb,64) { illegal_1();                           } /* DB   DD          */
OP(xycb,65) { illegal_1();                           } /* DB   DD          */
OP(xycb,66) { bit_xy(4, rm_reg(m_ea));               } /* BIT  4,(XY+o)    */
OP(xycb,67) { illegal_1();                           } /* DB   DD          */

OP(xycb,68) { illegal_1();                           } /* DB   DD          */
OP(xycb,69) { illegal_1();                           } /* DB   DD          */
OP(xycb,6a) { illegal_1();                           } /* DB   DD          */
OP(xycb,6b) { illegal_1();                           } /* DB   DD          */
OP(xycb,6c) { illegal_1();                           } /* DB   DD          */
OP(xycb,6d) { illegal_1();                           } /* DB   DD          */
OP(xycb,6e) { bit_xy(5, rm_reg(m_ea));               } /* BIT  5,(XY+o)    */
OP(xycb,6f) { illegal_1();                           } /* DB   DD          */

OP(xycb,70) { illegal_1();                           } /* DB   DD          */
OP(xycb,71) { illegal_1();                           } /* DB   DD          */
OP(xycb,72) { illegal_1();                           } /* DB   DD          */
OP(xycb,73) { illegal_1();                           } /* DB   DD          */
OP(xycb,74) { illegal_1();                           } /* DB   DD          */
OP(xycb,75) { illegal_1();                           } /* DB   DD          */
OP(xycb,76) { bit_xy(6, rm_reg(m_ea));               } /* BIT  6,(XY+o)    */
OP(xycb,77) { illegal_1();                           } /* DB   DD          */

OP(xycb,78) { illegal_1();                           } /* DB   DD          */
OP(xycb,79) { illegal_1();                           } /* DB   DD          */
OP(xycb,7a) { illegal_1();                           } /* DB   DD          */
OP(xycb,7b) { illegal_1();                           } /* DB   DD          */
OP(xycb,7c) { illegal_1();                           } /* DB   DD          */
OP(xycb,7d) { illegal_1();                           } /* DB   DD          */
OP(xycb,7e) { bit_xy(7, rm_reg(m_ea));               } /* BIT  7,(XY+o)    */
OP(xycb,7f) { illegal_1();                           } /* DB   DD          */

OP(xycb,80) { illegal_1();                           } /* DB   DD          */
OP(xycb,81) { illegal_1();                           } /* DB   DD          */
OP(xycb,82) { illegal_1();                           } /* DB   DD          */
OP(xycb,83) { illegal_1();                           } /* DB   DD          */
OP(xycb,84) { illegal_1();                           } /* DB   DD          */
OP(xycb,85) { illegal_1();                           } /* DB   DD          */
OP(xycb,86) { wm(m_ea, res(0, rm_reg(m_ea)));        } /* RES  0,(XY+o)    */
OP(xycb,87) { illegal_1();                           } /* DB   DD          */

OP(xycb,88) { illegal_1();                           } /* DB   DD          */
OP(xycb,89) { illegal_1();                           } /* DB   DD          */
OP(xycb,8a) { illegal_1();                           } /* DB   DD          */
OP(xycb,8b) { illegal_1();                           } /* DB   DD          */
OP(xycb,8c) { illegal_1();                           } /* DB   DD          */
OP(xycb,8d) { illegal_1();                           } /* DB   DD          */
OP(xycb,8e) { wm(m_ea, res(1, rm_reg(m_ea)));        } /* RES  1,(XY+o)    */
OP(xycb,8f) { illegal_1();                           } /* DB   DD          */

OP(xycb,90) { illegal_1();                           } /* DB   DD          */
OP(xycb,91) { illegal_1();                           } /* DB   DD          */
OP(xycb,92) { illegal_1();                           } /* DB   DD          */
OP(xycb,93) { illegal_1();                           } /* DB   DD          */
OP(xycb,94) { illegal_1();                           } /* DB   DD          */
OP(xycb,95) { illegal_1();                           } /* DB   DD          */
OP(xycb,96) { wm(m_ea, res(2, rm_reg(m_ea)));        } /* RES  2,(XY+o)    */
OP(xycb,97) { illegal_1();                           } /* DB   DD          */

OP(xycb,98) { illegal_1();                           } /* DB   DD          */
OP(xycb,99) { illegal_1();                           } /* DB   DD          */
OP(xycb,9a) { illegal_1();                           } /* DB   DD          */
OP(xycb,9b) { illegal_1();                           } /* DB   DD          */
OP(xycb,9c) { illegal_1();                           } /* DB   DD          */
OP(xycb,9d) { illegal_1();                           } /* DB   DD          */
OP(xycb,9e) { wm(m_ea, res(3, rm_reg(m_ea)));        } /* RES  3,(XY+o)    */
OP(xycb,9f) { illegal_1();                           } /* DB   DD          */

OP(xycb,a0) { illegal_1();                           } /* DB   DD          */
OP(xycb,a1) { illegal_1();                           } /* DB   DD          */
OP(xycb,a2) { illegal_1();                           } /* DB   DD          */
OP(xycb,a3) { illegal_1();                           } /* DB   DD          */
OP(xycb,a4) { illegal_1();                           } /* DB   DD          */
OP(xycb,a5) { illegal_1();                           } /* DB   DD          */
OP(xycb,a6) { wm(m_ea, res(4, rm_reg(m_ea)));        } /* RES  4,(XY+o)    */
OP(xycb,a7) { illegal_1();                           } /* DB   DD          */

OP(xycb,a8) { illegal_1();                           } /* DB   DD          */
OP(xycb,a9) { illegal_1();                           } /* DB   DD          */
OP(xycb,aa) { illegal_1();                           } /* DB   DD          */
OP(xycb,ab) { illegal_1();                           } /* DB   DD          */
OP(xycb,ac) { illegal_1();                           } /* DB   DD          */
OP(xycb,ad) { illegal_1();                           } /* DB   DD          */
OP(xycb,ae) { wm(m_ea, res(5, rm_reg(m_ea)));        } /* RES  5,(XY+o)    */
OP(xycb,af) { illegal_1();                           } /* DB   DD          */

OP(xycb,b0) { illegal_1();                           } /* DB   DD          */
OP(xycb,b1) { illegal_1();                           } /* DB   DD          */
OP(xycb,b2) { illegal_1();                           } /* DB   DD          */
OP(xycb,b3) { illegal_1();                           } /* DB   DD          */
OP(xycb,b4) { illegal_1();                           } /* DB   DD          */
OP(xycb,b5) { illegal_1();                           } /* DB   DD          */
OP(xycb,b6) { wm(m_ea, res(6, rm_reg(m_ea)));        } /* RES  6,(XY+o)    */
OP(xycb,b7) { illegal_1();                           } /* DB   DD          */

OP(xycb,b8) { illegal_1();                           } /* DB   DD          */
OP(xycb,b9) { illegal_1();                           } /* DB   DD          */
OP(xycb,ba) { illegal_1();                           } /* DB   DD          */
OP(xycb,bb) { illegal_1();                           } /* DB   DD          */
OP(xycb,bc) { illegal_1();                           } /* DB   DD          */
OP(xycb,bd) { illegal_1();                           } /* DB   DD          */
OP(xycb,be) { wm(m_ea, res(7, rm_reg(m_ea)));        } /* RES  7,(XY+o)    */
OP(xycb,bf) { illegal_1();                           } /* DB   DD          */

OP(xycb,c0) { illegal_1();                           } /* DB   DD          */
OP(xycb,c1) { illegal_1();                           } /* DB   DD          */
OP(xycb,c2) { illegal_1();                           } /* DB   DD          */
OP(xycb,c3) { illegal_1();                           } /* DB   DD          */
OP(xycb,c4) { illegal_1();                           } /* DB   DD          */
OP(xycb,c5) { illegal_1();                           } /* DB   DD          */
OP(xycb,c6) { wm(m_ea, set(0, rm_reg(m_ea)));        } /* SET  0,(XY+o)    */
OP(xycb,c7) { illegal_1();                           } /* DB   DD          */

OP(xycb,c8) { illegal_1();                           } /* DB   DD          */
OP(xycb,c9) { illegal_1();                           } /* DB   DD          */
OP(xycb,ca) { illegal_1();                           } /* DB   DD          */
OP(xycb,cb) { illegal_1();                           } /* DB   DD          */
OP(xycb,cc) { illegal_1();                           } /* DB   DD          */
OP(xycb,cd) { illegal_1();                           } /* DB   DD          */
OP(xycb,ce) { wm(m_ea, set(1, rm_reg(m_ea)));        } /* SET  1,(XY+o)    */
OP(xycb,cf) { illegal_1();                           } /* DB   DD          */

OP(xycb,d0) { illegal_1();                           } /* DB   DD          */
OP(xycb,d1) { illegal_1();                           } /* DB   DD          */
OP(xycb,d2) { illegal_1();                           } /* DB   DD          */
OP(xycb,d3) { illegal_1();                           } /* DB   DD          */
OP(xycb,d4) { illegal_1();                           } /* DB   DD          */
OP(xycb,d5) { illegal_1();                           } /* DB   DD          */
OP(xycb,d6) { wm(m_ea, set(2, rm_reg(m_ea)));        } /* SET  2,(XY+o)    */
OP(xycb,d7) { illegal_1();                           } /* DB   DD          */

OP(xycb,d8) { illegal_1();                           } /* DB   DD          */
OP(xycb,d9) { illegal_1();                           } /* DB   DD          */
OP(xycb,da) { illegal_1();                           } /* DB   DD          */
OP(xycb,db) { illegal_1();                           } /* DB   DD          */
OP(xycb,dc) { illegal_1();                           } /* DB   DD          */
OP(xycb,dd) { illegal_1();                           } /* DB   DD          */
OP(xycb,de) { wm(m_ea, set(3, rm_reg(m_ea)));        } /* SET  3,(XY+o)    */
OP(xycb,df) { illegal_1();                           } /* DB   DD          */

OP(xycb,e0) { illegal_1();                           } /* DB   DD          */
OP(xycb,e1) { illegal_1();                           } /* DB   DD          */
OP(xycb,e2) { illegal_1();                           } /* DB   DD          */
OP(xycb,e3) { illegal_1();                           } /* DB   DD          */
OP(xycb,e4) { illegal_1();                           } /* DB   DD          */
OP(xycb,e5) { illegal_1();                           } /* DB   DD          */
OP(xycb,e6) { wm(m_ea, set(4, rm_reg(m_ea)));        } /* SET  4,(XY+o)    */
OP(xycb,e7) { illegal_1();                           } /* DB   DD          */

OP(xycb,e8) { illegal_1();                           } /* DB   DD          */
OP(xycb,e9) { illegal_1();                           } /* DB   DD          */
OP(xycb,ea) { illegal_1();                           } /* DB   DD          */
OP(xycb,eb) { illegal_1();                           } /* DB   DD          */
OP(xycb,ec) { illegal_1();                           } /* DB   DD          */
OP(xycb,ed) { illegal_1();                           } /* DB   DD          */
OP(xycb,ee) { wm(m_ea, set(5, rm_reg(m_ea)));        } /* SET  5,(XY+o)    */
OP(xycb,ef) { illegal_1();                           } /* DB   DD          */

OP(xycb,f0) { illegal_1();                           } /* DB   DD          */
OP(xycb,f1) { illegal_1();                           } /* DB   DD          */
OP(xycb,f2) { illegal_1();                           } /* DB   DD          */
OP(xycb,f3) { illegal_1();                           } /* DB   DD          */
OP(xycb,f4) { illegal_1();                           } /* DB   DD          */
OP(xycb,f5) { illegal_1();                           } /* DB   DD          */
OP(xycb,f6) { wm(m_ea, set(6, rm_reg(m_ea)));        } /* SET  6,(XY+o)    */
OP(xycb,f7) { illegal_1();                           } /* DB   DD          */

OP(xycb,f8) { illegal_1();                           } /* DB   DD          */
OP(xycb,f9) { illegal_1();                           } /* DB   DD          */
OP(xycb,fa) { illegal_1();                           } /* DB   DD          */
OP(xycb,fb) { illegal_1();                           } /* DB   DD          */
OP(xycb,fc) { illegal_1();                           } /* DB   DD          */
OP(xycb,fd) { illegal_1();                           } /* DB   DD          */
OP(xycb,fe) { wm(m_ea, set(7, rm_reg(m_ea)));        } /* SET  7,(XY+o)    */
OP(xycb,ff) { illegal_1();                           } /* DB   DD          */
...
OP(ed,4c) { illegal_2();                                     } /* DB   ED          */
OP(ed,4d) { reti();                                          } /* RETI             */
OP(ed,4e) { illegal_2();                                     } /* DB   ED          */
...
OP(ed,54) { illegal_2();                                     } /* DB   ED          */
OP(ed,55) { illegal_2();                                     } /* DB   ED          */
OP(ed,56) { m_im = 1; T(1);                                  } /* IM   1           */
...
OP(ed,5c) { illegal_2();                                     } /* DB   ED          */
OP(ed,5d) { illegal_2();                                     } /* DB   ED          */
OP(ed,5e) { m_im = 2; T(1);                                  } /* IM   2           */
...
OP(ed,64) { illegal_2();                                     } /* DB   ED          */
OP(ed,65) { illegal_2();                                     } /* DB   ED          */
OP(ed,66) { illegal_2();                                     } /* DB   ED          */
OP(ed,67) { rrd();                                           } /* RRD  (HL)        */
...
OP(ed,6c) { illegal_2();                                     } /* DB   ED          */
OP(ed,6d) { reti();                                          } /* RETI             */
OP(ed,6e) { m_im = 0; T(1);                                  } /* IM   0           */
OP(ed,6f) { rld();                                           } /* RLD  (HL)        */

OP(ed,70) { u8 res = in(BC); set_f((F & CF) | SZP[res]); WZ = BC + 1; } /* IN   F,(C)       */
OP(ed,71) { illegal_2();                                     } /* DB   ED          */
OP(ed,72) { sbc_hl(m_sp);                                    } /* SBC  HL,SP       */
OP(ed,73) { m_ea = arg16(); wm16(m_ea, m_sp); WZ = m_ea + 1; } /* LD   (w),SP      */
OP(ed,74) { illegal_2();                                     } /* DB   ED          */
OP(ed,75) { illegal_2();                                     } /* DB   ED          */
OP(ed,76) { illegal_2();                                     } /* DB   ED          */
...
OP(ed,7c) { illegal_2();                                     } /* DB   ED          */
OP(ed,7d) { illegal_2();                                     } /* DB   ED          */
OP(ed,7e) { illegal_2();                                     } /* DB   ED          */
OP(ed,7f) { illegal_2();                                     } /* DB   ED          */
...
OP(ed,a0) { ldi();                                           } /* LDI              */
OP(ed,a1) { cpi();                                           } /* CPI              */
OP(ed,a2) { ini(true);                                       } /* INI              */
OP(ed,a3) { outi(true);                                      } /* OUTI             */
...
OP(ed,a8) { ldd();                                           } /* LDD              */
OP(ed,a9) { cpd();                                           } /* CPD              */
OP(ed,aa) { ind(true);                                       } /* IND              */
OP(ed,ab) { outd(true);                                      } /* OUTD             */
...
OP(ed,c1) { mulub(B); T(12);                                 } /* MULUB A,B        */
OP(ed,c2) { illegal_2();                                     } /* DB   ED          */
OP(ed,c3) { muluw(BC); T(34);                                } /* MULUW HL,BC      */
...
OP(ed,c9) { mulub(C); T(12);                                 } /* MULUB A,C        */
...
OP(ed,d1) { mulub(D); T(12);                                 } /* MULUB A,D        */
...
OP(ed,d9) { mulub(E); T(12);                                 } /* MULUB A,E        */
...
OP(ed,e1) { mulub(H); T(12);                                 } /* MULUB A,H (undocumented) */
...
OP(ed,e9) { mulub(L); T(12);                                 } /* MULUB A,L (undocumented) */
...
OP(ed,f1) { mulub(A); T(12);                                 } /* MULUB A,A (undocumented) */
OP(ed,f2) { illegal_2();                                     } /* DB   ED          */
OP(ed,f3) { muluw(SP); T(34);                                } /* MULUW HL,SP      */
...
OP(ed,f9) { mulub(A); T(12);                                 } /* MULUB A,A (undocumented) */
...
OP(op,f3) { m_iff1 = m_iff2 = 0; T(1);                                            } /* DI               */
