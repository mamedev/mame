...
s1c33l17_device::s1c33l17_device(const machine_config &mconfig, const char *tag, device_t *owner, u32 clock)
	: c33std_cpu_device_base(mconfig, S1C33L17, tag, owner, clock, address_map_constructor(FUNC(s1c33l17_device::internal_map), this))
{
}
...
void s1c33l17_device::internal_map(address_map &map)
{
	...
	// 0x00300660-0x0030033c Watchdog Timer
	// 0x00300780-0x003007ea 16-bit Timer
	// 0x00300900-0x0030099f USB Function Controller
	// 0x00300a00-0x00300aff USB DMA Area
	// 0x00300b00-0x00300b4f Serial Interface
	...
	// 0x00301a00-0x00301aac LCD Controller
