...
offs_t pic16c62x_device::disassemble(std::ostream &stream, offs_t pc, const data_buffer &opcodes, const data_buffer &params, uint32_t options)
{
	extern CPU_DISASSEMBLE( pic16c62x );
	return CPU_DISASSEMBLE_NAME(pic16c62x)(this, stream, pc, opcodes, params, options);
}
