...
const sonix16_disassembler::instruction sonix16_disassembler::instructions[] = {
	...
	{ 0xc884, 0xf89c, 1, [](std::ostream &stream, u16 opcode, u16 arg, u32 pc) { util::stream_format(stream, "r%d = BCLR.%d %s", (opcode >> 8) & 1, ((opcode >> 7) & 0xc) | ((opcode >> 5) & 3), yregs[opcode & 3]); }},
	{ 0xc88c, 0xf89c, 1, [](std::ostream &stream, u16 opcode, u16 arg, u32 pc) { util::stream_format(stream, "r%d = BSET.%d %s", (opcode >> 8) & 1, ((opcode >> 7) & 0xc) | ((opcode >> 5) & 3), yregs[opcode & 3]); }},
