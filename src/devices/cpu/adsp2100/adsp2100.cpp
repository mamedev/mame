...
uint32_t adsp21xx_device::opcode_alignment() const
{
	return 1;
}
...
offs_t adsp21xx_device::disassemble(std::ostream &stream, offs_t pc, const data_buffer &opcodes, const data_buffer &params, uint32_t options)
{
	extern CPU_DISASSEMBLE( adsp21xx );
	return CPU_DISASSEMBLE_NAME(adsp21xx)(this, stream, pc, opcodes, params, options);
}
