...
static u16 r16p(offs_t &pc, const device_disasm_interface::data_buffer &opcodes)
{
...
static void MakeEA (char *ea, int lo, offs_t &pc, int width, const device_disasm_interface::data_buffer &opcodes)
{
	int reg, pm;
...
/*      case 0x0d00:
		...
		case 0x1e00: case 0x1e40: case 0x1e80: case 0x1ec0: case 0x1f00: case 0x1f40: case 0x1f80: case 0x1fc0:
			MakeEA (ea1, hi, pc, 4, opcodes);
			MakeEA (ea2, lo, pc, 4, opcodes);
		...
		case 0x9e00: case 0x9e40: case 0x9e80: case 0x9ec0: case 0x9f00: case 0x9f40: case 0x9f80: case 0x9fc0:
			MakeEA (ea1, hi, pc, 2, opcodes);
			MakeEA (ea2, lo, pc, 2, opcodes);
