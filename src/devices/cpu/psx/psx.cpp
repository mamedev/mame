...
void psxcpu_device::device_start()
{
	...
	save_item(NAME(m_bus_attached));
	save_item(NAME(m_bad_byte_address_mask));
	save_item(NAME(m_bad_half_address_mask));
	save_item(NAME(m_bad_word_address_mask));
