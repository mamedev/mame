...
void psxmdec_device::write(address_space &space, offs_t offset, uint32_t data, uint32_t mem_mask)
{
	switch( offset )
	{
	case 0:
...
uint32_t psxmdec_device::read(address_space &space, offs_t offset, uint32_t mem_mask)
{
	switch( offset )
	{
	case 0:
