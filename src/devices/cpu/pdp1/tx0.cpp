...
offs_t tx0_8kw_device::disassemble(std::ostream &stream, offs_t pc, const data_buffer &opcodes, const data_buffer &params, uint32_t options)
{
	extern CPU_DISASSEMBLE( tx0_8kw );
	return CPU_DISASSEMBLE_NAME(tx0_8kw)(this, stream, pc, opcodes, params, options);
}


offs_t tx0_64kw_device::disassemble(std::ostream &stream, offs_t pc, const data_buffer &opcodes, const data_buffer &params, uint32_t options)
{
	extern CPU_DISASSEMBLE( tx0_64kw );
	return CPU_DISASSEMBLE_NAME(tx0_64kw)(this, stream, pc, opcodes, params, options);
}
