...
static std::pair<u16, char const *> const tmp95c063_syms[] = {
	...
	{ 0x1c, "P9CR" }, { 0x1d, "P9FC" }, { 0x1e, "PA" }, { 0x1f, "PB" },
	...
	{ 0x3b, "T16RUN" }, { 0x40, "TREGAL" }, { 0x41, "TREGAH" },
	{ 0x42, "TREGBL" }, { 0x43, "TREGBH" }, { 0x44, "CAP3L" },
	{ 0x45, "CAP3H" }, { 0x46, "CAP4L" }, { 0x47, "CAP4H" },
	{ 0x48, "T9MOD" }, { 0x49, "T9FFCR" }, { 0x4a, "DAREG0" },
	{ 0x4b, "DAREG1" }, { 0x4c, "PG0REG" }, { 0x4d, "PG1REG" },
	{ 0x4e, "PG01CR" }, { 0x4f, "DADRV" }, { 0x50, "SC0BUF" },
	{ 0x51, "SC0CR" }, { 0x52, "SC0MOD" }, { 0x53, "BR0CR" },
	{ 0x54, "SC1BUF" }, { 0x55, "SC1CR" }, { 0x56, "SC1MOD" },
	{ 0x57, "BR1CR" }, { 0x58, "ODE" }, { 0x5a, "DMA0V" },
	{ 0x5b, "DMA1V" }, { 0x5c, "DMA2V" }, { 0x5d, "DMA3V" },
	{ 0x5e, "ADMOD1" }, { 0x5f, "ADMOD2" }, { 0x60, "ADREG04L" },
	{ 0x61, "ADREG04H" }, { 0x62, "ADREG15L" }, { 0x63, "ADREG15H" },
	{ 0x64, "ADREG26L" }, { 0x65, "ADREG26H" }, { 0x66, "ADREG37L" },
	{ 0x67, "ADREG37H" }, { 0x6a, "SDMACR0" }, { 0x6b, "SDMACR1" },
	{ 0x6c, "SDMACR2" }, { 0x6d, "SDMACR3" }, { 0x6e, "WDMOD" },
	{ 0x6f, "WDCR" }, { 0x70, "INTE_0AD" }, { 0x71, "INTE12" },
	...
	{ 0x7e, "INTETC23" }, { 0x7f, "IIMC" }, { 0x80, "PACR" },
	{ 0x81, "PAFC" }, { 0x82, "PBCR" }, { 0x83, "PBFC" }, { 0x84, "PC" },
	{ 0x85, "PD"}, { 0x88, "PDCR" }, { 0x8a, "PE" }, { 0x8c, "PECR" },
	{ 0x8f, "BEXCS" }, { 0x90, "B0CS" }, { 0x91, "B1CS" },
	{ 0x92, "B2CS" }, { 0x93, "B3CS" }, { 0x94, "MSAR0" },
	{ 0x95, "MAMR0" }, { 0x96, "MSAR1" }, { 0x97, "MAMR1" },
	{ 0x98, "MSAR2" }, { 0x99, "MAMR2" }, { 0x9a, "MSAR3" },
	{ 0x9b, "MAMR3" }, { 0x9c, "DREFCR1" }, { 0x9d, "DMEMCR1" },
	{ 0x9e, "DREFCR3" }, { 0x9f, "DMEMCR3" }
};
