...
offs_t g65816_device::disassemble(std::ostream &stream, offs_t pc, const data_buffer &opcodes, const data_buffer &params, uint32_t options)
{
	return g65816_disassemble(stream, (pc & 0x00ffff), (pc & 0xff0000) >> 16, opcodes, FLAG_M, FLAG_X);
}

CPU_DISASSEMBLE( g65816 )
{
	return g65816_disassemble(stream, (pc & 0x00ffff), (pc & 0xff0000) >> 16, opcodes, 0/*FLAG_M*/, 0/*FLAG_X*/);
}
