...
int m7700_disassemble(std::ostream &stream, offs_t pc, unsigned int pb, const device_disasm_interface::data_buffer &opcodes, int m_flag, int x_flag)
{
...
{
	return m7700_disassemble(stream, (pc&0xffff), pc>>16, opcodes, 0, 0);
}
