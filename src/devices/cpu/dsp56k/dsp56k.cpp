...
offs_t dsp56k_device::disassemble(std::ostream &stream, offs_t pc, const data_buffer &opcodes, const data_buffer &params, uint32_t options)
{
	return CPU_DISASSEMBLE_NAME(dsp56k)(this, stream, pc, opcodes, params, options);
}
