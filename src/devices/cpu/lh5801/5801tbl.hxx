...
void lh5801_cpu_device::lh5801_vector(int taken, int nr)
{
	if (taken)
	{
		lh5801_push_word(P);
...
void lh5801_cpu_device::lh5801_rol()
{
	...
	if (m_a & 0x10)
		m_t |= H;
	if ((BIT(n, 6) && !BIT(n, 7)) || (!BIT(n, 6) && BIT(n, 7)))
		m_t |= V;
}
...
void lh5801_cpu_device::lh5801_ror()
{
	...
	if (m_a & 0x08)
		m_t |= H;
	if ((BIT(n, 0) && BIT(m_a, 1)) || (BIT(m_a, 0) && BIT(n, 1)))
		m_t |= V;
}
...
void lh5801_cpu_device::lh5801_instruction_fd()
{
	...
	default:
		logerror("lh5801 illegal opcode at %04x fd(%02x)\n", P-2, oper);
	}
}
...
void lh5801_cpu_device::lh5801_instruction()
{
	...
	case 0x8c:
		...
		break;
	case 0x8d:
		lh5801_branch_plus(!(m_t&V));
		m_icount -= 8;
		break;
	case 0x8e:
		lh5801_branch_plus(1);
		m_icount -= 5;
		break;
	case 0x8f:
		lh5801_branch_plus(m_t&V);
	...
	case 0x9c:
		...
		break;
	case 0x9d:
		lh5801_branch_minus(!(m_t&V));
		m_icount -= 8;
		break;
	case 0x9e:
		lh5801_branch_minus(1);
		m_icount -= 6;
		break;
	case 0x9f:
		lh5801_branch_minus(m_t&V);
