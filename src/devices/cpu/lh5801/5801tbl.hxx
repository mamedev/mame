...
void lh5801_cpu_device::lh5801_instruction_fd()
{
	...
	case 0x4d: lh5801_bit(m_io->read_byte(X), m_cache->read_byte(P++));m_icount-=14;break;
	...
	case 0x5b: lh5801_ora_mem(*m_io, Y, m_cache->read_byte(P++)); m_icount-=17;break;
	case 0x5d: lh5801_bit(m_io->read_byte(Y), m_cache->read_byte(P++));m_icount-=14;break;
	...
	case 0x6b: lh5801_ora_mem(*m_io, U, m_cache->read_byte(P++)); m_icount-=17;break;
	case 0x6d: lh5801_bit(m_io->read_byte(X), m_cache->read_byte(P++));m_icount-=14;break;
	case 0x6f: lh5801_add_mem(*m_io, U, m_cache->read_byte(P++)); m_icount-=17;break;
	...
	case 0xe9:
		...
		lh5801_and_mem(*m_io, adr, m_cache->read_byte(P++)); m_icount-=23;
		break;
	case 0xeb:
		adr=lh5801_readop_word();
		lh5801_ora_mem(*m_io, adr, m_cache->read_byte(P++)); m_icount-=23;
		break;
	...
	case 0xef:
		adr=lh5801_readop_word();
		lh5801_add_mem(*m_io, adr, m_cache->read_byte(P++)); m_icount-=23;
		break;
...
void lh5801_cpu_device::lh5801_instruction()
{
	...
	case 0x48: XH=m_cache->read_byte(P++);m_icount-=6;break;
	case 0x49: lh5801_and_mem(*m_program, X, m_cache->read_byte(P++)); m_icount-=13;break;
	case 0x4a: XL=m_cache->read_byte(P++);m_icount-=6;break;
	case 0x4b: lh5801_ora_mem(*m_program, X, m_cache->read_byte(P++)); m_icount-=13;break;
	case 0x4c: lh5801_cpa(XH, m_cache->read_byte(P++)); m_icount-=7;break;
	case 0x4d: lh5801_bit(m_program->read_byte(X), m_cache->read_byte(P++));m_icount-=10;break;
	case 0x4e: lh5801_cpa(XL, m_cache->read_byte(P++)); m_icount-=7;break;
	case 0x4f: lh5801_add_mem(*m_program, X, m_cache->read_byte(P++)); m_icount-=13;break;
	...
	case 0x58: YH=m_cache->read_byte(P++);m_icount-=6;break;
	case 0x59: lh5801_and_mem(*m_program, Y, m_cache->read_byte(P++)); m_icount-=13;break;
	case 0x5a: YL=m_cache->read_byte(P++);m_icount-=6;break;
	case 0x5b: lh5801_ora_mem(*m_program, Y, m_cache->read_byte(P++)); m_icount-=13;break;
	case 0x5c: lh5801_cpa(YH, m_cache->read_byte(P++)); m_icount-=7;break;
	case 0x5d: lh5801_bit(m_program->read_byte(Y), m_cache->read_byte(P++));m_icount-=10;break;
	case 0x5e: lh5801_cpa(YL, m_cache->read_byte(P++)); m_icount-=7;break;
	case 0x5f: lh5801_add_mem(*m_program, Y, m_cache->read_byte(P++)); m_icount-=13;break;
	...
	case 0x68: UH=m_cache->read_byte(P++);m_icount-=6;break;
	case 0x69: lh5801_and_mem(*m_program, U, m_cache->read_byte(P++)); m_icount-=13;break;
	case 0x6a: UL=m_cache->read_byte(P++);m_icount-=6;break;
	case 0x6b: lh5801_ora_mem(*m_program, U, m_cache->read_byte(P++)); m_icount-=13;break;
	case 0x6c: lh5801_cpa(UH, m_cache->read_byte(P++)); m_icount-=7;break;
	case 0x6d: lh5801_bit(m_program->read_byte(U), m_cache->read_byte(P++));m_icount-=10;break;
	case 0x6e: lh5801_cpa(UL, m_cache->read_byte(P++)); m_icount-=7;break;
	case 0x6f: lh5801_add_mem(*m_program, U, m_cache->read_byte(P++)); m_icount-=13;break;
	...
	case 0xb1: lh5801_sbc(m_cache->read_byte(P++)); m_icount-=7;break;
	case 0xb3: lh5801_adc(m_cache->read_byte(P++)); m_icount-=7;break;
	case 0xb5: lh5801_lda(m_cache->read_byte(P++)); m_icount-=6;break;
	case 0xb7: lh5801_cpa(m_a, m_cache->read_byte(P++)); m_icount-=7;break;
	case 0xb8: m_pv=0;/*rpv!*/ m_icount-=4; break;
	case 0xb9: lh5801_and(m_cache->read_byte(P++)); m_icount-=7;break;
	case 0xba: lh5801_jmp(lh5801_readop_word()); m_icount-=12;break;
	case 0xbb: lh5801_ora(m_cache->read_byte(P++)); m_icount-=7;break;
	case 0xbd: lh5801_eor(m_cache->read_byte(P++)); m_icount-=7;break;
	case 0xbe: lh5801_sjp(); m_icount-=19; break;
	case 0xbf: lh5801_bit(m_a, m_cache->read_byte(P++));m_icount-=7;break;
	case 0xc1: lh5801_vector(!(m_t&C), m_cache->read_byte(P++)); m_icount-=8;break;
	case 0xc3: lh5801_vector(m_t&C, m_cache->read_byte(P++)); m_icount-=8;break;
	case 0xc5: lh5801_vector(!(m_t&H), m_cache->read_byte(P++)); m_icount-=8;break;
	case 0xc7: lh5801_vector(m_t&H, m_cache->read_byte(P++)); m_icount-=8;break;
	case 0xc9: lh5801_vector(!(m_t&Z), m_cache->read_byte(P++)); m_icount-=8;break;
	case 0xcb: lh5801_vector(m_t&Z, m_cache->read_byte(P++)); m_icount-=8;break;
	case 0xcd: lh5801_vector(1, m_cache->read_byte(P++)); m_icount-=7;break;
	case 0xcf: lh5801_vector(m_t&V, m_cache->read_byte(P++)); m_icount-=8;break;
	...
	case 0xe9:
		adr=lh5801_readop_word();lh5801_and_mem(*m_program, adr, m_cache->read_byte(P++));
		m_icount-=19;break;
	case 0xeb:
		adr=lh5801_readop_word();lh5801_ora_mem(*m_program, adr, m_cache->read_byte(P++));
		m_icount-=19;break;
	case 0xed:
		adr=lh5801_readop_word();lh5801_bit(m_program->read_byte(adr), m_cache->read_byte(P++));
		m_icount-=16;break;
	case 0xef:
		adr=lh5801_readop_word();
		lh5801_add_mem(*m_program, adr, m_cache->read_byte(P++)); m_icount-=19;
		break;
