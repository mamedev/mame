...
offs_t lh5801_cpu_device::disassemble(std::ostream &stream, offs_t pc, const data_buffer &opcodes, const data_buffer &params, uint32_t options)
{
	extern CPU_DISASSEMBLE( lh5801 );
	return CPU_DISASSEMBLE_NAME(lh5801)(this, stream, pc, opcodes, params, options);
}
