...
uint16_t sh7604_bus_device::bus_control_1_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	return (m_bcr1 & 0x1ff7) | (m_is_slave == true ? 0x8000 : 0);
}

void sh7604_bus_device::bus_control_1_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	COMBINE_DATA(&m_bcr1);
...
uint16_t sh7604_bus_device::bus_control_2_r(address_space &space, offs_t offset, uint16_t mem_mask) { return m_bcr2 & 0x00fc; }
void sh7604_bus_device::bus_control_2_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	COMBINE_DATA(&m_bcr2);
	if(m_bcr2 != 0x00fc)
...
uint16_t sh7604_bus_device::wait_control_r(address_space &space, offs_t offset, uint16_t mem_mask) { return m_wcr; }
void sh7604_bus_device::wait_control_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask) { COMBINE_DATA(&m_wcr); }

uint16_t sh7604_bus_device::memory_control_r(address_space &space, offs_t offset, uint16_t mem_mask) { return m_mcr & 0xfefc; }
void sh7604_bus_device::memory_control_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask) { COMBINE_DATA(&m_mcr); }

uint16_t sh7604_bus_device::refresh_timer_status_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	return m_rtcsr & 0x00f8;
}

void sh7604_bus_device::refresh_timer_control_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
uint16_t sh7604_bus_device::refresh_timer_counter_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	throw emu_fatalerror("%s: reading timer counter!\n",tag());
	return 0;
}

void sh7604_bus_device::refresh_timer_counter_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
	throw emu_fatalerror("%s: writing timer counter %04x\n",tag(),data);
	//COMBINE_DATA(&m_rtcnt);
}

uint16_t sh7604_bus_device::refresh_timer_constant_r(address_space &space, offs_t offset, uint16_t mem_mask)
{
	return m_rtcor & 0xff;
}

void sh7604_bus_device::refresh_timer_constant_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask)
{
...
uint32_t sh7604_bus_device::read(address_space &space, offs_t offset, uint32_t mem_mask)
{
