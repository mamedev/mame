...
uint8_t sh7604_sci_device::serial_mode_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_smr;
}

void sh7604_sci_device::serial_mode_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_smr = data;
...
uint8_t sh7604_sci_device::serial_control_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_scr;
}

void sh7604_sci_device::serial_control_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_scr = data;
...
uint8_t sh7604_sci_device::serial_status_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_ssr;
}

void sh7604_sci_device::serial_ack_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	// TODO: verify this
	m_ssr = (m_ssr & 0x06) | (m_ssr & data & 0xf9);
}

uint8_t sh7604_sci_device::bitrate_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return m_brr;
}

void sh7604_sci_device::bitrate_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_brr = data;
}

uint8_t sh7604_sci_device::transmit_data_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	// ...
	return 0;
}

void sh7604_sci_device::transmit_data_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	// ...
}

uint8_t sh7604_sci_device::receive_data_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	// ...
	return 0;
}
...
uint8_t sh7604_sci_device::read(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return space.read_byte(offset);
}

void sh7604_sci_device::write(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
