    ...
    def get_value_expression(self, params):
        if self.values[0] == "single":
            ...
            if mode == 'imm' or mode == 'bit' or mode == 'shift' or mode == 'abs':
                ...
                return 'm_pc + util::sext(BIT(opcode, %d, %d), %d)' % (params[0], self.bcount, self.bcount)
            else:
            ...
            if mode == 'imm' or mode == 'bit' or mode == 'shift':
                ...
                return 'm_pc + util::sext(bitswap<%d>(opcode%s%s), %d)' % (self.bcount, self.brange(params[0], b1), self.brange(params[1], b2), self.bcount)
            else:
    ...
    def param(self, params):
        if self.values[0] == "single":
            ...
            if mode == 'imm' or mode == 'bit' or mode == 'shift' or mode == 'abs':
                ...
                return ', pc + util::sext(BIT(opcode, %d, %d), %d)' % (params[0], self.bcount, self.bcount)
        elif self.values[0] == 'split-range':
            b2 = self.values[1]
            b1 = self.bcount - b2
            mode = self.values[3]
            if mode == 'imm' or mode == 'bit' or mode == 'shift':
                ...
                return ', pc + util::sext(bitswap<%d>(opcode%s%s), %d)' % (self.bcount, self.brange(params[0], b1), self.brange(params[1], b2), self.bcount)
        elif self.name == 'exabs' or self.name == 'eximm' or self.name == 'exoff' or self.name == 'eam1a' or self.name == 'eam1i':
            return ', exv'
        elif self.name == 'expcrel':
