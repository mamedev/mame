...
void dsp563xx_device::execute_npar(u16 knpar, u32 opcode, u32 exv)
{
	...
	case 162: // andi #[i],mr
		...
		break;
	case 163: // andi #[i],ccr
		unhandled("andi #[i],ccr");
		break;
	case 164: // andi #[i],com
		unhandled("andi #[i],com");
		break;
	case 165: // andi #[i],eom
		unhandled("andi #[i],eom");
		break;
	case 166: // asl #[i],a,a
		unhandled("asl #[i],a,a");
		break;
	...
	case 595: // bset #[n],x:[pp]
		unhandled("bset #[n],x:[pp]");
		break;
	case 596: // bset #[n],y:[pp]
		unhandled("bset #[n],y:[pp]");
		break;
	...
	case 979: // do #[i],[expr]
		...
		break;
	case 980: // do x0,[expr]
		unhandled("do x0,[expr]");
		break;
	case 981: // do x1,[expr]
		unhandled("do x1,[expr]");
		break;
	case 982: // do y0,[expr]
		unhandled("do y0,[expr]");
		break;
	case 983: // do y1,[expr]
		unhandled("do y1,[expr]");
		break;
	case 984: // do a0,[expr]
		unhandled("do a0,[expr]");
		break;
	case 985: // do b0,[expr]
		unhandled("do b0,[expr]");
		break;
	case 986: // do a2,[expr]
		unhandled("do a2,[expr]");
		break;
	case 987: // do b2,[expr]
		unhandled("do b2,[expr]");
		break;
	case 988: // do a1,[expr]
		unhandled("do a1,[expr]");
		break;
	case 989: // do b1,[expr]
		unhandled("do b1,[expr]");
		break;
	case 990: // do a,[expr]
		unhandled("do a,[expr]");
		break;
	...
	case 994: // do m,[expr]
		...
		break;
	case 995: // do ep,[expr]
		unhandled("do ep,[expr]");
		break;
	case 996: // do vba,[expr]
		unhandled("do vba,[expr]");
		break;
	case 997: // do sc,[expr]
		unhandled("do sc,[expr]");
		break;
	case 998: // do sz,[expr]
		unhandled("do sz,[expr]");
		break;
	case 999: // do sr,[expr]
		unhandled("do sr,[expr]");
		break;
	case 1000: // do omr,[expr]
		unhandled("do omr,[expr]");
		break;
	case 1001: // do sp,[expr]
		unhandled("do sp,[expr]");
		break;
	case 1002: // do ssl,[expr]
		unhandled("do ssl,[expr]");
		break;
	case 1003: // do la,[expr]
		unhandled("do la,[expr]");
		break;
	case 1004: // do lc,[expr]
		unhandled("do lc,[expr]");
		break;
	case 1005: // do forever
		unhandled("do forever");
		break;
	...
	case 1022: // dor #[i],[expr]
		unhandled("dor #[i],[expr]");
		break;
	case 1023: // dor x0,[expr]
		unhandled("dor x0,[expr]");
		break;
	case 1024: // dor x1,[expr]
		unhandled("dor x1,[expr]");
		break;
	case 1025: // dor y0,[expr]
		unhandled("dor y0,[expr]");
		break;
	case 1026: // dor y1,[expr]
		unhandled("dor y1,[expr]");
		break;
	case 1027: // dor a0,[expr]
		unhandled("dor a0,[expr]");
		break;
	case 1028: // dor b0,[expr]
		unhandled("dor b0,[expr]");
		break;
	case 1029: // dor a2,[expr]
		unhandled("dor a2,[expr]");
		break;
	case 1030: // dor b2,[expr]
		unhandled("dor b2,[expr]");
		break;
	case 1031: // dor a1,[expr]
		unhandled("dor a1,[expr]");
		break;
	case 1032: // dor b1,[expr]
		unhandled("dor b1,[expr]");
		break;
	case 1033: // dor a,[expr]
		unhandled("dor a,[expr]");
		break;
	case 1034: // dor b,[expr]
		unhandled("dor b,[expr]");
		break;
	case 1035: // dor r,[expr]
		unhandled("dor r,[expr]");
		break;
	case 1036: // dor n,[expr]
		unhandled("dor n,[expr]");
		break;
	case 1037: // dor m,[expr]
		unhandled("dor m,[expr]");
		break;
	case 1038: // dor ep,[expr]
		unhandled("dor ep,[expr]");
		break;
	case 1039: // dor vba,[expr]
		unhandled("dor vba,[expr]");
		break;
	case 1040: // dor sc,[expr]
		unhandled("dor sc,[expr]");
		break;
	case 1041: // dor sz,[expr]
		unhandled("dor sz,[expr]");
		break;
	case 1042: // dor sr,[expr]
		unhandled("dor sr,[expr]");
		break;
	case 1043: // dor omr,[expr]
		unhandled("dor omr,[expr]");
		break;
	case 1044: // dor sp,[expr]
		unhandled("dor sp,[expr]");
		break;
	case 1045: // dor ssl,[expr]
		unhandled("dor ssl,[expr]");
		break;
	case 1046: // dor la,[expr]
		unhandled("dor la,[expr]");
		break;
	case 1047: // dor lc,[expr]
		unhandled("dor lc,[expr]");
		break;
	case 1048: // dor forever
		unhandled("dor forever");
		break;
	case 1049: // enddo
		unhandled("enddo");
		break;
	...
	case 1297: // jclr #[n],x:[pp],[x]
		unhandled("jclr #[n],x:[pp],[x]");
		break;
	case 1298: // jclr #[n],y:[pp],[x]
		unhandled("jclr #[n],y:[pp],[x]");
		break;
	case 1299: // jclr #[n],x:[qq],[x]
		unhandled("jclr #[n],x:[qq],[x]");
		break;
	case 1300: // jclr #[n],y:[qq],[x]
		unhandled("jclr #[n],y:[qq],[x]");
		break;
	case 1301: // jclr #[n],x0,[x]
		unhandled("jclr #[n],x0,[x]");
		break;
	case 1302: // jclr #[n],x1,[x]
		unhandled("jclr #[n],x1,[x]");
		break;
	case 1303: // jclr #[n],y0,[x]
		unhandled("jclr #[n],y0,[x]");
		break;
	case 1304: // jclr #[n],y1,[x]
		unhandled("jclr #[n],y1,[x]");
		break;
	case 1305: // jclr #[n],a0,[x]
		unhandled("jclr #[n],a0,[x]");
		break;
	case 1306: // jclr #[n],b0,[x]
		unhandled("jclr #[n],b0,[x]");
		break;
	case 1307: // jclr #[n],a2,[x]
		unhandled("jclr #[n],a2,[x]");
		break;
	case 1308: // jclr #[n],b2,[x]
		unhandled("jclr #[n],b2,[x]");
		break;
	case 1309: // jclr #[n],a1,[x]
		unhandled("jclr #[n],a1,[x]");
		break;
	case 1310: // jclr #[n],b1,[x]
		unhandled("jclr #[n],b1,[x]");
		break;
	case 1311: // jclr #[n],a,[x]
		unhandled("jclr #[n],a,[x]");
		break;
	case 1312: // jclr #[n],b,[x]
		unhandled("jclr #[n],b,[x]");
		break;
	case 1313: // jclr #[n],r,[x]
		unhandled("jclr #[n],r,[x]");
		break;
	case 1314: // jclr #[n],n,[x]
		unhandled("jclr #[n],n,[x]");
		break;
	case 1315: // jclr #[n],m,[x]
		unhandled("jclr #[n],m,[x]");
		break;
	case 1316: // jclr #[n],ep,[x]
		unhandled("jclr #[n],ep,[x]");
		break;
	case 1317: // jclr #[n],vba,[x]
		unhandled("jclr #[n],vba,[x]");
		break;
	case 1318: // jclr #[n],sc,[x]
		unhandled("jclr #[n],sc,[x]");
		break;
	case 1319: // jclr #[n],sz,[x]
		unhandled("jclr #[n],sz,[x]");
		break;
	case 1320: // jclr #[n],sr,[x]
		unhandled("jclr #[n],sr,[x]");
		break;
	case 1321: // jclr #[n],omr,[x]
		unhandled("jclr #[n],omr,[x]");
		break;
	case 1322: // jclr #[n],sp,[x]
		unhandled("jclr #[n],sp,[x]");
		break;
	case 1323: // jclr #[n],ssh,[x]
		unhandled("jclr #[n],ssh,[x]");
		break;
	case 1324: // jclr #[n],ssl,[x]
		unhandled("jclr #[n],ssl,[x]");
		break;
	case 1325: // jclr #[n],la,[x]
		unhandled("jclr #[n],la,[x]");
		break;
	case 1326: // jclr #[n],lc,[x]
		unhandled("jclr #[n],lc,[x]");
		break;
	case 1327: // jmp (r)-n
		unhandled("jmp (r)-n");
		break;
	...
	case 1542: // jset #[n],x:[pp],[x]
		unhandled("jset #[n],x:[pp],[x]");
		break;
	case 1543: // jset #[n],y:[pp],[x]
		unhandled("jset #[n],y:[pp],[x]");
		break;
	case 1544: // jset #[n],x:[qq],[x]
		unhandled("jset #[n],x:[qq],[x]");
		break;
	case 1545: // jset #[n],y:[qq],[x]
		unhandled("jset #[n],y:[qq],[x]");
		break;
	case 1546: // jset #[n],x0,[x]
		unhandled("jset #[n],x0,[x]");
		break;
	case 1547: // jset #[n],x1,[x]
		unhandled("jset #[n],x1,[x]");
		break;
	case 1548: // jset #[n],y0,[x]
		unhandled("jset #[n],y0,[x]");
		break;
	case 1549: // jset #[n],y1,[x]
		unhandled("jset #[n],y1,[x]");
		break;
	case 1550: // jset #[n],a0,[x]
		unhandled("jset #[n],a0,[x]");
		break;
	case 1551: // jset #[n],b0,[x]
		unhandled("jset #[n],b0,[x]");
		break;
	case 1552: // jset #[n],a2,[x]
		unhandled("jset #[n],a2,[x]");
		break;
	case 1553: // jset #[n],b2,[x]
		unhandled("jset #[n],b2,[x]");
		break;
	case 1554: // jset #[n],a1,[x]
		unhandled("jset #[n],a1,[x]");
		break;
	case 1555: // jset #[n],b1,[x]
		unhandled("jset #[n],b1,[x]");
		break;
	case 1556: // jset #[n],a,[x]
		unhandled("jset #[n],a,[x]");
		break;
	case 1557: // jset #[n],b,[x]
		unhandled("jset #[n],b,[x]");
		break;
	case 1558: // jset #[n],r,[x]
		unhandled("jset #[n],r,[x]");
		break;
	case 1559: // jset #[n],n,[x]
		unhandled("jset #[n],n,[x]");
		break;
	case 1560: // jset #[n],m,[x]
		unhandled("jset #[n],m,[x]");
		break;
	case 1561: // jset #[n],ep,[x]
		unhandled("jset #[n],ep,[x]");
		break;
	case 1562: // jset #[n],vba,[x]
		unhandled("jset #[n],vba,[x]");
		break;
	case 1563: // jset #[n],sc,[x]
		unhandled("jset #[n],sc,[x]");
		break;
	case 1564: // jset #[n],sz,[x]
		unhandled("jset #[n],sz,[x]");
		break;
	case 1565: // jset #[n],sr,[x]
		unhandled("jset #[n],sr,[x]");
		break;
	case 1566: // jset #[n],omr,[x]
		unhandled("jset #[n],omr,[x]");
		break;
	case 1567: // jset #[n],sp,[x]
		unhandled("jset #[n],sp,[x]");
		break;
	case 1568: // jset #[n],ssh,[x]
		unhandled("jset #[n],ssh,[x]");
		break;
	case 1569: // jset #[n],ssl,[x]
		unhandled("jset #[n],ssl,[x]");
		break;
	case 1570: // jset #[n],la,[x]
		unhandled("jset #[n],la,[x]");
		break;
	case 1571: // jset #[n],lc,[x]
		unhandled("jset #[n],lc,[x]");
		break;
	case 1572: // jsr (r)-n
		unhandled("jsr (r)-n");
		break;
	...
	case 3503: // movep #[i],x:[pp]
		unhandled("movep #[i],x:[pp]");
		break;
	case 3504: // movep #[i],y:[pp]
		unhandled("movep #[i],y:[pp]");
		break;
	...
	case 3567: // movep p:(r)-n,x:[pp]
		unhandled("movep p:(r)-n,x:[pp]");
		break;
	case 3568: // movep p:(r)+n,x:[pp]
		unhandled("movep p:(r)+n,x:[pp]");
		break;
	case 3569: // movep p:(r)-,x:[pp]
		unhandled("movep p:(r)-,x:[pp]");
		break;
	...
	case 3574: // movep p:(r)-n,y:[pp]
		unhandled("movep p:(r)-n,y:[pp]");
		break;
	case 3575: // movep p:(r)+n,y:[pp]
		unhandled("movep p:(r)+n,y:[pp]");
		break;
	case 3576: // movep p:(r)-,y:[pp]
		unhandled("movep p:(r)-,y:[pp]");
		break;
	...
	case 3581: // movep x:[pp],p:(r)-n
		unhandled("movep x:[pp],p:(r)-n");
		break;
	case 3582: // movep x:[pp],p:(r)+n
		unhandled("movep x:[pp],p:(r)+n");
		break;
	case 3583: // movep x:[pp],p:(r)-
		unhandled("movep x:[pp],p:(r)-");
		break;
	...
	case 3588: // movep y:[pp],p:(r)-n
		unhandled("movep y:[pp],p:(r)-n");
		break;
	case 3589: // movep y:[pp],p:(r)+n
		unhandled("movep y:[pp],p:(r)+n");
		break;
	case 3590: // movep y:[pp],p:(r)-
		unhandled("movep y:[pp],p:(r)-");
		break;
	...
	case 3627: // movep x0,x:[pp]
		unhandled("movep x0,x:[pp]");
		break;
	case 3628: // movep x1,x:[pp]
		unhandled("movep x1,x:[pp]");
		break;
	case 3629: // movep y0,x:[pp]
		unhandled("movep y0,x:[pp]");
		break;
	case 3630: // movep y1,x:[pp]
		unhandled("movep y1,x:[pp]");
		break;
	case 3631: // movep a0,x:[pp]
		unhandled("movep a0,x:[pp]");
		break;
	case 3632: // movep b0,x:[pp]
		unhandled("movep b0,x:[pp]");
		break;
	case 3633: // movep a2,x:[pp]
		unhandled("movep a2,x:[pp]");
		break;
	case 3634: // movep b2,x:[pp]
		unhandled("movep b2,x:[pp]");
		break;
	case 3635: // movep a1,x:[pp]
		unhandled("movep a1,x:[pp]");
		break;
	case 3636: // movep b1,x:[pp]
		unhandled("movep b1,x:[pp]");
		break;
	case 3637: // movep a,x:[pp]
		unhandled("movep a,x:[pp]");
		break;
	case 3638: // movep b,x:[pp]
		unhandled("movep b,x:[pp]");
		break;
	case 3639: // movep r,x:[pp]
		unhandled("movep r,x:[pp]");
		break;
	case 3640: // movep n,x:[pp]
		unhandled("movep n,x:[pp]");
		break;
	case 3641: // movep m,x:[pp]
		unhandled("movep m,x:[pp]");
		break;
	case 3642: // movep ep,x:[pp]
		unhandled("movep ep,x:[pp]");
		break;
	case 3643: // movep vba,x:[pp]
		unhandled("movep vba,x:[pp]");
		break;
	case 3644: // movep sc,x:[pp]
		unhandled("movep sc,x:[pp]");
		break;
	case 3645: // movep sz,x:[pp]
		unhandled("movep sz,x:[pp]");
		break;
	case 3646: // movep sr,x:[pp]
		unhandled("movep sr,x:[pp]");
		break;
	case 3647: // movep omr,x:[pp]
		unhandled("movep omr,x:[pp]");
		break;
	case 3648: // movep sp,x:[pp]
		unhandled("movep sp,x:[pp]");
		break;
	case 3649: // movep ssh,x:[pp]
		unhandled("movep ssh,x:[pp]");
		break;
	case 3650: // movep ssl,x:[pp]
		unhandled("movep ssl,x:[pp]");
		break;
	case 3651: // movep la,x:[pp]
		unhandled("movep la,x:[pp]");
		break;
	case 3652: // movep lc,x:[pp]
		unhandled("movep lc,x:[pp]");
		break;
	case 3653: // movep x0,y:[pp]
		unhandled("movep x0,y:[pp]");
		break;
	case 3654: // movep x1,y:[pp]
		unhandled("movep x1,y:[pp]");
		break;
	case 3655: // movep y0,y:[pp]
		unhandled("movep y0,y:[pp]");
		break;
	case 3656: // movep y1,y:[pp]
		unhandled("movep y1,y:[pp]");
		break;
	case 3657: // movep a0,y:[pp]
		unhandled("movep a0,y:[pp]");
		break;
	case 3658: // movep b0,y:[pp]
		unhandled("movep b0,y:[pp]");
		break;
	case 3659: // movep a2,y:[pp]
		unhandled("movep a2,y:[pp]");
		break;
	case 3660: // movep b2,y:[pp]
		unhandled("movep b2,y:[pp]");
		break;
	case 3661: // movep a1,y:[pp]
		unhandled("movep a1,y:[pp]");
		break;
	case 3662: // movep b1,y:[pp]
		unhandled("movep b1,y:[pp]");
		break;
	case 3663: // movep a,y:[pp]
		unhandled("movep a,y:[pp]");
		break;
	case 3664: // movep b,y:[pp]
		unhandled("movep b,y:[pp]");
		break;
	case 3665: // movep r,y:[pp]
		unhandled("movep r,y:[pp]");
		break;
	case 3666: // movep n,y:[pp]
		unhandled("movep n,y:[pp]");
		break;
	case 3667: // movep m,y:[pp]
		unhandled("movep m,y:[pp]");
		break;
	case 3668: // movep ep,y:[pp]
		unhandled("movep ep,y:[pp]");
		break;
	case 3669: // movep vba,y:[pp]
		unhandled("movep vba,y:[pp]");
		break;
	case 3670: // movep sc,y:[pp]
		unhandled("movep sc,y:[pp]");
		break;
	case 3671: // movep sz,y:[pp]
		unhandled("movep sz,y:[pp]");
		break;
	case 3672: // movep sr,y:[pp]
		unhandled("movep sr,y:[pp]");
		break;
	case 3673: // movep omr,y:[pp]
		unhandled("movep omr,y:[pp]");
		break;
	case 3674: // movep sp,y:[pp]
		unhandled("movep sp,y:[pp]");
		break;
	case 3675: // movep ssh,y:[pp]
		unhandled("movep ssh,y:[pp]");
		break;
	case 3676: // movep ssl,y:[pp]
		unhandled("movep ssl,y:[pp]");
		break;
	case 3677: // movep la,y:[pp]
		unhandled("movep la,y:[pp]");
		break;
	case 3678: // movep lc,y:[pp]
		unhandled("movep lc,y:[pp]");
		break;
	case 3679: // movep x:[pp],x0
		unhandled("movep x:[pp],x0");
		break;
	case 3680: // movep x:[pp],x1
		unhandled("movep x:[pp],x1");
		break;
	case 3681: // movep x:[pp],y0
		unhandled("movep x:[pp],y0");
		break;
	case 3682: // movep x:[pp],y1
		unhandled("movep x:[pp],y1");
		break;
	case 3683: // movep x:[pp],a0
		unhandled("movep x:[pp],a0");
		break;
	case 3684: // movep x:[pp],b0
		unhandled("movep x:[pp],b0");
		break;
	case 3685: // movep x:[pp],a2
		unhandled("movep x:[pp],a2");
		break;
	case 3686: // movep x:[pp],b2
		unhandled("movep x:[pp],b2");
		break;
	case 3687: // movep x:[pp],a1
		unhandled("movep x:[pp],a1");
		break;
	case 3688: // movep x:[pp],b1
		unhandled("movep x:[pp],b1");
		break;
	case 3689: // movep x:[pp],a
		unhandled("movep x:[pp],a");
		break;
	case 3690: // movep x:[pp],b
		unhandled("movep x:[pp],b");
		break;
	case 3691: // movep x:[pp],r
		unhandled("movep x:[pp],r");
		break;
	case 3692: // movep x:[pp],n
		unhandled("movep x:[pp],n");
		break;
	case 3693: // movep x:[pp],m
		unhandled("movep x:[pp],m");
		break;
	case 3694: // movep x:[pp],ep
		unhandled("movep x:[pp],ep");
		break;
	case 3695: // movep x:[pp],vba
		unhandled("movep x:[pp],vba");
		break;
	case 3696: // movep x:[pp],sc
		unhandled("movep x:[pp],sc");
		break;
	case 3697: // movep x:[pp],sz
		unhandled("movep x:[pp],sz");
		break;
	case 3698: // movep x:[pp],sr
		unhandled("movep x:[pp],sr");
		break;
	case 3699: // movep x:[pp],omr
		unhandled("movep x:[pp],omr");
		break;
	case 3700: // movep x:[pp],sp
		unhandled("movep x:[pp],sp");
		break;
	case 3701: // movep x:[pp],ssh
		unhandled("movep x:[pp],ssh");
		break;
	case 3702: // movep x:[pp],ssl
		unhandled("movep x:[pp],ssl");
		break;
	case 3703: // movep x:[pp],la
		unhandled("movep x:[pp],la");
		break;
	case 3704: // movep x:[pp],lc
		unhandled("movep x:[pp],lc");
		break;
	case 3705: // movep y:[pp],x0
		unhandled("movep y:[pp],x0");
		break;
	case 3706: // movep y:[pp],x1
		unhandled("movep y:[pp],x1");
		break;
	case 3707: // movep y:[pp],y0
		unhandled("movep y:[pp],y0");
		break;
	case 3708: // movep y:[pp],y1
		unhandled("movep y:[pp],y1");
		break;
	case 3709: // movep y:[pp],a0
		unhandled("movep y:[pp],a0");
		break;
	case 3710: // movep y:[pp],b0
		unhandled("movep y:[pp],b0");
		break;
	case 3711: // movep y:[pp],a2
		unhandled("movep y:[pp],a2");
		break;
	case 3712: // movep y:[pp],b2
		unhandled("movep y:[pp],b2");
		break;
	case 3713: // movep y:[pp],a1
		unhandled("movep y:[pp],a1");
		break;
	case 3714: // movep y:[pp],b1
		unhandled("movep y:[pp],b1");
		break;
	case 3715: // movep y:[pp],a
		unhandled("movep y:[pp],a");
		break;
	case 3716: // movep y:[pp],b
		unhandled("movep y:[pp],b");
		break;
	case 3717: // movep y:[pp],r
		unhandled("movep y:[pp],r");
		break;
	case 3718: // movep y:[pp],n
		unhandled("movep y:[pp],n");
		break;
	case 3719: // movep y:[pp],m
		unhandled("movep y:[pp],m");
		break;
	case 3720: // movep y:[pp],ep
		unhandled("movep y:[pp],ep");
		break;
	case 3721: // movep y:[pp],vba
		unhandled("movep y:[pp],vba");
		break;
	case 3722: // movep y:[pp],sc
		unhandled("movep y:[pp],sc");
		break;
	case 3723: // movep y:[pp],sz
		unhandled("movep y:[pp],sz");
		break;
	case 3724: // movep y:[pp],sr
		unhandled("movep y:[pp],sr");
		break;
	case 3725: // movep y:[pp],omr
		unhandled("movep y:[pp],omr");
		break;
	case 3726: // movep y:[pp],sp
		unhandled("movep y:[pp],sp");
		break;
	case 3727: // movep y:[pp],ssh
		unhandled("movep y:[pp],ssh");
		break;
	case 3728: // movep y:[pp],ssl
		unhandled("movep y:[pp],ssl");
		break;
	case 3729: // movep y:[pp],la
		unhandled("movep y:[pp],la");
		break;
	case 3730: // movep y:[pp],lc
		unhandled("movep y:[pp],lc");
		break;
	case 3731: // movep x0,x:[qq]
		unhandled("movep x0,x:[qq]");
		break;
	case 3732: // movep x1,x:[qq]
		unhandled("movep x1,x:[qq]");
		break;
	case 3733: // movep y0,x:[qq]
		unhandled("movep y0,x:[qq]");
		break;
	case 3734: // movep y1,x:[qq]
		unhandled("movep y1,x:[qq]");
		break;
	case 3735: // movep a0,x:[qq]
		unhandled("movep a0,x:[qq]");
		break;
	case 3736: // movep b0,x:[qq]
		unhandled("movep b0,x:[qq]");
		break;
	case 3737: // movep a2,x:[qq]
		unhandled("movep a2,x:[qq]");
		break;
	case 3738: // movep b2,x:[qq]
		unhandled("movep b2,x:[qq]");
		break;
	case 3739: // movep a1,x:[qq]
		unhandled("movep a1,x:[qq]");
		break;
	case 3740: // movep b1,x:[qq]
		unhandled("movep b1,x:[qq]");
		break;
	case 3741: // movep a,x:[qq]
		unhandled("movep a,x:[qq]");
		break;
	case 3742: // movep b,x:[qq]
		unhandled("movep b,x:[qq]");
		break;
	case 3743: // movep r,x:[qq]
		unhandled("movep r,x:[qq]");
		break;
	case 3744: // movep n,x:[qq]
		unhandled("movep n,x:[qq]");
		break;
	case 3745: // movep m,x:[qq]
		unhandled("movep m,x:[qq]");
		break;
	case 3746: // movep ep,x:[qq]
		unhandled("movep ep,x:[qq]");
		break;
	case 3747: // movep vba,x:[qq]
		unhandled("movep vba,x:[qq]");
		break;
	case 3748: // movep sc,x:[qq]
		unhandled("movep sc,x:[qq]");
		break;
	case 3749: // movep sz,x:[qq]
		unhandled("movep sz,x:[qq]");
		break;
	case 3750: // movep sr,x:[qq]
		unhandled("movep sr,x:[qq]");
		break;
	case 3751: // movep omr,x:[qq]
		unhandled("movep omr,x:[qq]");
		break;
	case 3752: // movep sp,x:[qq]
		unhandled("movep sp,x:[qq]");
		break;
	case 3753: // movep ssh,x:[qq]
		unhandled("movep ssh,x:[qq]");
		break;
	case 3754: // movep ssl,x:[qq]
		unhandled("movep ssl,x:[qq]");
		break;
	case 3755: // movep la,x:[qq]
		unhandled("movep la,x:[qq]");
		break;
	case 3756: // movep lc,x:[qq]
		unhandled("movep lc,x:[qq]");
		break;
	case 3757: // movep x:[qq],x0
		unhandled("movep x:[qq],x0");
		break;
	case 3758: // movep x:[qq],x1
		unhandled("movep x:[qq],x1");
		break;
	case 3759: // movep x:[qq],y0
		unhandled("movep x:[qq],y0");
		break;
	case 3760: // movep x:[qq],y1
		unhandled("movep x:[qq],y1");
		break;
	case 3761: // movep x:[qq],a0
		unhandled("movep x:[qq],a0");
		break;
	case 3762: // movep x:[qq],b0
		unhandled("movep x:[qq],b0");
		break;
	case 3763: // movep x:[qq],a2
		unhandled("movep x:[qq],a2");
		break;
	case 3764: // movep x:[qq],b2
		unhandled("movep x:[qq],b2");
		break;
	case 3765: // movep x:[qq],a1
		unhandled("movep x:[qq],a1");
		break;
	case 3766: // movep x:[qq],b1
		unhandled("movep x:[qq],b1");
		break;
	case 3767: // movep x:[qq],a
		unhandled("movep x:[qq],a");
		break;
	case 3768: // movep x:[qq],b
		unhandled("movep x:[qq],b");
		break;
	case 3769: // movep x:[qq],r
		unhandled("movep x:[qq],r");
		break;
	case 3770: // movep x:[qq],n
		unhandled("movep x:[qq],n");
		break;
	case 3771: // movep x:[qq],m
		unhandled("movep x:[qq],m");
		break;
	case 3772: // movep x:[qq],ep
		unhandled("movep x:[qq],ep");
		break;
	case 3773: // movep x:[qq],vba
		unhandled("movep x:[qq],vba");
		break;
	case 3774: // movep x:[qq],sc
		unhandled("movep x:[qq],sc");
		break;
	case 3775: // movep x:[qq],sz
		unhandled("movep x:[qq],sz");
		break;
	case 3776: // movep x:[qq],sr
		unhandled("movep x:[qq],sr");
		break;
	case 3777: // movep x:[qq],omr
		unhandled("movep x:[qq],omr");
		break;
	case 3778: // movep x:[qq],sp
		unhandled("movep x:[qq],sp");
		break;
	case 3779: // movep x:[qq],ssh
		unhandled("movep x:[qq],ssh");
		break;
	case 3780: // movep x:[qq],ssl
		unhandled("movep x:[qq],ssl");
		break;
	case 3781: // movep x:[qq],la
		unhandled("movep x:[qq],la");
		break;
	case 3782: // movep x:[qq],lc
		unhandled("movep x:[qq],lc");
		break;
	case 3783: // movep x0,y:[qq]
		unhandled("movep x0,y:[qq]");
		break;
	case 3784: // movep x1,y:[qq]
		unhandled("movep x1,y:[qq]");
		break;
	case 3785: // movep y0,y:[qq]
		unhandled("movep y0,y:[qq]");
		break;
	case 3786: // movep y1,y:[qq]
		unhandled("movep y1,y:[qq]");
		break;
	case 3787: // movep a0,y:[qq]
		unhandled("movep a0,y:[qq]");
		break;
	case 3788: // movep b0,y:[qq]
		unhandled("movep b0,y:[qq]");
		break;
	case 3789: // movep a2,y:[qq]
		unhandled("movep a2,y:[qq]");
		break;
	case 3790: // movep b2,y:[qq]
		unhandled("movep b2,y:[qq]");
		break;
	case 3791: // movep a1,y:[qq]
		unhandled("movep a1,y:[qq]");
		break;
	case 3792: // movep b1,y:[qq]
		unhandled("movep b1,y:[qq]");
		break;
	case 3793: // movep a,y:[qq]
		unhandled("movep a,y:[qq]");
		break;
	case 3794: // movep b,y:[qq]
		unhandled("movep b,y:[qq]");
		break;
	case 3795: // movep r,y:[qq]
		unhandled("movep r,y:[qq]");
		break;
	case 3796: // movep n,y:[qq]
		unhandled("movep n,y:[qq]");
		break;
	case 3797: // movep m,y:[qq]
		unhandled("movep m,y:[qq]");
		break;
	case 3798: // movep ep,y:[qq]
		unhandled("movep ep,y:[qq]");
		break;
	case 3799: // movep vba,y:[qq]
		unhandled("movep vba,y:[qq]");
		break;
	case 3800: // movep sc,y:[qq]
		unhandled("movep sc,y:[qq]");
		break;
	case 3801: // movep sz,y:[qq]
		unhandled("movep sz,y:[qq]");
		break;
	case 3802: // movep sr,y:[qq]
		unhandled("movep sr,y:[qq]");
		break;
	case 3803: // movep omr,y:[qq]
		unhandled("movep omr,y:[qq]");
		break;
	case 3804: // movep sp,y:[qq]
		unhandled("movep sp,y:[qq]");
		break;
	case 3805: // movep ssh,y:[qq]
		unhandled("movep ssh,y:[qq]");
		break;
	case 3806: // movep ssl,y:[qq]
		unhandled("movep ssl,y:[qq]");
		break;
	case 3807: // movep la,y:[qq]
		unhandled("movep la,y:[qq]");
		break;
	case 3808: // movep lc,y:[qq]
		unhandled("movep lc,y:[qq]");
		break;
	case 3809: // movep y:[qq],x0
		unhandled("movep y:[qq],x0");
		break;
	case 3810: // movep y:[qq],x1
		unhandled("movep y:[qq],x1");
		break;
	case 3811: // movep y:[qq],y0
		unhandled("movep y:[qq],y0");
		break;
	case 3812: // movep y:[qq],y1
		unhandled("movep y:[qq],y1");
		break;
	case 3813: // movep y:[qq],a0
		unhandled("movep y:[qq],a0");
		break;
	case 3814: // movep y:[qq],b0
		unhandled("movep y:[qq],b0");
		break;
	case 3815: // movep y:[qq],a2
		unhandled("movep y:[qq],a2");
		break;
	case 3816: // movep y:[qq],b2
		unhandled("movep y:[qq],b2");
		break;
	case 3817: // movep y:[qq],a1
		unhandled("movep y:[qq],a1");
		break;
	case 3818: // movep y:[qq],b1
		unhandled("movep y:[qq],b1");
		break;
	case 3819: // movep y:[qq],a
		unhandled("movep y:[qq],a");
		break;
	case 3820: // movep y:[qq],b
		unhandled("movep y:[qq],b");
		break;
	case 3821: // movep y:[qq],r
		unhandled("movep y:[qq],r");
		break;
	case 3822: // movep y:[qq],n
		unhandled("movep y:[qq],n");
		break;
	case 3823: // movep y:[qq],m
		unhandled("movep y:[qq],m");
		break;
	case 3824: // movep y:[qq],ep
		unhandled("movep y:[qq],ep");
		break;
	case 3825: // movep y:[qq],vba
		unhandled("movep y:[qq],vba");
		break;
	case 3826: // movep y:[qq],sc
		unhandled("movep y:[qq],sc");
		break;
	case 3827: // movep y:[qq],sz
		unhandled("movep y:[qq],sz");
		break;
	case 3828: // movep y:[qq],sr
		unhandled("movep y:[qq],sr");
		break;
	case 3829: // movep y:[qq],omr
		unhandled("movep y:[qq],omr");
		break;
	case 3830: // movep y:[qq],sp
		unhandled("movep y:[qq],sp");
		break;
	case 3831: // movep y:[qq],ssh
		unhandled("movep y:[qq],ssh");
		break;
	case 3832: // movep y:[qq],ssl
		unhandled("movep y:[qq],ssl");
		break;
	case 3833: // movep y:[qq],la
		unhandled("movep y:[qq],la");
		break;
	case 3834: // movep y:[qq],lc
		unhandled("movep y:[qq],lc");
		break;
