...
void dsp563xx_device::execute_pre_move(u16 kmove, u32 opcode, u32 exv)
{
	...
	case 1460: { // x:(r)+n,x0 y:(rh)+n,y0
		unhandled("x:(r)+n,x0 y:(rh)+n,y0");
		break;
		}
	case 1461: { // x:(r)+n,x0 y:(rh)+n,y1
		unhandled("x:(r)+n,x0 y:(rh)+n,y1");
		break;
		}
	case 1462: { // x:(r)+n,x0 y:(rh)+n,a
		unhandled("x:(r)+n,x0 y:(rh)+n,a");
		break;
		}
	case 1463: { // x:(r)+n,x0 y:(rh)+n,b
		unhandled("x:(r)+n,x0 y:(rh)+n,b");
		break;
		}
	case 1464: { // x:(r)+n,x1 y:(rh)+n,y0
		unhandled("x:(r)+n,x1 y:(rh)+n,y0");
		break;
		}
	case 1465: { // x:(r)+n,x1 y:(rh)+n,y1
		unhandled("x:(r)+n,x1 y:(rh)+n,y1");
		break;
		}
	case 1466: { // x:(r)+n,x1 y:(rh)+n,a
		unhandled("x:(r)+n,x1 y:(rh)+n,a");
		break;
		}
	case 1467: { // x:(r)+n,x1 y:(rh)+n,b
		unhandled("x:(r)+n,x1 y:(rh)+n,b");
		break;
		}
	case 1468: { // x:(r)+n,a y:(rh)+n,y0
		unhandled("x:(r)+n,a y:(rh)+n,y0");
		break;
		}
	case 1469: { // x:(r)+n,a y:(rh)+n,y1
		unhandled("x:(r)+n,a y:(rh)+n,y1");
		break;
		}
	case 1470: { // x:(r)+n,a y:(rh)+n,a
		unhandled("x:(r)+n,a y:(rh)+n,a");
		break;
		}
	case 1471: { // x:(r)+n,a y:(rh)+n,b
		unhandled("x:(r)+n,a y:(rh)+n,b");
		break;
		}
	case 1472: { // x:(r)+n,b y:(rh)+n,y0
		unhandled("x:(r)+n,b y:(rh)+n,y0");
		break;
		}
	case 1473: { // x:(r)+n,b y:(rh)+n,y1
		unhandled("x:(r)+n,b y:(rh)+n,y1");
		break;
		}
	case 1474: { // x:(r)+n,b y:(rh)+n,a
		unhandled("x:(r)+n,b y:(rh)+n,a");
		break;
		}
	case 1475: { // x:(r)+n,b y:(rh)+n,b
		unhandled("x:(r)+n,b y:(rh)+n,b");
		break;
		}
	case 1476: { // x:(r)+n,x0 y:(rh)-,y0
		unhandled("x:(r)+n,x0 y:(rh)-,y0");
		break;
		}
	case 1477: { // x:(r)+n,x0 y:(rh)-,y1
		unhandled("x:(r)+n,x0 y:(rh)-,y1");
		break;
		}
	case 1478: { // x:(r)+n,x0 y:(rh)-,a
	...
	case 1480: { // x:(r)+n,x1 y:(rh)-,y0
		unhandled("x:(r)+n,x1 y:(rh)-,y0");
		break;
		}
	case 1481: { // x:(r)+n,x1 y:(rh)-,y1
		unhandled("x:(r)+n,x1 y:(rh)-,y1");
		break;
		}
	case 1482: { // x:(r)+n,x1 y:(rh)-,a
	...
	case 1484: { // x:(r)+n,a y:(rh)-,y0
		unhandled("x:(r)+n,a y:(rh)-,y0");
		break;
		}
	case 1485: { // x:(r)+n,a y:(rh)-,y1
		unhandled("x:(r)+n,a y:(rh)-,y1");
		break;
		}
	case 1486: { // x:(r)+n,a y:(rh)-,a
	...
	case 1488: { // x:(r)+n,b y:(rh)-,y0
		unhandled("x:(r)+n,b y:(rh)-,y0");
		break;
		}
	case 1489: { // x:(r)+n,b y:(rh)-,y1
		unhandled("x:(r)+n,b y:(rh)-,y1");
		break;
		}
	case 1490: { // x:(r)+n,b y:(rh)-,a
	...
	case 1492: { // x:(r)+n,x0 y:(rh)+,y0
		unhandled("x:(r)+n,x0 y:(rh)+,y0");
		break;
		}
	case 1493: { // x:(r)+n,x0 y:(rh)+,y1
		unhandled("x:(r)+n,x0 y:(rh)+,y1");
		break;
		}
	case 1494: { // x:(r)+n,x0 y:(rh)+,a
		unhandled("x:(r)+n,x0 y:(rh)+,a");
		break;
		}
	...
	case 1496: { // x:(r)+n,x1 y:(rh)+,y0
		unhandled("x:(r)+n,x1 y:(rh)+,y0");
		break;
		}
	case 1497: { // x:(r)+n,x1 y:(rh)+,y1
		unhandled("x:(r)+n,x1 y:(rh)+,y1");
		break;
		}
	case 1498: { // x:(r)+n,x1 y:(rh)+,a
		unhandled("x:(r)+n,x1 y:(rh)+,a");
		break;
		}
	...
	case 1500: { // x:(r)+n,a y:(rh)+,y0
		unhandled("x:(r)+n,a y:(rh)+,y0");
		break;
		}
	case 1501: { // x:(r)+n,a y:(rh)+,y1
		unhandled("x:(r)+n,a y:(rh)+,y1");
		break;
		}
	case 1502: { // x:(r)+n,a y:(rh)+,a
		unhandled("x:(r)+n,a y:(rh)+,a");
		break;
		}
	case 1503: { // x:(r)+n,a y:(rh)+,b
		unhandled("x:(r)+n,a y:(rh)+,b");
		break;
		}
	case 1504: { // x:(r)+n,b y:(rh)+,y0
		unhandled("x:(r)+n,b y:(rh)+,y0");
		break;
		}
	case 1505: { // x:(r)+n,b y:(rh)+,y1
		unhandled("x:(r)+n,b y:(rh)+,y1");
		break;
		}
	case 1506: { // x:(r)+n,b y:(rh)+,a
		unhandled("x:(r)+n,b y:(rh)+,a");
		break;
		}
	...
	case 1508: { // x:(r)+n,x0 y:(rh),y0
		unhandled("x:(r)+n,x0 y:(rh),y0");
		break;
		}
	case 1509: { // x:(r)+n,x0 y:(rh),y1
		unhandled("x:(r)+n,x0 y:(rh),y1");
		break;
		}
	case 1510: { // x:(r)+n,x0 y:(rh),a
		unhandled("x:(r)+n,x0 y:(rh),a");
		break;
		}
	...
	case 1512: { // x:(r)+n,x1 y:(rh),y0
		unhandled("x:(r)+n,x1 y:(rh),y0");
		break;
		}
	case 1513: { // x:(r)+n,x1 y:(rh),y1
		unhandled("x:(r)+n,x1 y:(rh),y1");
		break;
		}
	case 1514: { // x:(r)+n,x1 y:(rh),a
		unhandled("x:(r)+n,x1 y:(rh),a");
		break;
		}
	...
	case 1516: { // x:(r)+n,a y:(rh),y0
		unhandled("x:(r)+n,a y:(rh),y0");
		break;
		}
	case 1517: { // x:(r)+n,a y:(rh),y1
		unhandled("x:(r)+n,a y:(rh),y1");
		break;
		}
	case 1518: { // x:(r)+n,a y:(rh),a
		unhandled("x:(r)+n,a y:(rh),a");
		break;
		}
	...
	case 1520: { // x:(r)+n,b y:(rh),y0
		unhandled("x:(r)+n,b y:(rh),y0");
		break;
		}
	case 1521: { // x:(r)+n,b y:(rh),y1
		unhandled("x:(r)+n,b y:(rh),y1");
		break;
		}
	case 1522: { // x:(r)+n,b y:(rh),a
		unhandled("x:(r)+n,b y:(rh),a");
		break;
		}
	...
	case 1652: { // x:(r),x0 y:(rh)+n,y0
		unhandled("x:(r),x0 y:(rh)+n,y0");
		break;
		}
	case 1653: { // x:(r),x0 y:(rh)+n,y1
		unhandled("x:(r),x0 y:(rh)+n,y1");
		break;
		}
	case 1654: { // x:(r),x0 y:(rh)+n,a
		unhandled("x:(r),x0 y:(rh)+n,a");
		break;
		}
	case 1655: { // x:(r),x0 y:(rh)+n,b
		unhandled("x:(r),x0 y:(rh)+n,b");
		break;
		}
	case 1656: { // x:(r),x1 y:(rh)+n,y0
		unhandled("x:(r),x1 y:(rh)+n,y0");
		break;
		}
	case 1657: { // x:(r),x1 y:(rh)+n,y1
		unhandled("x:(r),x1 y:(rh)+n,y1");
		break;
		}
	case 1658: { // x:(r),x1 y:(rh)+n,a
		unhandled("x:(r),x1 y:(rh)+n,a");
		break;
		}
	case 1659: { // x:(r),x1 y:(rh)+n,b
		unhandled("x:(r),x1 y:(rh)+n,b");
		break;
		}
	case 1660: { // x:(r),a y:(rh)+n,y0
		unhandled("x:(r),a y:(rh)+n,y0");
		break;
		}
	case 1661: { // x:(r),a y:(rh)+n,y1
		unhandled("x:(r),a y:(rh)+n,y1");
		break;
		}
	case 1662: { // x:(r),a y:(rh)+n,a
		unhandled("x:(r),a y:(rh)+n,a");
		break;
		}
	case 1663: { // x:(r),a y:(rh)+n,b
		unhandled("x:(r),a y:(rh)+n,b");
		break;
		}
	case 1664: { // x:(r),b y:(rh)+n,y0
		unhandled("x:(r),b y:(rh)+n,y0");
		break;
		}
	case 1665: { // x:(r),b y:(rh)+n,y1
		unhandled("x:(r),b y:(rh)+n,y1");
		break;
		}
	case 1666: { // x:(r),b y:(rh)+n,a
		unhandled("x:(r),b y:(rh)+n,a");
		break;
		}
	case 1667: { // x:(r),b y:(rh)+n,b
		unhandled("x:(r),b y:(rh)+n,b");
		break;
		}
	case 1668: { // x:(r),x0 y:(rh)-,y0
		unhandled("x:(r),x0 y:(rh)-,y0");
		break;
		}
	case 1669: { // x:(r),x0 y:(rh)-,y1
		unhandled("x:(r),x0 y:(rh)-,y1");
		break;
		}
	case 1670: { // x:(r),x0 y:(rh)-,a
		unhandled("x:(r),x0 y:(rh)-,a");
		break;
		}
	...
	case 1672: { // x:(r),x1 y:(rh)-,y0
		unhandled("x:(r),x1 y:(rh)-,y0");
		break;
		}
	case 1673: { // x:(r),x1 y:(rh)-,y1
		unhandled("x:(r),x1 y:(rh)-,y1");
		break;
		}
	case 1674: { // x:(r),x1 y:(rh)-,a
		unhandled("x:(r),x1 y:(rh)-,a");
		break;
		}
	...
	case 1676: { // x:(r),a y:(rh)-,y0
		unhandled("x:(r),a y:(rh)-,y0");
		break;
		}
	case 1677: { // x:(r),a y:(rh)-,y1
		unhandled("x:(r),a y:(rh)-,y1");
		break;
		}
	case 1678: { // x:(r),a y:(rh)-,a
		unhandled("x:(r),a y:(rh)-,a");
		break;
		}
	...
	case 1680: { // x:(r),b y:(rh)-,y0
		unhandled("x:(r),b y:(rh)-,y0");
		break;
		}
	case 1681: { // x:(r),b y:(rh)-,y1
		unhandled("x:(r),b y:(rh)-,y1");
		break;
		}
	case 1682: { // x:(r),b y:(rh)-,a
		unhandled("x:(r),b y:(rh)-,a");
		break;
		}
	...
	case 1684: { // x:(r),x0 y:(rh)+,y0
		unhandled("x:(r),x0 y:(rh)+,y0");
		break;
		}
	case 1685: { // x:(r),x0 y:(rh)+,y1
		unhandled("x:(r),x0 y:(rh)+,y1");
		break;
		}
	case 1686: { // x:(r),x0 y:(rh)+,a
		unhandled("x:(r),x0 y:(rh)+,a");
		break;
		}
	...
	case 1688: { // x:(r),x1 y:(rh)+,y0
		unhandled("x:(r),x1 y:(rh)+,y0");
		break;
		}
	case 1689: { // x:(r),x1 y:(rh)+,y1
		unhandled("x:(r),x1 y:(rh)+,y1");
		break;
		}
	case 1690: { // x:(r),x1 y:(rh)+,a
		unhandled("x:(r),x1 y:(rh)+,a");
		break;
		}
	...
	case 1692: { // x:(r),a y:(rh)+,y0
		unhandled("x:(r),a y:(rh)+,y0");
		break;
		}
	case 1693: { // x:(r),a y:(rh)+,y1
		unhandled("x:(r),a y:(rh)+,y1");
		break;
		}
	case 1694: { // x:(r),a y:(rh)+,a
		unhandled("x:(r),a y:(rh)+,a");
		break;
		}
	...
	case 1696: { // x:(r),b y:(rh)+,y0
		unhandled("x:(r),b y:(rh)+,y0");
		break;
		}
	case 1697: { // x:(r),b y:(rh)+,y1
		unhandled("x:(r),b y:(rh)+,y1");
		break;
		}
	case 1698: { // x:(r),b y:(rh)+,a
		unhandled("x:(r),b y:(rh)+,a");
		break;
		}
	...
	case 1700: { // x:(r),x0 y:(rh),y0
		unhandled("x:(r),x0 y:(rh),y0");
		break;
		}
	case 1701: { // x:(r),x0 y:(rh),y1
		unhandled("x:(r),x0 y:(rh),y1");
		break;
		}
	case 1702: { // x:(r),x0 y:(rh),a
		unhandled("x:(r),x0 y:(rh),a");
		break;
		}
	...
	case 1704: { // x:(r),x1 y:(rh),y0
		unhandled("x:(r),x1 y:(rh),y0");
		break;
		}
	case 1705: { // x:(r),x1 y:(rh),y1
		unhandled("x:(r),x1 y:(rh),y1");
		break;
		}
	case 1706: { // x:(r),x1 y:(rh),a
		unhandled("x:(r),x1 y:(rh),a");
		break;
		}
	...
	case 1708: { // x:(r),a y:(rh),y0
		unhandled("x:(r),a y:(rh),y0");
		break;
		}
	case 1709: { // x:(r),a y:(rh),y1
		unhandled("x:(r),a y:(rh),y1");
		break;
		}
	case 1710: { // x:(r),a y:(rh),a
		unhandled("x:(r),a y:(rh),a");
		break;
		}
	...
	case 1712: { // x:(r),b y:(rh),y0
		unhandled("x:(r),b y:(rh),y0");
		break;
		}
	case 1713: { // x:(r),b y:(rh),y1
		unhandled("x:(r),b y:(rh),y1");
		break;
		}
	case 1714: { // x:(r),b y:(rh),a
		unhandled("x:(r),b y:(rh),a");
		break;
		}
	...
	case 1716: { // x:(r)+n,x0 y0,y:(rh)+n
		unhandled("x:(r)+n,x0 y0,y:(rh)+n");
		break;
		}
	case 1717: { // x:(r)+n,x0 y1,y:(rh)+n
		unhandled("x:(r)+n,x0 y1,y:(rh)+n");
		break;
		}
	case 1718: { // x:(r)+n,x0 a,y:(rh)+n
		unhandled("x:(r)+n,x0 a,y:(rh)+n");
		break;
		}
	case 1719: { // x:(r)+n,x0 b,y:(rh)+n
		unhandled("x:(r)+n,x0 b,y:(rh)+n");
		break;
		}
	case 1720: { // x:(r)+n,x1 y0,y:(rh)+n
		unhandled("x:(r)+n,x1 y0,y:(rh)+n");
		break;
		}
	case 1721: { // x:(r)+n,x1 y1,y:(rh)+n
		unhandled("x:(r)+n,x1 y1,y:(rh)+n");
		break;
		}
	case 1722: { // x:(r)+n,x1 a,y:(rh)+n
		unhandled("x:(r)+n,x1 a,y:(rh)+n");
		break;
		}
	case 1723: { // x:(r)+n,x1 b,y:(rh)+n
		unhandled("x:(r)+n,x1 b,y:(rh)+n");
		break;
		}
	case 1724: { // x:(r)+n,a y0,y:(rh)+n
		unhandled("x:(r)+n,a y0,y:(rh)+n");
		break;
		}
	case 1725: { // x:(r)+n,a y1,y:(rh)+n
		unhandled("x:(r)+n,a y1,y:(rh)+n");
		break;
		}
	case 1726: { // x:(r)+n,a a,y:(rh)+n
		unhandled("x:(r)+n,a a,y:(rh)+n");
		break;
		}
	case 1727: { // x:(r)+n,a b,y:(rh)+n
		unhandled("x:(r)+n,a b,y:(rh)+n");
		break;
		}
	case 1728: { // x:(r)+n,b y0,y:(rh)+n
		unhandled("x:(r)+n,b y0,y:(rh)+n");
		break;
		}
	case 1729: { // x:(r)+n,b y1,y:(rh)+n
		unhandled("x:(r)+n,b y1,y:(rh)+n");
		break;
		}
	case 1730: { // x:(r)+n,b a,y:(rh)+n
		unhandled("x:(r)+n,b a,y:(rh)+n");
		break;
		}
	case 1731: { // x:(r)+n,b b,y:(rh)+n
		unhandled("x:(r)+n,b b,y:(rh)+n");
		break;
		}
	case 1732: { // x:(r)+n,x0 y0,y:(rh)-
		unhandled("x:(r)+n,x0 y0,y:(rh)-");
		break;
		}
	case 1733: { // x:(r)+n,x0 y1,y:(rh)-
		unhandled("x:(r)+n,x0 y1,y:(rh)-");
		break;
		}
	case 1734: { // x:(r)+n,x0 a,y:(rh)-
		unhandled("x:(r)+n,x0 a,y:(rh)-");
		break;
		}
	case 1735: { // x:(r)+n,x0 b,y:(rh)-
		unhandled("x:(r)+n,x0 b,y:(rh)-");
		break;
		}
	case 1736: { // x:(r)+n,x1 y0,y:(rh)-
		unhandled("x:(r)+n,x1 y0,y:(rh)-");
		break;
		}
	case 1737: { // x:(r)+n,x1 y1,y:(rh)-
		unhandled("x:(r)+n,x1 y1,y:(rh)-");
		break;
		}
	case 1738: { // x:(r)+n,x1 a,y:(rh)-
		unhandled("x:(r)+n,x1 a,y:(rh)-");
		break;
		}
	case 1739: { // x:(r)+n,x1 b,y:(rh)-
		unhandled("x:(r)+n,x1 b,y:(rh)-");
		break;
		}
	case 1740: { // x:(r)+n,a y0,y:(rh)-
		unhandled("x:(r)+n,a y0,y:(rh)-");
		break;
		}
	case 1741: { // x:(r)+n,a y1,y:(rh)-
		unhandled("x:(r)+n,a y1,y:(rh)-");
		break;
		}
	case 1742: { // x:(r)+n,a a,y:(rh)-
		unhandled("x:(r)+n,a a,y:(rh)-");
		break;
		}
	case 1743: { // x:(r)+n,a b,y:(rh)-
		unhandled("x:(r)+n,a b,y:(rh)-");
		break;
		}
	case 1744: { // x:(r)+n,b y0,y:(rh)-
		unhandled("x:(r)+n,b y0,y:(rh)-");
		break;
		}
	case 1745: { // x:(r)+n,b y1,y:(rh)-
		unhandled("x:(r)+n,b y1,y:(rh)-");
		break;
		}
	case 1746: { // x:(r)+n,b a,y:(rh)-
		unhandled("x:(r)+n,b a,y:(rh)-");
		break;
		}
	case 1747: { // x:(r)+n,b b,y:(rh)-
		unhandled("x:(r)+n,b b,y:(rh)-");
		break;
		}
	case 1748: { // x:(r)+n,x0 y0,y:(rh)+
		unhandled("x:(r)+n,x0 y0,y:(rh)+");
		break;
		}
	case 1749: { // x:(r)+n,x0 y1,y:(rh)+
		unhandled("x:(r)+n,x0 y1,y:(rh)+");
		break;
		}
	case 1750: { // x:(r)+n,x0 a,y:(rh)+
		unhandled("x:(r)+n,x0 a,y:(rh)+");
		break;
		}
	case 1751: { // x:(r)+n,x0 b,y:(rh)+
		unhandled("x:(r)+n,x0 b,y:(rh)+");
		break;
		}
	case 1752: { // x:(r)+n,x1 y0,y:(rh)+
		unhandled("x:(r)+n,x1 y0,y:(rh)+");
		break;
		}
	case 1753: { // x:(r)+n,x1 y1,y:(rh)+
		unhandled("x:(r)+n,x1 y1,y:(rh)+");
		break;
		}
	case 1754: { // x:(r)+n,x1 a,y:(rh)+
		unhandled("x:(r)+n,x1 a,y:(rh)+");
		break;
		}
	case 1755: { // x:(r)+n,x1 b,y:(rh)+
		unhandled("x:(r)+n,x1 b,y:(rh)+");
		break;
		}
	case 1756: { // x:(r)+n,a y0,y:(rh)+
		unhandled("x:(r)+n,a y0,y:(rh)+");
		break;
		}
	case 1757: { // x:(r)+n,a y1,y:(rh)+
		unhandled("x:(r)+n,a y1,y:(rh)+");
		break;
		}
	case 1758: { // x:(r)+n,a a,y:(rh)+
		unhandled("x:(r)+n,a a,y:(rh)+");
		break;
		}
	case 1759: { // x:(r)+n,a b,y:(rh)+
		unhandled("x:(r)+n,a b,y:(rh)+");
		break;
		}
	case 1760: { // x:(r)+n,b y0,y:(rh)+
		unhandled("x:(r)+n,b y0,y:(rh)+");
		break;
		}
	case 1761: { // x:(r)+n,b y1,y:(rh)+
		unhandled("x:(r)+n,b y1,y:(rh)+");
		break;
		}
	case 1762: { // x:(r)+n,b a,y:(rh)+
		unhandled("x:(r)+n,b a,y:(rh)+");
		break;
		}
	case 1763: { // x:(r)+n,b b,y:(rh)+
		unhandled("x:(r)+n,b b,y:(rh)+");
		break;
		}
	case 1764: { // x:(r)+n,x0 y0,y:(rh)
		unhandled("x:(r)+n,x0 y0,y:(rh)");
		break;
		}
	case 1765: { // x:(r)+n,x0 y1,y:(rh)
		unhandled("x:(r)+n,x0 y1,y:(rh)");
		break;
		}
	case 1766: { // x:(r)+n,x0 a,y:(rh)
		unhandled("x:(r)+n,x0 a,y:(rh)");
		break;
		}
	case 1767: { // x:(r)+n,x0 b,y:(rh)
		unhandled("x:(r)+n,x0 b,y:(rh)");
		break;
		}
	case 1768: { // x:(r)+n,x1 y0,y:(rh)
		unhandled("x:(r)+n,x1 y0,y:(rh)");
		break;
		}
	case 1769: { // x:(r)+n,x1 y1,y:(rh)
		unhandled("x:(r)+n,x1 y1,y:(rh)");
		break;
		}
	case 1770: { // x:(r)+n,x1 a,y:(rh)
		unhandled("x:(r)+n,x1 a,y:(rh)");
		break;
		}
	case 1771: { // x:(r)+n,x1 b,y:(rh)
		unhandled("x:(r)+n,x1 b,y:(rh)");
		break;
		}
	case 1772: { // x:(r)+n,a y0,y:(rh)
		unhandled("x:(r)+n,a y0,y:(rh)");
		break;
		}
	case 1773: { // x:(r)+n,a y1,y:(rh)
		unhandled("x:(r)+n,a y1,y:(rh)");
		break;
		}
	case 1774: { // x:(r)+n,a a,y:(rh)
		unhandled("x:(r)+n,a a,y:(rh)");
		break;
		}
	case 1775: { // x:(r)+n,a b,y:(rh)
		unhandled("x:(r)+n,a b,y:(rh)");
		break;
		}
	case 1776: { // x:(r)+n,b y0,y:(rh)
		unhandled("x:(r)+n,b y0,y:(rh)");
		break;
		}
	case 1777: { // x:(r)+n,b y1,y:(rh)
		unhandled("x:(r)+n,b y1,y:(rh)");
		break;
		}
	case 1778: { // x:(r)+n,b a,y:(rh)
		unhandled("x:(r)+n,b a,y:(rh)");
		break;
		}
	case 1779: { // x:(r)+n,b b,y:(rh)
		unhandled("x:(r)+n,b b,y:(rh)");
		break;
		}
	...
	case 1908: { // x:(r),x0 y0,y:(rh)+n
		unhandled("x:(r),x0 y0,y:(rh)+n");
		break;
		}
	case 1909: { // x:(r),x0 y1,y:(rh)+n
		unhandled("x:(r),x0 y1,y:(rh)+n");
		break;
		}
	case 1910: { // x:(r),x0 a,y:(rh)+n
		unhandled("x:(r),x0 a,y:(rh)+n");
		break;
		}
	case 1911: { // x:(r),x0 b,y:(rh)+n
		unhandled("x:(r),x0 b,y:(rh)+n");
		break;
		}
	case 1912: { // x:(r),x1 y0,y:(rh)+n
		unhandled("x:(r),x1 y0,y:(rh)+n");
		break;
		}
	case 1913: { // x:(r),x1 y1,y:(rh)+n
		unhandled("x:(r),x1 y1,y:(rh)+n");
		break;
		}
	case 1914: { // x:(r),x1 a,y:(rh)+n
		unhandled("x:(r),x1 a,y:(rh)+n");
		break;
		}
	case 1915: { // x:(r),x1 b,y:(rh)+n
		unhandled("x:(r),x1 b,y:(rh)+n");
		break;
		}
	case 1916: { // x:(r),a y0,y:(rh)+n
		unhandled("x:(r),a y0,y:(rh)+n");
		break;
		}
	case 1917: { // x:(r),a y1,y:(rh)+n
		unhandled("x:(r),a y1,y:(rh)+n");
		break;
		}
	case 1918: { // x:(r),a a,y:(rh)+n
		unhandled("x:(r),a a,y:(rh)+n");
		break;
		}
	case 1919: { // x:(r),a b,y:(rh)+n
		unhandled("x:(r),a b,y:(rh)+n");
		break;
		}
	case 1920: { // x:(r),b y0,y:(rh)+n
		unhandled("x:(r),b y0,y:(rh)+n");
		break;
		}
	case 1921: { // x:(r),b y1,y:(rh)+n
		unhandled("x:(r),b y1,y:(rh)+n");
		break;
		}
	case 1922: { // x:(r),b a,y:(rh)+n
		unhandled("x:(r),b a,y:(rh)+n");
		break;
		}
	case 1923: { // x:(r),b b,y:(rh)+n
		unhandled("x:(r),b b,y:(rh)+n");
		break;
		}
	case 1924: { // x:(r),x0 y0,y:(rh)-
		unhandled("x:(r),x0 y0,y:(rh)-");
		break;
		}
	case 1925: { // x:(r),x0 y1,y:(rh)-
		unhandled("x:(r),x0 y1,y:(rh)-");
		break;
		}
	case 1926: { // x:(r),x0 a,y:(rh)-
		unhandled("x:(r),x0 a,y:(rh)-");
		break;
		}
	case 1927: { // x:(r),x0 b,y:(rh)-
		unhandled("x:(r),x0 b,y:(rh)-");
		break;
		}
	case 1928: { // x:(r),x1 y0,y:(rh)-
		unhandled("x:(r),x1 y0,y:(rh)-");
		break;
		}
	case 1929: { // x:(r),x1 y1,y:(rh)-
		unhandled("x:(r),x1 y1,y:(rh)-");
		break;
		}
	case 1930: { // x:(r),x1 a,y:(rh)-
		unhandled("x:(r),x1 a,y:(rh)-");
		break;
		}
	case 1931: { // x:(r),x1 b,y:(rh)-
		unhandled("x:(r),x1 b,y:(rh)-");
		break;
		}
	case 1932: { // x:(r),a y0,y:(rh)-
		unhandled("x:(r),a y0,y:(rh)-");
		break;
		}
	case 1933: { // x:(r),a y1,y:(rh)-
		unhandled("x:(r),a y1,y:(rh)-");
		break;
		}
	case 1934: { // x:(r),a a,y:(rh)-
		unhandled("x:(r),a a,y:(rh)-");
		break;
		}
	case 1935: { // x:(r),a b,y:(rh)-
		unhandled("x:(r),a b,y:(rh)-");
		break;
		}
	case 1936: { // x:(r),b y0,y:(rh)-
		unhandled("x:(r),b y0,y:(rh)-");
		break;
		}
	case 1937: { // x:(r),b y1,y:(rh)-
		unhandled("x:(r),b y1,y:(rh)-");
		break;
		}
	case 1938: { // x:(r),b a,y:(rh)-
		unhandled("x:(r),b a,y:(rh)-");
		break;
		}
	case 1939: { // x:(r),b b,y:(rh)-
		unhandled("x:(r),b b,y:(rh)-");
		break;
		}
	case 1940: { // x:(r),x0 y0,y:(rh)+
		unhandled("x:(r),x0 y0,y:(rh)+");
		break;
		}
	case 1941: { // x:(r),x0 y1,y:(rh)+
		unhandled("x:(r),x0 y1,y:(rh)+");
		break;
		}
	case 1942: { // x:(r),x0 a,y:(rh)+
		unhandled("x:(r),x0 a,y:(rh)+");
		break;
		}
	case 1943: { // x:(r),x0 b,y:(rh)+
		unhandled("x:(r),x0 b,y:(rh)+");
		break;
		}
	case 1944: { // x:(r),x1 y0,y:(rh)+
		unhandled("x:(r),x1 y0,y:(rh)+");
		break;
		}
	case 1945: { // x:(r),x1 y1,y:(rh)+
		unhandled("x:(r),x1 y1,y:(rh)+");
		break;
		}
	case 1946: { // x:(r),x1 a,y:(rh)+
		unhandled("x:(r),x1 a,y:(rh)+");
		break;
		}
	case 1947: { // x:(r),x1 b,y:(rh)+
		unhandled("x:(r),x1 b,y:(rh)+");
		break;
		}
	case 1948: { // x:(r),a y0,y:(rh)+
		unhandled("x:(r),a y0,y:(rh)+");
		break;
		}
	case 1949: { // x:(r),a y1,y:(rh)+
		unhandled("x:(r),a y1,y:(rh)+");
		break;
		}
	case 1950: { // x:(r),a a,y:(rh)+
		unhandled("x:(r),a a,y:(rh)+");
		break;
		}
	case 1951: { // x:(r),a b,y:(rh)+
		unhandled("x:(r),a b,y:(rh)+");
		break;
		}
	case 1952: { // x:(r),b y0,y:(rh)+
		unhandled("x:(r),b y0,y:(rh)+");
		break;
		}
	case 1953: { // x:(r),b y1,y:(rh)+
		unhandled("x:(r),b y1,y:(rh)+");
		break;
		}
	case 1954: { // x:(r),b a,y:(rh)+
		unhandled("x:(r),b a,y:(rh)+");
		break;
		}
	case 1955: { // x:(r),b b,y:(rh)+
		unhandled("x:(r),b b,y:(rh)+");
		break;
		}
	case 1956: { // x:(r),x0 y0,y:(rh)
		unhandled("x:(r),x0 y0,y:(rh)");
		break;
		}
	case 1957: { // x:(r),x0 y1,y:(rh)
		unhandled("x:(r),x0 y1,y:(rh)");
		break;
		}
	case 1958: { // x:(r),x0 a,y:(rh)
		unhandled("x:(r),x0 a,y:(rh)");
		break;
		}
	case 1959: { // x:(r),x0 b,y:(rh)
		unhandled("x:(r),x0 b,y:(rh)");
		break;
		}
	case 1960: { // x:(r),x1 y0,y:(rh)
		unhandled("x:(r),x1 y0,y:(rh)");
		break;
		}
	case 1961: { // x:(r),x1 y1,y:(rh)
		unhandled("x:(r),x1 y1,y:(rh)");
		break;
		}
	case 1962: { // x:(r),x1 a,y:(rh)
		unhandled("x:(r),x1 a,y:(rh)");
		break;
		}
	case 1963: { // x:(r),x1 b,y:(rh)
		unhandled("x:(r),x1 b,y:(rh)");
		break;
		}
	case 1964: { // x:(r),a y0,y:(rh)
		unhandled("x:(r),a y0,y:(rh)");
		break;
		}
	case 1965: { // x:(r),a y1,y:(rh)
		unhandled("x:(r),a y1,y:(rh)");
		break;
		}
	case 1966: { // x:(r),a a,y:(rh)
		unhandled("x:(r),a a,y:(rh)");
		break;
		}
	case 1967: { // x:(r),a b,y:(rh)
		unhandled("x:(r),a b,y:(rh)");
		break;
		}
	case 1968: { // x:(r),b y0,y:(rh)
		unhandled("x:(r),b y0,y:(rh)");
		break;
		}
	case 1969: { // x:(r),b y1,y:(rh)
		unhandled("x:(r),b y1,y:(rh)");
		break;
		}
	case 1970: { // x:(r),b a,y:(rh)
		unhandled("x:(r),b a,y:(rh)");
		break;
		}
	case 1971: { // x:(r),b b,y:(rh)
		unhandled("x:(r),b b,y:(rh)");
		break;
		}
	case 1972: { // x0,x:(r)+n y:(rh)+n,y0
		unhandled("x0,x:(r)+n y:(rh)+n,y0");
		break;
		}
	case 1973: { // x0,x:(r)+n y:(rh)+n,y1
		unhandled("x0,x:(r)+n y:(rh)+n,y1");
		break;
		}
	case 1974: { // x0,x:(r)+n y:(rh)+n,a
		unhandled("x0,x:(r)+n y:(rh)+n,a");
		break;
		}
	case 1975: { // x0,x:(r)+n y:(rh)+n,b
		unhandled("x0,x:(r)+n y:(rh)+n,b");
		break;
		}
	case 1976: { // x1,x:(r)+n y:(rh)+n,y0
		unhandled("x1,x:(r)+n y:(rh)+n,y0");
		break;
		}
	case 1977: { // x1,x:(r)+n y:(rh)+n,y1
		unhandled("x1,x:(r)+n y:(rh)+n,y1");
		break;
		}
	case 1978: { // x1,x:(r)+n y:(rh)+n,a
		unhandled("x1,x:(r)+n y:(rh)+n,a");
		break;
		}
	case 1979: { // x1,x:(r)+n y:(rh)+n,b
		unhandled("x1,x:(r)+n y:(rh)+n,b");
		break;
		}
	case 1980: { // a,x:(r)+n y:(rh)+n,y0
		unhandled("a,x:(r)+n y:(rh)+n,y0");
		break;
		}
	case 1981: { // a,x:(r)+n y:(rh)+n,y1
		unhandled("a,x:(r)+n y:(rh)+n,y1");
		break;
		}
	case 1982: { // a,x:(r)+n y:(rh)+n,a
		unhandled("a,x:(r)+n y:(rh)+n,a");
		break;
		}
	case 1983: { // a,x:(r)+n y:(rh)+n,b
		unhandled("a,x:(r)+n y:(rh)+n,b");
		break;
		}
	case 1984: { // b,x:(r)+n y:(rh)+n,y0
		unhandled("b,x:(r)+n y:(rh)+n,y0");
		break;
		}
	case 1985: { // b,x:(r)+n y:(rh)+n,y1
		unhandled("b,x:(r)+n y:(rh)+n,y1");
		break;
		}
	case 1986: { // b,x:(r)+n y:(rh)+n,a
		unhandled("b,x:(r)+n y:(rh)+n,a");
		break;
		}
	case 1987: { // b,x:(r)+n y:(rh)+n,b
		unhandled("b,x:(r)+n y:(rh)+n,b");
		break;
		}
	case 1988: { // x0,x:(r)+n y:(rh)-,y0
		unhandled("x0,x:(r)+n y:(rh)-,y0");
		break;
		}
	case 1989: { // x0,x:(r)+n y:(rh)-,y1
		unhandled("x0,x:(r)+n y:(rh)-,y1");
		break;
		}
	case 1990: { // x0,x:(r)+n y:(rh)-,a
	...
	case 1992: { // x1,x:(r)+n y:(rh)-,y0
		unhandled("x1,x:(r)+n y:(rh)-,y0");
		break;
		}
	case 1993: { // x1,x:(r)+n y:(rh)-,y1
		unhandled("x1,x:(r)+n y:(rh)-,y1");
		break;
		}
	case 1994: { // x1,x:(r)+n y:(rh)-,a
	...
	case 1996: { // a,x:(r)+n y:(rh)-,y0
		unhandled("a,x:(r)+n y:(rh)-,y0");
		break;
		}
	case 1997: { // a,x:(r)+n y:(rh)-,y1
		unhandled("a,x:(r)+n y:(rh)-,y1");
		break;
		}
	case 1998: { // a,x:(r)+n y:(rh)-,a
	...
	case 2000: { // b,x:(r)+n y:(rh)-,y0
		unhandled("b,x:(r)+n y:(rh)-,y0");
		break;
		}
	case 2001: { // b,x:(r)+n y:(rh)-,y1
		unhandled("b,x:(r)+n y:(rh)-,y1");
		break;
		}
	case 2002: { // b,x:(r)+n y:(rh)-,a
	...
	case 2004: { // x0,x:(r)+n y:(rh)+,y0
		unhandled("x0,x:(r)+n y:(rh)+,y0");
		break;
		}
	case 2005: { // x0,x:(r)+n y:(rh)+,y1
		unhandled("x0,x:(r)+n y:(rh)+,y1");
		break;
		}
	case 2006: { // x0,x:(r)+n y:(rh)+,a
		unhandled("x0,x:(r)+n y:(rh)+,a");
		break;
		}
	...
	case 2008: { // x1,x:(r)+n y:(rh)+,y0
		unhandled("x1,x:(r)+n y:(rh)+,y0");
		break;
		}
	case 2009: { // x1,x:(r)+n y:(rh)+,y1
		unhandled("x1,x:(r)+n y:(rh)+,y1");
		break;
		}
	case 2010: { // x1,x:(r)+n y:(rh)+,a
		unhandled("x1,x:(r)+n y:(rh)+,a");
		break;
		}
	...
	case 2012: { // a,x:(r)+n y:(rh)+,y0
		unhandled("a,x:(r)+n y:(rh)+,y0");
		break;
		}
	case 2013: { // a,x:(r)+n y:(rh)+,y1
		unhandled("a,x:(r)+n y:(rh)+,y1");
		break;
		}
	case 2014: { // a,x:(r)+n y:(rh)+,a
		unhandled("a,x:(r)+n y:(rh)+,a");
		break;
		}
	...
	case 2016: { // b,x:(r)+n y:(rh)+,y0
		unhandled("b,x:(r)+n y:(rh)+,y0");
		break;
		}
	case 2017: { // b,x:(r)+n y:(rh)+,y1
		unhandled("b,x:(r)+n y:(rh)+,y1");
		break;
		}
	case 2018: { // b,x:(r)+n y:(rh)+,a
		unhandled("b,x:(r)+n y:(rh)+,a");
		break;
		}
	...
	case 2020: { // x0,x:(r)+n y:(rh),y0
		unhandled("x0,x:(r)+n y:(rh),y0");
		break;
		}
	case 2021: { // x0,x:(r)+n y:(rh),y1
		unhandled("x0,x:(r)+n y:(rh),y1");
		break;
		}
	case 2022: { // x0,x:(r)+n y:(rh),a
		unhandled("x0,x:(r)+n y:(rh),a");
		break;
		}
	...
	case 2024: { // x1,x:(r)+n y:(rh),y0
		unhandled("x1,x:(r)+n y:(rh),y0");
		break;
		}
	case 2025: { // x1,x:(r)+n y:(rh),y1
		unhandled("x1,x:(r)+n y:(rh),y1");
		break;
		}
	case 2026: { // x1,x:(r)+n y:(rh),a
		unhandled("x1,x:(r)+n y:(rh),a");
		break;
		}
	...
	case 2028: { // a,x:(r)+n y:(rh),y0
		unhandled("a,x:(r)+n y:(rh),y0");
		break;
		}
	case 2029: { // a,x:(r)+n y:(rh),y1
		unhandled("a,x:(r)+n y:(rh),y1");
		break;
		}
	case 2030: { // a,x:(r)+n y:(rh),a
		unhandled("a,x:(r)+n y:(rh),a");
		break;
		}
	...
	case 2032: { // b,x:(r)+n y:(rh),y0
		unhandled("b,x:(r)+n y:(rh),y0");
		break;
		}
	case 2033: { // b,x:(r)+n y:(rh),y1
		unhandled("b,x:(r)+n y:(rh),y1");
		break;
		}
	case 2034: { // b,x:(r)+n y:(rh),a
		unhandled("b,x:(r)+n y:(rh),a");
		break;
		}
	...
	case 2164: { // x0,x:(r) y:(rh)+n,y0
		unhandled("x0,x:(r) y:(rh)+n,y0");
		break;
		}
	case 2165: { // x0,x:(r) y:(rh)+n,y1
		unhandled("x0,x:(r) y:(rh)+n,y1");
		break;
		}
	case 2166: { // x0,x:(r) y:(rh)+n,a
		unhandled("x0,x:(r) y:(rh)+n,a");
		break;
		}
	case 2167: { // x0,x:(r) y:(rh)+n,b
		unhandled("x0,x:(r) y:(rh)+n,b");
		break;
		}
	case 2168: { // x1,x:(r) y:(rh)+n,y0
		unhandled("x1,x:(r) y:(rh)+n,y0");
		break;
		}
	case 2169: { // x1,x:(r) y:(rh)+n,y1
		unhandled("x1,x:(r) y:(rh)+n,y1");
		break;
		}
	case 2170: { // x1,x:(r) y:(rh)+n,a
		unhandled("x1,x:(r) y:(rh)+n,a");
		break;
		}
	case 2171: { // x1,x:(r) y:(rh)+n,b
		unhandled("x1,x:(r) y:(rh)+n,b");
		break;
		}
	case 2172: { // a,x:(r) y:(rh)+n,y0
		unhandled("a,x:(r) y:(rh)+n,y0");
		break;
		}
	case 2173: { // a,x:(r) y:(rh)+n,y1
		unhandled("a,x:(r) y:(rh)+n,y1");
		break;
		}
	case 2174: { // a,x:(r) y:(rh)+n,a
		unhandled("a,x:(r) y:(rh)+n,a");
		break;
		}
	case 2175: { // a,x:(r) y:(rh)+n,b
		unhandled("a,x:(r) y:(rh)+n,b");
		break;
		}
	case 2176: { // b,x:(r) y:(rh)+n,y0
		unhandled("b,x:(r) y:(rh)+n,y0");
		break;
		}
	case 2177: { // b,x:(r) y:(rh)+n,y1
		unhandled("b,x:(r) y:(rh)+n,y1");
		break;
		}
	case 2178: { // b,x:(r) y:(rh)+n,a
		unhandled("b,x:(r) y:(rh)+n,a");
		break;
		}
	case 2179: { // b,x:(r) y:(rh)+n,b
		unhandled("b,x:(r) y:(rh)+n,b");
		break;
		}
	case 2180: { // x0,x:(r) y:(rh)-,y0
		unhandled("x0,x:(r) y:(rh)-,y0");
		break;
		}
	case 2181: { // x0,x:(r) y:(rh)-,y1
		unhandled("x0,x:(r) y:(rh)-,y1");
		break;
		}
	case 2182: { // x0,x:(r) y:(rh)-,a
		unhandled("x0,x:(r) y:(rh)-,a");
		break;
		}
	...
	case 2184: { // x1,x:(r) y:(rh)-,y0
		unhandled("x1,x:(r) y:(rh)-,y0");
		break;
		}
	case 2185: { // x1,x:(r) y:(rh)-,y1
		unhandled("x1,x:(r) y:(rh)-,y1");
		break;
		}
	case 2186: { // x1,x:(r) y:(rh)-,a
		unhandled("x1,x:(r) y:(rh)-,a");
		break;
		}
	...
	case 2188: { // a,x:(r) y:(rh)-,y0
		unhandled("a,x:(r) y:(rh)-,y0");
		break;
		}
	case 2189: { // a,x:(r) y:(rh)-,y1
		unhandled("a,x:(r) y:(rh)-,y1");
		break;
		}
	case 2190: { // a,x:(r) y:(rh)-,a
		unhandled("a,x:(r) y:(rh)-,a");
		break;
		}
	...
	case 2192: { // b,x:(r) y:(rh)-,y0
		unhandled("b,x:(r) y:(rh)-,y0");
		break;
		}
	case 2193: { // b,x:(r) y:(rh)-,y1
		unhandled("b,x:(r) y:(rh)-,y1");
		break;
		}
	case 2194: { // b,x:(r) y:(rh)-,a
		unhandled("b,x:(r) y:(rh)-,a");
		break;
		}
	case 2195: { // b,x:(r) y:(rh)-,b
		unhandled("b,x:(r) y:(rh)-,b");
		break;
		}
	case 2196: { // x0,x:(r) y:(rh)+,y0
		unhandled("x0,x:(r) y:(rh)+,y0");
		break;
		}
	case 2197: { // x0,x:(r) y:(rh)+,y1
		unhandled("x0,x:(r) y:(rh)+,y1");
		break;
		}
	case 2198: { // x0,x:(r) y:(rh)+,a
		unhandled("x0,x:(r) y:(rh)+,a");
		break;
		}
	...
	case 2200: { // x1,x:(r) y:(rh)+,y0
		unhandled("x1,x:(r) y:(rh)+,y0");
		break;
		}
	case 2201: { // x1,x:(r) y:(rh)+,y1
		unhandled("x1,x:(r) y:(rh)+,y1");
		break;
		}
	case 2202: { // x1,x:(r) y:(rh)+,a
		unhandled("x1,x:(r) y:(rh)+,a");
		break;
		}
	...
	case 2204: { // a,x:(r) y:(rh)+,y0
		unhandled("a,x:(r) y:(rh)+,y0");
		break;
		}
	case 2205: { // a,x:(r) y:(rh)+,y1
		unhandled("a,x:(r) y:(rh)+,y1");
		break;
		}
	case 2206: { // a,x:(r) y:(rh)+,a
		unhandled("a,x:(r) y:(rh)+,a");
		break;
		}
	...
	case 2208: { // b,x:(r) y:(rh)+,y0
		unhandled("b,x:(r) y:(rh)+,y0");
		break;
		}
	case 2209: { // b,x:(r) y:(rh)+,y1
		unhandled("b,x:(r) y:(rh)+,y1");
		break;
		}
	case 2210: { // b,x:(r) y:(rh)+,a
		unhandled("b,x:(r) y:(rh)+,a");
		break;
		}
	...
	case 2212: { // x0,x:(r) y:(rh),y0
		unhandled("x0,x:(r) y:(rh),y0");
		break;
		}
	case 2213: { // x0,x:(r) y:(rh),y1
		unhandled("x0,x:(r) y:(rh),y1");
		break;
		}
	case 2214: { // x0,x:(r) y:(rh),a
		unhandled("x0,x:(r) y:(rh),a");
		break;
		}
	...
	case 2216: { // x1,x:(r) y:(rh),y0
		unhandled("x1,x:(r) y:(rh),y0");
		break;
		}
	case 2217: { // x1,x:(r) y:(rh),y1
		unhandled("x1,x:(r) y:(rh),y1");
		break;
		}
	case 2218: { // x1,x:(r) y:(rh),a
		unhandled("x1,x:(r) y:(rh),a");
		break;
		}
	...
	case 2220: { // a,x:(r) y:(rh),y0
		unhandled("a,x:(r) y:(rh),y0");
		break;
		}
	case 2221: { // a,x:(r) y:(rh),y1
		unhandled("a,x:(r) y:(rh),y1");
		break;
		}
	case 2222: { // a,x:(r) y:(rh),a
		unhandled("a,x:(r) y:(rh),a");
		break;
		}
	...
	case 2224: { // b,x:(r) y:(rh),y0
		unhandled("b,x:(r) y:(rh),y0");
		break;
		}
	case 2225: { // b,x:(r) y:(rh),y1
		unhandled("b,x:(r) y:(rh),y1");
		break;
		}
	case 2226: { // b,x:(r) y:(rh),a
		unhandled("b,x:(r) y:(rh),a");
		break;
		}
	...
	case 2228: { // x0,x:(r)+n y0,y:(rh)+n
		unhandled("x0,x:(r)+n y0,y:(rh)+n");
		break;
		}
	case 2229: { // x0,x:(r)+n y1,y:(rh)+n
		unhandled("x0,x:(r)+n y1,y:(rh)+n");
		break;
		}
	case 2230: { // x0,x:(r)+n a,y:(rh)+n
		unhandled("x0,x:(r)+n a,y:(rh)+n");
		break;
		}
	case 2231: { // x0,x:(r)+n b,y:(rh)+n
		unhandled("x0,x:(r)+n b,y:(rh)+n");
		break;
		}
	case 2232: { // x1,x:(r)+n y0,y:(rh)+n
		unhandled("x1,x:(r)+n y0,y:(rh)+n");
		break;
		}
	case 2233: { // x1,x:(r)+n y1,y:(rh)+n
		unhandled("x1,x:(r)+n y1,y:(rh)+n");
		break;
		}
	case 2234: { // x1,x:(r)+n a,y:(rh)+n
		unhandled("x1,x:(r)+n a,y:(rh)+n");
		break;
		}
	case 2235: { // x1,x:(r)+n b,y:(rh)+n
		unhandled("x1,x:(r)+n b,y:(rh)+n");
		break;
		}
	case 2236: { // a,x:(r)+n y0,y:(rh)+n
		unhandled("a,x:(r)+n y0,y:(rh)+n");
		break;
		}
	case 2237: { // a,x:(r)+n y1,y:(rh)+n
		unhandled("a,x:(r)+n y1,y:(rh)+n");
		break;
		}
	case 2238: { // a,x:(r)+n a,y:(rh)+n
		unhandled("a,x:(r)+n a,y:(rh)+n");
		break;
		}
	case 2239: { // a,x:(r)+n b,y:(rh)+n
		unhandled("a,x:(r)+n b,y:(rh)+n");
		break;
		}
	case 2240: { // b,x:(r)+n y0,y:(rh)+n
		unhandled("b,x:(r)+n y0,y:(rh)+n");
		break;
		}
	case 2241: { // b,x:(r)+n y1,y:(rh)+n
		unhandled("b,x:(r)+n y1,y:(rh)+n");
		break;
		}
	case 2242: { // b,x:(r)+n a,y:(rh)+n
		unhandled("b,x:(r)+n a,y:(rh)+n");
		break;
		}
	case 2243: { // b,x:(r)+n b,y:(rh)+n
		unhandled("b,x:(r)+n b,y:(rh)+n");
		break;
		}
	case 2244: { // x0,x:(r)+n y0,y:(rh)-
		unhandled("x0,x:(r)+n y0,y:(rh)-");
		break;
		}
	case 2245: { // x0,x:(r)+n y1,y:(rh)-
		unhandled("x0,x:(r)+n y1,y:(rh)-");
		break;
		}
	case 2246: { // x0,x:(r)+n a,y:(rh)-
		unhandled("x0,x:(r)+n a,y:(rh)-");
		break;
		}
	case 2247: { // x0,x:(r)+n b,y:(rh)-
		unhandled("x0,x:(r)+n b,y:(rh)-");
		break;
		}
	case 2248: { // x1,x:(r)+n y0,y:(rh)-
		unhandled("x1,x:(r)+n y0,y:(rh)-");
		break;
		}
	case 2249: { // x1,x:(r)+n y1,y:(rh)-
		unhandled("x1,x:(r)+n y1,y:(rh)-");
		break;
		}
	case 2250: { // x1,x:(r)+n a,y:(rh)-
		unhandled("x1,x:(r)+n a,y:(rh)-");
		break;
		}
	case 2251: { // x1,x:(r)+n b,y:(rh)-
		unhandled("x1,x:(r)+n b,y:(rh)-");
		break;
		}
	case 2252: { // a,x:(r)+n y0,y:(rh)-
		unhandled("a,x:(r)+n y0,y:(rh)-");
		break;
		}
	case 2253: { // a,x:(r)+n y1,y:(rh)-
		unhandled("a,x:(r)+n y1,y:(rh)-");
		break;
		}
	case 2254: { // a,x:(r)+n a,y:(rh)-
		unhandled("a,x:(r)+n a,y:(rh)-");
		break;
		}
	case 2255: { // a,x:(r)+n b,y:(rh)-
		unhandled("a,x:(r)+n b,y:(rh)-");
		break;
		}
	case 2256: { // b,x:(r)+n y0,y:(rh)-
		unhandled("b,x:(r)+n y0,y:(rh)-");
		break;
		}
	case 2257: { // b,x:(r)+n y1,y:(rh)-
		unhandled("b,x:(r)+n y1,y:(rh)-");
		break;
		}
	case 2258: { // b,x:(r)+n a,y:(rh)-
		unhandled("b,x:(r)+n a,y:(rh)-");
		break;
		}
	case 2259: { // b,x:(r)+n b,y:(rh)-
		unhandled("b,x:(r)+n b,y:(rh)-");
		break;
		}
	case 2260: { // x0,x:(r)+n y0,y:(rh)+
		unhandled("x0,x:(r)+n y0,y:(rh)+");
		break;
		}
	case 2261: { // x0,x:(r)+n y1,y:(rh)+
		unhandled("x0,x:(r)+n y1,y:(rh)+");
		break;
		}
	case 2262: { // x0,x:(r)+n a,y:(rh)+
		unhandled("x0,x:(r)+n a,y:(rh)+");
		break;
		}
	case 2263: { // x0,x:(r)+n b,y:(rh)+
		unhandled("x0,x:(r)+n b,y:(rh)+");
		break;
		}
	case 2264: { // x1,x:(r)+n y0,y:(rh)+
		unhandled("x1,x:(r)+n y0,y:(rh)+");
		break;
		}
	case 2265: { // x1,x:(r)+n y1,y:(rh)+
		unhandled("x1,x:(r)+n y1,y:(rh)+");
		break;
		}
	case 2266: { // x1,x:(r)+n a,y:(rh)+
		unhandled("x1,x:(r)+n a,y:(rh)+");
		break;
		}
	case 2267: { // x1,x:(r)+n b,y:(rh)+
		unhandled("x1,x:(r)+n b,y:(rh)+");
		break;
		}
	case 2268: { // a,x:(r)+n y0,y:(rh)+
		unhandled("a,x:(r)+n y0,y:(rh)+");
		break;
		}
	case 2269: { // a,x:(r)+n y1,y:(rh)+
		unhandled("a,x:(r)+n y1,y:(rh)+");
		break;
		}
	case 2270: { // a,x:(r)+n a,y:(rh)+
		unhandled("a,x:(r)+n a,y:(rh)+");
		break;
		}
	case 2271: { // a,x:(r)+n b,y:(rh)+
		unhandled("a,x:(r)+n b,y:(rh)+");
		break;
		}
	case 2272: { // b,x:(r)+n y0,y:(rh)+
		unhandled("b,x:(r)+n y0,y:(rh)+");
		break;
		}
	case 2273: { // b,x:(r)+n y1,y:(rh)+
		unhandled("b,x:(r)+n y1,y:(rh)+");
		break;
		}
	case 2274: { // b,x:(r)+n a,y:(rh)+
		unhandled("b,x:(r)+n a,y:(rh)+");
		break;
		}
	case 2275: { // b,x:(r)+n b,y:(rh)+
		unhandled("b,x:(r)+n b,y:(rh)+");
		break;
		}
	case 2276: { // x0,x:(r)+n y0,y:(rh)
		unhandled("x0,x:(r)+n y0,y:(rh)");
		break;
		}
	case 2277: { // x0,x:(r)+n y1,y:(rh)
		unhandled("x0,x:(r)+n y1,y:(rh)");
		break;
		}
	case 2278: { // x0,x:(r)+n a,y:(rh)
		unhandled("x0,x:(r)+n a,y:(rh)");
		break;
		}
	case 2279: { // x0,x:(r)+n b,y:(rh)
		unhandled("x0,x:(r)+n b,y:(rh)");
		break;
		}
	case 2280: { // x1,x:(r)+n y0,y:(rh)
		unhandled("x1,x:(r)+n y0,y:(rh)");
		break;
		}
	case 2281: { // x1,x:(r)+n y1,y:(rh)
		unhandled("x1,x:(r)+n y1,y:(rh)");
		break;
		}
	case 2282: { // x1,x:(r)+n a,y:(rh)
		unhandled("x1,x:(r)+n a,y:(rh)");
		break;
		}
	case 2283: { // x1,x:(r)+n b,y:(rh)
		unhandled("x1,x:(r)+n b,y:(rh)");
		break;
		}
	case 2284: { // a,x:(r)+n y0,y:(rh)
		unhandled("a,x:(r)+n y0,y:(rh)");
		break;
		}
	case 2285: { // a,x:(r)+n y1,y:(rh)
		unhandled("a,x:(r)+n y1,y:(rh)");
		break;
		}
	case 2286: { // a,x:(r)+n a,y:(rh)
		unhandled("a,x:(r)+n a,y:(rh)");
		break;
		}
	case 2287: { // a,x:(r)+n b,y:(rh)
		unhandled("a,x:(r)+n b,y:(rh)");
		break;
		}
	case 2288: { // b,x:(r)+n y0,y:(rh)
		unhandled("b,x:(r)+n y0,y:(rh)");
		break;
		}
	case 2289: { // b,x:(r)+n y1,y:(rh)
		unhandled("b,x:(r)+n y1,y:(rh)");
		break;
		}
	case 2290: { // b,x:(r)+n a,y:(rh)
		unhandled("b,x:(r)+n a,y:(rh)");
		break;
		}
	case 2291: { // b,x:(r)+n b,y:(rh)
		unhandled("b,x:(r)+n b,y:(rh)");
		break;
		}
	...
	case 2420: { // x0,x:(r) y0,y:(rh)+n
		unhandled("x0,x:(r) y0,y:(rh)+n");
		break;
		}
	case 2421: { // x0,x:(r) y1,y:(rh)+n
		unhandled("x0,x:(r) y1,y:(rh)+n");
		break;
		}
	case 2422: { // x0,x:(r) a,y:(rh)+n
		unhandled("x0,x:(r) a,y:(rh)+n");
		break;
		}
	case 2423: { // x0,x:(r) b,y:(rh)+n
		unhandled("x0,x:(r) b,y:(rh)+n");
		break;
		}
	case 2424: { // x1,x:(r) y0,y:(rh)+n
		unhandled("x1,x:(r) y0,y:(rh)+n");
		break;
		}
	case 2425: { // x1,x:(r) y1,y:(rh)+n
		unhandled("x1,x:(r) y1,y:(rh)+n");
		break;
		}
	case 2426: { // x1,x:(r) a,y:(rh)+n
		unhandled("x1,x:(r) a,y:(rh)+n");
		break;
		}
	case 2427: { // x1,x:(r) b,y:(rh)+n
		unhandled("x1,x:(r) b,y:(rh)+n");
		break;
		}
	case 2428: { // a,x:(r) y0,y:(rh)+n
		unhandled("a,x:(r) y0,y:(rh)+n");
		break;
		}
	case 2429: { // a,x:(r) y1,y:(rh)+n
		unhandled("a,x:(r) y1,y:(rh)+n");
		break;
		}
	case 2430: { // a,x:(r) a,y:(rh)+n
		unhandled("a,x:(r) a,y:(rh)+n");
		break;
		}
	case 2431: { // a,x:(r) b,y:(rh)+n
		unhandled("a,x:(r) b,y:(rh)+n");
		break;
		}
	case 2432: { // b,x:(r) y0,y:(rh)+n
		unhandled("b,x:(r) y0,y:(rh)+n");
		break;
		}
	case 2433: { // b,x:(r) y1,y:(rh)+n
		unhandled("b,x:(r) y1,y:(rh)+n");
		break;
		}
	case 2434: { // b,x:(r) a,y:(rh)+n
		unhandled("b,x:(r) a,y:(rh)+n");
		break;
		}
	case 2435: { // b,x:(r) b,y:(rh)+n
		unhandled("b,x:(r) b,y:(rh)+n");
		break;
		}
	case 2436: { // x0,x:(r) y0,y:(rh)-
		unhandled("x0,x:(r) y0,y:(rh)-");
		break;
		}
	case 2437: { // x0,x:(r) y1,y:(rh)-
		unhandled("x0,x:(r) y1,y:(rh)-");
		break;
		}
	case 2438: { // x0,x:(r) a,y:(rh)-
		unhandled("x0,x:(r) a,y:(rh)-");
		break;
		}
	case 2439: { // x0,x:(r) b,y:(rh)-
		unhandled("x0,x:(r) b,y:(rh)-");
		break;
		}
	case 2440: { // x1,x:(r) y0,y:(rh)-
		unhandled("x1,x:(r) y0,y:(rh)-");
		break;
		}
	case 2441: { // x1,x:(r) y1,y:(rh)-
		unhandled("x1,x:(r) y1,y:(rh)-");
		break;
		}
	case 2442: { // x1,x:(r) a,y:(rh)-
		unhandled("x1,x:(r) a,y:(rh)-");
		break;
		}
	case 2443: { // x1,x:(r) b,y:(rh)-
		unhandled("x1,x:(r) b,y:(rh)-");
		break;
		}
	case 2444: { // a,x:(r) y0,y:(rh)-
		unhandled("a,x:(r) y0,y:(rh)-");
		break;
		}
	case 2445: { // a,x:(r) y1,y:(rh)-
		unhandled("a,x:(r) y1,y:(rh)-");
		break;
		}
	case 2446: { // a,x:(r) a,y:(rh)-
		unhandled("a,x:(r) a,y:(rh)-");
		break;
		}
	case 2447: { // a,x:(r) b,y:(rh)-
		unhandled("a,x:(r) b,y:(rh)-");
		break;
		}
	case 2448: { // b,x:(r) y0,y:(rh)-
		unhandled("b,x:(r) y0,y:(rh)-");
		break;
		}
	case 2449: { // b,x:(r) y1,y:(rh)-
		unhandled("b,x:(r) y1,y:(rh)-");
		break;
		}
	case 2450: { // b,x:(r) a,y:(rh)-
		unhandled("b,x:(r) a,y:(rh)-");
		break;
		}
	case 2451: { // b,x:(r) b,y:(rh)-
		unhandled("b,x:(r) b,y:(rh)-");
		break;
		}
	case 2452: { // x0,x:(r) y0,y:(rh)+
		unhandled("x0,x:(r) y0,y:(rh)+");
		break;
		}
	case 2453: { // x0,x:(r) y1,y:(rh)+
		unhandled("x0,x:(r) y1,y:(rh)+");
		break;
		}
	case 2454: { // x0,x:(r) a,y:(rh)+
		unhandled("x0,x:(r) a,y:(rh)+");
		break;
		}
	case 2455: { // x0,x:(r) b,y:(rh)+
		unhandled("x0,x:(r) b,y:(rh)+");
		break;
		}
	case 2456: { // x1,x:(r) y0,y:(rh)+
		unhandled("x1,x:(r) y0,y:(rh)+");
		break;
		}
	case 2457: { // x1,x:(r) y1,y:(rh)+
		unhandled("x1,x:(r) y1,y:(rh)+");
		break;
		}
	case 2458: { // x1,x:(r) a,y:(rh)+
		unhandled("x1,x:(r) a,y:(rh)+");
		break;
		}
	case 2459: { // x1,x:(r) b,y:(rh)+
		unhandled("x1,x:(r) b,y:(rh)+");
		break;
		}
	case 2460: { // a,x:(r) y0,y:(rh)+
		unhandled("a,x:(r) y0,y:(rh)+");
		break;
		}
	case 2461: { // a,x:(r) y1,y:(rh)+
		unhandled("a,x:(r) y1,y:(rh)+");
		break;
		}
	case 2462: { // a,x:(r) a,y:(rh)+
		unhandled("a,x:(r) a,y:(rh)+");
		break;
		}
	case 2463: { // a,x:(r) b,y:(rh)+
		unhandled("a,x:(r) b,y:(rh)+");
		break;
		}
	case 2464: { // b,x:(r) y0,y:(rh)+
		unhandled("b,x:(r) y0,y:(rh)+");
		break;
		}
	case 2465: { // b,x:(r) y1,y:(rh)+
		unhandled("b,x:(r) y1,y:(rh)+");
		break;
		}
	case 2466: { // b,x:(r) a,y:(rh)+
		unhandled("b,x:(r) a,y:(rh)+");
		break;
		}
	case 2467: { // b,x:(r) b,y:(rh)+
		unhandled("b,x:(r) b,y:(rh)+");
		break;
		}
	case 2468: { // x0,x:(r) y0,y:(rh)
		unhandled("x0,x:(r) y0,y:(rh)");
		break;
		}
	case 2469: { // x0,x:(r) y1,y:(rh)
		unhandled("x0,x:(r) y1,y:(rh)");
		break;
		}
	case 2470: { // x0,x:(r) a,y:(rh)
		unhandled("x0,x:(r) a,y:(rh)");
		break;
		}
	case 2471: { // x0,x:(r) b,y:(rh)
		unhandled("x0,x:(r) b,y:(rh)");
		break;
		}
	case 2472: { // x1,x:(r) y0,y:(rh)
		unhandled("x1,x:(r) y0,y:(rh)");
		break;
		}
	case 2473: { // x1,x:(r) y1,y:(rh)
		unhandled("x1,x:(r) y1,y:(rh)");
		break;
		}
	case 2474: { // x1,x:(r) a,y:(rh)
		unhandled("x1,x:(r) a,y:(rh)");
		break;
		}
	case 2475: { // x1,x:(r) b,y:(rh)
		unhandled("x1,x:(r) b,y:(rh)");
		break;
		}
	case 2476: { // a,x:(r) y0,y:(rh)
		unhandled("a,x:(r) y0,y:(rh)");
		break;
		}
	case 2477: { // a,x:(r) y1,y:(rh)
		unhandled("a,x:(r) y1,y:(rh)");
		break;
		}
	case 2478: { // a,x:(r) a,y:(rh)
		unhandled("a,x:(r) a,y:(rh)");
		break;
		}
	case 2479: { // a,x:(r) b,y:(rh)
		unhandled("a,x:(r) b,y:(rh)");
		break;
		}
	case 2480: { // b,x:(r) y0,y:(rh)
		unhandled("b,x:(r) y0,y:(rh)");
		break;
		}
	case 2481: { // b,x:(r) y1,y:(rh)
		unhandled("b,x:(r) y1,y:(rh)");
		break;
		}
	case 2482: { // b,x:(r) a,y:(rh)
		unhandled("b,x:(r) a,y:(rh)");
		break;
		}
	case 2483: { // b,x:(r) b,y:(rh)
		unhandled("b,x:(r) b,y:(rh)");
		break;
		}
	case 2484: { // ifcc
...
void dsp563xx_device::execute_npar(u16 knpar, u32 opcode, u32 exv)
{
	...
	case 238: { // bcc [x]
		bool cc = test_cc();
		u32 x = m_pc + util::sext(bitswap<9>(opcode, 9, 8, 7, 6, 4, 3, 2, 1, 0), 9);
		if(cc) {
		m_npc = x;
		}
		break;
	...
	case 3365: { // movem p:[abs],x0
		u32 abs = exv;
		set_x0(m_p.read_dword(abs));
		break;
		}
	case 3366: { // movem p:[abs],x1
		u32 abs = exv;
		set_x1(m_p.read_dword(abs));
		break;
		}
	case 3367: { // movem p:[abs],y0
		u32 abs = exv;
		set_y0(m_p.read_dword(abs));
		break;
		}
	case 3368: { // movem p:[abs],y1
		u32 abs = exv;
		set_y1(m_p.read_dword(abs));
		break;
		}
	case 3369: { // movem p:[abs],a0
		u32 abs = exv;
		set_a0(m_p.read_dword(abs));
		break;
		}
	case 3370: { // movem p:[abs],b0
		u32 abs = exv;
		set_b0(m_p.read_dword(abs));
		break;
		}
	case 3371: { // movem p:[abs],a2
		u32 abs = exv;
		set_a2(m_p.read_dword(abs));
		break;
		}
	case 3372: { // movem p:[abs],b2
		u32 abs = exv;
		set_b2(m_p.read_dword(abs));
		break;
		}
	case 3373: { // movem p:[abs],a1
		u32 abs = exv;
		set_a1(m_p.read_dword(abs));
		break;
		}
	case 3374: { // movem p:[abs],b1
		u32 abs = exv;
		set_b1(m_p.read_dword(abs));
		break;
		}
	...
	case 3377: { // movem p:[abs],r
		u32 abs = exv;
		set_r(BIT(opcode, 0, 6) & 7, m_p.read_dword(abs));
		break;
		}
	case 3378: { // movem p:[abs],n
		u32 abs = exv;
		set_n(BIT(opcode, 0, 6) & 7, m_p.read_dword(abs));
		break;
		}
	case 3379: { // movem p:[abs],m
		u32 abs = exv;
		set_m(BIT(opcode, 0, 6) & 7, m_p.read_dword(abs));
		break;
		}
	case 3380: { // movem p:[abs],ep
		u32 abs = exv;
		set_ep(m_p.read_dword(abs));
		break;
		}
	case 3381: { // movem p:[abs],vba
		u32 abs = exv;
		set_vba(m_p.read_dword(abs));
		break;
		}
	case 3382: { // movem p:[abs],sc
		u32 abs = exv;
		set_sc(m_p.read_dword(abs));
		break;
		}
	case 3383: { // movem p:[abs],sz
		u32 abs = exv;
		set_sz(m_p.read_dword(abs));
		break;
		}
	case 3384: { // movem p:[abs],sr
		u32 abs = exv;
		set_sr(m_p.read_dword(abs));
		break;
		}
	case 3385: { // movem p:[abs],omr
		u32 abs = exv;
		set_omr(m_p.read_dword(abs));
		break;
		}
	case 3386: { // movem p:[abs],sp
		u32 abs = exv;
		set_sp(m_p.read_dword(abs));
		break;
		}
	case 3387: { // movem p:[abs],ssh
		u32 abs = exv;
		set_ssh(m_p.read_dword(abs));
		break;
		}
	case 3388: { // movem p:[abs],ssl
		u32 abs = exv;
		set_ssl(m_p.read_dword(abs));
		break;
		}
	case 3389: { // movem p:[abs],la
		u32 abs = exv;
		set_la(m_p.read_dword(abs));
		break;
		}
	case 3390: { // movem p:[abs],lc
		u32 abs = exv;
		set_lc(m_p.read_dword(abs));
		break;
		}
	case 3391: { // movem x0,p:[abs]
		u32 abs = exv;
		u32 s = get_x0();
		m_p.write_dword(abs, s);
		break;
		}
	case 3392: { // movem x1,p:[abs]
		u32 abs = exv;
		u32 s = get_x1();
		m_p.write_dword(abs, s);
		break;
		}
	case 3393: { // movem y0,p:[abs]
		u32 abs = exv;
		u32 s = get_y0();
		m_p.write_dword(abs, s);
		break;
		}
	case 3394: { // movem y1,p:[abs]
		u32 abs = exv;
		u32 s = get_y1();
		m_p.write_dword(abs, s);
		break;
		}
	case 3395: { // movem a0,p:[abs]
		u32 abs = exv;
		u32 s = get_a0();
		m_p.write_dword(abs, s);
		break;
		}
	case 3396: { // movem b0,p:[abs]
		u32 abs = exv;
		u32 s = get_b0();
		m_p.write_dword(abs, s);
		break;
		}
	case 3397: { // movem a2,p:[abs]
		u32 abs = exv;
		u32 s = get_a2();
		m_p.write_dword(abs, s);
		break;
		}
	case 3398: { // movem b2,p:[abs]
		u32 abs = exv;
		u32 s = get_b2();
		m_p.write_dword(abs, s);
		break;
		}
	case 3399: { // movem a1,p:[abs]
		u32 abs = exv;
		u32 s = get_a1();
		m_p.write_dword(abs, s);
		break;
		}
	case 3400: { // movem b1,p:[abs]
		u32 abs = exv;
		u32 s = get_b1();
		m_p.write_dword(abs, s);
		break;
		}
	case 3401: { // movem a,p:[abs]
		u32 abs = exv;
		u32 s_h = get_ah();
		m_p.write_dword(abs, s_h);
		break;
		}
	case 3402: { // movem b,p:[abs]
		u32 abs = exv;
		u32 s_h = get_bh();
		m_p.write_dword(abs, s_h);
		break;
		}
	case 3403: { // movem r,p:[abs]
		u32 abs = exv;
		u32 s = get_r(BIT(opcode, 0, 6) & 7);
		m_p.write_dword(abs, s);
		break;
		}
	case 3404: { // movem n,p:[abs]
		u32 abs = exv;
		u32 s = get_n(BIT(opcode, 0, 6) & 7);
		m_p.write_dword(abs, s);
		break;
		}
	case 3405: { // movem m,p:[abs]
		u32 abs = exv;
		u32 s = get_m(BIT(opcode, 0, 6) & 7);
		m_p.write_dword(abs, s);
		break;
		}
	case 3406: { // movem ep,p:[abs]
		u32 abs = exv;
		u32 s = get_ep();
		m_p.write_dword(abs, s);
		break;
		}
	case 3407: { // movem vba,p:[abs]
		u32 abs = exv;
		u32 s = get_vba();
		m_p.write_dword(abs, s);
		break;
		}
	case 3408: { // movem sc,p:[abs]
		u32 abs = exv;
		u32 s = get_sc();
		m_p.write_dword(abs, s);
		break;
		}
	case 3409: { // movem sz,p:[abs]
		u32 abs = exv;
		u32 s = get_sz();
		m_p.write_dword(abs, s);
		break;
		}
	case 3410: { // movem sr,p:[abs]
		u32 abs = exv;
		u32 s = get_sr();
		m_p.write_dword(abs, s);
		break;
		}
	case 3411: { // movem omr,p:[abs]
		u32 abs = exv;
		u32 s = get_omr();
		m_p.write_dword(abs, s);
		break;
		}
	case 3412: { // movem sp,p:[abs]
		u32 abs = exv;
		u32 s = get_sp();
		m_p.write_dword(abs, s);
		break;
		}
	case 3413: { // movem ssh,p:[abs]
		u32 abs = exv;
		u32 s = get_ssh();
		m_p.write_dword(abs, s);
		break;
		}
	case 3414: { // movem ssl,p:[abs]
		u32 abs = exv;
		u32 s = get_ssl();
		m_p.write_dword(abs, s);
		break;
		}
	case 3415: { // movem la,p:[abs]
		u32 abs = exv;
		u32 s = get_la();
		m_p.write_dword(abs, s);
		break;
		}
	case 3416: { // movem lc,p:[abs]
		u32 abs = exv;
		u32 s = get_lc();
		m_p.write_dword(abs, s);
		break;
		}
	case 3417: { // movem p:[aa],x0
		u32 aa = BIT(opcode, 8, 6);
		set_x0(m_p.read_dword(aa));
		break;
		}
	case 3418: { // movem p:[aa],x1
		u32 aa = BIT(opcode, 8, 6);
		set_x1(m_p.read_dword(aa));
		break;
		}
	case 3419: { // movem p:[aa],y0
		u32 aa = BIT(opcode, 8, 6);
		set_y0(m_p.read_dword(aa));
		break;
		}
	case 3420: { // movem p:[aa],y1
		u32 aa = BIT(opcode, 8, 6);
		set_y1(m_p.read_dword(aa));
		break;
		}
	case 3421: { // movem p:[aa],a0
		u32 aa = BIT(opcode, 8, 6);
		set_a0(m_p.read_dword(aa));
		break;
		}
	case 3422: { // movem p:[aa],b0
		u32 aa = BIT(opcode, 8, 6);
		set_b0(m_p.read_dword(aa));
		break;
		}
	case 3423: { // movem p:[aa],a2
		u32 aa = BIT(opcode, 8, 6);
		set_a2(m_p.read_dword(aa));
		break;
		}
	case 3424: { // movem p:[aa],b2
		u32 aa = BIT(opcode, 8, 6);
		set_b2(m_p.read_dword(aa));
		break;
		}
	case 3425: { // movem p:[aa],a1
		u32 aa = BIT(opcode, 8, 6);
		set_a1(m_p.read_dword(aa));
		break;
		}
	case 3426: { // movem p:[aa],b1
		u32 aa = BIT(opcode, 8, 6);
		set_b1(m_p.read_dword(aa));
		break;
		}
	case 3427: { // movem p:[aa],a
		u32 aa = BIT(opcode, 8, 6);
		set_ah(m_p.read_dword(aa));
		break;
		}
	case 3428: { // movem p:[aa],b
		u32 aa = BIT(opcode, 8, 6);
		set_bh(m_p.read_dword(aa));
		break;
		}
	case 3429: { // movem p:[aa],r
		u32 aa = BIT(opcode, 8, 6);
		set_r(BIT(opcode, 0, 6) & 7, m_p.read_dword(aa));
		break;
		}
	case 3430: { // movem p:[aa],n
		u32 aa = BIT(opcode, 8, 6);
		set_n(BIT(opcode, 0, 6) & 7, m_p.read_dword(aa));
		break;
		}
	case 3431: { // movem p:[aa],m
		u32 aa = BIT(opcode, 8, 6);
		set_m(BIT(opcode, 0, 6) & 7, m_p.read_dword(aa));
		break;
		}
	case 3432: { // movem p:[aa],ep
		u32 aa = BIT(opcode, 8, 6);
		set_ep(m_p.read_dword(aa));
		break;
		}
	case 3433: { // movem p:[aa],vba
		u32 aa = BIT(opcode, 8, 6);
		set_vba(m_p.read_dword(aa));
		break;
		}
	case 3434: { // movem p:[aa],sc
		u32 aa = BIT(opcode, 8, 6);
		set_sc(m_p.read_dword(aa));
		break;
		}
	case 3435: { // movem p:[aa],sz
		u32 aa = BIT(opcode, 8, 6);
		set_sz(m_p.read_dword(aa));
		break;
		}
	case 3436: { // movem p:[aa],sr
		u32 aa = BIT(opcode, 8, 6);
		set_sr(m_p.read_dword(aa));
		break;
		}
	case 3437: { // movem p:[aa],omr
		u32 aa = BIT(opcode, 8, 6);
	...
	case 3439: { // movem p:[aa],ssh
		u32 aa = BIT(opcode, 8, 6);
		set_ssh(m_p.read_dword(aa));
		break;
		}
	case 3440: { // movem p:[aa],ssl
		u32 aa = BIT(opcode, 8, 6);
		set_ssl(m_p.read_dword(aa));
		break;
		}
	case 3441: { // movem p:[aa],la
		u32 aa = BIT(opcode, 8, 6);
		set_la(m_p.read_dword(aa));
		break;
		}
	case 3442: { // movem p:[aa],lc
		u32 aa = BIT(opcode, 8, 6);
		set_lc(m_p.read_dword(aa));
		break;
		}
	case 3443: { // movem x0,p:[aa]
		u32 aa = BIT(opcode, 8, 6);
		u32 s = get_x0();
		m_p.write_dword(aa, s);
		break;
		}
	case 3444: { // movem x1,p:[aa]
		u32 aa = BIT(opcode, 8, 6);
		u32 s = get_x1();
		m_p.write_dword(aa, s);
		break;
		}
	case 3445: { // movem y0,p:[aa]
		u32 aa = BIT(opcode, 8, 6);
		u32 s = get_y0();
		m_p.write_dword(aa, s);
		break;
		}
	case 3446: { // movem y1,p:[aa]
		u32 aa = BIT(opcode, 8, 6);
		u32 s = get_y1();
		m_p.write_dword(aa, s);
		break;
		}
	case 3447: { // movem a0,p:[aa]
		u32 aa = BIT(opcode, 8, 6);
		u32 s = get_a0();
		m_p.write_dword(aa, s);
		break;
		}
	case 3448: { // movem b0,p:[aa]
		u32 aa = BIT(opcode, 8, 6);
		u32 s = get_b0();
		m_p.write_dword(aa, s);
		break;
		}
	case 3449: { // movem a2,p:[aa]
		u32 aa = BIT(opcode, 8, 6);
		u32 s = get_a2();
		m_p.write_dword(aa, s);
		break;
		}
	case 3450: { // movem b2,p:[aa]
		u32 aa = BIT(opcode, 8, 6);
		u32 s = get_b2();
		m_p.write_dword(aa, s);
		break;
		}
	case 3451: { // movem a1,p:[aa]
		u32 aa = BIT(opcode, 8, 6);
		u32 s = get_a1();
		m_p.write_dword(aa, s);
		break;
		}
	case 3452: { // movem b1,p:[aa]
		u32 aa = BIT(opcode, 8, 6);
		u32 s = get_b1();
		m_p.write_dword(aa, s);
		break;
		}
	case 3453: { // movem a,p:[aa]
		u32 aa = BIT(opcode, 8, 6);
		u32 s_h = get_ah();
		m_p.write_dword(aa, s_h);
		break;
		}
	case 3454: { // movem b,p:[aa]
		u32 aa = BIT(opcode, 8, 6);
		u32 s_h = get_bh();
		m_p.write_dword(aa, s_h);
		break;
		}
	case 3455: { // movem r,p:[aa]
		u32 aa = BIT(opcode, 8, 6);
		u32 s = get_r(BIT(opcode, 0, 6) & 7);
		m_p.write_dword(aa, s);
		break;
		}
	case 3456: { // movem n,p:[aa]
		u32 aa = BIT(opcode, 8, 6);
		u32 s = get_n(BIT(opcode, 0, 6) & 7);
		m_p.write_dword(aa, s);
		break;
		}
	case 3457: { // movem m,p:[aa]
		u32 aa = BIT(opcode, 8, 6);
		u32 s = get_m(BIT(opcode, 0, 6) & 7);
		m_p.write_dword(aa, s);
		break;
		}
	case 3458: { // movem ep,p:[aa]
		u32 aa = BIT(opcode, 8, 6);
		u32 s = get_ep();
		m_p.write_dword(aa, s);
		break;
		}
	case 3459: { // movem vba,p:[aa]
		u32 aa = BIT(opcode, 8, 6);
		u32 s = get_vba();
		m_p.write_dword(aa, s);
		break;
		}
	case 3460: { // movem sc,p:[aa]
		u32 aa = BIT(opcode, 8, 6);
		u32 s = get_sc();
		m_p.write_dword(aa, s);
		break;
		}
	case 3461: { // movem sz,p:[aa]
		u32 aa = BIT(opcode, 8, 6);
		u32 s = get_sz();
		m_p.write_dword(aa, s);
		break;
		}
	case 3462: { // movem sr,p:[aa]
		u32 aa = BIT(opcode, 8, 6);
		u32 s = get_sr();
		m_p.write_dword(aa, s);
		break;
		}
	case 3463: { // movem omr,p:[aa]
		u32 aa = BIT(opcode, 8, 6);
		u32 s = get_omr();
		m_p.write_dword(aa, s);
		break;
		}
	case 3464: { // movem sp,p:[aa]
		u32 aa = BIT(opcode, 8, 6);
		u32 s = get_sp();
		m_p.write_dword(aa, s);
		break;
		}
	case 3465: { // movem ssh,p:[aa]
		u32 aa = BIT(opcode, 8, 6);
		u32 s = get_ssh();
		m_p.write_dword(aa, s);
		break;
		}
	case 3466: { // movem ssl,p:[aa]
		u32 aa = BIT(opcode, 8, 6);
		u32 s = get_ssl();
		m_p.write_dword(aa, s);
		break;
		}
	case 3467: { // movem la,p:[aa]
		u32 aa = BIT(opcode, 8, 6);
		u32 s = get_la();
		m_p.write_dword(aa, s);
		break;
		}
	case 3468: { // movem lc,p:[aa]
		u32 aa = BIT(opcode, 8, 6);
		u32 s = get_lc();
		m_p.write_dword(aa, s);
		break;
		}
	case 3469: { // movep x:(r)-n,x:[pp]
	...
	case 3559: { // movep x:[abs],x:[qq]
		u32 qq = 0xffff80 + BIT(opcode, 0, 6);
		u32 abs = exv;
		m_x.write_dword(qq, m_x.read_dword(abs));
		break;
		}
	case 3560: { // movep y:[abs],x:[qq]
		u32 qq = 0xffff80 + BIT(opcode, 0, 6);
		u32 abs = exv;
		m_x.write_dword(qq, m_y.read_dword(abs));
		break;
		}
	case 3561: { // movep #[i],x:[qq]
		u32 qq = 0xffff80 + BIT(opcode, 0, 6);
		u32 i = exv;
		m_x.write_dword(qq, i);
		break;
		}
	case 3562: { // movep x:(r)-n,y:[qq]
		u32 qq = 0xffff80 + BIT(opcode, 0, 6);
		int ea_r = BIT(opcode, 8, 6) & 7;
		u32 ea = get_r(ea_r);
		add_r(ea_r, -m_n[ea_r]);
	...
	case 3590: { // movep x:[abs],y:[qq]
		u32 qq = 0xffff80 + BIT(opcode, 0, 6);
		u32 abs = exv;
		m_y.write_dword(qq, m_x.read_dword(abs));
		break;
		}
	case 3591: { // movep y:[abs],y:[qq]
		u32 qq = 0xffff80 + BIT(opcode, 0, 6);
		u32 abs = exv;
		m_y.write_dword(qq, m_y.read_dword(abs));
		break;
		}
	case 3592: { // movep #[i],y:[qq]
		u32 qq = 0xffff80 + BIT(opcode, 0, 6);
		u32 i = exv;
		m_y.write_dword(qq, i);
		break;
		}
	case 3593: { // movep p:(r)-n,x:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		int ea_r = BIT(opcode, 8, 6) & 7;
		u32 ea = get_r(ea_r);
		add_r(ea_r, -m_n[ea_r]);
	...
	case 3621: { // movep p:[abs],x:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 abs = exv;
		m_x.write_dword(pp, m_p.read_dword(abs));
		break;
		}
	case 3622: { // movep p:[abs],y:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 abs = exv;
		m_y.write_dword(pp, m_p.read_dword(abs));
		break;
		}
	case 3623: { // movep p:(r)-n,x:[qq]
		u32 qq = 0xffff80 + BIT(opcode, 0, 6);
		int ea_r = BIT(opcode, 8, 6) & 7;
		u32 ea = get_r(ea_r);
		add_r(ea_r, -m_n[ea_r]);
	...
	case 3651: { // movep p:[abs],x:[qq]
		u32 qq = 0xffff80 + BIT(opcode, 0, 6);
		u32 abs = exv;
		m_x.write_dword(qq, m_p.read_dword(abs));
		break;
		}
	case 3652: { // movep p:[abs],y:[qq]
		u32 qq = 0xffff80 + BIT(opcode, 0, 6);
		u32 abs = exv;
		m_y.write_dword(qq, m_p.read_dword(abs));
		break;
		}
	case 3653: { // movep x0,x:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_x0();
		m_x.write_dword(pp, s);
		break;
		}
	case 3654: { // movep x1,x:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_x1();
		m_x.write_dword(pp, s);
		break;
		}
	case 3655: { // movep y0,x:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_y0();
		m_x.write_dword(pp, s);
		break;
		}
	case 3656: { // movep y1,x:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_y1();
		m_x.write_dword(pp, s);
		break;
		}
	case 3657: { // movep a0,x:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_a0();
		m_x.write_dword(pp, s);
		break;
		}
	case 3658: { // movep b0,x:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_b0();
		m_x.write_dword(pp, s);
		break;
		}
	case 3659: { // movep a2,x:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_a2();
		m_x.write_dword(pp, s);
		break;
		}
	case 3660: { // movep b2,x:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_b2();
		m_x.write_dword(pp, s);
		break;
		}
	case 3661: { // movep a1,x:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_a1();
		m_x.write_dword(pp, s);
		break;
		}
	case 3662: { // movep b1,x:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_b1();
		m_x.write_dword(pp, s);
		break;
		}
	case 3663: { // movep a,x:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u64 s = get_a();
		m_x.write_dword(pp, s);
		break;
		}
	case 3664: { // movep b,x:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u64 s = get_b();
		m_x.write_dword(pp, s);
		break;
		}
	case 3665: { // movep r,x:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_r(BIT(opcode, 8, 6) & 7);
		m_x.write_dword(pp, s);
		break;
		}
	case 3666: { // movep n,x:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_n(BIT(opcode, 8, 6) & 7);
		m_x.write_dword(pp, s);
		break;
		}
	case 3667: { // movep m,x:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_m(BIT(opcode, 8, 6) & 7);
		m_x.write_dword(pp, s);
		break;
		}
	case 3668: { // movep ep,x:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_ep();
		m_x.write_dword(pp, s);
		break;
		}
	case 3669: { // movep vba,x:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_vba();
		m_x.write_dword(pp, s);
		break;
		}
	case 3670: { // movep sc,x:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_sc();
		m_x.write_dword(pp, s);
		break;
		}
	case 3671: { // movep sz,x:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_sz();
		m_x.write_dword(pp, s);
		break;
		}
	case 3672: { // movep sr,x:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_sr();
		m_x.write_dword(pp, s);
		break;
		}
	case 3673: { // movep omr,x:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_omr();
		m_x.write_dword(pp, s);
		break;
		}
	case 3674: { // movep sp,x:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_sp();
		m_x.write_dword(pp, s);
		break;
		}
	case 3675: { // movep ssh,x:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_ssh();
		m_x.write_dword(pp, s);
		break;
		}
	case 3676: { // movep ssl,x:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_ssl();
		m_x.write_dword(pp, s);
		break;
		}
	case 3677: { // movep la,x:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_la();
		m_x.write_dword(pp, s);
		break;
		}
	case 3678: { // movep lc,x:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_lc();
		m_x.write_dword(pp, s);
		break;
		}
	case 3679: { // movep x0,y:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_x0();
		m_y.write_dword(pp, s);
		break;
		}
	case 3680: { // movep x1,y:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_x1();
		m_y.write_dword(pp, s);
		break;
		}
	case 3681: { // movep y0,y:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_y0();
		m_y.write_dword(pp, s);
		break;
		}
	case 3682: { // movep y1,y:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_y1();
		m_y.write_dword(pp, s);
		break;
		}
	case 3683: { // movep a0,y:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_a0();
		m_y.write_dword(pp, s);
		break;
		}
	case 3684: { // movep b0,y:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_b0();
		m_y.write_dword(pp, s);
		break;
		}
	case 3685: { // movep a2,y:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_a2();
		m_y.write_dword(pp, s);
		break;
		}
	case 3686: { // movep b2,y:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_b2();
		m_y.write_dword(pp, s);
		break;
		}
	case 3687: { // movep a1,y:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_a1();
		m_y.write_dword(pp, s);
		break;
		}
	case 3688: { // movep b1,y:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_b1();
		m_y.write_dword(pp, s);
		break;
		}
	case 3689: { // movep a,y:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u64 s = get_a();
		m_y.write_dword(pp, s);
		break;
		}
	case 3690: { // movep b,y:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u64 s = get_b();
		m_y.write_dword(pp, s);
		break;
		}
	case 3691: { // movep r,y:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_r(BIT(opcode, 8, 6) & 7);
		m_y.write_dword(pp, s);
		break;
		}
	case 3692: { // movep n,y:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_n(BIT(opcode, 8, 6) & 7);
		m_y.write_dword(pp, s);
		break;
		}
	case 3693: { // movep m,y:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_m(BIT(opcode, 8, 6) & 7);
		m_y.write_dword(pp, s);
		break;
		}
	case 3694: { // movep ep,y:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_ep();
		m_y.write_dword(pp, s);
		break;
		}
	case 3695: { // movep vba,y:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_vba();
		m_y.write_dword(pp, s);
		break;
		}
	case 3696: { // movep sc,y:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_sc();
		m_y.write_dword(pp, s);
		break;
		}
	case 3697: { // movep sz,y:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_sz();
		m_y.write_dword(pp, s);
		break;
		}
	case 3698: { // movep sr,y:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_sr();
		m_y.write_dword(pp, s);
		break;
		}
	case 3699: { // movep omr,y:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_omr();
		m_y.write_dword(pp, s);
		break;
		}
	case 3700: { // movep sp,y:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_sp();
		m_y.write_dword(pp, s);
		break;
		}
	case 3701: { // movep ssh,y:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_ssh();
		m_y.write_dword(pp, s);
		break;
		}
	case 3702: { // movep ssl,y:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_ssl();
		m_y.write_dword(pp, s);
		break;
		}
	case 3703: { // movep la,y:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_la();
		m_y.write_dword(pp, s);
		break;
		}
	case 3704: { // movep lc,y:[pp]
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		u32 s = get_lc();
		m_y.write_dword(pp, s);
		break;
		}
	case 3705: { // movep x:[pp],x0
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		set_x0(m_x.read_dword(pp));
		break;
		}
	case 3706: { // movep x:[pp],x1
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		set_x1(m_x.read_dword(pp));
		break;
		}
	case 3707: { // movep x:[pp],y0
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
	...
	case 3735: { // movep y:[pp],a0
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		set_a0(m_y.read_dword(pp));
		break;
		}
	case 3736: { // movep y:[pp],b0
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		set_b0(m_y.read_dword(pp));
		break;
		}
	case 3737: { // movep y:[pp],a2
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		set_a2(m_y.read_dword(pp));
		break;
		}
	case 3738: { // movep y:[pp],b2
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		set_b2(m_y.read_dword(pp));
		break;
		}
	case 3739: { // movep y:[pp],a1
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		set_a1(m_y.read_dword(pp));
		break;
		}
	case 3740: { // movep y:[pp],b1
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		set_b1(m_y.read_dword(pp));
		break;
		}
	case 3741: { // movep y:[pp],a
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		set_ah(m_y.read_dword(pp));
		break;
		}
	case 3742: { // movep y:[pp],b
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		set_bh(m_y.read_dword(pp));
		break;
		}
	case 3743: { // movep y:[pp],r
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		set_r(BIT(opcode, 8, 6) & 7, m_y.read_dword(pp));
		break;
		}
	case 3744: { // movep y:[pp],n
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		set_n(BIT(opcode, 8, 6) & 7, m_y.read_dword(pp));
		break;
		}
	case 3745: { // movep y:[pp],m
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		set_m(BIT(opcode, 8, 6) & 7, m_y.read_dword(pp));
		break;
		}
	case 3746: { // movep y:[pp],ep
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		set_ep(m_y.read_dword(pp));
		break;
		}
	case 3747: { // movep y:[pp],vba
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		set_vba(m_y.read_dword(pp));
		break;
		}
	case 3748: { // movep y:[pp],sc
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		set_sc(m_y.read_dword(pp));
		break;
		}
	case 3749: { // movep y:[pp],sz
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		set_sz(m_y.read_dword(pp));
		break;
		}
	case 3750: { // movep y:[pp],sr
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		set_sr(m_y.read_dword(pp));
		break;
		}
	case 3751: { // movep y:[pp],omr
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		set_omr(m_y.read_dword(pp));
		break;
		}
	case 3752: { // movep y:[pp],sp
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		set_sp(m_y.read_dword(pp));
		break;
		}
	case 3753: { // movep y:[pp],ssh
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		set_ssh(m_y.read_dword(pp));
		break;
		}
	case 3754: { // movep y:[pp],ssl
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		set_ssl(m_y.read_dword(pp));
		break;
		}
	case 3755: { // movep y:[pp],la
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		set_la(m_y.read_dword(pp));
		break;
		}
	case 3756: { // movep y:[pp],lc
		u32 pp = 0xffffc0 + BIT(opcode, 0, 6);
		set_lc(m_y.read_dword(pp));
		break;
		}
	case 3757: { // movep x0,x:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_x0();
		m_x.write_dword(qq, s);
		break;
		}
	case 3758: { // movep x1,x:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_x1();
		m_x.write_dword(qq, s);
		break;
		}
	case 3759: { // movep y0,x:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_y0();
		m_x.write_dword(qq, s);
		break;
		}
	case 3760: { // movep y1,x:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_y1();
		m_x.write_dword(qq, s);
		break;
		}
	case 3761: { // movep a0,x:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_a0();
		m_x.write_dword(qq, s);
		break;
		}
	case 3762: { // movep b0,x:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_b0();
		m_x.write_dword(qq, s);
		break;
		}
	case 3763: { // movep a2,x:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_a2();
		m_x.write_dword(qq, s);
		break;
		}
	case 3764: { // movep b2,x:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_b2();
		m_x.write_dword(qq, s);
		break;
		}
	case 3765: { // movep a1,x:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_a1();
		m_x.write_dword(qq, s);
		break;
		}
	case 3766: { // movep b1,x:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_b1();
		m_x.write_dword(qq, s);
		break;
		}
	case 3767: { // movep a,x:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s_h = get_ah();
		m_x.write_dword(qq, s_h);
		break;
		}
	case 3768: { // movep b,x:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s_h = get_bh();
		m_x.write_dword(qq, s_h);
		break;
		}
	case 3769: { // movep r,x:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_r(BIT(opcode, 8, 6) & 7);
		m_x.write_dword(qq, s);
		break;
		}
	case 3770: { // movep n,x:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_n(BIT(opcode, 8, 6) & 7);
		m_x.write_dword(qq, s);
		break;
		}
	case 3771: { // movep m,x:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_m(BIT(opcode, 8, 6) & 7);
		m_x.write_dword(qq, s);
		break;
		}
	case 3772: { // movep ep,x:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_ep();
		m_x.write_dword(qq, s);
		break;
		}
	case 3773: { // movep vba,x:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_vba();
		m_x.write_dword(qq, s);
		break;
		}
	case 3774: { // movep sc,x:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_sc();
		m_x.write_dword(qq, s);
		break;
		}
	case 3775: { // movep sz,x:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_sz();
		m_x.write_dword(qq, s);
		break;
		}
	case 3776: { // movep sr,x:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_sr();
		m_x.write_dword(qq, s);
		break;
		}
	case 3777: { // movep omr,x:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_omr();
		m_x.write_dword(qq, s);
		break;
		}
	case 3778: { // movep sp,x:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_sp();
		m_x.write_dword(qq, s);
		break;
		}
	case 3779: { // movep ssh,x:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_ssh();
		m_x.write_dword(qq, s);
		break;
		}
	case 3780: { // movep ssl,x:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_ssl();
		m_x.write_dword(qq, s);
		break;
		}
	case 3781: { // movep la,x:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_la();
		m_x.write_dword(qq, s);
		break;
		}
	case 3782: { // movep lc,x:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_lc();
		m_x.write_dword(qq, s);
		break;
		}
	case 3783: { // movep x:[qq],x0
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_x0(m_x.read_dword(qq));
		break;
		}
	case 3784: { // movep x:[qq],x1
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_x1(m_x.read_dword(qq));
		break;
		}
	case 3785: { // movep x:[qq],y0
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
	...
	case 3787: { // movep x:[qq],a0
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_a0(m_x.read_dword(qq));
		break;
		}
	case 3788: { // movep x:[qq],b0
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_b0(m_x.read_dword(qq));
		break;
		}
	case 3789: { // movep x:[qq],a2
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_a2(m_x.read_dword(qq));
		break;
		}
	case 3790: { // movep x:[qq],b2
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_b2(m_x.read_dword(qq));
		break;
		}
	case 3791: { // movep x:[qq],a1
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_a1(m_x.read_dword(qq));
		break;
		}
	case 3792: { // movep x:[qq],b1
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_b1(m_x.read_dword(qq));
		break;
		}
	case 3793: { // movep x:[qq],a
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_ah(m_x.read_dword(qq));
		break;
		}
	case 3794: { // movep x:[qq],b
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_bh(m_x.read_dword(qq));
		break;
		}
	case 3795: { // movep x:[qq],r
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_r(BIT(opcode, 8, 6) & 7, m_x.read_dword(qq));
		break;
		}
	case 3796: { // movep x:[qq],n
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_n(BIT(opcode, 8, 6) & 7, m_x.read_dword(qq));
		break;
		}
	case 3797: { // movep x:[qq],m
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_m(BIT(opcode, 8, 6) & 7, m_x.read_dword(qq));
		break;
		}
	case 3798: { // movep x:[qq],ep
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_ep(m_x.read_dword(qq));
		break;
		}
	case 3799: { // movep x:[qq],vba
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_vba(m_x.read_dword(qq));
		break;
		}
	case 3800: { // movep x:[qq],sc
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_sc(m_x.read_dword(qq));
		break;
		}
	case 3801: { // movep x:[qq],sz
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_sz(m_x.read_dword(qq));
		break;
		}
	case 3802: { // movep x:[qq],sr
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_sr(m_x.read_dword(qq));
		break;
		}
	case 3803: { // movep x:[qq],omr
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_omr(m_x.read_dword(qq));
		break;
		}
	case 3804: { // movep x:[qq],sp
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_sp(m_x.read_dword(qq));
		break;
		}
	case 3805: { // movep x:[qq],ssh
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_ssh(m_x.read_dword(qq));
		break;
		}
	case 3806: { // movep x:[qq],ssl
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_ssl(m_x.read_dword(qq));
		break;
		}
	case 3807: { // movep x:[qq],la
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_la(m_x.read_dword(qq));
		break;
		}
	case 3808: { // movep x:[qq],lc
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_lc(m_x.read_dword(qq));
		break;
		}
	case 3809: { // movep x0,y:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_x0();
		m_y.write_dword(qq, s);
		break;
		}
	case 3810: { // movep x1,y:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_x1();
		m_y.write_dword(qq, s);
		break;
		}
	case 3811: { // movep y0,y:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_y0();
		m_y.write_dword(qq, s);
		break;
		}
	case 3812: { // movep y1,y:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_y1();
		m_y.write_dword(qq, s);
		break;
		}
	case 3813: { // movep a0,y:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_a0();
		m_y.write_dword(qq, s);
		break;
		}
	case 3814: { // movep b0,y:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_b0();
		m_y.write_dword(qq, s);
		break;
		}
	case 3815: { // movep a2,y:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_a2();
		m_y.write_dword(qq, s);
		break;
		}
	case 3816: { // movep b2,y:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_b2();
		m_y.write_dword(qq, s);
		break;
		}
	case 3817: { // movep a1,y:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_a1();
		m_y.write_dword(qq, s);
		break;
		}
	case 3818: { // movep b1,y:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_b1();
		m_y.write_dword(qq, s);
		break;
		}
	case 3819: { // movep a,y:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s_h = get_ah();
		m_y.write_dword(qq, s_h);
		break;
		}
	case 3820: { // movep b,y:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s_h = get_bh();
		m_y.write_dword(qq, s_h);
		break;
		}
	case 3821: { // movep r,y:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_r(BIT(opcode, 8, 6) & 7);
		m_y.write_dword(qq, s);
		break;
		}
	case 3822: { // movep n,y:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_n(BIT(opcode, 8, 6) & 7);
		m_y.write_dword(qq, s);
		break;
		}
	case 3823: { // movep m,y:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_m(BIT(opcode, 8, 6) & 7);
		m_y.write_dword(qq, s);
		break;
		}
	case 3824: { // movep ep,y:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_ep();
		m_y.write_dword(qq, s);
		break;
		}
	case 3825: { // movep vba,y:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_vba();
		m_y.write_dword(qq, s);
		break;
		}
	case 3826: { // movep sc,y:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_sc();
		m_y.write_dword(qq, s);
		break;
		}
	case 3827: { // movep sz,y:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_sz();
		m_y.write_dword(qq, s);
		break;
		}
	case 3828: { // movep sr,y:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_sr();
		m_y.write_dword(qq, s);
		break;
		}
	case 3829: { // movep omr,y:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_omr();
		m_y.write_dword(qq, s);
		break;
		}
	case 3830: { // movep sp,y:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_sp();
		m_y.write_dword(qq, s);
		break;
		}
	case 3831: { // movep ssh,y:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_ssh();
		m_y.write_dword(qq, s);
		break;
		}
	case 3832: { // movep ssl,y:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_ssl();
		m_y.write_dword(qq, s);
		break;
		}
	case 3833: { // movep la,y:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_la();
		m_y.write_dword(qq, s);
		break;
		}
	case 3834: { // movep lc,y:[qq]
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		u32 s = get_lc();
		m_y.write_dword(qq, s);
		break;
		}
	case 3835: { // movep y:[qq],x0
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_x0(m_y.read_dword(qq));
		break;
		}
	case 3836: { // movep y:[qq],x1
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_x1(m_y.read_dword(qq));
		break;
		}
	case 3837: { // movep y:[qq],y0
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
	...
	case 3839: { // movep y:[qq],a0
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_a0(m_y.read_dword(qq));
		break;
		}
	case 3840: { // movep y:[qq],b0
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
	...
	case 3842: { // movep y:[qq],b2
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_b2(m_y.read_dword(qq));
		break;
		}
	case 3843: { // movep y:[qq],a1
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_a1(m_y.read_dword(qq));
		break;
		}
	case 3844: { // movep y:[qq],b1
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_b1(m_y.read_dword(qq));
		break;
		}
	case 3845: { // movep y:[qq],a
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_ah(m_y.read_dword(qq));
		break;
		}
	case 3846: { // movep y:[qq],b
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_bh(m_y.read_dword(qq));
		break;
		}
	case 3847: { // movep y:[qq],r
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_r(BIT(opcode, 8, 6) & 7, m_y.read_dword(qq));
		break;
		}
	case 3848: { // movep y:[qq],n
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_n(BIT(opcode, 8, 6) & 7, m_y.read_dword(qq));
		break;
		}
	case 3849: { // movep y:[qq],m
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_m(BIT(opcode, 8, 6) & 7, m_y.read_dword(qq));
		break;
		}
	case 3850: { // movep y:[qq],ep
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_ep(m_y.read_dword(qq));
		break;
		}
	case 3851: { // movep y:[qq],vba
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_vba(m_y.read_dword(qq));
		break;
		}
	case 3852: { // movep y:[qq],sc
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_sc(m_y.read_dword(qq));
		break;
		}
	case 3853: { // movep y:[qq],sz
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_sz(m_y.read_dword(qq));
		break;
		}
	case 3854: { // movep y:[qq],sr
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_sr(m_y.read_dword(qq));
		break;
		}
	case 3855: { // movep y:[qq],omr
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_omr(m_y.read_dword(qq));
		break;
		}
	case 3856: { // movep y:[qq],sp
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_sp(m_y.read_dword(qq));
		break;
		}
	case 3857: { // movep y:[qq],ssh
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_ssh(m_y.read_dword(qq));
		break;
		}
	case 3858: { // movep y:[qq],ssl
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_ssl(m_y.read_dword(qq));
		break;
		}
	case 3859: { // movep y:[qq],la
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_la(m_y.read_dword(qq));
		break;
		}
	case 3860: { // movep y:[qq],lc
		u32 qq = 0xffff80 + bitswap<6>(opcode, 6, 4, 3, 2, 1, 0);
		set_lc(m_y.read_dword(qq));
		break;
		}
	case 3861: { // mpy +y1,#[i],a
		unhandled("mpy +y1,#[i],a");
		break;
		}
	case 3862: { // mpy -y1,#[i],a
		unhandled("mpy -y1,#[i],a");
		break;
		}
	case 3863: { // mpy +y1,#[i],b
		unhandled("mpy +y1,#[i],b");
		break;
		}
	case 3864: { // mpy -y1,#[i],b
		unhandled("mpy -y1,#[i],b");
		break;
		}
	case 3865: { // mpy +x0,#[i],a
		unhandled("mpy +x0,#[i],a");
		break;
		}
	case 3866: { // mpy -x0,#[i],a
		unhandled("mpy -x0,#[i],a");
		break;
		}
	case 3867: { // mpy +x0,#[i],b
		unhandled("mpy +x0,#[i],b");
		break;
		}
	case 3868: { // mpy -x0,#[i],b
		unhandled("mpy -x0,#[i],b");
		break;
		}
	case 3869: { // mpy +y0,#[i],a
		unhandled("mpy +y0,#[i],a");
		break;
		}
	case 3870: { // mpy -y0,#[i],a
		unhandled("mpy -y0,#[i],a");
		break;
		}
	case 3871: { // mpy +y0,#[i],b
		unhandled("mpy +y0,#[i],b");
		break;
		}
	case 3872: { // mpy -y0,#[i],b
		unhandled("mpy -y0,#[i],b");
		break;
		}
	case 3873: { // mpy +x1,#[i],a
		unhandled("mpy +x1,#[i],a");
		break;
		}
	case 3874: { // mpy -x1,#[i],a
		unhandled("mpy -x1,#[i],a");
		break;
		}
	case 3875: { // mpy +x1,#[i],b
		unhandled("mpy +x1,#[i],b");
		break;
		}
	case 3876: { // mpy -x1,#[i],b
		unhandled("mpy -x1,#[i],b");
		break;
		}
	case 3877: { // mpysu +x0,x0,a
		unhandled("mpysu +x0,x0,a");
		break;
		}
	case 3878: { // mpysu +y0,y0,a
		unhandled("mpysu +y0,y0,a");
		break;
		}
	case 3879: { // mpysu +x1,x0,a
		unhandled("mpysu +x1,x0,a");
		break;
		}
	case 3880: { // mpysu +y1,y0,a
		unhandled("mpysu +y1,y0,a");
		break;
		}
	case 3881: { // mpysu +x1,x1,a
		unhandled("mpysu +x1,x1,a");
		break;
		}
	case 3882: { // mpysu +y1,y1,a
		unhandled("mpysu +y1,y1,a");
		break;
		}
	case 3883: { // mpysu +x0,x1,a
		unhandled("mpysu +x0,x1,a");
		break;
		}
	case 3884: { // mpysu +y0,y1,a
		unhandled("mpysu +y0,y1,a");
		break;
		}
	case 3885: { // mpysu +x0,y1,a
		unhandled("mpysu +x0,y1,a");
		break;
		}
	case 3886: { // mpysu +y0,x0,a
		unhandled("mpysu +y0,x0,a");
		break;
		}
	case 3887: { // mpysu +x1,y0,a
		unhandled("mpysu +x1,y0,a");
		break;
		}
	case 3888: { // mpysu +y1,x1,a
		unhandled("mpysu +y1,x1,a");
		break;
		}
	case 3889: { // mpysu +y1,x0,a
		unhandled("mpysu +y1,x0,a");
		break;
		}
	case 3890: { // mpysu +x0,y0,a
		unhandled("mpysu +x0,y0,a");
		break;
		}
	case 3891: { // mpysu +y0,x1,a
		unhandled("mpysu +y0,x1,a");
		break;
		}
	case 3892: { // mpysu +x1,y1,a
		unhandled("mpysu +x1,y1,a");
		break;
		}
	case 3893: { // mpysu -x0,x0,a
		unhandled("mpysu -x0,x0,a");
		break;
		}
	case 3894: { // mpysu -y0,y0,a
		unhandled("mpysu -y0,y0,a");
		break;
		}
	case 3895: { // mpysu -x1,x0,a
		unhandled("mpysu -x1,x0,a");
		break;
		}
	case 3896: { // mpysu -y1,y0,a
		unhandled("mpysu -y1,y0,a");
		break;
		}
	case 3897: { // mpysu -x1,x1,a
		unhandled("mpysu -x1,x1,a");
		break;
		}
	case 3898: { // mpysu -y1,y1,a
		unhandled("mpysu -y1,y1,a");
		break;
		}
	case 3899: { // mpysu -x0,x1,a
		unhandled("mpysu -x0,x1,a");
		break;
		}
	case 3900: { // mpysu -y0,y1,a
		unhandled("mpysu -y0,y1,a");
		break;
		}
	case 3901: { // mpysu -x0,y1,a
		unhandled("mpysu -x0,y1,a");
		break;
		}
	case 3902: { // mpysu -y0,x0,a
		unhandled("mpysu -y0,x0,a");
		break;
		}
	case 3903: { // mpysu -x1,y0,a
		unhandled("mpysu -x1,y0,a");
		break;
		}
	case 3904: { // mpysu -y1,x1,a
		unhandled("mpysu -y1,x1,a");
		break;
		}
	case 3905: { // mpysu -y1,x0,a
		unhandled("mpysu -y1,x0,a");
		break;
		}
	case 3906: { // mpysu -x0,y0,a
		unhandled("mpysu -x0,y0,a");
		break;
		}
	case 3907: { // mpysu -y0,x1,a
		unhandled("mpysu -y0,x1,a");
		break;
		}
	case 3908: { // mpysu -x1,y1,a
		unhandled("mpysu -x1,y1,a");
		break;
		}
	case 3909: { // mpysu +x0,x0,b
		unhandled("mpysu +x0,x0,b");
		break;
		}
	case 3910: { // mpysu +y0,y0,b
		unhandled("mpysu +y0,y0,b");
		break;
		}
	case 3911: { // mpysu +x1,x0,b
		unhandled("mpysu +x1,x0,b");
		break;
		}
	case 3912: { // mpysu +y1,y0,b
		unhandled("mpysu +y1,y0,b");
		break;
		}
	case 3913: { // mpysu +x1,x1,b
		unhandled("mpysu +x1,x1,b");
		break;
		}
	case 3914: { // mpysu +y1,y1,b
		unhandled("mpysu +y1,y1,b");
		break;
		}
	case 3915: { // mpysu +x0,x1,b
		unhandled("mpysu +x0,x1,b");
		break;
		}
	case 3916: { // mpysu +y0,y1,b
		unhandled("mpysu +y0,y1,b");
		break;
		}
	case 3917: { // mpysu +x0,y1,b
		unhandled("mpysu +x0,y1,b");
		break;
		}
	case 3918: { // mpysu +y0,x0,b
		unhandled("mpysu +y0,x0,b");
		break;
		}
	case 3919: { // mpysu +x1,y0,b
		unhandled("mpysu +x1,y0,b");
		break;
		}
	case 3920: { // mpysu +y1,x1,b
		unhandled("mpysu +y1,x1,b");
		break;
		}
	case 3921: { // mpysu +y1,x0,b
		unhandled("mpysu +y1,x0,b");
		break;
		}
	case 3922: { // mpysu +x0,y0,b
		unhandled("mpysu +x0,y0,b");
		break;
		}
	case 3923: { // mpysu +y0,x1,b
		unhandled("mpysu +y0,x1,b");
		break;
		}
	case 3924: { // mpysu +x1,y1,b
		unhandled("mpysu +x1,y1,b");
		break;
		}
	case 3925: { // mpysu -x0,x0,b
		unhandled("mpysu -x0,x0,b");
		break;
		}
	case 3926: { // mpysu -y0,y0,b
		unhandled("mpysu -y0,y0,b");
		break;
		}
	case 3927: { // mpysu -x1,x0,b
		unhandled("mpysu -x1,x0,b");
		break;
		}
	case 3928: { // mpysu -y1,y0,b
		unhandled("mpysu -y1,y0,b");
		break;
		}
	case 3929: { // mpysu -x1,x1,b
		unhandled("mpysu -x1,x1,b");
		break;
		}
	case 3930: { // mpysu -y1,y1,b
		unhandled("mpysu -y1,y1,b");
		break;
		}
	case 3931: { // mpysu -x0,x1,b
		unhandled("mpysu -x0,x1,b");
		break;
		}
	case 3932: { // mpysu -y0,y1,b
		unhandled("mpysu -y0,y1,b");
		break;
		}
	case 3933: { // mpysu -x0,y1,b
		unhandled("mpysu -x0,y1,b");
		break;
		}
	case 3934: { // mpysu -y0,x0,b
		unhandled("mpysu -y0,x0,b");
		break;
		}
	case 3935: { // mpysu -x1,y0,b
		unhandled("mpysu -x1,y0,b");
		break;
		}
	case 3936: { // mpysu -y1,x1,b
		unhandled("mpysu -y1,x1,b");
		break;
		}
	case 3937: { // mpysu -y1,x0,b
		unhandled("mpysu -y1,x0,b");
		break;
		}
	case 3938: { // mpysu -x0,y0,b
		unhandled("mpysu -x0,y0,b");
		break;
		}
	case 3939: { // mpysu -y0,x1,b
		unhandled("mpysu -y0,x1,b");
		break;
		}
	case 3940: { // mpysu -x1,y1,b
		unhandled("mpysu -x1,y1,b");
		break;
		}
	case 3941: { // mpyuu +x0,x0,a
		unhandled("mpyuu +x0,x0,a");
		break;
		}
	case 3942: { // mpyuu +y0,y0,a
		unhandled("mpyuu +y0,y0,a");
		break;
		}
	case 3943: { // mpyuu +x1,x0,a
		unhandled("mpyuu +x1,x0,a");
		break;
		}
	case 3944: { // mpyuu +y1,y0,a
		unhandled("mpyuu +y1,y0,a");
		break;
		}
	case 3945: { // mpyuu +x1,x1,a
		unhandled("mpyuu +x1,x1,a");
		break;
		}
	case 3946: { // mpyuu +y1,y1,a
		unhandled("mpyuu +y1,y1,a");
		break;
		}
	case 3947: { // mpyuu +x0,x1,a
		unhandled("mpyuu +x0,x1,a");
		break;
		}
	case 3948: { // mpyuu +y0,y1,a
		unhandled("mpyuu +y0,y1,a");
		break;
		}
	case 3949: { // mpyuu +x0,y1,a
		unhandled("mpyuu +x0,y1,a");
		break;
		}
	case 3950: { // mpyuu +y0,x0,a
		unhandled("mpyuu +y0,x0,a");
		break;
		}
	case 3951: { // mpyuu +x1,y0,a
		unhandled("mpyuu +x1,y0,a");
		break;
		}
	case 3952: { // mpyuu +y1,x1,a
		unhandled("mpyuu +y1,x1,a");
		break;
		}
	case 3953: { // mpyuu +y1,x0,a
		unhandled("mpyuu +y1,x0,a");
		break;
		}
	case 3954: { // mpyuu +x0,y0,a
		unhandled("mpyuu +x0,y0,a");
		break;
		}
	case 3955: { // mpyuu +y0,x1,a
		unhandled("mpyuu +y0,x1,a");
		break;
		}
	case 3956: { // mpyuu +x1,y1,a
		unhandled("mpyuu +x1,y1,a");
		break;
		}
	case 3957: { // mpyuu -x0,x0,a
		unhandled("mpyuu -x0,x0,a");
		break;
		}
	case 3958: { // mpyuu -y0,y0,a
		unhandled("mpyuu -y0,y0,a");
		break;
		}
	case 3959: { // mpyuu -x1,x0,a
		unhandled("mpyuu -x1,x0,a");
		break;
		}
	case 3960: { // mpyuu -y1,y0,a
		unhandled("mpyuu -y1,y0,a");
		break;
		}
	case 3961: { // mpyuu -x1,x1,a
		unhandled("mpyuu -x1,x1,a");
		break;
		}
	case 3962: { // mpyuu -y1,y1,a
		unhandled("mpyuu -y1,y1,a");
		break;
		}
	case 3963: { // mpyuu -x0,x1,a
		unhandled("mpyuu -x0,x1,a");
		break;
		}
	case 3964: { // mpyuu -y0,y1,a
		unhandled("mpyuu -y0,y1,a");
		break;
		}
	case 3965: { // mpyuu -x0,y1,a
		unhandled("mpyuu -x0,y1,a");
		break;
		}
	case 3966: { // mpyuu -y0,x0,a
		unhandled("mpyuu -y0,x0,a");
		break;
		}
	case 3967: { // mpyuu -x1,y0,a
		unhandled("mpyuu -x1,y0,a");
		break;
		}
	case 3968: { // mpyuu -y1,x1,a
		unhandled("mpyuu -y1,x1,a");
		break;
		}
	case 3969: { // mpyuu -y1,x0,a
		unhandled("mpyuu -y1,x0,a");
		break;
		}
	case 3970: { // mpyuu -x0,y0,a
		unhandled("mpyuu -x0,y0,a");
		break;
		}
	case 3971: { // mpyuu -y0,x1,a
		unhandled("mpyuu -y0,x1,a");
		break;
		}
	case 3972: { // mpyuu -x1,y1,a
		unhandled("mpyuu -x1,y1,a");
		break;
		}
	case 3973: { // mpyuu +x0,x0,b
		unhandled("mpyuu +x0,x0,b");
		break;
		}
	case 3974: { // mpyuu +y0,y0,b
		unhandled("mpyuu +y0,y0,b");
		break;
		}
	case 3975: { // mpyuu +x1,x0,b
		unhandled("mpyuu +x1,x0,b");
		break;
		}
	case 3976: { // mpyuu +y1,y0,b
		unhandled("mpyuu +y1,y0,b");
		break;
		}
	case 3977: { // mpyuu +x1,x1,b
		unhandled("mpyuu +x1,x1,b");
		break;
		}
	case 3978: { // mpyuu +y1,y1,b
		unhandled("mpyuu +y1,y1,b");
		break;
		}
	case 3979: { // mpyuu +x0,x1,b
		unhandled("mpyuu +x0,x1,b");
		break;
		}
	case 3980: { // mpyuu +y0,y1,b
		unhandled("mpyuu +y0,y1,b");
		break;
		}
	case 3981: { // mpyuu +x0,y1,b
		unhandled("mpyuu +x0,y1,b");
		break;
		}
	case 3982: { // mpyuu +y0,x0,b
		unhandled("mpyuu +y0,x0,b");
		break;
		}
	case 3983: { // mpyuu +x1,y0,b
		unhandled("mpyuu +x1,y0,b");
		break;
		}
	case 3984: { // mpyuu +y1,x1,b
		unhandled("mpyuu +y1,x1,b");
		break;
		}
	case 3985: { // mpyuu +y1,x0,b
		unhandled("mpyuu +y1,x0,b");
		break;
		}
	case 3986: { // mpyuu +x0,y0,b
		unhandled("mpyuu +x0,y0,b");
		break;
		}
	case 3987: { // mpyuu +y0,x1,b
		unhandled("mpyuu +y0,x1,b");
		break;
		}
	case 3988: { // mpyuu +x1,y1,b
		unhandled("mpyuu +x1,y1,b");
		break;
		}
	case 3989: { // mpyuu -x0,x0,b
		unhandled("mpyuu -x0,x0,b");
		break;
		}
	case 3990: { // mpyuu -y0,y0,b
		unhandled("mpyuu -y0,y0,b");
		break;
		}
	case 3991: { // mpyuu -x1,x0,b
		unhandled("mpyuu -x1,x0,b");
		break;
		}
	case 3992: { // mpyuu -y1,y0,b
		unhandled("mpyuu -y1,y0,b");
		break;
		}
	case 3993: { // mpyuu -x1,x1,b
		unhandled("mpyuu -x1,x1,b");
		break;
		}
	case 3994: { // mpyuu -y1,y1,b
		unhandled("mpyuu -y1,y1,b");
		break;
		}
	case 3995: { // mpyuu -x0,x1,b
		unhandled("mpyuu -x0,x1,b");
		break;
		}
	case 3996: { // mpyuu -y0,y1,b
		unhandled("mpyuu -y0,y1,b");
		break;
		}
	case 3997: { // mpyuu -x0,y1,b
		unhandled("mpyuu -x0,y1,b");
		break;
		}
	case 3998: { // mpyuu -y0,x0,b
		unhandled("mpyuu -y0,x0,b");
		break;
		}
	case 3999: { // mpyuu -x1,y0,b
		unhandled("mpyuu -x1,y0,b");
		break;
		}
	case 4000: { // mpyuu -y1,x1,b
		unhandled("mpyuu -y1,x1,b");
		break;
		}
	case 4001: { // mpyuu -y1,x0,b
		unhandled("mpyuu -y1,x0,b");
		break;
		}
	case 4002: { // mpyuu -x0,y0,b
		unhandled("mpyuu -x0,y0,b");
		break;
		}
	case 4003: { // mpyuu -y0,x1,b
		unhandled("mpyuu -y0,x1,b");
		break;
		}
	case 4004: { // mpyuu -x1,y1,b
		unhandled("mpyuu -x1,y1,b");
		break;
		}
	case 4005: { // mpyi +#[i],y1,a
		unhandled("mpyi +#[i],y1,a");
		break;
		}
	case 4006: { // mpyi -#[i],y1,a
		unhandled("mpyi -#[i],y1,a");
		break;
		}
	case 4007: { // mpyi +#[i],y1,b
		unhandled("mpyi +#[i],y1,b");
		break;
		}
	case 4008: { // mpyi -#[i],y1,b
		unhandled("mpyi -#[i],y1,b");
		break;
		}
	case 4009: { // mpyi +#[i],x0,a
		unhandled("mpyi +#[i],x0,a");
		break;
		}
	case 4010: { // mpyi -#[i],x0,a
		unhandled("mpyi -#[i],x0,a");
		break;
		}
	case 4011: { // mpyi +#[i],x0,b
		unhandled("mpyi +#[i],x0,b");
		break;
		}
	case 4012: { // mpyi -#[i],x0,b
		unhandled("mpyi -#[i],x0,b");
		break;
		}
	case 4013: { // mpyi +#[i],y0,a
		unhandled("mpyi +#[i],y0,a");
		break;
		}
	case 4014: { // mpyi -#[i],y0,a
		unhandled("mpyi -#[i],y0,a");
		break;
		}
	case 4015: { // mpyi +#[i],y0,b
		unhandled("mpyi +#[i],y0,b");
		break;
		}
	case 4016: { // mpyi -#[i],y0,b
		unhandled("mpyi -#[i],y0,b");
		break;
		}
	case 4017: { // mpyi +#[i],x1,a
		unhandled("mpyi +#[i],x1,a");
		break;
		}
	case 4018: { // mpyi -#[i],x1,a
		unhandled("mpyi -#[i],x1,a");
		break;
		}
	case 4019: { // mpyi +#[i],x1,b
		unhandled("mpyi +#[i],x1,b");
		break;
		}
	case 4020: { // mpyi -#[i],x1,b
		unhandled("mpyi -#[i],x1,b");
		break;
		}
	case 4021: { // mpyr +y1,#[i],a
		unhandled("mpyr +y1,#[i],a");
		break;
		}
	case 4022: { // mpyr -y1,#[i],a
		unhandled("mpyr -y1,#[i],a");
		break;
		}
	case 4023: { // mpyr +y1,#[i],b
		unhandled("mpyr +y1,#[i],b");
		break;
		}
	case 4024: { // mpyr -y1,#[i],b
		unhandled("mpyr -y1,#[i],b");
		break;
		}
	case 4025: { // mpyr +x0,#[i],a
		unhandled("mpyr +x0,#[i],a");
		break;
		}
	case 4026: { // mpyr -x0,#[i],a
		unhandled("mpyr -x0,#[i],a");
		break;
		}
	case 4027: { // mpyr +x0,#[i],b
		unhandled("mpyr +x0,#[i],b");
		break;
		}
	case 4028: { // mpyr -x0,#[i],b
		unhandled("mpyr -x0,#[i],b");
		break;
		}
	case 4029: { // mpyr +y0,#[i],a
		unhandled("mpyr +y0,#[i],a");
		break;
		}
	case 4030: { // mpyr -y0,#[i],a
		unhandled("mpyr -y0,#[i],a");
		break;
		}
	case 4031: { // mpyr +y0,#[i],b
		unhandled("mpyr +y0,#[i],b");
		break;
		}
	case 4032: { // mpyr -y0,#[i],b
		unhandled("mpyr -y0,#[i],b");
		break;
		}
	case 4033: { // mpyr +x1,#[i],a
		unhandled("mpyr +x1,#[i],a");
		break;
		}
	case 4034: { // mpyr -x1,#[i],a
		unhandled("mpyr -x1,#[i],a");
		break;
		}
	case 4035: { // mpyr +x1,#[i],b
		unhandled("mpyr +x1,#[i],b");
		break;
		}
	case 4036: { // mpyr -x1,#[i],b
		unhandled("mpyr -x1,#[i],b");
		break;
		}
	case 4037: { // mpyri +#[i],y1,a
		unhandled("mpyri +#[i],y1,a");
		break;
		}
	case 4038: { // mpyri -#[i],y1,a
		unhandled("mpyri -#[i],y1,a");
		break;
		}
	case 4039: { // mpyri +#[i],y1,b
		unhandled("mpyri +#[i],y1,b");
		break;
		}
	case 4040: { // mpyri -#[i],y1,b
		unhandled("mpyri -#[i],y1,b");
		break;
		}
	case 4041: { // mpyri +#[i],x0,a
		unhandled("mpyri +#[i],x0,a");
		break;
		}
	case 4042: { // mpyri -#[i],x0,a
		unhandled("mpyri -#[i],x0,a");
		break;
		}
	case 4043: { // mpyri +#[i],x0,b
		unhandled("mpyri +#[i],x0,b");
		break;
		}
	case 4044: { // mpyri -#[i],x0,b
		unhandled("mpyri -#[i],x0,b");
		break;
		}
	case 4045: { // mpyri +#[i],y0,a
		unhandled("mpyri +#[i],y0,a");
		break;
		}
	case 4046: { // mpyri -#[i],y0,a
		unhandled("mpyri -#[i],y0,a");
		break;
		}
	case 4047: { // mpyri +#[i],y0,b
		unhandled("mpyri +#[i],y0,b");
		break;
		}
	case 4048: { // mpyri -#[i],y0,b
		unhandled("mpyri -#[i],y0,b");
		break;
		}
	case 4049: { // mpyri +#[i],x1,a
		unhandled("mpyri +#[i],x1,a");
		break;
		}
	case 4050: { // mpyri -#[i],x1,a
		unhandled("mpyri -#[i],x1,a");
		break;
		}
	case 4051: { // mpyri +#[i],x1,b
		unhandled("mpyri +#[i],x1,b");
		break;
		}
	case 4052: { // mpyri -#[i],x1,b
		unhandled("mpyri -#[i],x1,b");
		break;
		}
	case 4053: { // norm r,a
	...
	case 4055: { // normf a1,a
		unhandled("normf a1,a");
		break;
		}
	case 4056: { // normf a1,b
		unhandled("normf a1,b");
		break;
		}
	case 4057: { // normf b1,a
		unhandled("normf b1,a");
		break;
		}
	case 4058: { // normf b1,b
		unhandled("normf b1,b");
		break;
		}
	case 4059: { // normf x0,a
		unhandled("normf x0,a");
		break;
		}
	case 4060: { // normf x0,b
		unhandled("normf x0,b");
		break;
		}
	case 4061: { // normf y0,a
		unhandled("normf y0,a");
		break;
		}
	case 4062: { // normf y0,b
		unhandled("normf y0,b");
		break;
		}
	case 4063: { // normf x1,a
		unhandled("normf x1,a");
		break;
		}
	case 4064: { // normf x1,b
		unhandled("normf x1,b");
		break;
		}
	case 4065: { // normf y1,a
		unhandled("normf y1,a");
		break;
		}
	case 4066: { // normf y1,b
	...
	case 4087: { // punlock (r)-n
		unhandled("punlock (r)-n");
		break;
		}
	case 4088: { // punlock (r)+n
		unhandled("punlock (r)+n");
		break;
		}
	case 4089: { // punlock (r)-
	...
	case 4094: { // punlock [abs]
		unhandled("punlock [abs]");
		break;
		}
	case 4095: { // punlockr [x]
	...
	case 4307: { // tcc b,a r,r
		unhandled("tcc b,a r,r");
		break;
		}
	case 4308: { // tcc b,b r,r
		unhandled("tcc b,b r,r");
		break;
		}
	case 4309: { // tcc x0,a r,r
		unhandled("tcc x0,a r,r");
		break;
		}
	case 4310: { // tcc x0,b r,r
		unhandled("tcc x0,b r,r");
		break;
		}
	case 4311: { // tcc y0,a r,r
		unhandled("tcc y0,a r,r");
		break;
		}
	case 4312: { // tcc y0,b r,r
		unhandled("tcc y0,b r,r");
		break;
		}
	case 4313: { // tcc x1,a r,r
		unhandled("tcc x1,a r,r");
		break;
		}
	case 4314: { // tcc x1,b r,r
		unhandled("tcc x1,b r,r");
		break;
		}
	case 4315: { // tcc y1,a r,r
		unhandled("tcc y1,a r,r");
		break;
		}
	case 4316: { // tcc y1,b r,r
		unhandled("tcc y1,b r,r");
		break;
		}
	case 4317: { // tge b,a r,r
		unhandled("tge b,a r,r");
		break;
		}
	case 4318: { // tge b,b r,r
		unhandled("tge b,b r,r");
		break;
		}
	case 4319: { // tge x0,a r,r
		unhandled("tge x0,a r,r");
		break;
		}
	case 4320: { // tge x0,b r,r
		unhandled("tge x0,b r,r");
		break;
		}
	case 4321: { // tge y0,a r,r
		unhandled("tge y0,a r,r");
		break;
		}
	case 4322: { // tge y0,b r,r
		unhandled("tge y0,b r,r");
		break;
		}
	case 4323: { // tge x1,a r,r
		unhandled("tge x1,a r,r");
		break;
		}
	case 4324: { // tge x1,b r,r
		unhandled("tge x1,b r,r");
		break;
		}
	case 4325: { // tge y1,a r,r
		unhandled("tge y1,a r,r");
		break;
		}
	case 4326: { // tge y1,b r,r
		unhandled("tge y1,b r,r");
		break;
		}
	case 4327: { // tne b,a r,r
		unhandled("tne b,a r,r");
		break;
		}
	case 4328: { // tne b,b r,r
		unhandled("tne b,b r,r");
		break;
		}
	case 4329: { // tne x0,a r,r
		unhandled("tne x0,a r,r");
		break;
		}
	case 4330: { // tne x0,b r,r
		unhandled("tne x0,b r,r");
		break;
		}
	case 4331: { // tne y0,a r,r
		unhandled("tne y0,a r,r");
		break;
		}
	case 4332: { // tne y0,b r,r
		unhandled("tne y0,b r,r");
		break;
		}
	case 4333: { // tne x1,a r,r
		unhandled("tne x1,a r,r");
		break;
		}
	case 4334: { // tne x1,b r,r
		unhandled("tne x1,b r,r");
		break;
		}
	case 4335: { // tne y1,a r,r
		unhandled("tne y1,a r,r");
		break;
		}
	case 4336: { // tne y1,b r,r
		unhandled("tne y1,b r,r");
		break;
		}
	case 4337: { // tpl b,a r,r
		unhandled("tpl b,a r,r");
		break;
		}
	case 4338: { // tpl b,b r,r
		unhandled("tpl b,b r,r");
		break;
		}
	case 4339: { // tpl x0,a r,r
		unhandled("tpl x0,a r,r");
		break;
		}
	case 4340: { // tpl x0,b r,r
		unhandled("tpl x0,b r,r");
		break;
		}
	case 4341: { // tpl y0,a r,r
		unhandled("tpl y0,a r,r");
		break;
		}
	case 4342: { // tpl y0,b r,r
		unhandled("tpl y0,b r,r");
		break;
		}
	case 4343: { // tpl x1,a r,r
		unhandled("tpl x1,a r,r");
		break;
		}
	case 4344: { // tpl x1,b r,r
		unhandled("tpl x1,b r,r");
		break;
		}
	case 4345: { // tpl y1,a r,r
		unhandled("tpl y1,a r,r");
		break;
		}
	case 4346: { // tpl y1,b r,r
		unhandled("tpl y1,b r,r");
		break;
		}
	case 4347: { // tnn b,a r,r
		unhandled("tnn b,a r,r");
		break;
		}
	case 4348: { // tnn b,b r,r
		unhandled("tnn b,b r,r");
		break;
		}
	case 4349: { // tnn x0,a r,r
		unhandled("tnn x0,a r,r");
		break;
		}
	case 4350: { // tnn x0,b r,r
		unhandled("tnn x0,b r,r");
		break;
		}
	case 4351: { // tnn y0,a r,r
		unhandled("tnn y0,a r,r");
		break;
		}
	case 4352: { // tnn y0,b r,r
		unhandled("tnn y0,b r,r");
		break;
		}
	case 4353: { // tnn x1,a r,r
		unhandled("tnn x1,a r,r");
		break;
		}
	case 4354: { // tnn x1,b r,r
		unhandled("tnn x1,b r,r");
		break;
		}
	case 4355: { // tnn y1,a r,r
		unhandled("tnn y1,a r,r");
		break;
		}
	case 4356: { // tnn y1,b r,r
		unhandled("tnn y1,b r,r");
		break;
		}
	case 4357: { // tec b,a r,r
		unhandled("tec b,a r,r");
		break;
		}
	case 4358: { // tec b,b r,r
		unhandled("tec b,b r,r");
		break;
		}
	case 4359: { // tec x0,a r,r
		unhandled("tec x0,a r,r");
		break;
		}
	case 4360: { // tec x0,b r,r
		unhandled("tec x0,b r,r");
		break;
		}
	case 4361: { // tec y0,a r,r
		unhandled("tec y0,a r,r");
		break;
		}
	case 4362: { // tec y0,b r,r
		unhandled("tec y0,b r,r");
		break;
		}
	case 4363: { // tec x1,a r,r
		unhandled("tec x1,a r,r");
		break;
		}
	case 4364: { // tec x1,b r,r
		unhandled("tec x1,b r,r");
		break;
		}
	case 4365: { // tec y1,a r,r
		unhandled("tec y1,a r,r");
		break;
		}
	case 4366: { // tec y1,b r,r
		unhandled("tec y1,b r,r");
		break;
		}
	case 4367: { // tlc b,a r,r
		unhandled("tlc b,a r,r");
		break;
		}
	case 4368: { // tlc b,b r,r
		unhandled("tlc b,b r,r");
		break;
		}
	case 4369: { // tlc x0,a r,r
		unhandled("tlc x0,a r,r");
		break;
		}
	case 4370: { // tlc x0,b r,r
		unhandled("tlc x0,b r,r");
		break;
		}
	case 4371: { // tlc y0,a r,r
		unhandled("tlc y0,a r,r");
		break;
		}
	case 4372: { // tlc y0,b r,r
		unhandled("tlc y0,b r,r");
		break;
		}
	case 4373: { // tlc x1,a r,r
		unhandled("tlc x1,a r,r");
		break;
		}
	case 4374: { // tlc x1,b r,r
		unhandled("tlc x1,b r,r");
		break;
		}
	case 4375: { // tlc y1,a r,r
		unhandled("tlc y1,a r,r");
		break;
		}
	case 4376: { // tlc y1,b r,r
		unhandled("tlc y1,b r,r");
		break;
		}
	case 4377: { // tgt b,a r,r
		unhandled("tgt b,a r,r");
		break;
		}
	case 4378: { // tgt b,b r,r
		unhandled("tgt b,b r,r");
		break;
		}
	case 4379: { // tgt x0,a r,r
		unhandled("tgt x0,a r,r");
		break;
		}
	case 4380: { // tgt x0,b r,r
		unhandled("tgt x0,b r,r");
		break;
		}
	case 4381: { // tgt y0,a r,r
		unhandled("tgt y0,a r,r");
		break;
		}
	case 4382: { // tgt y0,b r,r
		unhandled("tgt y0,b r,r");
		break;
		}
	case 4383: { // tgt x1,a r,r
		unhandled("tgt x1,a r,r");
		break;
		}
	case 4384: { // tgt x1,b r,r
		unhandled("tgt x1,b r,r");
		break;
		}
	case 4385: { // tgt y1,a r,r
		unhandled("tgt y1,a r,r");
		break;
		}
	case 4386: { // tgt y1,b r,r
		unhandled("tgt y1,b r,r");
		break;
		}
	case 4387: { // tcs b,a r,r
		unhandled("tcs b,a r,r");
		break;
		}
	case 4388: { // tcs b,b r,r
		unhandled("tcs b,b r,r");
		break;
		}
	case 4389: { // tcs x0,a r,r
		unhandled("tcs x0,a r,r");
		break;
		}
	case 4390: { // tcs x0,b r,r
		unhandled("tcs x0,b r,r");
		break;
		}
	case 4391: { // tcs y0,a r,r
		unhandled("tcs y0,a r,r");
		break;
		}
	case 4392: { // tcs y0,b r,r
		unhandled("tcs y0,b r,r");
		break;
		}
	case 4393: { // tcs x1,a r,r
		unhandled("tcs x1,a r,r");
		break;
		}
	case 4394: { // tcs x1,b r,r
		unhandled("tcs x1,b r,r");
		break;
		}
	case 4395: { // tcs y1,a r,r
		unhandled("tcs y1,a r,r");
		break;
		}
	case 4396: { // tcs y1,b r,r
		unhandled("tcs y1,b r,r");
		break;
		}
	case 4397: { // tlt b,a r,r
		unhandled("tlt b,a r,r");
		break;
		}
	case 4398: { // tlt b,b r,r
		unhandled("tlt b,b r,r");
		break;
		}
	case 4399: { // tlt x0,a r,r
		unhandled("tlt x0,a r,r");
		break;
		}
	case 4400: { // tlt x0,b r,r
		unhandled("tlt x0,b r,r");
		break;
		}
	case 4401: { // tlt y0,a r,r
		unhandled("tlt y0,a r,r");
		break;
		}
	case 4402: { // tlt y0,b r,r
		unhandled("tlt y0,b r,r");
		break;
		}
	case 4403: { // tlt x1,a r,r
		unhandled("tlt x1,a r,r");
		break;
		}
	case 4404: { // tlt x1,b r,r
		unhandled("tlt x1,b r,r");
		break;
		}
	case 4405: { // tlt y1,a r,r
		unhandled("tlt y1,a r,r");
		break;
		}
	case 4406: { // tlt y1,b r,r
		unhandled("tlt y1,b r,r");
		break;
		}
	case 4407: { // teq b,a r,r
		unhandled("teq b,a r,r");
		break;
		}
	case 4408: { // teq b,b r,r
		unhandled("teq b,b r,r");
		break;
		}
	case 4409: { // teq x0,a r,r
		unhandled("teq x0,a r,r");
		break;
		}
	case 4410: { // teq x0,b r,r
		unhandled("teq x0,b r,r");
		break;
		}
	case 4411: { // teq y0,a r,r
		unhandled("teq y0,a r,r");
		break;
		}
	case 4412: { // teq y0,b r,r
		unhandled("teq y0,b r,r");
		break;
		}
	case 4413: { // teq x1,a r,r
		unhandled("teq x1,a r,r");
		break;
		}
	case 4414: { // teq x1,b r,r
		unhandled("teq x1,b r,r");
		break;
		}
	case 4415: { // teq y1,a r,r
		unhandled("teq y1,a r,r");
		break;
		}
	case 4416: { // teq y1,b r,r
		unhandled("teq y1,b r,r");
		break;
		}
	case 4417: { // tmi b,a r,r
		unhandled("tmi b,a r,r");
		break;
		}
	case 4418: { // tmi b,b r,r
		unhandled("tmi b,b r,r");
		break;
		}
	case 4419: { // tmi x0,a r,r
		unhandled("tmi x0,a r,r");
		break;
		}
	case 4420: { // tmi x0,b r,r
		unhandled("tmi x0,b r,r");
		break;
		}
	case 4421: { // tmi y0,a r,r
		unhandled("tmi y0,a r,r");
		break;
		}
	case 4422: { // tmi y0,b r,r
		unhandled("tmi y0,b r,r");
		break;
		}
	case 4423: { // tmi x1,a r,r
		unhandled("tmi x1,a r,r");
		break;
		}
	case 4424: { // tmi x1,b r,r
		unhandled("tmi x1,b r,r");
		break;
		}
	case 4425: { // tmi y1,a r,r
		unhandled("tmi y1,a r,r");
		break;
		}
	case 4426: { // tmi y1,b r,r
		unhandled("tmi y1,b r,r");
		break;
		}
	case 4427: { // tnr b,a r,r
		unhandled("tnr b,a r,r");
		break;
		}
	case 4428: { // tnr b,b r,r
		unhandled("tnr b,b r,r");
		break;
		}
	case 4429: { // tnr x0,a r,r
		unhandled("tnr x0,a r,r");
		break;
		}
	case 4430: { // tnr x0,b r,r
		unhandled("tnr x0,b r,r");
		break;
		}
	case 4431: { // tnr y0,a r,r
		unhandled("tnr y0,a r,r");
		break;
		}
	case 4432: { // tnr y0,b r,r
		unhandled("tnr y0,b r,r");
		break;
		}
	case 4433: { // tnr x1,a r,r
		unhandled("tnr x1,a r,r");
		break;
		}
	case 4434: { // tnr x1,b r,r
		unhandled("tnr x1,b r,r");
		break;
		}
	case 4435: { // tnr y1,a r,r
		unhandled("tnr y1,a r,r");
		break;
		}
	case 4436: { // tnr y1,b r,r
		unhandled("tnr y1,b r,r");
		break;
		}
	case 4437: { // tes b,a r,r
		unhandled("tes b,a r,r");
		break;
		}
	case 4438: { // tes b,b r,r
		unhandled("tes b,b r,r");
		break;
		}
	case 4439: { // tes x0,a r,r
		unhandled("tes x0,a r,r");
		break;
		}
	case 4440: { // tes x0,b r,r
		unhandled("tes x0,b r,r");
		break;
		}
	case 4441: { // tes y0,a r,r
		unhandled("tes y0,a r,r");
		break;
		}
	case 4442: { // tes y0,b r,r
		unhandled("tes y0,b r,r");
		break;
		}
	case 4443: { // tes x1,a r,r
		unhandled("tes x1,a r,r");
		break;
		}
	case 4444: { // tes x1,b r,r
		unhandled("tes x1,b r,r");
		break;
		}
	case 4445: { // tes y1,a r,r
		unhandled("tes y1,a r,r");
		break;
		}
	case 4446: { // tes y1,b r,r
		unhandled("tes y1,b r,r");
		break;
		}
	case 4447: { // tls b,a r,r
		unhandled("tls b,a r,r");
		break;
		}
	case 4448: { // tls b,b r,r
		unhandled("tls b,b r,r");
		break;
		}
	case 4449: { // tls x0,a r,r
		unhandled("tls x0,a r,r");
		break;
		}
	case 4450: { // tls x0,b r,r
		unhandled("tls x0,b r,r");
		break;
		}
	case 4451: { // tls y0,a r,r
		unhandled("tls y0,a r,r");
		break;
		}
	case 4452: { // tls y0,b r,r
		unhandled("tls y0,b r,r");
		break;
		}
	case 4453: { // tls x1,a r,r
		unhandled("tls x1,a r,r");
		break;
		}
	case 4454: { // tls x1,b r,r
		unhandled("tls x1,b r,r");
		break;
		}
	case 4455: { // tls y1,a r,r
		unhandled("tls y1,a r,r");
		break;
		}
	case 4456: { // tls y1,b r,r
		unhandled("tls y1,b r,r");
		break;
		}
	case 4457: { // tle b,a r,r
		unhandled("tle b,a r,r");
		break;
		}
	case 4458: { // tle b,b r,r
		unhandled("tle b,b r,r");
		break;
		}
	case 4459: { // tle x0,a r,r
		unhandled("tle x0,a r,r");
		break;
		}
	case 4460: { // tle x0,b r,r
		unhandled("tle x0,b r,r");
		break;
		}
	case 4461: { // tle y0,a r,r
		unhandled("tle y0,a r,r");
		break;
		}
	case 4462: { // tle y0,b r,r
		unhandled("tle y0,b r,r");
		break;
		}
	case 4463: { // tle x1,a r,r
		unhandled("tle x1,a r,r");
		break;
		}
	case 4464: { // tle x1,b r,r
		unhandled("tle x1,b r,r");
		break;
		}
	case 4465: { // tle y1,a r,r
		unhandled("tle y1,a r,r");
		break;
		}
	case 4466: { // tle y1,b r,r
	...
	case 4500: { // vsl a,[i],l:(r)-n
		unhandled("vsl a,[i],l:(r)-n");
		break;
		}
	case 4501: { // vsl a,[i],l:(r)+n
		unhandled("vsl a,[i],l:(r)+n");
		break;
		}
	case 4502: { // vsl a,[i],l:(r)-
		unhandled("vsl a,[i],l:(r)-");
		break;
		}
	case 4503: { // vsl a,[i],l:(r)+
		unhandled("vsl a,[i],l:(r)+");
		break;
		}
	case 4504: { // vsl a,[i],l:(r)
		unhandled("vsl a,[i],l:(r)");
		break;
		}
	case 4505: { // vsl a,[i],l:(r+n)
		unhandled("vsl a,[i],l:(r+n)");
		break;
		}
	case 4506: { // vsl a,[i],l:-(r)
		unhandled("vsl a,[i],l:-(r)");
		break;
		}
	case 4507: { // vsl b,[i],l:(r)-n
		unhandled("vsl b,[i],l:(r)-n");
		break;
		}
	case 4508: { // vsl b,[i],l:(r)+n
		unhandled("vsl b,[i],l:(r)+n");
		break;
		}
	case 4509: { // vsl b,[i],l:(r)-
		unhandled("vsl b,[i],l:(r)-");
		break;
		}
	case 4510: { // vsl b,[i],l:(r)+
		unhandled("vsl b,[i],l:(r)+");
		break;
		}
	case 4511: { // vsl b,[i],l:(r)
		unhandled("vsl b,[i],l:(r)");
		break;
		}
	case 4512: { // vsl b,[i],l:(r+n)
		unhandled("vsl b,[i],l:(r+n)");
		break;
		}
	case 4513: { // vsl b,[i],l:-(r)
		unhandled("vsl b,[i],l:-(r)");
		break;
		}
	case 4514: { // vsl a,[i],l:[abs]
		unhandled("vsl a,[i],l:[abs]");
		break;
		}
	case 4515: { // vsl b,[i],l:[abs]
