...
static uint32_t common_dasm(device_t *device, std::ostream &stream, offs_t pc, const device_disasm_interface::data_buffer &opcodes, const device_disasm_interface::data_buffer &params, bool upi41)
{
	offs_t cpc = pc;
	uint32_t flags = 0;
	...
	switch (opcodes.r8(cpc++))
	{
		...
		case 0x12:      util::stream_format(stream, "jb0  $%03X", (pc & 0xf00) | params.r8(cpc++));                 break;
		case 0x13:      util::stream_format(stream, "addc a,#$%02X", params.r8(cpc++));                             break;
		case 0x14:      util::stream_format(stream, "call $0%02X", params.r8(cpc++)); flags = DASMFLAG_STEP_OVER;   break;
		case 0x15:      util::stream_format(stream, "dis  i");                                              break;
		case 0x16:      util::stream_format(stream, "jtf  $%03X", (pc & 0xf00) | params.r8(cpc++));                 break;
		...
		case 0x26:      util::stream_format(stream, "jnt0 $%03X", (pc & 0xf00) | params.r8(cpc++));                 break;
		...
		case 0x32:      util::stream_format(stream, "jb1  $%03X", (pc & 0xf00) | params.r8(cpc++));                 break;
		case 0x34:      util::stream_format(stream, "call $1%02X", params.r8(cpc++)); flags = DASMFLAG_STEP_OVER;   break;
		case 0x35:      util::stream_format(stream, "dis  tcnti");                                          break;
		case 0x36:      util::stream_format(stream, "jt0  $%03X", (pc & 0xf00) | params.r8(cpc++));                 break;
		...
		case 0x46:      util::stream_format(stream, "jnt1 $%03X", (pc & 0xf00) | params.r8(cpc++));                 break;
		...
		case 0x52:      util::stream_format(stream, "jb2  $%03X", (pc & 0xf00) | params.r8(cpc++));                 break;
		case 0x53:      util::stream_format(stream, "anl  a,#$%02X", params.r8(cpc++));                             break;
		case 0x54:      util::stream_format(stream, "call $2%02X", params.r8(cpc++)); flags = DASMFLAG_STEP_OVER;   break;
		case 0x55:      util::stream_format(stream, "strt t");                                              break;
		case 0x56:      util::stream_format(stream, "jt1  $%03X", (pc & 0xf00) | params.r8(cpc++));                 break;
		...
		case 0x72:      util::stream_format(stream, "jb3  $%03X", (pc & 0xf00) | params.r8(cpc++));                 break;
		case 0x74:      util::stream_format(stream, "call $3%02X", params.r8(cpc++)); flags = DASMFLAG_STEP_OVER;   break;
		case 0x75:  if (!upi41)
						util::stream_format(stream, "ent0 clk");
					else
						util::stream_format(stream, "illegal");
			break;
		case 0x76:      util::stream_format(stream, "jf1  $%03X", (pc & 0xf00) | params.r8(cpc++));                 break;
		...
		case 0x86:  if (!upi41)
						util::stream_format(stream, "jni  $%03X", (pc & 0xf00) | params.r8(cpc++));
					else
						util::stream_format(stream, "jobf $%03X", (pc & 0xf00) | params.r8(cpc++));
			break;
		case 0x88:  if (!upi41)
		...
		case 0x91:  if (!upi41)
						...
						util::stream_format(stream, "illegal");
			break;
		case 0x92:      util::stream_format(stream, "jb4  $%03X", (pc & 0xf00) | params.r8(cpc++));                 break;
		case 0x93:      util::stream_format(stream, "retr"); flags = DASMFLAG_STEP_OUT;                     break;
		case 0x94:      util::stream_format(stream, "call $4%02X", params.r8(cpc++)); flags = DASMFLAG_STEP_OVER;   break;
		case 0x95:      util::stream_format(stream, "cpl  f0");                                             break;
		case 0x96:      util::stream_format(stream, "jnz  $%03X", (pc & 0xf00) | params.r8(cpc++));                 break;
		...
		case 0xb2:      util::stream_format(stream, "jb5  $%03X", (pc & 0xf00) | params.r8(cpc++));                 break;
		case 0xb3:      util::stream_format(stream, "jmpp @a");                                             break;
		case 0xb4:      util::stream_format(stream, "call $5%02X", params.r8(cpc++)); flags = DASMFLAG_STEP_OVER;   break;
		case 0xb5:      util::stream_format(stream, "cpl  f1");                                             break;
		case 0xb6:      util::stream_format(stream, "jf0  $%03X", (pc & 0xf00) | params.r8(cpc++));                 break;
		...
		case 0xc6:      util::stream_format(stream, "jz   $%03X", (pc & 0xf00) | params.r8(cpc++));                 break;
		...
		case 0xd2:      util::stream_format(stream, "jb6  $%03X", (pc & 0xf00) | params.r8(cpc++));                 break;
		case 0xd3:      util::stream_format(stream, "xrl  a,#$%02X", params.r8(cpc++));                             break;
		case 0xd4:      util::stream_format(stream, "call $6%02X", params.r8(cpc++)); flags = DASMFLAG_STEP_OVER;   break;
		case 0xd5:      util::stream_format(stream, "sel  rb1");                                            break;
		case 0xd6:  if (!upi41)
						util::stream_format(stream, "illegal");
					else
						util::stream_format(stream, "jnibf $%03X", (pc & 0xf00) | params.r8(cpc++));
			break;
		...
		case 0xe5:  if (!upi41)
			...
			break;
		case 0xe6:      util::stream_format(stream, "jnc  $%03X", (pc & 0xf00) | params.r8(cpc++));                 break;
		case 0xe7:      util::stream_format(stream, "rl   a");                                              break;
		case 0xe8:      util::stream_format(stream, "djnz r0,$%03X", (pc & 0xf00) | params.r8(cpc++)); flags = DASMFLAG_STEP_OVER; break;
		case 0xe9:      util::stream_format(stream, "djnz r1,$%03X", (pc & 0xf00) | params.r8(cpc++)); flags = DASMFLAG_STEP_OVER; break;
		case 0xea:      util::stream_format(stream, "djnz r2,$%03X", (pc & 0xf00) | params.r8(cpc++)); flags = DASMFLAG_STEP_OVER; break;
		case 0xeb:      util::stream_format(stream, "djnz r3,$%03X", (pc & 0xf00) | params.r8(cpc++)); flags = DASMFLAG_STEP_OVER; break;
		case 0xec:      util::stream_format(stream, "djnz r4,$%03X", (pc & 0xf00) | params.r8(cpc++)); flags = DASMFLAG_STEP_OVER; break;
		case 0xed:      util::stream_format(stream, "djnz r5,$%03X", (pc & 0xf00) | params.r8(cpc++)); flags = DASMFLAG_STEP_OVER; break;
		case 0xee:      util::stream_format(stream, "djnz r6,$%03X", (pc & 0xf00) | params.r8(cpc++)); flags = DASMFLAG_STEP_OVER; break;
		case 0xef:      util::stream_format(stream, "djnz r7,$%03X", (pc & 0xf00) | params.r8(cpc++)); flags = DASMFLAG_STEP_OVER; break;
		case 0xf0:      util::stream_format(stream, "mov  a,@r0");                                          break;
		case 0xf1:      util::stream_format(stream, "mov  a,@r1");                                          break;
		case 0xf2:      util::stream_format(stream, "jb7  $%03X", (pc & 0xf00) | params.r8(cpc++));                 break;
		case 0xf4:      util::stream_format(stream, "call $7%02X", params.r8(cpc++)); flags = DASMFLAG_STEP_OVER;   break;
		case 0xf5:  if (!upi41)
						util::stream_format(stream, "sel  mb1");
					else
						util::stream_format(stream, "en   flags");
			break;
		case 0xf6:      util::stream_format(stream, "jc   $%03X", (pc & 0xf00) | params.r8(cpc++));                 break;
...
{
	return common_dasm(device, stream, pc, opcodes, params, false);
}


CPU_DISASSEMBLE( upi41 )
{
	return common_dasm(device, stream, pc, opcodes, params, true);
}
