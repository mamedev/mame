...
void axc51base_cpu_device::axc51_extended_a5(uint8_t r)
{
	...
	case 0x02:
		fatalerror("%s: DECDP0", machine().describe_context());
		break;

	case 0x03:
		fatalerror("%s: DECDP1", machine().describe_context());
		break;
	...
	case 0x08:
		fatalerror("%s: INC2DP0", machine().describe_context());
		break;
	...
	case 0x0d:
		fatalerror("%s: ROTL8 EACC, ER8", machine().describe_context());
		break;
	...
	{
		uint8_t n = (prm & 0x0c) >> 2;
		fatalerror("%s: DEC16 ER%01x", machine().describe_context(), n);
		break;
	}
	...
	case 0x82: case 0x83: case 0x86: case 0x87: case 0x8a: case 0x8b: case 0x8e: case 0x8f:
	{
		...
		fatalerror("%s: MOV16 EDP%01x, ER%01x", machine().describe_context(), i, n);
		break;
	}
