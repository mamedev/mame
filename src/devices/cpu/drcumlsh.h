...
#define UML_MULUH(block, dst, src1, src2)                   do { using namespace uml; block.append().muluh(dst, src1, src2); } while (0)
#define UML_MULS(block, dst, edst, src1, src2)              do { using namespace uml; block.append().muls(dst, edst, src1, src2); } while (0)
#define UML_MULSH(block, dst, src1, src2)                   do { using namespace uml; block.append().mulsh(dst, src1, src2); } while (0)
...
#define UML_DMULUH(block, dst, src1, src2)                  do { using namespace uml; block.append().dmuluh(dst, src1, src2); } while (0)
#define UML_DMULS(block, dst, edst, src1, src2)             do { using namespace uml; block.append().dmuls(dst, edst, src1, src2); } while (0)
#define UML_DMULSH(block, dst, src1, src2)                  do { using namespace uml; block.append().dmulsh(dst, src1, src2); } while (0)
