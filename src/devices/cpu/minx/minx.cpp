...
offs_t minx_cpu_device::disassemble(std::ostream &stream, offs_t pc, const data_buffer &opcodes, const data_buffer &params, uint32_t options)
{
	extern CPU_DISASSEMBLE( minx );
	return CPU_DISASSEMBLE_NAME(minx)(this, stream, pc, opcodes, params, options);
}
