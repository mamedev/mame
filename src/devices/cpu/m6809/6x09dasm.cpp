...
const m6x09_base_disassembler::opcodeinfo *m6x09_base_disassembler::fetch_opcode(const data_buffer &opcodes, offs_t &p)
{
	...
	while(!op)
	{
		...
		m6x09_instruction_level level = m_level;

		// perform the lookup
		auto iter = std::find_if(
			m_opcodes.begin(),
			m_opcodes.end(),
			[opcode,level](const opcodeinfo &info) { return (info.opcode() == opcode) && (info.level() <= level); });
	...
	// is this a M6809 undocumented instruction and we're in HD6309 mode? if so, reject it
	if (op && (op->level() == M6809_UNDOCUMENTED) && (m_level == HD6309_EXCLUSIVE))
		op = nullptr;
...
const m6x09_base_disassembler::opcodeinfo m6x09_disassembler::m6x09_opcodes[] =
{
	...
	{ 0x0B, 2, "XDEC",  DIR,    M6809_UNDOCUMENTED },
	...
	{ 0x3E, 1, "XRES",   INH,   M6809_UNDOCUMENTED },
	{ 0x3F, 1, "SWI",    INH,   M6x09_GENERAL },

	{ 0x40, 1, "NEGA",  INH,    M6x09_GENERAL },
	{ 0x41, 1, "NEGA",  INH,    M6809_UNDOCUMENTED },
	{ 0x42, 1, "XNCA",  INH,    M6809_UNDOCUMENTED },
	{ 0x43, 1, "COMA",  INH,    M6x09_GENERAL },
	{ 0x44, 1, "LSRA",  INH,    M6x09_GENERAL },
	{ 0x45, 1, "LSRA",  INH,    M6809_UNDOCUMENTED },
	...
	{ 0x6B, 2, "XDEC",  IND,    M6809_UNDOCUMENTED },
	...
	{ 0x7B, 3, "XDEC",  EXT,    M6809_UNDOCUMENTED },
	...
	{ 0x87, 2, "XSTA",  IMM,    M6809_UNDOCUMENTED },
	...
	{ 0xC7, 2, "XSTB",  IMM,    M6809_UNDOCUMENTED },
	...
	{ 0xCD, 1, "XHCF",  INH,    M6809_UNDOCUMENTED },
	{ 0xCD, 5, "LDQ",   IMM,    HD6309_EXCLUSIVE },
	{ 0xCE, 3, "LDU",   IMM,    M6x09_GENERAL },
	{ 0xCF, 3, "XSTU",  IMM,    M6809_UNDOCUMENTED },
	...
	{ 0x103E, 2, "XSWI2", INH,    M6809_UNDOCUMENTED },
	...
	{ 0x11D3, 3, "XADDU", DIR,  M6809_UNDOCUMENTED },
	...
	{ 0x11E3, 3, "XADDU", IND,  M6809_UNDOCUMENTED },
	...
	{ 0x11F3, 4, "XADDU", EXT,  M6809_UNDOCUMENTED },
...
m6809_disassembler::m6809_disassembler() : m6x09_disassembler(M6809_UNDOCUMENTED, m6809_teregs)
{
}
