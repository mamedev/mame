...
uint32_t ie15_cpu_device::opcode_alignment() const
{
	return 1;
}
...
offs_t ie15_cpu_device::disassemble(std::ostream &stream, offs_t pc, const data_buffer &opcodes, const data_buffer &params, uint32_t options)
{
	extern CPU_DISASSEMBLE( ie15 );
	return CPU_DISASSEMBLE_NAME(ie15)(nullptr, stream, pc, opcodes, params, 0);
}
