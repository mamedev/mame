...
offs_t hmcs40_cpu_device::disassemble(std::ostream &stream, offs_t pc, const data_buffer &opcodes, const data_buffer &params, u32 options)
{
	extern CPU_DISASSEMBLE(hmcs40);
	return CPU_DISASSEMBLE_NAME(hmcs40)(this, stream, pc, opcodes, params, options);
}

offs_t hmcs40_cpu_device::disasm_pc_linear_to_real(offs_t pc) const
{
...
offs_t hmcs40_cpu_device::disasm_pc_real_to_linear(offs_t pc) const
{
