...
offs_t se3208_device::disassemble(std::ostream &stream, offs_t pc, const data_buffer &opcodes, const data_buffer &params, uint32_t options)
{
	extern CPU_DISASSEMBLE( se3208 );
	return CPU_DISASSEMBLE_NAME(se3208)(this, stream, pc, opcodes, params, options);
}
