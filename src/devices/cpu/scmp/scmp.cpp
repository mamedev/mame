...
offs_t scmp_device::disassemble(std::ostream &stream, offs_t pc, const data_buffer &opcodes, const data_buffer &params, uint32_t options)
{
	extern CPU_DISASSEMBLE( scmp );
	return CPU_DISASSEMBLE_NAME(scmp)(this, stream, pc, opcodes, params, options);
}
