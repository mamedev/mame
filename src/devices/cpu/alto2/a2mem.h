...
uint16_t mear_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);       //!< memory error address register read
uint16_t mesr_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);       //!< memory error status register read
void mesr_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);       //!< memory error status register write (clear)
uint16_t mecr_r(address_space &space, offs_t offset, uint16_t mem_mask = 0xffff);       //!< memory error control register read
void mecr_w(address_space &space, offs_t offset, uint16_t data, uint16_t mem_mask = 0xffff);       //!< memory error control register write
