...
uint32_t dsp16_device::opcode_alignment() const
{
	return 1;
}
...
offs_t dsp16_device::disassemble(std::ostream &stream, offs_t pc, const data_buffer &opcodes, const data_buffer &params, uint32_t options)
{
	extern CPU_DISASSEMBLE( dsp16a );
	return CPU_DISASSEMBLE_NAME(dsp16a)(this, stream, pc, opcodes, params, options);
}
