...
CPU_DISASSEMBLE(i8085)
{
	...
	switch (op = opcodes.r8(pc++))
	{
		...
		case 0x01: util::stream_format(stream, "ld   bc,$%04x", params.r16(pc)); pc+=2;  break;
		...
		case 0x06: util::stream_format(stream, "ld   b,$%02x", params.r8(pc)); pc++;     break;
		...
		case 0x0e: util::stream_format(stream, "ld   c,$%02x", params.r8(pc)); pc++;     break;
		case 0x0f: util::stream_format(stream, "rrca");                            break;
		case 0x10: util::stream_format(stream, "sra  hl (*)");                     break;
		case 0x11: util::stream_format(stream, "ld   de,$%04x", params.r16(pc)); pc+=2;  break;
		...
		case 0x16: util::stream_format(stream, "ld   d,$%02x", params.r8(pc)); pc++;     break;
		...
		case 0x1e: util::stream_format(stream, "ld   e,$%02x", params.r8(pc)); pc++;     break;
		case 0x1f: util::stream_format(stream, "rra");                             break;
		case 0x20: util::stream_format(stream, "rim");                             break;
		case 0x21: util::stream_format(stream, "ld   hl,$%04x", params.r16(pc)); pc+=2;  break;
		case 0x22: util::stream_format(stream, "ld   ($%04x),hl", params.r16(pc)); pc+=2;break;
		...
		case 0x26: util::stream_format(stream, "ld   h,$%02x", params.r8(pc)); pc++;     break;
		case 0x27: util::stream_format(stream, "daa");                             break;
		case 0x28: util::stream_format(stream, "ld   de,hl+$%02x (*)",params.r8(pc));pc++;break;
		case 0x29: util::stream_format(stream, "add  hl,hl");                      break;
		case 0x2a: util::stream_format(stream, "ld   hl,($%04x)", params.r16(pc)); pc+=2;break;
		...
		case 0x2e: util::stream_format(stream, "ld   l,$%02x", params.r8(pc)); pc++;     break;
		case 0x2f: util::stream_format(stream, "cpl");                             break;
		case 0x30: util::stream_format(stream, "sim");                             break;
		case 0x31: util::stream_format(stream, "ld   sp,$%04x", params.r16(pc)); pc+=2;  break;
		case 0x32: util::stream_format(stream, "ld   ($%04x),a", params.r16(pc)); pc+=2; break;
		...
		case 0x36: util::stream_format(stream, "ld   (hl),$%02x", params.r8(pc)); pc++;  break;
		case 0x37: util::stream_format(stream, "scf");                             break;
		case 0x38: util::stream_format(stream, "ld   de,sp+$%02x (*)",params.r8(pc));pc++;break;
		case 0x39: util::stream_format(stream, "add  hl,sp");                      break;
		case 0x3a: util::stream_format(stream, "ld   a,($%04x)", params.r16(pc)); pc+=2; break;
		...
		case 0x3e: util::stream_format(stream, "ld   a,$%02x", params.r8(pc)); pc++;     break;
		...
		case 0xc2: util::stream_format(stream, "jp   nz,$%04x", params.r16(pc)); pc+=2;  break;
		case 0xc3: util::stream_format(stream, "jp   $%04x", params.r16(pc)); pc+=2;     break;
		case 0xc4: util::stream_format(stream, "call nz,$%04x", params.r16(pc)); pc+=2; flags = DASMFLAG_STEP_OVER; break;
		case 0xc5: util::stream_format(stream, "push bc");                         break;
		case 0xc6: util::stream_format(stream, "add  a,$%02x", params.r8(pc)); pc++;     break;
		...
		case 0xca: util::stream_format(stream, "jp   z,$%04x", params.r16(pc)); pc+=2;   break;
		case 0xcb: util::stream_format(stream, "rst  v,$40 (*)"); flags = DASMFLAG_STEP_OVER; break;
		case 0xcc: util::stream_format(stream, "call z,$%04x", params.r16(pc)); pc+=2; flags = DASMFLAG_STEP_OVER; break;
		case 0xcd: util::stream_format(stream, "call $%04x", params.r16(pc)); pc+=2; flags = DASMFLAG_STEP_OVER; break;
		case 0xce: util::stream_format(stream, "adc  a,$%02x", params.r8(pc)); pc++;     break;
		...
		case 0xd2: util::stream_format(stream, "jp   nc,$%04x", params.r16(pc)); pc+=2;  break;
		case 0xd3: util::stream_format(stream, "out  ($%02x),a", params.r8(pc)); pc++;   break;
		case 0xd4: util::stream_format(stream, "call nc,$%04x", params.r16(pc)); pc+=2; flags = DASMFLAG_STEP_OVER; break;
		case 0xd5: util::stream_format(stream, "push de");                         break;
		case 0xd6: util::stream_format(stream, "sub  $%02x", params.r8(pc)); pc++;       break;
		...
		case 0xda: util::stream_format(stream, "jp   c,$%04x", params.r16(pc)); pc+=2;   break;
		case 0xdb: util::stream_format(stream, "in   a,($%02x)", params.r8(pc)); pc++;   break;
		case 0xdc: util::stream_format(stream, "call c,$%04x", params.r16(pc)); pc+=2; flags = DASMFLAG_STEP_OVER; break;
		case 0xdd: util::stream_format(stream, "jp   nx,$%04x (*)",params.r16(pc));pc+=2;break;
		case 0xde: util::stream_format(stream, "sub  $%02x", params.r8(pc)); pc++;       break;
		...
		case 0xe2: util::stream_format(stream, "jp   pe,$%04x", params.r16(pc)); pc+=2;  break;
		case 0xe3: util::stream_format(stream, "ex   (sp),hl");                    break;
		case 0xe4: util::stream_format(stream, "call pe,$%04x", params.r16(pc)); pc+=2; flags = DASMFLAG_STEP_OVER; break;
		case 0xe5: util::stream_format(stream, "push hl");                         break;
		case 0xe6: util::stream_format(stream, "and  $%02x", params.r8(pc)); pc++;       break;
		...
		case 0xea: util::stream_format(stream, "jp   po,$%04x", params.r16(pc)); pc+=2;  break;
		case 0xeb: util::stream_format(stream, "ex   de,hl");                      break;
		case 0xec: util::stream_format(stream, "call po,$%04x", params.r16(pc)); pc+=2; flags = DASMFLAG_STEP_OVER; break;
		case 0xed: util::stream_format(stream, "ld   hl,(de) (*)");                break;
		case 0xee: util::stream_format(stream, "xor  $%02x", params.r8(pc)); pc++;       break;
		...
		case 0xf2: util::stream_format(stream, "jp   p,$%04x", params.r16(pc)); pc+=2;   break;
		...
		case 0xf6: util::stream_format(stream, "or   $%02x", params.r8(pc)); pc++;       break;
		...
		case 0xfa: util::stream_format(stream, "jp   m,$%04x", params.r16(pc)); pc+=2;   break;
		case 0xfb: util::stream_format(stream, "ei");                              break;
		case 0xfc: util::stream_format(stream, "call m,$%04x", params.r16(pc)); pc+=2; flags = DASMFLAG_STEP_OVER; break;
		case 0xfd: util::stream_format(stream, "jp   x,$%04x (*)",params.r16(pc));pc+=2; break;
		case 0xfe: util::stream_format(stream, "cp   $%02x", params.r8(pc)); pc++;       break;
		...
		case 0xc4: util::stream_format(stream, "cnz  $%04x", params.r16(pc)); pc+=2; flags = DASMFLAG_STEP_OVER; break;
		...
		case 0xcc: util::stream_format(stream, "cz   $%04x", params.r16(pc)); pc+=2; flags = DASMFLAG_STEP_OVER; break;
		case 0xcd: util::stream_format(stream, "call $%04x", params.r16(pc)); pc+=2; flags = DASMFLAG_STEP_OVER; break;
		...
		case 0xd4: util::stream_format(stream, "cnc  $%04x", params.r16(pc)); pc+=2; flags = DASMFLAG_STEP_OVER; break;
		...
		case 0xdc: util::stream_format(stream, "cc   $%04x", params.r16(pc)); pc+=2; flags = DASMFLAG_STEP_OVER; break;
		...
		case 0xe4: util::stream_format(stream, "cpo  $%04x", params.r16(pc)); pc+=2; flags = DASMFLAG_STEP_OVER; break;
		...
		case 0xec: util::stream_format(stream, "cpe  $%04x", params.r16(pc)); pc+=2; flags = DASMFLAG_STEP_OVER; break;
		...
		case 0xfb: util::stream_format(stream, "ei");                              break;
		case 0xfc: util::stream_format(stream, "cm   $%04x", params.r16(pc)); pc+=2; flags = DASMFLAG_STEP_OVER; break;
