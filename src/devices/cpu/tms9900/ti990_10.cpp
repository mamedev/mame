...
uint32_t ti990_10_device::opcode_alignment() const
{
	return 2;
}

// TODO: check 9900dasm
offs_t ti990_10_device::disassemble(std::ostream &stream, offs_t pc, const data_buffer &opcodes, const data_buffer &params, uint32_t options)
{
	extern CPU_DISASSEMBLE( tms9900 );
	return CPU_DISASSEMBLE_NAME(tms9900)(this, stream, pc, opcodes, params, options);
}
