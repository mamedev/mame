...
void vic3_device::palette_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	if (offset < 0x100)
...
void vic3_device::port_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t vic3_device::port_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	int val = 0;
	offset &= 0x7f;
