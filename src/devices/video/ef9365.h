...
private:
	...
	int draw_vector(unsigned short start_x,unsigned short start_y,short delta_x,short delta_y);
	unsigned short get_x_reg();
	unsigned short get_y_reg();
	void set_x_reg(unsigned short x);
	void set_y_reg(unsigned short y);
