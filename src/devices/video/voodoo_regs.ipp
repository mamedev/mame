...
REGISTER_TABLE_BEGIN
	...
	REGISTER_ENTRY(cmdFifoRdPtr,    passive,     cmdfifo,     32, FBI,        SYNC, NOFIFO)    // 1e8 - cmdFIFO mode
	...
	REGISTER_ENTRY(cmdFifoDepth,    passive,     cmdfifo,     16, FBI,        SYNC, NOFIFO)    // 1f4 - cmdFIFO mode
	REGISTER_ENTRY(cmdFifoHoles,    passive,     cmdfifo,     16, FBI,        SYNC, NOFIFO)    // 1f8 - cmdFIFO mode
	RESERVED_ENTRY                                                                             // 1fc
	//             name             rd handler   wr handler  bits chips     sync?     fifo?
