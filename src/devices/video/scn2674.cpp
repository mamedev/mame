...
uint8_t scn2674_device::read(address_space &space, offs_t offset, uint8_t mem_mask)
{
	/*
	Offset:  Purpose
...
void scn2674_device::write(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	/*
	Offset:  Purpose
