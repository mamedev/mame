...
static const uint16_t reg_masks[] = {
	0xffff, 0xffff, 0xffff, 0xffff,
	0xdfff, 0xdfff, 0xffff, 0xffff,
	...
	0xdead, 0xdead, 0xdead, 0xdead,
	0xdead, 0xdead, 0xdead, 0xdead,
	0x3f3f, 0x3f3f, 0xdead, 0xdead,
	0x3fff, 0x1f1f, 0xdead, 0xdead,
	0xdead, 0xdead, 0xdead, 0xdead,
};
...
READ32_MEMBER(gba_lcd_device::video_r)
{
	...
	default:
		...
		{
			retval |= m_regs[offset] & 0x0000ffff & reg_masks[offset * 2];
		}
		if (ACCESSING_BITS_16_31)
		{
			retval |= m_regs[offset] & 0xffff0000 & (reg_masks[offset * 2 + 1] << 16);
		}
		break;
	}
