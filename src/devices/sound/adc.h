...
class adc12_device : public device_t, public device_sound_interface
{
public:
	adc12_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock = 0);
	u16 read();
