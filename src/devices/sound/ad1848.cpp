...
uint8_t ad1848_device::read(address_space &space, offs_t offset, uint8_t mem_mask)
{
	switch(offset)
	{
		case 0:
...
void ad1848_device::write(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
...
uint8_t ad1848_device::dack_r(address_space &space, offs_t offset, uint8_t mem_mask)
{
	m_drq_cb(CLEAR_LINE);
	return 0; // not implemented
}

void ad1848_device::dack_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	if(!m_play)
		return;
