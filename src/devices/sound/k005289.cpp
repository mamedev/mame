...
void k005289_device::k005289_control_A_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_stream->update();
...
void k005289_device::k005289_control_B_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_stream->update();
...
void k005289_device::ld1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_freq_latch[0] = 0xfff - offset;
}


void k005289_device::ld2_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_freq_latch[1] = 0xfff - offset;
}


void k005289_device::tg1_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_stream->update();
...
void k005289_device::tg2_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	m_stream->update();
