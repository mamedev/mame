...
void wave_device::device_start()
{
	...
	if (speakers > 1)
		...
		stream_alloc(0, 1, machine().sample_rate());
}
...
void wave_device::sound_stream_update(sound_stream &stream, stream_sample_t const * const *inputs, stream_sample_t * const *outputs, int samples)
{
