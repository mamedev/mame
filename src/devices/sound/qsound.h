...
public:
	...
	void qsound_w(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask = 0xff);
	uint8_t qsound_r(address_space &space, offs_t offset, uint8_t mem_mask = 0xff);
