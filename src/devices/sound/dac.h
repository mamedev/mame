...
DAC_GENERATOR(DAC_5BIT_BINARY_WEIGHTED,      dac_4bit_binary_weighted_device,      dac_byte_device_base, dac_mapper_unsigned,        5, dac_gain_bw,  "5-Bit Binary Weighted DAC",       "dac_5bit_bw")
DAC_GENERATOR(DAC_5BIT_R2R,                  dac_4bit_r2r_device,                  dac_byte_device_base, dac_mapper_unsigned,        5, dac_gain_r2r, "5-Bit R-2R DAC",                  "dac_5bit_r2r")
