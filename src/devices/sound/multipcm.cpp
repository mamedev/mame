...
uint8_t multipcm_device::read(address_space &space, offs_t offset, uint8_t mem_mask)
{
	return 0;
}

void multipcm_device::write(address_space &space, offs_t offset, uint8_t data, uint8_t mem_mask)
{
	switch(offset)
	{
		case 0:     //Data write
