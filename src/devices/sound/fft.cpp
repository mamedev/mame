...
/*
	...
	tabs and to have the 'register' keyword omitted.
*/
...
static inline void un4(WDL_FFT_COMPLEX *a)
{
	WDL_FFT_REAL t1, t2, t3, t4, t5, t6, t7, t8;
...
static void un8(WDL_FFT_COMPLEX *a)
{
	WDL_FFT_REAL t1, t2, t3, t4, t5, t6, t7, t8;
...
static void un16(WDL_FFT_COMPLEX *a)
{
	WDL_FFT_REAL t1, t2, t3, t4, t5, t6, t7, t8;
...
static void un32(WDL_FFT_COMPLEX *a)
{
	un16(a);
	un8(a + 16);
	un8(a + 24);
...
static void un64(WDL_FFT_COMPLEX *a)
{
	un32(a);
	un16(a + 32);
	un16(a + 48);
...
static void un128(WDL_FFT_COMPLEX *a)
{
	un64(a);
	un32(a + 64);
	un32(a + 96);
...
static void un256(WDL_FFT_COMPLEX *a)
{
	un128(a);
	un64(a + 128);
	un64(a + 192);
...
static void un512(WDL_FFT_COMPLEX *a)
{
	un256(a);
	un128(a + 256);
	un128(a + 384);
...
static void un1024(WDL_FFT_COMPLEX *a)
{
	un512(a);
	un256(a + 512);
	un256(a + 768);
...
static void un2048(WDL_FFT_COMPLEX *a)
{
	un1024(a);
	un512(a + 1024);
	un512(a + 1536);
...
static void un4096(WDL_FFT_COMPLEX *a)
{
	un2048(a);
	un1024(a + 2048);
	un1024(a + 3072);
...
static void un8192(WDL_FFT_COMPLEX *a)
{
	un4096(a);
	un2048(a + 4096);
	un2048(a + 6144);
...
static void un16384(WDL_FFT_COMPLEX *a)
{
	un8192(a);
	un4096(a + 8192);
	un4096(a + 8192 + 4096);
...
static void un32768(WDL_FFT_COMPLEX *a)
{
	un16384(a);
	un8192(a + 16384);
	un8192(a + 16384  + 8192 );
...
void WDL_fft(WDL_FFT_COMPLEX *buf, int len, int isInverse)
{
	...
	{
		case 2: c2(buf); break;
#define TMP(x) case x: if (!isInverse) c##x(buf); else un##x(buf); break;
		TMP(4)
		TMP(8)
		TMP(16)
		TMP(32)
