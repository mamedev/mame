...
template<bool IsOpnA>
void opn_registers_base<IsOpnA>::save(fm_interface &intf)
{
	if (IsOpnA)
	{
		intf.save_item(YMFM_NAME(m_lfo_counter));
...
template class fm_engine_base<opl_registers>;
template class fm_engine_base<opl2_registers>;
template class fm_engine_base<opll_registers>;
template class fm_engine_base<opl3_registers>;
template class fm_engine_base<opl4_registers>;
template class fm_engine_base<opq_registers>;
