...
void msm5205_device::device_timer(emu_timer const &timer, device_timer_id id, int param, void *ptr)
{
	switch (id)
	{
		case TIMER_VCK:
...
void msm6585_device::device_timer(emu_timer const &timer, device_timer_id id, int param, void *ptr)
{
	switch (id)
	{
		case TIMER_VCK:
