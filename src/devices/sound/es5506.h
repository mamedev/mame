...
protected:
	...
	es550x_device(const machine_config &mconfig, device_type type, const char *tag, device_t *owner, u32 clock = 0);
...
{
public:
	es5506_device(const machine_config &mconfig, const char *tag, device_t *owner, u32 clock = 0);
	~es5506_device() {}
...
{
public:
	es5505_device(const machine_config &mconfig, const char *tag, device_t *owner, u32 clock = 0);
