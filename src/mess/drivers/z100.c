...
static MACHINE_CONFIG_START( z100, z100_state )
	...
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(z100_state, video_pia_A_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(z100_state, video_pia_B_w))
	MCFG_PIA6821_CA2_HANDLER(WRITELINE(z100_state, video_pia_CA2_w))
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(z100_state, video_pia_CB2_w))
