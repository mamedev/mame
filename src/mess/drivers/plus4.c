...
static MACHINE_CONFIG_START( plus4, plus4_state )
	...
	MCFG_MOS6551_RTS_HANDLER(DEVWRITELINE(PLUS4_USER_PORT_TAG, plus4_user_port_device, write_d))
	MCFG_MOS6551_DTR_HANDLER(DEVWRITELINE(PLUS4_USER_PORT_TAG, plus4_user_port_device, write_e))
	MCFG_MOS6551_TXD_HANDLER(DEVWRITELINE(PLUS4_USER_PORT_TAG, plus4_user_port_device, write_m))
	MCFG_MOS6551_IRQ_HANDLER(WRITELINE(plus4_state, acia_irq_w))

	MCFG_DEVICE_ADD(MOS6529_USER_TAG, MOS6529, 0)
	MCFG_MOS6529_P0_HANDLER(DEVWRITELINE(PLUS4_USER_PORT_TAG, plus4_user_port_device, write_b))
	MCFG_MOS6529_P1_HANDLER(DEVWRITELINE(PLUS4_USER_PORT_TAG, plus4_user_port_device, write_k))
	MCFG_MOS6529_P2_HANDLER(DEVWRITELINE(PLUS4_USER_PORT_TAG, plus4_user_port_device, write_4))
	MCFG_MOS6529_P3_HANDLER(DEVWRITELINE(PLUS4_USER_PORT_TAG, plus4_user_port_device, write_5))
	MCFG_MOS6529_P4_HANDLER(DEVWRITELINE(PLUS4_USER_PORT_TAG, plus4_user_port_device, write_6))
	MCFG_MOS6529_P5_HANDLER(DEVWRITELINE(PLUS4_USER_PORT_TAG, plus4_user_port_device, write_7))
	MCFG_MOS6529_P6_HANDLER(DEVWRITELINE(PLUS4_USER_PORT_TAG, plus4_user_port_device, write_j))
	MCFG_MOS6529_P7_HANDLER(DEVWRITELINE(PLUS4_USER_PORT_TAG, plus4_user_port_device, write_f))
	...
	MCFG_CBM_IEC_BUS_ATN_CALLBACK(DEVWRITELINE(PLUS4_USER_PORT_TAG, plus4_user_port_device, write_9))
	...
	MCFG_PLUS4_USER_PORT_4_HANDLER(DEVWRITELINE(MOS6529_USER_TAG, mos6529_device, write_p2)) // cassette sense
	MCFG_PLUS4_USER_PORT_5_HANDLER(DEVWRITELINE(MOS6529_USER_TAG, mos6529_device, write_p3))
	MCFG_PLUS4_USER_PORT_6_HANDLER(DEVWRITELINE(MOS6529_USER_TAG, mos6529_device, write_p4))
	MCFG_PLUS4_USER_PORT_7_HANDLER(DEVWRITELINE(MOS6529_USER_TAG, mos6529_device, write_p5))
	MCFG_PLUS4_USER_PORT_8_HANDLER(DEVWRITELINE(MOS6551_TAG, mos6551_device, rxc_w))
	MCFG_PLUS4_USER_PORT_B_HANDLER(DEVWRITELINE(MOS6529_USER_TAG, mos6529_device, write_p0))
	MCFG_PLUS4_USER_PORT_C_HANDLER(DEVWRITELINE(MOS6551_TAG, mos6551_device, rxd_w))
	MCFG_PLUS4_USER_PORT_F_HANDLER(DEVWRITELINE(MOS6529_USER_TAG, mos6529_device, write_p7))
	MCFG_PLUS4_USER_PORT_H_HANDLER(DEVWRITELINE(MOS6551_TAG, mos6551_device, dcd_w))
	MCFG_PLUS4_USER_PORT_J_HANDLER(DEVWRITELINE(MOS6529_USER_TAG, mos6529_device, write_p6))
	MCFG_PLUS4_USER_PORT_K_HANDLER(DEVWRITELINE(MOS6529_USER_TAG, mos6529_device, write_p1))
	MCFG_PLUS4_USER_PORT_L_HANDLER(DEVWRITELINE(MOS6551_TAG, mos6551_device, dsr_w))
