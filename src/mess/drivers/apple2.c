...
static MACHINE_CONFIG_DERIVED( apple2c, apple2ee )
	...
	MCFG_A2BUS_ONBOARD_ADD("a2bus", "sl1", A2BUS_SSC, 0)
	MCFG_A2BUS_ONBOARD_ADD("a2bus", "sl2", A2BUS_SSC, 0)
	MCFG_A2BUS_ONBOARD_ADD("a2bus", "sl6", A2BUS_DISKII, 0)
...
static MACHINE_CONFIG_DERIVED( apple2c_iwm, apple2c )
	...
	MCFG_A2BUS_SLOT_REMOVE("sl6")
	MCFG_A2BUS_ONBOARD_ADD("a2bus", "sl6", A2BUS_IWM_FDC, 0)
MACHINE_CONFIG_END
...
static MACHINE_CONFIG_DERIVED( laser128, apple2c )
	...
	MCFG_A2BUS_ONBOARD_ADD("a2bus", "sl1", A2BUS_LASER128, 0)
	MCFG_A2BUS_ONBOARD_ADD("a2bus", "sl2", A2BUS_LASER128, 0)
	MCFG_A2BUS_ONBOARD_ADD("a2bus", "sl3", A2BUS_LASER128, 0)
	MCFG_A2BUS_ONBOARD_ADD("a2bus", "sl4", A2BUS_LASER128, 0)
	MCFG_A2BUS_ONBOARD_ADD("a2bus", "sl5", A2BUS_LASER128, 0)
	MCFG_A2BUS_ONBOARD_ADD("a2bus", "sl6", A2BUS_IWM_FDC, 0)     // slots 6 and 7 are hacks for now
//    MCFG_A2BUS_ONBOARD_ADD("a2bus", "sl7", A2BUS_LASER128, 0)
MACHINE_CONFIG_END
