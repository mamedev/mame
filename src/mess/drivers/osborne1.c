...
static MACHINE_CONFIG_START( osborne1, osborne1_state )
	...
	MCFG_PIA6821_READPB_HANDLER(READ8(osborne1_state, ieee_pia_pb_r))
	MCFG_PIA6821_WRITEPA_HANDLER(DEVWRITE8(IEEE488_TAG, ieee488_device, dio_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(osborne1_state, ieee_pia_pb_w))
	MCFG_PIA6821_CA2_HANDLER(DEVWRITELINE(IEEE488_TAG, ieee488_device, ifc_w))
	MCFG_PIA6821_CB2_HANDLER(DEVWRITELINE(IEEE488_TAG, ieee488_device, ren_w))
	MCFG_PIA6821_IRQA_HANDLER(WRITELINE(osborne1_state, ieee_pia_irq_a_func))

	MCFG_DEVICE_ADD( "pia_1", PIA6821, 0)
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(osborne1_state, video_pia_port_a_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(osborne1_state, video_pia_port_b_w))
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(osborne1_state, video_pia_out_cb2_dummy))
	MCFG_PIA6821_IRQA_HANDLER(WRITELINE(osborne1_state, video_pia_irq_a_func))
