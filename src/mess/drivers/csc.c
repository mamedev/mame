...
static MACHINE_CONFIG_START( csc, csc_state )
	...
	MCFG_PIA6821_READPB_HANDLER(READ8(csc_state, pia0_pb_r))
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(csc_state, pia0_pa_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(csc_state, pia0_pb_w))
	MCFG_PIA6821_CA2_HANDLER(WRITELINE(csc_state, pia0_ca2_w))
	...
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(csc_state, pia1_cb2_w))
