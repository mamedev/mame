...
static MACHINE_CONFIG_START( dragon_base, dragon_state )
	...
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(coco_state, pia0_pa_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(coco_state, pia0_pb_w))
	MCFG_PIA6821_CA2_HANDLER(WRITELINE(coco_state, pia0_ca2_w))
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(coco_state, pia0_cb2_w))
	MCFG_PIA6821_IRQA_HANDLER(WRITELINE(coco_state, pia0_irq_a))
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(coco_state, pia0_irq_b))

	MCFG_DEVICE_ADD(PIA1_TAG, PIA6821, 0)
	MCFG_PIA6821_READPA_HANDLER(READ8(coco_state, pia1_pa_r))
	MCFG_PIA6821_READPB_HANDLER(READ8(coco_state, pia1_pb_r))
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(coco_state, pia1_pa_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(coco_state, pia1_pb_w))
	MCFG_PIA6821_CA2_HANDLER(WRITELINE(coco_state, pia1_ca2_w))
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(coco_state, pia1_cb2_w))
	MCFG_PIA6821_IRQA_HANDLER(WRITELINE(coco_state, pia1_firq_a))
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(coco_state, pia1_firq_b))
...
static MACHINE_CONFIG_DERIVED_CLASS( dgnalpha, dragon_base, dragon_alpha_state )
	...
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(dragon_alpha_state, pia2_pa_w))
	MCFG_PIA6821_IRQA_HANDLER(WRITELINE(dragon_alpha_state, pia2_firq_a))
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(dragon_alpha_state, pia2_firq_b))
MACHINE_CONFIG_END
