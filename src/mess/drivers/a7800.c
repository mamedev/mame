...
Colorburst/Hue = 180 degrees --> $17 = 179.92706396/$18 = 179.927063726
    ...
    2013/02/18 Fixed color clip in $1 & $F
...
#define NTSC_GOLD \
	MAKE_RGB(0x09,0x16,0x00), MAKE_RGB(0x12,0x28,0x00), MAKE_RGB(0x24,0x3A,0x00), MAKE_RGB(0x36,0x4C,0x00), \
...
#define NTSC_LIGHT_ORANGE \
	MAKE_RGB(0x08,0x17,0x00), MAKE_RGB(0x11,0x28,0x00), MAKE_RGB(0x23,0x3A,0x00), MAKE_RGB(0x35,0x4C,0x00), \
