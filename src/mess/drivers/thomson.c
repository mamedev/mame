...
/* pia */
	...
	MCFG_PIA6821_READPA_HANDLER(READ8(thomson_state, to7_sys_porta_in))
	MCFG_PIA6821_READPB_HANDLER(READ8(thomson_state, to7_sys_portb_in))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(thomson_state, to7_sys_portb_out))
	MCFG_PIA6821_CA2_HANDLER(WRITELINE(thomson_state, to7_set_cassette_motor))
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(thomson_state, to7_sys_cb2_out))
	MCFG_PIA6821_IRQA_HANDLER(WRITELINE(thomson_state, thom_firq_1))
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(thomson_state, thom_firq_1))

	MCFG_DEVICE_ADD(THOM_PIA_IO, PIA6821, 0)
	MCFG_PIA6821_READPA_HANDLER(DEVREAD8("to7_io", to7_io_line_device, porta_in))
	MCFG_PIA6821_WRITEPA_HANDLER(DEVWRITE8("to7_io", to7_io_line_device, porta_out))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(thomson_state, to7_io_portb_out))
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(thomson_state, to7_io_cb2_out))
	MCFG_PIA6821_IRQA_HANDLER(WRITELINE(thomson_state, thom_firq_1))
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(thomson_state, thom_firq_1))

	MCFG_DEVICE_ADD(THOM_PIA_GAME, PIA6821, 0)
	MCFG_PIA6821_READPA_HANDLER(READ8(thomson_state, to7_game_porta_in))
	MCFG_PIA6821_READPB_HANDLER(READ8(thomson_state, to7_game_portb_in))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(thomson_state, to7_game_portb_out))
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(thomson_state, to7_game_cb2_out))
	MCFG_PIA6821_IRQA_HANDLER(WRITELINE(thomson_state, thom_irq_1))
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(thomson_state, thom_irq_1))
...
static MACHINE_CONFIG_DERIVED( to770, to7 )
	...
	MCFG_PIA6821_READPA_HANDLER(READ8(thomson_state, to770_sys_porta_in))
	MCFG_PIA6821_READPB_HANDLER(NULL)
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(thomson_state, to770_sys_portb_out))
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(thomson_state, to770_sys_cb2_out))
...
static MACHINE_CONFIG_DERIVED( mo5, to7 )
	...
	MCFG_DEVICE_MODIFY(THOM_PIA_SYS)
	MCFG_PIA6821_READPA_HANDLER(READ8(thomson_state, mo5_sys_porta_in))
	MCFG_PIA6821_READPB_HANDLER(READ8(thomson_state, mo5_sys_portb_in))
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(thomson_state, mo5_sys_porta_out))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(thomson_state, mo5_sys_portb_out))
	MCFG_PIA6821_CA2_HANDLER(WRITELINE(thomson_state, mo5_set_cassette_motor))
	MCFG_PIA6821_CB2_HANDLER(NULL)
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(thomson_state, thom_irq_1)) /* WARNING: differs from TO7 ! */
...
static MACHINE_CONFIG_DERIVED( to9, to7 )
	...
	MCFG_DEVICE_MODIFY(THOM_PIA_SYS)
	MCFG_PIA6821_READPA_HANDLER(READ8(thomson_state, to9_sys_porta_in))
	MCFG_PIA6821_READPB_HANDLER(NULL)
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(thomson_state, to9_sys_porta_out))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(thomson_state, to9_sys_portb_out))
	MCFG_PIA6821_CB2_HANDLER(NULL)
	MCFG_PIA6821_IRQA_HANDLER(NULL)
...
static MACHINE_CONFIG_DERIVED( to8, to7 )
	...
	MCFG_DEVICE_MODIFY(THOM_PIA_SYS)
	MCFG_PIA6821_READPA_HANDLER(READ8(thomson_state, to8_sys_porta_in))
	MCFG_PIA6821_READPB_HANDLER(NULL)
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(thomson_state, to9_sys_porta_out))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(thomson_state, to8_sys_portb_out))
	MCFG_PIA6821_CB2_HANDLER(NULL)
	MCFG_PIA6821_IRQA_HANDLER(NULL)
...
static MACHINE_CONFIG_DERIVED( mo6, to7 )
	...
	MCFG_DEVICE_MODIFY(THOM_PIA_SYS)
	MCFG_PIA6821_READPA_HANDLER(READ8(thomson_state, mo6_sys_porta_in))
	MCFG_PIA6821_READPB_HANDLER(READ8(thomson_state, mo6_sys_portb_in))
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(thomson_state, mo6_sys_porta_out))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(thomson_state, mo6_sys_portb_out))
	MCFG_PIA6821_CA2_HANDLER(WRITELINE(thomson_state, mo5_set_cassette_motor))
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(thomson_state, mo6_sys_cb2_out))
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(thomson_state, thom_irq_1)) /* differs from TO */

	MCFG_DEVICE_REMOVE( THOM_PIA_IO )

	MCFG_DEVICE_MODIFY(THOM_PIA_GAME)
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(thomson_state, mo6_game_porta_out))
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(thomson_state, mo6_game_cb2_out))
...
static MACHINE_CONFIG_DERIVED( mo5nr, to7 )
	...
	MCFG_DEVICE_MODIFY(THOM_PIA_SYS)
	MCFG_PIA6821_READPA_HANDLER(READ8(thomson_state, mo6_sys_porta_in))
	MCFG_PIA6821_READPB_HANDLER(READ8(thomson_state, mo5nr_sys_portb_in))
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(thomson_state, mo5nr_sys_porta_out))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(thomson_state, mo6_sys_portb_out))
	MCFG_PIA6821_CA2_HANDLER(WRITELINE(thomson_state, mo5_set_cassette_motor))
	MCFG_PIA6821_CB2_HANDLER(WRITELINE(thomson_state, mo6_sys_cb2_out))
	MCFG_PIA6821_IRQB_HANDLER(WRITELINE(thomson_state, thom_irq_1)) /* differs from TO */
