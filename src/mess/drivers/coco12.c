...
INPUT_PORTS_START( coco_analog_control )
	...
	PORT_CONFNAME( 0x0f, 0x01, "Right Controller Port (P1)")			PORT_CHANGED_MEMBER(DEVICE_SELF, coco12_state,  coco_state::joystick_mode_changed, 0 )
	...
	PORT_CONFNAME( 0xf0, 0x10, "Left Controller Port (P2)")				PORT_CHANGED_MEMBER(DEVICE_SELF, coco12_state,  coco_state::joystick_mode_changed, 0 )
	PORT_CONFSETTING(  0x00, "Unconnected" )
