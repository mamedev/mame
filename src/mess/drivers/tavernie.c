...
static MACHINE_CONFIG_START( cpu09, tavernie_state )
	...
	MCFG_PIA6821_READPA_HANDLER(READ8(tavernie_state, pa_r))
	MCFG_PIA6821_READCA1_HANDLER(READLINE(tavernie_state, ca1_r))
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(tavernie_state, pa_w))
	MCFG_PIA6821_WRITEPB_HANDLER(WRITE8(tavernie_state, pb_w))
...
static MACHINE_CONFIG_DERIVED( ivg09, cpu09 )
	...
	MCFG_PIA6821_READPB_HANDLER(READ8(tavernie_state, pb_ivg_r))
	MCFG_PIA6821_WRITEPA_HANDLER(WRITE8(tavernie_state, pa_ivg_w))
	MCFG_PIA6821_CB2_HANDLER(DEVWRITELINE("beeper", beep_device, set_state))
