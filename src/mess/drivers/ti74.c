...
static INPUT_PORTS_START( ti74 )
	...
	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_KEYBOARD ) PORT_CODE(KEYCODE_ASTERISK) PORT_CHAR(UCHAR_MAMEKEY(ASTERISK)) PORT_NAME("*     "UTF8_NONSPACE_MACRON"y")
	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_KEYBOARD ) PORT_CODE(KEYCODE_SLASH_PAD) PORT_CODE(KEYCODE_SLASH) PORT_CHAR(UCHAR_MAMEKEY(SLASH_PAD)) PORT_NAME("/     "UTF8_NONSPACE_MACRON"x")
	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_UNUSED )
