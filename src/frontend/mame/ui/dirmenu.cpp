...
{
	{ __p("path-option", "ROMs"),               OPTION_MEDIAPATH,          ADDING },
	{ __p("path-option", "Software Media"),     OPTION_SWPATH,             CHANGE },
	{ __p("path-option", "Sound Samples"),      OPTION_SAMPLEPATH,         ADDING },
	{ __p("path-option", "Artwork"),            OPTION_ARTPATH,            ADDING },
	{ __p("path-option", "Crosshairs"),         OPTION_CROSSHAIRPATH,      ADDING },
	{ __p("path-option", "Cheat Files"),        OPTION_CHEATPATH,          ADDING },
	{ __p("path-option", "Plugins"),            OPTION_PLUGINSPATH,        ADDING },
	{ __p("path-option", "UI Translations"),    OPTION_LANGUAGEPATH,       CHANGE },
	{ __p("path-option", "INIs"),               OPTION_INIPATH,            ADDING },
	{ __p("path-option", "UI Settings"),        OPTION_UI_PATH,            CHANGE },
	{ __p("path-option", "Plugin Data"),        OPTION_PLUGINDATAPATH,     CHANGE },
	{ __p("path-option", "DATs"),               OPTION_HISTORY_PATH,       ADDING },
	{ __p("path-option", "Category INIs"),      OPTION_CATEGORYINI_PATH,   CHANGE },
	{ __p("path-option", "Snapshots"),          OPTION_SNAPSHOT_DIRECTORY, ADDING },
	{ __p("path-option", "Icons"),              OPTION_ICONS_PATH,         ADDING },
	{ __p("path-option", "Control Panels"),     OPTION_CPANELS_PATH,       ADDING },
	{ __p("path-option", "Cabinets"),           OPTION_CABINETS_PATH,      ADDING },
	{ __p("path-option", "Marquees"),           OPTION_MARQUEES_PATH,      ADDING },
	{ __p("path-option", "PCBs"),               OPTION_PCBS_PATH,          ADDING },
	{ __p("path-option", "Flyers"),             OPTION_FLYERS_PATH,        ADDING },
	{ __p("path-option", "Title Screens"),      OPTION_TITLES_PATH,        ADDING },
	{ __p("path-option", "Game Endings"),       OPTION_ENDS_PATH,          ADDING },
	{ __p("path-option", "Bosses"),             OPTION_BOSSES_PATH,        ADDING },
	{ __p("path-option", "Artwork Previews"),   OPTION_ARTPREV_PATH,       ADDING },
	{ __p("path-option", "Select"),             OPTION_SELECT_PATH,        ADDING },
	{ __p("path-option", "Game Over Screens"),  OPTION_GAMEOVER_PATH,      ADDING },
	{ __p("path-option", "HowTo"),              OPTION_HOWTO_PATH,         ADDING },
	{ __p("path-option", "Logos"),              OPTION_LOGOS_PATH,         ADDING },
	{ __p("path-option", "Scores"),             OPTION_SCORES_PATH,        ADDING },
	{ __p("path-option", "Versus"),             OPTION_VERSUS_PATH,        ADDING },
	{ __p("path-option", "Covers"),             OPTION_COVER_PATH,         ADDING }
};
