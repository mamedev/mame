...
static void palette_handler(mame_ui_manager &mui, render_container &container, ui_gfx_state &state)
{
	...
	mui.draw_outlined_box(container, boxbounds.x0 - x0, boxbounds.y0, boxbounds.x1 + x0, boxbounds.y1, mui.options().gfxviewer_bg_color());
...
static void tilemap_handler(mame_ui_manager &mui, render_container &container, ui_gfx_state &state)
{
	...
	// go ahead and draw the outer box now
	mui.draw_outlined_box(container, boxbounds.x0, boxbounds.y0, boxbounds.x1, boxbounds.y1, mui.options().gfxviewer_bg_color());
