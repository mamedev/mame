...
const options_entry ui_options::s_option_entries[] =
{
	...
	{ OPTION_UI_PALETTE,                    "classic",          option_type::STRING,     "UI color palette (classic, dark, light, solarized-dark, solarized-light)" },
	...
	{ OPTION_UI_DIPSW_COLOR,                "ff00a9ff",         option_type::STRING,     "UI dipswitch color (ARGB)" },
	...
	{ OPTION_UI_MOUSEDOWN_COLOR,            "ffffff00",         option_type::STRING,     "UI mouse down color (ARGB)" },
	{ OPTION_UI_MOUSEOVER_BG_COLOR,         "70404000",         option_type::STRING,     "UI mouse over bg color (ARGB)" },
	{ OPTION_UI_MOUSEOVER_COLOR,            "ffffff00",         option_type::STRING,     "UI mouse over color (ARGB)" },
	...
	{ OPTION_UI_UNAVAILABLE_COLOR,          "ff808080",         option_type::STRING,     "UI unavailable color (ARGB)" },
	{ OPTION_UI_ACCENT_COLOR,               "ef0a660a",         option_type::STRING,     "UI accent color (ARGB)" },
	{ OPTION_UI_STATUS_GOOD_COLOR,          "ef0a660a",         option_type::STRING,     "UI status good background color (ARGB)" },
	{ OPTION_UI_STATUS_WARNING_COLOR,       "efcc7a28",         option_type::STRING,     "UI status warning background color (ARGB)" },
	{ OPTION_UI_STATUS_ERROR_COLOR,         "efb20000",         option_type::STRING,     "UI status error background color (ARGB)" },
	{ OPTION_UI_FOCUS_COLOR,                "ffffff00",         option_type::STRING,     "UI focus text color (ARGB)" },
	{ OPTION_UI_FOCUS_BG_COLOR,             "ef808000",         option_type::STRING,     "UI focus background color (ARGB)" },
	{ OPTION_UI_FOCUS_OUTLINE_COLOR,        "ff2b2b2b",         option_type::STRING,     "UI focus outline color (ARGB)" },
	{ OPTION_UI_FOCUS_GRADIENT_TOP,         "ff00a9ff",         option_type::STRING,     "UI focus highlight gradient top color (ARGB)" },
	{ OPTION_UI_FOCUS_GRADIENT_BOTTOM,      "ff002782",         option_type::STRING,     "UI focus highlight gradient bottom color (ARGB)" },
	{ OPTION_UI_OVERLAY_COLOR,              "72000000",         option_type::STRING,     "UI overlay color (ARGB)" },
	{ OPTION_UI_CONFIG_DEEMPHASIZED_COLOR,  "ff808080",         option_type::STRING,     "UI configuration deemphasized color (ARGB)" },
