...
inline std::error_condition make_error_condition(err_t err) noexcept { return std::error_condition(int(err), fs_category()); }
...
template <> struct is_error_condition_enum<fs::err_t> : public std::true_type { };
