...
public:
	...
	const char *name() const noexcept override { return "mx"; }
	const char *description() const noexcept override { return "DVK MX disk image"; }
	const char *extensions() const noexcept override { return "mx"; }
