...
#ifndef MAME_FORMATS_FS_ADAM_EOS_H
#define MAME_FORMATS_FS_ADAM_EOS_H
...
class adam_eos_image : public manager_t {
public:
	adam_eos_image() = default;
...
extern const adam_eos_image ADAM_EOS;

} // namespace fs

#endif // MAME_FORMATS_FS_ADAM_EOS_H
