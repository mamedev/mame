...
PTEST(test_compile, compile)
{
	...
	plib::pmfp_base<plib::ppmf_type::INTERNAL_ITANIUM, void(int)>
		mfp_PPMF_TYPE_INTERNAL_ITANIUM;
	plib::pmfp_base<plib::ppmf_type::INTERNAL_ARM, void(int)>
		mfp_PPMF_TYPE_INTERNAL_ARM;
	plib::pmfp_base<plib::ppmf_type::INTERNAL_MSC, void(int)>
		mfp_PPMF_TYPE_INTERNAL_MSC;
	...
	plib::pmfp_base<plib::ppmf_type::GNUC_PMF_CONV, void(int)>
		mfp_PPMF_TYPE_GNUC_PMF_CONV;
