...
protected:
	...
	{
	public:
		virtual ret_t vp1() override
		{
			return ret_t(static_cast<void *>(this), 3);
		}
		virtual ret_t vp2() override
		{
			return ret_t(static_cast<void *>(this), 4);
		}
	};
	...
	public:
		virtual ret_t vp1() override
		{
			return ret_t(static_cast<void *>(this), 13);
		}
		virtual ret_t vp2() override
		{
			return ret_t(static_cast<void *>(this), 14);
		}
	};
...
protected:
	...
	{
	public:
		virtual void vp1(ret_t &r) override
		{
			r = ret_t(static_cast<void *>(this), 3);
		}
		virtual void vp2(ret_t &r) override
		{
			r = ret_t(static_cast<void *>(this), 4);
		}
	};
	...
	public:
		virtual void vp1(ret_t &r) override
		{
			r = ret_t(static_cast<void *>(this), 13);
		}
		virtual void vp2(ret_t &r) override
		{
			r = ret_t(static_cast<void *>(this), 14);
		}
	};
	...
	test_delegate
	make_forward_delegate(void (forward::*func)(ret_t &), forward *obj)
	{
		return test_delegate(func, obj);
	}
...
PTEST_F(pmfp_test_complex_return, multibase_test)
{
	...
	{
		PEXPECT_EQ(static_cast<int>(ts17.run_ft<INT128>(17)), 17); // FIXME: no
																   // operator
																   // << for
																   // INT128 yet
