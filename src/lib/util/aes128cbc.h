...
***************************************************************************/
#ifndef MAME_LIB_UTIL_AES128CBC_H
#define MAME_LIB_UTIL_AES128CBC_H
...
// The key is 16 bytes; the IV and each data block are 16 bytes.
...
#endif // MAME_LIB_UTIL_AES128CBC_H
