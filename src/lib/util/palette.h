...
inline constexpr uint8_t palexpand(uint8_t bits)
{
...
inline constexpr uint8_t pal1bit(uint8_t bits) { return palexpand<1>(bits); }
inline constexpr uint8_t pal2bit(uint8_t bits) { return palexpand<2>(bits); }
inline constexpr uint8_t pal3bit(uint8_t bits) { return palexpand<3>(bits); }
inline constexpr uint8_t pal4bit(uint8_t bits) { return palexpand<4>(bits); }
inline constexpr uint8_t pal5bit(uint8_t bits) { return palexpand<5>(bits); }
inline constexpr uint8_t pal6bit(uint8_t bits) { return palexpand<6>(bits); }
inline constexpr uint8_t pal7bit(uint8_t bits) { return palexpand<7>(bits); }
...
inline rgb_t constexpr rgbexpand(uint32_t data, uint8_t rshift, uint8_t gshift, uint8_t bshift)
{
...
inline rgb_t constexpr argbexpand(uint32_t data, uint8_t ashift, uint8_t rshift, uint8_t gshift, uint8_t bshift)
{
...
inline rgb_t constexpr pal332(uint32_t data, uint8_t rshift, uint8_t gshift, uint8_t bshift) { return rgbexpand<3,3,2>(data, rshift, gshift, bshift); }
inline rgb_t constexpr pal444(uint32_t data, uint8_t rshift, uint8_t gshift, uint8_t bshift) { return rgbexpand<4,4,4>(data, rshift, gshift, bshift); }
inline rgb_t constexpr pal555(uint32_t data, uint8_t rshift, uint8_t gshift, uint8_t bshift) { return rgbexpand<5,5,5>(data, rshift, gshift, bshift); }
inline rgb_t constexpr pal565(uint32_t data, uint8_t rshift, uint8_t gshift, uint8_t bshift) { return rgbexpand<5,6,5>(data, rshift, gshift, bshift); }
inline rgb_t constexpr pal888(uint32_t data, uint8_t rshift, uint8_t gshift, uint8_t bshift) { return rgbexpand<8,8,8>(data, rshift, gshift, bshift); }
