...
stack_walker::stack_walker()
	...
	m_first(true),
	m_stack_walk_64("StackWalk64", { TEXT("dbghelp.dll") }),
	m_sym_initialize("SymInitialize", { TEXT("dbghelp.dll") }),
	m_sym_function_table_access_64("SymFunctionTableAccess64", { TEXT("dbghelp.dll") }),
	m_sym_get_module_base_64("SymGetModuleBase64", { TEXT("dbghelp.dll") })
{
	// zap the structs
...
symbol_manager::symbol_manager(const char *argv0)
	...
	m_last_base(0),
	m_text_base(0),
	m_sym_from_addr("SymFromAddr", { TEXT("dbghelp.dll") }),
	m_sym_get_line_from_addr_64("SymGetLineFromAddr64", { TEXT("dbghelp.dll") })
{
#ifdef __GNUC__
...
{
	osd_dynamic_bind<ImageRvaToSection_fn> image_rva_to_section("ImageRvaToSection", { TEXT("dbghelp.dll") });
	osd_dynamic_bind<ImageNtHeader_fn> image_nt_header("ImageNtHeader", { TEXT("dbghelp.dll") });
