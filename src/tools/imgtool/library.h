...
{
public:
	typedef std::list<std::unique_ptr<imgtool::module> > modulelist;
	...
	// finds a module
	const imgtool::module *findmodule(const char *module_name);
...
private:
	...
	int module_compare(const imgtool::module *m1, const imgtool::module *m2, sort_type sort);
