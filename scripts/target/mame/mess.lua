...
files {
	...
	MAME_DIR .. "src/mame/drivers/megadriv_radica.cpp",
	MAME_DIR .. "src/mame/drivers/megadriv_radica.h",
...
files {
	...
	MAME_DIR .. "src/mame/drivers/vtech_elan_eu3a12.cpp",
...
files {
	...
	MAME_DIR .. "src/mame/drivers/radica_elan_eu3a14.cpp",
	MAME_DIR .. "src/mame/drivers/radicasi.cpp",
	MAME_DIR .. "src/mame/audio/radicasi.cpp",
	MAME_DIR .. "src/mame/audio/radicasi.h",
	MAME_DIR .. "src/mame/machine/radicasi_gpio.cpp",
	MAME_DIR .. "src/mame/machine/radicasi_gpio.h",
