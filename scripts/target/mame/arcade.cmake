...
list(APPEND VIDEOS I4100)
#list(APPEND VIDEOS I8244)
list(APPEND VIDEOS I8275)
list(APPEND VIDEOS JANGOU_BLITTER)
...
list(APPEND VIDEOS VOODOO_PCI)
list(APPEND VIDEOS ZEUS2)
...
list(APPEND MACHINES TTL74165)
list(APPEND MACHINES TTL74166)
...
list(APPEND MACHINES LDP1000)
list(APPEND MACHINES LDP1450)
...
list(APPEND MACHINES R10696)
list(APPEND MACHINES R10788)
list(APPEND MACHINES RA17XX)
...
list(APPEND MACHINES SECFLASH)
list(APPEND MACHINES PCCARD)
list(APPEND MACHINES FDC37C665GT)
...
macro(linkProjects_mame_arcade _target, _subtarget _projectname)
...
macro(createProjects_mame_arcade _target _subtarget)
##################################################
