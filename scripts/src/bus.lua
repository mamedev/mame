...
if (BUSES["MSX_SLOT"]~=null) then
	files {
		...
		MAME_DIR .. "src/devices/bus/msx/slot/minicart.cpp",
		MAME_DIR .. "src/devices/bus/msx/slot/minicart.h",
		MAME_DIR .. "src/devices/bus/msx/slot/module.cpp",
		MAME_DIR .. "src/devices/bus/msx/slot/module.h",
