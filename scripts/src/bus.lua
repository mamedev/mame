...
if (BUSES["SPECTRUM"]~=null) then
	files {
		...
		MAME_DIR .. "src/devices/bus/spectrum/beta128.h",
  		MAME_DIR .. "src/devices/bus/spectrum/disciple.cpp",
  		MAME_DIR .. "src/devices/bus/spectrum/disciple.h",
		...
		MAME_DIR .. "src/devices/bus/spectrum/plusd.cpp",
		MAME_DIR .. "src/devices/bus/spectrum/plusd.h",
