...
if (BUSES["CENTRONICS"]~=null) then
	files {
		...
		MAME_DIR .. "src/devices/bus/centronics/cenluaprinter.cpp",
		MAME_DIR .. "src/devices/bus/centronics/cenluaprinter.h",
...
if (BUSES["RS232"]~=null) then
	files {
		...
		MAME_DIR .. "src/devices/bus/rs232/rs232luaprinter.cpp",
		MAME_DIR .. "src/devices/bus/rs232/rs232luaprinter.h",
