...
--@src/devices/sound/ym2414.h,SOUNDS["YM3806"] = true
...
if (SOUNDS["YM3806"]~=null) then
	files {
		MAME_DIR .. "src/devices/sound/ym3806.cpp",
		MAME_DIR .. "src/devices/sound/ym3806.h",
		MAME_DIR .. "src/devices/sound/ymfm.cpp",
		MAME_DIR .. "src/devices/sound/ymfm.h",
		MAME_DIR .. "src/devices/sound/ymfm.ipp",
		MAME_DIR .. "src/devices/sound/ymfm_opq.cpp",
		MAME_DIR .. "src/devices/sound/ymfm_opq.h",
	}
end
...
if (SOUNDS["YM2203"]~=null or SOUNDS["YM2608"]~=null or SOUNDS["YM2610"]~=null or SOUNDS["YM2610B"]~=null or SOUNDS["YM2612"]~=null or SOUNDS["YM3438"]~=null) then
	files {
		...
		MAME_DIR .. "src/devices/sound/ymfm.h",
		MAME_DIR .. "src/devices/sound/ymfm.ipp",
		MAME_DIR .. "src/devices/sound/ymfm_adpcm.cpp",
		MAME_DIR .. "src/devices/sound/ymfm_adpcm.h",
		MAME_DIR .. "src/devices/sound/ymfm_opn.cpp",
		MAME_DIR .. "src/devices/sound/ymfm_opn.h",
		MAME_DIR .. "src/devices/sound/ymfm_ssg.cpp",
		MAME_DIR .. "src/devices/sound/ymfm_ssg.h",
	}
end
