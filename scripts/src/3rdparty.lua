...
--------------------------------------------------
-- The Final Ethernet library
--------------------------------------------------
project "tfe"
	uuid "c860787f-2867-4a3c-9676-32a5e138cd7b"
	kind "StaticLib"
	buildoptions {
		"-std=gnu99",
	}
	defines {
		"GSPORT_LITTLE_ENDIAN",
		"DOS_TFE=1",
		"HAVE_TFE",
		"HAVE_ATBRIDGE",
		"TOGGLE_STATUS",
	...
	files {
		MAME_DIR .. "3rdparty/tfe/atbridge/pcap_delay.c",
		MAME_DIR .. "3rdparty/tfe/tfe/tfe.c",
		MAME_DIR .. "3rdparty/tfe/tfe/tfearch.c",
		MAME_DIR .. "3rdparty/tfe/tfe/tfesupp.c",
	}
links {
	ext_lib("tfe"),
}
