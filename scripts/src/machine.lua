...
---------------------------------------------------
--
--@src/devices/machine/74164.h,MACHINES["TTL74164"] = true
---------------------------------------------------

if (MACHINES["TTL74164"]~=null) then
	files {
		MAME_DIR .. "src/devices/machine/74164.cpp",
		MAME_DIR .. "src/devices/machine/74164.h",
	}
end
