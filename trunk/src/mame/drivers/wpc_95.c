...
static ADDRESS_MAP_START( wpc_95_map, AS_PROGRAM, 8 )
...
GAME(1996,	tf95_12,	0,			wpc_95,	wpc_95,	wpc_95,	ROT0,	"Bally",				"WPC 95 Test Fixture (1.2)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1995,	afm_113,	0,			wpc_95,	wpc_95,	wpc_95,	ROT0,	"Bally",				"Attack From Mars (1.13)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1995,	afm_113b,	afm_113,	wpc_95,	wpc_95,	wpc_95,	ROT0,	"Bally",				"Attack From Mars (1.13b)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1995,	afm_11,		afm_113,	wpc_95,	wpc_95,	wpc_95,	ROT0,	"Bally",				"Attack From Mars (1.1)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1995,	afm_11u,	afm_113,	wpc_95,	wpc_95,	wpc_95,	ROT0,	"Bally",				"Attack From Mars (1.1 Ultrapin)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1995,	afm_10,		afm_113,	wpc_95,	wpc_95,	wpc_95,	ROT0,	"Bally",				"Attack From Mars (1.0)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1998,	cc_13,		0,			wpc_95,	wpc_95,	wpc_95,	ROT0,	"Bally",				"Cactus Canyon (1.3)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1998,	cc_12,		cc_13,		wpc_95,	wpc_95,	wpc_95,	ROT0,	"Bally",				"Cactus Canyon (1.2)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1997,	cv_14,		0,			wpc_95,	wpc_95,	wpc_95,	ROT0,	"Bally",				"Cirqus Voltaire (1.4)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1997,	cv_20h,		cv_14,		wpc_95,	wpc_95,	wpc_95,	ROT0,	"Bally",				"Cirqus Voltaire (2.0H)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1997,	cv_10,		cv_14,		wpc_95,	wpc_95,	wpc_95,	ROT0,	"Bally",				"Cirqus Voltaire (1.0)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1997,	cv_11,		cv_14,		wpc_95,	wpc_95,	wpc_95,	ROT0,	"Bally",				"Cirqus Voltaire (1.1)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
...
GAME(1999,	mm_10,		0,			wpc_95,	wpc_95,	wpc_95,	ROT0,	"Williams",				"Medieval Madness (1.0)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1999,	mm_10u,		mm_10,		wpc_95,	wpc_95,	wpc_95,	ROT0,	"Williams",				"Medieval Madness (1.0 Ultrapin)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1999,	mm_109,		mm_10,		wpc_95,	wpc_95,	wpc_95,	ROT0,	"Williams",				"Medieval Madness (1.09)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1999,	mm_109b,	mm_10,		wpc_95,	wpc_95,	wpc_95,	ROT0,	"Williams",				"Medieval Madness (1.09B)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1999,	mm_109c,	mm_10,		wpc_95,	wpc_95,	wpc_95,	ROT0,	"Williams",				"Medieval Madness (1.09C Profanity)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1997,	mm_05,		mm_10,		wpc_95,	wpc_95,	wpc_95,	ROT0,	"Williams",				"Medieval Madness (0.50)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1998,	mb_10,		0,			wpc_95,	wpc_95,	wpc_95,	ROT0,	"Williams",				"Monster Bash (1.0)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1998,	mb_106,		mb_10,		wpc_95,	wpc_95,	wpc_95,	ROT0,	"Williams",				"Monster Bash (1.06)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1998,	mb_106b,	mb_10,		wpc_95,	wpc_95,	wpc_95,	ROT0,	"Williams",				"Monster Bash (1.06b)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1997,	nbaf_31,	0,			wpc_95,	wpc_95,	wpc_95,	ROT0,	"Bally",				"NBA Fastbreak (3.1 - S3.0)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1997,	nbaf_31a,	nbaf_31,	wpc_95,	wpc_95,	wpc_95,	ROT0,	"Bally",				"NBA Fastbreak (3.1 - S1.0)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1997,	nbaf_11s,	nbaf_31,	wpc_95,	wpc_95,	wpc_95,	ROT0,	"Bally",				"NBA Fastbreak (1.1 - S0.4)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1997,	nbaf_11,	nbaf_31,	wpc_95,	wpc_95,	wpc_95,	ROT0,	"Bally",				"NBA Fastbreak (1.1)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1997,	nbaf_11a,	nbaf_31,	wpc_95,	wpc_95,	wpc_95,	ROT0,	"Bally",				"NBA Fastbreak (1.1 - S2.0)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1997,	nbaf_115,	nbaf_31,	wpc_95,	wpc_95,	wpc_95,	ROT0,	"Bally",				"NBA Fastbreak (1.15)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1997,	nbaf_21,	nbaf_31,	wpc_95,	wpc_95,	wpc_95,	ROT0,	"Bally",				"NBA Fastbreak (2.1)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1997,	nbaf_22,	nbaf_31,	wpc_95,	wpc_95,	wpc_95,	ROT0,	"Bally",				"NBA Fastbreak (2.2)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1997,	nbaf_23,	nbaf_31,	wpc_95,	wpc_95,	wpc_95,	ROT0,	"Bally",				"NBA Fastbreak (2.3)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1997,	ngg_13,		0,			wpc_95,	wpc_95,	wpc_95,	ROT0,	"Williams",				"No Good Gofers (1.3)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1997,	ngg_p06,	ngg_13,		wpc_95,	wpc_95,	wpc_95,	ROT0,	"Williams",				"No Good Gofers (p0.6)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1997,	ngg_10,		ngg_13,		wpc_95,	wpc_95,	wpc_95,	ROT0,	"Williams",				"No Good Gofers (1.0)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1998,	sc_18,		0,			wpc_95,	wpc_95,	wpc_95,	ROT0,	"Bally",				"Safe Cracker (1.8)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1998,	sc_18n,		sc_18,		wpc_95,	wpc_95,	wpc_95,	ROT0,	"Bally",				"Safe Cracker (1.8N)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1998,	sc_18s2,	sc_18,		wpc_95,	wpc_95,	wpc_95,	ROT0,	"Bally",				"Safe Cracker (1.8 alternate sound)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1996,	sc_17,		sc_18,		wpc_95,	wpc_95,	wpc_95,	ROT0,	"Bally",				"Safe Cracker (1.7)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1996,	sc_17n,		sc_18,		wpc_95,	wpc_95,	wpc_95,	ROT0,	"Bally",				"Safe Cracker (1.7N)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1996,	sc_14,		sc_18,		wpc_95,	wpc_95,	wpc_95,	ROT0,	"Bally",				"Safe Cracker (1.4)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1996,	ss_15,		0,			wpc_95,	wpc_95,	wpc_95,	ROT0,	"Bally",				"Scared Stiff (1.5)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
...
GAME(1996,	totan_04,	totan_14,	wpc_95,	wpc_95,	wpc_95,	ROT0,	"Williams",				"Tales Of The Arabian Nights (0.4)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1998,	cp_16,		0,			wpc_95,	wpc_95,	wpc_95,	ROT0,	"Bally",				"The Champion Pub (1.6)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1998,	cp_15,		cp_16,		wpc_95,	wpc_95,	wpc_95,	ROT0,	"Bally",				"The Champion Pub (1.5)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
GAME(1996,	ttt_10,		0,			wpc_95,	wpc_95,	wpc_95,	ROT0,	"Williams",				"Ticket Tac Toe (1.0)",				GAME_NOT_WORKING | GAME_NO_SOUND | GAME_MECHANICAL)
